...
import { LevelLine, Plane, SeriesTicks, TanLine, WindowArc } from '../src/components/grade10/figures.jsx'
  ...
  return (
    <div className="lesson-root" style={{ padding: 10 }}>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'flex-start' }}>
        <TanLine size={300} step={s} deg={30} />
        <TanLine size={212} step={s} deg={30} />
        <TanLine size={300} step={s} deg={120} />
      </div>
