...
- **`scored: true`** на части экранов — это **отдельный вопрос политики оценивания** (конфликт qa-validator/teaching_methodology vs ревизия инфры 6 июн). Решает Боязид (до 2026-08-05 вопрос был адресован Фузайлу, которого в проекте больше нет). В рамках миграции v5.2 это **не трогаем**.
