      ...
      audio: {
        intro: {
          ...
          ru: [
            ...
            'Бит — робот. Внутри у него компьютер, поэтому он выполняет команды.',
      ...
      audio: {
        intro: {
          ...
          ru: [
            ...
            'А настольный компьютер — самый знакомый. Сейчас рассмотрим его вблизи.',
          ],
          en: [
      ...
      audio: {
        intro: {
          ...
          ru: [
            ...
            'Первая — процессор. Он считает и выполняет команды.',
            'Вторая — память. Она держит то, с чем работаешь сейчас, и при выключении теряется.',
            'Третья — диск. Рисунки и тексты остаются на диске, даже если выключить компьютер.',
          ],
          en: [
            ...
            'The second is memory. It holds what you work with now, and it is lost when the power goes off.',
            'The third is the disk. Pictures and texts stay on the disk even if the computer is switched off.',
          ],
        },
      },
      doneText: {
    ...
    // ------------------------------------------------- 6 bridge (цепочка) ---
    {
      ...
      audio: {
        intro: {
          ...
          ru: [
            'Ты нажал букву на клавиатуре. Это ввод. Данные пришли в компьютер.',
      ...
      rounds: [
        {
          ...
          audio: {
            intro: {
              ...
              ru: 'Процессор — работник компьютера. В чём была его работа.',
        ...
        },
        {
          ...
          audio: {
            ...
            on_correct: {
              ...
              ru: 'Верно. Память — для текущей работы. При выключении она пустеет.',
      ...
      rounds: [
        {
          ...
          audio: {
            ...
            on_correct: {
              ...
              ru: 'Верно. Экран — устройство вывода, он данные не даёт.',
          ...
          audio: {
            ...
            on_wrong: [
              ...
              },
              {
                ...
                ru: 'Считать — работа процессора. Ни диск, ни память не считают.',
          ...
          audio: {
            ...
            on_wrong: [
              ...
              },
              {
                ...
                ru: 'Думать — дело человека. Компьютер выполняет команду.',
        ...
        },
        {
          ...
          audio: {
            intro: {
              ...
              ru: 'Последнее место — для хранения. Оно не теряется при выключении.',
              en: 'The last place is for storing. It is not lost at shutdown.',
            },
            on_correct: {
              uz: "To'g'ri. Disk uzoq saqlash uchun.",
              ru: 'Верно. Диск — для долгого хранения.',
    ...
    // ------------------------------------- 12 myth_check («компьютер думает») --
    {
      ...
      audio: {
        ...
        on_correct: {
          ...
          ru: 'Да. Компьютер делает написанное. Он не знает, чего ты хотел.',
    ...
    // -------------------------------------------------------- 15 summary --
    {
      ...
      audio: {
        ...
        ru: [
          ...
          'Компьютер — не экран. Это устройство, которое работает с данными.',
