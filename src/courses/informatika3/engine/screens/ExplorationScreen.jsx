...
export default function ExplorationScreen({
  ...
  // Отладочный console.debug, оставшийся в исходнике с пометкой «снять перед
  // коммитом», здесь снят: он печатался на каждый кадр каждого экрана объяснения,
  // а требование к сдаче урока — чистая консоль.
