// Dars01 «O'nliklar va birliklar» — CONTENT (RU + UZ + audio).
// Manba: src/books/grade2/Dars01_CONTENT.md — matn o'zgarmagan (bayt-aniq ko'chirma).
// Bu 3D-prototip DEMO uchun; etalon Dars01.jsx ga tegmaydi.
export const CONTENT = {
  s0: {
    ...
    opt1: { ru: 'По десять в кассету', uz: "O'ntadan kassetaga" },
  ...
  s11: {
    ...
    opt1: { ru: 'Корабль пятьдесят четыре', uz: "Ellik to'rt kemasi" },
    audio: {
...
export const ORDER = ['s0','s1','s2','s3','s4','s5','s6','s7','s8','s9','s10','s11','s12','s13','s14','s15'];
