...
export const grade11Nazariy = [
  ...
  {
    slug: 'dars35-fazoda-koordinatalar',
    title: 'Dars 35. Fazoda koordinatalar',
    desc: "Uchta son va ularning tartibi, nollar joyni aytadi, nuqtaning soyalari, kesma o'rtasi. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars35.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars36-vektorlar-amallar',
    title: 'Dars 36. Vektorlar ustida amallar',
    desc: "Vektorning uchligi, erkin vektor, uzunlik, qo'shish va songa ko'paytirish, kollinearlik. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars36.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars37-skalyar-kopaytma',
    title: "Dars 37. Skalyar ko'paytma",
    desc: "Ikki vektor orasidagi burchak, skalyar ko'paytma, ishora va burchak turi, perpendikularlik sharti. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars37.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars38-tekislik-tenglamasi',
    title: 'Dars 38. Tekislik tenglamasi',
    desc: "Nuqta va normal tekislikni beradi, koeffitsiyentlar bu normal, ozod had nuqtadan chiqadi. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars38.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars39-tekisliklar-burchagi',
    title: 'Dars 39. Tekisliklar orasidagi burchak',
    desc: "Normallar orqali burchak, kosinusdagi modul, perpendikular va parallel tekisliklar. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars39.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars40-masofalar',
    title: 'Dars 40. Masofalar',
    desc: "Perpendikular bo'ylab o'lchash, tekislikka bitta, o'qqa ikkita koordinata, sfera tenglamasi. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars40.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars41-almashtirishlar',
    title: "Dars 41. Almashtirishlar va o'xshashlik",
    desc: "Harakat masofani saqlaydi, o'xshashlik shaklni; koordinatalar jadvali va gomotetiya. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars41.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars43-hosila-tezlik',
    title: "Dars 43. Hosila: o'zgarish tezligi",
    desc: "O'rtacha tezlik oraliqda, oniy tezlik nuqtada; kesuvchi urinmaga o'tadi va nisbatning limiti hosila bo'ladi. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars43.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars44-jadval-va-qoidalar',
    title: "Dars 44. Hosilalar jadvali va qoidalar",
    desc: "Hosilani limit bilan izlash shart emas: jadvaldan qator tanlanadi, ko'paytma, bo'linma va murakkab funksiya esa o'z qoidasini talab qiladi. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars44.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars45-urinma-va-tekshirish',
    title: "Dars 45. Urinma va funksiyani tekshirish",
    desc: "Nuqtadagi hosila urinma tenglamasini beradi, ishora o'sish va kamayishni, hosilaning noli esa faqat nomzodni. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars45.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars46-almashtirishlar-sinov',
    title: "Dars 46. Almashtirishlar: sinov DTM",
    desc: "DTM rejimi: masala darrov, tushuntirishsiz. Ildiz va modul, manfiy ko'rsatkich, ODZ, bir asos; yakunda kamchiliklar xaritasi. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars46.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars47-tenglama-tengsizlik-sinov',
    title: "Dars 47. Tenglama va tengsizlik: sinov DTM",
    desc: "DTM rejimi: kvadratga ko'tarish begona ildiz beradi, asos birdan kichik bo'lsa yo'nalish almashadi, logarifmda ikki shart birga ishlaydi. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars47.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars48-grafiklar-va-yuza-sinov',
    title: "Dars 48. Grafiklar va yuza: sinov DTM",
    desc: "DTM rejimi: o'q ostida integral manfiy, chegaralar almashsa ishora almashadi, grafikni nuqta bilan aniqlash. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars48.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars49-matnli-masalalar-yakun',
    title: "Dars 49. Matnli masalalar va yil yakuni",
    desc: "DTM rejimi, yil yakuni: har masala boshqa blokdan, shartni yozuvga aylantirish, yakunda butun yil bo'yicha kamchiliklar xaritasi. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars49.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars51-planimetriya-sinov',
    title: "Dars 51. Planimetriya: sinov DTM",
    desc: "DTM rejimi: to'g'ri burchak kvadratlar bilan tekshiriladi, o'rta chiziq yarim yig'indi, o'xshashlikda yuza k kvadratga ko'payadi. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars51.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars52-stereometriya-sinov',
    title: "Dars 52. Stereometriya: sinov DTM",
    desc: "DTM rejimi, darslikning imtihon banki: uchdan bir koeffitsiyenti, sirt k kvadratga va hajm k kubga, qaysi o'q shunday jism. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars52.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars53-vektorlar-sinov',
    title: "Dars 53. Vektorlar va koordinatalar: sinov DTM",
    desc: "DTM rejimi, darslikning imtihon banki: oxiri minus boshi, yarim yig'indi, nomda yo'q koordinata ishora almashtiradi. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars53.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars54-tayyorlov-varianti',
    title: "Dars 54. Tayyorlov varianti: sinov DTM",
    desc: "DTM rejimi: har masala boshqa blokdan, imtihondagidek aralash. Javobni teskari amal bilan tekshirish, kamida bitta uchun teskari hodisa. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars54.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars55-kompleks-amaliyot',
    title: "Dars 55. Kompleks amaliyot: sinov DTM",
    desc: "DTM rejimi: geometriya ichida algebraik qadam. O'lchov darajani beradi, hajmdan qirraga kub ildiz, geometrik ehtimollik. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars55.jsx')),
    ownLangSwitch: true,
  },
  {
    slug: 'dars56-takrorlash-kurs-yakuni',
    title: "Dars 56. Takrorlash va kurs yakuni",
    desc: "Kursning oxirgi darsi: yil bo'yi eng ko'p uchragan xatolar, yakunda butun yil bo'yicha kamchiliklar xaritasi. 15 slayd, UZ/RU/EN.",
    Component: lazy(() => import('../components/grade11/Dars56.jsx')),
    ownLangSwitch: true,
  },
]
