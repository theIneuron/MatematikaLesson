...
// ============================================================================
// LessonPage — САМОДОСТАТОЧНЫЙ файл урока (переносится в другой проект целиком).
// Все данные урока живут ВНУТРИ этого файла в объекте `lesson` (см. export ниже).
// Чтобы сделать другой урок: замени LESSON_META + CONTENT + BRIDGES (+ экраны, если
// механика другая). Снаружи ничего импортировать не нужно.
//
// Сейчас внутри: 2-SINF · «Задача в два действия» (twostep-2-12-v1) · Б2 MARS
// ============================================================================
...
// ============================================================
// CONTENT — тексты / тесты / озвучка слайдов (часть объекта lesson.content).
// Меняй здесь тему урока: lead, q, opts, audio.ru / audio.uz и т.д.
// ============================================================
...
// ============================================================
// lesson — ЕДИНЫЙ объект данных урока (всё в этом файле, снаружи не тянется).
// Чтобы сменить тему: замени meta + content + bridges (+ screens при другой механике).
// ============================================================
export const lesson = {
  meta: LESSON_META,
...
// ============================================================
// KORNEVOY KOMPONENT — самодостаточный LessonPage (перенос = этот файл)
// ============================================================
