  ...
  return (
    <div className="pq pq2406">
      <style>{`
        ...
        .pq2406 .pq-scene{position:relative;width:380px;max-width:100%;height:214px;margin:0 auto;border-radius:20px;background:linear-gradient(#cfeafc 0%,#e4f4d9 52%,#d3edb6 100%);border:2px solid #bfe0a8;overflow:hidden;}
