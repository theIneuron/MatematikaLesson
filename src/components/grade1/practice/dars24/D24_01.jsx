  ...
  return (
    <div className="pq pq2401">
      <style>{`
        ...
        /* ===== TABIAT SAHNASI ===== */
        .pq2401 .pq-scene{position:relative;width:420px;max-width:100%;height:326px;border-radius:24px;overflow:hidden;border:2px solid #bfe0d0;background:linear-gradient(#bfe6fb 0%,#d9f1fd 42%,#eaf8ff 62%);box-shadow:inset 0 2px 8px rgba(90,140,180,.14);}
        ...
        /* variantlar + feedback */
        .pq2401 .pq-opts{display:flex;gap:12px;justify-content:center;}
