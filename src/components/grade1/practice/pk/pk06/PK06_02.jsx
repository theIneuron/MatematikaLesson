// PK06_02 — ПК6 (Blok 9) · Yumaloq o'nliklar (ayirish) · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Yumaloq o\'nliklar', kind: 'sub', noDots: true, a: 70, b: 30, options: [30, 40, 50], answer: 40,
  eyebrow: { uz: 'Nazorat · Ayirish', ru: 'Контроль · Вычитание' },
  setup: { uz: 'O\'nliklarni sanaymiz.', ru: 'Считаем десятки.' },
  ask: { uz: '70 dan 30 ayirsak necha qoladi?', ru: 'Сколько будет 70 минус 30?' },
...
export default function PK06_02(props) {
  const data = DATA;
