// PK06_01 — ПК6 (Blok 9) · Yumaloq o'nliklar (qo'shish) · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Yumaloq o\'nliklar', kind: 'add', noDots: true, a: 20, b: 30, options: [40, 50, 60], answer: 50,
  eyebrow: { uz: 'Nazorat · Qo\'shish', ru: 'Контроль · Сложение' },
  setup: { uz: 'O\'nliklarni sanaymiz.', ru: 'Считаем десятки.' },
  ask: { uz: '20 qo\'shish 30 nechaga teng?', ru: 'Сколько будет 20 плюс 30?' },
...
export default function PK06_01(props) {
  const data = DATA;
