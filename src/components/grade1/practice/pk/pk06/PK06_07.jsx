// PK06_07 — ПК6 (Blok 9) · 2 xonali − 2 xonali · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '2 xonali − 2 xonali', kind: 'sub', noDots: true, a: 68, b: 25, options: [42, 43, 44], answer: 43,
  eyebrow: { uz: 'Nazorat · Ayirish', ru: 'Контроль · Вычитание' },
  setup: { uz: 'Razryad bo\'yicha ayiring.', ru: 'Вычитай по разрядам.' },
  ask: { uz: '68 dan 25 ayirsak necha qoladi?', ru: 'Сколько будет 68 минус 25?' },
...
export default function PK06_07(props) {
  const data = DATA;
