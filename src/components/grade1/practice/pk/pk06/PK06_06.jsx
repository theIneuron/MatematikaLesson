// PK06_06 — ПК6 (Blok 9) · 2 xonali + 2 xonali · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '2 xonali + 2 xonali', kind: 'add', noDots: true, a: 41, b: 36, options: [76, 77, 78], answer: 77,
  eyebrow: { uz: 'Nazorat · Qo\'shish', ru: 'Контроль · Сложение' },
  setup: { uz: 'Razryad bo\'yicha qo\'shing.', ru: 'Складывай по разрядам.' },
  ask: { uz: '41 qo\'shish 36 nechaga teng?', ru: 'Сколько будет 41 плюс 36?' },
...
export default function PK06_06(props) {
  const data = DATA;
