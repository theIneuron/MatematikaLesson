// PK06_08 — ПК6 (Blok 9) · 100 dan ayirish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '100 dan ayirish', kind: 'sub', noDots: true, a: 100, b: 40, options: [50, 60, 70], answer: 60,
  eyebrow: { uz: 'Nazorat · Ayirish', ru: 'Контроль · Вычитание' },
  setup: { uz: 'Yuzdan o\'nliklarni oling.', ru: 'Из ста вычитаем десятки.' },
  ask: { uz: '100 dan 40 ayirsak necha qoladi?', ru: 'Сколько будет 100 минус 40?' },
  correct: { uz: 'Barakalla! To\'g\'ri hisobladingiz.', ru: 'Молодец! Посчитал верно.' },
  hint: { uz: 'O\'nlikdan o\'nlikni, birlikdan birlikni ayiring.', ru: 'Вычитай десятки из десятков, единицы из единиц.' },
};

export default function PK06_08(props) {
  const data = DATA;
