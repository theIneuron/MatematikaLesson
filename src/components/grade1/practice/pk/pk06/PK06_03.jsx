// PK06_03 — ПК6 (Blok 9) · 2 xonali + 1 xonali · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '2 xonali + 1 xonali', kind: 'add', noDots: true, a: 34, b: 5, options: [38, 39, 40], answer: 39,
  eyebrow: { uz: 'Nazorat · Qo\'shish', ru: 'Контроль · Сложение' },
  setup: { uz: 'Birlikka birlik qo\'shiladi.', ru: 'К единицам прибавляем единицы.' },
  ask: { uz: '34 qo\'shish 5 nechaga teng?', ru: 'Сколько будет 34 плюс 5?' },
  correct: { uz: 'Barakalla! To\'g\'ri hisobladingiz.', ru: 'Молодец! Посчитал верно.' },
  hint: { uz: 'O\'nlikni o\'nlikka, birlikni birlikka qo\'shing.', ru: 'Складывай десятки с десятками, единицы с единицами.' },
};

export default function PK06_03(props) {
  const data = DATA;
