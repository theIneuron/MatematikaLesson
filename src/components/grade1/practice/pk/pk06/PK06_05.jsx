// PK06_05 — ПК6 (Blok 9) · 2 xonali + 2 xonali · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '2 xonali + 2 xonali', kind: 'add', noDots: true, a: 34, b: 25, options: [58, 59, 60], answer: 59,
  eyebrow: { uz: 'Nazorat · Qo\'shish', ru: 'Контроль · Сложение' },
  setup: { uz: 'Razryad bo\'yicha qo\'shing.', ru: 'Складывай по разрядам.' },
  ask: { uz: '34 qo\'shish 25 nechaga teng?', ru: 'Сколько будет 34 плюс 25?' },
...
export default function PK06_05(props) {
  const data = DATA;
