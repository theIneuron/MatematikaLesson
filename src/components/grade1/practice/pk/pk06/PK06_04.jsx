// PK06_04 — ПК6 (Blok 9) · 2 xonali + 1 xonali · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '2 xonali + 1 xonali', kind: 'add', noDots: true, a: 52, b: 6, options: [57, 58, 59], answer: 58,
  eyebrow: { uz: 'Nazorat · Qo\'shish', ru: 'Контроль · Сложение' },
  setup: { uz: 'O\'nlik o\'zgarmaydi.', ru: 'Десяток не меняется.' },
  ask: { uz: '52 qo\'shish 6 nechaga teng?', ru: 'Сколько будет 52 плюс 6?' },
...
export default function PK06_04(props) {
  const data = DATA;
