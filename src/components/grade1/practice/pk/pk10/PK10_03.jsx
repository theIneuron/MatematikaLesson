// PK10_03 — ПК10 (Blok 11) · O'lchov birliklari · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Metr → dm', kind: 'convert', expr: '1 m =', unit: 'dm', options: [1, 10, 100], answer: 10,
  eyebrow: { uz: 'Nazorat · Uzunlik', ru: 'Контроль · Длина' },
  setup: { uz: 'Bir metrda detsimetrlarni sanang.', ru: 'Посчитай дециметры в одном метре.' },
  ask: { uz: '1 m necha dm?', ru: 'Сколько дм в 1 м?' },
  correct: { uz: 'Barakalla! Bir metr — o\'n detsimetr.', ru: 'Молодец! Один метр — десять дециметров.' },
  hint: { uz: '1 m = 10 dm.', ru: '1 м = 10 дм.' },
};

export default function PK10_03(props) {
  const data = DATA;
