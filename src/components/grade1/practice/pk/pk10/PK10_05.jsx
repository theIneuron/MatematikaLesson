// PK10_05 — ПК10 (Blok 11) · O'lchov birliklari · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Massa — teng', kind: 'compare', a: 4, b: 4, options: ['>', '<', '='], answer: '=',
  eyebrow: { uz: 'Nazorat · Massa', ru: 'Контроль · Масса' },
  setup: { uz: 'Ikki qopda ham 4 kg dan.', ru: 'В обоих мешках по 4 кг.' },
  ask: { uz: 'Qaysi belgi to\'g\'ri?', ru: 'Какой знак верный?' },
  correct: { uz: 'Barakalla! To\'rt va to\'rt — teng.', ru: 'Молодец! Четыре и четыре — равны.' },
  hint: { uz: 'Sonlar bir xil bo\'lsa — teng.', ru: 'Если числа одинаковы — равно.' },
};

export default function PK10_05(props) {
  const data = DATA;
