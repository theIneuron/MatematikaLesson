// PK10_01 — ПК10 (Blok 11) · O'lchov birliklari · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Detsimetr → sm', kind: 'convert', expr: '1 dm =', unit: 'sm', options: [1, 10, 100], answer: 10,
  eyebrow: { uz: 'Nazorat · Uzunlik', ru: 'Контроль · Длина' },
  setup: { uz: 'Bir detsimetrda santimetrlarni sanang.', ru: 'Посчитай сантиметры в одном дециметре.' },
  ask: { uz: '1 dm necha sm?', ru: 'Сколько см в 1 дм?' },
  correct: { uz: 'Barakalla! Bir detsimetr — o\'n santimetr.', ru: 'Молодец! Один дециметр — десять сантиметров.' },
  hint: { uz: '1 dm = 10 sm.', ru: '1 дм = 10 см.' },
};

export default function PK10_01(props) {
  const data = DATA;
