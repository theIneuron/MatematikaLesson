// PK10_02 — ПК10 (Blok 11) · O'lchov birliklari · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Detsimetr → sm', kind: 'convert', expr: '3 dm =', unit: 'sm', options: [13, 30, 33], answer: 30,
  eyebrow: { uz: 'Nazorat · Uzunlik', ru: 'Контроль · Длина' },
  setup: { uz: 'Har detsimetrda o\'n santimetr.', ru: 'В каждом дециметре десять сантиметров.' },
  ask: { uz: '3 dm necha sm?', ru: 'Сколько см в 3 дм?' },
  correct: { uz: 'Barakalla! Uch detsimetr — o\'ttiz santimetr.', ru: 'Молодец! Три дециметра — тридцать сантиметров.' },
  hint: { uz: 'Har dm — 10 sm, uchtasi — o\'ttiz.', ru: 'Каждый дм — 10 см, три — тридцать.' },
};

export default function PK10_02(props) {
  const data = DATA;
