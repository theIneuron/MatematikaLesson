// PK10_04 — ПК10 (Blok 11) · O'lchov birliklari · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Massa — qaysi og\'ir', kind: 'compare', a: 5, b: 3, options: ['>', '<', '='], answer: '>',
  eyebrow: { uz: 'Nazorat · Massa', ru: 'Контроль · Масса' },
  setup: { uz: 'Bir qopda 5 kg, ikkinchisida 3 kg.', ru: 'В одном мешке 5 кг, в другом 3 кг.' },
  ask: { uz: 'Qaysi belgi to\'g\'ri?', ru: 'Какой знак верный?' },
  correct: { uz: 'Barakalla! Besh kilogramm uch kilogrammdan og\'ir.', ru: 'Молодец! Пять килограммов тяжелее трёх.' },
  hint: { uz: 'Og\'irroq — kattaroq son.', ru: 'Тяжелее — большее число.' },
};

export default function PK10_04(props) {
  const data = DATA;
