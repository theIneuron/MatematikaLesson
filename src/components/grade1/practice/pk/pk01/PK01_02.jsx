// PK01_02 — ПК1 (Blok 1) · Sanoq 6–10 · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Sanoq 6–10', kind: 'count', n: 8, emoji: '🐤', options: [7, 8, 9], answer: 8,
  eyebrow: { uz: 'Nazorat · Sanoq', ru: 'Контроль · Счёт' },
  setup: { uz: 'Hovlida jo\'jalar yuribdi.', ru: 'Во дворе гуляют цыплята.' },
  ask: { uz: 'Nechta jo\'ja bor?', ru: 'Сколько цыплят?' },
  correct: { uz: 'Barakalla! Sakkizta jo\'ja.', ru: 'Молодец! Восемь цыплят.' },
  hint: { uz: 'Birma-bir sanang: bir, ikki, uch...', ru: 'Считай по одному: раз, два, три...' },
};

export default function PK01_02(props) {
  const data = DATA;
