// PK01_01 — ПК1 (Blok 1) · Sanoq 1–5 · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Sanoq 1–5', kind: 'count', n: 3, emoji: '🍎', options: [2, 3, 4], answer: 3,
  eyebrow: { uz: 'Nazorat · Sanoq', ru: 'Контроль · Счёт' },
  setup: { uz: 'Stolda olmalar turibdi.', ru: 'На столе лежат яблоки.' },
  ask: { uz: 'Nechta olma bor?', ru: 'Сколько яблок?' },
  correct: { uz: 'Barakalla! Uchta olma.', ru: 'Молодец! Три яблока.' },
  hint: { uz: 'Har olmani bir marta sanang.', ru: 'Посчитай каждое яблоко один раз.' },
};

export default function PK01_01(props) {
  const data = DATA;
