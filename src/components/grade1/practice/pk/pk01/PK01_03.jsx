// PK01_03 — ПК1 (Blok 1) · Nol soni · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Nol soni', kind: 'count', n: 0, emptyEmoji: '🧺', options: [0, 1, 2], answer: 0,
  eyebrow: { uz: 'Nazorat · Nol', ru: 'Контроль · Ноль' },
  setup: { uz: 'Savat bo\'sh — hech narsa yo\'q.', ru: 'Корзина пустая — ничего нет.' },
  ask: { uz: 'Savatda nechta meva bor?', ru: 'Сколько фруктов в корзине?' },
  correct: { uz: 'Barakalla! Hech narsa yo\'q — nol.', ru: 'Молодец! Ничего нет — ноль.' },
  hint: { uz: 'Hech narsa bo\'lmasa — bu nol.', ru: 'Если ничего нет — это ноль.' },
};

export default function PK01_03(props) {
  const data = DATA;
