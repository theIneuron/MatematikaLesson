// PK01_06 — ПК1 (Blok 1) · Sanoq 6–10 · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Sanoq 6–10', kind: 'count', n: 6, emoji: '⭐', options: [5, 6, 7], answer: 6,
  eyebrow: { uz: 'Nazorat · Sanoq', ru: 'Контроль · Счёт' },
  setup: { uz: 'Osmonda yulduzlar porlaydi.', ru: 'На небе сияют звёзды.' },
  ask: { uz: 'Nechta yulduz bor?', ru: 'Сколько звёзд?' },
  correct: { uz: 'Barakalla! Oltita yulduz.', ru: 'Молодец! Шесть звёзд.' },
  hint: { uz: 'Har yulduzni bir marta sanang.', ru: 'Посчитай каждую звезду один раз.' },
};

export default function PK01_06(props) {
  const data = DATA;
