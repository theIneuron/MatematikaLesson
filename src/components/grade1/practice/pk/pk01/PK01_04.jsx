// PK01_04 — ПК1 (Blok 1) · Son tarkibi 2–5 · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Son tarkibi 2–5', kind: 'compose', total: 5, left: 2, emoji: '🔵', options: [2, 3, 4], answer: 3,
  eyebrow: { uz: 'Nazorat · Son tarkibi', ru: 'Контроль · Состав числа' },
  setup: { uz: 'Beshta doiradan 2 tasi ko\'k.', ru: 'Из пяти кружков 2 синих.' },
  ask: { uz: 'Nechtasi qoladi?', ru: 'Сколько остаётся?' },
  correct: { uz: 'Barakalla! Ikki va uch — besh.', ru: 'Молодец! Два и три — пять.' },
  hint: { uz: 'Beshta bo\'lishi uchun ikkiga nechta qo\'shiladi?', ru: 'Сколько добавить к двум, чтобы вышло пять?' },
};

export default function PK01_04(props) {
  const data = DATA;
