// PK01_05 — ПК1 (Blok 1) · Taqqoslash · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Taqqoslash', kind: 'compare', a: 9, b: 6, options: ['>', '<', '='], answer: '>',
  ...
  correct: { uz: 'Barakalla! To\'qqiz oltidan katta.', ru: 'Молодец! Девять больше шести.' },
  hint: { uz: 'Belgining ochiq tomoni kattaga qaraydi.', ru: 'Открытая сторона знака смотрит на большее.' },
};

export default function PK01_05(props) {
  const data = DATA;
