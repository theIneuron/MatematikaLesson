// PK07_01 — ПК7 (Blok 5) · Matnli masalalar · yig'indiga masala.
...
const DATA = {
  topic: 'Yig\'indiga masala', kind: 'add', noDots: true, a: 23, b: 14, options: [36, 37, 38], answer: 37,
  eyebrow: { uz: 'Nazorat · Masala', ru: 'Контроль · Задача' },
  setup: { uz: 'Bog\'da 23 ta olma bor edi, yana 14 tasi terildi.', ru: 'В саду было 23 яблока, собрали ещё 14.' },
  ask: { uz: 'Hammasi bo\'lib nechta olma?', ru: 'Сколько яблок всего?' },
  correct: { uz: 'Barakalla! Birlashtirsak — qo\'shamiz.', ru: 'Молодец! Объединяем — значит складываем.' },
  hint: { uz: 'Birlashtirilsa qo\'shiladi: 23 va 14.', ru: 'Если объединяют — складывают: 23 и 14.' },
};

export default function PK07_01(props) {
  const data = DATA;
