// PK07_03 — ПК7 (Blok 5) · Matnli masalalar · qoldiqqa masala.
...
const DATA = {
  topic: 'Qoldiqqa masala', kind: 'sub', noDots: true, a: 18, b: 6, options: [11, 12, 13], answer: 12,
  eyebrow: { uz: 'Nazorat · Masala', ru: 'Контроль · Задача' },
  setup: { uz: 'Savatda 18 ta olma bor edi, 6 tasini yedik.', ru: 'В корзине было 18 яблок, 6 съели.' },
  ask: { uz: 'Nechta olma qoldi?', ru: 'Сколько яблок осталось?' },
  correct: { uz: 'Barakalla! Yeyilgani ketadi — ayiramiz.', ru: 'Молодец! Съеденное убывает — вычитаем.' },
  hint: { uz: 'Qoldiq — ayirish: 18 dan 6.', ru: 'Остаток — вычитание: из 18 шесть.' },
};

export default function PK07_03(props) {
  const data = DATA;
