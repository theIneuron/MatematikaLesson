// PK07_02 — ПК7 (Blok 5) · Matnli masalalar · yig'indiga masala.
...
const DATA = {
  topic: 'Yig\'indiga masala', kind: 'add', noDots: true, a: 30, b: 20, options: [40, 50, 60], answer: 50,
  eyebrow: { uz: 'Nazorat · Masala', ru: 'Контроль · Задача' },
  setup: { uz: 'Rafda 30 ta kitob bor edi, yana 20 tasi qo\'yildi.', ru: 'На полке было 30 книг, поставили ещё 20.' },
  ask: { uz: 'Hammasi bo\'lib nechta kitob?', ru: 'Сколько книг всего?' },
  correct: { uz: 'Barakalla! O\'ttiz va yigirma — ellik.', ru: 'Молодец! Тридцать и двадцать — пятьдесят.' },
  hint: { uz: 'Ikkalasini qo\'shing: 30 va 20.', ru: 'Сложи оба: 30 и 20.' },
};

export default function PK07_02(props) {
  const data = DATA;
