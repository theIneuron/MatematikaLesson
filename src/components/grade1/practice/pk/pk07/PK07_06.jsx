// PK07_06 — ПК7 (Blok 5) · Matnli masalalar · noma'lum qo'shiluvchi.
...
const DATA = {
  topic: 'Noma\'lum qo\'shiluvchi', kind: 'fill', a: 12, c: 20, options: [7, 8, 9], answer: 8,
  eyebrow: { uz: 'Nazorat · Masala', ru: 'Контроль · Задача' },
  setup: { uz: 'Bekatda 12 ta odam bor edi, yana bir nechtasi keldi, jami 20 ta bo\'ldi.', ru: 'На остановке было 12 человек, подошли ещё, стало 20.' },
  ask: { uz: 'Nechta odam keldi?', ru: 'Сколько человек подошло?' },
  correct: { uz: 'Barakalla! O\'n ikki va sakkiz — yigirma.', ru: 'Молодец! Двенадцать и восемь — двадцать.' },
  hint: { uz: 'O\'n ikkidan yigirmagacha nechta yetishmaydi?', ru: 'Сколько не хватает от двенадцати до двадцати?' },
};

export default function PK07_06(props) {
  const data = DATA;
