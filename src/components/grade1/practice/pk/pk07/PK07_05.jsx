// PK07_05 — ПК7 (Blok 5) · Matnli masalalar · noma'lum qo'shiluvchi.
...
const DATA = {
  topic: 'Noma\'lum qo\'shiluvchi', kind: 'fill', a: 5, c: 8, options: [2, 3, 4], answer: 3,
  eyebrow: { uz: 'Nazorat · Masala', ru: 'Контроль · Задача' },
  setup: { uz: 'Zuhrada 5 ta qalam bor edi, yana bir nechtasi qo\'shildi, jami 8 ta bo\'ldi.', ru: 'У Зухры было 5 карандашей, добавили ещё несколько, стало 8.' },
  ask: { uz: 'Nechta qalam qo\'shildi?', ru: 'Сколько карандашей добавили?' },
  correct: { uz: 'Barakalla! Besh va uch — sakkiz.', ru: 'Молодец! Пять и три — восемь.' },
  hint: { uz: 'Beshdan sakkizgacha nechta yetishmaydi?', ru: 'Сколько не хватает от пяти до восьми?' },
};

export default function PK07_05(props) {
  const data = DATA;
