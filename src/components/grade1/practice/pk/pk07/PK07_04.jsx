// PK07_04 — ПК7 (Blok 5) · Matnli masalalar · qoldiqqa masala.
...
const DATA = {
  topic: 'Qoldiqqa masala', kind: 'sub', noDots: true, a: 24, b: 10, options: [13, 14, 15], answer: 14,
  eyebrow: { uz: 'Nazorat · Masala', ru: 'Контроль · Задача' },
  setup: { uz: 'Do\'konda 24 ta non bor edi, 10 tasi sotildi.', ru: 'В магазине было 24 хлеба, 10 продали.' },
  ask: { uz: 'Nechta non qoldi?', ru: 'Сколько хлеба осталось?' },
  correct: { uz: 'Barakalla! Yigirma to\'rtdan o\'n — o\'n to\'rt.', ru: 'Молодец! Из двадцати четырёх десять — четырнадцать.' },
  hint: { uz: 'Sotilgani kamayadi: 24 dan 10.', ru: 'Проданное убывает: из 24 десять.' },
};

export default function PK07_04(props) {
  const data = DATA;
