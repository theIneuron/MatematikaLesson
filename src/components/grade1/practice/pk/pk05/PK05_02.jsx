// PK05_02 — ПК5 (Blok 8) · Sonlar 21–100 · Razryad — birlik · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Razryad — birlik', kind: 'place', num: 63, options: [3, 6, 9], answer: 3,
  ...
  ask: { uz: '63 da nechta birlik bor?', ru: 'Сколько единиц в числе 63?' },
  correct: { uz: 'Barakalla! 63 da 3 birlik bor.', ru: 'Молодец! В 63 три единицы.' },
  hint: { uz: 'O\'ngdagi raqam — birliklar soni.', ru: 'Правая цифра — число единиц.' },
};

export default function PK05_02(props) {
  const data = DATA;
