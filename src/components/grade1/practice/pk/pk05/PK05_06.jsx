// PK05_06 — ПК5 (Blok 8) · Sonlar 21–100 · 5 lab sanoq · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '5 lab sanoq', kind: 'skip', seq: [10, 15, null, 25], options: [18, 20, 22], answer: 20,
  eyebrow: { uz: 'Nazorat · Sanoq', ru: 'Контроль · Счёт' },
  setup: { uz: 'Beshlab sanaymiz.', ru: 'Считаем пятёрками.' },
  ask: { uz: 'Bo\'sh joyga qaysi son yoziladi?', ru: 'Какое число впишем в пропуск?' },
  correct: { uz: 'Barakalla! 10, 15, 20, 25.', ru: 'Молодец! 10, 15, 20, 25.' },
  hint: { uz: 'Har safar beshtaga oshiring.', ru: 'Каждый раз прибавляй пять.' },
};

export default function PK05_06(props) {
  const data = DATA;
