// PK05_03 — ПК5 (Blok 8) · Sonlar 21–100 · Ikki xonali taqqoslash · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Ikki xonali taqqoslash', kind: 'compare', a: 45, b: 52, options: ['>', '<', '='], answer: '<',
  ...
  correct: { uz: 'Barakalla! Qirq besh ellik ikkidan kichik.', ru: 'Молодец! Сорок пять меньше пятидесяти двух.' },
  hint: { uz: 'Kim ko\'proq o\'nlikka ega — o\'sha katta.', ru: 'У кого больше десятков — то и больше.' },
};

export default function PK05_03(props) {
  const data = DATA;
