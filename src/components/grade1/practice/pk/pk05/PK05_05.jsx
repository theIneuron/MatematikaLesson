// PK05_05 — ПК5 (Blok 8) · Sonlar 21–100 · 10 lab sanoq · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '10 lab sanoq', kind: 'skip', seq: [20, 30, null, 50], options: [35, 40, 45], answer: 40,
  eyebrow: { uz: 'Nazorat · Sanoq', ru: 'Контроль · Счёт' },
  setup: { uz: 'O\'nlab sanaymiz.', ru: 'Считаем десятками.' },
  ask: { uz: 'Bo\'sh joyga qaysi son yoziladi?', ru: 'Какое число впишем в пропуск?' },
  correct: { uz: 'Barakalla! 20, 30, 40, 50.', ru: 'Молодец! 20, 30, 40, 50.' },
  hint: { uz: 'Har safar o\'ntaga oshiring.', ru: 'Каждый раз прибавляй десять.' },
};

export default function PK05_05(props) {
  const data = DATA;
