// PK05_01 — ПК5 (Blok 8) · Sonlar 21–100 · Razryad — o'nlik · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Razryad — o\'nlik', kind: 'place', num: 47, options: [4, 5, 7], answer: 4,
  eyebrow: { uz: 'Nazorat · Razryad', ru: 'Контроль · Разряд' },
  setup: { uz: 'Ikki xonali son: o\'nliklar va birliklar.', ru: 'Двузначное число: десятки и единицы.' },
  ask: { uz: '47 da nechta o\'nlik bor?', ru: 'Сколько десятков в числе 47?' },
  correct: { uz: 'Barakalla! 47 da 4 o\'nlik bor.', ru: 'Молодец! В 47 четыре десятка.' },
  hint: { uz: 'Chapdagi raqam — o\'nliklar soni.', ru: 'Левая цифра — число десятков.' },
};

export default function PK05_01(props) {
  const data = DATA;
