// PK05_04 — ПК5 (Blok 8) · Sonlar 21–100 · Ikki xonali taqqoslash · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Ikki xonali taqqoslash', kind: 'compare', a: 71, b: 68, options: ['>', '<', '='], answer: '>',
  eyebrow: { uz: 'Nazorat · Taqqoslash', ru: 'Контроль · Сравнение' },
  setup: { uz: 'Avval o\'nliklarni taqqoslang.', ru: 'Сначала сравни десятки.' },
  ask: { uz: 'Qaysi belgi to\'g\'ri?', ru: 'Какой знак верный?' },
  correct: { uz: 'Barakalla! Yetmish bir oltmish sakkizdan katta.', ru: 'Молодец! Семьдесят один больше шестидесяти восьми.' },
  hint: { uz: 'Yetti o\'nlik olti o\'nlikdan katta.', ru: 'Семь десятков больше шести десятков.' },
};

export default function PK05_04(props) {
  const data = DATA;
