// PK04_05 — ПК4 (Blok 4) · O'nlikdan o'tish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'O\'tib qo\'shish', kind: 'add', noDots: true, a: 7, b: 8, options: [14, 15, 16], answer: 15,
  ...
  ask: { uz: 'Yetti qo\'shish sakkiz nechaga teng?', ru: 'Сколько будет семь плюс восемь?' },
  correct: { uz: 'Barakalla! Yetti va sakkiz — o\'n besh.', ru: 'Молодец! Семь и восемь — пятнадцать.' },
  hint: { uz: 'Yetti va uch — o\'n, yana besh — o\'n besh.', ru: 'Семь и три — десять, ещё пять — пятнадцать.' },
};

export default function PK04_05(props) {
  const data = DATA;
