// PK04_06 — ПК4 (Blok 4) · O'nlikdan o'tish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'O\'tib ayirish', kind: 'sub', noDots: true, a: 13, b: 5, options: [7, 8, 9], answer: 8,
  eyebrow: { uz: 'Nazorat · O\'tib ayirish', ru: 'Контроль · Вычитание с переходом' },
  setup: { uz: 'Avval o\'ngacha, keyin qolganini ayiring.', ru: 'Сначала до десяти, потом вычти остаток.' },
  ask: { uz: 'O\'n uchdan besh ayirsak necha qoladi?', ru: 'Сколько будет тринадцать минус пять?' },
  correct: { uz: 'Barakalla! O\'n uchdan besh — sakkiz.', ru: 'Молодец! Тринадцать минус пять — восемь.' },
  hint: { uz: 'O\'n uchdan uch — o\'n, yana ikki — sakkiz.', ru: 'Тринадцать минус три — десять, ещё два — восемь.' },
};

export default function PK04_06(props) {
  const data = DATA;
