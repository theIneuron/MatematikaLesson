// PK04_04 — ПК4 (Blok 4) · O'nlikdan o'tish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'O\'tib qo\'shish', kind: 'add', noDots: true, a: 9, b: 6, options: [14, 15, 16], answer: 15,
  eyebrow: { uz: 'Nazorat · O\'tib qo\'shish', ru: 'Контроль · Сложение с переходом' },
  setup: { uz: 'O\'nni to\'ldirib qo\'shing.', ru: 'Сложи через десяток.' },
  ask: { uz: 'To\'qqiz qo\'shish olti nechaga teng?', ru: 'Сколько будет девять плюс шесть?' },
  correct: { uz: 'Barakalla! To\'qqiz va olti — o\'n besh.', ru: 'Молодец! Девять и шесть — пятнадцать.' },
  hint: { uz: 'To\'qqiz va bir — o\'n, yana besh — o\'n besh.', ru: 'Девять и один — десять, ещё пять — пятнадцать.' },
};

export default function PK04_04(props) {
  const data = DATA;
