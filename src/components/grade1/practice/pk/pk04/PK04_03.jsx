// PK04_03 — ПК4 (Blok 4) · O'nlikdan o'tish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'O\'tib qo\'shish', kind: 'add', noDots: true, a: 8, b: 5, options: [12, 13, 14], answer: 13,
  eyebrow: { uz: 'Nazorat · O\'tib qo\'shish', ru: 'Контроль · Сложение с переходом' },
  setup: { uz: 'Avval o\'nni to\'ldiring, keyin qolganini qo\'shing.', ru: 'Сначала дополни до десяти, потом прибавь остаток.' },
  ask: { uz: 'Sakkiz qo\'shish besh nechaga teng?', ru: 'Сколько будет восемь плюс пять?' },
  correct: { uz: 'Barakalla! Sakkiz va besh — o\'n uch.', ru: 'Молодец! Восемь и пять — тринадцать.' },
  hint: { uz: 'Sakkiz va ikki — o\'n, yana uch — o\'n uch.', ru: 'Восемь и два — десять, ещё три — тринадцать.' },
};

export default function PK04_03(props) {
  const data = DATA;
