// PK04_01 — ПК4 (Blok 4) · O'nlikdan o'tish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '10 ga to\'ldirish', kind: 'fill', a: 8, c: 10, options: [1, 2, 3], answer: 2,
  eyebrow: { uz: 'Nazorat · 10 ga to\'ldirish', ru: 'Контроль · Дополнение до 10' },
  setup: { uz: 'O\'nni to\'ldiramiz.', ru: 'Дополняем до десяти.' },
  ask: { uz: 'Sakkizga nechtani qo\'shsak o\'n bo\'ladi?', ru: 'Сколько прибавить к восьми до десяти?' },
  correct: { uz: 'Barakalla! Sakkiz va ikki — o\'n.', ru: 'Молодец! Восемь и два — десять.' },
  hint: { uz: 'Sakkizdan o\'ngacha sanang.', ru: 'Посчитай от восьми до десяти.' },
};

export default function PK04_01(props) {
  const data = DATA;
