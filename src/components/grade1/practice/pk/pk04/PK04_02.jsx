// PK04_02 — ПК4 (Blok 4) · O'nlikdan o'tish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '10 ga to\'ldirish', kind: 'fill', a: 5, c: 10, options: [4, 5, 6], answer: 5,
  eyebrow: { uz: 'Nazorat · 10 ga to\'ldirish', ru: 'Контроль · Дополнение до 10' },
  setup: { uz: 'O\'nni to\'ldiramiz.', ru: 'Дополняем до десяти.' },
  ask: { uz: 'Beshga nechtani qo\'shsak o\'n bo\'ladi?', ru: 'Сколько прибавить к пяти до десяти?' },
  correct: { uz: 'Barakalla! Besh va besh — o\'n.', ru: 'Молодец! Пять и пять — десять.' },
  hint: { uz: 'Beshdan o\'ngacha sanang.', ru: 'Посчитай от пяти до десяти.' },
};

export default function PK04_02(props) {
  const data = DATA;
