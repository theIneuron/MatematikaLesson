// PK04_07 — ПК4 (Blok 4) · O'nlikdan o'tish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'O\'tib ayirish', kind: 'sub', noDots: true, a: 16, b: 7, options: [8, 9, 10], answer: 9,
  eyebrow: { uz: 'Nazorat · O\'tib ayirish', ru: 'Контроль · Вычитание с переходом' },
  setup: { uz: 'O\'ndan o\'tib ayiring.', ru: 'Вычти через десяток.' },
  ask: { uz: 'O\'n oltidan yetti ayirsak necha qoladi?', ru: 'Сколько будет шестнадцать минус семь?' },
  correct: { uz: 'Barakalla! O\'n oltidan yetti — to\'qqiz.', ru: 'Молодец! Шестнадцать минус семь — девять.' },
  hint: { uz: 'O\'n oltidan olti — o\'n, yana bir — to\'qqiz.', ru: 'Шестнадцать минус шесть — десять, ещё один — девять.' },
};

export default function PK04_07(props) {
  const data = DATA;
