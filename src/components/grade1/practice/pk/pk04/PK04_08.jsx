// PK04_08 — ПК4 (Blok 4) · O'nlikdan o'tish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'O\'tib ayirish', kind: 'sub', noDots: true, a: 14, b: 6, options: [7, 8, 9], answer: 8,
  eyebrow: { uz: 'Nazorat · O\'tib ayirish', ru: 'Контроль · Вычитание с переходом' },
  setup: { uz: 'O\'ndan o\'tib ayiring.', ru: 'Вычти через десяток.' },
  ask: { uz: 'O\'n to\'rtdan olti ayirsak necha qoladi?', ru: 'Сколько будет четырнадцать минус шесть?' },
  correct: { uz: 'Barakalla! O\'n to\'rtdan olti — sakkiz.', ru: 'Молодец! Четырнадцать минус шесть — восемь.' },
  hint: { uz: 'O\'n to\'rtdan to\'rt — o\'n, yana ikki — sakkiz.', ru: 'Четырнадцать минус четыре — десять, ещё два — восемь.' },
};

export default function PK04_08(props) {
  const data = DATA;
