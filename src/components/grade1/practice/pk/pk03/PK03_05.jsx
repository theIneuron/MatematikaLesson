// PK03_05 — ПК3 (Blok 3) · Taqqoslash 20 gacha · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Taqqoslash 20 gacha', kind: 'compare', a: 12, b: 20, options: ['>', '<', '='], answer: '<',
  ...
  correct: { uz: 'Barakalla! O\'n ikki yigirmadan kichik.', ru: 'Молодец! Двенадцать меньше двадцати.' },
  hint: { uz: 'Belgining uchi kichik songa qaraydi.', ru: 'Остриё знака смотрит на меньшее число.' },
};

export default function PK03_05(props) {
  const data = DATA;
