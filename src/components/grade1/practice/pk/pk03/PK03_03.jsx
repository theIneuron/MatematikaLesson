// PK03_03 — ПК3 (Blok 3) · 13 hosil qilish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '13 hosil qilish', kind: 'fill', a: 10, c: 13, options: [2, 3, 4], answer: 3,
  eyebrow: { uz: 'Nazorat · Sonlar 11–15', ru: 'Контроль · Числа 11–15' },
  setup: { uz: 'O\'n uchni hosil qilamiz.', ru: 'Составляем тринадцать.' },
  ask: { uz: 'O\'nga nechtani qo\'shsak o\'n uch bo\'ladi?', ru: 'Сколько прибавить к десяти, чтобы вышло тринадцать?' },
  correct: { uz: 'Barakalla! O\'n va uch — o\'n uch.', ru: 'Молодец! Десять и три — тринадцать.' },
  hint: { uz: 'O\'n uchda nechta birlik bor?', ru: 'Сколько единиц в тринадцати?' },
};

export default function PK03_03(props) {
  const data = DATA;
