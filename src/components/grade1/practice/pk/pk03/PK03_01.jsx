// PK03_01 — ПК3 (Blok 3) · O'nlik va birlik · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'O\'nlik va birlik', kind: 'add', noDots: true, a: 10, b: 4, options: [13, 14, 15], answer: 14,
  eyebrow: { uz: 'Nazorat · O\'nlik', ru: 'Контроль · Десяток' },
  setup: { uz: 'Bir o\'nlik va yana 4 ta birlik bor.', ru: 'Один десяток и ещё 4 единицы.' },
  ask: { uz: 'Qaysi son hosil bo\'ladi?', ru: 'Какое число получится?' },
  correct: { uz: 'Barakalla! O\'n va to\'rt — o\'n to\'rt.', ru: 'Молодец! Десять и четыре — четырнадцать.' },
  hint: { uz: 'O\'nga birliklarni qo\'shing: 10 va 4.', ru: 'Прибавь к десяти единицы: 10 и 4.' },
};

export default function PK03_01(props) {
  const data = DATA;
