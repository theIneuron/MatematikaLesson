// PK03_04 — ПК3 (Blok 3) · Taqqoslash 20 gacha · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Taqqoslash 20 gacha', kind: 'compare', a: 17, b: 15, options: ['>', '<', '='], answer: '>',
  eyebrow: { uz: 'Nazorat · Taqqoslash', ru: 'Контроль · Сравнение' },
  setup: { uz: 'Ikki sonni taqqoslang.', ru: 'Сравни два числа.' },
  ask: { uz: 'Qaysi belgi to\'g\'ri?', ru: 'Какой знак верный?' },
  correct: { uz: 'Barakalla! O\'n yetti o\'n beshdan katta.', ru: 'Молодец! Семнадцать больше пятнадцати.' },
  hint: { uz: 'Kattaroq songa belgining ochiq tomoni qaraydi.', ru: 'Открытая сторона знака смотрит на большее число.' },
};

export default function PK03_04(props) {
  const data = DATA;
