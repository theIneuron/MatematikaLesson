// PK03_02 — ПК3 (Blok 3) · Sonlar 16–20 · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Sonlar 16–20', kind: 'add', noDots: true, a: 10, b: 8, options: [16, 18, 20], answer: 18,
  eyebrow: { uz: 'Nazorat · 16–20', ru: 'Контроль · 16–20' },
  setup: { uz: 'O\'nta va yana sakkizta.', ru: 'Десять и ещё восемь.' },
  ask: { uz: 'Nechta bo\'ldi?', ru: 'Сколько получилось?' },
  correct: { uz: 'Barakalla! O\'n va sakkiz — o\'n sakkiz.', ru: 'Молодец! Десять и восемь — восемнадцать.' },
  hint: { uz: 'O\'nga sakkizni qo\'shing.', ru: 'Прибавь к десяти восемь.' },
};

export default function PK03_02(props) {
  const data = DATA;
