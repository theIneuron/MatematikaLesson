// PK03_06 — ПК3 (Blok 3) · Tenglik / tengsizlik · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Tenglik / tengsizlik', kind: 'truefalse', expr: '10 + 6 = 15', options: ['yes', 'no'], answer: 'no',
  optLabels: { yes: { uz: 'To\'g\'ri', ru: 'Верно' }, no: { uz: 'Noto\'g\'ri', ru: 'Неверно' } },
  eyebrow: { uz: 'Nazorat · Tenglik', ru: 'Контроль · Равенство' },
  setup: { uz: 'Yozuvni tekshiring.', ru: 'Проверь запись.' },
  ask: { uz: 'Bu yozuv to\'g\'rimi?', ru: 'Верна ли эта запись?' },
  correct: { uz: 'Barakalla! O\'n va olti — o\'n olti, o\'n besh emas.', ru: 'Молодец! Десять и шесть — шестнадцать, а не пятнадцать.' },
  hint: { uz: 'O\'nga oltini qo\'shing: nechta chiqadi?', ru: 'Прибавь к десяти шесть: сколько выйдет?' },
};

export default function PK03_06(props) {
  const data = DATA;
