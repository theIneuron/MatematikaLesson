// PK08_01 — ПК8 (Blok 10) · Tarkibli masalalar · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Ikki qadamli masala', kind: 'steps', start: 10, steps: [{ op: '−', n: 4 }, { op: '+', n: 2 }], options: [7, 8, 9], answer: 8,
  eyebrow: { uz: 'Nazorat · Ikki qadam', ru: 'Контроль · Два шага' },
  setup: { uz: 'Simda 10 ta qush bor edi, 4 tasi uchdi, 2 tasi qaytib keldi.', ru: 'На проводе было 10 птиц, 4 улетели, 2 вернулись.' },
  ask: { uz: 'Nechta qush bo\'ldi?', ru: 'Сколько птиц стало?' },
  correct: { uz: 'Barakalla! Avval ayirdik, keyin qo\'shdik.', ru: 'Молодец! Сначала вычли, потом сложили.' },
  hint: { uz: 'Ketma-ket: 10 dan 4 — olti, so\'ng 2 ni qo\'shing.', ru: 'По порядку: из 10 четыре — шесть, потом прибавь 2.' },
};

export default function PK08_04(props) {
  const data = DATA;
