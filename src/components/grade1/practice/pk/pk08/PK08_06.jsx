...
const DATA = {
  topic: 'Ikki qadamli masala', kind: 'steps', start: 12, steps: [{ op: '+', n: 3 }, { op: '−', n: 5 }], options: [9, 10, 11], answer: 10,
  eyebrow: { uz: 'Nazorat · Ikki qadam', ru: 'Контроль · Два шага' },
  setup: { uz: 'Rafda 12 ta kitob bor edi, 3 tasi qo\'yildi, 5 tasi olindi.', ru: 'На полке было 12 книг, поставили 3, взяли 5.' },
  ask: { uz: 'Nechta kitob qoldi?', ru: 'Сколько книг осталось?' },
  correct: { uz: 'Barakalla! Avval qo\'shdik, keyin ayirdik.', ru: 'Молодец! Сначала сложили, потом вычли.' },
  hint: { uz: 'Ketma-ket: 12 va 3 — o\'n besh, so\'ng 5 ni oling.', ru: 'По порядку: 12 и 3 — пятнадцать, потом убери 5.' },
};

export default function PK08_06(props) {
  const data = DATA;
