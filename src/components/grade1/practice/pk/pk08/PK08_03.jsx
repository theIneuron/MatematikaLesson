...
const DATA = {
  topic: 'Ikki qadamli masala', kind: 'steps', start: 5, steps: [{ op: '+', n: 3 }, { op: '−', n: 2 }], options: [5, 6, 7], answer: 6,
  eyebrow: { uz: 'Nazorat · Ikki qadam', ru: 'Контроль · Два шага' },
  setup: { uz: 'Hovuzda 5 ta baliq bor edi, 3 tasi qo\'shildi, 2 tasi suzib ketdi.', ru: 'В пруду было 5 рыбок, 3 добавили, 2 уплыли.' },
  ask: { uz: 'Nechta baliq qoldi?', ru: 'Сколько рыбок осталось?' },
  correct: { uz: 'Barakalla! Avval qo\'shdik, keyin ayirdik.', ru: 'Молодец! Сначала сложили, потом вычли.' },
  hint: { uz: 'Ketma-ket: 5 va 3 — sakkiz, so\'ng 2 ni oling.', ru: 'По порядку: 5 и 3 — восемь, потом убери 2.' },
};

export default function PK08_03(props) {
  const data = DATA;
