...
const DATA = {
  topic: 'Ikki qadamli masala', kind: 'steps', start: 6, steps: [{ op: '+', n: 2 }, { op: '+', n: 1 }], options: [8, 9, 10], answer: 9,
  eyebrow: { uz: 'Nazorat · Ikki qadam', ru: 'Контроль · Два шага' },
  setup: { uz: 'To\'xtash joyida 6 ta mashina bor edi, 2 tasi keldi, yana 1 tasi keldi.', ru: 'На стоянке было 6 машин, приехали 2, потом ещё 1.' },
  ask: { uz: 'Nechta mashina bo\'ldi?', ru: 'Сколько машин стало?' },
  correct: { uz: 'Barakalla! Ikki marta qo\'shdik.', ru: 'Молодец! Дважды прибавили.' },
  hint: { uz: 'Hammasini qo\'shing: 6, 2 va 1.', ru: 'Сложи всё: 6, 2 и 1.' },
};

export default function PK08_05(props) {
  const data = DATA;
