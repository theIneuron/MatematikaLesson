...
const DATA = {
  topic: 'Tarkibli: jami', kind: 'add', noDots: true, a: 14, b: 13, options: [26, 27, 28], answer: 27,
  eyebrow: { uz: 'Nazorat · Tarkibli masala', ru: 'Контроль · Составная задача' },
  setup: { uz: 'Birinchi savatda 14 ta, ikkinchisida 13 ta olma bor.', ru: 'В первой корзине 14 яблок, во второй 13.' },
  ask: { uz: 'Jami nechta olma?', ru: 'Сколько яблок всего?' },
  correct: { uz: 'Barakalla! Ikki savatni birga qo\'shdik.', ru: 'Молодец! Сложили обе корзины.' },
  hint: { uz: 'Jami — ikkalasini qo\'shing.', ru: 'Всего — сложи обе.' },
};

export default function PK08_01(props) {
  const data = DATA;
