...
const DATA = {
  topic: 'Tarkibli: qoldi', kind: 'sub', noDots: true, a: 40, b: 15, options: [24, 25, 26], answer: 25,
  eyebrow: { uz: 'Nazorat · Tarkibli masala', ru: 'Контроль · Составная задача' },
  setup: { uz: 'Bayramda 40 ta sharcha bor edi, 15 tasi yorildi.', ru: 'На празднике было 40 шариков, 15 лопнули.' },
  ask: { uz: 'Nechta sharcha qoldi?', ru: 'Сколько шариков осталось?' },
  correct: { uz: 'Barakalla! Qirqdan o\'n besh — yigirma besh.', ru: 'Молодец! Из сорока пятнадцать — двадцать пять.' },
  hint: { uz: 'Qoldi — ayirish: 40 dan 15.', ru: 'Осталось — вычитание: из 40 пятнадцать.' },
};

export default function PK08_02(props) {
  const data = DATA;
