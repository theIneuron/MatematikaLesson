// PK09_05 — ПК9 (Blok 6) · Geometriya · Kvadratni tanish.
...
const DATA = {
  topic: 'Kvadrat', kind: 'shape', mode: 'pick', options: ['circle', 'square', 'triangle'], answer: 'square',
  eyebrow: { uz: 'Nazorat · Shakllar', ru: 'Контроль · Фигуры' },
  setup: { uz: 'Shakllarni taning.', ru: 'Узнай фигуры.' },
  ask: { uz: 'Kvadratni tanlang.', ru: 'Выбери квадрат.' },
  correct: { uz: 'Barakalla! Bu kvadrat.', ru: 'Молодец! Это квадрат.' },
  hint: { uz: 'Kvadratning to\'rt teng tomoni bor.', ru: 'У квадрата четыре равные стороны.' },
};

export default function PK09_05(props) {
  const data = DATA;
