// PK09_06 — ПК9 (Blok 6) · Geometriya · Kvadrat burchaklarini sanash.
...
const DATA = {
  topic: 'Burchaklar soni', kind: 'shape', mode: 'count', shape: 'square', options: [3, 4, 5], answer: 4,
  eyebrow: { uz: 'Nazorat · Burchaklar', ru: 'Контроль · Углы' },
  setup: { uz: 'Shaklning burchaklarini sanang.', ru: 'Посчитай углы фигуры.' },
  ask: { uz: 'Kvadratning nechta burchagi bor?', ru: 'Сколько углов у квадрата?' },
  correct: { uz: 'Barakalla! Kvadratning to\'rt burchagi bor.', ru: 'Молодец! У квадрата четыре угла.' },
  hint: { uz: 'Har bir chetini sanang.', ru: 'Посчитай каждый уголок.' },
};

export default function PK09_06(props) {
  const data = DATA;
