// PK09_03 — ПК9 (Blok 6) · Geometriya · Doirani tanish.
...
const DATA = {
  topic: 'Doira', kind: 'shape', mode: 'pick', options: ['circle', 'square', 'triangle'], answer: 'circle',
  eyebrow: { uz: 'Nazorat · Shakllar', ru: 'Контроль · Фигуры' },
  setup: { uz: 'Shakllarni taning.', ru: 'Узнай фигуры.' },
  ask: { uz: 'Doirani tanlang.', ru: 'Выбери круг.' },
  correct: { uz: 'Barakalla! Bu doira.', ru: 'Молодец! Это круг.' },
  hint: { uz: 'Doiraning burchagi yo\'q.', ru: 'У круга нет углов.' },
};

export default function PK09_03(props) {
  const data = DATA;
