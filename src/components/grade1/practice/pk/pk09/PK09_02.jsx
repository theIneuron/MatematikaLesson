// PK09_02 — ПК9 (Blok 6) · Geometriya · Egri chiziqni tanish.
...
const DATA = {
  topic: 'Egri chiziq', kind: 'shape', mode: 'pick', options: ['straight', 'curved', 'broken'], answer: 'curved',
  eyebrow: { uz: 'Nazorat · Chiziqlar', ru: 'Контроль · Линии' },
  setup: { uz: 'Chiziq turlarini eslang.', ru: 'Вспомни виды линий.' },
  ask: { uz: 'Egri chiziqni tanlang.', ru: 'Выбери кривую линию.' },
  correct: { uz: 'Barakalla! Bu egri chiziq.', ru: 'Молодец! Это кривая линия.' },
  hint: { uz: 'Egri chiziq silliq bukiladi.', ru: 'Кривая линия плавно изгибается.' },
};

export default function PK09_02(props) {
  const data = DATA;
