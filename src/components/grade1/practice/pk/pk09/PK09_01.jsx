// PK09_01 — ПК9 (Blok 6) · Geometriya · To'g'ri chiziqni tanish.
...
const DATA = {
  topic: 'To\'g\'ri chiziq', kind: 'shape', mode: 'pick', options: ['straight', 'curved', 'broken'], answer: 'straight',
  eyebrow: { uz: 'Nazorat · Chiziqlar', ru: 'Контроль · Линии' },
  setup: { uz: 'Chiziq turlarini eslang.', ru: 'Вспомни виды линий.' },
  ask: { uz: 'To\'g\'ri chiziqni tanlang.', ru: 'Выбери прямую линию.' },
  correct: { uz: 'Barakalla! Bu to\'g\'ri chiziq.', ru: 'Молодец! Это прямая линия.' },
  hint: { uz: 'To\'g\'ri chiziq bukilmaydi.', ru: 'Прямая линия не изгибается.' },
};

export default function PK09_01(props) {
  const data = DATA;
