// PK09_04 — ПК9 (Blok 6) · Geometriya · Uchburchakni tanish.
...
const DATA = {
  topic: 'Uchburchak', kind: 'shape', mode: 'pick', options: ['circle', 'square', 'triangle'], answer: 'triangle',
  eyebrow: { uz: 'Nazorat · Shakllar', ru: 'Контроль · Фигуры' },
  setup: { uz: 'Shakllarni taning.', ru: 'Узнай фигуры.' },
  ask: { uz: 'Uchburchakni tanlang.', ru: 'Выбери треугольник.' },
  correct: { uz: 'Barakalla! Bu uchburchak.', ru: 'Молодец! Это треугольник.' },
  hint: { uz: 'Uchburchakning uch burchagi bor.', ru: 'У треугольника три угла.' },
};

export default function PK09_04(props) {
  const data = DATA;
