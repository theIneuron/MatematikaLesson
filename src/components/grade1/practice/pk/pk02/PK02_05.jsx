// PK02_05 — ПК2 (Blok 2) · O'rin almashtirish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'O\'rin almashtirish', kind: 'commute', a: 4, b: 5, options: [3, 4, 5], answer: 4,
  eyebrow: { uz: 'Nazorat · O\'rin almashtirish', ru: 'Контроль · Перестановка' },
  setup: { uz: 'Qo\'shiluvchilar o\'rin almashsa, yig\'indi o\'zgarmaydi.', ru: 'Если слагаемые поменять местами, сумма не меняется.' },
  ask: { uz: 'Bo\'sh katakka qaysi son yoziladi?', ru: 'Какое число впишем в пустое окошко?' },
  correct: { uz: 'Barakalla! To\'rt va besh — besh va to\'rt.', ru: 'Молодец! Четыре и пять — пять и четыре.' },
  hint: { uz: 'Chap tomondagi birinchi son bilan bir xil.', ru: 'Такое же, как первое число слева.' },
};

export default function PK02_05(props) {
  const data = DATA;
