// PK02_01 — ПК2 (Blok 2) · Qo'shishning ma'nosi · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Qo\'shishning ma\'nosi', kind: 'add', a: 3, b: 2, emoji: '🐟', options: [4, 5, 6], answer: 5,
  eyebrow: { uz: 'Nazorat · Qo\'shish', ru: 'Контроль · Сложение' },
  setup: { uz: 'Akvariumda 3 ta baliq bor edi, yana 2 tasi qo\'shildi.', ru: 'В аквариуме было 3 рыбки, добавили ещё 2.' },
  ask: { uz: 'Hammasi bo\'lib nechta baliq?', ru: 'Сколько рыбок всего?' },
  correct: { uz: 'Barakalla! Uch va ikki — besh.', ru: 'Молодец! Три и два — пять.' },
  hint: { uz: 'Ikkala guruhni birga sanang: 3 va yana 2.', ru: 'Посчитай обе группы вместе: 3 и ещё 2.' },
};

export default function PK02_01(props) {
  const data = DATA;
