// PK02_04 — ПК2 (Blok 2) · 10 ichida ayirish · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: '10 ichida ayirish', kind: 'sub', a: 9, b: 4, emoji: '⭐', options: [4, 5, 6], answer: 5,
  eyebrow: { uz: 'Nazorat · 10 ichida', ru: 'Контроль · В пределах 10' },
  setup: { uz: 'Osmonda 9 ta yulduz porladi, 4 tasi so\'ndi.', ru: 'На небе сияли 9 звёзд, 4 погасли.' },
  ask: { uz: 'Nechta yulduz qoldi?', ru: 'Сколько звёзд осталось?' },
  correct: { uz: 'Barakalla! To\'qqizdan to\'rt — besh qoldi.', ru: 'Молодец! От девяти четыре — осталось пять.' },
  hint: { uz: 'To\'qqizdan to\'rttasini ayiring.', ru: 'Вычти из девяти четыре.' },
};

export default function PK02_04(props) {
  const data = DATA;
