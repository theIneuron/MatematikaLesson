// PK02_02 — ПК2 (Blok 2) · Ayirishning ma'nosi · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Ayirishning ma\'nosi', kind: 'sub', a: 7, b: 3, emoji: '🎈', options: [3, 4, 5], answer: 4,
  eyebrow: { uz: 'Nazorat · Ayirish', ru: 'Контроль · Вычитание' },
  setup: { uz: 'Anvarda 7 ta sharcha bor edi, 3 tasi uchib ketdi.', ru: 'У Анвара было 7 шариков, 3 улетели.' },
  ask: { uz: 'Nechta sharcha qoldi?', ru: 'Сколько шариков осталось?' },
  correct: { uz: 'Barakalla! Yettidan uch ketdi — to\'rt qoldi.', ru: 'Молодец! От семи ушли три — осталось четыре.' },
  hint: { uz: 'Yettidan uchtasini oling: barmoqda sanang.', ru: 'Убери от семи три: посчитай на пальцах.' },
};

export default function PK02_02(props) {
  const data = DATA;
