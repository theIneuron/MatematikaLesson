// PK02_06 — ПК2 (Blok 2) · Tenglik / tengsizlik · YANGI SHARTLI (amaliyotda yo'q).
...
const DATA = {
  topic: 'Tenglik / tengsizlik', kind: 'truefalse', expr: '3 + 4 = 8', options: ['yes', 'no'], answer: 'no',
  ...
  correct: { uz: 'Barakalla! Uch va to\'rt — yetti, sakkiz emas.', ru: 'Молодец! Три и четыре — семь, а не восемь.' },
  hint: { uz: 'Uch va to\'rtni qo\'shing: nechta chiqadi?', ru: 'Сложи три и четыре: сколько получится?' },
};

export default function PK02_06(props) {
  const data = DATA;
