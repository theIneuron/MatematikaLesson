// Dars13 · Amaliyot 09 — P13 Sonli-bog' «Qalam do'koni» · 🔴 · tag: decompose_ten
// «Domik»: o'nta qalam ikki qutiga bo'linadi — chapda 4 ko'rinadi, o'ngda «?» yashirin.
// 10 = 4 + ? — yetishmagan qismni tanlaydi. G'alabada o'ng quti ochilib 6 qalam + «10 = 4 + 6».
import React, { useState, useEffect, useRef, useCallback } from 'react';

const WHOLE = 10, LEFT = 4, RIGHT = 6;
const DATA = { whole: WHOLE, left: LEFT, target: RIGHT, options: [5, 6, 7], ptype: 'P13', level: '🔴', tag: 'decompose_ten' };
...
const T = {
  uz: {
    eyebrow: "Qalam do'koni · Tarkib", title: "10 = 4 va yana nechta?",
    setup: "O'nta qalam ikki qutiga bo'lindi. Chapda to'rtta, o'ngdagi berkitilgan.",
    ask: "O'ngdagi qutida nechta qalam bor?",
    correct: "Barakalla! To'rt va yana olti — o'nta. 10 = 4 + 6.",
    hint: "O'ntadan to'rttasi chapda. O'ngga nechta qoladi?",
  },
  ru: {
    eyebrow: "Магазин карандашей · Состав", title: "10 — это 4 и ещё сколько?",
    setup: "Десять карандашей разложили в две коробки. Слева четыре, правая закрыта.",
    ask: "Сколько карандашей в правой коробке?",
    correct: "Молодец! Четыре и ещё шесть — десять. 10 = 4 + 6.",
    hint: "Из десяти четыре слева. Сколько остаётся справа?",
  },
};
  ...
  return (
    <div className="pq pq1309">
      <style>{`
        ...
        .pq1309 .pq-eye{font-size:12px;font-weight:800;letter-spacing:.04em;color:#c9822f;text-transform:uppercase;}
        ...
        .pq1309 .pq-scene{position:relative;width:340px;max-width:100%;margin:0 auto;border-radius:20px;background:linear-gradient(#f3e2c6 0%,#eed7b2 60%,#e7c99b 100%);border:2px solid #d9be92;padding:16px 12px 18px;overflow:hidden;}
        .pq1309 .pq-whole{position:relative;z-index:2;width:78px;margin:0 auto;display:flex;flex-direction:column;align-items:center;gap:2px;padding:6px 10px;border-radius:14px;background:#fff;border:2.5px solid #1a7f43;box-shadow:0 3px 8px rgba(0,0,0,.12);}
        .pq1309 .pq-whole b{font-size:30px;font-weight:900;color:#1a7f43;line-height:1;font-variant-numeric:tabular-nums;}
        .pq1309 .pq-whole span{font-size:11px;font-weight:800;color:#5a9440;text-transform:uppercase;letter-spacing:.04em;}
        .pq1309 .pq-links{position:relative;height:26px;}
        .pq1309 .pq-links svg{position:absolute;left:0;top:0;width:100%;height:100%;}
        .pq1309 .pq-parts{position:relative;z-index:2;display:flex;gap:14px;justify-content:center;}
        .pq1309 .pq-part{width:132px;min-height:96px;border-radius:14px;background:linear-gradient(#cd8f52,#b0703a);border:2.5px solid #86531f;box-shadow:0 5px 12px rgba(0,0,0,.2),inset 0 2px 0 rgba(255,255,255,.24);padding:8px 6px 6px;display:flex;flex-direction:column;align-items:center;}
        .pq1309 .pq-part.win{animation:pqCele .5s ease;}
        .pq1309 .pq-pens{display:flex;flex-wrap:wrap;gap:2px;justify-content:center;align-items:flex-end;min-height:56px;}
        .pq1309 .pq-penw{position:relative;line-height:0;animation:pqSway 3s ease-in-out infinite;transform-origin:bottom center;}
        .pq1309 .pq-penw.in{animation:pqDrop .5s cubic-bezier(.3,1.3,.5,1) both;animation-delay:var(--dd,0s);}
        .pq1309 .pq-cnt{position:absolute;top:-6px;right:-4px;min-width:15px;height:15px;padding:0 2px;border-radius:50%;background:#2563eb;color:#fff;font-size:9.5px;font-weight:800;display:flex;align-items:center;justify-content:center;z-index:6;animation:pqPop .3s ease both;}
        .pq1309 .pq-plbl{margin-top:4px;font-size:19px;font-weight:900;color:#fff6ea;font-variant-numeric:tabular-nums;text-shadow:0 1px 2px rgba(0,0,0,.3);min-height:22px;}
        .pq1309 .pq-qbox{width:100%;min-height:56px;border-radius:10px;border:2.5px dashed #f4dcae;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,.14);}
        .pq1309 .pq-qbox b{font-size:34px;font-weight:900;color:#fff2d6;animation:pqQ 1.9s ease-in-out infinite;}
        .pq1309 .pq-eq{display:flex;justify-content:center;align-items:center;gap:6px;margin-top:14px;animation:pqIn .3s ease both;}
        ...
        .pq1309 .pq-opt.sel{border-color:#2563eb;background:#e8eefc;}
