...
export default function D13_04(props) {
  ...
  return (
    <div className="pq pq1304" ref={fitRef}>
      <style>{`
        ...
        .pq1304 .pq-scene{box-sizing:border-box;position:relative;width:340px;height:252px;border-radius:20px;background:linear-gradient(#f3e2c6 0%,#eed7b2 46%,#e7c99b 100%);border:2px solid #d9be92;overflow:hidden;}
        .pq1304 .pq-fit{position:relative;margin:0 auto;}
        ...
        .pq1304 .pq-opts{display:flex;flex-wrap:wrap;gap:12px;justify-content:center;margin-top:18px;}
