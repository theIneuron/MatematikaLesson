  ...
  return (
    <div className="pq pq1802">
      <style>{`
        ...
        .pq1802 .pq-scene{position:relative;width:380px;max-width:100%;height:252px;margin:0 auto;border-radius:20px;background:linear-gradient(#dff1fb 0%,#eaf6ee 50%,#f3ead6 100%);border:2px solid #cfe0d2;overflow:hidden;}
        ...
        .pq1802 .pq-opts{display:flex;gap:12px;justify-content:center;margin-top:18px;}
