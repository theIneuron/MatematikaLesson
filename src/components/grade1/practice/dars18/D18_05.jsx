  ...
  return (
    <div className="pq pq1805">
      <style>{`
        ...
        .pq1805 .pq-scene{position:relative;width:388px;max-width:100%;height:256px;margin:0 auto;border-radius:20px;background:linear-gradient(#dff1fb 0%,#eaf6ec 52%,#e3efd7 100%);border:2px solid #cfe1c6;overflow:hidden;}
        ...
        .pq1805 .pq-opts{display:flex;gap:12px;justify-content:center;margin-top:18px;}
