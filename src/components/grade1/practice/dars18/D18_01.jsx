...
export default function D18_01(props) {
  ...
  return (
    <div className="pq pq1801" ref={fitRef}>
      <style>{`
        ...
        .pq1801 .pq-scene{box-sizing:border-box;position:relative;width:372px;height:250px;border-radius:20px;background:linear-gradient(#dff0f7 0%,#eaf6ec 52%,#f3ecd8 100%);border:2px solid #d3c9a8;overflow:hidden;}
        .pq1801 .pq-fit{position:relative;margin:0 auto;}
        ...
        .pq1801 .pq-opts{display:flex;flex-wrap:wrap;gap:12px;justify-content:center;margin-top:18px;}
