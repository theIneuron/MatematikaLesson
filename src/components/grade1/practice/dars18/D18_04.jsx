  ...
  return (
    <div className="pq pq1804">
      <style>{`
        ...
        .pq1804 .pq-scene{position:relative;width:372px;max-width:100%;height:250px;margin:0 auto;border-radius:20px;background:linear-gradient(#eaf6ff 0%,#dcefff 42%,#cfe7f7 100%);border:2px solid #b9d8ea;overflow:hidden;}
        ...
        .pq1804 .pq-opts{display:flex;gap:12px;justify-content:center;margin-top:18px;}
