...
export default function D16_02(props) {
  ...
  return (
    <div className="pq pq1602" ref={fitRef}>
      <style>{`
        ...
        .pq1602 .pq-scene{box-sizing:border-box;position:relative;width:352px;height:250px;border-radius:20px;background:linear-gradient(#fce7f0 0%,#f8d6e4 46%,#f2c3d5 100%);border:2px solid #e6b4cb;overflow:hidden;}
        .pq1602 .pq-fit{position:relative;margin:0 auto;}
        ...
        .pq1602 .pq-opts{display:flex;flex-wrap:wrap;gap:12px;justify-content:center;margin-top:18px;}
