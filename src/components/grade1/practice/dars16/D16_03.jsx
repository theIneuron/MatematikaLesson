  ...
  return (
    <div className="pq pq1603">
      <style>{`
        ...
        .pq1603 .pq-scene{position:relative;width:344px;max-width:100%;height:236px;margin:0 auto;border-radius:20px;background:linear-gradient(#ffeef5 0%,#fbdcea 48%,#f6cbe0 100%);border:2px solid #eab9d2;overflow:hidden;}
        ...
        .pq1603 .pq-opts{display:flex;gap:12px;justify-content:center;margin-top:18px;}
