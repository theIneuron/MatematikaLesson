  ...
  return (
    <div className="pq pq1605">
      <style>{`
        ...
        .pq1605 .pq-scene{position:relative;width:360px;max-width:100%;height:238px;margin:0 auto;border-radius:20px;background:linear-gradient(#fbe7d0 0%,#f6d9b4 48%,#efc999 100%);border:2px solid #e2c493;overflow:hidden;}
        ...
        .pq1605 .pq-opts{display:flex;gap:12px;justify-content:center;margin-top:18px;}
