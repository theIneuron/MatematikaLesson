...
export default function D03_04(props) {
  ...
  const [fitRef, scale] = useFitScale(280);

  return (
    <div className="pq pq0304" ref={fitRef}>
      <style>{`
        ...
        .pq0304 .pq-fit{position:relative;margin:0 auto;}
        .pq0304 .pq-scene{box-sizing:border-box;position:relative;width:280px;height:200px;border-radius:20px;background:linear-gradient(#cfe9fb 0%,#e6f5ff 55%,#eef9ea 100%);border:2px solid #c4dff0;overflow:hidden;}
        ...
        .pq0304 .pq-opts{display:flex;flex-wrap:wrap;gap:12px;justify-content:center;margin-top:20px;}
      ...
      <div className="pq-fit" style={{ width: 280 * scale, height: 200 * scale }}>
