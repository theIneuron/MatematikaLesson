  ...
  return (
    <div className="pq pq1009">
      <style>{`
        ...
        .pq1009 .pq-fit{position:relative;margin:0 auto;}
        .pq1009 .pq-scene{box-sizing:border-box;position:relative;width:372px;height:210px;border-radius:18px;background:linear-gradient(#dbe2ec 0%,#ccd5e2 62%,#c0cad9 100%);border:2px solid #c0cad9;overflow:hidden;}
        ...
        .pq1009 .pq-mote{position:absolute;z-index:0;width:5px;height:5px;border-radius:50%;background:radial-gradient(circle at 40% 40%,#fff,rgba(124,240,255,.5) 55%,rgba(124,240,255,0) 74%);pointer-events:none;opacity:0;animation:pq1009Mote 10s ease-in-out infinite;}
        .pq1009 .pq-mote.m2{width:4px;height:4px;animation-duration:12.5s;animation-delay:-4s;}
        .pq1009 .pq-mote.m3{width:6px;height:6px;animation-duration:13.5s;animation-delay:-8s;}
        @keyframes pq1009Mote{0%{opacity:0;transform:translate(0,8px) scale(.7);}22%{opacity:.5;}50%{opacity:.55;transform:translate(4px,-9px) scale(1);}80%{opacity:.3;}100%{opacity:0;transform:translate(0,-20px) scale(.7);}}
      `}</style>
      ...
      <div className="pq-stage" ref={fitRef}>
        ...
        <div className={'pq-scene' + (still ? ' still' : '')} style={{ transform: `scale(${scale})`, transformOrigin: 'top left' }}>
          ...
          <span className="pq-mote m1" aria-hidden="true" style={{ left: 170, top: 48 }} />
          <span className="pq-mote m2" aria-hidden="true" style={{ left: 232, top: 38 }} />
          <span className="pq-mote m3" aria-hidden="true" style={{ left: 262, top: 70 }} />
