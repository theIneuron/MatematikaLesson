  ...
  return (
    <div className="pq pq1002">
      <style>{`
        ...
        .pq1002 .pq-fit{position:relative;margin:0 auto;}
        .pq1002 .pq-scene{box-sizing:border-box;position:relative;width:340px;height:276px;border-radius:18px;background:linear-gradient(#eef1f6 0%,#dfe4ec 55%,#d2d9e4 100%);border:2px solid #c2cad8;overflow:hidden;}
        ...
        /* --- Variantlar --- */
        .pq1002 .pq-opts{display:flex;flex-wrap:wrap;gap:12px;justify-content:center;margin-top:20px;}
