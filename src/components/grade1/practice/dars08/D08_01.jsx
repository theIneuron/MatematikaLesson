...
export default function D08_01(props) {
  ...
  return (
    <div className="pq pq0801" ref={fitRef}>
      <style>{`
        ...
        .pq0801 .pq-scene{box-sizing:border-box;position:relative;width:360px;height:232px;border-radius:20px;background:linear-gradient(#cfe9fb 0%,#e6f5ff 52%,#eef9ea 100%);border:2px solid #c4dff0;overflow:hidden;}
        .pq0801 .pq-fit{position:relative;margin:0 auto;}
        ...
        .pq0801 .pq-opts{display:flex;flex-wrap:wrap;gap:12px;justify-content:center;margin-top:22px;}
