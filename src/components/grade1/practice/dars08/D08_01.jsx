...
const T = {
  uz: {
    ...
    setup: 'Bolalar bobo-buvining hovlisiga kirishdi. Hovlida uchta tovuq don cho\'qiyapti. Yana ikkita tovuq yugurib kelib qo\'shildi.',
  ...
  ru: {
    ...
    setup: 'Дети зашли во двор к бабушке и дедушке. Во дворе три курицы клюют зёрна. Ещё две курицы прибежали и присоединились.',
