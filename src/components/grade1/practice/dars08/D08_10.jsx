  ...
  return (
    <div className="pq pq0810">
      <style>{`
        ...
        .pq0810 .pq-scene{position:relative;width:360px;height:240px;margin:0 auto;border-radius:20px;background:linear-gradient(#cfe9fb 0%,#e6f5ff 52%,#eef9ea 100%);border:2px solid #c4dff0;overflow:hidden;}
        ...
        .pq0810 .pq-opts{display:flex;gap:12px;justify-content:center;margin-top:22px;}
