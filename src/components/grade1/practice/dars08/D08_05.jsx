  ...
  return (
    <div className="pq pq0805">
      <style>{`
        ...
        .pq0805 .pq-scene{position:relative;width:360px;height:232px;margin:0 auto;border-radius:20px;background:linear-gradient(#cfe9fb 0%,#e6f5ff 50%,#f4ecd6 100%);border:2px solid #c4dff0;overflow:hidden;}
        ...
        .pq0805 .pq-opts{display:flex;gap:12px;justify-content:center;margin-top:22px;}
