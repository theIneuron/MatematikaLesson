  ...
  return (
    <div className="pq pq0807">
      <style>{`
        ...
        .pq0807 .pq-scene{position:relative;width:372px;max-width:100%;height:252px;margin:0 auto;border-radius:20px;background:linear-gradient(#cfe9fb 0%,#e6f5ff 52%,#f2f0dd 70%);border:2px solid #c4dff0;overflow:hidden;}
        ...
        .pq0807 .pq-opts{display:flex;gap:14px;justify-content:center;margin-top:20px;}
