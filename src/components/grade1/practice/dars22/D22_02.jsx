...
export default function D22_02(props) {
  ...
  return (
    <div className="pq pq2202" ref={fitRef}>
      <style>{`
        ...
        .pq2202 .pq-scene{box-sizing:border-box;position:relative;width:392px;height:258px;border-radius:20px;background:linear-gradient(#cfeafc 0%,#e4f4d9 52%,#d3edb6 100%);border:2px solid #bfe0a8;overflow:hidden;}
        .pq2202 .pq-fit{position:relative;margin:0 auto;}
        ...
        .pq2202 .pq-opts{display:flex;flex-wrap:wrap;gap:12px;justify-content:center;margin-top:18px;}
      ...
      <div className="pq-fit" style={{ width: 392 * scale, height: 258 * scale }}>
