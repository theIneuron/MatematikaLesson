...
export default function D22_06(props) {
  ...
  return (
    <div className="pq pq2206" ref={fitRef}>
      <style>{`
        ...
        .pq2206 .pq-scene{box-sizing:border-box;position:relative;width:380px;height:214px;border-radius:20px;background:linear-gradient(#cfeafc 0%,#e4f4d9 52%,#d3edb6 100%);border:2px solid #bfe0a8;overflow:hidden;}
        .pq2206 .pq-fit{position:relative;margin:0 auto;}
        ...
        .pq2206 .pq-opts{display:flex;flex-wrap:wrap;gap:12px;justify-content:center;margin-top:18px;}
