...
export default function D22_09(props) {
  ...
  return (
    <div className="pq pq2209" ref={fitRef}>
      <style>{`
        ...
        .pq2209 .pq-scene{box-sizing:border-box;position:relative;width:392px;height:264px;border-radius:20px;background:linear-gradient(#cfeafc 0%,#e4f4d9 52%,#d3edb6 100%);border:2px solid #bfe0a8;overflow:hidden;}
        .pq2209 .pq-fit{position:relative;margin:0 auto;}
      ...
      <div className="pq-fit" style={{ width: 392 * scale, height: 264 * scale }}>
