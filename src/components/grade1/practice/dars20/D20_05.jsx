...
export default function D20_05(props) {
  ...
  return (
    <div className="pq pq2005" ref={fitRef}>
      <style>{`
        ...
        .pq2005 .pq-scene{box-sizing:border-box;position:relative;width:392px;height:262px;border-radius:20px;background:linear-gradient(#dff1fb 0%,#eaf2fb 52%,#eef1f5 100%);border:2px solid #d3ddec;overflow:hidden;}
        .pq2005 .pq-fit{position:relative;margin:0 auto;}
        ...
        .pq2005 .pq-opts{display:flex;flex-wrap:wrap;gap:12px;justify-content:center;margin-top:18px;}
