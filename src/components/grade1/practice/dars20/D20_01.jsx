  ...
  return (
    <div className="pq pq2001">
      <style>{`
        ...
        .pq2001 .pq-scene{position:relative;width:392px;max-width:100%;height:256px;margin:0 auto;border-radius:20px;background:linear-gradient(#cfe9fb 0%,#e2eef9 46%,#eef1f5 100%);border:2px solid #cdd9e8;overflow:hidden;}
        ...
        .pq2001 .pq-opts{display:flex;gap:12px;justify-content:center;margin-top:18px;}
