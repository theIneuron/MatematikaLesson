  ...
  return (
    <div className="pq pq0604">
      <style>{`
        ...
        .pq0604 .pq-scene{position:relative;width:330px;height:292px;margin:0 auto;border-radius:20px;background:linear-gradient(#cfe9fb 0%,#e6f5ff 60%,#dff0fa 100%);border:2px solid #c4dff0;overflow:hidden;}
        ...
        .pq0604 .pq-opts{display:flex;gap:12px;justify-content:center;margin-top:20px;}
