  ...
  return (
    <div className="pq pq0602">
      <style>{`
        ...
        .pq0602 .pq-scene{position:relative;width:350px;height:256px;margin:0 auto;border-radius:20px;background:linear-gradient(#cfe9fb 0%,#e6f4fe 60%,#eef8f2 100%);border:2px solid #c4dff0;overflow:hidden;}
        ...
        .pq0602 .pq-opts{display:flex;gap:12px;justify-content:center;margin-top:20px;}
