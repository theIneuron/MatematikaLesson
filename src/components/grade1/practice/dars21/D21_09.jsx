  ...
  return (
    <div className="pq pq2109">
      <style>{`
        ...
        .pq2109 .pq-scene{position:relative;width:400px;max-width:100%;height:238px;margin:0 auto;border-radius:20px;background:linear-gradient(#cdeafd 0%,#dff1fb 46%,#cdeeb6 72%,#b6df97 100%);border:2px solid #bfe0cd;overflow:hidden;}
