  ...
  return (
    <div className="pq pq1706">
      <style>{`
        ...
        .pq1706 .pq-fit{position:relative;margin:0 auto;}
        .pq1706 .pq-scene{box-sizing:border-box;position:relative;width:372px;height:92px;border-radius:18px;background:linear-gradient(#fdf0f5 0%,#f8dfe8 55%,#f0cdd9 100%);border:2px solid #e9cad7;overflow:hidden;}
        ...
        /* qatorlar */
        .pq1706 .pq-rows{display:grid;grid-template-columns:1fr;align-items:start;gap:8px;width:100%;max-width:360px;}
        @media (min-width:480px){.pq1706 .pq-rows{grid-template-columns:1fr 1fr;max-width:520px;}}
        ...
        .pq1706 .pq-sgs{flex-basis:100%;display:flex;flex-wrap:wrap;gap:6px;margin-left:2px;justify-content:center;align-content:center;}
