...
const BookViz = ({ tens = 0, ones = 0, pop = false, animate = false, ans = null, seal = true }) => (
...
const Screen3 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      figure={(solved) => <BookViz tens={1} ones={3} pop={solved} seal={solved} ans={solved ? 13 : null}/>}
...
const Screen4 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <BookViz tens={1} ones={3} pop={solved} seal={solved} ans={solved ? 1 : null}/>}
...
const Screen5 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <BookViz tens={1} ones={3} pop={solved} seal={solved} ans={solved ? 3 : null}/>}
...
const Screen6 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <BookViz tens={1} ones={2} pop={solved} seal={solved}/>}
...
const Screen7 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <BookViz tens={1} ones={4} pop={solved} seal={solved} ans={solved ? 14 : null}/>}
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 2.2vw, 16px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(14px, 2.6vw, 20px)', padding: 'clamp(14px, 2.6vw, 22px)' }}>
          <BookViz key={ri} tens={Math.floor(round.n / 10)} ones={round.n % 10} pop={solvedItem} seal={solvedItem} ans={solvedItem ? round.n : null}/>
          {!solvedItem && (
...
const Screen8 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <BookViz tens={1} ones={5} pop={solved} seal={false} ans={solved ? 15 : null}/>}
...
@media (prefers-reduced-motion: reduce) { .g1-fviz-pop .g1-fviz-one { animation: none; } .g1-bd-sealin { animation: none; } }
