  ...
  return (
    <div className="g1-yardscene">
      ...
      <div className="g1-yard-cast">
        ...
        {/* hovlidagi olmalar — o'ylov pufakchasida (Dars04 FruitBubble), audio bilan mos (Ra'no 3, Zuhra 2) */}
...
/* hovlidagi olmalar — personaj tepasida o'ylov pufakchasida (Ra'no 3, Zuhra 2) */
.g1-yard-bubble { position: absolute; bottom: 33cqh; width: 20cqw; z-index: 5; opacity: 0; transition: opacity 0.5s ease; }
.g1-yard-bubble.in { opacity: 1; }
.g1-yard-bubble .fb, .g1-yard-bubble .fb-body { width: 100%; }
.g1-yard-bubble-rano { left: 19cqw; }
.g1-yard-bubble-zuhra { right: 16cqw; }
