...
const Screen4 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <RemoveRow total={7} gone={solved ? 3 : 0} kind="apple" ans={solved ? 4 : null}/>}
...
const Screen7 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <><BondFrame total={6} a={2} hide={!solved} hideSide="blue" anim={solved}/>{solved && <AnsPop n={4}/>}</>}
...
const Screen8 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <RemoveRow total={8} gone={solved ? 3 : 0} kind="apple" ans={solved ? 5 : null}/>}
