...
// ============================================================================
// ░░ 1-SINF · Dars28 — "Структура задачи. Задача на сумму" (num-1-28-v1) · Б5 · spec: ETALON_1SINF.md ░░
// Baza: Dars21 (BARQAROR — infra + Pips/cast/saxnalar string-in-string). Dars15 EMAS (boshqa chat o'zgartiradi).
// YADRO: matnli masala — 4 qism (shart→savol→amal→javob); yig'indiga masala (birlashtirish → qo'shish), amalni MAZMUNDAN tanlash.
// MEXANIKA: ProblemViz (ikki olma-guruh Pips, amalsiz), SolTile (yechim yozuvi), OpTile (+/−), PQ (savol+masala matni).
// Matn ovozда to'liq o'qiladi (1-sinf), ekranда qisqa tayanch. Typing YO'Q, son kichik (yig'indi ≤ 9).
// Misconception'lar: M1 amalni noto'g'ri (ayirish) · M2 shart/savolни chalkashtirish · M3 javobda noto'g'ri son.
//
...
const LESSON_META = {
  lessonId: 'num-1-28-v1',
  lessonTitle: { ru: 'Структура задачи. Задача на сумму', uz: "Masala tuzilishi. Yig'indiga masala" }
};
const SCREEN_META = [
  { id: 'sIntro', type: 'hook',        template: 'custom',   scored: false, scope: null },            // syujet: masala nima
  { id: 's0',  type: 'hook',        template: 'custom',   scored: false, scope: 'hook' },          // jumboq: savol nima
  { id: 's1',  type: 'exploration', template: 'custom',   scored: false, scope: null },            // shart va savol
  { id: 's2',  type: 'rule',        template: 'custom',   scored: false, scope: null },            // 4 qism
  { id: 's3',  type: 'test',        template: 'MCScreen', scored: true,  scope: 'module-mikro' },  // qaysi gap savol
  { id: 's4',  type: 'exploration', template: 'custom',   scored: false, scope: null },            // birlashtirilsa qo'shamiz
  { id: 's5',  type: 'rule',        template: 'custom',   scored: false, scope: null },            // birlashtirilsa -> qo'shish
  { id: 's6',  type: 'test',        template: 'MCScreen', scored: true,  scope: 'module-mikro' },  // qaysi amal (+)
  { id: 's7',  type: 'test',        template: 'MCScreen', scored: true,  scope: 'module-mikro' },  // to'g'ri yechim 4+3=7
  { id: 's8',  type: 'test',        template: 'MCScreen', scored: true,  scope: 'module-mikro' },  // javob 5+2=7
  { id: 'sg',  type: 'exploration', template: 'custom',   scored: false, scope: null },            // o'yin: 3 masala
  { id: 'sGuest', type: 'hook',     template: 'custom',   scored: false, scope: null },            // syujet ko'prik
  { id: 's9',  type: 'test',        template: 'MCScreen', scored: true,  scope: 'final' },         // final: 6+3=9 + fakt
...
const CONTENT = {
  sIntro: {
    ...
    title: { ru: 'Что такое задача', uz: 'Masala nima' },
    body: {
      ru: 'Задача — это маленькая история. В ней что-то известно и о чём-то спрашивают. Сегодня научимся решать задачи.',
      uz: "Masala — bu kichik hikoya. Unda nimadir ma'lum va nimadir so'raladi. Bugun masala yechishni o'rganamiz."
    },
    ...
    audio: {
      ru: [
        'Привет, друг! Сегодня будем решать задачи.',
        'Задача — это маленькая история про числа.',
        'В ней что-то известно, и о чём-то спрашивают.',
        'Научимся читать задачу и находить ответ. Слушай до конца и нажимай кнопку дальше.'
      ],
      uz: [
        "Salom, do'stim! Bugun masala yechamiz.",
        "Masala — bu sonlar haqidagi kichik hikoya.",
        "Unda nimadir ma'lum, va nimadir so'raladi.",
        "Masalani o'qib, javob topishni o'rganamiz. Oxirigacha tinglang va davom tugmasini bosing."
      ]
    }
  },
  ...
  s0: {
    ...
    title_part1: { ru: 'У Рано 5 яблок, Анвар принёс 3. Какой тут', uz: "Ra'noda 5 olma, Anvar 3 ta keltirdi. Bu yerda qanday" },
    ...
    opt0: { ru: 'Сколько всего яблок?', uz: 'Hammasi nechta olma?' },
    opt1: { ru: 'Кто старше?', uz: 'Kim kattaroq?' },
    opt2: { ru: 'Трудно сказать', uz: 'Aytish qiyin' },
    audio: {
      intro: {
        ru: 'У Рано пять яблок. Анвар принёс ещё три. Какой вопрос тут можно задать? Нажми, как думаешь.',
        uz: "Ra'noda besh olma. Anvar yana uchta keltirdi. Bu yerda qanday savol berish mumkin? O'ylab, bosing."
      },
      on_correct: { ru: 'Хорошо. Спросим, сколько яблок всего.', uz: "Yaxshi. Hammasi nechta olma, deb so'raymiz." },
      on_wrong: { ru: 'Хорошо. Спросим, сколько яблок всего.', uz: "Yaxshi. Hammasi nechta olma, deb so'raymiz." }
    }
  },

  s1: {
    eyebrow: { ru: 'Условие и вопрос', uz: 'Shart va savol' },
    instruction: { ru: 'В задаче есть условие и вопрос. Найдём их', uz: 'Masalada shart va savol bor. Ularni topamiz' },
    ...
    shart_text: { ru: 'У Рано 5 яблок, Анвар принёс 3.', uz: "Ra'noda 5 olma, Anvar 3 ta keltirdi." },
    savol_text: { ru: 'Сколько яблок вместе?', uz: 'Birga nechta olma?' },
    full_text: { ru: 'Условие — что известно. Вопрос — о чём спрашивают.', uz: "Shart — nima ma'lum. Savol — nima so'ralyapti." },
    full_audio: { ru: 'Условие говорит, что известно. Вопрос говорит, о чём спрашивают.', uz: "Shart nima ma'lumligini aytadi. Savol nima so'ralayotganini aytadi." },
    audio: {
      ru: [
        'Послушай задачу. У Рано пять яблок, Анвар принёс три. Это условие — то, что известно.',
        'Сколько яблок вместе? Это вопрос — о чём спрашивают.'
      ],
      uz: [
        "Masalani tinglang. Ra'noda besh olma, Anvar uchta keltirdi. Bu shart — nima ma'lum.",
        "Birga nechta olma? Bu savol — nima so'ralyapti."
      ]
    }
  },
  ...
  s2: {
    ...
    title_part1: { ru: 'В задаче', uz: 'Masalada' },
    title_part2_em: { ru: 'четыре части', uz: "to'rt qism" },
    title_part3: { ru: '', uz: ' bor' },
    p1: { ru: 'Условие', uz: 'Shart' },
    p2: { ru: 'Вопрос', uz: 'Savol' },
    p3: { ru: 'Действие', uz: 'Amal' },
    p4: { ru: 'Ответ', uz: 'Javob' },
    tip: {
      ru: 'У задачи четыре части: условие, вопрос, действие и ответ. Сначала читаем условие и вопрос, потом выбираем действие и пишем ответ.',
      uz: "Masalada to'rt qism bor: shart, savol, amal va javob. Avval shart va savolni o'qiymiz, keyin amalni tanlab, javob yozamiz."
    },
    audio: {
      ru: 'У каждой задачи четыре части. Условие, вопрос, действие и ответ. Сначала читаем условие и вопрос. Потом выбираем действие и находим ответ.',
      uz: "Har masalada to'rt qism bor. Shart, savol, amal va javob. Avval shart va savolni o'qiymiz. Keyin amalni tanlab, javob topamiz."
    }
  },

  s3: {
    eyebrow: { ru: 'Тренировка · 1 / 4', uz: 'Mashq · 1 / 4' },
    title: { ru: 'Какое предложение — вопрос?', uz: 'Qaysi gap — savol?' },
    problem: { ru: 'У Рано 5 яблок, Анвар принёс 3.', uz: "Ra'noda 5 olma, Anvar 3 ta keltirdi." },
    opt0: { ru: 'Сколько яблок вместе?', uz: 'Birga nechta olma?' },
    opt1: { ru: 'У Рано 5 яблок.', uz: "Ra'noda 5 olma bor." },
    opt2: { ru: 'Рано любит яблоки.', uz: "Ra'no olmani yaxshi ko'radi." },
    correct_text: { ru: 'Правильно. Вопрос спрашивает, сколько яблок вместе.', uz: "To'g'ri. Savol birga nechta olma ekanini so'raydi." },
    wrong_1: {
      ru: 'Это условие — то, что известно. Вопрос спрашивает, сколько яблок вместе.',
      uz: "Bu shart — nima ma'lum. Savol birga nechta olma ekanini so'raydi."
    },
    wrong_2: {
      ru: 'Это не вопрос задачи. Вопрос спрашивает, сколько яблок вместе.',
      uz: "Bu masala savoli emas. Savol birga nechta olma ekanini so'raydi."
    },
    wrong_default: {
    ...
    audio: {
      ...
      on_correct: { ru: 'Верно. Вопрос спрашивает, сколько яблок вместе.', uz: "To'g'ri. Savol birga nechta olma ekanini so'raydi." },
      on_wrong: { ru: 'Не совсем. Вопрос — это о чём спрашивают.', uz: "Unchalik emas. Savol — bu nima so'ralyapti." }
    }
  },
  ...
  s4: {
    ...
    audio: {
      ru: [
        ...
        'Когда предметы соединяют и спрашивают сколько всего — мы складываем.'
      ],
      uz: [
        "Ra'noda olma, Anvarda olma. Ular bitta uyumga yig'ildi.",
        "Narsalar birlashtirilib, hammasi nechta deb so'ralsa — biz qo'shamiz."
      ]
    }
  },
  ...
  s5: {
    eyebrow: { ru: 'Запомним', uz: 'Eslab qolamiz' },
    title_part1: { ru: 'Объединяют —', uz: 'Birlashtirilsa —' },
    title_part2_em: { ru: 'складываем', uz: "qo'shamiz" },
    title_part3: { ru: '', uz: '' },
    tip: {
      ru: 'Если предметы соединяют вместе и спрашивают, сколько всего — выбираем сложение. Смотрим на смысл, а не только на слова.',
      uz: "Agar narsalar birga qo'shilib, hammasi nechta deb so'ralsa — qo'shishni tanlaymiz. Mazmunga qaraymiz, faqat so'zga emas."
    },
    audio: {
      ru: 'Запомни. Если предметы соединяют вместе и спрашивают сколько всего, мы складываем. Думаем о смысле, а не только о словах.',
      uz: "Eslab qoling. Agar narsalar birga qo'shilib, hammasi nechta deb so'ralsa, biz qo'shamiz. So'zga emas, mazmunga o'ylaymiz."
    }
  },
  ...
  s6: {
    ...
    problem: { ru: 'У Анвара 4 яблока, Жасур дал ещё 3. Сколько вместе?', uz: 'Anvarda 4 olma, Jasur yana 3 ta berdi. Birga nechta?' },
    correct_text: { ru: 'Правильно. Яблоки объединяют — значит плюс.', uz: "To'g'ri. Olmalar birlashtirilyapti — demak qo'shuv." },
    wrong_1: {
      ru: 'Здесь яблоки соединяют вместе, ничего не убирают. Значит складываем, ставим плюс.',
      uz: "Bu yerda olmalar birga qo'shilyapti, hech narsa olinmaydi. Demak qo'shamiz, qo'shuv belgisi."
    },
    wrong_default: {
      ru: 'Предметы соединяют — выбираем плюс.',
      uz: "Narsalar birlashtirilsa — qo'shuvni tanlaymiz."
    },
    audio: {
      intro: { ru: 'У Анвара четыре яблока, Жасур дал ещё три. Какое действие подходит? Выбери.', uz: "Anvarda to'rt olma, Jasur yana uchta berdi. Qaysi amal mos? Tanlang." },
      on_correct: { ru: 'Верно. Объединяют — складываем, ставим плюс.', uz: "To'g'ri. Birlashtirilyapti — qo'shamiz, qo'shuv belgisi." },
  ...
  s7: {
    ...
    audio: {
      ...
      on_correct: { ru: 'Верно. Четыре и три семь. У них семь яблок.', uz: "To'g'ri. To'rt va uch yetti. Ularda yetti olma." },
      on_wrong: { ru: 'Не совсем. Яблоки соединяют — складываем.', uz: "Unchalik emas. Olmalar birlashtirilyapti — qo'shamiz." }
    }
  },

  s8: {
    eyebrow: { ru: 'Тренировка · 4 / 4', uz: 'Mashq · 4 / 4' },
    title: { ru: 'Сколько всего яблок?', uz: 'Hammasi nechta olma?' },
    problem: { ru: 'У Зухры 5 яблок, Жасур дал ещё 2.', uz: 'Zuhrada 5 olma, Jasur yana 2 ta berdi.' },
    opt0: { ru: '7', uz: '7' },
    opt1: { ru: '3', uz: '3' },
    opt2: { ru: '5', uz: '5' },
  ...
  sg: {
    ...
    audio: {
      intro: { ru: 'Поиграем с задачами. Я читаю задачу, а ты выбираешь, сколько всего. Начинаем.', uz: "Masalalar bilan o'ynaymiz. Men masalani o'qiyman, siz hammasi nechta ekanini tanlaysiz. Boshladik." }
    }
  },

  sGuest: {
    eyebrow: { ru: 'Задача решена', uz: 'Masala yechildi' },
    title: { ru: 'Решили по частям', uz: 'Qism-qism yechdik' },
    body: {
      ru: 'Рано, Анвар и Зухра прочитали условие и вопрос, выбрали действие и нашли ответ. Так решается любая задача.',
      uz: "Ra'no, Anvar va Zuhra shart va savolni o'qib, amalni tanlab, javob topdi. Har masala shunday yechiladi."
    },
    rano_label: { ru: 'Рано', uz: "Ra'no" },
    anvar_label: { ru: 'Анвар', uz: 'Anvar' },
    zuhra_label: { ru: 'Зухра', uz: 'Zuhra' },
    audio: {
      ru: [
        'Послушай, мы решили задачу по частям.',
        'Прочитали условие и вопрос, выбрали действие, нашли ответ.'
      ],
      uz: [
        "Tinglang, biz masalani qism-qism yechdik.",
        "Shart va savolni o'qidik, amalni tanladik, javob topdik."
      ]
    }
  },
  ...
  s9: {
    ...
    fact_text: {
      ru: 'В каждой задаче есть условие, вопрос и ответ. Сначала читаем, потом считаем.',
      uz: "Har masalada shart, savol va javob bor. Avval o'qiymiz, keyin sanaymiz."
    },
    fact_audio: {
      ru: 'В каждой задаче есть условие, вопрос и ответ. Сначала читаем, потом считаем.',
      uz: "Har masalada shart, savol va javob bor. Avval o'qiymiz, keyin sanaymiz."
    ...
    audio: {
      intro: { ru: 'У Рано шесть яблок, Зухра принесла три. Какое решение верное? Выбери.', uz: "Ra'noda olti olma, Zuhra uchta keltirdi. Qaysi yechim to'g'ri? Tanlang." },
      on_correct: { ru: 'Верно. Шесть и три девять. Всего девять яблок.', uz: "To'g'ri. Olti va uch to'qqiz. Hammasi to'qqiz olma." },
      on_wrong: { ru: 'Не совсем. Яблоки соединяют — складываем.', uz: "Unchalik emas. Olmalar birlashtirilyapti — qo'shamiz." }
    }
  },
  ...
  s10: {
    ...
    main_2_em: { ru: 'решать задачи на сумму', uz: "yig'indiga masala yecha olasiz" },
    connections_title: { ru: 'Что дальше', uz: 'Keyin nima' },
    connections_text: {
      ru: 'На следующем уроке будем решать задачи на остаток.',
      uz: 'Keyingi darsda qoldiqqa masala yechamiz.'
    },
    audio: {
      ru: [
        'Молодец! Ты читал условие и вопрос, выбирал действие, находил ответ.',
        'Задачи на сумму решаются сложением. На следующем уроке решим задачи на остаток. До встречи!'
      ],
      uz: [
        "Barakalla! Shart va savolni o'qib, amalni tanlab, javob topdingiz.",
        "Yig'indiga masala qo'shish bilan yechiladi. Keyingi darsda qoldiqqa masala yechamiz. Ko'rishguncha!"
      ]
    }
  }
};
...
// ProblemViz — masala vaziyati: ikki olma-guruh + har birining SONI (olma↔son ko'prigi, CPA). Amalni oldindan bermaydi.
// ans != null -> yechilgach "= N" pop (AnsPop) vizual ichida.
const ProblemViz = ({ na, nb, kind = 'apple', anim = 'bob', showNums = true, combine = false, ans = null }) => (
  <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', gap: combine ? 'clamp(2px, 1vw, 8px)' : 'clamp(16px, 6vw, 48px)', flexWrap: 'wrap', transition: 'gap 0.55s cubic-bezier(0.4, 0, 0.2, 1)' }}>
    {[na, nb].map((n, i) => (
      <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(4px, 1.4vw, 8px)' }}>
        <span style={{ display: 'inline-flex', maxWidth: 'clamp(90px, 28vw, 160px)' }}><Pips n={n} kind={kind} wrap={true} anim={anim}/></span>
        {showNums && <DigitGlyph d={n} size="sm" tone="accent"/>}
      </div>
    ))}
...
// s0 — HOOK (soft): Ra'no 5, Anvar 3 — savol nima? har javob OK.
const Screen0 = (props) => {
  const lang = useLang();
  const t = useT();
  const c = CONTENT.s0;
  ...
  return (
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(14px, 2.4vw, 18px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 'clamp(6px, 1.6vw, 12px)', flexWrap: 'wrap', padding: 'clamp(16px, 3vw, 24px)' }}>
          {parts.map((p, i) => (
            <React.Fragment key={i}>
              <span className="g1-tile g1-pop-in" style={{ animationDelay: `${0.2 + i * 0.22}s`, padding: 'clamp(8px, 1.6vw, 12px) clamp(10px, 2vw, 16px)', fontSize: 'clamp(13px, 1.8vw, 16px)', fontWeight: 700 }}>{t(p)}</span>
              {i < parts.length - 1 && <span className="mono g1-pop-in" style={{ animationDelay: `${0.32 + i * 0.22}s`, ...D28_OP, fontSize: 'clamp(16px, 3vw, 22px)' }}>→</span>}
            </React.Fragment>
          ))}
        </div>
...
// s3 — TEST MC: qaysi gap savol? (idx0). Variantlar — gaplar (matn).
const Screen3 = (props) => {
  const c = CONTENT.s3;
  const t = useT();
  return (
...
// s4 — EXPLORATION: birlashtirilsa qo'shamiz.
const Screen4 = (props) => {
  const lang = useLang();
  const t = useT();
  const c = CONTENT.s4;
  ...
  const revealRef = useRevealScroll(done, 1050);   // javob materiallashgach (950ms) skroll
  const go = () => {
    if (done || !canAct) return;
    setDone(true);   // avval "4 + 3 = ?" (son gapi), keyin javob materiallashadi
    setTimeout(() => {
      setShowRes(true);
      if (!audio.muted) { const e = getAudioEngine(); if (e) e.pushOneOff(c.full_audio[lang]); }
    }, 950);
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 2.2vw, 16px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(14px, 2.6vw, 20px)', padding: 'clamp(16px, 3vw, 26px)' }}>
          {!done ? (
            <ProblemViz na={4} nb={3}/>
          ) : (
            <div className="fade-up" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(8px, 2vw, 14px)' }}>
              <span style={{ display: 'inline-flex', maxWidth: 'clamp(120px, 40vw, 220px)' }}><Pips n={7} kind="apple" wrap={true}/></span>
              <span className="mono" style={{ ...D28_OP, fontSize: 'clamp(22px, 4.4vw, 32px)', fontWeight: 800, color: T.accent }}>4 + 3 = {showRes ? <span className="g1-pop-in" style={{ display: 'inline-block' }}>7</span> : '?'}</span>
            </div>
          )}
          {!done && (
            <button className="btn" disabled={!canAct} onClick={go}
              ...
              {lang === 'uz' ? 'Birlashtirish' : 'Соединить'}
            </button>
          )}
        </div>
        {done && (
...
// s5 — RULE: birlashtirilsa -> qo'shish.
const Screen5 = (props) => {
  const lang = useLang();
  const t = useT();
  const c = CONTENT.s5;
  ...
  return (
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(14px, 2.4vw, 18px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 'clamp(10px, 2.6vw, 18px)', padding: 'clamp(18px, 3.4vw, 28px)' }}>
          <span className="g1-pop-in" style={{ display: 'inline-flex', maxWidth: 'clamp(70px, 20vw, 110px)', animationDelay: '0.2s' }}><Pips n={3} kind="apple" wrap={true}/></span>
          <span className="g1-pop-in" style={{ display: 'inline-flex', animationDelay: '0.42s' }}><OpTile op="add"/></span>
          <span className="g1-pop-in" style={{ display: 'inline-flex', maxWidth: 'clamp(70px, 20vw, 110px)', animationDelay: '0.64s' }}><Pips n={4} kind="apple" wrap={true}/></span>
        </div>
        <BitSays text={t(c.tip)}/>
      </div>
    </Stage>
...
// s6 — TEST MC: qaysi amal? + (idx0). Variantlar — OpTile +/−.
const Screen6 = (props) => {
  const c = CONTENT.s6;
  const t = useT();
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<PQ title={t(c.title)} problem={t(c.problem)}/>}
      figure={(solved) => <ProblemViz na={4} nb={3} combine={solved}/>}
      options={[<OpTile op="add"/>, <OpTile op="sub"/>]}
      correctIdx={0}
      mascot={false}
      storedAnswer={props.storedAnswer} onAnswer={props.onAnswer}
      onNext={props.onNext} onPrev={props.onPrev}
...
// s7 — TEST MC: to'g'ri yechim 4+3=7 (idx0). Variantlar — SolTile.
const Screen7 = (props) => {
  const c = CONTENT.s7;
  const t = useT();
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<PQ title={t(c.title)} problem={t(c.problem)}/>}
      figure={(solved) => <ProblemViz na={4} nb={3} combine={solved} ans={solved ? 7 : null}/>}
...
// s8 — TEST MC: javob 7 (idx0). Variantlar — DigitGlyph.
const Screen8 = (props) => {
  const c = CONTENT.s8;
  const t = useT();
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<PQ title={t(c.title)} problem={t(c.problem)}/>}
      figure={(solved) => <ProblemViz na={5} nb={2} combine={solved} ans={solved ? 7 : null}/>}
      options={[<DigitGlyph d={7} size="mid"/>, <DigitGlyph d={3} size="mid"/>, <DigitGlyph d={5} size="mid"/>]}
      correctIdx={0}
      optionsCols={3}
      mascot={false}
      storedAnswer={props.storedAnswer} onAnswer={props.onAnswer}
...
// sg — MINI-O'YIN (3 raund, ballsiz): yig'indi masalalar.
const PROB_GAME = [
  { na: 3, nb: 4, ans: 7, opts: [7, 1, 3], qk: 'q_round1' },
  { na: 5, nb: 3, ans: 8, opts: [8, 2, 5], qk: 'q_round2' },
  { na: 2, nb: 6, ans: 8, opts: [8, 4, 2], qk: 'q_round3' },
];
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 2.2vw, 16px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(14px, 2.6vw, 20px)', padding: 'clamp(14px, 2.6vw, 22px)' }}>
          <ProblemViz key={ri} na={round.na} nb={round.nb} kind={round.kind || 'apple'} ans={solvedItem ? round.ans : null}/>
          {!solvedItem && (
...
// s9 — TEST final + FactCard: 6+3=9 (idx0).
const Screen9 = (props) => {
  const c = CONTENT.s9;
  const t = useT();
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<PQ title={t(c.title)} problem={t(c.problem)}/>}
      figure={(solved) => <ProblemViz na={6} nb={3} combine={solved} ans={solved ? 9 : null}/>}
      options={[<SolTile a={6} op="add" b={3} r={9}/>, <SolTile a={6} op="sub" b={3} r={3}/>, <SolTile a={6} op="add" b={3} r={8}/>]}
      correctIdx={0}
      optionsCols={1}
      mascot={false}
      factOnCorrect={(
