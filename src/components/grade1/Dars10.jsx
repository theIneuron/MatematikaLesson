...
// ============================================================================
// ░░ 1-SINF · Dars10 — "10 ichida qo'shish va ayirish" (num-1-10-v1) · son o'qi 0..10 (Dars09 mexanikasi), aralash +/− · spec: ETALON_1SINF.md ░░
...
const CONTENT = {
  // ---- sIntro: endi 10 gacha narsalar bilan ishlaymiz ----
  sIntro: {
    eyebrow: { ru: 'История', uz: 'Hikoya' },
    title: { ru: 'Дорожка выросла до десяти', uz: "Yo'lak o'ngacha o'sdi" },
    body: {
      ru: 'В прошлый раз друзья играли в прыжки до пяти. Сегодня Рано, Анвар и Зухра дорисовали дорожку — теперь в ней десять клеток! Будем прыгать дальше: прибавлять и убирать в пределах десяти.',
      uz: "O'tgan safar do'stlar beshgacha sakrash o'yinini o'ynadi. Bugun Ra'no, Anvar va Zuhra yo'lakni chizib bitirishdi — endi unda o'nta katak! Uzoqroq sakraymiz: o'n ichida qo'shamiz va olamiz."
    },
    ...
    audio: {
      ru: [
        'Привет, друг! В прошлый раз друзья прыгали по дорожке до пяти.',
        'Сегодня они дорисовали дорожку. Теперь в ней десять клеток, и прыжки стали длиннее.',
        'Будем прибавлять и убирать в пределах десяти. Слушай и нажимай кнопку дальше.'
      ],
      uz: [
        "Salom, do'stim! O'tgan safar do'stlar beshgacha yo'lakda sakrashdi.",
        "Bugun ular yo'lakni chizib bitirishdi. Endi unda o'nta katak, sakrashlar uzunroq bo'ldi.",
        "O'n ichida qo'shamiz va olamiz. Tinglang va davom tugmasini bosing."
      ]
    }
  },

  // ---- sGuest SYUJET KO'PRIK: 10 ichida puxta -> Dars11 ga ishora (o'rin almashtirish) ----
  sGuest: {
    eyebrow: { ru: 'История', uz: 'Hikoya' },
    title: { ru: 'Рано и Анвар поменялись', uz: "Ra'no bilan Anvar almashdi" },
    body: {
      ru: 'В конце игры Рано и Анвар поменялись очередью: сначала прыгнул Анвар, потом Рано. И вместе получилось столько же! В следующий раз откроем этот секрет — числа можно складывать в любом порядке.',
      uz: "O'yin oxirida Ra'no bilan Anvar navbat almashdi: avval Anvar sakradi, keyin Ra'no. Birgalikda esa xuddi shuncha chiqdi! Keyingi safar shu sirni ochamiz — sonlarni istalgan tartibda qo'shsa bo'ladi."
    },
    bit_label: { ru: 'Бит', uz: 'Bit' },
    rano_label: { ru: 'Рано', uz: "Ra'no" },
    anvar_label: { ru: 'Анвар', uz: 'Anvar' },
    ...
    audio: {
      ru: [
        'В конце игры Рано и Анвар поменялись очередью. Сначала прыгнул Анвар, потом Рано.',
        'И вместе получилось столько же! В следующий раз откроем этот секрет. Числа можно складывать в любом порядке.',
        'Слушай и нажимай кнопку дальше.'
      ],
      uz: [
        "O'yin oxirida Ra'no bilan Anvar navbat almashdi. Avval Anvar sakradi, keyin Ra'no.",
        "Birgalikda esa xuddi shuncha chiqdi! Keyingi safar shu sirni ochamiz. Sonlarni istalgan tartibda qo'shsa bo'ladi.",
        "Tinglang va davom tugmasini bosing."
      ]
    }
  },

  // ---- s0 HOOK (son o'qi 0..10): marker 0 da, oldinga sakraydi ----
  s0: {
    eyebrow: { ru: 'Попробуй', uz: "Sinab ko'ring" },
    title_part1: { ru: 'Дорожка стала', uz: "Yo'lak endi" },
    title_part2_em: { ru: 'длиннее — до десяти', uz: 'uzunroq — o\'ngacha' },
    title_part3: { ru: '. Прыгай вперёд.', uz: '. Oldinga sakrang.' },
    question: { ru: 'Каждый прыжок — на одно число вперёд.', uz: "Har sakrash — bitta son oldinga." },
    counter_label: { ru: 'Точка на', uz: 'Nuqta' },
    done_text: { ru: 'Чем больше прыжков вперёд, тем больше число.', uz: "Oldinga sakrash qancha ko'p — son shuncha katta." },
    audio: {
      intro: {
        ru: 'Теперь дорожка длиннее — от нуля до десяти. Нажми на кнопку прыжок и пройди по числам вперёд. Смотри, как число растёт.',
        uz: "Endi yo'lak uzunroq — noldan o'ngacha. Sakrash tugmasini bosing va sonlar bo'ylab oldinga yuring. Son qanday o'sishini kuzating."
      },
      on_done: { ru: 'Ты прошёл вперёд, и число стало больше.', uz: "Oldinga yurdingiz va son kattalashdi." }
    }
  },

  // ---- s1 TEST MC (+): 6 + 3 = 9. options [8,9,10,6] to'g'ri idx1 ----
  s1: {
    eyebrow: { ru: 'Тренировка · 1', uz: 'Mashq · 1' },
    title: { ru: 'Шесть и ещё три. Сколько вместе?', uz: "Olti va yana uch. Birga nechta?" },
    correct_text: { ru: 'Верно. Шесть плюс три равно девять.', uz: "To'g'ri. Olti plyus uch teng to'qqiz." },
  ...
  // ---- s2 EXPLORATION (son o'qi +): 6 + 3 — markerni 6 dan 3 ta oldinga -> 9 ----
  s2: {
    eyebrow: { ru: 'Смотри', uz: 'Qarang' },
    instruction: { ru: 'Шесть плюс три: точка стоит на шести и прыгает вперёд три раза', uz: "Olti plyus uch: nuqta oltida turibdi va uch marta oldinga sakraydi" },
    btn: { ru: 'Прыжок', uz: 'Sakrash' },
    count_label: { ru: 'Точка на', uz: 'Nuqta' },
    done_text: { ru: 'Три прыжка: семь, восемь, девять. Стало девять.', uz: "Uch marta: yetti, sakkiz, to'qqiz. To'qqiz bo'ldi." },
    audio: {
      ru: [
        'Точка стоит на числе шесть. Прибавляем три, значит прыгаем вперёд три раза.',
        'Прыжок — семь.',
        'Прыжок — восемь.',
        'Ещё прыжок — девять. Шесть плюс три равно девять.'
      ],
      uz: [
        "Nuqta olti sonida turibdi. Uch qo'shamiz, demak uch marta oldinga sakraymiz.",
        "Sakrash — yetti.",
        "Sakrash — sakkiz.",
        "Yana sakrash — to'qqiz. Olti plyus uch teng to'qqiz."
      ]
    }
  },

  // ---- s3 RULE: + oldinga, − orqaga (endi 10 gacha) ----
  s3: {
    ...
    tip: {
      ru: 'Прибавить — вперёд, вычесть — назад. До десяти так же.',
      uz: "Qo'shish — oldinga, ayirish — orqaga. O'ngacha ham shunday."
    },
    audio: {
  ...
  // ---- s5 TEST MC (−): 9 − 4 = 5. options [4,5,6,3] to'g'ri idx1 ----
  s5: {
    eyebrow: { ru: 'Тренировка · 3', uz: 'Mashq · 3' },
    title: { ru: 'Было девять, забрали четыре. Сколько осталось?', uz: "To'qqizta edi, to'rttasi olindi. Nechta qoldi?" },
    correct_text: { ru: 'Верно. Девять минус четыре равно пять.', uz: "To'g'ri. To'qqiz minus to'rt teng besh." },
    wrong_0: { ru: 'Это на один меньше. Посчитай оставшиеся по одному.', uz: "Bu bittaga kam. Qolganlarini bittadan sanang." },
    wrong_2: { ru: 'Это на один больше. Забери все четыре и посчитай оставшиеся.', uz: "Bu bittaga ko'p. To'rttala olmani oling va qolganini sanang." },
    wrong_3: { ru: 'Слишком мало. Посчитай ещё раз, не спеша.', uz: "Juda kam. Yana, shoshmasdan sanang." },
    wrong_default: { ru: 'Из девяти убери четыре и посчитай оставшиеся.', uz: "To'qqiztadan to'rttasini oling va qolganini sanang." },
    audio: {
  ...
  // ---- s6 TEST (juftlash): 5+3=8, 10−4=6, 6+1=7 -> 6,7,8 ----
  s6: {
  ...
  // ---- sg MINI-O'YIN (aralash ±10, 3 raund) ----
  sg: {
    ...
    done_text: { ru: 'Молодец! Ты считал до десяти и плюс, и минус.', uz: "Barakalla! Siz o'ngacha qo'shdingiz ham, ayirdingiz ham." },
  ...
  // ---- s8 TEST final + FactCard (+): Ra'no 6 + Anvar 2 = 8. options [8,9,7,6] to'g'ri idx0 ----
  // (6+3 emas — s1/s2 bilan takrorlanmasin, final javob yod olishsiz hisoblansin)
  s8: {
    eyebrow: { ru: 'Итог', uz: 'Yakun' },
    title: { ru: 'Рано собрала 6 яблок, Анвар — ещё 2. Сколько всего?', uz: "Ra'no oltita olma terdi, Anvar yana ikkita. Hammasi nechta?" },
    rano_label: { ru: 'Рано', uz: "Ra'no" },
    anvar_label: { ru: 'Анвар', uz: 'Anvar' },
    zuhra_label: { ru: 'Зухра', uz: 'Zuhra' },
    correct_text: { ru: 'Верно. Шесть плюс два равно восемь.', uz: "To'g'ri. Olti plyus ikki teng sakkiz." },
    wrong_1: { ru: 'Это на один больше. Посчитай обе группы по одному.', uz: "Bu bittaga ko'p. Ikkala guruhni bittadan sanang." },
    wrong_2: { ru: 'Это на один меньше. Прибавь вторую группу и считай дальше.', uz: "Bu bittaga kam. Ikkinchi guruhni qo'shing va davomidan sanang." },
    wrong_3: { ru: 'Это только первая группа. Прибавь вторую и считай дальше.', uz: "Bu faqat birinchi guruh. Ikkinchisini qo'shing va davomidan sanang." },
    wrong_default: { ru: 'Соедини обе группы и посчитай по одному.', uz: "Ikki guruhni birlashtirib, bittadan sanang." },
    fact_badge: { ru: 'А знаешь? · Счёт', uz: 'Bilasizmi? · Sanoq' },
    fact_text: { ru: 'Соберётся десять — начнётся новый десяток.', uz: "O'nta yig'ilsa — yangi o'nlik boshlanadi." },
    fact_audio: { ru: 'А знаешь, десять — особое число. Когда наберётся десять, начинают новый десяток. Об этом узнаешь дальше.', uz: "Bilasizmi, o'n — alohida son. O'nta yig'ilsa, yangi o'nlik boshlanadi. Buni keyin o'rganasiz." },
    audio: {
      intro: { ru: 'Рано собрала шесть яблок. Анвар собрал ещё два. Все яблоки сложили вместе. Посчитай и выбери, сколько всего.', uz: "Ra'no oltita olma terdi. Anvar yana ikkita terdi. Hamma olma birga qo'shildi. Sanang va hammasi nechta ekanini tanlang." },
      on_correct: { ru: 'Верно. Всего восемь.', uz: "To'g'ri. Hammasi sakkiz." },
      on_wrong: { ru: 'Не совсем. Посчитай заново, внимательно.', uz: "Unchalik emas. Qaytadan diqqat bilan sanang." }
    }
  },
  ...
  s9: {
    ...
    main_2_em: { ru: 'считаешь в пределах десяти — и плюс, и минус', uz: "o'n ichida sanaysiz — plyus ham, minus ham" },
    rano_label: { ru: 'Рано', uz: "Ra'no" },
    anvar_label: { ru: 'Анвар', uz: 'Anvar' },
    zuhra_label: { ru: 'Зухра', uz: 'Zuhra' },
    audio: {
      ru: 'Сегодня ты считал в пределах десяти — и складывал, и вычитал. На числовой дорожке вперёд число растёт, назад уменьшается. На следующем уроке узнаем, что от перестановки мест слагаемых сумма не меняется.',
      uz: "Bugun o'n ichida sanadingiz — qo'shdingiz ham, ayirdingiz ham. Sonli yo'lakda oldinga son o'sadi, orqaga kamayadi. Keyingi darsda qo'shiluvchilar o'rin almashsa ham yig'indi o'zgarmasligini bilib olamiz."
    }
  }
};
...
// SentTile — yozuv plitkasi (5 + 3 / 10 − 4). ans != null -> "= N" pop bilan qo'shiladi.
...
const Screen1 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      figure={(solved) => <CombineGroups a={6} b={3} kind="apple" ans={solved ? 9 : null}/>}
      options={[<DigitGlyph d={8} size="mid"/>, <DigitGlyph d={9} size="mid"/>, <DigitGlyph d={10} size="mid"/>, <DigitGlyph d={6} size="mid"/>]}
      correctIdx={1}
      mascot={false}
...
const Screen2 = (props) => {
  ...
  const hop = () => {
    if (!canAct || pos >= 9) return;
    const np = pos + 1; setPos(np);
    if (!audio.muted) { const e = getAudioEngine(); if (e) e.pushOneOff(c.audio[lang][np - 6]); }
  };
  const navContent = (
    <>
      <NavBack onPrev={props.onPrev} label={<BackLabel/>}/>
  ...
  return (
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 2.2vw, 16px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(14px, 2.6vw, 20px)', padding: 'clamp(16px, 3vw, 24px)' }}>
          <NumberLine max={10} marker={pos} path={{ from: 6, to: pos }}/>
          <div className="g1-count-line">
          ...
          {!done && (
            <button className="btn" disabled={!canAct} onClick={hop}
              style={{ padding: 'clamp(10px, 1.6vw, 13px) clamp(20px, 3vw, 30px)', fontSize: 'clamp(14px, 1.8vw, 16px)' }}>
              {t(c.btn)} <span className="mono small" style={{ opacity: 0.7 }}>{hops} / 3</span>
            </button>
          )}
        </div>
        {done && (
...
// s3 — RULE: + oldinga, − orqaga (10 gacha).
const Screen3 = (props) => {
  const lang = useLang();
  const t = useT();
  const c = CONTENT.s3;
...
// s4 — son o'qi scored (+): 7 + 2 = 9.
const Screen4 = (props) => <NumberLineSolve props={props} c={CONTENT.s4} start={7} answer={9} max={10} op="+"/>;
...
const Screen5 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <RemoveRow total={9} gone={4} kind="apple" ans={solved ? 5 : null}/>}
      options={[<DigitGlyph d={4} size="mid"/>, <DigitGlyph d={5} size="mid"/>, <DigitGlyph d={6} size="mid"/>, <DigitGlyph d={3} size="mid"/>]}
      correctIdx={1}
      mascot={false}
      storedAnswer={props.storedAnswer} onAnswer={props.onAnswer}
      onNext={props.onNext} onPrev={props.onPrev}
...
// s6 — TEST (juftlash): 5+3=8, 10−4=6, 6+1=7 -> 6,7,8.
const S6_ITEMS = [{ a: 5, op: '+', b: 3, ans: 8 }, { a: 10, op: '−', b: 4, ans: 6 }, { a: 6, op: '+', b: 1, ans: 7 }];
const S6_TILES = [6, 7, 8];
const Screen6 = (props) => {
  const lang = useLang();
  const t = useT();
  const c = CONTENT.s6;
...
// s7 — son o'qi scored (−): 8 − 3 = 5.
const Screen7 = (props) => <NumberLineSolve props={props} c={CONTENT.s7} start={8} answer={5} max={10} op="−"/>;

// sg — MINI-O'YIN (aralash ±10, 3 raund).
const GAME_ROUNDS = [
  { a: 7, op: '+', b: 2, ans: 9, opts: [8, 9, 10] },
  { a: 10, op: '−', b: 3, ans: 7, opts: [6, 7, 8] },
  { a: 4, op: '+', b: 4, ans: 8, opts: [7, 8, 9] },
];
...
// s8 — TEST final + FactCard (+): 6 + 2 = 8. options [8,9,7,6] to'g'ri idx0.
const Screen8 = (props) => {
  const c = CONTENT.s8;
  const t = useT();
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <CombineGroups a={6} b={2} kind="apple" ans={solved ? 8 : null}/>}
      options={[<DigitGlyph d={8} size="mid"/>, <DigitGlyph d={9} size="mid"/>, <DigitGlyph d={7} size="mid"/>, <DigitGlyph d={6} size="mid"/>]}
      correctIdx={0}
      mascot={false}
      factOnCorrect={(
