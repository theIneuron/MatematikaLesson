...
// ============================================================================
// ░░ 1-SINF · Dars17 — "O'nlikdan o'tib qo'shish" (ten-1-17-v1) · 8+5 = 8+2+3 = 10+3 = 13 · spec: ETALON_1SINF.md ░░
// Dars16 (make-ten) bazasidan. MEXANIKA: MakeTenFrames — ikki javon; avval 1-javon 10 ga to'ladi, qolgani 2-javonga.
// Make-ten qo'shish: avval o'ngacha to'ldir, keyin qolganini. Sahna: maktab (daftar). Jasur bor.
...
const CONTENT = {
  // ---- sIntro: maktab, o'nlikdan o'tib qo'shish ----
  sIntro: {
    eyebrow: { ru: 'История', uz: 'Hikoya' },
    title: { ru: 'Складываем через десяток', uz: "O'nlikdan o'tib qo'shamiz" },
    body: {
      ru: 'В прошлый раз мы научились дополнять до десяти. Сегодня это поможет складывать большие числа: восемь плюс пять. Сначала дополним до десяти, потом добавим остальное.',
      uz: "O'tgan safar o'ngacha to'ldirishni o'rgandik. Bugun bu katta sonlarni qo'shishga yordam beradi: sakkiz plyus besh. Avval o'ngacha to'ldiramiz, keyin qolganini qo'shamiz."
    },
    ...
    audio: {
      ru: [
        'Привет, друг! В прошлый раз мы научились дополнять до десяти.',
        'Сегодня сложим через десяток. Сначала дополним до десяти, потом добавим остальное.',
        'Слушай и нажимай кнопку дальше.'
      ],
      uz: [
        "Salom, do'stim! O'tgan safar o'ngacha to'ldirishni o'rgandik.",
        "Bugun o'nlikdan o'tib qo'shamiz. Avval o'ngacha to'ldiramiz, keyin qolganini qo'shamiz.",
  ...
  s1: {
    ...
    instruction: { ru: 'Восемь тетрадей и нужно добавить пять. Нажми — сделаем через десяток', uz: "Sakkizta daftar, beshta qo'shish kerak. Bosing — o'nlikdan o'tib qo'shamiz" },
    ...
    audio: {
      ru: [
        'У нас восемь тетрадей, и нужно добавить пять. Нажми кнопку сложить.',
        'Сначала два места дополнились до десяти. Потом ещё три в новый ряд. Десять и три — это тринадцать.'
      ],
      uz: [
        "Bizda sakkizta daftar, beshta qo'shish kerak. Qo'shish tugmasini bosing.",
