...
const CONTENT = {
  // ---- sIntro: maktab, o'nlikdan o'tib ayirish ----
  sIntro: {
    eyebrow: { ru: 'История', uz: 'Hikoya' },
    title: { ru: 'Вычитаем через десяток', uz: "O'nlikdan o'tib ayiramiz" },
    body: {
      ru: 'В прошлый раз мы складывали через десяток. Сегодня будем так же вычитать: тринадцать минус пять. Сначала уберём до десяти, потом остальное.',
      uz: "O'tgan safar o'nlikdan o'tib qo'shdik. Bugun xuddi shunday ayiramiz: o'n uch minus besh. Avval o'ngacha tushiramiz, keyin qolganini."
    },
    ...
    audio: {
      ru: [
        'Привет, друг! В прошлый раз мы складывали через десяток.',
        'Сегодня будем так же вычитать. Сначала уберём до десяти, потом остальное.',
        'Слушай и нажимай кнопку дальше.'
      ],
      uz: [
        "Salom, do'stim! O'tgan safar o'nlikdan o'tib qo'shdik.",
        "Bugun xuddi shunday ayiramiz. Avval o'ngacha tushiramiz, keyin qolganini.",
  ...
  s0: {
    ...
    title_part1: { ru: 'Тринадцать минус пять. Сколько', uz: "O'n uch minus besh. Qancha" },
    title_part2_em: { ru: 'останется?', uz: 'qoladi?' },
    title_part3: { ru: '', uz: '' },
    question: { ru: 'Как думаешь? Скоро вычтем вместе.', uz: "Sizningcha-chi? Tez orada birga ayiramiz." },
    opt_yes: { ru: 'Восемь', uz: "Sakkiz" },
    opt_no: { ru: 'Восемнадцать', uz: "O'n sakkiz" },
    opt_idk: { ru: 'Не уверен', uz: 'Ishonchim komil emas' },
    audio: {
      intro: { ru: 'Посмотри: тринадцать минус пять. Как думаешь, сколько останется? Выбери ответ, потом вычтем вместе.', uz: "Qarang: o'n uch minus besh. Sizningcha qancha qoladi? Javobni tanlang, keyin birga ayiramiz." },
      on_correct: { ru: 'Хорошо. Сейчас вычтем.', uz: "Yaxshi. Hozir ayiramiz." },
      on_wrong: { ru: 'Хорошо. Сейчас вычтем.', uz: "Yaxshi. Hozir ayiramiz." }
    }
  },

  // ---- s1 EXPLORATION (DRAG-AYIRISH): 13-5 — bola 5 kitobni O'ZI savatga suradi:
  // avval 3 yakka (aynan o'n qoladi!), keyin o'nlik OCHILIB undan yana 2 -> 8.
  s1: {
    eyebrow: { ru: 'Вычтем через десяток', uz: "O'nlikdan o'tib ayiramiz" },
    instruction: { ru: 'Тринадцать книг. Перетащи пять книг в корзину — через десяток', uz: "O'n uchta kitob. Beshta kitobni savatga suring — o'nlikdan o'tib" },
    ...
    mid_hint: {
      ru: 'Стало ровно десять! Теперь десяток раскрылся — возьми ещё две.',
      uz: "Aynan o'n bo'ldi! Endi o'nlik ochildi — yana ikkitasini oling."
    },
    ...
    audio: {
      ru: [
        'У нас тринадцать книг, нужно убрать пять. Сначала перетащи в корзину три отдельные книги.',
        'Ты убрал три, а потом ещё две из десятка. Тринадцать минус пять — осталось восемь.'
      ],
      uz: [
        "Bizda o'n uchta kitob, beshta olib qo'yish kerak. Avval uchta yakka kitobni savatga suring.",
        "Siz uchtasini oldingiz, keyin o'nlikdan yana ikkitasini. O'n uch minus besh — sakkiz qoldi."
      ]
    }
  },
  ...
  s6: {
    ...
    title: { ru: 'Верно ли: тринадцать минус пять равно восемь?', uz: "To'g'rimi: o'n uch minus besh teng sakkiz?" },
  ...
  // ---- sGuest: o'tib ayirish -> Dars20 (amaliyot) ----
  sGuest: {
    eyebrow: { ru: 'История', uz: 'Hikoya' },
    title: { ru: 'Скоро — потренируемся дома', uz: "Tez orada — uyda mashq qilamiz" },
    body: {
      ru: 'Теперь мы умеем вычитать через десяток. В следующий раз потренируемся дома и закрепим: и сложение, и вычитание через десяток.',
      uz: "Endi o'nlikdan o'tib ayirishni bilamiz. Keyingi safar uyda mashq qilib mustahkamlaymiz: ham qo'shish, ham ayirish o'nlikdan o'tib."
    },
    bit_label: { ru: 'Бит', uz: 'Bit' },
    rano_label: { ru: 'Рано', uz: "Ra'no" },
    anvar_label: { ru: 'Анвар', uz: 'Anvar' },
    ...
    audio: {
      ru: [
        'Теперь мы умеем вычитать через десяток.',
        'В следующий раз потренируемся дома и закрепим сложение и вычитание.',
        'Молодец! Слушай и нажимай кнопку дальше.'
      ],
      uz: [
        "Endi o'nlikdan o'tib ayirishni bilamiz.",
        "Keyingi safar uyda mashq qilib qo'shish va ayirishni mustahkamlaymiz.",
  ...
  s9: {
    ...
    main_2_em: { ru: 'вычитать через десяток', uz: "o'nlikdan o'tib ayirish" },
    rano_label: { ru: 'Рано', uz: "Ra'no" },
    anvar_label: { ru: 'Анвар', uz: 'Anvar' },
    zuhra_label: { ru: 'Зухра', uz: 'Zuhra' },
    jasur_label: { ru: 'Жасур', uz: 'Jasur' },
    audio: {
      ru: 'Сегодня ты вычитал через десяток: сначала до десяти, потом остальное. Тринадцать минус пять — восемь. В следующий раз потренируемся.',
      uz: "Bugun o'nlikdan o'tib ayirdingiz: avval o'ngacha, keyin qolgani. O'n uch minus besh — sakkiz. Keyingi safar mashq qilamiz."
    }
  }
};
...
// o'nlik OCHILIB (8 + 2 yakka ko'rinadi), undan yana 2 olinadi -> 8. Dars13 naqshi.
    ...
    setRemoved((prev) => {
      ...
      if (!audio.muted) {
        ...
        if (e) {
          ...
          if (n.size === S1_ONES3.length) e.pushOneOff(c.mid_hint[lang]);   // "aynan o'n bo'ldi!"
        }
      }
...
const Screen3 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      options={[<DigitGlyph d={8} size="mid"/>, <DigitGlyph d={7} size="mid"/>, <DigitGlyph d={6} size="mid"/>, <DigitGlyph d={2} size="mid"/>]}
      correctIdx={1}
      mascot={false}
...
const Screen4 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      options={[<DigitGlyph d={9} size="mid"/>, <DigitGlyph d={7} size="mid"/>, <DigitGlyph d={8} size="mid"/>, <DigitGlyph d={4} size="mid"/>]}
      correctIdx={2}
      mascot={false}
      storedAnswer={props.storedAnswer} onAnswer={props.onAnswer}
      onNext={props.onNext} onPrev={props.onPrev}
...
const Screen5 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      options={[<DigitGlyph d={3} size="mid"/>, <DigitGlyph d={8} size="mid"/>, <DigitGlyph d={10} size="mid"/>, <DigitGlyph d={9} size="mid"/>]}
      correctIdx={3}
      mascot={false}
      storedAnswer={props.storedAnswer} onAnswer={props.onAnswer}
      onNext={props.onNext} onPrev={props.onPrev}
...
const Screen8 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      options={[<DigitGlyph d={9} size="mid"/>, <DigitGlyph d={7} size="mid"/>, <DigitGlyph d={8} size="mid"/>, <DigitGlyph d={3} size="mid"/>]}
      correctIdx={2}
      mascot={false}
      factOnCorrect={(
