...
const PairViz = ({ a, b, sign = null, solved = false }) => {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 'clamp(10px, 3vw, 26px)', flexWrap: 'wrap' }}>
      <AppleViz tens={pa.tens} ones={pa.ones} pop={solved}/>
      {sign && <CompareSign dir={sign} big/>}
      <AppleViz tens={pb.tens} ones={pb.ones} pop={solved}/>
    </div>
  );
};
...
const Screen4 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      figure={(solved) => <PairViz a={38} b={53} solved={solved}/>}
...
const Screen8 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub" style={{ textAlign: 'center' }}>{t(c.title)}</h2>}
      figure={(solved) => <PairViz a={47} b={51} solved={solved}/>}
...
const Screen9 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub" style={{ textAlign: 'center' }}>{t(c.title)}</h2>}
      figure={(solved) => <PairViz a={46} b={64} solved={solved}/>}
