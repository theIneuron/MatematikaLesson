...
// ============================================================================
// ░░ 1-SINF · Dars18 — "O'tib qo'shish (amaliyot)" (ten-1-18-v1) · 20 ichida o'nlikdan o'tib qo'shish mashqi · spec: ETALON_1SINF.md ░░
// Dars17 (o'tib qo'shish) bazasidan. MEXANIKA: MakeTenFrames (olma). Sahna: BOZOR (olma).
// Make-ten qo'shish amaliyoti. Mustaqil mashq. Jasur bor.
...
const LESSON_META = {
  lessonId: 'ten-1-18-v1',
  lessonTitle: { ru: 'Сложение через десяток — практика', uz: "O'tib qo'shish — amaliyot" }
};
const SCREEN_META = [
...
const CONTENT = {
  ...
  sIntro: {
    ...
    title: { ru: 'Складываем на базаре', uz: "Bozorda qo'shamiz" },
    body: {
      ru: 'Друзья снова на базаре, тут много яблок. Сегодня сами потренируемся складывать через десяток: восемь яблок и ещё пять. Сначала дополним до десяти, потом остальное.',
      uz: "Do'stlar yana bozorda, bu yerda olma ko'p. Bugun o'nlikdan o'tib qo'shishni o'zimiz mashq qilamiz: sakkizta olma va yana besh. Avval o'ngacha to'ldiramiz, keyin qolganini."
    },
    ...
    audio: {
      ru: [
        'Привет, друг! Друзья снова на базаре, тут много яблок.',
        'Сегодня сами потренируемся складывать через десяток. Сначала дополним до десяти, потом остальное.',
        'Слушай и нажимай кнопку дальше.'
      ],
      uz: [
        "Salom, do'stim! Do'stlar yana bozorda, bu yerda olma ko'p.",
        "Bugun o'nlikdan o'tib qo'shishni o'zimiz mashq qilamiz. Avval o'ngacha to'ldiramiz, keyin qolganini.",
        "Tinglang va davom tugmasini bosing."
      ]
    }
  },

  // ---- s0 HOOK (soft): 8 + 5 — javob 10 dan katta. Qancha? ----
  s0: {
    eyebrow: { ru: 'Загадка', uz: 'Topishmoq' },
    title_part1: { ru: 'Восемь плюс пять. Ответ больше десяти —', uz: "Sakkiz plyus besh. Javob o'ndan katta —" },
    title_part2_em: { ru: 'сколько?', uz: 'qancha?' },
    title_part3: { ru: '', uz: '' },
    question: { ru: 'Как думаешь? Скоро сложим вместе.', uz: "Sizningcha-chi? Tez orada birga qo'shamiz." },
    opt_yes: { ru: 'Тринадцать', uz: "O'n uch" },
    opt_no: { ru: 'Три', uz: "Uch" },
    opt_idk: { ru: 'Не уверен', uz: 'Ishonchim komil emas' },
    audio: {
      intro: { ru: 'Посмотри: восемь плюс пять. Ответ будет больше десяти. Как думаешь, сколько? Выбери ответ, потом сложим вместе.', uz: "Qarang: sakkiz plyus besh. Javob o'ndan katta bo'ladi. Sizningcha qancha? Javobni tanlang, keyin birga qo'shamiz." },
      on_correct: { ru: 'Хорошо. Сейчас сложим.', uz: "Yaxshi. Hozir qo'shamiz." },
      on_wrong: { ru: 'Хорошо. Сейчас сложим.', uz: "Yaxshi. Hozir qo'shamiz." }
    }
  },
  ...
  s1: {
    ...
    instruction: { ru: 'Восемь яблок и нужно добавить пять. Нажми — сделаем через десяток', uz: "Sakkizta olma, beshta qo'shish kerak. Bosing — o'nlikdan o'tib qo'shamiz" },
    ...
    audio: {
      ru: [
        'У нас восемь яблок, и нужно добавить пять. Нажми кнопку сложить.',
        'Сначала два места дополнились до десяти. Потом ещё три в новый ряд. Десять и три — это тринадцать.'
      ],
      uz: [
        "Bizda sakkizta olma, beshta qo'shish kerak. Qo'shish tugmasini bosing.",
  ...
  s2: {
    ...
    title_part1: { ru: 'Через десяток —', uz: "O'nlikdan o'tib —" },
  ...
  s3: {
    ...
    wrong_1: { ru: 'Чуть меньше. Семь и три десять, и ещё два — двенадцать.', uz: "Sal kam. Yetti va uch o'n, yana ikki — o'n ikki." },
    wrong_2: { ru: 'Чуть больше. Считай через десяток: получится двенадцать.', uz: "Sal ko'p. O'nlikdan o'tib sana: o'n ikki chiqadi." },
    wrong_default: { ru: 'Семь плюс пять — это двенадцать.', uz: "Yetti plyus besh — bu o'n ikki." },
    audio: {
  ...
  s4: {
    ...
    wrong_1: { ru: 'Чуть меньше. Девять и один десять, и ещё три — тринадцать.', uz: "Sal kam. To'qqiz va bir o'n, yana uch — o'n uch." },
    wrong_2: { ru: 'Чуть больше. Через десяток выходит тринадцать.', uz: "Sal ko'p. O'nlikdan o'tib o'n uch chiqadi." },
    wrong_default: { ru: 'Девять плюс четыре — это тринадцать.', uz: "To'qqiz plyus to'rt — bu o'n uch." },
    audio: {
  ...
  s5: {
    ...
    wrong_1: { ru: 'Чуть меньше. Восемь и два десять, и ещё четыре — четырнадцать.', uz: "Sal kam. Sakkiz va ikki o'n, yana to'rt — o'n to'rt." },
    wrong_2: { ru: 'Чуть больше. Через десяток выходит четырнадцать.', uz: "Sal ko'p. O'nlikdan o'tib o'n to'rt chiqadi." },
    wrong_default: { ru: 'Восемь плюс шесть — это четырнадцать.', uz: "Sakkiz plyus olti — bu o'n to'rt." },
    audio: {
  ...
  s6: {
    ...
    wrong_1: { ru: 'Это верно. Восемь плюс пять — тринадцать.', uz: "Bu to'g'ri. Sakkiz plyus besh — o'n uch." },
    wrong_default: { ru: 'Восемь плюс пять — это тринадцать.', uz: "Sakkiz plyus besh — bu o'n uch." },
    audio: {
  ...
  s7: {
    ...
    title: { ru: 'Семь плюс шесть. Сколько получится?', uz: "Yetti plyus olti. Nechta bo'ladi?" },
    correct_text: { ru: 'Верно. Семь и три это десять, и ещё три — тринадцать.', uz: "To'g'ri. Yetti va uch o'n, yana uch — o'n uch." },
    wrong_1: { ru: 'Чуть меньше. Семь и три десять, и ещё три — тринадцать.', uz: "Sal kam. Yetti va uch o'n, yana uch — o'n uch." },
    wrong_2: { ru: 'Чуть больше. Через десяток выходит тринадцать.', uz: "Sal ko'p. O'nlikdan o'tib o'n uch chiqadi." },
    wrong_default: { ru: 'Семь плюс шесть — это тринадцать.', uz: "Yetti plyus olti — bu o'n uch." },
    audio: {
      intro: { ru: 'Семь плюс шесть. Дополни до десяти, потом остальное. Сколько? Выбери ответ.', uz: "Yetti plyus olti. O'ngacha to'ldir, keyin qolgani. Nechta? Javobni tanlang." },
      on_correct: { ru: 'Верно. Тринадцать.', uz: "To'g'ri. O'n uch." },
      on_wrong: { ru: 'Не совсем. Посмотри разбор справа.', uz: "Unchalik emas. O'ngdagi tushuntirishga qarang." }
    }
  },
  ...
  // ---- sGuest SYUJET KO'PRIK: o'tib qo'shish -> Dars18 (amaliyot) ----
  sGuest: {
    eyebrow: { ru: 'История', uz: 'Hikoya' },
    title: { ru: 'Скоро — потренируемся', uz: "Tez orada — mashq qilamiz" },
    body: {
      ru: 'Теперь мы умеем складывать через десяток. В следующий раз потренируемся на базаре: будем складывать яблоки и считать через десяток сами.',
      uz: "Endi o'nlikdan o'tib qo'shishni bilamiz. Keyingi safar bozorda mashq qilamiz: olmalarni qo'shib, o'nlikdan o'tib o'zimiz sanaymiz."
    },
    bit_label: { ru: 'Бит', uz: 'Bit' },
    rano_label: { ru: 'Рано', uz: "Ra'no" },
    anvar_label: { ru: 'Анвар', uz: 'Anvar' },
    ...
    audio: {
      ru: [
        'Теперь мы умеем складывать через десяток.',
        'В следующий раз потренируемся на базаре: будем складывать через десяток сами.',
        'Молодец! Слушай и нажимай кнопку дальше.'
      ],
      uz: [
        "Endi o'nlikdan o'tib qo'shishni bilamiz.",
        "Keyingi safar bozorda mashq qilamiz: o'nlikdan o'tib o'zimiz sanaymiz.",
  ...
  s8: {
    ...
    correct_text: { ru: 'Верно. Восемь и два десять, и ещё три — тринадцать.', uz: "To'g'ri. Sakkiz va ikki o'n, yana uch — o'n uch." },
    wrong_1: { ru: 'Чуть меньше. Через десяток выходит тринадцать.', uz: "Sal kam. O'nlikdan o'tib o'n uch chiqadi." },
    wrong_2: { ru: 'Чуть больше. Восемь и два десять, и ещё три — тринадцать.', uz: "Sal ko'p. Sakkiz va ikki o'n, yana uch — o'n uch." },
    wrong_default: { ru: 'Восемь плюс пять — это тринадцать.', uz: "Sakkiz plyus besh — bu o'n uch." },
  ...
  s9: {
    ...
    main_2_em: { ru: 'складывать через десяток', uz: "o'nlikdan o'tib qo'shish" },
    rano_label: { ru: 'Рано', uz: "Ra'no" },
    anvar_label: { ru: 'Анвар', uz: 'Anvar' },
    zuhra_label: { ru: 'Зухра', uz: 'Zuhra' },
    jasur_label: { ru: 'Жасур', uz: 'Jasur' },
...
// Niderlandiya metodi: har qatorda 10 munchoq (5 qizil + 5 oq, 5-tuzilma). active = chapga surilgan munchoqlar.
...
const TenSlots = ({ filled = 0, fillTo = null, kind = 'apple' }) => (
    ...
    {Array.from({ length: 10 }).map((_, i) => {
      ...
      return (
        <span key={i} className={`g1-slot ${(has || newly) ? 'on' : ''} ${newly ? 'g1-slot-new' : ''}`}
          ...
          {(has || newly) && (kind === 'apple' ? <Apple/> : <Book tone={i}/>)}
        </span>
      );
    })}
  </div>
...
// ===== MAKE-TEN QO'SHISH: ikki javon — 1-javon o'ngacha to'ladi, qolgani 2-javonga =====
const MakeTenFrames = ({ a = 0, b = 0, done = false }) => {
  const need = Math.max(0, 10 - a);
  const rest = Math.max(0, b - need);
  return (
    <div className="g1-mt2" aria-hidden="true">
      <TenSlots filled={a} fillTo={done ? Math.min(10, a + b) : null}/>
      {done && rest > 0 && <span className="g1-mt2-plus">+</span>}
      {done && rest > 0 && <TenSlots filled={0} fillTo={rest}/>}
    </div>
  );
};
...
const Screen3 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      figure={(solved) => <MakeTenFrames a={7} b={5} done={solved}/>}
      options={[<DigitGlyph d={12} size="mid"/>, <DigitGlyph d={11} size="mid"/>, <DigitGlyph d={13} size="mid"/>, <DigitGlyph d={2} size="mid"/>]}
      correctIdx={0}
      mascot={false}
...
const Screen4 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <MakeTenFrames a={9} b={4} done={solved}/>}
      options={[<DigitGlyph d={13} size="mid"/>, <DigitGlyph d={12} size="mid"/>, <DigitGlyph d={14} size="mid"/>, <DigitGlyph d={3} size="mid"/>]}
      correctIdx={0}
      mascot={false}
      storedAnswer={props.storedAnswer} onAnswer={props.onAnswer}
      onNext={props.onNext} onPrev={props.onPrev}
...
const Screen5 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <MakeTenFrames a={8} b={6} done={solved}/>}
      options={[<DigitGlyph d={14} size="mid"/>, <DigitGlyph d={13} size="mid"/>, <DigitGlyph d={15} size="mid"/>, <DigitGlyph d={4} size="mid"/>]}
      correctIdx={0}
      mascot={false}
      storedAnswer={props.storedAnswer} onAnswer={props.onAnswer}
      onNext={props.onNext} onPrev={props.onPrev}
...
const Screen7 = (props) => {
  ...
  return (
    <QuestionScreen
      ...
      screenMeta={SCREEN_META[props.screen]} screenContent={c}
      question={<h2 className="title h-sub">{t(c.title)}</h2>}
      figure={(solved) => <MakeTenFrames a={7} b={6} done={solved}/>}
      options={[<DigitGlyph d={13} size="mid"/>, <DigitGlyph d={12} size="mid"/>, <DigitGlyph d={14} size="mid"/>, <DigitGlyph d={1} size="mid"/>]}
      correctIdx={0}
      mascot={false}
      storedAnswer={props.storedAnswer} onAnswer={props.onAnswer}
      onNext={props.onNext} onPrev={props.onPrev}
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 2.2vw, 16px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(14px, 2.6vw, 20px)', padding: 'clamp(14px, 2.6vw, 22px)' }}>
          <MakeTenFrames key={ri} a={round.a} b={round.b} done={solvedItem}/>
          {!solvedItem && (
...
/* === Dars18 — BOZOR sahnasi jonli harakatlari === */
...
/* === Dars18 — OLMA / yashik (bozor sanoq metodi) === */
