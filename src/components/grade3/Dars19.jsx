...
// ============================================================================
// DD 3-SINF | Dars19 — "Ikki xonali sonni bir xonaliga ko'paytirish" (num-3-19) | Б3 boshi
...
// SAHNA (metodist qoidasi: 1-10-darsdan olib qayta ishlash): 3-darsning maydoni
...
//   TAP + MC (o'rin almashtirish), bitta savolli MC (17-darsning soat ekranidan, soatsiz),
//   NumPad trenajyor + CheckStrip, konsol (1-dars uslubi, 16-darsning `MeasureCell`i),
//   masala (yozuv + jadval + ikki qadam javob + tekshirish), final panel + FactCard.
//   Test ekranlarida RASM YO'Q (metodist qoidasi 16-darsdan).
// KO'CHIRILGAN: `MeasureCell` va `TaskTable` (16-dars), `FoldRow` (14-dars), CheckStrip
//   (15-16-dars), sahna karkasi (3-dars).
...
// YADRO: 23 · 4 — yig'indini ko'paytirish (12-dars) davomi. USTUN YO'Q (u 23-darsda).
...
// Kontent: src/books/grade3/KONTENT_3SINF.md, «Dars 19» (tasdiq 2026-08-05).
//
...
// STRUKTURA (KONTENT_3SINF.md «Dars 19»): s0 xuk (buyurtma 4 × 23) · s1 modul qismlarga
...
const CONTENT = {
  ...
  s4: {
    ...
    rule_lines: {
      ru: [
        ...
        'сложи результаты — умножение суммы, урок 12'
      ],
      uz: [
        "sonni o'nlik va birlikka ajrating",
        "har bir qismni alohida ko'paytiring",
        "natijalarni qo'shing — yig'indini ko'paytirish, 12-dars"
      ]
    },
  ...
  s5: {
    ...
    line0: '3 · 27 = 27 · 3',
    line0_cap: { ru: 'перестановка, урок 10', uz: "o'rin almashtirish, 10-dars" },
    line1: '27 · 3 = 20 · 3 + 7 · 3',
    line2: '60 + 21 = 81',
...
// --- KETMA-KET OCHILISH: audio segmenti YOKI taymer (metodist qoidasi: ovozsiz ham dars
// to'liq o'tilishi kerak). Ovoz o'chiq bo'lsa dvijok segment bermaydi (useAudio: !state.muted)
// — shuning uchun ochilish taymer bilan yuradi. Ovoz yoniq bo'lsa taymer FAQAT zaxira
// (uzoq kechikish): normal holatda segment birinchi keladi, TTS jim qolsa ekran qotmaydi.
// KETMA-KET OCHILISH — BOLANING TAP'i bilan (taymer yoki audio-flaglarga TAYANMAYDI).
...
// --- KONSOL YACHEYKASI (1-darsdan ko'chirilgan `.lm-cons*` uslubi, 16-darsning komponenti):
...
// --- DARSLIK JADVALI (16-darsdan): uch ustun, shapka tepada, haqiqiy chiziqlar.
...
// --- IFODA SVYORTKASI (14-darsdan `FoldRow`): juftlik yonadi, natija yashil chiqadi.
const FoldRow = ({ items }) => (
...
// --- BITTA SAVOLLI MC (17-darsning soat ekrani naqshi, SOATSIZ): variantlar aralashadi,
...
// --- BITTA TOPSHIRIQLI NumPad TRENAJYOR (17-darsning s11 naqshi, bitta misolga): javob
...
// s3 — BIRLIKLAR va YIG'INDI: 3 · 4 = 12, keyin 80 + 12 = 92 (14-darsning svyortkasi)
const Screen3 = (props) => {
  const lang = useLang();
  const t = useT();
  const sfx = useSfx();
...
// s10 — KONSOL: 7 · 12 uch qadamda (1-dars uslubi, 16-darsning MeasureCell'i)
...
/* --- KONSOL (1-dars uslubi, 16-darsdan ko'chirilgan CSS) --- */
...
/* --- DARSLIK JADVALI (16-darsdan ko'chirilgan CSS) --- */
...
/* --- IFODA SVYORTKASI (14-darsdan ko'chirilgan CSS) --- */
