        ...
        {true && (
          <>
            ...
            <div className="frame fade-up delay-1" style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(10px, 2vw, 14px)', padding: 'clamp(12px, 2.4vw, 18px)' }}>
              ...
              <NumPad value={val} setValue={(next) => { setVal(next); setChecked(false); }} disabled={!canAct || (checked && roundOk) || done} max={4}/>
            ...
            {it.kind === 'num' ? (
              <>
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <NumPad value={val} setValue={(next) => { setVal(next); setNumWrong(false); }} disabled={!canAct || numLock} max={4}/>
                </div>
                <div style={{ display: 'flex', justifyContent: 'center' }}>
