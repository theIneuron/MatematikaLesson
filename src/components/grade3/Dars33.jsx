...
export default function Dars33() {
  return (
    <Grade3LessonShell
      screens={SCREENS}
      titleUz="33-dars. Bir xil maxrajli kasrlarni qo'shish va ayirish"
      titleRu="Урок 33. Сложение и вычитание дробей с одинаковыми знаменателями"
    />
  );
}
