...
const CONTENT = {
  s0: {
    ...
    count: 69,
    baskets: 3,
    grid_cap: { ru: 'Плодов 69, корзин 3. Готового табличного случая для 69 ÷ 3 нет.', uz: "Meva 69 ta, savat 3 ta. 69 ÷ 3 uchun tayyor jadval holati yo'q." },
    opt0: { ru: '66', uz: '66' },
    opt1: { ru: '23', uz: '23' },
    opt2: { ru: '21', uz: '21' },
    audio: {
  ...
  s4: {
    ...
    done_text: { ru: 'Шестьдесят девять разделить на три — двадцать три. Для каждой корзины сложили долю от большой и маленькой частей.', uz: "Oltmish to'qqizni uchga bo'lsak — yigirma uch. Har bir savat uchun katta va kichik bo'lakdan tushgan ulushlarni qo'shdik." },
    audio: {
      ru: [
  ...
  s5: {
    ...
    done_text: { ru: 'Четыре шага: разложить на удобные части, разделить каждую и сложить результаты.', uz: "To'rtta qadam: qulay bo'laklarga ajratish, har birini bo'lish va natijalarni qo'shish." },
    audio: {
      ru: [
  ...
  s6: {
    ...
    rule: { ru: 'Чтобы разделить сумму на число, делим на это число каждое удобное слагаемое и складываем результаты. Все части должны делиться без остатка.', uz: "Yig'indini songa bo'lish uchun har bir qulay qo'shiluvchini shu songa bo'lamiz va natijalarni qo'shamiz. Barcha bo'laklar qoldiqsiz bo'linishi kerak." },
  ...
  s7: {
    ...
    audio: {
      ...
      on_correct: { ru: 'Верно. Сумма сохранилась, и обе части делятся без остатка.', uz: "To'g'ri. Yig'indi o'zgarmadi va ikkala bo'lak ham qoldiqsiz bo'linadi." },
  ...
  s8: {
    ...
    audio: {
      ...
      on_correct: { ru: 'Верно. Обе удобные части разделены и результаты сложены.', uz: "To'g'ri. Ikkala qulay bo'lak bo'lindi va natijalar qo'shildi." },
  ...
  s9: {
    ...
    audio: {
      ...
      on_correct: { ru: 'Верно. Ошибка найдена в разряде или в неделённой части.', uz: "To'g'ri. Xato xona qiymatida yoki bo'linmay qolgan bo'lakda topildi." },
  ...
  s10: {
    ...
    audio: {
      ...
      on_correct: { ru: 'Верно. Для деления выбраны удобные части.', uz: "To'g'ri. Bo'lish uchun qulay bo'laklar tanlandi." },
      on_wrong: { ru: 'Не совсем. Посмотри подсказку.', uz: "Unchalik emas. Maslahatga qarang." }
    }
  },
  ...
  s12: {
    ...
    fact_text: { ru: 'Листья на многих растениях располагаются вокруг стебля так, чтобы меньше заслонять друг другу свет. Природа тоже умеет распределять пространство.', uz: "Ko'plab o'simliklarda barglar bir-birining yorug'ligini kamroq to'sadigan tarzda poya atrofida joylashadi. Tabiat ham joyni taqsimlay oladi." },
    fact_audio: { ru: 'Листья на многих растениях располагаются вокруг стебля так, чтобы меньше заслонять друг другу свет. Природа тоже умеет распределять пространство.', uz: "Ko'plab o'simliklarda barglar bir-birining yorug'ligini kamroq to'sadigan tarzda poya atrofida joylashadi. Tabiat ham joyni taqsimlay oladi." },
    audio: {
      ...
      on_correct: { ru: 'Верно. Каждое слагаемое разделено на один и тот же делитель.', uz: "To'g'ri. Har bir qo'shiluvchi bir xil bo'luvchiga bo'lindi." },
      on_wrong: { ru: 'Проверь две вещи: сумма должна сохраниться, а каждая выбранная часть — делиться без остатка.', uz: "Ikki narsani tekshiring: yig'indi o'zgarmasin va tanlangan har bir bo'lak qoldiqsiz bo'linsin." }
    }
  },
...
const GardenTerraceBg = ({ split = false }) => (
  <svg className="lm-scene-bg" viewBox="0 0 400 230" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
    ...
    {/* --- MARKAZIY ASBOB (Dars12): HOSIL TAQSIMI — uyum va uchta savat --- */}
    {/* hosil uyumi (chapda) */}
