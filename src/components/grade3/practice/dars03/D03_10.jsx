// Dars 3 (3-sinf) · Amaliyot 10 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi 4-bet sonlari (427, 341, 750). Xato yozuv: 341 = 3 + 4 + 1 (raqam yuzi, M1).
...
/* =================== 10 · Xatoni toping · 🔴 · find_error =================== */
const D10_TAG = 'find_error_expand', D10_LEVEL = '🔴', D10_CORRECT = 1;
const D10_T = {
  uz: {
    eyebrow: 'Xatoni toping', setup: "Uchta yoyilma yozildi. Bittasida xato bor.",
    ask: 'Qaysi yozuv XATO? Uni bosing.',
    opts: ['427 = 400 + 20 + 7', '341 = 3 + 4 + 1', '750 = 700 + 50'],
    correct: "To'g'ri topdingiz! 341 = 300 + 40 + 1 bo'lishi kerak. 3 + 4 + 1 = 8 — bu son qaytmaydi: yoyilmada raqamlar emas, qiymatlar yoziladi.",
    wrong: "Maslahat: har yoyilmani tekshiring: qo'shiluvchilarni qo'shsangiz son qaytadimi? Qaysi birida raqamlar qiymatsiz yozilgan?",
    rule: "Yoyilma tekshiruvi: qo'shiluvchilar yig'indisi sonning o'ziga teng bo'lishi shart.",
  },
  ru: {
    eyebrow: 'Найди ошибку', setup: 'Записаны три разложения. В одном — ошибка.',
    ask: 'Какая запись НЕВЕРНА? Нажми на неё.',
    opts: ['427 = 400 + 20 + 7', '341 = 3 + 4 + 1', '750 = 700 + 50'],
    correct: 'Верно! Должно быть 341 = 300 + 40 + 1. А 3 + 4 + 1 = 8 — число не возвращается: в разложении пишутся значения, а не цифры.',
    wrong: 'Подсказка: проверь каждое разложение: если сложить слагаемые, вернётся ли число? Где цифры записаны без значений?',
