// Dars 3 (3-sinf) · Amaliyot 03 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 4-bet 7-mashq qatoridagi yig'indilar (200+80+9, 300+40+1, 600+20+5).
// Mexanika: moslash — son ↔ yoyilma. Hammasi-yoki-hech.
...
/* =================== 03 · Moslashtiring (son ↔ yoyilma) · 🟢 · match_expand =================== */
const D03_TAG = 'match_expand', D03_LEVEL = '🟢';
const D03_NUMS = ['289', '341', '625'];
const D03_EXP = { '289': '200 + 80 + 9', '341': '300 + 40 + 1', '625': '600 + 20 + 5' };
const D03_T = {
  uz: {
    eyebrow: 'Moslashtiring', setup: "Har son o'z yoyilmasiga ulanishi kerak.",
    ask: "Sonni bosing, keyin mos yoyilmani bosing.",
    correct: "To'g'ri! 289 = 200+80+9, 341 = 300+40+1, 625 = 600+20+5.",
    wrong: "Maslahat: sonning birinchi raqami yoyilmadagi yuzlik bilan mos kelishi kerak. Avval yuzliklarni solishtiring, keyin o'nliklarni.",
    rule: "Yoyilma sonning razryadlarini ochib beradi: yuzlik + o'nlik + birlik.",
  },
  ru: {
    eyebrow: 'Соедини пары', setup: 'Каждое число должно соединиться со своим разложением.',
    ask: 'Нажми число, потом его разложение.',
    correct: 'Верно! 289 = 200+80+9, 341 = 300+40+1, 625 = 600+20+5.',
    wrong: 'Подсказка: первая цифра числа должна совпадать с сотнями в разложении. Сначала сравни сотни, потом десятки.',
