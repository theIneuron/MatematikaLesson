// Dars 3 (3-sinf) · Amaliyot 05 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 4-bet 4-mashq — 854 soni (854 − 50 − 4 turkumidan).
// Chalg'ituvchilar: 8+5+4 (raqam yuzi, M1 misconception) va 800+5+4 (o'nlik qiymati yo'qolgan, M4).
...
/* =================== 05 · 854 yoyilmasi · 🟡 · decompose_digit_trap =================== */
const D05_TAG = 'decompose_digit_trap', D05_LEVEL = '🟡', D05_CORRECT = 0;
const D05_T = {
  uz: {
    eyebrow: 'Yoyilmani toping', setup: "Displeyda 854. Yoyilmada raqamlar emas, ularning QIYMATLARI yoziladi.",
    ask: "854 sonining yoyilmasi qaysi?",
    opts: ['800 + 50 + 4', '8 + 5 + 4', '800 + 5 + 4'],
    correct: "To'g'ri! 854 = 800 + 50 + 4: 5 raqami o'nliklar joyida, demak u 50.",
    wrong: "Maslahat: yoyilmada raqamning o'zi emas, qiymati yoziladi. 8 yuzliklar joyida — bu 800. 5 o'nliklar joyida — bu necha?",
    rule: "854 = 800 + 50 + 4. Raqamlarni oddiy qo'shsak (8+5+4=17) son qaytmaydi.",
  },
  ru: {
    eyebrow: 'Найди разложение', setup: 'На дисплее 854. В разложении пишутся не цифры, а их ЗНАЧЕНИЯ.',
    ask: 'Какое разложение числа 854 верно?',
    opts: ['800 + 50 + 4', '8 + 5 + 4', '800 + 5 + 4'],
    correct: 'Верно! 854 = 800 + 50 + 4: цифра 5 стоит на месте десятков, значит это 50.',
    wrong: 'Подсказка: в разложении пишется не сама цифра, а её значение. 8 на месте сотен — это 800. 5 на месте десятков — это сколько?',
...
function D03_05Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: t.opts.map((l, i) => ({ id: String(i), label: l })), studentAnswer: { idx: picked, label: t.opts[picked] }, correctAnswer: { idx: D05_CORRECT, label: t.opts[D05_CORRECT] }, correct, meta: { tag: D05_TAG, level: D05_LEVEL } });
