// Dars 3 (3-sinf) · Amaliyot 01 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 4-bet 4-mashq — 427 soni (razryadlarga ajratish turkumi).
...
/* =================== 01 · Yoyilmani toping (427) · 🟢 · decompose =================== */
// Chalg'ituvchilar: 400+2+7 (o'nlik qiymati yo'qolgan, M4), 40+20+7 (yuzlik qiymati xato).
const D01_TAG = 'decompose', D01_LEVEL = '🟢', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: "Razryad qo'shiluvchilari", setup: "Displeyda 427 soni. Uni razryad qo'shiluvchilariga ajratamiz.",
    ask: "427 sonining yoyilmasi qaysi?",
    opts: ['400 + 20 + 7', '400 + 2 + 7', '40 + 20 + 7'],
    correct: "To'g'ri! 427 = 400 + 20 + 7: to'rt yuzlik, ikki o'nlik, yetti birlik.",
    wrong: "Maslahat: har raqamning QIYMATINI oling: 4 yuzliklar joyida — demak u nechani bildiradi? 2 o'nliklar joyida-chi?",
    rule: "Yoyilmada har raqam o'z qiymati bilan yoziladi: 427 = 400 + 20 + 7.",
  },
  ru: {
    eyebrow: 'Разрядные слагаемые', setup: 'На дисплее число 427. Разложим его на разрядные слагаемые.',
    ask: 'Какое разложение числа 427 верно?',
    opts: ['400 + 20 + 7', '400 + 2 + 7', '40 + 20 + 7'],
    correct: 'Верно! 427 = 400 + 20 + 7: четыре сотни, два десятка, семь единиц.',
    wrong: 'Подсказка: бери ЗНАЧЕНИЕ каждой цифры: 4 стоит на месте сотен — значит, сколько это? А 2 на месте десятков?',
    rule: 'В разложении каждая цифра записывается со своим значением: 427 = 400 + 20 + 7.',
  },
};
