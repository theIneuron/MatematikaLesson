// Dars 3 (3-sinf) · Amaliyot 02 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 4-bet 7-mashq — «birliklar yig'indisini toping»: 400 + 40 + 6.
...
/* =================== 02 · Yig'indini toping (400+40+6) · 🟢 · compose_sum =================== */
const D02_ANS = '446';
const D02_T = {
  uz: {
    eyebrow: "Yig'indini toping", setup: "Displeyda razryad qo'shiluvchilari yig'indisi turibdi.",
    ask: "400 + 40 + 6 — qanday son hosil bo'ladi? Raqam-plitada tering.",
    expr: '400 + 40 + 6',
    correct: "To'g'ri! 400 + 40 + 6 = 446: yuzlik, o'nlik va birlik o'z joyiga tushdi.",
    wrong: "Maslahat: 400 — yuzliklar, 40 — o'nliklar, 6 — birliklar. Har birini o'z razryad katagiga qo'ying.",
    rule: "Yoyilmadan son yig'iladi: 400 + 40 + 6 = 446.",
  },
  ru: {
    eyebrow: 'Найди сумму', setup: 'На дисплее — сумма разрядных слагаемых.',
    ask: '400 + 40 + 6 — какое число получится? Набери его на панели.',
    expr: '400 + 40 + 6',
    correct: 'Верно! 400 + 40 + 6 = 446: сотни, десятки и единицы встали на свои места.',
    wrong: 'Подсказка: 400 — сотни, 40 — десятки, 6 — единицы. Поставь каждое в свою разрядную клетку.',
    rule: 'Из разложения собирается число: 400 + 40 + 6 = 446.',
  },
};
function D03_02Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value }, correctAnswer: { value: D02_ANS }, correct, feedbackText: correct ? t.correct : t.wrong, explanationText: correct ? t.correct : t.wrong, ruleText: t.rule || '', meta: { tag: 'compose_sum', level: '🟢' } });
