// Dars 6 (3-sinf) · Amaliyot 03 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 50-bet 5-mashq — son o'qida 246 va 256 orasidagi sonlar.
...
/* =================== 03 · Orasidagi yumaloq o'nlik (250) · 🟢 · between_round =================== */
const D02_ANS = '250';
const D02_T = {
  uz: {
    eyebrow: "Son o'qi mashqi", setup: "Son o'qida 246 va 256 sonlari belgilangan. Ular orasida bitta yumaloq o'nlik yashiringan.",
    ask: "246 bilan 256 orasidagi yumaloq o'nlikni tering.",
    expr: '246 ... ? ... 256',
    correct: "To'g'ri! 246 bilan 256 orasidagi yumaloq o'nlik — 250: u 246 dan katta, 256 dan kichik.",
    wrong: "Maslahat: 246 dan boshlab sanang: 247, 248, 249, ... Qaysi son nol bilan tugaydi?",
    rule: "246 < 250 < 256 — oraliqda yotgan yumaloq o'nlik.",
  },
  ru: {
    eyebrow: 'Задача с прямой', setup: 'На числовой прямой отмечены 246 и 256. Между ними прячется один круглый десяток.',
    ask: 'Набери круглый десяток между 246 и 256.',
    expr: '246 ... ? ... 256',
    correct: 'Верно! Круглый десяток между 246 и 256 — это 250: он больше 246 и меньше 256.',
    wrong: 'Подсказка: считай от 246: 247, 248, 249, ... Какое число оканчивается на ноль?',
    rule: '246 < 250 < 256 — круглый десяток внутри промежутка.',
  },
};
function D06_03Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value }, correctAnswer: { value: D02_ANS }, correct, meta: { tag: 'between_round', level: '🟢' } });
