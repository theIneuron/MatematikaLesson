// Dars 6 (3-sinf) · Amaliyot 08 — mustaqil topshiriq fayli (grade2 naqshi).
// Teskari savol: belgilangan oraliqqa mos sonni topish.
// Oraliq 400-500 yoritilgan; faqat 470 shu oraliqda yotadi (370 va 570 tashqarida).
...
/* =================== 08 · Oraliqdagi son (400-500) · 🔴 · interval_member =================== */
const D01_TAG = 'interval_member', D01_LEVEL = '🔴', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: 'Oraliqdagi son', setup: "O'qda 400 bilan 500 orasidagi oraliq yoritilgan.",
    ask: "Qaysi son shu yoritilgan oraliqda yotadi?",
    opts: ['470', '370', '570'],
    correct: "To'g'ri! 400 < 470 < 500 — demak 470 shu oraliqda. 370 — 400 dan oldin, 570 — 500 dan keyin.",
    wrong: "Maslahat: oraliqda yotgan son 400 dan katta VA 500 dan kichik bo'lishi kerak. Har variantning yuzligiga qarang.",
    rule: "Oraliqdagi son ikkala chegara orasida bo'ladi: 400 < 470 < 500.",
  },
  ru: {
    eyebrow: 'Число в промежутке', setup: 'На прямой подсвечен промежуток между 400 и 500.',
    ask: 'Какое число лежит в подсвеченном промежутке?',
    opts: ['470', '370', '570'],
    correct: 'Верно! 400 < 470 < 500 — значит, 470 в этом промежутке. 370 — до 400, 570 — после 500.',
    wrong: 'Подсказка: число из промежутка должно быть больше 400 И меньше 500. Посмотри на сотни каждого варианта.',
    rule: 'Число из промежутка лежит между границами: 400 < 470 < 500.',
  },
};
...
function D06_08Impl(props) {
  ...
  return (
    <div style={S.wrap}>
      ...
      <Stage><NumLine lo={350} hi={600} seg={[400, 500]} dot={checked && fb?.correct ? 470 : null} dotLabel={checked && fb?.correct ? '470' : null} /></Stage>
