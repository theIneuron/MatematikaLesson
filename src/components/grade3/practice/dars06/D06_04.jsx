// Dars 6 (3-sinf) · Amaliyot 04 — mustaqil topshiriq fayli (grade2 naqshi).
// Son o'qini o'qish: katta belgi — yuzlik, kichik belgi — o'nlik (nazariy Dars06 qoidasi).
// Strelka 470 da (nazariy Dars06 hero soni); chalg'ituvchilar: 407 va 480.
...
/* =================== 04 · Strelka qaysi sonda? (470) · 🟡 · line_read2 =================== */
const D01_TAG = 'line_read2', D01_LEVEL = '🟡', D01_CORRECT = 0;
const D01_T = {
  uz: {
    ...
    opts: ['470', '480', '407'],
    correct: "To'g'ri! 400 dan boshlab o'nliklab sanaymiz: 410, 420, ... 470 — strelka 470 da.",
    wrong: "Maslahat: katta belgi — 400. Undan strelkagacha kichik belgilarni sanang: har kichik belgi — bitta o'nlik, birlik emas.",
  ...
  ru: {
    ...
    opts: ['470', '480', '407'],
    correct: 'Верно! Считаем от 400 десятками: 410, 420, ... 470 — стрелка на 470.',
    wrong: 'Подсказка: большая метка — 400. Считай от неё маленькие метки до стрелки: каждая маленькая метка — десяток, а не единица.',
...
function D06_04Impl(props) {
  ...
  return (
    <div style={S.wrap}>
      ...
      <Stage><NumLine lo={400} hi={500} dot={470} dotLabel={checked && fb?.correct ? '470' : '?'} /></Stage>
