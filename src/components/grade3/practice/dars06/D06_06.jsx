// Dars 6 (3-sinf) · Amaliyot 06 — mustaqil topshiriq fayli (grade2 naqshi).
// O'qda harakat: 280 dan 20 qadam o'ngga — 300 (nazariy seed 280).
...
/* =================== 06 · O'qda harakat (280 + 20) · 🟡 · line_step =================== */
const D02_ANS = '300';
const D02_T = {
  uz: {
    eyebrow: "O'qda harakat", setup: "Strelka son o'qida 280 da turibdi. U o'ngga 20 qadam yuradi (o'ngga — kattayish tomoni).",
    ask: "Strelka qaysi songa yetib boradi? Tering.",
    expr: '280 → +20 → ?',
    correct: "To'g'ri! 280 + 20 = 300: o'ngga yurish — qo'shish. Yangi yuzlik boshlanadi!",
    wrong: "Maslahat: o'ngga yurish — qo'shish demak. 280 ga 20 ni qo'shsangiz, o'nliklar to'lib yuzlikka aylanadi.",
    rule: "O'qda o'ngga yurish — qo'shish: 280 + 20 = 300.",
  },
  ru: {
    eyebrow: 'Движение по прямой', setup: 'Стрелка стоит на прямой на 280. Она идёт вправо на 20 шагов (вправо — сторона увеличения).',
    ask: 'До какого числа дойдёт стрелка? Набери.',
    expr: '280 → +20 → ?',
    correct: 'Верно! 280 + 20 = 300: движение вправо — это сложение. Начинается новая сотня!',
    wrong: 'Подсказка: движение вправо — это сложение. Прибавь к 280 число 20: десятки заполнятся и станут сотней.',
    rule: 'Движение вправо по прямой — сложение: 280 + 20 = 300.',
  },
};
function D06_06Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value }, correctAnswer: { value: D02_ANS }, correct, meta: { tag: 'line_step', level: '🟡' } });
