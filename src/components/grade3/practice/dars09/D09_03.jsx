// Dars 9 (3-sinf) · Amaliyot 03 — mustaqil topshiriq fayli (grade5 dars04 «Moslash» formati).
// Manba: darslik 15-bet 6-mashq jadval faktlari — 6·7, 6·9, 8·9.
// Mexanika: moslash — ko'paytma ↔ natija. Hammasi-yoki-hech.
...
/* =================== 03 · Moslashtiring (ko'paytma ↔ natija) · 🟢 · match_product =================== */
const D03_TAG = 'match_product', D03_LEVEL = '🟢';
const D03_NUMS = ['6 × 7', '6 × 9', '8 × 9'];
const D03_EXP = { '6 × 7': '42', '6 × 9': '54', '8 × 9': '72' };
const D03_T = {
  uz: {
    eyebrow: 'Moslashtiring', setup: "Jadvalning uchta fakti o'z natijasini yo'qotib qo'ydi.",
    ask: "Ko'paytmani bosing, keyin uning natijasini bosing.",
    correct: "To'g'ri! 6 × 7 = 42, 6 × 9 = 54, 8 × 9 = 72.",
    wrong: "Maslahat: bilganingizdan boshlang: 6 × 7 kichigi, 8 × 9 kattasi. Qolgani o'rtadagisiga tushadi.",
    rule: "Jadval faktlari: 6 × 7 = 42, 6 × 9 = 54, 8 × 9 = 72.",
  },
  ru: {
    eyebrow: 'Соедини пары', setup: 'Три факта таблицы потеряли свои ответы.',
    ask: 'Нажми произведение, потом его результат.',
    correct: 'Верно! 6 × 7 = 42, 6 × 9 = 54, 8 × 9 = 72.',
    wrong: 'Подсказка: начни со знакомого: 6 × 7 — меньшее, 8 × 9 — большее. Оставшееся достанется среднему.',
    rule: 'Факты таблицы: 6 × 7 = 42, 6 × 9 = 54, 8 × 9 = 72.',
  },
};
