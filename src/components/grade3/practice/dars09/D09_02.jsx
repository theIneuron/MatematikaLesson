// Dars 9 (3-sinf) · Amaliyot 02 — mustaqil topshiriq fayli (grade5 dars04 formati).
// Manba: darslik 15-bet 6-mashq jadvalidagi fakt — 7 · 8 · grade5 «Og'zaki» formati.
...
/* =================== 02 · Og'zaki (7 × 8) · 🟢 · simple_product =================== */
const D02_ANS = '56';
const D02_T = {
  uz: {
    eyebrow: "Og'zaki", setup: "Jadvalning eng «qaysar» faktlaridan biri displeyda.",
    ask: "7 × 8 = ? Javobni tering.",
    expr: '7 × 8',
    correct: "To'g'ri! 7 × 8 = 56. Eslab qolish uchun: 5, 6, 7, 8 → 56 = 7 × 8.",
    wrong: "Maslahat: bilgan faktdan boring: 7 × 7 = 49, yana bitta 7 qo'shsangiz — 49 + 7 = ?",
    rule: "7 × 8 = 56. Qatordagi qo'shni faktdan chiqarish mumkin: 7 × 7 + 7.",
  },
  ru: {
    eyebrow: 'Устно', setup: 'Один из самых «упрямых» фактов таблицы на дисплее.',
    ask: '7 × 8 = ? Набери ответ.',
    expr: '7 × 8',
    correct: 'Верно! 7 × 8 = 56. Чтобы запомнить: 5, 6, 7, 8 → 56 = 7 × 8.',
    wrong: 'Подсказка: иди от знакомого факта: 7 × 7 = 49, добавь ещё одну семёрку — 49 + 7 = ?',
    rule: '7 × 8 = 56. Можно вывести из соседнего факта: 7 × 7 + 7.',
  },
};
function D10_02Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value }, correctAnswer: { value: D02_ANS }, correct, feedbackText: correct ? t.correct : t.wrong, explanationText: correct ? t.correct : t.wrong, ruleText: t.rule || '', meta: { tag: 'simple_product', level: '🟢' } });
