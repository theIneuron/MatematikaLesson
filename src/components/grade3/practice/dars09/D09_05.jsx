// Dars 9 (3-sinf) · Amaliyot 05 — mustaqil topshiriq fayli (grade5 dars04 formati).
// Manba: darslik 15-bet jadval faktlari (6 · 9 = 54) · grade5 «Yo'qolgan son» formati.
...
/* =================== 05 · Yo'qolgan son (6 × ? = 54) · 🟡 · missing_factor =================== */
const D02_ANS = '9';
const D02_T = {
  uz: {
    eyebrow: "Yo'qolgan son", setup: "Displeyda ko'paytuvchilardan biri yashiringan.",
    ask: "6 × ? = 54. Yashiringan ko'paytuvchini tering.",
    expr: '6 × ? = 54',
    correct: "To'g'ri! 6 × 9 = 54. Tekshiruv: 54 ni 6 ga bo'lsak — 9 chiqadi.",
    wrong: "Maslahat: 6 ni nechaga ko'paytirsak 54 bo'ladi? Jadvaldagi 6 lik qatorni yodga oling: 48, 54, 60...",
    rule: "Yashiringan ko'paytuvchi jadvalni teskari bilishdan topiladi: 54 = 6 × 9.",
  },
  ru: {
    eyebrow: 'Пропавшее число', setup: 'На дисплее спрятался один из множителей.',
    ask: '6 × ? = 54. Набери спрятанный множитель.',
    expr: '6 × ? = 54',
    correct: 'Верно! 6 × 9 = 54. Проверка: 54 разделить на 6 — получится 9.',
    wrong: 'Подсказка: на сколько умножить 6, чтобы получилось 54? Вспомни ряд шестёрки: 48, 54, 60...',
    rule: 'Спрятанный множитель находится обратным знанием таблицы: 54 = 6 × 9.',
  },
};
function D10_05Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value }, correctAnswer: { value: D02_ANS }, correct, feedbackText: correct ? t.correct : t.wrong, explanationText: correct ? t.correct : t.wrong, ruleText: t.rule || '', meta: { tag: 'missing_factor', level: '🟡' } });
  ...
  return (
    <div style={S.wrap}>
      ...
      <NumPad value={value} setValue={setValue} disabled={locked} max={1} tone={checked ? (fb?.correct ? 'ok' : 'no') : 'idle'} />
