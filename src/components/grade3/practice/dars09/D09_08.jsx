// Dars 9 (3-sinf) · Amaliyot 08 — mustaqil topshiriq fayli (grade5 dars04 formati).
// Manba: darslik 12-bet 3-mashq — husayni 9 savat 8 kg dan, toifi 8 savat 9 kg dan (shart moslab qayta yozilgan).
...
/* =================== 08 · Masala: uzum navlari · 🔴 · word_commut =================== */
// Sirli nuqta: 9 × 8 = 8 × 9 — miqdorlar teng chiqadi (kommutativlik).
const D01_TAG = 'word_commut', D01_LEVEL = '🔴', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: "Masala", setup: "Tokzorda husayni uzum 9 ta savatga 8 kg dan, toifi uzum esa 8 ta savatga 9 kg dan joylandi.",
    ask: "Qaysi navdan ko'proq uzum uzilgan?",
    opts: ['Ikkalasi teng', 'Husayni', 'Toifi'],
    correct: "To'g'ri! Husayni: 9 × 8 = 72 kg. Toifi: 8 × 9 = 72 kg. Ko'paytuvchilar o'rni almashsa, ko'paytma o'zgarmaydi!",
    wrong: "Maslahat: har navni hisoblang: husayni 9 × 8, toifi 8 × 9. Ko'paytuvchilar o'rni almashganda nima bo'ladi?",
    rule: "Ko'paytuvchilar o'rni almashtirilsa, ko'paytma o'zgarmaydi: 9 × 8 = 8 × 9 = 72.",
  },
  ru: {
    eyebrow: 'Задача', setup: 'В винограднике сорт хусайни разложили в 9 корзин по 8 кг, а сорт тоифи — в 8 корзин по 9 кг.',
    ask: 'Какого сорта винограда собрали больше?',
    opts: ['Поровну', 'Хусайни', 'Тоифи'],
    correct: 'Верно! Хусайни: 9 × 8 = 72 кг. Тоифи: 8 × 9 = 72 кг. От перестановки множителей произведение не меняется!',
    wrong: 'Подсказка: посчитай каждый сорт: хусайни 9 × 8, тоифи 8 × 9. Что происходит при перестановке множителей?',
