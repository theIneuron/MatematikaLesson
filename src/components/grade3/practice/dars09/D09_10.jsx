// Dars 9 (3-sinf) · Amaliyot 10 — mustaqil topshiriq fayli (grade5 dars04 formati).
// Manba: darslik 59-bet 3-mashq g'oyasi — 72 ni ikki son ko'paytmasi ko'rinishida hosil qilish.
...
/* =================== 10 · Ko'paytma juftligi (72) · 🔴 · factor_pairs =================== */
// Jadvalni teskari bilish: 72 = 8 × 9. Chalg'ituvchilar: 7×9=63, 8×8=64.
const D01_TAG = 'factor_pairs', D01_LEVEL = '🔴', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: "Teskari jadval", setup: "Displeyda ko'paytma turibdi: 72. Uni jadvaldagi qaysi juftlik beradi?",
    ask: "Qaysi ikki son ko'paytmasi 72 ga teng?",
    opts: ['8 va 9', '7 va 9', '8 va 8'],
    correct: "To'g'ri! 8 × 9 = 72. Boshqalari: 7 × 9 = 63, 8 × 8 = 64 — yaqin, lekin 72 emas.",
    wrong: "Maslahat: har juftlikni tekshiring: 7 × 9 = ?, 8 × 8 = ?, 8 × 9 = ? Qaysi biri 72 beradi?",
    rule: "Jadvalni teskari bilish ham kerak: 72 = 8 × 9 — bu keyin bo'lishda asqotadi.",
  },
  ru: {
    eyebrow: 'Таблица наоборот', setup: 'На дисплее произведение: 72. Какая пара из таблицы его даёт?',
    ask: 'Произведение каких двух чисел равно 72?',
    opts: ['8 и 9', '7 и 9', '8 и 8'],
    correct: 'Верно! 8 × 9 = 72. Остальные: 7 × 9 = 63, 8 × 8 = 64 — близко, но не 72.',
    wrong: 'Подсказка: проверь каждую пару: 7 × 9 = ?, 8 × 8 = ?, 8 × 9 = ? Какая даёт 72?',
    rule: 'Таблицу нужно знать и наоборот: 72 = 8 × 9 — это пригодится при делении.',
  },
};
...
function D10_10Impl(props) {
  ...
  return (
    <div style={S.wrap}>
      ...
      <Stage><Neon text="? × ? = 72" size={30} /></Stage>
