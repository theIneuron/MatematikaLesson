// Dars 9 (3-sinf) · Amaliyot 07 — mustaqil topshiriq fayli (grade5 dars04 formati).
// Manba: darslik 12-bet 2-mashq — 2 · 7 · 5 (qulay usulda guruhlash) · grade5 «Qulay usul» formati.
...
/* =================== 07 · Qulay usul (2 × 7 × 5) · 🟡 · qulay_mul =================== */
const D02_ANS = '70';
const D02_T = {
  uz: {
    eyebrow: "Qulay usul", setup: "Uchta ko'paytuvchi bor. Tartib bilan hisoblash shart emas — qulay juftlikni AVVAL ko'paytirish mumkin.",
    ask: "2 × 7 × 5 = ? Qulay usulda hisoblab, tering.",
    expr: '2 × 7 × 5',
    correct: "To'g'ri! Qulay yo'l: avval 2 × 5 = 10, keyin 7 × 10 = 70. O'nlik bilan ko'paytirish oson!",
    wrong: "Maslahat: qaysi ikki ko'paytuvchi yumaloq son beradi? 2 bilan 5 ni avval juftlang, keyin 7 ga ko'paytiring.",
    rule: "Ko'paytuvchilarni guruhlash mumkin: 2 × 7 × 5 = 7 × (2 × 5) = 70.",
  },
  ru: {
    eyebrow: 'Удобный способ', setup: 'Три множителя. Считать по порядку не обязательно — удобную пару можно перемножить СНАЧАЛА.',
    ask: '2 × 7 × 5 = ? Сосчитай удобным способом и набери.',
    expr: '2 × 7 × 5',
    correct: 'Верно! Удобный путь: сначала 2 × 5 = 10, потом 7 × 10 = 70. С десяткой умножать легко!',
    wrong: 'Подсказка: какие два множителя дают круглое число? Сначала соедини 2 и 5, потом умножь на 7.',
    rule: 'Множители можно группировать: 2 × 7 × 5 = 7 × (2 × 5) = 70.',
  },
};
function D10_07Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value }, correctAnswer: { value: D02_ANS }, correct, feedbackText: correct ? t.correct : t.wrong, explanationText: correct ? t.correct : t.wrong, ruleText: t.rule || '', meta: { tag: 'qulay_mul', level: '🟡' } });
