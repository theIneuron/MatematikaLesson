...
function D01_10Impl(props) {
  ...
  const btn = (bg, dis) => ({ width: 46, height: 46, borderRadius: 12, border: 'none', background: dis ? '#D9E6F0' : bg, color: '#243447', fontSize: 24, fontWeight: 800, cursor: (locked || dis) ? 'default' : 'pointer' });
  return (
    <div style={S.wrap}>
      ...
      <Stage>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, marginTop: 10 }}>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div className="g3d1-float" style={{ ...S.mono, fontSize: 38, fontWeight: 800, color: C.glow, textShadow: '0 0 12px rgba(20,90,134,.18)' }}>{n * 100}</div>
          </div>
