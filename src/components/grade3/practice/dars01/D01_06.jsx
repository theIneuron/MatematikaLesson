  ...
  <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
    {digits.map((d, i) => (
      <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
        <div style={{ width: 62, height: 70, borderRadius: 12, background: '#152342', border: '1.5px solid ' + C.ribbonBd, boxShadow: 'inset 0 0 14px rgba(255,184,77,.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <span style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: 38, fontWeight: 800, color: C.glow, textShadow: '0 0 12px rgba(255,184,77,.8)' }}>{d}</span>
        </div>
