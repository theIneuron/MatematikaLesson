// Dars 2 (3-sinf) · Amaliyot 10 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 15-bet kombinatorika mashqidagi 490 soni (9, 0, 4 raqamlaridan yasalgan).
// Chalg'ituvchilar shu raqamlardan yasalgan boshqa sonlar — o'qishni sinchiklab farqlash kerak.
...
/* =================== 10 · Qaysi son? (490) · 🔴 · discriminate =================== */
// Variantlar — 9, 0, 4 dan yasalgan sonlar: 490 (to'g'ri), 409 (raqamlar almashgan), 4090 (yopishtirilgan).
const D10_TAG = 'discriminate', D10_LEVEL = '🔴', D10_CORRECT = 0;
const D10_T = {
  uz: {
    eyebrow: 'Sinchiklab tanlang', setup: "Displeyda son so'z bilan yozilgan. Variantlar juda o'xshash — shoshilmang.",
    ask: "«To'rt yuz to'qson» — bu qaysi son?",
    word: "to'rt yuz to'qson", opts: ['490', '409', '4090'],
    correct: "To'g'ri! To'rt yuz to'qson = 490: 4 yuzlik, 9 o'nlik. 409 esa to'rt yuz to'qqiz bo'lar edi.",
    wrong: "Maslahat: to'qson — bu o'nliklar (90), to'qqiz esa birlik (9). Qaysi razryad aytilganini aniqlang, keyin sonni tuzing.",
    rule: "490 — to'rt yuz to'qson, 409 — to'rt yuz to'qqiz: bitta harf farqi, boshqa-boshqa sonlar.",
  },
  ru: {
    eyebrow: 'Выбери внимательно', setup: 'На дисплее число записано словами. Варианты очень похожи — не спеши.',
    ask: '«Четыреста девяносто» — какое это число?',
    word: 'четыреста девяносто', opts: ['490', '409', '4090'],
    correct: 'Верно! Четыреста девяносто = 490: 4 сотни, 9 десятков. А 409 — это четыреста девять.',
    wrong: 'Подсказка: девяносто — это десятки (90), а девять — единицы (9). Определи, какой разряд назван, потом составь число.',
