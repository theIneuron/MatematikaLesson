// Dars 2 (3-sinf) · Amaliyot 06 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 8-bet 7-mashq — maktabdagi 890 soni (shart moslab qayta yozilgan).
// Tuzoq: razryadlarni yonma-yon yopishtirish (8090) va o'nlik nolini birlik deb yozish (809).
...
/* =================== 06 · Qaysi yozuv to'g'ri? (890) · 🟡 · concat_trap =================== */
const D06_TAG = 'concat_trap', D06_LEVEL = '🟡', D06_CORRECT = 0;
const D06_T = {
  uz: {
    eyebrow: "Qaysi yozuv to'g'ri?", setup: "Maktabda sakkiz yuz to'qson nafar o'quvchi o'qiydi. Jurnalga shu sonni yozish kerak.",
    ask: "«Sakkiz yuz to'qson» raqamlar bilan qanday yoziladi?",
    word: "sakkiz yuz to'qson", opts: ['890', '8090', '809'],
    correct: "To'g'ri! Sakkiz yuz to'qson = 890: 8 yuzlik, 9 o'nlik, 0 birlik.",
    wrong: "Maslahat: uch xonali sonda faqat uchta katak bor: yuzlik, o'nlik, birlik. «Sakkiz yuz» va «to'qson» bitta uch xonali songa joylashadi.",
    rule: "Sakkiz yuz (800) + to'qson (90) = 890 — razryadlar yonma-yon yozilmaydi, qo'shiladi.",
  },
  ru: {
    eyebrow: 'Какая запись верна?', setup: 'В школе учатся восемьсот девяносто учеников. Это число нужно записать в журнал.',
    ask: 'Как записывается цифрами «восемьсот девяносто»?',
    word: 'восемьсот девяносто', opts: ['890', '8090', '809'],
    correct: 'Верно! Восемьсот девяносто = 890: 8 сотен, 9 десятков, 0 единиц.',
    wrong: 'Подсказка: в трёхзначном числе только три клетки: сотни, десятки, единицы. «Восемьсот» и «девяносто» помещаются в одно трёхзначное число.',
    rule: 'Восемьсот (800) + девяносто (90) = 890 — разряды не пишутся рядом, а складываются.',
  },
};
