// Dars 7 (3-sinf) · Amaliyot 01 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 9-bet 5-mashq — 323 + 571 (xonadan o'tmasdan).
...
/* =================== 01 · Ustunda qo'shish (323 + 571) · 🟢 · col_add =================== */
// Chalg'ituvchilar: 884 (o'nlik xato), 794 (yuzlik xato).
const D01_TAG = 'col_add', D01_LEVEL = '🟢', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: 'Ustunda qo\'shish', setup: "Ustun shaklida qo'shamiz: xona xona ostida, o'ngdan chapga.",
    ask: '323 + 571 yig\'indisi qancha?',
    opts: ['894', '884', '794'],
    correct: "To'g'ri! Birliklar: 3 + 1 = 4. O'nliklar: 2 + 7 = 9. Yuzliklar: 3 + 5 = 8. Javob: 894.",
    wrong: "Maslahat: o'ngdan chapga xonama-xona qo'shing: birliklar 3+1, o'nliklar 2+7, yuzliklar 3+5.",
    rule: "Ustunda qo'shish o'ngdan chapga: birlik, o'nlik, yuzlik.",
  },
  ru: {
    eyebrow: 'Сложение столбиком', setup: 'Складываем в столбик: разряд под разрядом, справа налево.',
    ask: 'Чему равна сумма 323 + 571?',
    opts: ['894', '884', '794'],
    correct: 'Верно! Единицы: 3 + 1 = 4. Десятки: 2 + 7 = 9. Сотни: 3 + 5 = 8. Ответ: 894.',
    wrong: 'Подсказка: складывай поразрядно справа налево: единицы 3+1, десятки 2+7, сотни 3+5.',
...
function D07_01Impl(props) {
  ...
  return (
    <div style={S.wrap}>
      ...
      <Stage><div style={{ display: 'flex', justifyContent: 'center' }}><div style={{ padding: '10px 22px', borderRadius: 14, background: '#152342', border: '1.5px solid ' + C.ribbonBd }}><pre style={{ margin: 0, fontFamily: "'JetBrains Mono', monospace", fontSize: 28, fontWeight: 800, color: C.glow, textShadow: '0 0 10px rgba(255,184,77,.7)', lineHeight: 1.35 }}>{'  323\n+ 571\n-----\n    ?'}</pre></div></div></Stage>
