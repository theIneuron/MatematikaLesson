// Dars 7 (3-sinf) · Amaliyot 10 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 16-bet 3-mashq — 856 − 477 (ikki marta qarz olish).
...
/* =================== 10 · Ikki marta qarz (856 − 477) · 🔴 · col_sub_borrow2 =================== */
const D03_A = 856, D03_B = 477, D03_ANS = '379';
const D03_T = {
  uz: {
    eyebrow: 'Ikki qarz', setup: "Eng qiyini: qarz olish IKKI marta bo'ladi — birlikda ham, o'nlikda ham.",
    ask: '856 − 477 = ? Javobni tering.',
    correct: "To'g'ri! Birliklar: 16 − 7 = 9 (o'nlikdan qarz). O'nliklar: 14 − 7 = 7 (yuzlikdan qarz). Yuzliklar: 7 − 4 = 3. Javob: 379.",
    wrong: "Maslahat: 6 < 7 — o'nlikdan qarz: 16 − 7. Endi o'nlik 4 bo'ldi, 4 < 7 — yuzlikdan ham qarz: 14 − 7. Har qarzni hisobga oling!",
    rule: "Qarz ketma-ket bo'lishi mumkin: har safar qo'shni xona 1 ga kamayadi.",
  },
  ru: {
    eyebrow: 'Два займа', setup: 'Самое сложное: занимать придётся ДВА раза — и в единицах, и в десятках.',
    ask: '856 − 477 = ? Набери ответ.',
    correct: 'Верно! Единицы: 16 − 7 = 9 (заняли у десятков). Десятки: 14 − 7 = 7 (заняли у сотен). Сотни: 7 − 4 = 3. Ответ: 379.',
    wrong: 'Подсказка: 6 < 7 — займи у десятков: 16 − 7. Теперь десятков 4, а 4 < 7 — займи и у сотен: 14 − 7. Учитывай каждый заём!',
    rule: 'Займы могут идти подряд: каждый раз соседний разряд уменьшается на 1.',
  },
};
function D07_10Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value }, correctAnswer: { value: D03_ANS }, correct, feedbackText: correct ? t.correct : t.wrong, explanationText: correct ? t.correct : t.wrong, ruleText: t.rule || '', meta: { tag: 'col_sub_borrow2', level: '🔴' } });
