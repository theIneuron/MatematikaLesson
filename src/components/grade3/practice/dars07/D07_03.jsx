// Dars 7 (3-sinf) · Amaliyot 03 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 9-bet 5-mashq qatoridan — 243 − 122 (xonadan o'tmasdan ayirish).
...
/* =================== 03 · O'tishsiz ayirish (243 − 122) · 🟢 · col_sub =================== */
const D03_A = 243, D03_B = 122, D03_ANS = '121';
const D03_T = {
  uz: {
    eyebrow: 'Ustunda ayirish', setup: "Ustun shaklida ayiramiz: xona xona ostida, o'ngdan chapga.",
    ask: '243 − 122 = ? Javobni tering.',
    correct: "To'g'ri! Birliklar: 3 − 2 = 1. O'nliklar: 4 − 2 = 2. Yuzliklar: 2 − 1 = 1. Javob: 121.",
    wrong: "Maslahat: o'ngdan boshlang: avval birliklarni ayiring (3 − 2), keyin o'nliklarni (4 − 2), oxirida yuzliklarni (2 − 1).",
    rule: "Ustunda amal o'ngdan chapga bajariladi: birlik, o'nlik, yuzlik.",
  },
  ru: {
    eyebrow: 'Вычитание столбиком', setup: 'Вычитаем в столбик: разряд под разрядом, справа налево.',
    ask: '243 − 122 = ? Набери ответ.',
    correct: 'Верно! Единицы: 3 − 2 = 1. Десятки: 4 − 2 = 2. Сотни: 2 − 1 = 1. Ответ: 121.',
    wrong: 'Подсказка: начинай справа: сначала вычти единицы (3 − 2), потом десятки (4 − 2), в конце сотни (2 − 1).',
    rule: 'В столбике действие идёт справа налево: единицы, десятки, сотни.',
  },
};
function D07_03Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value }, correctAnswer: { value: D03_ANS }, correct, feedbackText: correct ? t.correct : t.wrong, explanationText: correct ? t.correct : t.wrong, ruleText: t.rule || '', meta: { tag: 'col_sub', level: '🟢' } });
