// Dars 8 (3-sinf) · Amaliyot 01 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 88-bet — rim belgilari: I=1, V=5, X=10, L=50, C=100.
...
/* =================== 01 · Belgi qiymati (X) · 🟢 · rome_symbol =================== */
// Chalg'ituvchilar: 5 (V bilan adashish), 100 (C bilan adashish).
const D01_TAG = 'rome_symbol', D01_LEVEL = '🟢', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: "Rim belgisi", setup: "Qadimgi Rimda sonlar harf-belgilar bilan yozilgan. Displeyda ulardan biri yonib turibdi.",
    ask: "X belgisi qaysi sonni bildiradi?",
    opts: ['10', '5', '100'],
    correct: "To'g'ri! X = 10. Boshqalari: I = 1, V = 5, L = 50, C = 100.",
    wrong: "Maslahat: belgilarni eslang: I — bir, V — besh, X — o'n, L — ellik, C — yuz.",
    rule: "Rim belgilari: I = 1, V = 5, X = 10, L = 50, C = 100.",
  },
  ru: {
    eyebrow: 'Римский знак', setup: 'В Древнем Риме числа записывали буквами-знаками. На дисплее горит один из них.',
    ask: 'Какое число обозначает знак X?',
    opts: ['10', '5', '100'],
    correct: 'Верно! X = 10. Остальные: I = 1, V = 5, L = 50, C = 100.',
    wrong: 'Подсказка: вспомни знаки: I — один, V — пять, X — десять, L — пятьдесят, C — сто.',
    rule: 'Римские знаки: I = 1, V = 5, X = 10, L = 50, C = 100.',
  },
};
