// Dars 8 (3-sinf) · Amaliyot 03 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: darslik 88-bet qoidasi (o'ngda qo'shish) — VI = 6 misoli asosida.
// Mexanika: moslash — rim yozuvi ↔ oddiy son. Hammasi-yoki-hech.
...
/* =================== 03 · Moslashtiring (rim ↔ son) · 🟢 · match_rome =================== */
const D03_TAG = 'match_rome', D03_LEVEL = '🟢';
const D03_NUMS = ['VI', 'XV', 'XX'];
const D03_EXP = { 'VI': '6', 'XV': '15', 'XX': '20' };
const D03_T = {
  uz: {
    eyebrow: 'Moslashtiring', setup: "Har rim yozuvini o'z soniga ulang. Hammasida belgilar o'ngda — qo'shiladi.",
    ask: "Rim yozuvini bosing, keyin uning sonini bosing.",
    correct: "To'g'ri! VI = 5 + 1 = 6, XV = 10 + 5 = 15, XX = 10 + 10 = 20.",
    wrong: "Maslahat: belgilarni qo'shib chiqing: V — besh, X — o'n, I — bir. O'ngdagi belgi kattasiga qo'shiladi.",
    rule: "O'ngdagi belgilar qo'shiladi: VI = 6, XV = 15, XX = 20.",
  },
  ru: {
    eyebrow: 'Соедини пары', setup: 'Соедини каждую римскую запись с её числом. Во всех знаки справа — прибавляются.',
    ask: 'Нажми римскую запись, потом её число.',
    correct: 'Верно! VI = 5 + 1 = 6, XV = 10 + 5 = 15, XX = 10 + 10 = 20.',
    wrong: 'Подсказка: складывай знаки: V — пять, X — десять, I — один. Знак справа прибавляется к большому.',
    rule: 'Знаки справа прибавляются: VI = 6, XV = 15, XX = 20.',
  },
};
