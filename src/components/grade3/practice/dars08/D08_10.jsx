// Dars 8 (3-sinf) · Amaliyot 10 — mustaqil topshiriq fayli (grade2 naqshi).
// Umumlashtirish: rim yozuvlarini o'qib taqqoslash (XIX = 19, XVI = 16).
...
/* =================== 10 · Qaysi katta? (XIX va XVI) · 🔴 · rome_compare =================== */
// Avval har yozuvni oddiy songa aylantirish, keyin taqqoslash kerak.
const D01_TAG = 'rome_compare', D01_LEVEL = '🔴', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: "Qaysi katta?", setup: "Ikkita rim yozuvi: XIX va XVI. Qaysi son katta ekanini bilish uchun avval ularni o'qib oling.",
    ask: "Qaysi yozuv kattaroq sonni bildiradi?",
    opts: ['XIX', 'XVI', 'Ular teng'],
    correct: "To'g'ri! XIX = 10 + 9 = 19, XVI = 10 + 6 = 16. 19 > 16.",
    wrong: "Maslahat: har yozuvni bo'laklab o'qing: XIX = X va IX. XVI = X va VI. Endi oddiy sonlarni taqqoslang.",
    rule: "Rim yozuvlarini taqqoslash uchun avval ularni oddiy songa aylantiramiz: XIX = 19 > XVI = 16.",
  },
  ru: {
