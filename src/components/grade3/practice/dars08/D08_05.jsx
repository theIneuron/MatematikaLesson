// Dars 8 (3-sinf) · Amaliyot 05 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 89-bet — chapda yozilsa ayiriladi: IX = 10 − 1 = 9.
...
/* =================== 05 · Chapda ayirish (IX) · 🟡 · rome_sub =================== */
// Tuzoq: 11 (XI bilan adashish — o'ngda qo'shish deb o'ylash).
const D01_TAG = 'rome_sub', D01_LEVEL = '🟡', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: "Diqqat, chapda!", setup: "Displeyda IX yozuvi. Kichik belgi I kattasidan CHAPDA turibdi.",
    ask: "IX qaysi sonni bildiradi?",
    opts: ['9', '11', '8'],
    correct: "To'g'ri! I chapda — ayiriladi: IX = 10 − 1 = 9. XI bo'lsa edi, 10 + 1 = 11 bo'lardi.",
    wrong: "Maslahat: kichik belgi kattadan CHAPDA tursa — ayiriladi, o'ngda tursa — qo'shiladi. I qaysi tomonda?",
    rule: "Kichik belgi chapda — ayiriladi: IX = 9. O'ngda — qo'shiladi: XI = 11.",
  },
  ru: {
    eyebrow: 'Внимание, слева!', setup: 'На дисплее запись IX. Маленький знак I стоит СЛЕВА от большого.',
    ask: 'Какое число обозначает IX?',
    opts: ['9', '11', '8'],
    correct: 'Верно! I слева — вычитается: IX = 10 − 1 = 9. А XI было бы 10 + 1 = 11.',
    wrong: 'Подсказка: маленький знак СЛЕВА от большого вычитается, справа — прибавляется. С какой стороны I?',
    rule: 'Маленький знак слева — вычитается: IX = 9. Справа — прибавляется: XI = 11.',
  },
};
