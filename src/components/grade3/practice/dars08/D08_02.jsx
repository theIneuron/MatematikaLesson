// Dars 8 (3-sinf) · Amaliyot 02 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 88-bet misoli — XII = 10 + 2 = 12 (o'ngda qo'shish).
...
/* =================== 02 · Rimchani o'qing (XII) · 🟢 · rome_read =================== */
const D02_ANS = '12';
const D02_T = {
  uz: {
    eyebrow: "Rimchani o'qing", setup: "Qadimgi soat yuzida XII yozuvi bor. Kichik belgilar kattasidan O'NGDA — qo'shiladi.",
    ask: "XII qaysi son? Raqam-plitada tering.",
    expr: 'XII',
    correct: "To'g'ri! XII = 10 + 1 + 1 = 12. Soatlardagi o'n ikki shu!",
    wrong: "Maslahat: X — o'n, har I — bir. Belgilar o'ngda tursa qo'shiladi: o'n va yana ikkita bir.",
    rule: "O'ngdagi belgilar qo'shiladi: XII = 10 + 2 = 12.",
  },
  ru: {
    eyebrow: 'Читай римские', setup: 'На старинных часах есть запись XII. Маленькие знаки СПРАВА от большого — прибавляются.',
    ask: 'Какое это число — XII? Набери на панели.',
    expr: 'XII',
    correct: 'Верно! XII = 10 + 1 + 1 = 12. Это двенадцать, как на часах!',
    wrong: 'Подсказка: X — десять, каждая I — один. Знаки справа прибавляются: десять и ещё две единицы.',
    rule: 'Знаки справа прибавляются: XII = 10 + 2 = 12.',
  },
};
function D08_02Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value }, correctAnswer: { value: D02_ANS }, correct, feedbackText: correct ? t.correct : t.wrong, explanationText: correct ? t.correct : t.wrong, ruleText: t.rule || '', meta: { tag: 'rome_read', level: '🟢' } });
