// Dars 8 (3-sinf) · Amaliyot 09 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 89-bet 7-mashq — oylarni rim raqamida ifodalash (Yanvar — I).
...
/* =================== 09 · Oylar rim raqamida (sentabr) · 🔴 · rome_month =================== */
// Tuzoq: VIIII (to'rt marta takrorlash mumkin emas), XI (11-oy emas).
const D01_TAG = 'rome_month', D01_LEVEL = '🔴', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: "Oylar rimchada", setup: "Hujjatlarda oy raqami ko'pincha rim raqamida yoziladi: yanvar — I, fevral — II. Sentabr — yilning 9-oyi.",
    ask: "Sentabr rim raqamida qanday yoziladi?",
    opts: ['IX', 'XI', 'VIIII'],
    correct: "To'g'ri! 9-oy — IX (10 − 1). VIIII deb yozib bo'lmaydi: bir belgi 3 martadan ko'p takrorlanmaydi.",
    wrong: "Maslahat: sentabr — 9-oy. 9 ni rimchada yozish uchun chapda-ayirish qoidasi kerak. XI esa 11 bo'ladi.",
    rule: "9 = IX. Bir xil belgi ketma-ket 3 martadan ko'p yozilmaydi.",
  },
  ru: {
    eyebrow: 'Месяцы по-римски', setup: 'В документах номер месяца часто пишут римскими цифрами: январь — I, февраль — II. Сентябрь — 9-й месяц.',
    ask: 'Как записывается сентябрь римскими цифрами?',
    opts: ['IX', 'XI', 'VIIII'],
    correct: 'Верно! 9-й месяц — IX (10 − 1). VIIII писать нельзя: знак не повторяется больше 3 раз подряд.',
    wrong: 'Подсказка: сентябрь — 9-й месяц. Чтобы записать 9, нужно правило вычитания слева. А XI — это 11.',
    rule: '9 = IX. Одинаковый знак не пишется подряд больше 3 раз.',
  },
};
...
function D08_09Impl(props) {
  ...
  return (
    <div style={S.wrap}>
      ...
      <Stage><Neon text="sentabr = ?" size={26} /></Stage>
