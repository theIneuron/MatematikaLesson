...
function D04_05Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: ['>', '<', '='].map((s, i) => ({ id: String(i), label: s })), studentAnswer: { sign }, correctAnswer: { sign: D01_SIGN }, correct, feedbackText: correct ? t.correct : t.wrong, explanationText: correct ? t.correct : t.wrong, ruleText: t.rule || '', meta: { tag: 'compare_equal', level: '🟡' } });
