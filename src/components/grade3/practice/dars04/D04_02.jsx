...
// Manba: 3-sinf darsligi, 79-bet 1-mashq — 348 va 523 juftligi.
...
/* =================== 02 · Belgini qo'ying (348 va 523) · 🟢 · compare_sign =================== */
const D01_A = '348', D01_B = '523', D01_SIGN = '<';
const D01_T = {
  uz: {
    eyebrow: "Belgini qo'ying", setup: "Ikki tuman displeyida sonlar. Ular orasiga mos belgini qo'yamiz.",
    ask: "348 va 523 orasiga qaysi belgi qo'yiladi?",
    correct: "To'g'ri! 348 < 523: 3 yuzlik 5 yuzlikdan kichik. Belgining ochiq tomoni kattaga qaraydi.",
    wrong: "Maslahat: taqqoslashni ENG KATTA razryaddan — yuzliklardan boshlang. Qaysi sonda yuzlik ko'p?",
    rule: "Belgining ochiq tomoni katta songa qaraydi: 348 < 523.",
  },
  ru: {
    eyebrow: 'Поставь знак', setup: 'На дисплеях двух районов — числа. Поставим между ними верный знак.',
    ask: 'Какой знак ставится между 348 и 523?',
    correct: 'Верно! 348 < 523: 3 сотни меньше 5 сотен. Открытая сторона знака смотрит на большее.',
    wrong: 'Подсказка: начинай сравнение со СТАРШЕГО разряда — с сотен. В каком числе сотен больше?',
    rule: 'Открытая сторона знака смотрит на большее число: 348 < 523.',
  },
};
