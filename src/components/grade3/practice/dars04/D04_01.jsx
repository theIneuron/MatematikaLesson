...
// Manba: 3-sinf darsligi, 79-bet 1-mashq — 348 va 267 juftligi.
...
/* =================== 01 · Belgini qo'ying (348 va 267) · 🟢 · compare_sign =================== */
const D01_A = '348', D01_B = '267', D01_SIGN = '>';
const D01_T = {
  uz: {
    eyebrow: "Belgini qo'ying", setup: "Ikki tuman displeyida sonlar. Ular orasiga mos belgini qo'yamiz.",
    ask: "348 va 267 orasiga qaysi belgi qo'yiladi?",
    correct: "To'g'ri! 348 > 267: yuzliklardan boshlaymiz — 3 yuzlik 2 yuzlikdan katta.",
    wrong: "Maslahat: taqqoslashni ENG KATTA razryaddan — yuzliklardan boshlang. Qaysi sonda yuzlik ko'p?",
    rule: "Sonlar razryadma-razryad, chapdan boshlab taqqoslanadi: 348 > 267, chunki 3 yuzl. > 2 yuzl.",
  },
  ru: {
    eyebrow: 'Поставь знак', setup: 'На дисплеях двух районов — числа. Поставим между ними верный знак.',
    ask: 'Какой знак ставится между 348 и 267?',
    correct: 'Верно! 348 > 267: начинаем с сотен — 3 сотни больше 2 сотен.',
    wrong: 'Подсказка: начинай сравнение со СТАРШЕГО разряда — с сотен. В каком числе сотен больше?',
    rule: 'Числа сравниваются по разрядам слева: 348 > 267, потому что 3 сотни > 2 сотен.',
  },
};
function D04_01Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: ['>', '<', '='].map((s, i) => ({ id: String(i), label: s })), studentAnswer: { sign }, correctAnswer: { sign: D01_SIGN }, correct, feedbackText: correct ? t.correct : t.wrong, explanationText: correct ? t.correct : t.wrong, ruleText: t.rule || '', meta: { tag: 'compare_sign', level: '🟢' } });
