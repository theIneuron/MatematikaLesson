...
// Nazariy Dars04 «tuzoq» misoli: 600 va 599 — raqamlari kattaroq ko'ringan son aslida kichik.
...
/* =================== 06 · Tuzoq: 600 va 599 · 🟡 · compare_600_599 =================== */
const D03_TAG = 'compare_600_599', D03_LEVEL = '🟡', D03_CORRECT = 0;
const D03_T = {
  uz: {
    eyebrow: 'Diqqat, tuzoq!', setup: "599 da to'qqizlar ko'p, 600 da esa nollar. Qaysi biri katta?",
    ask: "600 va 599 uchun qaysi yozuv to'g'ri?",
    opts: ['600 > 599', '600 < 599', '600 = 599'],
    correct: "To'g'ri! 600 > 599: 6 yuzlik 5 yuzlikdan katta. To'qqizlar ko'pligi aldamasin — yuzlik hal qiladi.",
    wrong: "Maslahat: katta raqamlar ko'p bo'lgani son katta degani emas. Eng katta razryaddan boshlang: yuzliklarni solishtiring.",
    rule: "600 > 599: sanashda 599 dan keyin 600 keladi.",
  },
  ru: {
    eyebrow: 'Внимание, ловушка!', setup: 'В 599 много девяток, а в 600 — ноли. Какое из них больше?',
    ask: 'Какая запись верна для 600 и 599?',
    opts: ['600 > 599', '600 < 599', '600 = 599'],
    correct: 'Верно! 600 > 599: 6 сотен больше 5 сотен. Пусть девятки не обманывают — решают сотни.',
    wrong: 'Подсказка: много больших цифр не значит большое число. Начни со старшего разряда: сравни сотни.',
