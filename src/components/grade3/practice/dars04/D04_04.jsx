...
// Manba: 3-sinf darsligi, 79-bet misoli — 987 > 879 (yuzlik hal qiladi).
...
/* =================== 04 · Qaysi son katta? (987 va 879) · 🟡 · compare_pick2 =================== */
const D03_TAG = 'compare_pick2', D03_LEVEL = '🟡', D03_CORRECT = 0;
const D03_T = {
  uz: {
    eyebrow: 'Qaysi son katta?', setup: "Displeyda ikkita son: 987 va 879. Raqamlari bir xil, joylari har xil.",
    ask: 'Qaysi son katta?',
    opts: ['987', '879', 'Ular teng'],
    correct: "To'g'ri! 987 > 879: 9 yuzlik 8 yuzlikdan katta — qolgan raqamlarni qarash ham shart emas.",
    wrong: "Maslahat: taqqoslash eng katta razryaddan boshlanadi. 987 da nechta yuzlik, 879 da nechta?",
    rule: "Yuzligi katta son — katta: 987 > 879.",
  },
  ru: {
    eyebrow: 'Какое число больше?', setup: 'На дисплее два числа: 987 и 879. Цифры одинаковые, места разные.',
    ask: 'Какое число больше?',
    opts: ['987', '879', 'Они равны'],
    correct: 'Верно! 987 > 879: 9 сотен больше 8 сотен — остальные цифры можно даже не смотреть.',
    wrong: 'Подсказка: сравнение начинается со старшего разряда. Сколько сотен в 987 и сколько в 879?',
    rule: 'Число с большими сотнями больше: 987 > 879.',
  },
};
...
function D04_04Impl(props) {
  ...
  return (
    <div style={S.wrap}>
      ...
      <Stage><div style={{ display: 'flex', gap: 14, justifyContent: 'center' }}>{['987', '879'].map((n) => (<div key={n} style={{ minWidth: 104, height: 70, borderRadius: 12, background: '#152342', border: '1.5px solid ' + C.ribbonBd, boxShadow: 'inset 0 0 14px rgba(255,184,77,.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><span style={{ ...S.mono, fontSize: 34, fontWeight: 800, color: C.glow, textShadow: '0 0 12px rgba(255,184,77,.8)' }}>{n}</span></div>))}</div></Stage>
