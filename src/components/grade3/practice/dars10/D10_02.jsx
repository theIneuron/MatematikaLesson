// Dars 10 (3-sinf) · Amaliyot 02 — mustaqil topshiriq fayli (grade5 dars04 formati).
...
function D10_02Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value }, correctAnswer: { value: D02_ANS }, correct, meta: { tag: 'simple_product', level: '🟢' } });
