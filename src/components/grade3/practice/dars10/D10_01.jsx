// Dars 10 (3-sinf) · Amaliyot 01 — mustaqil topshiriq fayli (grade5 dars04 formati).
...
function D10_01Impl(props) {
  ...
  return (
    <div style={S.wrap}>
      ...
      <Stage><div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, justifyContent: 'center', maxWidth: 420, margin: '0 auto' }}>{Array.from({ length: 9 }).map((_, i) => (<div key={i} style={{ minWidth: 48, padding: '8px 6px', borderRadius: 10, background: '#152342', border: '1.5px solid ' + C.ribbonBd, textAlign: 'center' }}><div style={{ fontSize: 16 }}>🍇</div><div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 13, fontWeight: 800, color: C.glow }}>8 kg</div></div>))}</div></Stage>
