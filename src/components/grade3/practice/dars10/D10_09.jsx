// Dars 10 (3-sinf) · Amaliyot 09 — mustaqil topshiriq fayli (grade5 dars04 formati).
...
function D10_09Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value }, correctAnswer: { value: D02_ANS }, correct, meta: { tag: 'qulay_mul2', level: '🔴' } });
