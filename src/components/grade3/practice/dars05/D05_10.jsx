// Dars 5 (3-sinf) · Amaliyot 10 — mustaqil topshiriq fayli (grade2 naqshi).
// Manba: 3-sinf darsligi, 5-bet — Afrosiyob poyezdi 215 o'rin (taxminiy hisob kontekstida).
...
/* =================== 10 · Taxminiy hisob (215) · 🔴 · round_estimate =================== */
// Taxmin uchun son yumaloq o'nlikka olinadi: 215 → 220 (5 — yuqoriga).
const D01_TAG = 'round_estimate', D01_LEVEL = '🔴', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: 'Taxminiy hisob', setup: "Afrosiyob poyezdida 215 o'rin bor. Jasur do'stiga taxminan aytmoqchi — buning uchun sonni yumaloq o'nlikka oladi.",
    ask: "Jasur taxminan qancha deb aytadi?",
    opts: ['Taxminan 220 ta', 'Taxminan 210 ta', 'Taxminan 200 ta'],
    correct: "To'g'ri! 215 → 220: oxirida 5 bor, o'rtadagi son yuqoriga olinadi.",
    wrong: "Maslahat: 215 soni 210 bilan 220 orasida, aynan o'rtada. O'rtadagi son uchun kelishuvni eslang.",
    rule: "Taxmin qilishda son eng yaqin yumaloq songa olinadi: 215 → 220.",
  },
  ru: {
    eyebrow: 'Примерный счёт', setup: 'В поезде Афросиёб 215 мест. Жасур хочет сказать другу примерно — для этого он берёт круглый десяток.',
    ask: 'Сколько примерно скажет Жасур?',
    opts: ['Примерно 220 мест', 'Примерно 210 мест', 'Примерно 200 мест'],
    correct: 'Верно! 215 → 220: на конце 5, а число с середины берётся вверх.',
    wrong: 'Подсказка: число 215 стоит между 210 и 220, ровно посередине. Вспомни договорённость про середину.',
    rule: 'Для примерного счёта число берут к ближайшему круглому: 215 → 220.',
  },
};
