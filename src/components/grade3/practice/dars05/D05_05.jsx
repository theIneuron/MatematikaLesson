// Dars 5 (3-sinf) · Amaliyot 05 — mustaqil topshiriq fayli (grade2 naqshi).
// Chegara holati: 45 — 40 bilan 50 ning aynan o'rtasida; qoida: o'rtada — yuqoriga.
...
/* =================== 05 · O'rtadagi son (45) · 🟡 · round_half =================== */
// Chalg'ituvchi: 40 (o'rtada pastga deb o'ylash — asosiy xato).
const D01_TAG = 'round_half', D01_LEVEL = '🟡', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: "Qiziq holat", setup: "45 soni 40 bilan 50 ning AYNAN o'rtasida turadi. Qaysi tomonga boradi?",
    ask: "45 ga qaysi yumaloq o'nlik mos deb kelishilgan?",
    opts: ['50', '40', '45'],
    correct: "To'g'ri! Kelishuv shunday: son aynan o'rtada tursa, YUQORIGA olamiz — 45 → 50.",
    wrong: "Maslahat: 45 ikkala tomonga ham teng uzoq. Bunday holat uchun maxsus kelishuv bor: o'rtadagi son qaysi tomonga olinadi?",
    rule: "O'rtadagi son yuqoriga olinadi: 45 → 50. Bu — kelishuv.",
  },
  ru: {
    eyebrow: 'Интересный случай', setup: 'Число 45 стоит РОВНО посередине между 40 и 50. Куда оно пойдёт?',
    ask: 'Какой круглый десяток договорились считать для 45?',
    opts: ['50', '40', '45'],
    correct: 'Верно! Договорённость такая: если число ровно посередине, берём ВВЕРХ — 45 → 50.',
    wrong: 'Подсказка: от 45 до обеих сторон одинаково. Для этого случая есть специальная договорённость: куда берут число с середины?',
    rule: 'Число с середины берётся вверх: 45 → 50. Это договорённость.',
  },
};
