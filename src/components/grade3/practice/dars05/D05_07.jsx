// Dars 5 (3-sinf) · Amaliyot 07 — mustaqil topshiriq fayli (grade2 naqshi).
// Tuzoq: 350 allaqachon yumaloq o'nlik, lekin yumaloq YUZLIK so'ralyapti; o'rtada — yuqoriga (400).
...
/* =================== 07 · Yumaloq son ham yumaloqlanadi (350) · 🟡 · round_350 =================== */
// Chalg'ituvchilar: 300 (o'rtada pastga), 350 (allaqachon yumaloq deb o'ylash).
const D01_TAG = 'round_350', D01_LEVEL = '🟡', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: "Diqqat, tuzoq!", setup: "350 — o'zi yumaloq o'nlik. Lekin bizga yumaloq YUZLIK kerak: u 300 bilan 400 orasida, aynan o'rtada.",
    ask: "350 ga qaysi yumaloq yuzlik mos?",
    opts: ['400', '300', '350'],
    correct: "To'g'ri! 350 o'rtada turibdi, o'rtadagi son yuqoriga olinadi: 350 → 400.",
    wrong: "Maslahat: yumaloq yuzliklar: 300 va 400. 350 ular orasida qayerda turibdi? O'rtadagi son uchun kelishuvni eslang.",
    rule: "350 → 400: o'rtadagi son yuqoriga olinadi, yumaloq yuzlik esa nol bilan tugagan yuzlik bo'ladi.",
  },
  ru: {
    eyebrow: 'Внимание, ловушка!', setup: '350 — сам круглый десяток. Но нам нужна круглая СОТНЯ: оно между 300 и 400, ровно посередине.',
    ask: 'Какая круглая сотня подходит для 350?',
    opts: ['400', '300', '350'],
    correct: 'Верно! 350 стоит посередине, а число с середины берётся вверх: 350 → 400.',
    wrong: 'Подсказка: круглые сотни — 300 и 400. Где между ними стоит 350? Вспомни договорённость про середину.',
