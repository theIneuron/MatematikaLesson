// Dars 5 (3-sinf) · Amaliyot 08 — mustaqil topshiriq fayli (grade2 naqshi).
// Sonlar darslik poolidan: 427, 267, 854. Xato: 267 → 260 (270 bo'lishi kerak, 7 > 5).
...
/* =================== 08 · Xatoni toping · 🔴 · round_error =================== */
// Uchta yumaloqlashdan bittasi xato.
const D01_TAG = 'round_error', D01_LEVEL = '🔴', D01_CORRECT = 1;
const D01_T = {
  uz: {
    eyebrow: 'Xatoni toping', setup: "Uchta son yumaloq o'nlikka olindi. Bittasi xato.",
    ask: "Qaysi yozuv XATO? Uni bosing.",
    opts: ['427 → 430', '267 → 260', '854 → 850'],
    correct: "To'g'ri topdingiz! 267 → 270 bo'lishi kerak: oxirida 7 bor, 7 > 5 — keyingi o'nlikka.",
    wrong: "Maslahat: har sonning oxirgi raqamini tekshiring: 5 dan kichik — pastga, 5 va katta — yuqoriga. Qaysi yozuv bu qoidaga bo'ysunmagan?",
    rule: "Tekshiruv qoidasi: oxirgi raqam 5 dan kichik — pastga, aks holda yuqoriga.",
  },
  ru: {
    eyebrow: 'Найди ошибку', setup: 'Три числа привели к круглому десятку. Одно — с ошибкой.',
    ask: 'Какая запись НЕВЕРНА? Нажми на неё.',
    opts: ['427 → 430', '267 → 260', '854 → 850'],
    correct: 'Верно! Должно быть 267 → 270: на конце 7, а 7 > 5 — к следующему десятку.',
    wrong: 'Подсказка: проверь последнюю цифру каждого числа: меньше 5 — вниз, 5 и больше — вверх. Какая запись не подчиняется правилу?',
    rule: 'Правило проверки: последняя цифра меньше 5 — вниз, иначе — вверх.',
  },
};
...
function D05_08Impl(props) {
  ...
  return (
    <div style={S.wrap}>
      ...
      <Stage><Neon text="430 · 260 · 850" size={26} /></Stage>
