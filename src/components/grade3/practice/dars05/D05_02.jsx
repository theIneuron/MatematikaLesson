// Dars 5 (3-sinf) · Amaliyot 02 — mustaqil topshiriq fayli (grade2 naqshi).
// Sonlar darslik poolidan: 348 (79-bet). Eng yaqin yumaloq o'nlik — 350.
...
/* =================== 02 · Yumaloq o'nlik (348) · 🟢 · round_ten =================== */
// Chalg'ituvchilar: 340 (pastga olish), 300 (yuzlikka olish).
const D01_TAG = 'round_ten', D01_LEVEL = '🟢', D01_CORRECT = 0;
const D01_T = {
  uz: {
    eyebrow: 'Yumaloq songa', setup: "Displeyda 348 soni. Unga eng yaqin yumaloq o'nlikni topamiz.",
    ask: "348 ga eng yaqin yumaloq o'nlik qaysi?",
    opts: ['350', '340', '300'],
    correct: "To'g'ri! 348 → 350: oxirida 8 bor, 8 > 5 — demak keyingi yumaloq o'nlikka yaqin.",
    wrong: "Maslahat: 348 qaysi ikki yumaloq o'nlik orasida turibdi? Oxirgi raqamiga qarang: 8 — yarmidan ko'pmi?",
    rule: "Oxirgi raqam 5 yoki katta bo'lsa — keyingi yumaloq o'nlikka: 348 → 350.",
  },
  ru: {
    eyebrow: 'К круглому числу', setup: 'На дисплее число 348. Найдём ближайший круглый десяток.',
    ask: 'Какой круглый десяток ближе всего к 348?',
    opts: ['350', '340', '300'],
    correct: 'Верно! 348 → 350: на конце 8, а 8 > 5 — значит, ближе следующий круглый десяток.',
    wrong: 'Подсказка: между какими круглыми десятками стоит 348? Посмотри на последнюю цифру: 8 — это больше половины?',
    rule: 'Если последняя цифра 5 или больше — к следующему десятку: 348 → 350.',
  },
};
