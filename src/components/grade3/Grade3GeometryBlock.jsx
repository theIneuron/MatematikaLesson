...
export const GEOMETRY_LESSONS = {
  ...
  36: {
    ...
    story: T("Kristall maydoncha kvadrat shaklida, tomoni 6 m. Uni 1 m² li plitkalar bilan qoplash uchun nechta plitka kerakligini topish kerak.", 'Кристальная площадка имеет форму квадрата со стороной 6 м. Нужно узнать, сколько плиток площадью 1 м² потребуется для покрытия.'),
    rule: T("Kvadratning bo'yi va eni teng: a va a. Shuning uchun uning yuzasi S = a × a formula bilan topiladi va kvadrat birliklarda yoziladi.", 'Длина и ширина квадрата равны: a и a. Поэтому его площадь находят по формуле S = a × a и записывают в квадратных единицах.'),
    finish: T("Kvadrat maydoncha uchun 6 × 6 = 36 m² qoplama kerakligi aniqlandi. Siz kvadrat yuzasini topish va uni perimetr bilan adashtirmaslik qoidasini ochdingiz.", 'Для квадратной площадки вычислено покрытие: 6 × 6 = 36 м². Ты открыл правило площади квадрата и научился не путать её с периметром.'),
    checks: [
      q('▦  5 × 5', "Katakli shaklning yuzasi qancha?", 'Какова площадь фигуры на клетчатой сетке?', ['10 birlik²', '20 birlik²', '25 birlik²'], 2, "Qatorlar sonini ustunlar soniga ko'paytiring.", 'Умножь число рядов на число столбцов.'),
      q('□  a = 5 cm', "Kvadratning eni necha santimetr?", 'Какова ширина квадрата?', ['4 cm', '5 cm', '10 cm'], 1, "Kvadratning barcha tomonlari teng.", 'Все стороны квадрата равны.'),
      q('□  a = 6 m', "Maydonchadagi 1 m² li plitkalar sonini qaysi yozuv topadi?", 'Какая запись поможет найти число плиток площадью 1 м²?', ['6 + 6', '6 × 4', '6 × 6'], 2, "Kvadratning bo'yi ham, eni ham 6 m.", 'Длина и ширина квадрата равны 6 м.'),
      q('▦  4 qator × 4 ustun', "Katakli kvadratning yuzasi qancha?", 'Какова площадь квадрата на клетчатой сетке?', ['8 birlik²', '16 birlik²', '20 birlik²'], 1, "To'rtta qatorda to'rttadan katak bor.", 'В четырёх рядах по четыре клетки.'),
      q('□  a = 3 cm  →  ▦ 3 × 3', "Model qaysi yuzani ko'rsatadi?", 'Какую площадь показывает модель?', ['6 cm²', '9 cm²', '12 cm²'], 1, "3 × 3 ni hisoblang va kvadrat birlikni saqlang.", 'Вычисли 3 × 3 и сохрани квадратную единицу.'),
      q('2 × 2 = 4   3 × 3 = 9   4 × 4 = 16', "Har bir ko'paytmadagi teng ko'paytuvchilar nimani bildiradi?", 'Что обозначают одинаковые множители в каждом произведении?', [["Kvadratning tomonlarini", "Стороны квадрата"], ["Faqat perimetrni", "Только периметр"], ["Ikki xil shaklni", "Две разные фигуры"]], 0, "Kvadratning bo'yi va eni bir xil.", 'Длина и ширина квадрата одинаковы.'),
      q('S = a × a', "Nega formulada a ikki marta yoziladi?", 'Почему в формуле a записано дважды?', [["Bo'yi va eni teng", "Длина и ширина равны"], ["Kvadrat ikkita bo'ladi", "Квадратов два"], ["Perimetr hisoblanadi", "Вычисляется периметр"]], 0, "Yuza bo'yi bilan enining ko'paytmasidir.", 'Площадь — произведение длины и ширины.'),
      q('□  a = 8 cm   S = 8 × 8', "Kvadrat yuzasini toping.", 'Найди площадь квадрата.', ['16 cm²', '32 cm²', '64 cm²'], 2, "8 × 8 ni hisoblang.", 'Вычисли 8 × 8.'),
      q('□  a = 9 dm', "Qaysi javob to'g'ri?", 'Какой ответ верный?', ['18 dm²', '36 dm²', '81 dm²'], 2, "Tomonni o'ziga ko'paytiring.", 'Умножь сторону на себя.'),
      q('□  a = 12 m', "Yuzani mustaqil hisoblang.", 'Вычисли площадь самостоятельно.', ['24 m²', '48 m²', '144 m²'], 2, "S = 12 × 12.", 'S = 12 × 12.'),
      q('□  S = 49 cm²   a = ?', "Kvadrat tomoni qancha?", 'Чему равна сторона квадрата?', ['6 cm', '7 cm', '8 cm'], 1, "Qaysi son o'ziga ko'paytirilsa 49 bo'ladi?", 'Какое число при умножении на себя даёт 49?'),
      q('a = 6 m  →  S = 6 × 4 = 24 m²', "Hisobdagi xatoni toping.", 'Найди ошибку в вычислении.', [["Yuza 6 × 6 = 36 m²", "Площадь равна 6 × 6 = 36 м²"], ["24 m² — to'g'ri javob", "24 м² — верный ответ"], ["Yuza 6 + 6 bilan topiladi", "Площадь находят как 6 + 6"]], 0, "4 × a kvadratning perimetriga tegishli.", '4 × a относится к периметру квадрата.'),
      q('Kvadrat sahna: a = 10 m', "Polni qoplash uchun necha m² material kerak?", 'Сколько м² материала нужно для покрытия пола?', ['20 m²', '40 m²', '100 m²'], 2, "Ichki joy uchun S = 10 × 10.", 'Для внутренней части S = 10 × 10.'),
      q('Kvadrat panel: P = 32 cm', "Avval tomonini, so'ng yuzasini toping.", 'Сначала найди сторону, затем площадь.', ['32 cm²', '64 cm²', '128 cm²'], 1, "32 : 4 = 8 cm, keyin 8 × 8.", '32 : 4 = 8 см, затем 8 × 8.'),
      q('□  S = a × a', "Darsning asosiy xulosasi qaysi?", 'Какой главный вывод урока?', [["Kvadrat yuzasi tomonning o'ziga ko'paytmasi", "Площадь квадрата — произведение стороны на себя"], ["Kvadrat yuzasi to'rtta tomon yig'indisi", "Площадь квадрата — сумма четырёх сторон"], ["Yuza uzunlik birligida yoziladi", "Площадь записывают в единицах длины"]], 0, "Yuza ichki joyni bildiradi va kvadrat birliklarda yoziladi.", 'Площадь обозначает внутреннюю часть и записывается в квадратных единицах.'),
    ],
  },
  37: {
