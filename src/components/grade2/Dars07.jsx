...
const CONTENT = {
  ...
  s2: {
    ...
    info_badge: { ru: 'Главное', uz: 'Asosiy' },
    info: { ru: 'Единицы: 4 плюс 5 это 9. Десятки: 3 плюс 2 это 5. Вместе — 59.', uz: "Birliklar: 4 qo'shuv 5 — 9. O'nliklar: 3 qo'shuv 2 — 5. Birgalikda — 59." },
    audio: {
      ru: [
      ...
      uz: [
        ...
        "Doim o'ng tomondan, birliklardan boshlaymiz. To'rt qo'shuv besh — to'qqiz. To'qqizni birlik ustuniga yozamiz.",
        "Endi chapga, o'nliklarga o'tamiz. Uch qo'shuv ikki — besh. Beshni o'nlik ustuniga yozamiz.",
  ...
  s3: {
    ...
    rule: { ru: 'Складываем по разрядам: сначала единицы, потом десятки. Единицы под единицами, десятки под десятками. Ведь каждое число состоит из десятков и единиц.', uz: "Xonalab qo'shamiz: avval birliklar, keyin o'nliklar. Birlik ostiga birlik, o'nlik ostiga o'nlik. Chunki har son o'nlik va birliklardan tuzilgan." },
    check_q: { ru: 'Сложи единицы: 4 + 5 = ?', uz: "Birliklarni qo'sh: 4 + 5 = ?" },
    opts: [{ ru: '9', uz: '9', ok: true }, { ru: '8', uz: '8' }, { ru: '5', uz: '5' }, { ru: '45', uz: '45' }],
    wrong: { ru: 'Складываем только единицы: четыре плюс пять это девять.', uz: "Faqat birliklarni qo'shamiz: to'rt qo'shuv besh — to'qqiz." },
    ...
    audio: {
      ...
      uz: [
        ...
        "Endi o'zingiz. Birliklarni qo'shing: to'rt qo'shuv besh."
      ]
    }
  },
  ...
  s4: {
    ...
    body: { ru: 'Единицы: 2 плюс 6 это 8. Десятки: 5 плюс 1 это 6. Получилось 68.', uz: "Birliklar: 2 qo'shuv 6 — 8. O'nliklar: 5 qo'shuv 1 — 6. 68 bo'ldi." },
    warn: { ru: 'Не складывай десятки с единицами! Каждый столбик отдельно.', uz: "O'nlik bilan birlikni qo'shma! Har ustun alohida." },
    check_q: { ru: 'Сложи десятки: 5 + 1 = ?', uz: "O'nliklarni qo'sh: 5 + 1 = ?" },
    opts: [{ ru: '6', uz: '6', ok: true }, { ru: '7', uz: '7' }, { ru: '60', uz: '60' }],
    wrong: { ru: 'Складываем десятки: пять плюс один это шесть.', uz: "O'nliklarni qo'shamiz: besh qo'shuv bir — olti." },
    ...
    audio: {
      ...
      uz: [
        ...
        "Birliklar: ikki qo'shuv olti — sakkiz.",
        "O'nliklar: besh qo'shuv bir — olti. Oltmish sakkiz bo'ldi.",
        "O'nliklarni o'zingiz qo'shing: besh qo'shuv bir."
      ]
    }
  },
  ...
  s5: {
    ...
    wrong: { ru: 'Единицы: 3 плюс 1 это 4. Десятки: 4 плюс 2 это 6. Всего 64.', uz: "Birliklar: 3 qo'shuv 1 — 4. O'nliklar: 4 qo'shuv 2 — 6. Jami 64." },
    ...
    audio: {
      ...
      uz: [
        ...
        "Birliklar: uch qo'shuv bir — to'rt. O'nliklar: to'rt qo'shuv ikki — olti.",
  ...
  s6: {
    ...
    wrong: { ru: 'Единицы: 1 плюс 7 это 8. Десятки: 6 плюс 2 это 8. Всего 88.', uz: "Birliklar: 1 qo'shuv 7 — 8. O'nliklar: 6 qo'shuv 2 — 8. Jami 88." },
    done_text: { ru: 'Верно! 61 + 27 = 88.', uz: "To'g'ri! 61 + 27 = 88." },
    audio: {
      intro: { ru: 'Проверь себя перед практикой. Сложи шестьдесят один и двадцать семь.', uz: "Mashqdan oldin o'zingizni sina. Oltmish bir va yigirma yettini qo'sh." },
  ...
  s7: {
    ...
    wrong: { ru: 'Складывай по столбикам: единицы с единицами, десятки с десятками.', uz: "Ustunlab qo'sh: birlik bilan birlik, o'nlik bilan o'nlik." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Объяснение мы закончили, теперь тренировка. Складывай столбиком: сначала единицы, потом десятки.', uz: "Tushuntirishni tugatdik, endi trenirovka. Ustunlab qo'sh: avval birliklar, keyin o'nliklar." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Складывай каждый столбик отдельно.', uz: "Har ustunni alohida qo'sh." }
    }
  },
  ...
  s9: {
    eyebrow: { ru: 'Практика', uz: 'Mashq' },
    lead: { ru: 'Найди пропущенное число.', uz: "Yo'qolgan sonni top." },
    rounds: [
  ...
  s10: {
    ...
    wrong: { ru: 'Проверь каждый столбик: единицы и десятки отдельно.', uz: "Har ustunni tekshir: birlik va o'nlik alohida." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Ещё примеры на сложение. Считай столбиком.', uz: "Yana qo'shish misollari. Ustunlab sana." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Складывай каждый разряд отдельно.', uz: "Har xonani alohida qo'sh." }
    }
  },
  ...
  s11: {
    eyebrow: { ru: 'Практика', uz: 'Mashq' },
    lead: { ru: 'Найди ошибку в столбике.', uz: "Ustundagi xatoni top." },
    rounds: [
  ...
  s12: {
    ...
    audio: {
      ...
      uz: "Anvar kemaga ikki konteynerni yuklaydi. Birinchisida qirq ikki quti, ikkinchisida o'ttiz olti. Jami qancha quti? Ustunlab qo'sh."
    }
  },
  ...
  s13: {
    ...
    wrong: { ru: 'Единицы: 2 плюс 6 это 8. Десятки: 4 плюс 3 это 7. Всего 78.', uz: "Birliklar: 2 qo'shuv 6 — 8. O'nliklar: 4 qo'shuv 3 — 7. Jami 78." },
    done_text: { ru: 'Верно! 42 + 36 = 78 ящиков.', uz: "To'g'ri! 42 + 36 = 78 quti." },
    audio: {
      intro: { ru: 'В первом контейнере сорок два ящика, во втором тридцать шесть. Сложи столбиком.', uz: "Birinchi konteynerda qirq ikki quti, ikkinchisida o'ttiz olti. Ustunlab qo'sh." },
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <ColumnAdd a={34} b={25} sum={done ? 59 : null} emph={done ? null : 'units'}/>
        </div>
