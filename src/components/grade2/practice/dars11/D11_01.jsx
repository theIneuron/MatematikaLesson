// Dars 11 · Amaliyot 01 — mustaqil topshiriq fayli (grade1/grade5 uslubi).
...
const CFG_01 = {
  top: ['3', '4'], sign: '+', chips: [2, 5], want: { ten: 2, bir: 5 }, tag: 'placetwo', level: '🟢',
  T: {
    uz: { eyebrow: 'Joylang', setup: 'Yuqorida 34 turibdi. Pastga 25 ni joylaymiz.', ask: '25 ni to‘g‘ri joylang: 2 va 5 ni mos ustunga qo‘ying.', placed: '✓ joylandi', correct: "To'g'ri. 2 → o‘nlik ustuni, 5 → birlik ustuni.", wrong: "Maslahat: birlik ostiga birlik, o‘nlik ostiga o‘nlik. 25 sonida qaysi raqam birlik, qaysi biri o‘nlik ekanini aniqlang.", rule: "Ustunlab: birlik ostiga birlik, o‘nlik ostiga o‘nlik." },
    ru: { eyebrow: 'Размести', setup: 'Сверху 34. Снизу разместим 25.', ask: 'Размести 25 верно: 2 и 5 в нужный столбец.', placed: '✓ размещено', correct: 'Верно. 2 → десятки, 5 → единицы.', wrong: 'Подсказка: единицы под единицы, десятки под десятки. Определи, какая цифра в 25 — единицы, какая — десятки.', rule: 'Столбиком: единицы под единицы, десятки под десятки.' },
  },
};
const D11_01Impl = (props) => <PlaceTask {...props} cfg={CFG_01} />;
