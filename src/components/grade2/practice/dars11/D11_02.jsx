// Dars 11 · Amaliyot 02 — mustaqil topshiriq fayli (grade1/grade5 uslubi).
...
const CFG_02 = {
  top: ['4', '3'], sign: '+', chips: [5], want: { ten: null, bir: 5 }, tag: 'onesplace', level: '🟢',
  T: {
    uz: { eyebrow: 'Bir xonali son', setup: 'Yuqorida 43. Bir xonali 5 ni joylaymiz.', ask: '5 ni to‘g‘ri katakka qo‘ying. O‘nlik katagi bo‘sh qoladi.', placed: '✓ joylandi', correct: "To'g'ri. Bir xonali son birlik ustuniga tushadi, o‘nlik katagi bo‘sh.", wrong: "Maslahat: 5 — bu bir xonali son, ya'ni birlik. U qaysi ustunga tushadi?", rule: "Bir xonali son → birlik ustuniga. O‘nlik katagi bo‘sh qoladi." },
    ru: { eyebrow: 'Однозначное число', setup: 'Сверху 43. Разместим однозначное 5.', ask: 'Поставь 5 в нужную ячейку. Ячейка десятков остаётся пустой.', placed: '✓ размещено', correct: 'Верно. Однозначное число идёт в единицы, ячейка десятков пуста.', wrong: 'Подсказка: 5 — однозначное число, то есть единицы. В какой столбец оно идёт?', rule: 'Однозначное число → в единицы. Ячейка десятков пуста.' },
  },
};
const D11_02Impl = (props) => <PlaceTask {...props} cfg={CFG_02} />;
