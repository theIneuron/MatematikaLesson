// Dars 11 · Amaliyot 09 — mustaqil topshiriq fayli (grade1/grade5 uslubi).
...
const CFG_09 = {
  top: ['5', '4'], sign: '+', chips: [5], want: { ten: null, bir: 5 }, tag: 'wordsetup', level: '🔴',
  T: {
    uz: { eyebrow: 'Masala', setup: 'Anvar 54 ta batareya, yana 5 ta batareya yozmoqchi.', ask: '54 va 5 ni ustunlab tuzing: 5 ni to‘g‘ri katakka qo‘ying.', placed: '✓ joylandi', correct: "To'g'ri. 5 — bir xonali (birlik), 4 ning ostiga (birlik ustuniga) tushadi.", wrong: "Maslahat: 5 — bir xonali son. U 54 ning qaysi raqami ostiga tushadi?", rule: "Bir xonali son birlik ustuniga (4 ning ostiga)." },
    ru: { eyebrow: 'Задача', setup: 'Анвар записывает 54 батарейки и ещё 5 батареек.', ask: 'Составь 54 и 5 столбиком: поставь 5 в нужную ячейку.', placed: '✓ размещено', correct: 'Верно. 5 — однозначное (единицы), идёт под 4 (в единицы).', wrong: 'Подсказка: 5 — однозначное число. Под какую цифру 54 оно идёт?', rule: 'Однозначное число — в единицы (под 4).' },
  },
};
const D11_09Impl = (props) => <PlaceTask {...props} cfg={CFG_09} />;
