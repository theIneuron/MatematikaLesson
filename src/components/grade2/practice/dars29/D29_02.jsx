// Dars 29 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · MC · kvadrat nechta nuqta ===== */
const D02 = makeMC({ tag:'sq_pts', level:'🟢', correctIdx:1, half:true, fs:22, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><PolyFig n={4} stroke="#5BD6F2" /></div>) });
D02.T = {
  uz: { eyebrow:'Nuqtalar soni', setup:'Kvadratning har bir burchagida bitta nuqta (uch) bo‘ladi.', ask:'Kvadrat yasash uchun nechta nuqta (uch) kerak bo‘ladi?', opts:['3','4','5','6'],
    correct:"To'g'ri. Kvadratda 4 ta burchak — 4 ta nuqta kerak.", wrong:'Kvadratning burchaklarini sanang: har burchakda bitta nuqta.', rule:'Kvadrat — 4 ta nuqta (uch).' },
  ru: { eyebrow:'Число точек', setup:'В каждом углу квадрата — одна точка (вершина).', ask:'Сколько точек (вершин) нужно, чтобы построить квадрат?', opts:['3','4','5','6'],
    correct:'Верно. У квадрата 4 угла — нужны 4 точки.', wrong:'Посчитай углы квадрата: в каждом одна точка.', rule:'Квадрат — 4 точки.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_29_02(props) {
  return (
    <React.Fragment>
