// Dars 29 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · Story MC · kvadrat ===== */
const D09 = makeMC({ tag:'story_sq', level:'🔴', correctIdx:0, half:true, fs:16, mono:false, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><PolyFig n={4} stroke="#FFC23C" /></div>) });
D09.T = {
  uz: { eyebrow:'Masala', setup:'Anvar to‘rdan to‘rtta teng tomonli shakl yasadi. Uning har bir tomoni 3 katak.', ask:'Anvar qanday shakl yasadi?', opts:['Kvadrat','Uchburchak','Beshburchak','Doira'],
    correct:"To'g'ri. 4 ta teng tomon — bu kvadrat.", wrong:'Shaklning 4 ta teng tomoni bor. 4 teng tomonli shakl qanday ataladi?', rule:'4 ta teng tomon = kvadrat.' },
  ru: { eyebrow:'Задача', setup:'Анвар построил фигуру с 4 равными сторонами. Каждая сторона — 3 клетки.', ask:'Какую фигуру построил Анвар?', opts:['Квадрат','Треугольник','Пятиугольник','Круг'],
    correct:'Верно. 4 равные стороны — это квадрат.', wrong:'У фигуры 4 равные стороны. Как она называется?', rule:'4 равные стороны = квадрат.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_29_09(props) {
  return (
    <React.Fragment>
