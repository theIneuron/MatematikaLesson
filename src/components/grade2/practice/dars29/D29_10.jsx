// Dars 29 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 10 · TrueFalse · umumlashtirish ===== */
const D10 = makeTrueFalse({ tag:'tf_closed', level:'🔴', answer:true });
D10.T = {
  uz: { eyebrow:'Umumlashtirish', setup:'Shakl to‘liq (yopiq) bo‘lishi kerak.', ask:'Shakl to‘liq bo‘lishi uchun oxirgi chiziq birinchi nuqtaga qaytib ulanishi kerak. Bu fikr to‘g‘rimi?', yes:'Ha', no:'Yo‘q',
    correct:"To'g'ri javob: Ha. Oxirgi chiziq birinchi nuqtaga ulansa, shakl yopiq bo‘ladi.", wrong:'Yopiq shaklda chiziq aylanib, boshiga qaytadi. Bu shartmi?', rule:'Yopiq shakl — oxiri boshiga ulanadi.' },
  ru: { eyebrow:'Обобщение', setup:'Фигура должна быть замкнутой.', ask:'Чтобы фигура была замкнутой, последняя линия должна вернуться к первой точке. Верно?', yes:'Да', no:'Нет',
    correct:'Правильно: Да. Если последняя линия соединяется с первой точкой, фигура замкнута.', wrong:'В замкнутой фигуре линия возвращается к началу. Это условие?', rule:'Замкнутая — конец соединён с началом.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_29_10(props) {
  return (
    <React.Fragment>
