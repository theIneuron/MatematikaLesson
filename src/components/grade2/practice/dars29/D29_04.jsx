// Dars 29 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · IMZO DotBuild · kvadrat ===== */
const D04 = makeDotBuild({ tag:'build_sq', level:'🟡', target:4, shape:'square', cols:3, rows:3 });
D04.T = {
  uz: { eyebrow:'Nuqta-to‘r', setup:'Endi to‘rtta nuqtani ulab, to‘rt burchakli shakl yasaymiz.', ask:'To‘rdan 4 ta nuqtani bosib, KVADRAT yasang.', hint:'Nuqtalar', correct:"To'g'ri. 4 ta nuqta teng tomonli kvadrat hosil qildi.", wrong:'Kvadratning 4 burchagi kerak: tomonlari teng bo‘lsin va 3 ta nuqta bir chiziqda yotmasin. Masalan 2×2 kvadrat yasang.', rule:'Kvadrat — 4 ta nuqta, tomonlari teng (k×k).' },
  ru: { eyebrow:'Сетка точек', setup:'Теперь соединим четыре точки в четырёхугольник.', ask:'Нажми 4 точки и построй КВАДРАТ.', hint:'Точки', correct:'Верно. 4 точки образовали квадрат с равными сторонами.', wrong:'Нужны 4 угла квадрата: стороны равны и 3 точки не на одной прямой. Например, квадрат 2×2.', rule:'Квадрат — 4 точки, стороны равны (k×k).' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_29_04(props) {
  return (
    <React.Fragment>
