// Dars 29 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · IMZO DotBuild · uchburchak ===== */
const D01 = makeDotBuild({ tag:'build_tri', level:'🟢', target:3, shape:'triangle', cols:3, rows:3 });
D01.T = {
  uz: { eyebrow:'Nuqta-to‘r', setup:"Ra'no kosmik chizmada nuqtalar to‘rini ochdi. Nuqtalarni ulab shakl yasaymiz.", ask:'To‘rdan 3 ta nuqtani ketma-ket bosib ulang va uchburchak yasang.', hint:'Nuqtalar', correct:"To'g'ri. 3 ta nuqta ulanganda uchburchak hosil bo‘ldi.", wrong:'Uchburchak uchun 3 ta nuqta kerak, lekin ular BIR CHIZIQDA (bir qatorda yoki diagonalda) bo‘lmasligi kerak. Turli joylardan tanlang.', rule:'Uchburchak — 3 ta nuqta (uch) va 3 ta tomon.' },
  ru: { eyebrow:'Сетка точек', setup:'Рано открыла сетку точек. Соединим точки и построим фигуру.', ask:'Нажми и соедини 3 точки, чтобы получить треугольник.', hint:'Точки', correct:'Верно. 3 точки образуют треугольник.', wrong:'Для треугольника нужны 3 точки, но они НЕ должны лежать на одной прямой (в ряд или по диагонали). Выбери из разных мест.', rule:'Треугольник — 3 точки и 3 стороны.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_29_01(props) {
  return (
    <React.Fragment>
