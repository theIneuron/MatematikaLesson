// Dars 31 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · MC · x+3=8 ===== */
const D02 = makeMC({ tag:'mc_x3', level:'🟢', correctIdx:0, half:true, fs:20, stage:eqStage('x + 3 = 8') });
D02.T = {
  uz: { eyebrow:'Tenglama', setup:'x + 3 = 8 tenglamasida x — noma‘lum son.', ask:'x + 3 = 8 tenglamasida x nechchi bo‘ladi?', opts:['5','11','3','8'],
    correct:"To'g'ri. x = 8 − 3 = 5.", wrong:'x ga 3 qo‘shilganda 8 chiqadi. 8 dan 3 ni ayiring.', rule:'x + 3 = 8 → x = 5.' },
  ru: { eyebrow:'Уравнение', setup:'В x + 3 = 8 x — неизвестное число.', ask:'Чему равен x в уравнении x + 3 = 8?', opts:['5','11','3','8'],
    correct:'Верно. x = 8 − 3 = 5.', wrong:'К x прибавили 3 и вышло 8. Вычти из 8 число 3.', rule:'x + 3 = 8 → x = 5.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_31_02(props) {
  return (
    <React.Fragment>
