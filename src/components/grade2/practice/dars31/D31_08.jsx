// Dars 31 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · BuildNum · 12−x=8 ===== */
const D08 = makeBuildNum({ tag:'build_12x', level:'🔴', answer:4, cells:1, digits:['4','8','2','1'], stage:eqStage('12 − x = 8') });
D08.T = {
  uz: { eyebrow:'Yashirin ayriluvchi', setup:'12 − x = 8 tenglamasida x — ayiriladigan noma‘lum son.', ask:'12 − x = 8 tenglamada x ni toping va raqamlardan yasang:', correct:"To'g'ri. x = 12 − 8 = 4.", wrong:'12 dan x ni ayirganda 8 qoldi. Qancha ayirilgan? 12 dan 8 ni ayiring.', rule:'12 − x = 8 → x = 12 − 8 = 4.' },
  ru: { eyebrow:'Скрытое вычитаемое', setup:'В 12 − x = 8 x — вычитаемое неизвестное.', ask:'Найди x в 12 − x = 8 и составь из цифр:', correct:'Верно. x = 12 − 8 = 4.', wrong:'Из 12 вычли x и осталось 8. Сколько вычли? 12 − 8.', rule:'12 − x = 8 → x = 4.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_31_08(props) {
  return (
    <React.Fragment>
