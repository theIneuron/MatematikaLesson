// Dars 31 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · BuildNum · x−3=4 ===== */
const D04 = makeBuildNum({ tag:'build_x3', level:'🟡', answer:7, cells:1, digits:['7','1','4','3'], stage:eqStage('x − 3 = 4') });
D04.T = {
  uz: { eyebrow:'Tenglama · javob', setup:'x − 3 = 4 tenglamasida x — noma‘lum.', ask:'x − 3 = 4 tenglamada x ni toping va raqamlardan yasang:', correct:"To'g'ri. x = 4 + 3 = 7.", wrong:'x dan 3 ni ayirganda 4 qoldi. Demak x = 4 ga 3 ni qo‘shing.', rule:'x − 3 = 4 → x = 4 + 3 = 7.' },
  ru: { eyebrow:'Уравнение · ответ', setup:'В x − 3 = 4 x — неизвестное.', ask:'Найди x в x − 3 = 4 и составь из цифр:', correct:'Верно. x = 4 + 3 = 7.', wrong:'От x отняли 3 и осталось 4. Значит x = 4 + 3.', rule:'x − 3 = 4 → x = 7.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_31_04(props) {
  return (
    <React.Fragment>
