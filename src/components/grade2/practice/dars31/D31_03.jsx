// Dars 31 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · TrueFalse · x+2=6, x=4 ===== */
const D03 = makeTrueFalse({ tag:'tf_check', level:'🟢', answer:true, stage:eqStage('x + 2 = 6') });
D03.T = {
  uz: { eyebrow:"To'g'ri yoki noto'g'ri", setup:'x + 2 = 6 tenglamasi uchun javob taklif qilindi: x = 4.', ask:'x + 2 = 6 tenglamada x = 4 deyilyapti. 4 + 2 ni tekshiring — bu javob to‘g‘rimi?', yes:'Ha', no:'Yo‘q',
    correct:"To'g'ri javob: Ha. 4 + 2 = 6, demak x = 4 to‘g‘ri.", wrong:'x o‘rniga 4 ni qo‘yib tekshiring: 4 + 2 nechchi bo‘ladi? 6 gami?', rule:'x = 4 to‘g‘ri, chunki 4 + 2 = 6.' },
  ru: { eyebrow:'Верно или неверно', setup:'Для x + 2 = 6 предложен ответ: x = 4.', ask:'Говорят, что x = 4 в x + 2 = 6. Проверь 4 + 2 — верен ли ответ?', yes:'Да', no:'Нет',
    correct:'Правильно: Да. 4 + 2 = 6, значит x = 4 верно.', wrong:'Подставь 4 вместо x: сколько 4 + 2? Равно 6?', rule:'x = 4 верно, ведь 4 + 2 = 6.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_31_03(props) {
  return (
    <React.Fragment>
