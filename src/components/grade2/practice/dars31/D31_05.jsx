// Dars 31 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 05 · IMZO Balance · 7+x=10 ===== */
const D05 = makeBalance({ tag:'bal_7x', level:'🟡', op:'+', k:7, target:10, xvals:[3,17,4,2], leftLabel:(x)=> '7 + '+(x==null?'x':x) });
D05.T = {
  uz: { eyebrow:'Tarozi-muvozanat', setup:'Chap pallada 7 + x, o‘ng pallada 10.', ask:'7 + x = 10 bo‘lsa, x nechchi? Tarozi tenglashadigan sonni tanlang.', hint:'x ni tanlang — tarozi tenglashsin', level:'Muvozanat!', correct:"To'g'ri. x = 3, chunki 7 + 3 = 10.", wrong:'7 ga x qo‘shilganda 10 chiqadi. 10 dan 7 ni ayiring.', rule:'7 + x = 10 → x = 10 − 7 = 3.' },
  ru: { eyebrow:'Весы-равновесие', setup:'Слева 7 + x, справа 10.', ask:'Если 7 + x = 10, чему равен x? Выбери уравновешивающее число.', hint:'выбери x — пусть весы уравновесятся', level:'Равновесие!', correct:'Верно. x = 3, ведь 7 + 3 = 10.', wrong:'К 7 прибавили x и вышло 10. Вычти из 10 число 7.', rule:'7 + x = 10 → x = 3.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_31_05(props) {
  return (
    <React.Fragment>
