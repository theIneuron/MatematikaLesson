// Dars 31 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · MC · x−4=5 ===== */
const D07 = makeMC({ tag:'mc_x4', level:'🟡', correctIdx:0, half:true, fs:20, stage:eqStage('x − 4 = 5') });
D07.T = {
  uz: { eyebrow:'Tenglama', setup:'x − 4 = 5 tenglamasida x — noma‘lum.', ask:'x − 4 = 5 tenglamada x nechchi?', opts:['9','1','5','4'],
    correct:"To'g'ri. x = 5 + 4 = 9.", wrong:'x dan 4 ni ayirganda 5 qoldi. x ni topish uchun 5 ga 4 ni qo‘shing.', rule:'x − 4 = 5 → x = 9.' },
  ru: { eyebrow:'Уравнение', setup:'В x − 4 = 5 x — неизвестное.', ask:'Чему равен x в x − 4 = 5?', opts:['9','1','5','4'],
    correct:'Верно. x = 5 + 4 = 9.', wrong:'От x отняли 4 и осталось 5. Чтобы найти x, прибавь к 5 число 4.', rule:'x − 4 = 5 → x = 9.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_31_07(props) {
  return (
    <React.Fragment>
