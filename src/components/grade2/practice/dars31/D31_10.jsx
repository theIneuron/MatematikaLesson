// Dars 31 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 10 · MC · x+6=6 ===== */
const D10 = makeMC({ tag:'mc_zero', level:'🔴', correctIdx:0, half:true, fs:22, stage:eqStage('x + 6 = 6') });
D10.T = {
  uz: { eyebrow:'Umumlashtirish', setup:'x + 6 = 6 tenglamasida yig‘indi qo‘shiluvchining o‘ziga teng.', ask:'x + 6 = 6 tenglamada x nechchi bo‘ladi?', opts:['0','6','12','1'],
    correct:"To'g'ri. x = 6 − 6 = 0. Nol qo‘shilsa son o‘zgarmaydi.", wrong:'x ga 6 qo‘shilganda yana 6 chiqdi. Demak x hech narsa qo‘shmagan — nechchi?', rule:'x + 6 = 6 → x = 0.' },
  ru: { eyebrow:'Обобщение', setup:'В x + 6 = 6 сумма равна самому слагаемому.', ask:'Чему равен x в x + 6 = 6?', opts:['0','6','12','1'],
    correct:'Верно. x = 6 − 6 = 0. Прибавив ноль, число не меняется.', wrong:'К x прибавили 6 и снова вышло 6. Значит x ничего не добавил — сколько?', rule:'x + 6 = 6 → x = 0.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_31_10(props) {
  return (
    <React.Fragment>
