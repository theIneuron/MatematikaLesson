// Dars 31 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · IMZO Balance · x+4=9 ===== */
const D01 = makeBalance({ tag:'bal_x4', level:'🟢', op:'+', k:4, target:9, xvals:[5,13,4,6], leftLabel:(x)=> (x==null?'x':x)+' + 4' });
D01.T = {
  uz: { eyebrow:'Tarozi-muvozanat', setup:"Ra'no shlyuz kodini tarozida yechyapti. Chap pallada x + 4, o‘ng pallada 9. Tarozi muvozanatda.", ask:'x + 4 = 9 bo‘lsa, x nechchi? Pallalarni tenglashtiradigan sonni tanlang.', hint:'x ni tanlang — tarozi tenglashsin', level:'Muvozanat!', correct:"To'g'ri. x = 5, chunki 5 + 4 = 9.", wrong:'x + 4 natijasi 9 bo‘lishi kerak. 9 dan 4 ni ayiring — x qancha? (9 + 4 emas)', rule:'x + 4 = 9 → x = 9 − 4 = 5.' },
  ru: { eyebrow:'Весы-равновесие', setup:'Рано решает код на весах. Слева x + 4, справа 9. Весы в равновесии.', ask:'Если x + 4 = 9, чему равен x? Выбери число, уравновешивающее чаши.', hint:'выбери x — пусть весы уравновесятся', level:'Равновесие!', correct:'Верно. x = 5, ведь 5 + 4 = 9.', wrong:'x + 4 должно дать 9. Вычти из 9 число 4 — сколько x? (не 9 + 4)', rule:'x + 4 = 9 → x = 9 − 4 = 5.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_31_01(props) {
  return (
    <React.Fragment>
