// Dars 31 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · Story MC · x+4=9 ===== */
const D09 = makeMC({ tag:'story_eq', level:'🔴', correctIdx:0, half:true, fs:22, stage:eqStage('x + 4 = 9') });
D09.T = {
  uz: { eyebrow:'Masala', setup:'Anvarda bir necha batareya bor edi. Unga yana 4 ta batareya berilgach, jami 9 ta bo‘ldi. Bu holat x + 4 = 9 tenglamasi bilan yoziladi.', ask:'Anvarda dastlab nechta batareya bor edi?', opts:['5','13','4','9'],
    correct:"To'g'ri. x = 9 − 4 = 5 ta batareya.", wrong:'Jamidan (9) qo‘shilganini (4) ayiring — dastlab qancha bor edi?', rule:'x + 4 = 9 → x = 5.' },
  ru: { eyebrow:'Задача', setup:'У Анвара было несколько батареек. Ему дали ещё 4, и стало 9. Это записывают как x + 4 = 9.', ask:'Сколько батареек было у Анвара сначала?', opts:['5','13','4','9'],
    correct:'Верно. x = 9 − 4 = 5 батареек.', wrong:'Из общего (9) вычти добавленное (4) — сколько было сначала?', rule:'x + 4 = 9 → x = 5.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_31_09(props) {
  return (
    <React.Fragment>
