// Dars 8 · Amaliyot 08 — mustaqil topshiriq fayli (grade1/grade5 uslubi).
...
const D08_T = {
  uz: {
    eyebrow: 'Stolbik yeching', setup: 'Stolbik 76 − 32. Ikkala ustun ayiriladi.',
    ask: 'Ustunlab ayiring: avval birliklar, keyin o‘nliklar. Javobni tering.',
    correct: "To'g'ri. 6 − 2 = 4, 7 − 3 = 4. Javob 44.",
    wrong: "Maslahat: birliklarni ayiring (6 − 2), keyin o‘nliklarni (7 − 3). Har raqamni o‘rniga yozing.",
    rule: "Stolbik ayirish: birlik − birlik, o‘nlik − o‘nlik. 76 − 32 = 44.",
  },
  ru: {
    eyebrow: 'Реши столбиком', setup: 'Столбик 76 − 32. Вычитают оба столбца.',
    ask: 'Вычти столбиком: сначала единицы, потом десятки. Набери ответ.',
    correct: 'Верно. 6 − 2 = 4, 7 − 3 = 4. Ответ 44.',
    wrong: 'Подсказка: вычти единицы (6 − 2), затем десятки (7 − 3). Каждую цифру на место.',
    rule: 'Вычитание столбиком: единицы − единицы, десятки − десятки. 76 − 32 = 44.',
  },
};
function D08_08Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value: parseInt(val, 10) }, correctAnswer: { value: D08_ANS }, correct, meta: { tag: 'solve', level: '🔴' } });
    ...
    <div style={S.wrap}>
      ...
      <Stage>
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 12 }}>
          <Colon>
            <ColHeader />
            <Row sign="" tenNode={<DC ch="7" c={C.ten} />} oneNode={<DC ch="6" c={C.one} />} />
