// Dars 36 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · Story MC · vaqt ===== */
const D09 = makeMC({ tag:'story_time', level:'🔴', correctIdx:0, half:true, fs:20 });
D09.T = {
  uz: { eyebrow:'Masala', setup:'Kamola ertalab soat 8:00 da uyg‘ondi va 40 daqiqadan keyin maktabga chiqdi.', ask:'Kamola soat nechchida maktabga chiqdi?', opts:['8:40','8:04','9:40','8:00'],
    correct:"To'g'ri. 8:00 ga 40 daqiqa qo‘shsak — 8:40.", wrong:'8:00 ga 40 daqiqa qo‘shing: soat nechchi bo‘ladi?', rule:'8:00 + 40 daqiqa = 8:40.' },
  ru: { eyebrow:'Задача', setup:'Камола проснулась в 8:00 и через 40 минут вышла в школу.', ask:'Во сколько Камола вышла в школу?', opts:['8:40','8:04','9:40','8:00'],
    correct:'Верно. 8:00 плюс 40 минут — 8:40.', wrong:'Прибавь к 8:00 40 минут: который час?', rule:'8:00 + 40 минут = 8:40.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_36_09(props) {
  return (
    <React.Fragment>
