// Dars 36 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · IMZO UnitBuild · 300 so'm ===== */
const D04 = makeUnitBuild({ tag:'ub_money', level:'🟡', answer:300, cells:3, digits:['3','0','7','2'], unitIdx:2 });
D04.T = {
  uz: { eyebrow:'Birlikli javob', units:['daqiqa','sm','so‘m'], setup:'Bitda 500 so‘m bor edi. U 200 so‘mlik narsa sotib oldi.', ask:'Bitning qancha puli qoldi? Sonni yasang va birlikni tanlang.', correct:"To'g'ri. 500 − 200 = 300 so‘m.", wrong:'Bor puldan (500) sarflanganini (200) ayiring va so‘m birligini tanlang.', rule:'500 − 200 = 300 so‘m.' },
  ru: { eyebrow:'Ответ с единицей', units:['минут','см','сум'], setup:'У Бита было 500 сумов. Он купил вещь за 200 сумов.', ask:'Сколько денег осталось у Бита? Составь число и выбери единицу.', correct:'Верно. 500 − 200 = 300 сумов.', wrong:'Из своих денег (500) вычти потраченное (200) и выбери «сум».', rule:'500 − 200 = 300 сумов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_36_04(props) {
  return (
    <React.Fragment>
