// Dars 36 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · IMZO UnitBuild · 35 daqiqa ===== */
const D01 = makeUnitBuild({ tag:'ub_time', level:'🟢', answer:35, cells:2, digits:['3','5','2','0'], unitIdx:0 });
D01.T = {
  uz: { eyebrow:'Birlikli javob', units:['daqiqa','sm','so‘m'], setup:"Ra'no darsni 20 daqiqa o‘qidi, so‘ng 15 daqiqa mashq qildi.", ask:'Ra‘no jami necha vaqt shug‘ullandi? Sonni raqamlardan yasang va birlikni tanlang.', correct:"To'g'ri. 20 + 15 = 35 daqiqa.", wrong:'Ikkala vaqtni qo‘shing (20 + 15) va to‘g‘ri birlik (daqiqa) ni tanlang.', rule:'20 + 15 = 35 daqiqa.' },
  ru: { eyebrow:'Ответ с единицей', units:['минут','см','сум'], setup:'Рано читала урок 20 минут, затем 15 минут занималась.', ask:'Сколько всего времени занималась Рано? Составь число из цифр и выбери единицу.', correct:'Верно. 20 + 15 = 35 минут.', wrong:'Сложи оба времени (20 + 15) и выбери единицу (минут).', rule:'20 + 15 = 35 минут.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_36_01(props) {
  return (
    <React.Fragment>
