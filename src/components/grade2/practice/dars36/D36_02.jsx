// Dars 36 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · MC · 1m20sm = 120 sm ===== */
const D02 = makeMC({ tag:'len120', level:'🟢', correctIdx:0, half:true, fs:20 });
D02.T = {
  uz: { eyebrow:'Uzunlik masalasi', setup:'Anvar 1 m 20 sm uzunlikdagi arqon oldi. 1 m = 100 sm.', ask:'Anvar olgan arqon necha santimetr bo‘ladi?', opts:['120 sm','12 sm','20 sm','100 sm'],
    correct:"To'g'ri. 100 + 20 = 120 sm.", wrong:'Avval metrni sm ga aylantiring (100 sm), so‘ng 20 ni qo‘shing.', rule:'1 m 20 sm = 120 sm.' },
  ru: { eyebrow:'Задача на длину', setup:'Анвар взял верёвку 1 м 20 см. 1 м = 100 см.', ask:'Сколько сантиметров в верёвке Анвара?', opts:['120 см','12 см','20 см','100 см'],
    correct:'Верно. 100 + 20 = 120 см.', wrong:'Сначала переведи метр в см (100), затем прибавь 20.', rule:'1 м 20 см = 120 см.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_36_02(props) {
  return (
    <React.Fragment>
