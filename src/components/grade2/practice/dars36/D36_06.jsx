// Dars 36 · Amaliyot 06 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 06 · BuildNum · 50+50 sm ===== */
const D06 = makeBuildNum({ tag:'len100', level:'🟡', answer:100, cells:3, digits:['1','0','5','2'] });
D06.T = {
  uz: { eyebrow:'Uzunlik · javob', setup:'Zuhra 50 sm va yana 50 sm uzunlikdagi lentani uladi.', ask:'Lentaning umumiy uzunligi necha sm? Javobni raqamlardan yasang.', correct:"To'g'ri. 50 + 50 = 100 sm (1 m).", wrong:'Ikki lentani qo‘shing: 50 + 50 nechchi sm bo‘ladi?', rule:'50 + 50 = 100 sm.' },
  ru: { eyebrow:'Длина · ответ', setup:'Зухра соединила ленту 50 см и ещё 50 см.', ask:'Какова общая длина ленты в см? Составь ответ из цифр.', correct:'Верно. 50 + 50 = 100 см (1 м).', wrong:'Сложи две ленты: сколько 50 + 50 см?', rule:'50 + 50 = 100 см.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_36_06(props) {
  return (
    <React.Fragment>
