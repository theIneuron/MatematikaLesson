// Dars 36 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 10 · IMZO UnitBuild · 2dm+30sm = 50 sm ===== */
const D10 = makeUnitBuild({ tag:'ub_len', level:'🔴', answer:50, cells:2, digits:['5','0','3','2'], unitIdx:1 });
D10.T = {
  uz: { eyebrow:'Birlikli javob', units:['daqiqa','sm','so‘m'], setup:'Otabek 2 dm va 30 sm uzunlikdagi ikki simni uladi. 1 dm = 10 sm.', ask:'Simning umumiy uzunligi necha sm? Sonni yasang va birlikni tanlang.', correct:"To'g'ri. 2 dm = 20 sm, 20 + 30 = 50 sm.", wrong:'Avval dm ni sm ga aylantiring (2 dm = 20 sm), so‘ng 30 ni qo‘shing.', rule:'2 dm + 30 sm = 20 + 30 = 50 sm.' },
  ru: { eyebrow:'Ответ с единицей', units:['минут','см','сум'], setup:'Отабек соединил два провода: 2 дм и 30 см. 1 дм = 10 см.', ask:'Какова общая длина в см? Составь число и выбери единицу.', correct:'Верно. 2 дм = 20 см, 20 + 30 = 50 см.', wrong:'Сначала переведи дм в см (2 дм = 20 см), затем прибавь 30.', rule:'2 дм + 30 см = 20 + 30 = 50 см.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_36_10(props) {
  return (
    <React.Fragment>
