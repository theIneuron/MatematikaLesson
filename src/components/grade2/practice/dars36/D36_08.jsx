// Dars 36 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · Story MC · pul ikki narsa ===== */
const D08 = makeMC({ tag:'story_money2', level:'🔴', correctIdx:0, half:true, fs:18 });
D08.T = {
  uz: { eyebrow:'Masala', setup:'Sardorda 700 so‘m bor edi. U 300 so‘mlik va 200 so‘mlik ikkita narsa sotib oldi.', ask:'Sardorda qancha puli qoldi?', opts:['200 so‘m','500 so‘m','400 so‘m','100 so‘m'],
    correct:"To'g'ri. 300 + 200 = 500 sarfladi, 700 − 500 = 200 so‘m qoldi.", wrong:'Avval ikki narx yig‘indisini toping (300 + 200), so‘ng puldan ayiring.', rule:'700 − (300 + 200) = 200 so‘m.' },
  ru: { eyebrow:'Задача', setup:'У Сардора было 700 сумов. Он купил две вещи: за 300 и за 200 сумов.', ask:'Сколько денег осталось у Сардора?', opts:['200 сумов','500 сумов','400 сумов','100 сумов'],
    correct:'Верно. 300 + 200 = 500 потратил, 700 − 500 = 200 сумов осталось.', wrong:'Сначала сумма двух цен (300 + 200), потом вычти из денег.', rule:'700 − (300 + 200) = 200 сумов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_36_08(props) {
  return (
    <React.Fragment>
