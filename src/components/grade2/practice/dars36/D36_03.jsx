// Dars 36 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · MC · pul qo'shish ===== */
const D03 = makeMC({ tag:'money_sum', level:'🟢', correctIdx:0, half:true, fs:18 });
D03.T = {
  uz: { eyebrow:'Pul masalasi', setup:'Do‘konda ruchka 300 so‘m, o‘chirg‘ich 200 so‘m turadi.', ask:'Ruchka va o‘chirg‘ichni birga olsa, qancha to‘lash kerak?', opts:['500 so‘m','320 so‘m','100 so‘m','600 so‘m'],
    correct:"To'g'ri. 300 + 200 = 500 so‘m.", wrong:'Ikki narxni qo‘shing: 300 + 200 nechchi bo‘ladi?', rule:'300 + 200 = 500 so‘m.' },
  ru: { eyebrow:'Задача о деньгах', setup:'В магазине ручка 300 сумов, ластик 200 сумов.', ask:'Сколько заплатить за ручку и ластик вместе?', opts:['500 сумов','320 сумов','100 сумов','600 сумов'],
    correct:'Верно. 300 + 200 = 500 сумов.', wrong:'Сложи две цены: сколько 300 + 200?', rule:'300 + 200 = 500 сумов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_36_03(props) {
  return (
    <React.Fragment>
