// Dars 36 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 05 · MC · vaqt 9:30 ===== */
const D05 = makeMC({ tag:'time930', level:'🟡', correctIdx:0, half:true, fs:20 });
D05.T = {
  uz: { eyebrow:'Vaqt masalasi', setup:'Dars soat 9:00 da boshlandi va 30 minut davom etdi.', ask:'Dars soat nechchida tugadi?', opts:['9:30','9:03','12:00','10:00'],
    correct:"To'g'ri. 9:00 ga 30 minut qo‘shsak — 9:30.", wrong:'9:00 ga yarim soat (30 minut) qo‘shing: soat nechchi bo‘ladi?', rule:'9:00 + 30 minut = 9:30.' },
  ru: { eyebrow:'Задача на время', setup:'Урок начался в 9:00 и длился 30 минут.', ask:'Во сколько закончился урок?', opts:['9:30','9:03','12:00','10:00'],
    correct:'Верно. 9:00 плюс 30 минут — 9:30.', wrong:'Прибавь к 9:00 полчаса (30 минут): который час?', rule:'9:00 + 30 минут = 9:30.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_36_05(props) {
  return (
    <React.Fragment>
