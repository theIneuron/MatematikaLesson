// Dars 24 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 04 · Qaysi amal? (ko'paytirish) · 🟡 · opchoice2 =================== */
const D24_04 = makeMC('opchoice2', '🟡', 1,
  { uz: { eyebrow: 'Qaysi amal?', setup: "«Har vagonchada 6 kristal. 4 ta vagoncha bor. JAMI qancha?»", ask: 'Bu masala qaysi amal bilan yechiladi?', opts: ['Bo‘lish  ÷', 'Ko‘paytirish  ×', 'Ayirish  −', 'Qo‘shish  +'], correct: "To'g'ri. «Jami» va teng guruhlar — ko'paytirish: 6 × 4 = 24.", wrong: "Maslahat: teng guruhlarni JAMI uchun yig'sak — ko'paytirish, teng ulasak — bo'lish.", rule: "Teng guruhlar × jami → ko'paytirish (×). Teng ulash → bo'lish (÷)." },
    ru: { eyebrow: 'Какое действие?', setup: '«В каждой вагонетке 6 кристаллов. Вагонеток 4. Сколько ВСЕГО?»', ask: 'Каким действием решается задача?', opts: ['Деление  ÷', 'Умножение  ×', 'Вычитание  −', 'Сложение  +'], correct: 'Верно. «Всего» и равные группы — умножение: 6 × 4 = 24.', wrong: 'Подсказка: равные группы на «всего» — умножение, поделить поровну — деление.', rule: 'Равные группы, всего → умножение (×). Поровну → деление (÷).' } },
  null, true);
...
const __FX_CSS = `
      ...
      `;
export default function Task_24_04(props) {
  return (
    <React.Fragment>
