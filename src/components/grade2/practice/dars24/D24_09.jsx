// Dars 24 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 09 · Masala (katta) · 🔴 · wordhard =================== */
const D24_09 = makeMC('wordhard', '🔴', 2,
  { uz: { eyebrow: 'Masala', setup: "Zuhra 32 ta kristalni 8 do'stiga TENG uladi.", ask: 'Har do‘stga nechta kristal tegadi?', opts: ['6', '5', '4', '24'], correct: "To'g'ri. 32 ÷ 8 = 4. (8 × 4 = 32)", wrong: "Maslahat: teng ulash — bo'lish. 8 ni nechaga ko'paytirsak 32 bo'ladi? 32 − 8 = 24 emas.", rule: "Teng ulash → bo'lish: 32 ÷ 8 = 4." },
    ru: { eyebrow: 'Задача', setup: 'Зухра разделила 32 кристалла между 8 друзьями ПОРОВНУ.', ask: 'Сколько кристаллов достанется каждому?', opts: ['6', '5', '4', '24'], correct: 'Верно. 32 ÷ 8 = 4. (8 × 4 = 32)', wrong: 'Подсказка: поровну — деление. На что умножить 8, чтобы вышло 32? 32 − 8 = 24 — неверно.', rule: 'Поровну → деление: 32 ÷ 8 = 4.' } },
  () => <div>{CryRow(8, 4)}<div style={{ textAlign: 'center', marginTop: 6, fontSize: 13, fontWeight: 700, color: C.goldSoft }}>32 kristal · 8 do‘st · teng</div></div>);
...
const __FX_CSS = `
      ...
      `;
export default function Task_24_09(props) {
  return (
    <React.Fragment>
