// Dars 24 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 10 · Tuzoqli masala · 🔴 · trap =================== */
const D24_10 = makeMC('trap', '🔴', 1,
  { uz: { eyebrow: 'Diqqat!', setup: "«5 ta vagoncha, HAR birida 4 kristal. JAMI qancha kristal?»", ask: 'To‘g‘ri javobni tanlang:', opts: ['9  (5 + 4)', '20  (5 × 4)', '1  (5 − 4)', '2  (?)'], correct: "To'g'ri. «Jami» va teng guruhlar — ko'paytirish: 5 × 4 = 20.", wrong: "Maslahat: bu yerda teng ulash EMAS — teng guruhlarni JAMI uchun yig'yapmiz. Bu ko'paytirish.", rule: "«Jami» + teng guruhlar → ko'paytirish: 5 × 4 = 20." },
    ru: { eyebrow: 'Внимание!', setup: '«5 вагонеток, в КАЖДОЙ 4 кристалла. Сколько ВСЕГО?»', ask: 'Выбери верный ответ:', opts: ['9  (5 + 4)', '20  (5 × 4)', '1  (5 − 4)', '2  (?)'], correct: 'Верно. «Всего» и равные группы — умножение: 5 × 4 = 20.', wrong: 'Подсказка: здесь НЕ деление поровну — складываем равные группы для «всего». Это умножение.', rule: '«Всего» + равные группы → умножение: 5 × 4 = 20.' } },
  () => <div>{CryRow(5, 4)}<div style={{ textAlign: 'center', marginTop: 6, fontSize: 13, fontWeight: 700, color: C.goldSoft }}>5 vagoncha · har birida 4 · JAMI?</div></div>, true);
...
const __FX_CSS = `
      ...
      `;
export default function Task_24_10(props) {
  return (
    <React.Fragment>
