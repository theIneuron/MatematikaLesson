// Dars 24 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 01 · Teng ulash masala · 🟢 · partitive =================== */
const D24_01 = makeMC('partitive', '🟢', 0,
  { uz: { eyebrow: 'Masala', setup: "Anvar 12 ta kristalni 3 do'stiga TENG uladi.", ask: 'Har do‘stga nechta kristal tegadi?', opts: ['4', '3', '9', '36'], correct: "To'g'ri. 12 ÷ 3 = 4. «Teng ulash» — bo'lish.", wrong: "Maslahat: «teng ulash» — bu bo'lish. 12 ÷ 3 = ? 12 − 3 = 9 emas.", rule: "Teng ulash → bo'lish: 12 ÷ 3 = 4." },
    ru: { eyebrow: 'Задача', setup: 'Анвар разделил 12 кристаллов между 3 друзьями ПОРОВНУ.', ask: 'Сколько кристаллов достанется каждому?', opts: ['4', '3', '9', '36'], correct: 'Верно. 12 ÷ 3 = 4. «Поровну» — деление.', wrong: 'Подсказка: «поровну» — деление. 12 ÷ 3 = ? 12 − 3 = 9 — неверно.', rule: 'Поровну → деление: 12 ÷ 3 = 4.' } },
  () => <div>{CryRow(3, 4)}<div style={{ textAlign: 'center', marginTop: 6, fontSize: 13, fontWeight: 700, color: C.goldSoft }}>12 kristal · 3 do‘st · teng</div></div>);
...
const __FX_CSS = `
      ...
      `;
export default function Task_24_01(props) {
  return (
    <React.Fragment>
