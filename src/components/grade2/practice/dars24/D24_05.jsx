// Dars 24 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 05 · Kalit so'z · 🟡 · keyword =================== */
const D24_05 = makeMC('keyword', '🟡', 0,
  { uz: { eyebrow: 'Kalit so‘z', setup: "Ba'zi so'zlar bo'lishni bildiradi.", ask: 'Qaysi so‘z BO‘LISHni bildiradi?', opts: ['«teng ulash»', '«jami»', '«qo‘shildi»', '«ko‘paytir»'], correct: "To'g'ri. «Teng ulash» — bo'lish kaliti.", wrong: "Maslahat: teng qismlarga ajratish qaysi amal? «Jami» — yig'ish/ko'paytirish.", rule: "«Teng ulash / har biriga / teng bo‘l» — bo'lish kalitlari." },
    ru: { eyebrow: 'Ключевое слово', setup: 'Некоторые слова указывают на деление.', ask: 'Какое слово указывает на ДЕЛЕНИЕ?', opts: ['«поровну»', '«всего»', '«добавили»', '«умножь»'], correct: 'Верно. «Поровну» — ключ деления.', wrong: 'Подсказка: разделить на равные части — какое действие? «Всего» — сложение/умножение.', rule: '«Поровну / каждому / раздели» — ключи деления.' } },
  null, true);
...
const __FX_CSS = `
      ...
      `;
export default function Task_24_05(props) {
  return (
    <React.Fragment>
