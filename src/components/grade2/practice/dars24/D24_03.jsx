// Dars 24 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 03 · Qaysi amal? (bo'lish) · 🟢 · opchoice1 =================== */
const D24_03 = makeMC('opchoice1', '🟢', 0,
  { uz: { eyebrow: 'Qaysi amal?', setup: "«20 ta kristal 4 vagonchaga TENG ulanadi. Har vagonchada nechta?»", ask: 'Bu masala qaysi amal bilan yechiladi?', opts: ['Bo‘lish  ÷', 'Ko‘paytirish  ×', 'Qo‘shish  +', 'Ayirish  −'], correct: "To'g'ri. «Teng ulash» — bo'lish: 20 ÷ 4 = 5.", wrong: "Maslahat: «teng ulanadi» so'zi bo'lishni bildiradi. Jami emas, teng ulash.", rule: "Teng ulash → bo'lish (÷)." },
    ru: { eyebrow: 'Какое действие?', setup: '«20 кристаллов делят ПОРОВНУ в 4 вагонетки. Сколько в каждой?»', ask: 'Каким действием решается задача?', opts: ['Деление  ÷', 'Умножение  ×', 'Сложение  +', 'Вычитание  −'], correct: 'Верно. «Поровну» — деление: 20 ÷ 4 = 5.', wrong: 'Подсказка: «поровну» означает деление. Не «всего», а поровну.', rule: 'Поровну → деление (÷).' } },
  null, true);
...
const __FX_CSS = `
      ...
      `;
export default function Task_24_03(props) {
  return (
    <React.Fragment>
