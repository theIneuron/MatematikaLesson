// Dars 22 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 04 · Jadval to'ldir (÷5) · 🟡 · tablefill5 =================== */
const CFG_04 = {
  steps: [{ step: 5, count: 5, blanks: [{ idx: 1, val: 2 }, { idx: 3, val: 4 }] }], pool: [2, 4, 3, 5], tag: 'tablefill5', level: '🟡',
  T: {
    uz: { eyebrow: 'Jadvalni to‘ldir', setup: "÷5 jadvali. Ikki katak bo'sh.", ask: 'Bo‘sh kataklarni to‘g‘ri raqamlar bilan to‘ldiring:', correct: "To'g'ri. 10 ÷ 5 = 2, 20 ÷ 5 = 4.", wrong: "Maslahat: 5→1, 10→2 … tartib bilan. 5 × 2 = 10, 5 × 4 = 20.", rule: "÷5: 5→1, 10→2, 15→3, 20→4, 25→5." },
    ru: { eyebrow: 'Заполни таблицу', setup: 'Таблица ÷5. Две клетки пусты.', ask: 'Заполни пустые клетки верными числами:', correct: 'Верно. 10 ÷ 5 = 2, 20 ÷ 5 = 4.', wrong: 'Подсказка: 5→1, 10→2 … по порядку. 5 × 2 = 10, 5 × 4 = 20.', rule: '÷5: 5→1, 10→2, 15→3, 20→4, 25→5.' },
  },
};
const D22_04 = (props) => <TableFillTask {...props} cfg={CFG_04} />;
...
const __FX_CSS = `
      ...
      `;
export default function Task_22_04(props) {
  return (
    <React.Fragment>
