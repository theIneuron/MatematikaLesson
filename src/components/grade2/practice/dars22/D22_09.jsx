// Dars 22 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 09 · Aralash jadval (÷4 & ÷5) · 🔴 · tablefill_mixed =================== */
const CFG_09 = {
  steps: [{ step: 4, count: 5, blanks: [{ idx: 3, val: 4 }] }, { step: 5, count: 5, blanks: [{ idx: 4, val: 5 }] }], pool: [4, 5, 6, 3], tag: 'tablefill_mixed', level: '🔴',
  T: {
    uz: { eyebrow: 'Aralash jadval', setup: "÷4 va ÷5 jadvallari. Har qatorda bitta katak bo'sh.", ask: 'Ikkala bo‘sh katakni to‘g‘ri to‘ldiring:', correct: "To'g'ri. 16 ÷ 4 = 4, 25 ÷ 5 = 5.", wrong: "Maslahat: ÷4 qatorida tartib 1,2,3,4,5; ÷5 qatorida ham. 4 × 4 = 16, 5 × 5 = 25.", rule: "16 ÷ 4 = 4, 25 ÷ 5 = 5." },
    ru: { eyebrow: 'Смешанная таблица', setup: 'Таблицы ÷4 и ÷5. В каждой строке одна пустая клетка.', ask: 'Заполни обе пустые клетки верно:', correct: 'Верно. 16 ÷ 4 = 4, 25 ÷ 5 = 5.', wrong: 'Подсказка: в строке ÷4 порядок 1,2,3,4,5; в ÷5 так же. 4 × 4 = 16, 5 × 5 = 25.', rule: '16 ÷ 4 = 4, 25 ÷ 5 = 5.' },
  },
};
const D22_09 = (props) => <TableFillTask {...props} cfg={CFG_09} />;
...
const __FX_CSS = `
      ...
      `;
export default function Task_22_09(props) {
  return (
    <React.Fragment>
