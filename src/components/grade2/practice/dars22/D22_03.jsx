// Dars 22 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 03 · Jadval to'ldir (÷4) · 🟢 · tablefill4 =================== */
const CFG_03 = {
  steps: [{ step: 4, count: 5, blanks: [{ idx: 2, val: 3 }, { idx: 4, val: 5 }] }], pool: [3, 5, 6, 2], tag: 'tablefill4', level: '🟢',
  T: {
    uz: { eyebrow: 'Jadvalni to‘ldir', setup: "÷4 jadvali. Ikki katak bo'sh.", ask: 'Ikki bo‘sh katakni to‘g‘ri raqamlar bilan to‘ldiring:', correct: "To'g'ri. 12 ÷ 4 = 3, 20 ÷ 4 = 5. Bo'linmalar tartib bilan.", wrong: "Maslahat: bo'linmalar 1, 2, 3, 4, 5 tartibda. 4 × 3 = 12, 4 × 5 = 20.", rule: "÷4: 4→1, 8→2, 12→3, 16→4, 20→5." },
    ru: { eyebrow: 'Заполни таблицу', setup: 'Таблица ÷4. Две клетки пусты.', ask: 'Заполни две пустые клетки верными числами:', correct: 'Верно. 12 ÷ 4 = 3, 20 ÷ 4 = 5. По порядку.', wrong: 'Подсказка: частные по порядку 1, 2, 3, 4, 5. 4 × 3 = 12, 4 × 5 = 20.', rule: '÷4: 4→1, 8→2, 12→3, 16→4, 20→5.' },
  },
};
const D22_03 = (props) => <TableFillTask {...props} cfg={CFG_03} />;
...
const __FX_CSS = `
      ...
      `;
export default function Task_22_03(props) {
  return (
    <React.Fragment>
