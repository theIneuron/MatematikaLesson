// Dars 33 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 05 · MC · minut strelkasi 3 ===== */
const D05 = makeMC({ tag:'min15', level:'🟡', correctIdx:0, half:true, fs:22, stage:clockStage(1,15) });
D05.T = {
  uz: { eyebrow:'Minutlarni o‘qish', setup:'Katta (minut) strelka 3 raqamining ustida turibdi.', ask:'Minut strelkasi 3 raqamida bo‘lsa, bu necha minutni bildiradi?', opts:['15','3','30','5'],
    correct:"To'g'ri. Har bir raqam 5 minut: 3 × 5 = 15 minut.", wrong:'Har bir raqam orasida 5 minut bor. 3 raqamigacha: 5, 10, 15 — nechchi?', rule:'Minut strelkasi 3 da → 15 minut.' },
  ru: { eyebrow:'Чтение минут', setup:'Большая (минутная) стрелка на числе 3.', ask:'Если минутная стрелка на числе 3, сколько это минут?', opts:['15','3','30','5'],
    correct:'Верно. Каждое число — 5 минут: 3 × 5 = 15 минут.', wrong:'Между числами по 5 минут. До числа 3: 5, 10, 15 — сколько?', rule:'Минутная на 3 → 15 минут.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_33_05(props) {
  return (
    <React.Fragment>
