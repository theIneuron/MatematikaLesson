// Dars 33 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · Story MC · 8:00 + 30 min ===== */
const D09 = makeMC({ tag:'story_time', level:'🔴', correctIdx:0, half:true, fs:20, stage:clockStage(8,0) });
D09.T = {
  uz: { eyebrow:'Masala', setup:'Ra‘no ertalab soat 8:00 da uyg‘ondi. 30 minutdan keyin nonushta qildi.', ask:'Ra‘no soat nechchida nonushta qildi?', opts:['8:30','8:03','11:00','8:00'],
    correct:"To'g'ri. 8:00 ga 30 minut qo‘shsak — 8:30.", wrong:'8:00 ga 30 minut (yarim soat) qo‘shing: soat nechchi bo‘ladi?', rule:'8:00 + 30 minut = 8:30.' },
  ru: { eyebrow:'Задача', setup:'Рано проснулась в 8:00. Через 30 минут позавтракала.', ask:'Во сколько Рано позавтракала?', opts:['8:30','8:03','11:00','8:00'],
    correct:'Верно. 8:00 плюс 30 минут — 8:30.', wrong:'Прибавь к 8:00 30 минут (полчаса): который час?', rule:'8:00 + 30 минут = 8:30.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_33_09(props) {
  return (
    <React.Fragment>
