// Dars 33 · Amaliyot 06 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 06 · MC ClockRead · 4:30 ===== */
const D06 = makeMC({ tag:'read430', level:'🟡', correctIdx:0, half:true, fs:20, stage:clockStage(4,30) });
D06.T = {
  uz: { eyebrow:'Soatni o‘qish', setup:'Kichik strelka 4 va 5 orasida, katta strelka 6 da (pastda) turibdi.', ask:'Soat nechani ko‘rsatyapti?', opts:['4:30','6:04','4:06','5:30'],
    correct:"To'g'ri. Soat 4:30 (to‘rt yarim) ni ko‘rsatyapti.", wrong:'Katta strelka 6 da — bu 30 minut. Kichik strelka 4 dan o‘tgan. Soat nechchi?', rule:'Katta strelka 6 da → 30 minut; 4:30.' },
  ru: { eyebrow:'Чтение часов', setup:'Маленькая стрелка между 4 и 5, большая на 6 (внизу).', ask:'Который час показывают часы?', opts:['4:30','6:04','4:06','5:30'],
    correct:'Верно. Часы показывают 4:30 (половина пятого).', wrong:'Большая стрелка на 6 — это 30 минут. Маленькая прошла 4. Который час?', rule:'Большая на 6 → 30 минут; 4:30.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_33_06(props) {
  return (
    <React.Fragment>
