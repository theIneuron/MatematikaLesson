// Dars 33 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · MC · 1 soat = 60 minut ===== */
const D02 = makeMC({ tag:'hour_min', level:'🟢', correctIdx:0, half:true, fs:22 });
D02.T = {
  uz: { eyebrow:'Vaqt birliklari', setup:'Soat va minut — vaqt birliklari.', ask:'Bir soatda nechta minut bor?', opts:['60','100','30','12'],
    correct:"To'g'ri. 1 soat = 60 minut.", wrong:'Soat gardishini katta strelka to‘liq aylanib chiqadi — bu qancha minut?', rule:'1 soat = 60 minut.' },
  ru: { eyebrow:'Единицы времени', setup:'Час и минута — единицы времени.', ask:'Сколько минут в одном часе?', opts:['60','100','30','12'],
    correct:'Верно. 1 час = 60 минут.', wrong:'Большая стрелка делает полный круг — это сколько минут?', rule:'1 час = 60 минут.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_33_02(props) {
  return (
    <React.Fragment>
