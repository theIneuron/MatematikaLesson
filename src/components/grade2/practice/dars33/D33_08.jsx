// Dars 33 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · MC · 2:00 + 1 soat ===== */
const D08 = makeMC({ tag:'plus1h', level:'🔴', correctIdx:0, half:true, fs:20, stage:clockStage(2,0) });
D08.T = {
  uz: { eyebrow:'Vaqtni qo‘shish', setup:'Hozir soat 2:00 ni ko‘rsatyapti.', ask:'Hozir soat 2:00. Oradan 1 soat o‘tgach, soat nechchi bo‘ladi?', opts:['3:00','1:00','2:01','12:00'],
    correct:"To'g'ri. 2:00 dan 1 soat o‘tsa — 3:00.", wrong:'Soatga 1 soat qo‘shing: 2 dan keyingi soat nechchi?', rule:'2:00 + 1 soat = 3:00.' },
  ru: { eyebrow:'Прибавь время', setup:'Сейчас часы показывают 2:00.', ask:'Сейчас 2:00. Через 1 час который будет час?', opts:['3:00','1:00','2:01','12:00'],
    correct:'Верно. Через час после 2:00 — 3:00.', wrong:'Прибавь к часу 1 час: какой час после 2?', rule:'2:00 + 1 час = 3:00.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_33_08(props) {
  return (
    <React.Fragment>
