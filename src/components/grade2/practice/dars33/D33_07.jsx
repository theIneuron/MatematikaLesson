// Dars 33 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · BuildNum · yarim soat = 30 min ===== */
const D07 = makeBuildNum({ tag:'half_hour', level:'🟡', answer:30, cells:2, digits:['3','0','1','5'] });
D07.T = {
  uz: { eyebrow:'Yarim soat', setup:'Bir soat 60 minut. Yarim soat — bu soatning yarmi.', ask:'Yarim soat necha minutga teng? Javobni raqamlardan yasang.', correct:"To'g'ri. Yarim soat = 30 minut (60 ning yarmi).", wrong:'60 minutning yarmi qancha bo‘ladi? 60 ni ikkiga bo‘ling.', rule:'Yarim soat = 30 minut.' },
  ru: { eyebrow:'Полчаса', setup:'В часе 60 минут. Полчаса — половина часа.', ask:'Сколько минут в получасе? Составь ответ из цифр.', correct:'Верно. Полчаса = 30 минут (половина 60).', wrong:'Сколько половина от 60 минут? Раздели 60 на два.', rule:'Полчаса = 30 минут.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_33_07(props) {
  return (
    <React.Fragment>
