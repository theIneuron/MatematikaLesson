// Dars 33 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 10 · TrueFalse · 12:00 ===== */
const D10 = makeTrueFalse({ tag:'tf_1200', level:'🔴', answer:true, stage:clockStage(12,0) });
D10.T = {
  uz: { eyebrow:'Umumlashtirish', setup:'Soat 12:00 ni ko‘rsatyapti.', ask:'Soat 12:00 ni ko‘rsatganda ikkala strelka ham 12 raqamining ustida turadi. Bu fikr to‘g‘rimi?', yes:'Ha', no:'Yo‘q',
    correct:"To'g'ri javob: Ha. 12:00 da ikkala strelka 12 da.", wrong:'12:00 da soat ham, minut ham 12 ni ko‘rsatadi. Rasmga qarang.', rule:'12:00 → ikkala strelka 12 da.' },
  ru: { eyebrow:'Обобщение', setup:'Часы показывают 12:00.', ask:'Когда часы показывают 12:00, обе стрелки стоят на числе 12. Верно?', yes:'Да', no:'Нет',
    correct:'Правильно: Да. В 12:00 обе стрелки на 12.', wrong:'В 12:00 и часовая, и минутная на 12. Посмотри на рисунок.', rule:'12:00 → обе стрелки на 12.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_33_10(props) {
  return (
    <React.Fragment>
