// Dars 33 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · MC ClockRead · 3:00 ===== */
const D01 = makeMC({ tag:'read3', level:'🟢', correctIdx:0, half:true, fs:20, stage:clockStage(3,0) });
D01.T = {
  uz: { eyebrow:'Soatni o‘qish', setup:"Ra'no bort soatiga qaradi. Kichik strelka 3 da, katta strelka 12 da.", ask:'Soat nechani ko‘rsatyapti?', opts:['3:00','12:03','9:00','3:30'],
    correct:"To'g'ri. Soat 3:00 (uch) ni ko‘rsatyapti.", wrong:'Kichik strelka soatni, katta strelka (12 da) minutni ko‘rsatadi. Soat nechchi?', rule:'Kichik strelka 3 da, katta 12 da → 3:00.' },
  ru: { eyebrow:'Чтение часов', setup:'Рано взглянула на часы. Маленькая стрелка на 3, большая на 12.', ask:'Который час показывают часы?', opts:['3:00','12:03','9:00','3:30'],
    correct:'Верно. Часы показывают 3:00 (три).', wrong:'Маленькая стрелка — час, большая (на 12) — минуты. Который час?', rule:'Маленькая на 3, большая на 12 → 3:00.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_33_01(props) {
  return (
    <React.Fragment>
