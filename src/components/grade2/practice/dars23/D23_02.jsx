// Dars 23 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 02 · Jadvaldan izla (÷7) · 🟢 · mtlook7 =================== */
const D23_02 = makeMC('mtlook7', '🟢', 1,
  { uz: { eyebrow: 'Jadvaldan izla', setup: "28 ni 7 ga bo'lish.", ask: '7 × ? = 28. Demak 28 ÷ 7 = ?', opts: ['3', '4', '5', '6'], correct: "To'g'ri. 7 × 4 = 28, demak 28 ÷ 7 = 4.", wrong: "Maslahat: 7 ni nechaga ko'paytirsak 28 chiqadi?", rule: "7 × 4 = 28 → 28 ÷ 7 = 4." },
    ru: { eyebrow: 'Ищи в таблице', setup: 'Делим 28 на 7.', ask: '7 × ? = 28. Значит 28 ÷ 7 = ?', opts: ['3', '4', '5', '6'], correct: 'Верно. 7 × 4 = 28, значит 28 ÷ 7 = 4.', wrong: 'Подсказка: на что умножить 7, чтобы вышло 28?', rule: '7 × 4 = 28 → 28 ÷ 7 = 4.' } },
  () => <div style={{ display: 'flex', justifyContent: 'center' }}><MultRow base={7} upto={7} target={28} /></div>);
...
const __FX_CSS = `
      ...
      `;
export default function Task_23_02(props) {
  return (
    <React.Fragment>
