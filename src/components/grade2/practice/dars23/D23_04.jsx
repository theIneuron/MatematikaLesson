// Dars 23 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 04 · Jadvaldan izla (÷8) · 🟡 · mtlook8 =================== */
const D23_04 = makeMC('mtlook8', '🟡', 2,
  { uz: { eyebrow: 'Jadvaldan izla', setup: "48 ni 8 ga bo'lish.", ask: '8 × ? = 48. Demak 48 ÷ 8 = ?', opts: ['5', '7', '6', '8'], correct: "To'g'ri. 8 × 6 = 48, demak 48 ÷ 8 = 6.", wrong: "Maslahat: 8 ni nechaga ko'paytirsak 48 chiqadi?", rule: "8 × 6 = 48 → 48 ÷ 8 = 6." },
    ru: { eyebrow: 'Ищи в таблице', setup: 'Делим 48 на 8.', ask: '8 × ? = 48. Значит 48 ÷ 8 = ?', opts: ['5', '7', '6', '8'], correct: 'Верно. 8 × 6 = 48, значит 48 ÷ 8 = 6.', wrong: 'Подсказка: на что умножить 8, чтобы вышло 48?', rule: '8 × 6 = 48 → 48 ÷ 8 = 6.' } },
  () => <div style={{ display: 'flex', justifyContent: 'center' }}><MultRow base={8} upto={8} target={48} /></div>);
...
const __FX_CSS = `
      ...
      `;
export default function Task_23_04(props) {
  return (
    <React.Fragment>
