// Dars 23 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 10 · Katta izlash (÷9) · 🔴 · biglook =================== */
const D23_10 = makeMC('biglook', '🔴', 2,
  { uz: { eyebrow: 'Jadvaldan izla', setup: "72 ni 9 ga bo'lish (eng katta).", ask: '9 × ? = 72. Demak 72 ÷ 9 = ?', opts: ['7', '9', '8', '6'], correct: "To'g'ri. 9 × 8 = 72, demak 72 ÷ 9 = 8.", wrong: "Maslahat: 9 × 8 va 9 × 9 ni solishtiring. Qaysi biri 72?", rule: "9 × 8 = 72 → 72 ÷ 9 = 8." },
    ru: { eyebrow: 'Ищи в таблице', setup: 'Делим 72 на 9 (самое большое).', ask: '9 × ? = 72. Значит 72 ÷ 9 = ?', opts: ['7', '9', '8', '6'], correct: 'Верно. 9 × 8 = 72, значит 72 ÷ 9 = 8.', wrong: 'Подсказка: сравни 9 × 8 и 9 × 9. Какое даёт 72?', rule: '9 × 8 = 72 → 72 ÷ 9 = 8.' } },
  () => <div style={{ display: 'flex', justifyContent: 'center' }}><MultRow base={9} upto={9} target={72} /></div>);
...
const __FX_CSS = `
      ...
      `;
export default function Task_23_10(props) {
  return (
    <React.Fragment>
