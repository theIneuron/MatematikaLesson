// Dars 23 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 05 · Jadvaldan izla (÷9) · 🟡 · mtlook9 =================== */
const D23_05 = makeMC('mtlook9', '🟡', 3,
  { uz: { eyebrow: 'Jadvaldan izla', setup: "63 ni 9 ga bo'lish.", ask: '9 × ? = 63. Demak 63 ÷ 9 = ?', opts: ['6', '8', '9', '7'], correct: "To'g'ri. 9 × 7 = 63, demak 63 ÷ 9 = 7.", wrong: "Maslahat: 9 ni nechaga ko'paytirsak 63 chiqadi?", rule: "9 × 7 = 63 → 63 ÷ 9 = 7." },
    ru: { eyebrow: 'Ищи в таблице', setup: 'Делим 63 на 9.', ask: '9 × ? = 63. Значит 63 ÷ 9 = ?', opts: ['6', '8', '9', '7'], correct: 'Верно. 9 × 7 = 63, значит 63 ÷ 9 = 7.', wrong: 'Подсказка: на что умножить 9, чтобы вышло 63?', rule: '9 × 7 = 63 → 63 ÷ 9 = 7.' } },
  () => <div style={{ display: 'flex', justifyContent: 'center' }}><MultRow base={9} upto={7} target={63} /></div>);
...
const __FX_CSS = `
      ...
      `;
export default function Task_23_05(props) {
  return (
    <React.Fragment>
