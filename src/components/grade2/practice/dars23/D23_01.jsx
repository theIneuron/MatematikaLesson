// Dars 23 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 01 · Jadvaldan izla (÷6) · 🟢 · mtlook6 =================== */
const D23_01 = makeMC('mtlook6', '🟢', 3,
  { uz: { eyebrow: 'Jadvaldan izla', setup: "42 ni 6 ga bo'lish. Ko'paytirish jadvalidan izlang.", ask: '6 × ? = 42. Demak 42 ÷ 6 = ?', opts: ['5', '6', '8', '7'], correct: "To'g'ri. 6 × 7 = 42, demak 42 ÷ 6 = 7.", wrong: "Maslahat: 6 ni nechaga ko'paytirsak 42 chiqadi? O'sha son — javob.", rule: "6 × 7 = 42 → 42 ÷ 6 = 7." },
    ru: { eyebrow: 'Ищи в таблице', setup: 'Делим 42 на 6. Ищи в таблице умножения.', ask: '6 × ? = 42. Значит 42 ÷ 6 = ?', opts: ['5', '6', '8', '7'], correct: 'Верно. 6 × 7 = 42, значит 42 ÷ 6 = 7.', wrong: 'Подсказка: на что умножить 6, чтобы вышло 42? Это и есть ответ.', rule: '6 × 7 = 42 → 42 ÷ 6 = 7.' } },
  () => <div style={{ display: 'flex', justifyContent: 'center' }}><MultRow base={6} upto={8} target={42} /></div>);
...
const __FX_CSS = `
      ...
      `;
export default function Task_23_01(props) {
  return (
    <React.Fragment>
