// Dars 23 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 03 · Oila (massiv) · 🟢 · family =================== */
const D23_03 = makeMC('family', '🟢', 0,
  { uz: { eyebrow: 'Oila', setup: "Massiv: 6 qator, har qatorda 4 kristal (6 × 4 = 24).", ask: '24 kristal 6 qatorga teng bo‘lsa, har qatorda nechta? (24 ÷ 6)', opts: ['4', '6', '3', '8'], correct: "To'g'ri. 6 × 4 = 24, demak 24 ÷ 6 = 4. Bir oila.", wrong: "Maslahat: massivda 6 qator bor. Har qatorda nechta? 6 × 4 = 24.", rule: "6 × 4 = 24 → 24 ÷ 6 = 4, 24 ÷ 4 = 6 (bir oila)." },
    ru: { eyebrow: 'Семья', setup: 'Массив: 6 рядов по 4 кристалла (6 × 4 = 24).', ask: 'Если 24 кристалла в 6 рядов поровну, сколько в ряду? (24 ÷ 6)', opts: ['4', '6', '3', '8'], correct: 'Верно. 6 × 4 = 24, значит 24 ÷ 6 = 4. Одна семья.', wrong: 'Подсказка: в массиве 6 рядов. Сколько в каждом? 6 × 4 = 24.', rule: '6 × 4 = 24 → 24 ÷ 6 = 4, 24 ÷ 4 = 6 (одна семья).' } },
  () => <div style={{ display: 'flex', justifyContent: 'center' }}><ArrayGrid rows={6} cols={4} s={13} /></div>);
...
const __FX_CSS = `
      ...
      `;
export default function Task_23_03(props) {
  return (
    <React.Fragment>
