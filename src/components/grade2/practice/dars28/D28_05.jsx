// Dars 28 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 05 · IMZO PerimeterWalk · beshburchak ===== */
const D05 = makePerimeter({ tag:'walk_penta', level:'🟡', pts:PENTA, lens:[2,2,2,2,2], total:10, opts:['8','6','15','10'], correctIdx:3, box:200, h:190 });
D05.T = {
  uz: { eyebrow:'Perimetr-yurish', setup:'Beshburchakning har bir tomoni 2 birlik.', ask:'Beshburchak atrofidan yuring: har tomonni bosib, uzunliklarini qo‘shing. Perimetr nechchi?', tapHint:'Tomonlarni bosing', pickAsk:'Endi javobni tanlang:', walkFirst:'Avval barcha tomonlarni bosib ifodani yasang.', correct:"To'g'ri. 2 × 5 = 10 (2+2+2+2+2).", wrong:'Beshta tomonning hammasini bosing, 2 dan besh marta qo‘shing.', rule:'Beshburchak perimetri = 2 + 2 + 2 + 2 + 2 = 10.' },
  ru: { eyebrow:'Обход периметра', setup:'Каждая сторона пятиугольника — 2 единицы.', ask:'Обойди пятиугольник: нажимай стороны и складывай. Каков периметр?', tapHint:'Нажимай стороны', pickAsk:'Теперь выбери ответ:', walkFirst:'Сначала нажми все стороны и составь выражение.', correct:'Верно. 2 × 5 = 10.', wrong:'Нажми все пять сторон, сложи 2 пять раз.', rule:'Периметр пятиугольника = 2×5 = 10.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_28_05(props) {
  return (
    <React.Fragment>
