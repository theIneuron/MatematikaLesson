// Dars 28 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · IMZO PerimeterWalk · kvadrat ===== */
const D02 = makePerimeter({ tag:'walk_sq', level:'🟢', pts:[[45,30],[155,30],[155,140],[45,140]], lens:[4,4,4,4], total:16, opts:['8','12','16','20'], correctIdx:2, box:200, h:170 });
D02.T = {
  uz: { eyebrow:'Perimetr-yurish', setup:'Kvadratning har bir tomoni 4 birlik.', ask:'Kvadrat atrofidan yuring: har bir tomonni bosib, uzunliklarini qo‘shib boring. Perimetr nechchi?', tapHint:'Tomonlarni bosing', pickAsk:'Endi javobni tanlang:', walkFirst:'Avval barcha tomonlarni bosib ifodani yasang.', correct:"To'g'ri. 4 + 4 + 4 + 4 = 16.", wrong:'Har bir tomonni bosing — to‘rttasini ham. Bironta tomonni tashlab qo‘ymang.', rule:'Kvadrat perimetri = 4 + 4 + 4 + 4 = 16.' },
  ru: { eyebrow:'Обход периметра', setup:'Каждая сторона квадрата — 4 единицы.', ask:'Обойди квадрат: нажимай каждую сторону и складывай длины. Каков периметр?', tapHint:'Нажимай стороны', pickAsk:'Теперь выбери ответ:', walkFirst:'Сначала нажми все стороны и составь выражение.', correct:'Верно. 4 + 4 + 4 + 4 = 16.', wrong:'Нажми каждую сторону — все четыре. Не пропусти.', rule:'Периметр квадрата = 4+4+4+4 = 16.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_28_02(props) {
  return (
    <React.Fragment>
