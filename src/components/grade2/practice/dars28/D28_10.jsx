// Dars 28 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
const D10 = makeMC({ tag:'gen_perim', level:'🔴', correctIdx:1, half:false, fs:16, mono:false });
D10.T = {
  uz: { eyebrow:'Umumlashtirish', setup:'Kvadratning barcha to‘rt tomoni teng.', ask:'Tomoni 6 bo‘lgan kvadratning perimetrini eng tez qanday topamiz?', opts:['6 + 6','6 × 4','6 × 6','6 + 4'],
    correct:"To'g'ri. 4 ta teng tomon: 6 × 4 = 24.", wrong:'Kvadratda 4 ta teng tomon. Bir tomonni tomonlar soniga ko‘paytiring.', rule:'Kvadrat perimetri = tomon × 4.' },
  ru: { eyebrow:'Обобщение', setup:'У квадрата все четыре стороны равны.', ask:'Как быстрее всего найти периметр квадрата со стороной 6?', opts:['6 + 6','6 × 4','6 × 6','6 + 4'],
    correct:'Верно. 4 равные стороны: 6 × 4 = 24.', wrong:'У квадрата 4 равные стороны. Умножь сторону на их число.', rule:'Периметр квадрата = сторона × 4.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_28_10(props) {
  return (
    <React.Fragment>
