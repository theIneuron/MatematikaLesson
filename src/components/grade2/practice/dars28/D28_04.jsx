// Dars 28 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · BuildNum · to'rtburchak 6+3+6+3 ===== */
const D04 = makeBuildNum({ tag:'rect_perim', level:'🟡', answer:18, cells:2, digits:['2','5','1','8'], stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><svg width="200" height="120" viewBox="0 0 200 120"><rect x="30" y="30" width="140" height="60" fill="rgba(124,224,163,.14)" stroke="#7CE0A3" strokeWidth="3"/><text x="100" y="24" fill="#EAF0F8" fontSize="15" fontWeight="800" textAnchor="middle">6</text><text x="100" y="108" fill="#EAF0F8" fontSize="15" fontWeight="800" textAnchor="middle">6</text><text x="18" y="64" fill="#EAF0F8" fontSize="15" fontWeight="800">3</text><text x="178" y="64" fill="#EAF0F8" fontSize="15" fontWeight="800">3</text></svg></div>) });
D04.T = {
  uz: { eyebrow:'Perimetr · javob', setup:'To‘rtburchakning tomonlari 6, 3, 6, 3 birlik.', ask:'To‘rtburchakning perimetrini hisoblang va javobni raqamlardan yasang.', correct:"To'g'ri. 6 + 3 + 6 + 3 = 18.", wrong:'Barcha to‘rt tomonni qo‘shing: 6 + 3 + 6 + 3.', rule:'Perimetr = 6 + 3 + 6 + 3 = 18.' },
  ru: { eyebrow:'Периметр · ответ', setup:'Стороны четырёхугольника — 6, 3, 6, 3.', ask:'Вычисли периметр четырёхугольника и составь ответ из цифр.', correct:'Верно. 6 + 3 + 6 + 3 = 18.', wrong:'Сложи все четыре стороны: 6 + 3 + 6 + 3.', rule:'Периметр = 6 + 3 + 6 + 3 = 18.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_28_04(props) {
  return (
    <React.Fragment>
