// Dars 28 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · MC · perimetr nima ===== */
const D03 = makeMC({ tag:'concept', level:'🟢', correctIdx:0, half:false, fs:15, mono:false });
D03.T = {
  uz: { eyebrow:'Perimetr — bu nima?', setup:'Perimetr so‘zining ma‘nosini eslaymiz.', ask:'Perimetr — bu nima?', opts:['Shakl atrofidagi barcha tomonlar yig‘indisi','Shakl ichidagi joy','Eng uzun tomon','Burchaklar soni'],
    correct:"To'g'ri. Perimetr — shakl atrofidagi barcha tomonlar yig‘indisi.", wrong:'Perimetrni topish uchun shakl atrofidan yurib, tomonlarni qo‘shamiz.', rule:'Perimetr = barcha tomonlar yig‘indisi (atrof uzunligi).' },
  ru: { eyebrow:'Что такое периметр?', setup:'Вспомним значение слова «периметр».', ask:'Периметр — это что?', opts:['Сумма всех сторон вокруг фигуры','Место внутри фигуры','Самая длинная сторона','Число углов'],
    correct:'Верно. Периметр — сумма всех сторон вокруг фигуры.', wrong:'Чтобы найти периметр, обходят фигуру и складывают стороны.', rule:'Периметр = сумма всех сторон (длина границы).' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_28_03(props) {
  return (
    <React.Fragment>
