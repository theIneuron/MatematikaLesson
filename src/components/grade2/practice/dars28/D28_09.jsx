// Dars 28 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · Story MC · bog' ===== */
const D09 = makeMC({ tag:'story_garden', level:'🔴', correctIdx:2, half:true, fs:22 });
D09.T = {
  uz: { eyebrow:'Masala', setup:'Jasur to‘g‘ri to‘rtburchak shaklidagi bog‘ini panjara bilan o‘ramoqchi. Bog‘ning uzunligi 8 m, eni 3 m.', ask:'Jasurga bog‘ni to‘liq o‘rash uchun necha metr panjara kerak bo‘ladi?', opts:['24','11','22','16'],
    correct:"To'g'ri. 8 + 3 + 8 + 3 = 22 m.", wrong:'Bog‘ning to‘rt tomoni bor: uzunlik ikki marta, en ikki marta. Hammasini qo‘shing.', rule:'Perimetr = 8 + 3 + 8 + 3 = 22 m.' },
  ru: { eyebrow:'Задача', setup:'Джасур хочет огородить прямоугольный сад забором. Длина сада 8 м, ширина 3 м.', ask:'Сколько метров забора нужно, чтобы полностью огородить сад?', opts:['24','11','22','16'],
    correct:'Верно. 8 + 3 + 8 + 3 = 22 м.', wrong:'У сада четыре стороны: длина дважды, ширина дважды. Сложи всё.', rule:'Периметр = 8 + 3 + 8 + 3 = 22 м.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_28_09(props) {
  return (
    <React.Fragment>
