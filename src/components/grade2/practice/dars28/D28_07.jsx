// Dars 28 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · MC · kvadrat tomoni 5 ===== */
const D07 = makeMC({ tag:'sq5', level:'🟡', correctIdx:0, half:true, fs:22, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><svg width="140" height="130" viewBox="0 0 140 130"><rect x="30" y="20" width="80" height="80" fill="rgba(255,154,107,.14)" stroke="#FF9A6B" strokeWidth="3"/><text x="70" y="14" fill="#EAF0F8" fontSize="15" fontWeight="800" textAnchor="middle">5 sm</text></svg></div>) });
D07.T = {
  uz: { eyebrow:'Perimetr', setup:'Kvadratning barcha tomonlari teng. Uning bir tomoni 5 sm.', ask:'Bir tomoni 5 sm bo‘lgan kvadratning perimetri nechchi?', opts:['20','25','10','15'],
    correct:"To'g'ri. Kvadratda 4 ta teng tomon: 5 × 4 = 20 sm.", wrong:'Kvadratda 4 ta teng tomon bor. 5 ni 4 marta qo‘shing (yoki 5 × 4).', rule:'Kvadrat perimetri = tomon × 4 = 5 × 4 = 20.' },
  ru: { eyebrow:'Периметр', setup:'У квадрата все стороны равны. Одна сторона — 5 см.', ask:'Каков периметр квадрата со стороной 5 см?', opts:['20','25','10','15'],
    correct:'Верно. 4 равные стороны: 5 × 4 = 20 см.', wrong:'У квадрата 4 равные стороны. Сложи 5 четыре раза (5 × 4).', rule:'Периметр квадрата = сторона × 4 = 5 × 4 = 20.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_28_07(props) {
  return (
    <React.Fragment>
