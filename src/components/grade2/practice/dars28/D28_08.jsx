// Dars 28 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · MC · yashirin tomon ===== */
const D08 = makeMC({ tag:'hidden_side', level:'🔴', correctIdx:3, half:true, fs:22 });
D08.T = {
  uz: { eyebrow:'Yashirin tomon', setup:'Uchburchakning perimetri 15 birlik. Ikki tomoni 5 va 4.', ask:'Uchburchakning uchinchi tomoni nechchi? (perimetr 15, ikki tomoni 5 va 4)', opts:['15','9','5','6'],
    correct:"To'g'ri. 5 + 4 = 9, 15 − 9 = 6.", wrong:'Avval ma‘lum tomonlarni qo‘shing (5 + 4), so‘ng perimetrdan ayiring.', rule:'15 − (5 + 4) = 6.' },
  ru: { eyebrow:'Скрытая сторона', setup:'Периметр треугольника 15. Две стороны — 5 и 4.', ask:'Чему равна третья сторона? (периметр 15, две стороны 5 и 4)', opts:['15','9','5','6'],
    correct:'Верно. 5 + 4 = 9, 15 − 9 = 6.', wrong:'Сложи известные (5 + 4), потом вычти из периметра.', rule:'15 − (5 + 4) = 6.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_28_08(props) {
  return (
    <React.Fragment>
