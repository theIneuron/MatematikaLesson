// Dars 15 · Amaliyot 07 — mustaqil jsx-question (per-task split).
...
/* ===== 07 · oddout · ortiqchasini top (findwrong) · oddout ===== */
const D07 = makeFindwrong({ tag:'oddout', level:'🟡', colors:['#FFC23C','#5BD6F2','#7CE0A3','#FF9A6B'] });

D07.T = {
  uz: { eyebrow:'Ortiqchasini top', setup:"To'rttadan uchtasi 5 ga ko'paytirish, biri ortiqcha.", ask:"5 ga ko'paytirish EMAS bo'lganini (ortiqchasini) toping.",
    rows:[{ txt:'4 × 5', ok:true }, { txt:'2 × 5', ok:true }, { txt:'3 × 4', ok:false }, { txt:'5 × 5', ok:true }],
    correct:"To'g'ri. 3 × 4 da 5 yo'q — u ortiqcha. Qolganlarida 5 bor.", wrong:"Qaysi ifodada 5 ga ko'paytirish yo'q? Ko'paytuvchilarga qarang.", rule:"5 ga ko'paytirishda bir ko'paytuvchi — 5. 3 × 4 mos emas." },
  ru: { eyebrow:'Найди лишнее', setup:'Три из четырёх — умножение на 5, одно лишнее.', ask:'Найди лишнее (НЕ умножение на 5).',
    rows:[{ txt:'4 × 5', ok:true }, { txt:'2 × 5', ok:true }, { txt:'3 × 4', ok:false }, { txt:'5 × 5', ok:true }],
    correct:'Верно. В 3 × 4 нет пятёрки — оно лишнее. В остальных есть 5.', wrong:'В каком выражении нет умножения на 5? Смотри на множители.', rule:'В умножении на 5 один множитель — 5. 3 × 4 не подходит.' },
};
