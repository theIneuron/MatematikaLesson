// Dars 15 · Amaliyot 10 — mustaqil jsx-question (per-task split).
...
/* ===== 10 · findwrong · xatoni topish · findwrong ===== */
const D10 = makeFindwrong({ tag:'findwrong', level:'🔴', colors:['#FFC23C','#5BD6F2','#7CE0A3','#FF9A6B'] });

D10.T = {
  uz: { eyebrow:'Xatoni top', setup:"To'rt ko'paytirish yozilgan, bittasi noto'g'ri hisoblangan.", ask:"Noto'g'ri javobni toping.",
    rows:[{ txt:'4 × 5 = 20', ok:true }, { txt:'3 × 5 = 15', ok:true }, { txt:'5 × 5 = 25', ok:true }, { txt:'6 × 5 = 32', ok:false }],
    correct:"To'g'ri. 6 × 5 = 30 bo'lishi kerak. 32 ning oxiri 0 yoki 5 emas.", wrong:'×5 javobining oxiri doim 0 yoki 5. Qaysi qatorda bunday emas?', rule:"6 × 5 = 30 (oxiri 0). 32 — noto'g'ri." },
  ru: { eyebrow:'Найди ошибку', setup:'Записаны четыре умножения, одно посчитано неверно.', ask:'Найди неверный ответ.',
    rows:[{ txt:'4 × 5 = 20', ok:true }, { txt:'3 × 5 = 15', ok:true }, { txt:'5 × 5 = 25', ok:true }, { txt:'6 × 5 = 32', ok:false }],
    correct:'Верно. Должно быть 6 × 5 = 30. 32 не оканчивается на 0 или 5.', wrong:'У ×5 конец всегда 0 или 5. Где не так?', rule:'6 × 5 = 30 (конец 0). 32 — неверно.' },
};
