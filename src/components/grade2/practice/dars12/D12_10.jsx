// Dars 12 · Amaliyot 10 — mustaqil jsx-question (per-task split).
...
/* ===== 10 · wordhard · MC · wordhard · JAMI (−/−) ===== */
const D10 = makeMC({ tag:'wordhard', level:'🔴', correctIdx:0, half:true, fs:22, stage:marsMC });

D10.T = {
  uz: { eyebrow:'Qiyin masala', setup:'Kemada 80 quti bor edi. Avval 40 tasi, keyin yana 10 tasi tushirildi.', scene:'Mars bazasi · ikki tushirish', ask:'Kemada endi nechta quti bor?', opts:['30','40','50','120'],
    correct:"To'g'ri. 80 − 40 = 40, keyin 40 − 10 = 30. Ikki marta ayirildi.", wrong:'Ikkalasi ham tushirildi — ikki marta ayiring. Oxirigacha bajaring.', rule:'80 − 40 = 40, 40 − 10 = 30.' },
  ru: { eyebrow:'Сложная задача', setup:'На корабле было 80 ящиков. Сначала 40, потом ещё 10 выгрузили.', scene:'База Марс · две выгрузки', ask:'Сколько ящиков теперь на корабле?', opts:['30','40','50','120'],
    correct:'Верно. 80 − 40 = 40, затем 40 − 10 = 30. Вычли дважды.', wrong:'Оба раза выгрузили — вычти дважды. До конца.', rule:'80 − 40 = 40, 40 − 10 = 30.' },
};
...
D12_10.audio = {
  uz: { intro: "Kemada 80 quti bor edi. Avval 40 tasi, keyin yana 10 tasi tushirildi. Kemada endi nechta quti bor?", on_correct: "To'g'ri. 80 ayirish 40 teng 40, keyin 40 ayirish 10 teng 30. Ikki marta ayirildi.", on_wrong: "Ikkalasi ham tushirildi, ikki marta ayiring. Oxirigacha bajaring." },
  ru: { intro: "На корабле было 80 ящиков. Сначала 40, потом ещё 10 выгрузили. Сколько ящиков теперь на корабле?", on_correct: "Верно. 80 минус 40 равно 40, затем 40 минус 10 равно 30. Вычли дважды.", on_wrong: "Оба раза выгрузили, вычти дважды. До конца." },
};
