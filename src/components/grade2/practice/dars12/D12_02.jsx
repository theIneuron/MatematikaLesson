// Dars 12 · Amaliyot 02 — mustaqil jsx-question (per-task split).
...
/* ===== 02 · whichfirst · MC (full) · whichfirst · TARTIB ===== */
const D02 = makeMC({ tag:'whichfirst', level:'🟢', correctIdx:0, half:false, fs:19, stage:marsMC });

D02.T = {
  uz: { eyebrow:'Qaysi amal birinchi', setup:'Kemada 50 zaxira bor edi. 20 tasi tushirildi, keyin 13 tasi ortildi.', scene:'Mars bazasi · tartib', ask:'Qaysi amal BIRINCHI bajariladi?', opts:['50 − 20','50 + 13','20 + 13','50 − 13'],
    correct:"To'g'ri. Birinchi o'zgarish — 20 tushirildi: 50 − 20.", wrong:"Voqealar tartibiga qarang: birinchi nima sodir bo'ldi?", rule:"Birinchi o'zgarish — 20 tushirildi: 50 − 20 = 30." },
  ru: { eyebrow:'Какое действие первое', setup:'На корабле было 50 запасов. 20 выгрузили, затем 13 загрузили.', scene:'База Марс · порядок', ask:'Какое действие выполняется ПЕРВЫМ?', opts:['50 − 20','50 + 13','20 + 13','50 − 13'],
    correct:'Верно. Первое изменение — выгрузили 20: 50 − 20.', wrong:'Смотри на порядок событий: что произошло первым?', rule:'Первое изменение — выгрузили 20: 50 − 20 = 30.' },
};
