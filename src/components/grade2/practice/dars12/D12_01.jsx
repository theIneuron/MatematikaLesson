// Dars 12 · Amaliyot 01 — mustaqil jsx-question (per-task split).
...
/* ===== 01 · twostep_mc · MC · twostep · JAMI topish ===== */
const D01 = makeMC({ tag:'twostep', level:'🟢', correctIdx:0, half:true, fs:22, stage:marsMC });

D01.T = {
  uz: { eyebrow:'Ikki amalli masala', setup:'Kemada 40 quti bor edi. 15 tasi sarflandi, keyin 12 tasi ortildi.', scene:'Mars bazasi · yuklash', ask:'Kemada endi nechta quti bor?', opts:['37','25','43','27'],
    correct:"To'g'ri. 40 − 15 = 25, keyin 25 + 12 = 37.", wrong:"Ikki o'zgarish bor: avval ayiring, keyin qo'shing. Oxirigacha bajaring.", rule:"Ikki o'zgarish — ikki amal: 40 − 15 = 25, 25 + 12 = 37." },
  ru: { eyebrow:'Задача в два действия', setup:'На корабле было 40 ящиков. 15 израсходовали, затем 12 загрузили.', scene:'База Марс · погрузка', ask:'Сколько ящиков теперь на корабле?', opts:['37','25','43','27'],
    correct:'Верно. 40 − 15 = 25, затем 25 + 12 = 37.', wrong:'Два изменения: сначала вычти, потом прибавь. Доведи до конца.', rule:'Два изменения — два действия: 40 − 15 = 25, 25 + 12 = 37.' },
};
...
D12_01.audio = {
  uz: { intro: "Kemada 40 quti bor edi. 15 tasi sarflandi, keyin 12 tasi ortildi. Kemada endi nechta quti bor?", on_correct: "To'g'ri. 40 ayirish 15 teng 25, keyin 25 qo'shish 12 teng 37.", on_wrong: "Ikki o'zgarish bor. Avval ayiring, keyin qo'shing. Oxirigacha bajaring." },
  ru: { intro: "На корабле было 40 ящиков. 15 израсходовали, затем 12 загрузили. Сколько ящиков теперь на корабле?", on_correct: "Верно. 40 минус 15 равно 25, затем 25 плюс 12 равно 37.", on_wrong: "Два изменения. Сначала вычти, потом прибавь. Доведи до конца." },
};
