// Dars 12 · Amaliyot 08 — mustaqil jsx-question (per-task split).
...
/* ===== 08 · masala (Anvar) · MC · word2 · JAMI (masala) ===== */
const D08 = makeMC({ tag:'word2', level:'🔴', correctIdx:0, half:true, fs:22, stage:marsMC });

D08.T = {
  uz: { eyebrow:'Masala', setup:'Anvarda 42 quti bor edi. 20 tasini tushirdi, keyin bazadan 15 ta ortdi.', scene:'Mars bazasi · Anvar', ask:'Anvarda endi nechta quti bor?', opts:['37','22','57','7'],
    correct:"To'g'ri. 42 − 20 = 22, keyin 22 + 15 = 37.", wrong:"Ikki amal: avval ayiring, keyin qo'shing. To'liq bajaring.", rule:'42 − 20 = 22, 22 + 15 = 37.' },
  ru: { eyebrow:'Задача', setup:'У Анвара было 42 ящика. 20 выгрузил, затем с базы прибыло 15.', scene:'База Марс · Анвар', ask:'Сколько ящиков теперь у Анвара?', opts:['37','22','57','7'],
    correct:'Верно. 42 − 20 = 22, затем 22 + 15 = 37.', wrong:'Два действия: сначала вычти, потом прибавь. Полностью.', rule:'42 − 20 = 22, 22 + 15 = 37.' },
};
