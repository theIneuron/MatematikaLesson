// Dars 30 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 05 · BuildNum · c+c, c=7 ===== */
const D05 = makeBuildNum({ tag:'sub_cc', level:'🟡', answer:14, cells:2, digits:['1','4','7','2'], stage:exprStage('c + c,  c = 7') });
D05.T = {
  uz: { eyebrow:'Ifoda qiymati', setup:'c + c ifodasida ikkala c ham bir xil son. Bu yerda c = 7.', ask:'c + c ifodasida c = 7 bo‘lsa, qiymatini raqamlardan yasang:', correct:"To'g'ri. 7 + 7 = 14.", wrong:'Ikkala c ham 7. 7 + 7 nechchi bo‘ladi?', rule:'c + c da c = 7 → 7 + 7 = 14.' },
  ru: { eyebrow:'Значение выражения', setup:'В c + c обе c — одно число. Здесь c = 7.', ask:'Составь из цифр значение c + c при c = 7:', correct:'Верно. 7 + 7 = 14.', wrong:'Обе c равны 7. Сколько 7 + 7?', rule:'c + c при c = 7 → 7 + 7 = 14.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_30_05(props) {
  return (
    <React.Fragment>
