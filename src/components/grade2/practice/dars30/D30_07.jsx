// Dars 30 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · MC · 8−a, a=8 ===== */
const D07 = makeMC({ tag:'mc_8a', level:'🟡', correctIdx:0, half:true, fs:22, stage:exprStage('8 − a,  a = 8') });
D07.T = {
  uz: { eyebrow:'Ifoda qiymati', setup:'8 − a ifodasida a = 8.', ask:'8 − a ifodasida a = 8 bo‘lsa, qiymati nechchi?', opts:['0','8','16','1'],
    correct:"To'g'ri. 8 − 8 = 0.", wrong:'a o‘rniga 8 ni qo‘ying: 8 − 8 nechchi bo‘ladi?', rule:'8 − a da a = 8 → 8 − 8 = 0.' },
  ru: { eyebrow:'Значение выражения', setup:'В 8 − a значение a = 8.', ask:'Чему равно 8 − a, если a = 8?', opts:['0','8','16','1'],
    correct:'Верно. 8 − 8 = 0.', wrong:'Подставь 8 вместо a: сколько 8 − 8?', rule:'8 − a при a = 8 → 8 − 8 = 0.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_30_07(props) {
  return (
    <React.Fragment>
