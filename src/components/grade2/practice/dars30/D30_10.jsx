// Dars 30 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 10 · MC · a+2, a=10 ===== */
const D10 = makeMC({ tag:'mc_a2', level:'🔴', correctIdx:0, half:true, fs:22, stage:exprStage('a + 2,  a = 10') });
D10.T = {
  uz: { eyebrow:'Umumlashtirish', setup:'a + 2 ifodasida a o‘rniga katta son ham qo‘yish mumkin. Bu yerda a = 10.', ask:'a + 2 ifodasida a = 10 bo‘lsa, qiymati nechchi?', opts:['12','102','2','20'],
    correct:"To'g'ri. 10 + 2 = 12.", wrong:'a o‘rniga 10 ni qo‘ying: 10 + 2 nechchi bo‘ladi?', rule:'a + 2 da a = 10 → 10 + 2 = 12.' },
  ru: { eyebrow:'Обобщение', setup:'Вместо a можно ставить и большое число. Здесь a = 10.', ask:'Чему равно a + 2, если a = 10?', opts:['12','102','2','20'],
    correct:'Верно. 10 + 2 = 12.', wrong:'Подставь 10 вместо a: сколько 10 + 2?', rule:'a + 2 при a = 10 → 10 + 2 = 12.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_30_10(props) {
  return (
    <React.Fragment>
