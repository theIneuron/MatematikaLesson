// Dars 30 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · MC · a+b ===== */
const D08 = makeMC({ tag:'mc_ab', level:'🔴', correctIdx:0, half:true, fs:22, stage:exprStage('a + b,  a=4, b=5') });
D08.T = {
  uz: { eyebrow:'Ikki harf', setup:'a + b ifodasida ikkita harf bor: a = 4 va b = 5.', ask:'a + b ifodasida a = 4, b = 5 bo‘lsa, qiymati nechchi?', opts:['9','45','1','20'],
    correct:"To'g'ri. 4 + 5 = 9.", wrong:'Har bir harf o‘rniga o‘z sonini qo‘ying: 4 + 5 nechchi bo‘ladi?', rule:'a + b (a=4, b=5) → 4 + 5 = 9.' },
  ru: { eyebrow:'Две буквы', setup:'В a + b две буквы: a = 4 и b = 5.', ask:'Чему равно a + b, если a = 4, b = 5?', opts:['9','45','1','20'],
    correct:'Верно. 4 + 5 = 9.', wrong:'Подставь каждой букве своё число: сколько 4 + 5?', rule:'a + b (a=4, b=5) → 4 + 5 = 9.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_30_08(props) {
  return (
    <React.Fragment>
