// Dars 30 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · Story MC · a+3 ===== */
const D09 = makeMC({ tag:'story_ab', level:'🔴', correctIdx:0, half:true, fs:22, stage:exprStage('a + 3,  a = 6') });
D09.T = {
  uz: { eyebrow:'Masala', setup:'Zuhrada a ta olma bor edi, so‘ng 3 ta olma qo‘shildi. Bu holat a + 3 ifodasi bilan yoziladi.', ask:'Agar a = 6 bo‘lsa, Zuhrada endi nechta olma bor?', opts:['9','63','3','18'],
    correct:"To'g'ri. a = 6, 6 + 3 = 9 ta olma.", wrong:'a o‘rniga 6 ni qo‘ying: 6 + 3 nechchi bo‘ladi?', rule:'a + 3 da a = 6 → 6 + 3 = 9.' },
  ru: { eyebrow:'Задача', setup:'У Зухры было a яблок, затем добавилось 3. Это записывают как a + 3.', ask:'Если a = 6, сколько яблок теперь у Зухры?', opts:['9','63','3','18'],
    correct:'Верно. a = 6, 6 + 3 = 9 яблок.', wrong:'Подставь 6 вместо a: сколько 6 + 3?', rule:'a + 3 при a = 6 → 6 + 3 = 9.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_30_09(props) {
  return (
    <React.Fragment>
