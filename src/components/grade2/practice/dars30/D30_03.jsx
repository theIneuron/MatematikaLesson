// Dars 30 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · TrueFalse · harf son o'rnida ===== */
const D03 = makeTrueFalse({ tag:'tf_letter', level:'🟢', answer:true });
D03.T = {
  uz: { eyebrow:"To'g'ri yoki noto'g'ri", setup:'Harfli ifoda haqida fikr.', ask:'Harfli ifodada harf son o‘rnida turadi — uning o‘rniga har xil son qo‘yish mumkin. Bu fikr to‘g‘rimi?', yes:'Ha', no:'Yo‘q',
    correct:"To'g'ri javob: Ha. Harf o‘rniga turli sonlarni qo‘yish mumkin.", wrong:'a + 5 da a o‘rniga 3 ni ham, 4 ni ham qo‘ygan edik. Demak harf son o‘rnida turadi.', rule:'Harf — son o‘rnida; o‘rniga har xil son qo‘yish mumkin.' },
  ru: { eyebrow:'Верно или неверно', setup:'Утверждение о буквенном выражении.', ask:'В буквенном выражении буква стоит вместо числа — вместо неё можно ставить разные числа. Верно?', yes:'Да', no:'Нет',
    correct:'Правильно: Да. Вместо буквы можно подставлять разные числа.', wrong:'В a + 5 мы ставили и 3, и 4. Значит буква стоит вместо числа.', rule:'Буква — вместо числа; можно ставить разные числа.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_30_03(props) {
  return (
    <React.Fragment>
