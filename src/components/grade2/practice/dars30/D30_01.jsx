// Dars 30 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · IMZO Substitute · a+5, a=3 ===== */
const D01 = makeSubstitute({ tag:'sub_a5', level:'🟢', tpl:['a','+','5'], letter:'a', value:3, correctIdx:0 });
D01.T = {
  uz: { eyebrow:'Harf o‘rniga son', setup:"Zuhra boshqaruv panelida a + 5 ifodasini ko‘rdi. Bu yerda a = 3.", place:'qiymatni katakka qo‘yish uchun bosing', ask:'a katagiga 3 ni qo‘ying va ifodaning qiymatini toping:', opts:['8','5','35','2'],
    correct:"To'g'ri. a = 3, demak 3 + 5 = 8.", wrong:'a o‘rniga 3 ni qo‘ying: 3 + 5 nechchi bo‘ladi? Harfni son bilan yonma-yon yozmang.', rule:'a + 5 da a = 3 → 3 + 5 = 8.' },
  ru: { eyebrow:'Число вместо буквы', setup:'Зухра увидела на панели выражение a + 5. Здесь a = 3.', place:'нажми, чтобы поставить значение в клетку', ask:'Поставь 3 в клетку a и найди значение выражения:', opts:['8','5','35','2'],
    correct:'Верно. a = 3, значит 3 + 5 = 8.', wrong:'Подставь 3 вместо a: сколько 3 + 5? Не пиши букву рядом с числом.', rule:'a + 5 при a = 3 → 3 + 5 = 8.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_30_01(props) {
  return (
    <React.Fragment>
