// Dars 30 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · MC · a+5, a=4 ===== */
const D02 = makeMC({ tag:'mc_a5', level:'🟢', correctIdx:0, half:true, fs:22, stage:exprStage('a + 5,  a = 4') });
D02.T = {
  uz: { eyebrow:'Ifoda qiymati', setup:'a + 5 ifodasida a harfi o‘rniga son qo‘yiladi. Bu safar a = 4.', ask:'a + 5 ifodasida a = 4 bo‘lsa, uning qiymati nechchi bo‘ladi?', opts:['9','45','5','1'],
    correct:"To'g'ri. 4 + 5 = 9.", wrong:'a o‘rniga 4 ni qo‘ying: 4 + 5 nechchi? Raqamlarni yonma-yon yozmang.', rule:'a + 5 da a = 4 → 4 + 5 = 9.' },
  ru: { eyebrow:'Значение выражения', setup:'В a + 5 вместо буквы ставят число. Теперь a = 4.', ask:'Чему равно a + 5, если a = 4?', opts:['9','45','5','1'],
    correct:'Верно. 4 + 5 = 9.', wrong:'Подставь 4 вместо a: сколько 4 + 5? Не пиши числа подряд.', rule:'a + 5 при a = 4 → 4 + 5 = 9.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_30_02(props) {
  return (
    <React.Fragment>
