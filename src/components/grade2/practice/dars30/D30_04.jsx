// Dars 30 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · IMZO Substitute · 10−b, b=6 ===== */
const D04 = makeSubstitute({ tag:'sub_b', level:'🟡', tpl:['10','−','b'], letter:'b', value:6, correctIdx:0 });
D04.T = {
  uz: { eyebrow:'Harf o‘rniga son', setup:'10 − b ifodasida b = 6.', place:'qiymatni katakka qo‘yish uchun bosing', ask:'b katagiga 6 ni qo‘ying va ifodaning qiymatini toping:', opts:['4','16','6','60'],
    correct:"To'g'ri. b = 6, demak 10 − 6 = 4.", wrong:'b o‘rniga 6 ni qo‘ying: 10 − 6 nechchi bo‘ladi?', rule:'10 − b da b = 6 → 10 − 6 = 4.' },
  ru: { eyebrow:'Число вместо буквы', setup:'В 10 − b значение b = 6.', place:'нажми, чтобы поставить значение', ask:'Поставь 6 в клетку b и найди значение:', opts:['4','16','6','60'],
    correct:'Верно. b = 6, значит 10 − 6 = 4.', wrong:'Подставь 6 вместо b: сколько 10 − 6?', rule:'10 − b при b = 6 → 10 − 6 = 4.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_30_04(props) {
  return (
    <React.Fragment>
