// Dars 27 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · Match · obyekt ↔ birlik ===== */
const D04 = makeMatch({ tag:'obj_unit', level:'🟡' });
D04.T = {
  uz: { eyebrow:'Mos birlikni ulash', setup:'Har bir narsani o‘lchash uchun qulay birlik bor.', ask:'Chapdagini bosing, so‘ng o‘ngdan mos birlikni tanlang:',
    left:[{ label:'Qalam', match:2 }, { label:'Parta', match:0 }, { label:'Eshik bo‘yi', match:1 }],
    right:['dm','m','sm'],
    correct:"To'g'ri. Qalam — sm, parta — dm, eshik — m.", wrong:'Kichik narsa — kichik birlik, katta narsa — katta birlik.', rule:'Qalam↔sm · parta↔dm · eshik↔m.' },
  ru: { eyebrow:'Соедини единицу', setup:'Для каждого предмета удобна своя единица.', ask:'Нажми слева, затем выбери единицу справа:',
    left:[{ label:'Карандаш', match:2 }, { label:'Парта', match:0 }, { label:'Высота двери', match:1 }],
    right:['дм','м','см'],
    correct:'Верно. Карандаш — см, парта — дм, дверь — м.', wrong:'Маленькое — малая единица, большое — большая.', rule:'Карандаш↔см · парта↔дм · дверь↔м.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_27_04(props) {
  return (
    <React.Fragment>
