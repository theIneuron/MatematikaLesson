// Dars 27 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · MC · eng uzun birlik ===== */
const D03 = makeMC({ tag:'longest', level:'🟢', correctIdx:2, half:true, fs:20 });
D03.T = {
  uz: { eyebrow:'Birliklar', setup:'Uzunlik birliklari: sm, dm, m.', ask:'Quyidagi birliklardan qaysi biri eng uzun?', opts:['sm','dm','m','ular teng'],
    correct:"To'g'ri. Metr (m) eng uzun birlik: 1 m = 10 dm = 100 sm.", wrong:'Qaysi birlik bilan katta narsalarni (eshik, xona) o‘lchaymiz?', rule:'m > dm > sm.' },
  ru: { eyebrow:'Единицы', setup:'Единицы длины: см, дм, м.', ask:'Какая из единиц самая длинная?', opts:['см','дм','м','равны'],
    correct:'Верно. Метр (м) — самая длинная: 1 м = 10 дм = 100 см.', wrong:'Чем измеряют большое (дверь, комнату)?', rule:'м > дм > см.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_27_03(props) {
  return (
    <React.Fragment>
