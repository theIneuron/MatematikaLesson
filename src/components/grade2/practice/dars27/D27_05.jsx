// Dars 27 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 05 · IMZO Ruler (dm) ===== */
const D05 = makeRuler({ tag:'ruler_dm', level:'🟡', max:6, len:4, unit:'dm', color:'#7CE0A3' });
D05.T = {
  uz: { eyebrow:'Lineyka bilan o‘lchash', setup:"Anvar arqonni detsimetrli lineyka bo‘yicha noldan qo‘ydi.", ask:'Arqonning uchi qaysi bo‘linmada tugaydi? Shu bo‘linmani bosing (dm).', hint:'Arqon uchi turgan sonni bosing', correct:"To'g'ri. Arqonning uzunligi — 4 dm.", wrong:'Arqon noldan boshlanadi. Uning uchi qaysi son ustida — shuni bosing.', rule:'Uzunlik = arqon uchi turgan bo‘linma (dm).' },
  ru: { eyebrow:'Измерение линейкой', setup:'Анвар положил верёвку от нуля по дециметровой линейке.', ask:'На каком делении заканчивается верёвка? Нажми его (дм).', hint:'Нажми число, где конец верёвки', correct:'Верно. Длина верёвки — 4 дм.', wrong:'Верёвка начинается с нуля. На каком числе её конец — то и нажми.', rule:'Длина = деление конца верёвки (дм).' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_27_05(props) {
  return (
    <React.Fragment>
