// Dars 27 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · Story MC · 1m20sm = ? sm ===== */
const D09 = makeMC({ tag:'story_len', level:'🔴', correctIdx:3, half:true, fs:22 });
D09.T = {
  uz: { eyebrow:'Masala', setup:"Ra'no ustaxonada 1 m 20 sm uzunlikdagi sim oldi. 1 m = 100 sm ekanini eslang.", ask:'Ra‘no olgan sim necha santimetr bo‘ladi?', opts:['100','12','20','120'],
    correct:"To'g'ri. 1 m = 100 sm, 100 + 20 = 120 sm.", wrong:'Avval metrni sm ga aylantiring (100 sm), so‘ng 20 ni qo‘shing.', rule:'1 m 20 sm = 100 + 20 = 120 sm.' },
  ru: { eyebrow:'Задача', setup:'Рано взяла провод длиной 1 м 20 см. Вспомни: 1 м = 100 см.', ask:'Сколько сантиметров в этом проводе?', opts:['100','12','20','120'],
    correct:'Верно. 1 м = 100 см, 100 + 20 = 120 см.', wrong:'Сначала переведи метр в см (100), затем прибавь 20.', rule:'1 м 20 см = 100 + 20 = 120 см.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_27_09(props) {
  return (
    <React.Fragment>
