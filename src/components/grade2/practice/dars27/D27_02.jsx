// Dars 27 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · MC · 1 dm = ? sm ===== */
const D02 = makeMC({ tag:'dm_sm', level:'🟢', correctIdx:0, half:true, fs:22 });
D02.T = {
  uz: { eyebrow:'Birliklar', setup:'Detsimetr (dm) va santimetr (sm) — uzunlik birliklari.', ask:'1 dm (detsimetr) nechta sm ga teng?', opts:['10','1','100','12'],
    correct:"To'g'ri. 1 dm = 10 sm.", wrong:'Bir detsimetrda o‘nta santimetr bor. Nechta bo‘lardi?', rule:'1 dm = 10 sm.' },
  ru: { eyebrow:'Единицы', setup:'Дециметр (дм) и сантиметр (см) — единицы длины.', ask:'1 дм (дециметр) равен скольким см?', opts:['10','1','100','12'],
    correct:'Верно. 1 дм = 10 см.', wrong:'В одном дециметре десять сантиметров. Сколько это?', rule:'1 дм = 10 см.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_27_02(props) {
  return (
    <React.Fragment>
