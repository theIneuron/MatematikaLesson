// Dars 27 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · MC · 30 sm vs 3 dm ===== */
const D07 = makeMC({ tag:'compare', level:'🟡', correctIdx:2, half:true, fs:18 });
D07.T = {
  uz: { eyebrow:'Taqqoslash', setup:'30 sm va 3 dm uzunliklarini solishtiramiz.', ask:'30 sm va 3 dm — qaysi biri uzunroq?', opts:['30 sm uzun','3 dm uzun','Ular teng','Bilib bo‘lmaydi'],
    correct:"To'g'ri. 3 dm = 30 sm, demak ular teng.", wrong:'3 dm ni sm ga aylantiring: 3 × 10 = ? Keyin solishtiring.', rule:'3 dm = 30 sm — teng.' },
  ru: { eyebrow:'Сравнение', setup:'Сравним 30 см и 3 дм.', ask:'30 см и 3 дм — что длиннее?', opts:['30 см','3 дм','Равны','Нельзя узнать'],
    correct:'Верно. 3 дм = 30 см, значит равны.', wrong:'Переведи 3 дм в см: 3 × 10 = ? Потом сравни.', rule:'3 дм = 30 см — равны.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_27_07(props) {
  return (
    <React.Fragment>
