// Dars 27 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · BuildNum · 1 m = ? sm ===== */
const D08 = makeBuildNum({ tag:'m_sm', level:'🔴', answer:100, cells:3, digits:['5','1','2','0'] });
D08.T = {
  uz: { eyebrow:'Metr va santimetr', setup:'Metr — eng katta birlik. 1 m = 10 dm.', ask:'1 m nechta sm ga teng? Javobni raqamlardan yasang.', correct:"To'g'ri. 1 m = 100 sm.", wrong:'1 m = 10 dm, har dm = 10 sm. 10 marta 10 — nechta sm?', rule:'1 m = 100 sm.' },
  ru: { eyebrow:'Метр и сантиметр', setup:'Метр — самая большая единица. 1 м = 10 дм.', ask:'1 м равен скольким см? Составь ответ из цифр.', correct:'Верно. 1 м = 100 см.', wrong:'1 м = 10 дм, каждый дм = 10 см. 10 раз по 10 — сколько см?', rule:'1 м = 100 см.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_27_08(props) {
  return (
    <React.Fragment>
