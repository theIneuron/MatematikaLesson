// Dars 27 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 10 · Order · birliklarni tartiblash ===== */
const D10 = makeOrder({ tag:'order_units', level:'🔴' });
D10.T = {
  uz: { eyebrow:'Tartiblash', setup:'Uzunlik birliklarini kattaligi bo‘yicha tartiblaymiz.', ask:'Birliklarni kichikdan kattaga tartibda bosing (1, 2, 3):',
    cards:[{ txt:'dm', pos:1 }, { txt:'m', pos:2 }, { txt:'sm', pos:0 }],
    correct:"To'g'ri. sm < dm < m.", wrong:'Eng kichik birlik — sm, keyin dm, eng katta — m.', rule:'sm < dm < m (1 dm = 10 sm, 1 m = 10 dm).' },
  ru: { eyebrow:'Упорядочи', setup:'Расставим единицы длины по величине.', ask:'Нажми единицы от меньшей к большей (1, 2, 3):',
    cards:[{ txt:'дм', pos:1 }, { txt:'м', pos:2 }, { txt:'см', pos:0 }],
    correct:'Верно. см < дм < м.', wrong:'Самая малая — см, потом дм, самая большая — м.', rule:'см < дм < м.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_27_10(props) {
  return (
    <React.Fragment>
