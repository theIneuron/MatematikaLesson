// Dars 27 · Amaliyot 06 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 06 · MC · 2 dm = ? sm ===== */
const D06 = makeMC({ tag:'convert2', level:'🟡', correctIdx:0, half:true, fs:22 });
D06.T = {
  uz: { eyebrow:'Birlikni almashtirish', setup:'1 dm = 10 sm ekanini bilamiz.', ask:'2 dm nechta sm ga teng?', opts:['20','2','200','12'],
    correct:"To'g'ri. 2 dm = 20 sm (2 marta 10).", wrong:'Har bir dm — 10 sm. 2 dm da nechta sm bo‘ladi?', rule:'2 dm = 2 × 10 = 20 sm.' },
  ru: { eyebrow:'Перевод единиц', setup:'Мы знаем: 1 дм = 10 см.', ask:'2 дм равны скольким см?', opts:['20','2','200','12'],
    correct:'Верно. 2 дм = 20 см (2 раза по 10).', wrong:'Каждый дм — 10 см. Сколько см в 2 дм?', rule:'2 дм = 2 × 10 = 20 см.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_27_06(props) {
  return (
    <React.Fragment>
