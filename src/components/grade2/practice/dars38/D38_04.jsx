// Dars 38 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · IMZO PictoCount · nok 4 ===== */
const D04 = makePictoCount({ tag:'count_pear', level:'🟡', n:4, color:'#7CE0A3' });
D04.T = {
  uz: { eyebrow:'Piktogramma', setup:'Endi noklar piktogrammasini sanaymiz. Har rasm — bitta nok.', ask:'Piktogrammadagi noklarni bosib sanang: nechta nok bor?', counter:'Noklar', correct:"To'g'ri. Piktogrammada 4 ta nok bor.", wrong:'Har bir nok rasmini bir marta bosing va sanang.', rule:'Har rasm = 1 nok. Jami 4 ta.' },
  ru: { eyebrow:'Пиктограмма', setup:'Теперь посчитаем груши. Каждый рисунок — одна груша.', ask:'Нажми груши и посчитай: сколько груш?', counter:'Груши', correct:'Верно. На пиктограмме 4 груши.', wrong:'Нажми каждую грушу один раз и посчитай.', rule:'Каждый рисунок = 1 груша. Всего 4.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_38_04(props) {
  return (
    <React.Fragment>
