// Dars 38 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · Find-wrong · xulosa ===== */
const D07 = makeFindwrong({ tag:'data_wrong', level:'🟡', colors:['#FFC23C','#5BD6F2','#7CE0A3','#FF9A6B'] });
D07.T = {
  uz: { eyebrow:'Xatoni top', setup:'Jadval: Anvar — 5, Zuhra — 3, Jasur — 7 kitob. To‘rt xulosa qilingan, bittasi noto‘g‘ri.', ask:'Qaysi xulosa NOTO‘G‘RI?',
    rows:[{ txt:'Jasurda eng ko‘p', ok:true }, { txt:'Zuhrada eng kam', ok:true }, { txt:'Anvarda 3 ta', ok:false }, { txt:'Anvar Zuhradan ko‘p', ok:true }],
    correct:"To'g'ri. Anvarda 3 emas, 5 ta kitob bor.", wrong:'Har bir xulosani jadval bilan tekshiring: Anvarda nechta kitob?', rule:'Anvarda 5 kitob (3 emas).' },
  ru: { eyebrow:'Найди ошибку', setup:'Таблица: Анвар — 5, Зухра — 3, Джасур — 7 книг. Сделаны 4 вывода, один неверен.', ask:'Какой вывод НЕВЕРЕН?',
    rows:[{ txt:'У Джасура больше всех', ok:true }, { txt:'У Зухры меньше всех', ok:true }, { txt:'У Анвара 3 книги', ok:false }, { txt:'У Анвара больше, чем у Зухры', ok:true }],
    correct:'Верно. У Анвара не 3, а 5 книг.', wrong:'Проверь каждый вывод по таблице: сколько книг у Анвара?', rule:'У Анвара 5 книг (не 3).' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_38_07(props) {
  return (
    <React.Fragment>
