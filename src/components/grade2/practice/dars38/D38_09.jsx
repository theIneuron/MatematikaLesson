// Dars 38 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · MC · masshtab (1=2) ===== */
const D09 = makeMC({ tag:'scale', level:'🔴', correctIdx:0, half:true, fs:22, stage:(t)=>(<div style={{textAlign:'center'}}><div style={{display:'flex',gap:8,justifyContent:'center'}}>{[0,1,2].map(i=><Fruit key={i} c='#5BD6F2' s={38} delay={i*0.1} />)}</div><div style={{marginTop:8,color:C.goldSoft,fontWeight:700,fontSize:14}}>1 rasm = 2 bola</div></div>) });
D09.T = {
  uz: { eyebrow:'Masshtab', setup:'Piktogrammada 1 rasm 2 ta bolani bildiradi. Rasmlar 3 ta.', ask:'Agar 1 rasm = 2 bola bo‘lsa, 3 ta rasm nechta bolani bildiradi?', opts:['6','3','5','2'],
    correct:"To'g'ri. Har rasm 2 bola: 3 × 2 = 6 bola.", wrong:'Har bir rasm 2 ta bola. 3 ta rasmni 2 ga ko‘paytiring.', rule:'3 rasm × 2 = 6 bola.' },
  ru: { eyebrow:'Масштаб', setup:'На пиктограмме 1 рисунок = 2 ребёнка. Рисунков 3.', ask:'Если 1 рисунок = 2 ребёнка, сколько детей означают 3 рисунка?', opts:['6','3','5','2'],
    correct:'Верно. Каждый рисунок — 2 ребёнка: 3 × 2 = 6.', wrong:'Каждый рисунок — 2 ребёнка. Умножь 3 рисунка на 2.', rule:'3 рисунка × 2 = 6 детей.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_38_09(props) {
  return (
    <React.Fragment>
