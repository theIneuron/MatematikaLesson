// Dars 38 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 05 · MC · ustunlar farqi ===== */
const D05 = makeMC({ tag:'bar_diff', level:'🟡', correctIdx:0, half:true, fs:22, stage:barStage([{label:'Ko‘k',val:5,color:'#5BD6F2'},{label:'Qizil',val:3,color:'#FF6B6B'}]) });
D05.T = {
  uz: { eyebrow:'Diagramma', setup:'Ko‘k ustun 5 ni, qizil ustun 3 ni ko‘rsatadi.', ask:'Ko‘k va qizil ustunlar orasidagi farq nechchi?', opts:['2','8','5','3'],
    correct:"To'g'ri. 5 − 3 = 2.", wrong:'Kattaroq ustundan kichigini ayiring: 5 − 3 nechchi bo‘ladi?', rule:'Farq = 5 − 3 = 2.' },
  ru: { eyebrow:'Диаграмма', setup:'Синий столбик — 5, красный — 3.', ask:'Какова разница между синим и красным столбиками?', opts:['2','8','5','3'],
    correct:'Верно. 5 − 3 = 2.', wrong:'Вычти из большего меньший: сколько 5 − 3?', rule:'Разница = 5 − 3 = 2.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_38_05(props) {
  return (
    <React.Fragment>
