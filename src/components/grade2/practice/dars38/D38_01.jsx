// Dars 38 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · IMZO PictoCount · olma 6 ===== */
const D01 = makePictoCount({ tag:'count_apple', level:'🟢', n:6, color:'#FF6B6B' });
D01.T = {
  uz: { eyebrow:'Piktogramma', setup:"Ra'no bog'da olmalarni piktogrammaga chizdi. Har bir rasm — bitta olma.", ask:'Piktogrammadagi olmalarni birma-bir bosib sanang: nechta olma bor?', counter:'Olmalar', correct:"To'g'ri. Piktogrammada 6 ta olma bor.", wrong:'Har bir olma rasmini bir marta bosing — birortasini tashlab yoki ikki marta sanamang.', rule:'Har rasm = 1 olma. Jami 6 ta.' },
  ru: { eyebrow:'Пиктограмма', setup:'Рано нарисовала яблоки на пиктограмме. Каждый рисунок — одно яблоко.', ask:'Нажми яблоки по одному и посчитай: сколько яблок?', counter:'Яблоки', correct:'Верно. На пиктограмме 6 яблок.', wrong:'Нажми каждое яблоко один раз — не пропуская и не дважды.', rule:'Каждый рисунок = 1 яблоко. Всего 6.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_38_01(props) {
  return (
    <React.Fragment>
