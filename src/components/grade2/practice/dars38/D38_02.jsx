// Dars 38 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · MC · qaysi eng ko'p ===== */
const D02 = makeMC({ tag:'most', level:'🟢', correctIdx:0, half:true, fs:16, mono:false, stage:barStage([{label:'Olma',val:3,color:'#FF6B6B'},{label:'Nok',val:6,color:'#7CE0A3'},{label:'Uzum',val:4,color:'#c792ea'}]) });
D02.T = {
  uz: { eyebrow:'Diagramma', setup:'Diagrammada mevalar soni ustunlar balandligi bilan ko‘rsatilgan.', ask:'Diagrammaga ko‘ra qaysi meva eng ko‘p?', opts:['Nok','Olma','Uzum','Teng'],
    correct:"To'g'ri. Nok ustuni eng baland (6 ta) — eng ko‘p.", wrong:'Eng baland ustunga qarang: qaysi mevaniki balandroq?', rule:'Eng baland ustun — eng ko‘p (Nok, 6).' },
  ru: { eyebrow:'Диаграмма', setup:'На диаграмме число фруктов показано высотой столбиков.', ask:'Какого фрукта больше всего по диаграмме?', opts:['Груша','Яблоко','Виноград','Поровну'],
    correct:'Верно. Столбик груши самый высокий (6) — больше всех.', wrong:'Смотри на самый высокий столбик: чей выше?', rule:'Самый высокий столбик — больше всех (груша, 6).' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_38_02(props) {
  return (
    <React.Fragment>
