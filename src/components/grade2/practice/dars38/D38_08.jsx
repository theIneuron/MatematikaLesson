// Dars 38 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · Story MC · mashinalar ===== */
const D08 = makeMC({ tag:'story_data', level:'🔴', correctIdx:0, half:true, fs:15, mono:false, stage:barStage([{label:'Dush',val:5,color:'#5BD6F2'},{label:'Sesh',val:8,color:'#FF9A6B'}]) });
D08.T = {
  uz: { eyebrow:'Masala', setup:'Diagrammaga ko‘ra dushanbada 5 ta, seshanbada 8 ta mashina keldi.', ask:'Qaysi kuni ko‘proq mashina keldi va nechtaga ko‘p?', opts:['Seshanba, 3 taga','Dushanba, 3 taga','Seshanba, 13 taga','Teng'],
    correct:"To'g'ri. Seshanbada ko‘p: 8 − 5 = 3 taga ko‘p.", wrong:'Qaysi ustun baland? Farqni toping: 8 − 5 nechchi?', rule:'Seshanba: 8 − 5 = 3 taga ko‘p.' },
  ru: { eyebrow:'Задача', setup:'По диаграмме в понедельник приехало 5 машин, во вторник — 8.', ask:'В какой день машин больше и на сколько?', opts:['Вторник, на 3','Понедельник, на 3','Вторник, на 13','Поровну'],
    correct:'Верно. Во вторник больше: 8 − 5 = 3.', wrong:'Какой столбик выше? Найди разницу: 8 − 5?', rule:'Вторник: 8 − 5 = 3 больше.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_38_08(props) {
  return (
    <React.Fragment>
