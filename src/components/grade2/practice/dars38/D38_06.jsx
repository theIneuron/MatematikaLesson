// Dars 38 · Amaliyot 06 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 06 · BuildNum · jami ===== */
const D06 = makeBuildNum({ tag:'total', level:'🟡', answer:9, cells:1, digits:['9','3','4','2'], stage:barStage([{label:'Olma',val:3,color:'#FF6B6B'},{label:'Nok',val:4,color:'#7CE0A3'},{label:'Uzum',val:2,color:'#c792ea'}]) });
D06.T = {
  uz: { eyebrow:'Diagramma · jami', setup:'Diagrammada 3 olma, 4 nok va 2 uzum ko‘rsatilgan.', ask:'Diagrammadagi barcha mevalarni qo‘shing. Jami nechta? Raqamlardan yasang.', correct:"To'g'ri. 3 + 4 + 2 = 9 ta meva.", wrong:'Har uch ustunni qo‘shing: 3 + 4 + 2 nechchi bo‘ladi?', rule:'3 + 4 + 2 = 9.' },
  ru: { eyebrow:'Диаграмма · всего', setup:'На диаграмме 3 яблока, 4 груши и 2 винограда.', ask:'Сложи все фрукты диаграммы. Сколько всего? Составь из цифр.', correct:'Верно. 3 + 4 + 2 = 9 фруктов.', wrong:'Сложи три столбика: сколько 3 + 4 + 2?', rule:'3 + 4 + 2 = 9.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_38_06(props) {
  return (
    <React.Fragment>
