// Dars 38 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · MC · jadval o'qish ===== */
const D03 = makeMC({ tag:'table', level:'🟢', correctIdx:0, half:true, fs:22, stage:(t)=>(<div style={{...S.mono,color:C.sink,fontSize:16,fontWeight:800,textAlign:'center',lineHeight:1.9}}><div style={{color:C.goldSoft}}>Kitoblar soni</div><div>Anvar — 5</div><div>Zuhra — 3</div><div>Jasur — 7</div></div>) });
D03.T = {
  uz: { eyebrow:'Jadval', setup:'Jadvalda har bir bolaning kitoblari soni yozilgan.', ask:'Jadvalga ko‘ra, Anvarda nechta kitob bor?', opts:['5','3','7','8'],
    correct:"To'g'ri. Jadvalda Anvar — 5 kitob.", wrong:'Jadvaldan Anvar qatorini toping: uning yonida qaysi son yozilgan?', rule:'Jadval bo‘yicha Anvar — 5 kitob.' },
  ru: { eyebrow:'Таблица', setup:'В таблице записано число книг у каждого ребёнка.', ask:'Сколько книг у Анвара по таблице?', opts:['5','3','7','8'],
    correct:'Верно. В таблице у Анвара — 5 книг.', wrong:'Найди строку Анвара: какое число рядом с ним?', rule:'По таблице у Анвара — 5 книг.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_38_03(props) {
  return (
    <React.Fragment>
