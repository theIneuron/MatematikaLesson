// Dars 32 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · IMZO Shade · yarim (2 bo'lak) ===== */
const D01 = makeShade({ tag:'shade_half', level:'🟢', parts:2, need:1, shape:'circle' });
D01.T = {
  uz: { eyebrow:'Ulush-bo‘yash', setup:'Zuhra oshxonada dumaloq nonni 2 teng bo‘lakka bo‘ldi.', ask:'Nonning yarmini bosib bo‘yang (2 bo‘lakdan bittasini).', hint:'Bo‘yalgan bo‘laklar', correct:"To'g'ri. 2 teng bo‘lakdan biri — bu yarim.", wrong:'Yarim — bu 2 teng bo‘lakdan bittasi. Bitta bo‘lakni bo‘yang.', rule:'Yarim — butunning 2 teng bo‘lagidan biri.' },
  ru: { eyebrow:'Закрась долю', setup:'Зухра разделила круглый хлеб на 2 равные части.', ask:'Закрась половину хлеба (одну из 2 частей).', hint:'Закрашено', correct:'Верно. Одна из 2 равных частей — это половина.', wrong:'Половина — одна из 2 равных частей. Закрась одну.', rule:'Половина — одна из 2 равных частей целого.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_32_01(props) {
  return (
    <React.Fragment>
