// Dars 32 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · MC · chorak ===== */
const D03 = makeMC({ tag:'name_quarter', level:'🟢', correctIdx:1, half:true, fs:18, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><FracFig parts={4} shaded={[0]} /></div>) });
D03.T = {
  uz: { eyebrow:'Ulush nomi', setup:'Butun 4 teng bo‘lakka bo‘lingan va bittasi bo‘yalgan.', ask:'Butun 4 teng bo‘lakka bo‘lingan bo‘lsa, ulardan bittasi qanday ataladi?', opts:['Yarim','Chorak','Uchdan bir','Butun'],
    correct:"To'g'ri. 4 teng bo‘lakdan biri — chorak.", wrong:'4 teng bo‘lakdan bittasi maxsus nom bilan ataladi. Qaysi?', rule:'4 teng bo‘lakdan biri = chorak.' },
  ru: { eyebrow:'Название доли', setup:'Целое разделено на 4 равные части, одна закрашена.', ask:'Как называется одна часть, если целое поделили на 4 равные?', opts:['Половина','Четверть','Треть','Целое'],
    correct:'Верно. Одна из 4 равных частей — четверть.', wrong:'Одна из 4 равных частей имеет особое название. Какое?', rule:'Одна из 4 равных частей = четверть.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_32_03(props) {
  return (
    <React.Fragment>
