// Dars 32 · Amaliyot 06 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 06 · MC · non 4 bo'lak ===== */
const D06 = makeMC({ tag:'ate_quarter', level:'🟡', correctIdx:0, half:true, fs:18, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><FracFig parts={4} shaded={[0]} /></div>) });
D06.T = {
  uz: { eyebrow:'Masala', setup:'Non 4 teng bo‘lakka bo‘lindi. Jasur ulardan 1 bo‘lagini yedi.', ask:'Jasur nonning qaysi ulushini yedi?', opts:['Chorak','Yarim','Uchdan bir','Butun'],
    correct:"To'g'ri. 4 bo‘lakdan 1 tasi — chorak.", wrong:'Non nechta teng bo‘lakka bo‘lingan? Jasur bittasini yedi. Bu qanday ulush?', rule:'4 teng bo‘lakdan biri = chorak.' },
  ru: { eyebrow:'Задача', setup:'Хлеб разделён на 4 равные части. Джасур съел 1 часть.', ask:'Какую долю хлеба съел Джасур?', opts:['Четверть','Половину','Треть','Целое'],
    correct:'Верно. 1 из 4 частей — четверть.', wrong:'На сколько равных частей поделён хлеб? Джасур съел одну. Какая доля?', rule:'Одна из 4 равных частей = четверть.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_32_06(props) {
  return (
    <React.Fragment>
