// Dars 32 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · Story MC · pirog uchdan bir ===== */
const D09 = makeMC({ tag:'story_third', level:'🔴', correctIdx:0, half:true, fs:16, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><FracFig parts={3} shaded={[0]} /></div>) });
D09.T = {
  uz: { eyebrow:'Masala', setup:'Zuhra dumaloq pirogni 3 teng bo‘lakka bo‘ldi va o‘zi 1 bo‘lagini oldi.', ask:'Zuhra pirogning qaysi ulushini oldi?', opts:['Uchdan bir','Yarim','Chorak','Butun'],
    correct:"To'g'ri. 3 teng bo‘lakdan 1 tasi — uchdan bir.", wrong:'Pirog nechta teng bo‘lakka bo‘lingan? 3 bo‘lakdan bittasi qanday ataladi?', rule:'3 teng bo‘lakdan biri = uchdan bir.' },
  ru: { eyebrow:'Задача', setup:'Зухра разделила круглый пирог на 3 равные части и взяла 1.', ask:'Какую долю пирога взяла Зухра?', opts:['Треть','Половину','Четверть','Целое'],
    correct:'Верно. 1 из 3 равных частей — треть.', wrong:'На сколько равных частей поделён пирог? 1 из 3 — как называется?', rule:'Одна из 3 равных частей = треть.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_32_09(props) {
  return (
    <React.Fragment>
