// Dars 32 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · MC · yarim nomi ===== */
const D02 = makeMC({ tag:'name_half', level:'🟢', correctIdx:0, half:true, fs:18, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><FracFig parts={2} shaded={[0]} /></div>) });
D02.T = {
  uz: { eyebrow:'Ulush nomi', setup:'Butun narsa 2 teng bo‘lakka bo‘lingan.', ask:'Butunni 2 teng bo‘lakka bo‘lsak, har bir bo‘lak qanday ataladi?', opts:['Yarim','Chorak','Uchdan bir','Butun'],
    correct:"To'g'ri. 2 teng bo‘lakdan biri — yarim.", wrong:'Nechta teng bo‘lak bor? 2 bo‘lakdan biri qanday ataladi?', rule:'2 teng bo‘lakdan biri = yarim.' },
  ru: { eyebrow:'Название доли', setup:'Целое разделено на 2 равные части.', ask:'Как называется одна часть, если целое поделили на 2 равные?', opts:['Половина','Четверть','Треть','Целое'],
    correct:'Верно. Одна из 2 равных частей — половина.', wrong:'Сколько равных частей? Одна из 2 — как называется?', rule:'Одна из 2 равных частей = половина.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_32_02(props) {
  return (
    <React.Fragment>
