// Dars 32 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 10 · MC · yarim vs chorak ===== */
const D10 = makeMC({ tag:'compare_frac', level:'🔴', correctIdx:0, half:true, fs:18 });
D10.T = {
  uz: { eyebrow:'Umumlashtirish', setup:'Bir xil butun nonni yarim va chorak bo‘lakka solishtiramiz.', ask:'Bir xil non: yarim bo‘lakmi kattaroq, chorak bo‘lakmi?', opts:['Yarim kattaroq','Chorak kattaroq','Ular teng','Bilib bo‘lmaydi'],
    correct:"To'g'ri. Bo‘laklar kamroq bo‘lsa, har biri kattaroq: yarim > chorak.", wrong:'Non nechaga ko‘p bo‘linsa, har bir bo‘lak shuncha kichik bo‘ladi. 2 ga bo‘linganmi katta, 4 gami?', rule:'Bo‘lak kam bo‘lsa — ulush katta: yarim > chorak.' },
  ru: { eyebrow:'Обобщение', setup:'Сравним половину и четверть одного и того же хлеба.', ask:'Один хлеб: что больше — половина или четверть?', opts:['Половина','Четверть','Равны','Нельзя узнать'],
    correct:'Верно. Чем меньше частей, тем каждая больше: половина > четверть.', wrong:'Чем на большее число частей делят, тем каждая меньше. На 2 или на 4 — где больше?', rule:'Меньше частей — больше доля: половина > четверть.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_32_10(props) {
  return (
    <React.Fragment>
