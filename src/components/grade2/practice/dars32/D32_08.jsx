// Dars 32 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · VisualMC · qaysida yarmi ===== */
const D08 = makeVisualMC({ tag:'pick_half', level:'🔴', correctIdx:1, items:[{p:4,s:[0]},{p:2,s:[0]},{p:3,s:[0]},{p:4,s:[0,1]}], render:(it,i)=><FracFig parts={it.p} shaded={it.s} /> });
D08.T = {
  uz: { eyebrow:'Yarmini top', setup:'Yarim — butunning aynan teng ikki bo‘lagidan biri.', ask:'Quyidagi rasmlardan qaysi birida aynan YARMI bo‘yalgan?',
    correct:"To'g'ri. Bu rasmda butun 2 teng bo‘lak, biri bo‘yalgan — yarim.", wrong:'Yarim uchun butun 2 teng bo‘lakka bo‘linib, biri bo‘yalishi kerak.', rule:'Yarim — 2 bo‘lakdan 1 tasi bo‘yalgan.' },
  ru: { eyebrow:'Найди половину', setup:'Половина — одна из ровно двух равных частей целого.', ask:'На каком рисунке закрашена именно ПОЛОВИНА?',
    correct:'Верно. Здесь целое из 2 равных частей, одна закрашена — половина.', wrong:'Для половины целое делится на 2 равные части, одна закрашена.', rule:'Половина — 1 из 2 частей закрашена.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_32_08(props) {
  return (
    <React.Fragment>
