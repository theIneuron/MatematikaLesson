// Dars 32 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · Match · ulush ↔ bo'lak ===== */
const D07 = makeMatch({ tag:'frac_match', level:'🟡' });
D07.T = {
  uz: { eyebrow:'Ulushni ulash', setup:'Har bir ulush nomini uning ma‘nosiga ulang.', ask:'Chapdagi nomni bosing, so‘ng o‘ngdan mos ma‘noni tanlang:',
    left:[{ label:'Yarim', match:0 }, { label:'Chorak', match:1 }, { label:'Uchdan bir', match:2 }],
    right:['2 bo‘lakdan 1','4 bo‘lakdan 1','3 bo‘lakdan 1'],
    correct:"To'g'ri. Yarim — 2 dan 1; chorak — 4 dan 1; uchdan bir — 3 dan 1.", wrong:'Nom bo‘laklar soniga ishora qiladi: yarim=2, uchdan bir=3, chorak=4.', rule:'Yarim=2 dan 1 · Chorak=4 dan 1 · Uchdan bir=3 dan 1.' },
  ru: { eyebrow:'Соедини долю', setup:'Соедини каждое название доли с её смыслом.', ask:'Нажми название слева, затем выбери смысл справа:',
    left:[{ label:'Половина', match:0 }, { label:'Четверть', match:1 }, { label:'Треть', match:2 }],
    right:['1 из 2 частей','1 из 4 частей','1 из 3 частей'],
    correct:'Верно. Половина — 1 из 2; четверть — 1 из 4; треть — 1 из 3.', wrong:'Название указывает на число частей: половина=2, треть=3, четверть=4.', rule:'Половина=1из2 · Четверть=1из4 · Треть=1из3.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_32_07(props) {
  return (
    <React.Fragment>
