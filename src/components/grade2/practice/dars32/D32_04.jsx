// Dars 32 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · IMZO Shade · uchdan bir (3 bo'lak) ===== */
const D04 = makeShade({ tag:'shade_third', level:'🟡', parts:3, need:1, shape:'circle' });
D04.T = {
  uz: { eyebrow:'Ulush-bo‘yash', setup:'Pirog 3 teng bo‘lakka bo‘lingan.', ask:'Pirogning uchdan bir qismini bosib bo‘yang (3 bo‘lakdan bittasini).', hint:'Bo‘yalgan bo‘laklar', correct:"To'g'ri. 3 teng bo‘lakdan biri — uchdan bir.", wrong:'Uchdan bir — 3 teng bo‘lakdan bittasi. Faqat bitta bo‘lakni bo‘yang.', rule:'Uchdan bir — 3 teng bo‘lakdan biri.' },
  ru: { eyebrow:'Закрась долю', setup:'Пирог разделён на 3 равные части.', ask:'Закрась треть пирога (одну из 3 частей).', hint:'Закрашено', correct:'Верно. Одна из 3 равных частей — треть.', wrong:'Треть — одна из 3 равных частей. Закрась только одну.', rule:'Треть — одна из 3 равных частей.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_32_04(props) {
  return (
    <React.Fragment>
