// Dars 39 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · Multiselect · juft ===== */
const D07 = makeMultiselect({ tag:'r_even', level:'🟡' });
D07.T = {
  uz: { eyebrow:'Mantiq', setup:'Juft son 2 ga qoldiqsiz bo‘linadi.', ask:'Juft sonlarni belgilang:',
    opts:[{ label:'2', ok:true }, { label:'5', ok:false }, { label:'6', ok:true }, { label:'8', ok:true }],
    correct:"To'g'ri. 2, 6, 8 — juft sonlar.", wrong:'Juft son ikkiga teng bo‘linadi. 5 ni teng bo‘lib bo‘ladimi?', rule:'Juft: 2, 6, 8.' },
  ru: { eyebrow:'Логика', setup:'Чётное число делится на 2 без остатка.', ask:'Отметь чётные числа:',
    opts:[{ label:'2', ok:true }, { label:'5', ok:false }, { label:'6', ok:true }, { label:'8', ok:true }],
    correct:'Верно. 2, 6, 8 — чётные.', wrong:'Чётное делится на два поровну. Делится ли 5?', rule:'Чётные: 2, 6, 8.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_39_07(props) {
  return (
    <React.Fragment>
