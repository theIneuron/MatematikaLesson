// Dars 39 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · MC · perimetr ===== */
const D08 = makeMC({ tag:'r_perim', level:'🔴', correctIdx:0, half:true, fs:22, stage:SqStage });
D08.T = {
  uz: { eyebrow:'Geometriya', setup:'Kvadratning bir tomoni 5 sm. Uning to‘rt tomoni teng.', ask:'Bir tomoni 5 sm bo‘lgan kvadratning perimetri nechchi?', opts:['20','25','10','15'],
    correct:"To'g'ri. 5 × 4 = 20 sm.", wrong:'Kvadratda 4 ta teng tomon. 5 ni 4 marta qo‘shing (yoki 5 × 4).', rule:'Kvadrat perimetri = 5 × 4 = 20.' },
  ru: { eyebrow:'Геометрия', setup:'Сторона квадрата 5 см. Все четыре стороны равны.', ask:'Каков периметр квадрата со стороной 5 см?', opts:['20','25','10','15'],
    correct:'Верно. 5 × 4 = 20 см.', wrong:'У квадрата 4 равные стороны. Сложи 5 четыре раза (5 × 4).', rule:'Периметр квадрата = 5 × 4 = 20.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_39_08(props) {
  return (
    <React.Fragment>
