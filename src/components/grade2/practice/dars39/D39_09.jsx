// Dars 39 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · Story MC · masala ===== */
const D09 = makeMC({ tag:'r_story', level:'🔴', correctIdx:0, half:true, fs:16, mono:false });
D09.T = {
  uz: { eyebrow:'Masala', setup:'Jasur do‘konga 500 so‘m bilan bordi. U 300 so‘mlik daftar sotib oldi.', ask:'Jasurga qancha qaytim beriladi?', opts:['200 so‘m','800 so‘m','300 so‘m','100 so‘m'],
    correct:"To'g'ri. 500 − 300 = 200 so‘m qaytim.", wrong:'Bergan pulidan (500) narx (300) ni ayiring: qancha qaytadi?', rule:'500 − 300 = 200 so‘m.' },
  ru: { eyebrow:'Задача', setup:'Джасур пришёл в магазин с 500 сумами. Он купил тетрадь за 300 сумов.', ask:'Сколько сдачи получит Джасур?', opts:['200 сумов','800 сумов','300 сумов','100 сумов'],
    correct:'Верно. 500 − 300 = 200 сумов сдачи.', wrong:'Из отданных (500) вычти цену (300): сколько вернётся?', rule:'500 − 300 = 200 сумов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_39_09(props) {
  return (
    <React.Fragment>
