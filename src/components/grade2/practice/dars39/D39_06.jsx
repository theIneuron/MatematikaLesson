// Dars 39 · Amaliyot 06 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 06 · Order · kalendar ===== */
const D06 = makeOrder({ tag:'r_days', level:'🟡' });
D06.T = {
  uz: { eyebrow:'Kalendar', setup:'Hafta kunlari aralashib ketgan.', ask:'Hafta kunlarini to‘g‘ri tartibda bosing (1, 2, 3, 4):',
    cards:[{ txt:'Chorshanba', pos:2 }, { txt:'Dushanba', pos:0 }, { txt:'Payshanba', pos:3 }, { txt:'Seshanba', pos:1 }],
    correct:"To'g'ri. Dushanba, Seshanba, Chorshanba, Payshanba.", wrong:'Haftaning birinchi kuni — Dushanba. Keyin tartib bilan.', rule:'Dushanba → Seshanba → Chorshanba → Payshanba.' },
  ru: { eyebrow:'Календарь', setup:'Дни недели перемешаны.', ask:'Нажми дни недели по порядку (1, 2, 3, 4):',
    cards:[{ txt:'Среда', pos:2 }, { txt:'Понедельник', pos:0 }, { txt:'Четверг', pos:3 }, { txt:'Вторник', pos:1 }],
    correct:'Верно. Понедельник, вторник, среда, четверг.', wrong:'Первый день — понедельник. Дальше по порядку.', rule:'Пн → Вт → Ср → Чт.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_39_06(props) {
  return (
    <React.Fragment>
