// Dars 39 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · MC · harfli ifoda ===== */
const D01 = makeMC({ tag:'r_expr', level:'🟢', correctIdx:0, half:true, fs:22, stage:bigStage('a + 4,  a = 5') });
D01.T = {
  uz: { eyebrow:'Harfli ifoda', setup:'a + 4 ifodasida a = 5.', ask:'a + 4 ifodasida a = 5 bo‘lsa, qiymati nechchi?', opts:['9','54','5','1'],
    correct:"To'g'ri. 5 + 4 = 9.", wrong:'a o‘rniga 5 ni qo‘ying: 5 + 4 nechchi bo‘ladi?', rule:'a + 4 da a = 5 → 9.' },
  ru: { eyebrow:'Буквенное выражение', setup:'В a + 4 значение a = 5.', ask:'Чему равно a + 4, если a = 5?', opts:['9','54','5','1'],
    correct:'Верно. 5 + 4 = 9.', wrong:'Подставь 5 вместо a: сколько 5 + 4?', rule:'a + 4 при a = 5 → 9.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_39_01(props) {
  return (
    <React.Fragment>
