// Dars 39 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · BuildNum · tenglama ===== */
const D04 = makeBuildNum({ tag:'r_eq', level:'🟡', answer:7, cells:1, digits:['7','1','3','0'], stage:bigStage('x + 3 = 10') });
D04.T = {
  uz: { eyebrow:'Tenglama', setup:'x + 3 = 10 tenglamasida x — noma‘lum.', ask:'x + 3 = 10 tenglamada x ni toping va raqamlardan yasang:', correct:"To'g'ri. x = 10 − 3 = 7.", wrong:'x ga 3 qo‘shilganda 10 chiqadi. 10 dan 3 ni ayiring.', rule:'x + 3 = 10 → x = 7.' },
  ru: { eyebrow:'Уравнение', setup:'В x + 3 = 10 x — неизвестное.', ask:'Найди x в x + 3 = 10 и составь из цифр:', correct:'Верно. x = 10 − 3 = 7.', wrong:'К x прибавили 3 и вышло 10. Вычти из 10 число 3.', rule:'x + 3 = 10 → x = 7.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_39_04(props) {
  return (
    <React.Fragment>
