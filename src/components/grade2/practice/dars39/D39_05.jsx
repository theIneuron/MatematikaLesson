// Dars 39 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 05 · MC · ulush ===== */
const D05 = makeMC({ tag:'r_frac', level:'🟡', correctIdx:0, half:true, fs:18 });
D05.T = {
  uz: { eyebrow:'Ulush', setup:'Nonni 4 teng bo‘lakka bo‘ldik.', ask:'Butun 4 teng bo‘lakka bo‘lingan bo‘lsa, ulardan bittasi qanday ataladi?', opts:['Chorak','Yarim','Uchdan bir','Butun'],
    correct:"To'g'ri. 4 teng bo‘lakdan biri — chorak.", wrong:'4 teng bo‘lakdan bittasi maxsus nom bilan ataladi. Qaysi?', rule:'4 bo‘lakdan 1 = chorak.' },
  ru: { eyebrow:'Доля', setup:'Хлеб разделили на 4 равные части.', ask:'Как называется одна часть, если целое поделили на 4 равные?', opts:['Четверть','Половина','Треть','Целое'],
    correct:'Верно. Одна из 4 равных частей — четверть.', wrong:'Одна из 4 частей имеет особое название. Какое?', rule:'1 из 4 частей = четверть.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_39_05(props) {
  return (
    <React.Fragment>
