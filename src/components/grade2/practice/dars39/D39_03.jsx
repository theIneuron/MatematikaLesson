// Dars 39 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · MC · pul ===== */
const D03 = makeMC({ tag:'r_money', level:'🟢', correctIdx:0, half:true, fs:18 });
D03.T = {
  uz: { eyebrow:'Pul', setup:'Ra‘noda 200 so‘m bor edi, unga yana 300 so‘m berildi.', ask:'Endi Ra‘noda qancha pul bor?', opts:['500 so‘m','230 so‘m','100 so‘m','600 so‘m'],
    correct:"To'g'ri. 200 + 300 = 500 so‘m.", wrong:'Bor puliga qo‘shilgan pulni qo‘shing: 200 + 300 nechchi?', rule:'200 + 300 = 500 so‘m.' },
  ru: { eyebrow:'Деньги', setup:'У Рано было 200 сумов, ей дали ещё 300.', ask:'Сколько денег теперь у Рано?', opts:['500 сумов','230 сумов','100 сумов','600 сумов'],
    correct:'Верно. 200 + 300 = 500 сумов.', wrong:'К своим деньгам прибавь данные: 200 + 300?', rule:'200 + 300 = 500 сумов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_39_03(props) {
  return (
    <React.Fragment>
