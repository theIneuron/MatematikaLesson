// Dars 39 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · TrueFalse · vaqt ===== */
const D02 = makeTrueFalse({ tag:'r_time', level:'🟢', answer:true });
D02.T = {
  uz: { eyebrow:'Vaqt', setup:'Vaqt birliklarini eslaymiz.', ask:'Bir soatda 60 minut bor. Bu fikr to‘g‘rimi?', yes:'Ha', no:'Yo‘q',
    correct:"To'g'ri javob: Ha. 1 soat = 60 minut.", wrong:'Soat gardishini minut strelkasi to‘liq aylanadi — bu 60 minut.', rule:'1 soat = 60 minut.' },
  ru: { eyebrow:'Время', setup:'Вспомним единицы времени.', ask:'В одном часе 60 минут. Верно?', yes:'Да', no:'Нет',
    correct:'Правильно: Да. 1 час = 60 минут.', wrong:'Минутная стрелка проходит полный круг — это 60 минут.', rule:'1 час = 60 минут.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_39_02(props) {
  return (
    <React.Fragment>
