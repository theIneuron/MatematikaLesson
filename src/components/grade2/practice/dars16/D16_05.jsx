// Dars 16 · Amaliyot 05 — mustaqil topshiriq fayli (grade1/grade5 uslubi).
...
const D05_ROWS = [{ expr: '6 × 2', val: 12 }, { expr: '7 × 2', val: 14 }, { expr: '6 × 5', val: 30 }, { expr: '7 × 4', val: 28 }];
const D05_CARDS = [12, 30, 14, 28, 24, 35];
const D05_T = {
  uz: {
    ...
    correct: "To'g'ri. 6×2=12, 7×2=14, 6×5=30, 7×4=28.",
    wrong: "Maslahat: har birini alohida sanang. 6×5 — 6,12,18,24,30. 7×4 — 7,14,21,28.",
    rule: "×6 va ×7 — har xil jadval. Har ifodani o'z jadvalidan sanang.",
  },
  ru: {
    ...
    correct: 'Верно. 6×2=12, 7×2=14, 6×5=30, 7×4=28.',
    wrong: 'Подсказка: считай каждое отдельно. 6×5 — 6,12,18,24,30. 7×4 — 7,14,21,28.',
    rule: '×6 и ×7 — разные таблицы. Считай каждое по своей таблице.',
  },
};
function D16_05Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { slots }, correctAnswer: { vals: D05_ROWS.map((r) => r.val) }, correct, meta: { tag: 'mul_match', level: '🟡' } });
  }, [slots, t, playCorrect, playWrong, onSubmit]);
  useReg(check, registerCheck);
  const cols = ['#c2410c', '#1F7A4D', '#017CA3', '#B45309'];
  const bgs = [C.accSoft, '#EAF7EF', '#E6F4FA', '#FFF6E9'];
  return (
    <div style={S.wrap}>
...
export default function D16_05(props) {
  return (<><style>{FX_CSS}</style><D16_05Impl {...props} /></>);
}

/* v-audio (auto) — TTS-toza narratsiya (ovoz). UZ = draft, uz-metodist validatsiyasi kerak. */
D16_05.audio = {
  uz: { intro: "Bit ko'paytmalarni hisobladi. Har birini javobiga ulang. Kartani bosing, keyin mos ifodaning bo'sh joyini bosing.", on_correct: "To'g'ri. 6 ko'paytirish 2 teng 12, 7 ko'paytirish 2 teng 14, 6 ko'paytirish 5 teng 30, 7 ko'paytirish 4 teng 28.", on_wrong: "Maslahat. Har birini alohida sanang. 6 ko'paytirish 5, 6,12,18,24,30. 7 ko'paytirish 4, 7,14,21,28." },
  ru: { intro: "Бит посчитал произведения. Соедини каждое с ответом. Нажми карточку, затем пустое место нужного выражения.", on_correct: "Верно. 6 умножить на 2 равно 12, 7 умножить на 2 равно 14, 6 умножить на 5 равно 30, 7 умножить на 4 равно 28.", on_wrong: "Подсказка. Считай каждое отдельно. 6 умножить на 5, 6,12,18,24,30. 7 умножить на 4, 7,14,21,28." },
};
