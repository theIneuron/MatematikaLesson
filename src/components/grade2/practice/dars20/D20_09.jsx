// Dars 20 · Amaliyot 09 — mustaqil topshiriq fayli (grade1/grade5 uslubi).
...
const D09_T = {
  uz: {
    eyebrow: 'Masala', setup: "Zuhra 20 ta kristalni qutilarga terdi, har qutida 5 tadan.",
    ask: 'Nechta quti kerak bo‘ldi?',
    opts: ['15', '4', '5', '25'],
    correct: "To'g'ri. 20 ÷ 5 = 4. (4 × 5 = 20 — bir oila.)",
    wrong: "Maslahat: 20 da nechta 5 bor? 4 × 5 = 20, demak 20 ÷ 5 = 4.",
    rule: "«Jamini teng guruhga bo'lish»: 20 ÷ 5 = 4.",
  },
  ru: {
    eyebrow: 'Задача', setup: 'Зухра разложила 20 кристаллов по коробкам, по 5 в каждой.',
    ask: 'Сколько коробок понадобилось?',
    opts: ['15', '4', '5', '25'],
    correct: 'Верно. 20 ÷ 5 = 4. (4 × 5 = 20 — одна семья.)',
    wrong: 'Подсказка: сколько пятёрок в 20? 4 × 5 = 20, значит 20 ÷ 5 = 4.',
    rule: '«Разделить всё на равные группы»: 20 ÷ 5 = 4.',
  },
};
function D20_09Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: t.opts.map((l, i) => ({ id: String(i), label: l })), studentAnswer: { idx: picked, label: t.opts[picked] }, correctAnswer: { idx: 1, label: '4' }, correct, meta: { tag: 'fact_word', level: '🔴' } });
  ...
  return (
    <div style={S.wrap}>
      ...
      <Stage>
        <div style={{ display: 'flex', gap: 5, flexWrap: 'wrap', justifyContent: 'center', maxWidth: 340, margin: '0 auto' }}>
