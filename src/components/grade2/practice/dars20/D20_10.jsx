// Dars 20 · Amaliyot 10 — mustaqil topshiriq fayli (grade1/grade5 uslubi).
...
const D10_T = {
  uz: {
    eyebrow: 'Javobni ter', setup: "Yordam: 4 × 6 = 24 ni eslang.",
    ask: '24 ÷ 4 = ⬜? Raqamni bosib javobni tering:',
    correct: "To'g'ri. 24 ÷ 4 = 6, chunki 4 × 6 = 24. Bir oila.",
    wrong: "Maslahat: 4 × 6 = 24 bo'lgani uchun 24 ÷ 4 = 6.",
    rule: "Ko'paytirishni bilsang, bo'lishni topasan: 4 × 6 = 24 → 24 ÷ 4 = 6.",
  },
  ru: {
    eyebrow: 'Набери ответ', setup: 'Подсказка: вспомни 4 × 6 = 24.',
    ask: '24 ÷ 4 = ⬜? Набери ответ, нажимая цифру:',
    correct: 'Верно. 24 ÷ 4 = 6, потому что 4 × 6 = 24. Одна семья.',
    wrong: 'Подсказка: так как 4 × 6 = 24, то 24 ÷ 4 = 6.',
    rule: 'Знаешь умножение — найдёшь деление: 4 × 6 = 24 → 24 ÷ 4 = 6.',
  },
};
function D20_10Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value: parseInt(val, 10) }, correctAnswer: { value: D10_ANS }, correct, meta: { tag: 'fact_numpad', level: '🔴' } });
  ...
  return (
    <div style={S.wrap}>
      ...
      <Stage>
        <CrystalArray r={4} c={6} s={13} />
        <div className="d20-float" style={{ textAlign: 'center', marginTop: 6, ...S.mono, fontSize: 30, fontWeight: 800, color: C.gold }}>24 ÷ 4</div>
      </Stage>
