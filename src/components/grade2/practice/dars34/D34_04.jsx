// Dars 34 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · MC · 1 yil = 12 oy ===== */
const D04 = makeMC({ tag:'year12', level:'🟡', correctIdx:0, half:true, fs:22 });
D04.T = {
  uz: { eyebrow:'Kalendar', setup:'Oylar birlashib bir yilni tashkil qiladi.', ask:'Bir yilda nechta oy bor?', opts:['12','7','30','10'],
    correct:"To'g'ri. Bir yilda 12 oy bor.", wrong:'Yanvardan Dekabrgacha oylarni sanang: nechta bo‘ladi?', rule:'1 yil = 12 oy.' },
  ru: { eyebrow:'Календарь', setup:'Месяцы вместе составляют год.', ask:'Сколько месяцев в одном году?', opts:['12','7','30','10'],
    correct:'Верно. В году 12 месяцев.', wrong:'Посчитай месяцы от января до декабря: сколько?', rule:'1 год = 12 месяцев.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_34_04(props) {
  return (
    <React.Fragment>
