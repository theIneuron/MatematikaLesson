// Dars 34 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · Order · hafta kunlari ===== */
const D03 = makeOrder({ tag:'order_days', level:'🟢' });
D03.T = {
  uz: { eyebrow:'Tartiblash', setup:'Hafta kunlari aralashib ketgan.', ask:'Hafta kunlarini to‘g‘ri tartibda bosing (1, 2, 3, 4):',
    cards:[{ txt:'Seshanba', pos:1 }, { txt:'Dushanba', pos:0 }, { txt:'Payshanba', pos:3 }, { txt:'Chorshanba', pos:2 }],
    correct:"To'g'ri. Dushanba, Seshanba, Chorshanba, Payshanba.", wrong:'Haftaning birinchi kuni — Dushanba. Keyin tartib bilan davom eting.', rule:'Dushanba → Seshanba → Chorshanba → Payshanba.' },
  ru: { eyebrow:'Упорядочи', setup:'Дни недели перемешаны.', ask:'Нажми дни недели в верном порядке (1, 2, 3, 4):',
    cards:[{ txt:'Вторник', pos:1 }, { txt:'Понедельник', pos:0 }, { txt:'Четверг', pos:3 }, { txt:'Среда', pos:2 }],
    correct:'Верно. Понедельник, вторник, среда, четверг.', wrong:'Первый день недели — понедельник. Дальше по порядку.', rule:'Пн → Вт → Ср → Чт.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_34_03(props) {
  return (
    <React.Fragment>
