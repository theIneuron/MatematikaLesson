// Dars 34 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · MC · Yanvardan keyin ===== */
const D07 = makeMC({ tag:'after_jan', level:'🟡', correctIdx:0, half:true, fs:17, mono:false });
D07.T = {
  uz: { eyebrow:'Oylar tartibi', setup:'Oylar ham doim bir xil tartibda keladi.', ask:'Yanvar oyidan keyin qaysi oy keladi?', opts:['Fevral','Dekabr','Mart','Aprel'],
    correct:"To'g'ri. Yanvardan keyin Fevral keladi.", wrong:'Yilning birinchi oyi — Yanvar. Undan keyin qaysi oy?', rule:'Yanvar → Fevral.' },
  ru: { eyebrow:'Порядок месяцев', setup:'Месяцы тоже идут в одном порядке.', ask:'Какой месяц идёт после января?', opts:['Февраль','Декабрь','Март','Апрель'],
    correct:'Верно. После января — февраль.', wrong:'Первый месяц года — январь. Какой после него?', rule:'Январь → февраль.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_34_07(props) {
  return (
    <React.Fragment>
