// Dars 34 · Amaliyot 06 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 06 · Multiselect · dam olish kunlari ===== */
const D06 = makeMultiselect({ tag:'weekend', level:'🟡' });
D06.T = {
  uz: { eyebrow:'Dam olish kunlari', setup:'Haftada ish kunlari va dam olish kunlari bor.', ask:'Dam olish kunlarini belgilang (2 tasini):',
    opts:[{ label:'Shanba', ok:true }, { label:'Yakshanba', ok:true }, { label:'Dushanba', ok:false }, { label:'Payshanba', ok:false }],
    correct:"To'g'ri. Shanba va Yakshanba — dam olish kunlari.", wrong:'Haftaning oxirgi ikki kuni dam olish kunlari. Ular qaysi?', rule:'Dam olish kunlari — Shanba va Yakshanba.' },
  ru: { eyebrow:'Выходные дни', setup:'В неделе есть рабочие и выходные дни.', ask:'Отметь выходные дни (2):',
    opts:[{ label:'Суббота', ok:true }, { label:'Воскресенье', ok:true }, { label:'Понедельник', ok:false }, { label:'Четверг', ok:false }],
    correct:'Верно. Суббота и воскресенье — выходные.', wrong:'Последние два дня недели — выходные. Какие?', rule:'Выходные — суббота и воскресенье.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_34_06(props) {
  return (
    <React.Fragment>
