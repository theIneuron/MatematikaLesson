// Dars 34 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · MC · 1 hafta = 7 kun ===== */
const D01 = makeMC({ tag:'week7', level:'🟢', correctIdx:0, half:true, fs:22 });
D01.T = {
  uz: { eyebrow:'Kalendar', setup:'Kunlar haftalarga, haftalar oylarga birlashadi.', ask:'Bir haftada nechta kun bor?', opts:['7','5','30','12'],
    correct:"To'g'ri. Bir haftada 7 kun bor.", wrong:'Dushanbadan Yakshanbagacha kunlarni sanang: nechta bo‘ladi?', rule:'1 hafta = 7 kun.' },
  ru: { eyebrow:'Календарь', setup:'Дни складываются в недели, недели — в месяцы.', ask:'Сколько дней в одной неделе?', opts:['7','5','30','12'],
    correct:'Верно. В неделе 7 дней.', wrong:'Посчитай дни от понедельника до воскресенья: сколько?', rule:'1 неделя = 7 дней.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_34_01(props) {
  return (
    <React.Fragment>
