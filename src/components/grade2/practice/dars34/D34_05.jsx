// Dars 34 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 05 · IMZO CalendarGrid · 5-sana ===== */
const D05 = makeCalendar({ tag:'find_date', level:'🟡', days:30, target:5 });
D05.T = {
  uz: { eyebrow:'Kalendar-katak', setup:'Jasur bort jurnalidagi oy kalendarini ochdi.', ask:'Kalendardan 5-sanani toping va bosing.', dow:['Du','Se','Ch','Pa','Ju','Sh','Ya'], hint:'5 sanasini bosing', correct:"To'g'ri. Bu — oyning 5-sanasi.", wrong:'Kataklar 1 dan boshlanadi. 1, 2, 3, 4, 5 — beshinchi katakni bosing.', rule:'Kalendar kataklari sana tartibida: 1, 2, 3, …' },
  ru: { eyebrow:'Клетка календаря', setup:'Джасур открыл календарь месяца в бортжурнале.', ask:'Найди в календаре число 5 и нажми его.', dow:['Пн','Вт','Ср','Чт','Пт','Сб','Вс'], hint:'нажми число 5', correct:'Верно. Это 5-е число месяца.', wrong:'Клетки начинаются с 1. 1, 2, 3, 4, 5 — нажми пятую.', rule:'Клетки календаря по порядку: 1, 2, 3, …' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_34_05(props) {
  return (
    <React.Fragment>
