// Dars 37 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · MC · shakl naqshi ===== */
const D03 = makeMC({ tag:'shape_pat', level:'🟢', correctIdx:0, half:true, fs:26, stage:(t)=>(<div style={{textAlign:'center',fontSize:34,fontWeight:800,color:C.gold,letterSpacing:6}}>● ▲ ● ▲ ● ?</div>) });
D03.T = {
  uz: { eyebrow:'Shakl naqshi', setup:'Shakllar navbatma-navbat takrorlanadi: doira, uchburchak, doira, uchburchak…', ask:'● ▲ ● ▲ ● ? — keyingi shakl qaysi bo‘ladi?', opts:['▲','●','■','★'],
    correct:"To'g'ri. Naqsh navbatlashadi: doiradan keyin uchburchak.", wrong:'Naqshga qarang: doiradan keyin qaysi shakl kelyapti? Takrorlanishni davom ettiring.', rule:'● ▲ ● ▲ ● ▲ — navbatlashish.' },
  ru: { eyebrow:'Узор из фигур', setup:'Фигуры чередуются: круг, треугольник, круг, треугольник…', ask:'● ▲ ● ▲ ● ? — какая фигура следующая?', opts:['▲','●','■','★'],
    correct:'Верно. Узор чередуется: после круга — треугольник.', wrong:'Смотри на узор: что идёт после круга? Продолжи чередование.', rule:'● ▲ ● ▲ ● ▲ — чередование.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_37_03(props) {
  return (
    <React.Fragment>
