// Dars 37 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · IMZO PatternNext · 2,4,6,8 ===== */
const D01 = makePatternNext({ tag:'pat_even', level:'🟢', correctIdx:0 });
D01.T = {
  uz: { eyebrow:'Naqsh davomi', seq:['2','4','6','8'], opts:['10','9','12','7'], setup:'Jasur sonlar naqshini tuzdi. Har son avvalgidan 2 ga ko‘p.', ask:'Naqshni davom ettiring: 2, 4, 6, 8, ? — keyingi son qaysi?',
    correct:"To'g'ri. Har qadam +2: 8 dan keyin 10.", wrong:'Sonlar orasidagi farqni toping: har safar nechtaga oshyapti? 8 ga o‘shancha qo‘shing.', rule:'Naqsh: +2 → 8 + 2 = 10.' },
  ru: { eyebrow:'Продолжи узор', seq:['2','4','6','8'], opts:['10','9','12','7'], setup:'Джасур составил узор из чисел. Каждое на 2 больше предыдущего.', ask:'Продолжи узор: 2, 4, 6, 8, ? — какое следующее число?',
    correct:'Верно. Каждый шаг +2: после 8 идёт 10.', wrong:'Найди разницу между числами: на сколько растёт? Прибавь к 8 столько же.', rule:'Узор: +2 → 8 + 2 = 10.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_37_01(props) {
  return (
    <React.Fragment>
