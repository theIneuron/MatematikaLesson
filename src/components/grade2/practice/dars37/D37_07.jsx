// Dars 37 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · Find-wrong · naqsh buzilishi ===== */
const D07 = makeFindwrong({ tag:'pat_wrong', level:'🟡', colors:['#FFC23C','#5BD6F2','#7CE0A3','#FF9A6B'] });
D07.T = {
  uz: { eyebrow:'Naqshni buzgan', setup:'Bu naqsh uchtalab sanaladi: 3, 6, 9, 12, …', ask:'Naqshda bittasi noto‘g‘ri. Qaysi son naqshni BUZYAPTI?',
    rows:[{ txt:'3', ok:true }, { txt:'6', ok:true }, { txt:'9', ok:true }, { txt:'14', ok:false }],
    correct:"To'g'ri. 12 bo‘lishi kerak edi, 14 emas (uchtalab: 9 + 3 = 12).", wrong:'Har qadam +3. 9 dan keyin qaysi son kelishi kerak?', rule:'Naqsh: 3, 6, 9, 12 (+3). 14 — xato.' },
  ru: { eyebrow:'Кто ломает узор', setup:'Этот узор — счёт по три: 3, 6, 9, 12, …', ask:'Одно число неверно. Какое ЛОМАЕТ узор?',
    rows:[{ txt:'3', ok:true }, { txt:'6', ok:true }, { txt:'9', ok:true }, { txt:'14', ok:false }],
    correct:'Верно. Должно быть 12, а не 14 (по три: 9 + 3 = 12).', wrong:'Каждый шаг +3. Какое число после 9?', rule:'Узор: 3, 6, 9, 12 (+3). 14 — ошибка.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_37_07(props) {
  return (
    <React.Fragment>
