// Dars 37 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 10 · MC · o'nlab ortiqcha ===== */
const D10 = makeMC({ tag:'ten_out', level:'🔴', correctIdx:0, half:true, fs:22, stage:(t)=>(<div style={{textAlign:'center',...S.mono,fontSize:28,fontWeight:800,color:C.gold}}>10  20  30  35  40</div>) });
D10.T = {
  uz: { eyebrow:'Ortiqchasini top', setup:'Bu qator o‘nlab sanaladi: 10, 20, 30, …', ask:'10, 20, 30, 35, 40 — qaysi son o‘nlab sanashga MOS EMAS?', opts:['35','40','30','20'],
    correct:"To'g'ri. 35 — o‘nlab sanashga mos emas (30 dan keyin 40 kelishi kerak).", wrong:'O‘nlab sanang: 10, 20, 30, 40. Qaysi son bu tartibda yo‘q?', rule:'O‘nlab: 10, 20, 30, 40. 35 — ortiqcha.' },
  ru: { eyebrow:'Найди лишнее', setup:'Этот ряд — счёт по десять: 10, 20, 30, …', ask:'10, 20, 30, 35, 40 — какое число НЕ подходит счёту по десять?', opts:['35','40','30','20'],
    correct:'Верно. 35 не подходит (после 30 должно быть 40).', wrong:'Считай по десять: 10, 20, 30, 40. Какого числа тут не должно быть?', rule:'По десять: 10, 20, 30, 40. 35 — лишнее.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_37_10(props) {
  return (
    <React.Fragment>
