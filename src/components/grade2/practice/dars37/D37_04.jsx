// Dars 37 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · IMZO PatternNext · 5,10,15,20 ===== */
const D04 = makePatternNext({ tag:'pat_five', level:'🟡', correctIdx:0 });
D04.T = {
  uz: { eyebrow:'Naqsh davomi', seq:['5','10','15','20'], opts:['25','21','30','22'], setup:'Zuhra beshtalab sanash naqshini tuzdi.', ask:'Naqshni davom ettiring: 5, 10, 15, 20, ? — keyingi son qaysi?',
    correct:"To'g'ri. Har qadam +5: 20 dan keyin 25.", wrong:'Sonlar beshtalab oshyapti: 5, 10, 15, 20, … 20 ga 5 ni qo‘shing.', rule:'Naqsh: +5 → 20 + 5 = 25.' },
  ru: { eyebrow:'Продолжи узор', seq:['5','10','15','20'], opts:['25','21','30','22'], setup:'Зухра составила узор счёта по пять.', ask:'Продолжи: 5, 10, 15, 20, ? — следующее число?',
    correct:'Верно. Каждый шаг +5: после 20 идёт 25.', wrong:'Числа растут по 5: 5, 10, 15, 20, … Прибавь к 20 число 5.', rule:'Узор: +5 → 20 + 5 = 25.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_37_04(props) {
  return (
    <React.Fragment>
