// Dars 37 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · IMZO PatternNext · 1,2,4,7 ===== */
const D08 = makePatternNext({ tag:'pat_grow', level:'🔴', correctIdx:0 });
D08.T = {
  uz: { eyebrow:'Naqsh davomi', seq:['1','2','4','7'], opts:['11','10','14','8'], setup:'Bu naqshda qadam har safar bittaga ko‘payadi: +1, +2, +3, …', ask:'Naqshni davom ettiring: 1, 2, 4, 7, ? — keyingi son qaysi?',
    correct:"To'g'ri. Qadamlar: +1, +2, +3, +4. 7 + 4 = 11.", wrong:'Farqlarga qarang: 1→2 (+1), 2→4 (+2), 4→7 (+3). Keyingi qadam nechchi?', rule:'Qadam +1, +2, +3, +4 → 7 + 4 = 11.' },
  ru: { eyebrow:'Продолжи узор', seq:['1','2','4','7'], opts:['11','10','14','8'], setup:'Здесь шаг каждый раз растёт: +1, +2, +3, …', ask:'Продолжи: 1, 2, 4, 7, ? — следующее число?',
    correct:'Верно. Шаги: +1, +2, +3, +4. 7 + 4 = 11.', wrong:'Смотри на разницы: 1→2 (+1), 2→4 (+2), 4→7 (+3). Какой шаг дальше?', rule:'Шаг +1, +2, +3, +4 → 7 + 4 = 11.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_37_08(props) {
  return (
    <React.Fragment>
