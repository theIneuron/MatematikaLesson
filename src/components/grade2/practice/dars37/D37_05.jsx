// Dars 37 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 05 · Multiselect · juft sonlar ===== */
const D05 = makeMultiselect({ tag:'evens', level:'🟡' });
D05.T = {
  uz: { eyebrow:'Juft sonlar', setup:'Juft son 2 ga qoldiqsiz bo‘linadi (2, 4, 6, 8…).', ask:'Faqat juft sonlarni belgilang:',
    opts:[{ label:'3', ok:false }, { label:'4', ok:true }, { label:'6', ok:true }, { label:'8', ok:true }],
    correct:"To'g'ri. 4, 6, 8 — juft sonlar. 3 — toq.", wrong:'Juft son ikkiga teng bo‘linadi. 3 ni teng ikkiga bo‘lib bo‘ladimi?', rule:'Juft: 4, 6, 8; toq: 3.' },
  ru: { eyebrow:'Чётные числа', setup:'Чётное число делится на 2 без остатка (2, 4, 6, 8…).', ask:'Отметь только чётные числа:',
    opts:[{ label:'3', ok:false }, { label:'4', ok:true }, { label:'6', ok:true }, { label:'8', ok:true }],
    correct:'Верно. 4, 6, 8 — чётные. 3 — нечётное.', wrong:'Чётное делится на два поровну. Делится ли 3 на два поровну?', rule:'Чётные: 4, 6, 8; нечётное: 3.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_37_05(props) {
  return (
    <React.Fragment>
