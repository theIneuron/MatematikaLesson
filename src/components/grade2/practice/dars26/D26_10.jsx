// Dars 26 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
const D10 = makeMC({ tag:'gen_sv', level:'🔴', correctIdx:3, half:false, fs:16, mono:false });
D10.T = {
  uz: { eyebrow:'Umumlashtirish', setup:'Har qanday ko‘pburchakda tomonlar va burchaklar bir-biriga bog‘liq.', ask:'Ko‘pburchakda tomonlar soni bilan burchaklar soni qanday bo‘ladi?', opts:['Tomonlar ko‘p','Burchaklar ko‘p','Bog‘liq emas','Doim teng'],
    correct:"To'g'ri. Ko‘pburchakda tomonlar soni burchaklar soniga doim teng.", wrong:'Uchburchakda 3 tomon va 3 burchak; to‘rtburchakda 4 va 4. Nima sezasiz?', rule:'Ko‘pburchakda tomon soni = burchak soni.' },
  ru: { eyebrow:'Обобщение', setup:'В любом многоугольнике стороны и углы связаны.', ask:'Как соотносятся число сторон и число углов в многоугольнике?', opts:['Сторон больше','Углов больше','Не связаны','Всегда равны'],
    correct:'Верно. Число сторон всегда равно числу углов.', wrong:'В треугольнике 3 и 3; в четырёхугольнике 4 и 4. Что заметно?', rule:'Число сторон = число углов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_26_10(props) {
  return (
    <React.Fragment>
