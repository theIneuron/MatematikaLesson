// Dars 26 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · MC · diagonalli to'rtburchakda uchburchaklar ===== */
const TriRect = () => (
  <svg width="200" height="140" viewBox="0 0 200 140">
    <rect x="40" y="30" width="120" height="80" fill="rgba(91,214,242,.12)" stroke="#5BD6F2" strokeWidth="3" />
    <motion.line x1="40" y1="30" x2="160" y2="110" stroke="#FFC23C" strokeWidth="3" strokeLinecap="round" initial={{ pathLength:0 }} animate={{ pathLength:1 }} transition={{ delay:0.4, duration:0.6 }} />
    {[[40,30],[160,30],[160,110],[40,110]].map((p,i)=><circle key={i} cx={p[0]} cy={p[1]} r={4} fill="#fff" />)}
  </svg>
);
const D08 = makeMC({ tag:'count_tri', level:'🔴', correctIdx:1, half:true, fs:22, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><TriRect /></div>) });
D08.T = {
  uz: { eyebrow:'Uchburchaklarni sanash', setup:'Quyida bitta diagonal chizig‘i chizilgan to‘rtburchak berilgan. Diagonal shaklni ikkiga bo‘ladi.', ask:'Quyidagi rasmda nechta uchburchak mavjud?', opts:['1','2','3','4'],
    correct:"To'g'ri. Bitta diagonal to‘rtburchakni 2 ta uchburchakka bo‘ladi.", wrong:'Diagonal to‘rtburchakni nechta qismga bo‘ldi? Har bir qism — bitta uchburchak.', rule:'Bitta diagonal → 2 ta uchburchak.' },
  ru: { eyebrow:'Счёт треугольников', setup:'Ниже дан четырёхугольник с одной проведённой диагональю. Диагональ делит фигуру надвое.', ask:'Сколько треугольников на рисунке?', opts:['1','2','3','4'],
    correct:'Верно. Одна диагональ делит четырёхугольник на 2 треугольника.', wrong:'На сколько частей диагональ разделила четырёхугольник? Каждая часть — треугольник.', rule:'Одна диагональ → 2 треугольника.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_26_08(props) {
  return (
    <React.Fragment>
