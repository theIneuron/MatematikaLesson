// Dars 26 · Amaliyot 06 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 06 · TrueFalse · egri shakl ===== */
const D06 = makeTrueFalse({ tag:'tf_poly', level:'🟡', answer:false, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><CircleSVG r={40} /></div>) });
D06.T = {
  uz: { eyebrow:"To'g'ri yoki noto'g'ri", setup:'Ekranda egri (dumaloq) shakl ko‘rsatilgan.', ask:'Bu shaklni ko‘pburchak deb atash mumkinmi? (ko‘pburchakning tomonlari to‘g‘ri kesma bo‘lishi kerak)', yes:'Ha', no:'Yo‘q',
    correct:"To'g'ri javob: Yo‘q. Egri shakl ko‘pburchak emas.", wrong:'Ko‘pburchakning tomonlari to‘g‘ri kesmalardan iborat. Egri chiziq tomon bo‘la oladimi?', rule:'Egri (dumaloq) shakl ko‘pburchak emas.' },
  ru: { eyebrow:'Верно или неверно', setup:'На экране изогнутая (круглая) фигура.', ask:'Можно ли назвать эту фигуру многоугольником? (стороны должны быть прямыми отрезками)', yes:'Да', no:'Нет',
    correct:'Правильно: Нет. Изогнутая фигура не многоугольник.', wrong:'Стороны многоугольника — прямые отрезки. Может ли кривая быть стороной?', rule:'Изогнутая (круглая) фигура не многоугольник.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_26_06(props) {
  return (
    <React.Fragment>
