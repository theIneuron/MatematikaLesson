// Dars 26 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · VisualMC · qaysi to'rtburchak ===== */
const D07 = makeVisualMC({ tag:'pick4', level:'🟡', correctIdx:1, items:[{n:3},{n:4},{n:5},{n:6}], render:(it,i)=> <ShapeSVG n={it.n} r={38} stroke={COLS[i]} fill={COLS[i]+'22'} /> });
D07.T = {
  uz: { eyebrow:'To‘g‘ri shaklni top', setup:'Har bir shaklning tomonlarini sanang.', ask:'Quyidagilardan qaysi biri to‘rtburchak (4 tomonli)?',
    correct:"To'g'ri. 4 tomonli shakl — to‘rtburchak.", wrong:'Har shaklning tomonlarini sanang: qaysida aynan 4 ta tomon bor?', rule:'To‘rtburchak — aynan 4 tomonli.' },
  ru: { eyebrow:'Найди фигуру', setup:'Посчитай стороны каждой фигуры.', ask:'Какая из фигур — четырёхугольник (4 стороны)?',
    correct:'Верно. Фигура с 4 сторонами — четырёхугольник.', wrong:'Посчитай стороны каждой: где ровно 4?', rule:'Четырёхугольник — ровно 4 стороны.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_26_07(props) {
  return (
    <React.Fragment>
