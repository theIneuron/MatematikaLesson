// Dars 26 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · MC · beshburchak ===== */
const D03 = makeMC({ tag:'name5', level:'🟢', correctIdx:2, half:true, fs:15, mono:false, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><ShapeSVG n={5} r={42} stroke="#7CE0A3" fill="rgba(124,224,163,.16)" /></div>) });
D03.T = {
  uz: { eyebrow:'Ko‘pburchak nomi', setup:'Bu shaklning beshta tomoni bor.', ask:'Beshta tomoni bo‘lgan ko‘pburchak qanday ataladi?', opts:['Uchburchak','To‘rtburchak','Beshburchak','Oltiburchak'],
    correct:"To'g'ri. 5 tomon — bu beshburchak.", wrong:'Tomonlar sonini sanang: 5 tomonli ko‘pburchak nomini eslang.', rule:'Beshburchak — 5 tomonli.' },
  ru: { eyebrow:'Название', setup:'У этой фигуры пять сторон.', ask:'Как называется многоугольник с пятью сторонами?', opts:['Треугольник','Четырёхугольник','Пятиугольник','Шестиугольник'],
    correct:'Верно. 5 сторон — это пятиугольник.', wrong:'Посчитай стороны: вспомни название 5-стороннего.', rule:'Пятиугольник — 5 сторон.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_26_03(props) {
  return (
    <React.Fragment>
