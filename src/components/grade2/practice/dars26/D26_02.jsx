// Dars 26 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · MC · to'rtburchak nomi ===== */
const D02 = makeMC({ tag:'name4', level:'🟢', correctIdx:1, half:true, fs:15, mono:false, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><ShapeSVG n={4} r={40} /></div>) });
D02.T = {
  uz: { eyebrow:'Ko‘pburchak nomi', setup:'Bu shaklning 4 ta tomoni va 4 ta burchagi bor.', ask:'4 ta tomoni va 4 ta burchagi bo‘lgan bu ko‘pburchak qanday ataladi?', opts:['Uchburchak','To‘rtburchak','Beshburchak','Doira'],
    correct:"To'g'ri. 4 tomon, 4 burchak — bu to‘rtburchak.", wrong:'Tomonlarini sanang: nechta tomon bo‘lsa, nomida ham shuncha ko‘rsatiladi.', rule:'To‘rtburchak — 4 tomonli.' },
  ru: { eyebrow:'Название', setup:'У этой фигуры 4 стороны и 4 угла.', ask:'Как называется многоугольник с 4 сторонами и 4 углами?', opts:['Треугольник','Четырёхугольник','Пятиугольник','Круг'],
    correct:'Верно. 4 стороны, 4 угла — это четырёхугольник.', wrong:'Посчитай стороны: сколько сторон, столько в названии.', rule:'Четырёхугольник — 4 стороны.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_26_02(props) {
  return (
    <React.Fragment>
