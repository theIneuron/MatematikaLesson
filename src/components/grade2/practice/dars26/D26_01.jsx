// Dars 26 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · IMZO PolyCount (tomon) · uchburchak ===== */
const D01 = makePolyCount({ tag:'count_side3', level:'🟢', n:3, mode:'side' });
D01.T = {
  uz: { eyebrow:'Tomonlarni sanash', setup:'Zuhra kosmik panel uchun uchburchak yasadi. Uning har bir tomonini bosib sanaymiz.', ask:'Uchburchakning tomonlarini birma-bir bosing va nechta tomoni borligini aniqlang.', counter:'Tomonlar', correct:"To'g'ri. Uchburchakning 3 ta tomoni bor.", wrong:'Har bir tomonni (chekkani) bosing — biror tomonni tashlab qo‘ymang.', rule:'Uchburchak — 3 tomonli ko‘pburchak.' },
  ru: { eyebrow:'Счёт сторон', setup:'Зухра сделала треугольную панель. Нажмём каждую её сторону и посчитаем.', ask:'Нажимай стороны треугольника по одной и определи, сколько их.', counter:'Стороны', correct:'Верно. У треугольника 3 стороны.', wrong:'Нажми каждую сторону — не пропусти ни одной.', rule:'Треугольник — многоугольник с 3 сторонами.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_26_01(props) {
  return (
    <React.Fragment>
