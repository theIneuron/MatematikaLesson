// Dars 26 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · Story MC · oltiburchak ===== */
const D09 = makeMC({ tag:'story6', level:'🔴', correctIdx:2, half:true, fs:15, mono:false, stage:(t)=>(<div style={{display:'flex',justifyContent:'center'}}><ShapeSVG n={6} r={42} stroke="#c792ea" fill="rgba(199,146,234,.16)" /></div>) });
D09.T = {
  uz: { eyebrow:'Masala', setup:'Jasur kosmik stansiya uchun 6 ta teng tomonli plita yasadi va ularni birlashtirib bitta yopiq shakl hosil qildi.', ask:'Jasur yasagan bu shakl qanday ko‘pburchak?', opts:['To‘rtburchak','Beshburchak','Oltiburchak','Uchburchak'],
    correct:"To'g'ri. 6 tomonli shakl — oltiburchak.", wrong:'Shaklning tomonlari soniga qarang: 6 ta tomon qanday ko‘pburchak?', rule:'6 tomon = oltiburchak.' },
  ru: { eyebrow:'Задача', setup:'Джасур сделал 6 равных сторон-плит и соединил их в одну замкнутую фигуру.', ask:'Какой многоугольник получился у Джасура?', opts:['Четырёхугольник','Пятиугольник','Шестиугольник','Треугольник'],
    correct:'Верно. Фигура с 6 сторонами — шестиугольник.', wrong:'Смотри на число сторон: 6 сторон — какой многоугольник?', rule:'6 сторон = шестиугольник.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_26_09(props) {
  return (
    <React.Fragment>
