// Dars 26 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · IMZO PolyCount (burchak) · beshburchak ===== */
const D04 = makePolyCount({ tag:'count_vertex5', level:'🟡', n:5, mode:'vertex' });
D04.T = {
  uz: { eyebrow:'Burchaklarni sanash', setup:'Endi beshburchakning burchaklarini (uchlarini) sanaymiz.', ask:'Beshburchakning burchaklarini birma-bir bosing va nechta burchagi borligini aniqlang.', counter:'Burchaklar', correct:"To'g'ri. Beshburchakning 5 ta burchagi bor — tomonlari kabi.", wrong:'Har bir uchni (burchakni) bosing. Tomon soni bilan burchak soni teng bo‘ladi.', rule:'Beshburchak — 5 tomon, 5 burchak.' },
  ru: { eyebrow:'Счёт углов', setup:'Теперь посчитаем углы (вершины) пятиугольника.', ask:'Нажимай углы пятиугольника по одному и определи, сколько их.', counter:'Углы', correct:'Верно. У пятиугольника 5 углов — как и сторон.', wrong:'Нажми каждую вершину. Число углов равно числу сторон.', rule:'Пятиугольник — 5 сторон, 5 углов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_26_04(props) {
  return (
    <React.Fragment>
