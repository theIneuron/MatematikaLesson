// Dars 9 · Amaliyot 09 — mustaqil topshiriq fayli (grade1/grade5 uslubi).
...
// nishon 62. 37+25=62, 45+17=62, 38+27=65(ortiqcha). 38+27 ni tanla.
const D09_OPTS = [
  { e: '37 + 25', v: 62 }, { e: '45 + 17', v: 62 }, { e: '38 + 27', v: 65 },
];
const D09_CORRECT = 2;
const D09_T = {
  uz: {
    eyebrow: 'Ortiqchasini toping', setup: 'Nishon soni — 62.',
    ask: 'Qaysi ifoda 62 GA TENG EMAS? O‘shani belgilang.',
    correct: "To'g'ri. 38 + 27 = 65, u 62 ga teng emas. Qolganlari 62 ga teng.",
    wrong: "Maslahat: har ifodani o‘tish bilan qo‘shib, natijasini 62 bilan solishtiring.",
    rule: "37 + 25 = 62, 45 + 17 = 62, 38 + 27 = 65. Ortiqchasi — 38 + 27.",
  },
  ru: {
    eyebrow: 'Найди лишнее', setup: 'Целевое число — 62.',
    ask: 'Какое выражение НЕ РАВНО 62? Отметь его.',
    correct: 'Верно. 38 + 27 = 65, оно не равно 62. Остальные равны 62.',
    wrong: 'Подсказка: сложи каждое с переходом и сравни результат с 62.',
    rule: '37 + 25 = 62, 45 + 17 = 62, 38 + 27 = 65. Лишнее — 38 + 27.',
  },
};
function D09_09Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: D09_OPTS.map((o, i) => ({ id: String(i), label: o.e })), studentAnswer: { idx: picked, label: picked != null ? D09_OPTS[picked].e : null }, correctAnswer: { idx: 2, label: '38 + 27' }, correct, meta: { tag: 'oddone', level: '🔴' } });
