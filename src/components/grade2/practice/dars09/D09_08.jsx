// Dars 9 · Amaliyot 08 — mustaqil topshiriq fayli (grade1/grade5 uslubi).
...
// 3⬜ + 25 = 62 -> ⬜ = 7 (7 + 5 = 12, o'tish bor)
const D08_ANS = 7;
const D08_T = {
  uz: {
    eyebrow: 'Yashirin birlik raqami', setup: 'Stolbik: 3⬜ + 25 = 62. Birlik raqami yashiringan (o‘tish bor).',
    ask: 'Yashirin birlik raqamini toping va tering: 3⬜ + 25 = 62.',
    correct: "To'g'ri. 37 + 25 = 62 (7 + 5 = 12 → 2 yozamiz, 1 ko‘chadi; 3 + 2 + 1 = 6).",
    wrong: "Maslahat: birlik javobi 2, lekin o‘tish bo‘lgan. ⬜ + 5 nechchi bo‘lsa oxiri 2 chiqadi?",
    rule: "Birlik: ⬜ + 5 = 12 → ⬜ = 7. O‘tish bor: 37 + 25 = 62.",
  },
  ru: {
    eyebrow: 'Скрытая цифра единиц', setup: 'Столбик: 3⬜ + 25 = 62. Цифра единиц скрыта (есть переход).',
    ask: 'Найди и набери скрытую цифру единиц: 3⬜ + 25 = 62.',
    correct: 'Верно. 37 + 25 = 62 (7 + 5 = 12 → пишем 2, 1 переносим; 3 + 2 + 1 = 6).',
    wrong: 'Подсказка: цифра единиц ответа 2, но был переход. При каком ⬜ + 5 в конце получается 2?',
    rule: 'Единицы: ⬜ + 5 = 12 → ⬜ = 7. Есть переход: 37 + 25 = 62.',
  },
};
function D09_08Impl(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: [], studentAnswer: { value: parseInt(val, 10) }, correctAnswer: { value: D08_ANS }, correct, meta: { tag: 'carrymiss', level: '🔴' } });
      ...
      <Stage>
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 12 }}>
          <Colon>
            <ColHeader />
            <CarryRow show />
            <Row sign="" tenNode={<DC ch="3" c={C.ten} />} oneNode={<BoxCell ch={val || ''} tone={bt} />} />
            <Row sign="+" tenNode={<DC ch="2" c={C.ten} />} oneNode={<DC ch="5" c={C.one} />} />
            <HR />
            <Row sign="" tenNode={<DC ch="6" c={C.ten} />} oneNode={<DC ch="2" c={C.one} />} />
          </Colon>
        </div>
