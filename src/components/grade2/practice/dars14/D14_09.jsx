// Dars 14 · Amaliyot 09 — mustaqil jsx-question (per-task split).
...
/* ===== 09 · findwrong · findwrong · findwrong ===== */
const D09 = makeFindwrong({ tag:'findwrong', level:'🔴', colors:['#FFC23C','#5BD6F2','#7CE0A3','#FF9A6B'] });

D09.T = {
  uz: { eyebrow:'Xatoni top', setup:"To'rt ko'paytirish yozilgan, bittasi noto'g'ri.", ask:"Noto'g'ri javobni toping.",
    rows:[{ txt:'2 × 3 = 6', ok:true }, { txt:'3 × 3 = 9', ok:true }, { txt:'2 × 4 = 8', ok:true }, { txt:'3 × 5 = 14', ok:false }],
    correct:"To'g'ri. 3 × 5 = 15 bo'lishi kerak, 14 emas.", wrong:'Har birini tekshiring. 3 tadan besh marta sanang: 3, 6, 9, 12, …', rule:'3 × 5 = 15 (3 tadan: 3, 6, 9, 12, 15).' },
  ru: { eyebrow:'Найди ошибку', setup:'Записаны четыре умножения, одно неверно.', ask:'Найди неверный ответ.',
    rows:[{ txt:'2 × 3 = 6', ok:true }, { txt:'3 × 3 = 9', ok:true }, { txt:'2 × 4 = 8', ok:true }, { txt:'3 × 5 = 14', ok:false }],
    correct:'Верно. Должно быть 3 × 5 = 15, а не 14.', wrong:'Проверь каждое. Считай по 3 пять раз: 3, 6, 9, 12, …', rule:'3 × 5 = 15 (по 3: 3, 6, 9, 12, 15).' },
};
