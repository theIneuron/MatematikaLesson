// Dars 14 · Amaliyot 02 — mustaqil jsx-question (per-task split).
...
/* ===== 02 · skip3 · MC (groups) · skip3 ===== */
const D02 = makeMC({ tag:'skip3', level:'🟢', correctIdx:0, half:true, fs:22, stage:groups(4,3) });

D02.T = {
  uz: { eyebrow:'3 tadan sanash', setup:'4 guruh, har birida 3 tadan. 3 tadan sanaymiz: 3, 6, 9, …', scene:'4 guruh × 3 tadan', ask:"Jami nechta yo'ldosh? (4 marta 3)", opts:['12','9','15','7'],
    correct:"To'g'ri. 3, 6, 9, 12 — 4 marta 3 = 4 × 3 = 12.", wrong:"3 tadan sanang: 3, 6, 9, … To'rtinchi qadam qancha? Ikkitadan emas — uchtadan.", rule:'4 × 3 = 12 (3 tadan: 3, 6, 9, 12).' },
  ru: { eyebrow:'Счёт по 3', setup:'4 группы по 3. Считаем по 3: 3, 6, 9, …', scene:'4 группы × по 3', ask:'Сколько всего? (4 раза по 3)', opts:['12','9','15','7'],
    correct:'Верно. 3, 6, 9, 12 — 4 раза по 3 = 4 × 3 = 12.', wrong:'Считай по 3: 3, 6, 9, … Четвёртый шаг? Не по 2, а по 3.', rule:'4 × 3 = 12 (по 3: 3, 6, 9, 12).' },
};
...
D14_02.audio = {
  uz: { intro: "4 guruh, har birida 3 tadan. 3 tadan sanaymiz. 3, 6, 9, va hokazo Jami nechta yo'ldosh? 4 marta 3", on_correct: "To'g'ri. 3, 6, 9, 12, 4 marta 3 teng 4 ko'paytirish 3 teng 12.", on_wrong: "3 tadan sanang. 3, 6, 9, va hokazo To'rtinchi qadam qancha? Ikkitadan emas, uchtadan." },
  ru: { intro: "4 группы по 3. Считаем по 3. 3, 6, 9, и так далее Сколько всего? 4 раза по 3", on_correct: "Верно. 3, 6, 9, 12, 4 раза по 3 равно 4 умножить на 3 равно 12.", on_wrong: "Считай по 3. 3, 6, 9, и так далее Четвёртый шаг? Не по 2, а по 3." },
};
