// Dars 14 · Amaliyot 07 — mustaqil jsx-question (per-task split).
...
/* ===== 07 · multi12 · multiselect · multi12 ===== */
const D07 = makeMultiselect({ tag:'multi12', level:'🟡' });

D07.T = {
  uz: { eyebrow:'Bir xil javob', setup:"Ba'zi ifodalar bir xil javob beradi.", ask:'Javobi 12 ga teng 2 ta ifodani belgilang:',
    opts:[{ label:'6 × 2', ok:true }, { label:'4 × 3', ok:true }, { label:'5 × 2', ok:false }, { label:'3 × 3', ok:false }],
    correct:"To'g'ri. 6 × 2 = 12 va 4 × 3 = 12. Boshqalari 10 va 9.", wrong:'Har birini hisoblang: 5 × 2 = 10, 3 × 3 = 9 — 12 emas.', rule:'6 × 2 = 12 va 4 × 3 = 12.' },
  ru: { eyebrow:'Один ответ', setup:'Некоторые выражения дают одинаковый ответ.', ask:'Отметь 2 выражения, равные 12:',
    opts:[{ label:'6 × 2', ok:true }, { label:'4 × 3', ok:true }, { label:'5 × 2', ok:false }, { label:'3 × 3', ok:false }],
    correct:'Верно. 6 × 2 = 12 и 4 × 3 = 12. Остальные 10 и 9.', wrong:'Посчитай каждое: 5 × 2 = 10, 3 × 3 = 9 — не 12.', rule:'6 × 2 = 12 и 4 × 3 = 12.' },
};
