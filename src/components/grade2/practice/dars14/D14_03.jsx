// Dars 14 · Amaliyot 03 — mustaqil jsx-question (per-task split).
...
/* ===== 03 · tablefill2 · MC (strip) · tablefill2 ===== */
const D03 = makeMC({ tag:'tablefill2', level:'🟢', correctIdx:0, half:true, fs:22, stage:stripStage([2,4,0,8,10],2) });

D03.T = {
  uz: { eyebrow:'Jadval · ×2', setup:"2 ga ko'paytirish jadvali qatori. Har katak avvalgidan 2 ko'p.", scene:'2 tadan: 2, 4, ⬜, 8, 10', ask:"Bo'sh katakni to'ping (3 marta 2):", opts:['6','5','8','7'],
    correct:"To'g'ri. 2, 4, 6, 8, 10 — bo'sh katak 6 (3 × 2).", wrong:"Avvalgi katakka 2 qo'shing: 4 dan keyin nechchi? Ketma-ketlikka qarang.", rule:"×2: 2, 4, 6, 8, 10. Bo'sh — 6." },
  ru: { eyebrow:'Таблица · ×2', setup:'Строка таблицы ×2. Каждая клетка на 2 больше.', scene:'по 2: 2, 4, ⬜, 8, 10', ask:'Заполни пустую клетку (3 раза по 2):', opts:['6','5','8','7'],
    correct:'Верно. 2, 4, 6, 8, 10 — пустая клетка 6 (3 × 2).', wrong:'Прибавь 2 к предыдущей: что после 4? Смотри на ряд.', rule:'×2: 2, 4, 6, 8, 10. Пустая — 6.' },
};
