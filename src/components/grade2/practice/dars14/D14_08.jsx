// Dars 14 · Amaliyot 08 — mustaqil jsx-question (per-task split).
...
/* ===== 08 · word (Zuhra) · MC · word ===== */
const D08 = makeMC({ tag:'word', level:'🔴', correctIdx:0, half:true, fs:22, stage:groups(4,3) });

D08.T = {
  uz: { eyebrow:'Masala', setup:"Zuhra 4 qatorga, har biriga 3 tadan ko'chat ekdi.", scene:'Zuhra · 4 × 3', ask:"Zuhra jami nechta ko'chat ekdi?", opts:['12','7','15','9'],
    correct:"To'g'ri. 4 × 3 = 12. To'rt qator, har birida 3 tadan.", wrong:"3 tadan sanang: 3, 6, 9, 12. To'rt qadam.", rule:'4 × 3 = 12.' },
  ru: { eyebrow:'Задача', setup:'Зухра посадила 4 ряда по 3 ростка.', scene:'Зухра · 4 × 3', ask:'Сколько всего ростков посадила Зухра?', opts:['12','7','15','9'],
    correct:'Верно. 4 × 3 = 12. Четыре ряда по 3.', wrong:'Считай по 3: 3, 6, 9, 12. Четыре шага.', rule:'4 × 3 = 12.' },
};
