// Dars 14 · Amaliyot 10 — mustaqil jsx-question (per-task split).
...
/* ===== 10 · match23 · match (moslar) · match23 ===== */
const D10 = makeMatch({ tag:'match23', level:'🟡' });

D10.T = {
  uz: { eyebrow:'Juftlab ulash', setup:"Har ko'paytirishni javobiga ulang.", ask:"Chapdagini bosing, so'ng o'ngdan mos javobni tanlang:",
    left:[{ label:'7 × 2', match:1 }, { label:'6 × 3', match:0 }, { label:'4 × 2', match:2 }],
    right:['18','14','8'],
    correct:"To'g'ri. 7 × 2 = 14; 6 × 3 = 18; 4 × 2 = 8.", wrong:'Har birini sanang: 2 tadan yoki 3 tadan. Mos javobni toping.', rule:'7 × 2 = 14, 6 × 3 = 18, 4 × 2 = 8.' },
  ru: { eyebrow:'Соедини пары', setup:'Соедини каждое умножение с ответом.', ask:'Нажми слева, затем выбери ответ справа:',
    left:[{ label:'7 × 2', match:1 }, { label:'6 × 3', match:0 }, { label:'4 × 2', match:2 }],
    right:['18','14','8'],
    correct:'Верно. 7 × 2 = 14; 6 × 3 = 18; 4 × 2 = 8.', wrong:'Посчитай каждое: по 2 или по 3. Найди ответ.', rule:'7 × 2 = 14, 6 × 3 = 18, 4 × 2 = 8.' },
};
