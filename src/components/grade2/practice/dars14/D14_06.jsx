// Dars 14 · Amaliyot 06 — mustaqil jsx-question (per-task split).
...
/* ===== 06 · oddout · findwrong (ortiqchasini olib tashlash) · oddout ===== */
const D06 = makeFindwrong({ tag:'oddout', level:'🟡', colors:['#FFC23C','#5BD6F2','#7CE0A3','#FF9A6B'] });

D06.T = {
  uz: { eyebrow:'Ortiqchasini top', setup:"To'rttadan uchtasi 3 ga ko'paytirish, biri ortiqcha.", ask:"3 ga ko'paytirish EMAS bo'lganini (ortiqchasini) toping.",
    rows:[{ txt:'3 × 4', ok:true }, { txt:'3 × 5', ok:true }, { txt:'2 × 6', ok:false }, { txt:'3 × 2', ok:true }],
    correct:"To'g'ri. 2 × 6 da 3 yo'q — u ortiqcha. Qolganlarida 3 bor.", wrong:"Qaysi ifodada 3 ga ko'paytirish yo'q? Ko'paytuvchilarga qarang.", rule:"3 ga ko'paytirishda bir ko'paytuvchi — 3. 2 × 6 mos emas." },
  ru: { eyebrow:'Найди лишнее', setup:'Три из четырёх — умножение на 3, одно лишнее.', ask:'Найди лишнее (НЕ умножение на 3).',
    rows:[{ txt:'3 × 4', ok:true }, { txt:'3 × 5', ok:true }, { txt:'2 × 6', ok:false }, { txt:'3 × 2', ok:true }],
    correct:'Верно. В 2 × 6 нет тройки — оно лишнее. В остальных есть 3.', wrong:'В каком выражении нет умножения на 3? Смотри на множители.', rule:'В умножении на 3 один множитель — 3. 2 × 6 не подходит.' },
};
...
D14_06.audio = {
  uz: { intro: "To'rttadan uchtasi 3 ga ko'paytirish, biri ortiqcha. 3 ga ko'paytirish EMAS bo'lganini ortiqchasini toping.", on_correct: "To'g'ri. 2 ko'paytirish 6 da 3 yo'q, u ortiqcha. Qolganlarida 3 bor.", on_wrong: "Qaysi ifodada 3 ga ko'paytirish yo'q? Ko'paytuvchilarga qarang." },
  ru: { intro: "Три из четырёх, умножение на 3, одно лишнее. Найди лишнее НЕ умножение на 3.", on_correct: "Верно. В 2 умножить на 6 нет тройки, оно лишнее. В остальных есть 3.", on_wrong: "В каком выражении нет умножения на 3? Смотри на множители." },
};
