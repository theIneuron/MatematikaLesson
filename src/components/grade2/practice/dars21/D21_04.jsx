// Dars 21 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* =================== 04 · Son o'qi (÷3) · 🟡 · nline3 =================== */
const D04_CORRECT = 0;
const D04_T = {
  uz: {
    eyebrow: 'Son o‘qi', setup: "15 kristal. Har vagonchaga 3 tadan.",
    ask: '15 dan 0 gacha 3 tadan orqaga sakraymiz. Nechta sakrash?',
    opts: ['5', '4', '6', '12'],
    correct: "To'g'ri. 15 dan 3 talab 5 marta: 15 ÷ 3 = 5.",
    wrong: "Maslahat: 15, 12, 9, 6, 3, 0 — har qadam −3. Sakrashlarni sanang.",
    rule: "Orqaga 3 talik sakrashlar soni = 15 ÷ 3 = 5.",
  },
  ru: {
    eyebrow: 'Числовая ось', setup: '15 кристаллов. По 3 в каждую вагонетку.',
    ask: 'Прыгаем от 15 к 0 по 3. Сколько прыжков?',
    opts: ['5', '4', '6', '12'],
    correct: 'Верно. От 15 по 3 — 5 раз: 15 ÷ 3 = 5.',
    wrong: 'Подсказка: 15, 12, 9, 6, 3, 0 — каждый шаг 3 назад. Считай прыжки.',
    rule: 'Число прыжков назад по 3 = 15 ÷ 3 = 5.',
  },
};
function D21_04(props) {
  ...
  const check = useCallback(() => {
    ...
    onSubmit?.({ questionText: t.ask, options: t.opts.map((l, i) => ({ id: String(i), label: l })), studentAnswer: { idx: picked, label: t.opts[picked] }, correctAnswer: { idx: 0, label: '5' }, correct, meta: { tag: 'nline3', level: '🟡' } });
  ...
  return (
    <div style={S.wrap}>
      ...
      <Stage><NumberLine max={15} step={3} /></Stage>
...
const __FX_CSS = `
      ...
      `;
export default function Task_21_04(props) {
  return (
    <React.Fragment>
