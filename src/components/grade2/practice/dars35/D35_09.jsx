// Dars 35 · Amaliyot 09 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 09 · Story MC · 200+300 ===== */
const D09 = makeMC({ tag:'story_money', level:'🔴', correctIdx:0, half:true, fs:20 });
D09.T = {
  uz: { eyebrow:'Masala', setup:'Ra‘noda 200 so‘m bor edi. Onasi unga yana 300 so‘m berdi.', ask:'Endi Ra‘noda qancha pul bor?', opts:['500 so‘m','230 so‘m','100 so‘m','600 so‘m'],
    correct:"To'g'ri. 200 + 300 = 500 so‘m.", wrong:'Bor puliga (200) qo‘shilgan pulni (300) qo‘shing: jami qancha?', rule:'200 + 300 = 500 so‘m.' },
  ru: { eyebrow:'Задача', setup:'У Рано было 200 сумов. Мама дала ей ещё 300 сумов.', ask:'Сколько денег теперь у Рано?', opts:['500 сумов','230 сумов','100 сумов','600 сумов'],
    correct:'Верно. 200 + 300 = 500 сумов.', wrong:'К своим деньгам (200) прибавь данные (300): сколько всего?', rule:'200 + 300 = 500 сумов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_35_09(props) {
  return (
    <React.Fragment>
