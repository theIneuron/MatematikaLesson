// Dars 35 · Amaliyot 04 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 04 · IMZO CoinTray · 250 ===== */
const D04 = makeCoinTray({ tag:'tray250', level:'🟡', target:250, coins:[50,100,200] });
D04.T = {
  uz: { eyebrow:'Tanga-savat', setup:"Zuhra 250 so'mlik daftar olmoqchi.", ask:'Aynan 250 so‘m yig‘ing (masalan 200 + 50 yoki 100 + 100 + 50).', empty:'Tangalarni bu yerga soling', som:"so'm", correct:"To'g'ri. 250 so‘m yig‘ildi.", wrong:'Yig‘indi aynan 250 bo‘lsin: yirik tanga, so‘ng maydasini qo‘shing.', rule:'250 = 200 + 50 (yoki 100 + 100 + 50).' },
  ru: { eyebrow:'Копилка монет', setup:'Зухра хочет купить тетрадь за 250 сумов.', ask:'Собери ровно 250 сумов (например 200 + 50 или 100 + 100 + 50).', empty:'Клади монеты сюда', som:'сум', correct:'Верно. Собрано 250 сумов.', wrong:'Сумма ровно 250: сначала крупная монета, потом мелкие.', rule:'250 = 200 + 50 (или 100 + 100 + 50).' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_35_04(props) {
  return (
    <React.Fragment>
