// Dars 35 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · MC · 100 > 50 ===== */
const D03 = makeMC({ tag:'bigger', level:'🟢', correctIdx:0, half:true, fs:18, mono:false });
D03.T = {
  uz: { eyebrow:'Taqqoslash', setup:'Turli qiymatdagi tangalar bor.', ask:'Qaysi tanganing qiymati kattaroq: 100 so‘mmi yoki 50 so‘mmi?', opts:['100 so‘m','50 so‘m','Ular teng','Bilib bo‘lmaydi'],
    correct:"To'g'ri. 100 so‘m 50 so‘mdan katta.", wrong:'Qaysi son katta: 100 mi yoki 50 mi? Katta son — katta qiymat.', rule:'100 so‘m > 50 so‘m.' },
  ru: { eyebrow:'Сравнение', setup:'Есть монеты разного достоинства.', ask:'Какая монета дороже: 100 сумов или 50 сумов?', opts:['100 сумов','50 сумов','Равны','Нельзя узнать'],
    correct:'Верно. 100 сумов больше 50 сумов.', wrong:'Какое число больше: 100 или 50? Больше число — больше стоимость.', rule:'100 сумов > 50 сумов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_35_03(props) {
  return (
    <React.Fragment>
