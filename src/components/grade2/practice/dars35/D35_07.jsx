// Dars 35 · Amaliyot 07 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 07 · Find-wrong · summa ===== */
const D07 = makeFindwrong({ tag:'money_wrong', level:'🟡', colors:['#FFC23C','#5BD6F2','#7CE0A3','#FF9A6B'] });
D07.T = {
  uz: { eyebrow:'Xatoni top', setup:'To‘rt xil pul yig‘indisi hisoblangan, bittasi noto‘g‘ri.', ask:'Qaysi yig‘indi NOTO‘G‘RI hisoblangan?',
    rows:[{ txt:'100 + 100 = 200', ok:true }, { txt:'200 + 50 = 250', ok:true }, { txt:'100 + 50 = 200', ok:false }, { txt:'500 + 100 = 600', ok:true }],
    correct:"To'g'ri. 100 + 50 = 150 bo‘lishi kerak, 200 emas.", wrong:'Har birini qayta qo‘shing: 100 + 50 aynan nechchi bo‘ladi?', rule:'100 + 50 = 150 (200 emas).' },
  ru: { eyebrow:'Найди ошибку', setup:'Посчитаны четыре суммы денег, одна неверна.', ask:'Какая сумма посчитана НЕВЕРНО?',
    rows:[{ txt:'100 + 100 = 200', ok:true }, { txt:'200 + 50 = 250', ok:true }, { txt:'100 + 50 = 200', ok:false }, { txt:'500 + 100 = 600', ok:true }],
    correct:'Верно. 100 + 50 = 150, а не 200.', wrong:'Пересчитай каждую: сколько именно 100 + 50?', rule:'100 + 50 = 150 (не 200).' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_35_07(props) {
  return (
    <React.Fragment>
