// Dars 35 · Amaliyot 05 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 05 · BuildNum · 100+200 ===== */
const D05 = makeBuildNum({ tag:'sum300', level:'🟡', answer:300, cells:3, digits:['3','0','2','1'] });
D05.T = {
  uz: { eyebrow:'Qo‘shish', setup:'Anvarda 100 so‘m va 200 so‘m bor.', ask:'100 so‘m va 200 so‘mni qo‘shsak, qancha bo‘ladi? Javobni raqamlardan yasang.', correct:"To'g'ri. 100 + 200 = 300 so‘m.", wrong:'Yuzliklarni qo‘shing: 1 yuz va 2 yuz — nechta yuz bo‘ladi?', rule:'100 + 200 = 300 so‘m.' },
  ru: { eyebrow:'Сложение', setup:'У Анвара 100 сумов и 200 сумов.', ask:'Сколько будет 100 сумов плюс 200 сумов? Составь ответ из цифр.', correct:'Верно. 100 + 200 = 300 сумов.', wrong:'Сложи сотни: 1 сотня и 2 сотни — сколько сотен?', rule:'100 + 200 = 300 сумов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_35_05(props) {
  return (
    <React.Fragment>
