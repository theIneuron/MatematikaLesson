// Dars 35 · Amaliyot 01 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 01 · MC · 50+50 ===== */
const D01 = makeMC({ tag:'sum50', level:'🟢', correctIdx:0, half:true, fs:20 });
D01.T = {
  uz: { eyebrow:'Pul', setup:"Ra'no ikkita 50 so'mlik tanga oldi.", ask:'50 so‘m va yana 50 so‘m — jami qancha bo‘ladi?', opts:['100 so‘m','500 so‘m','55 so‘m','150 so‘m'],
    correct:"To'g'ri. 50 + 50 = 100 so‘m.", wrong:'Ikkita 50 so‘mlikni qo‘shing: 50 + 50 nechchi bo‘ladi?', rule:'50 + 50 = 100 so‘m.' },
  ru: { eyebrow:'Деньги', setup:'Рано взяла две монеты по 50 сумов.', ask:'50 сумов и ещё 50 сумов — сколько вместе?', opts:['100 сумов','500 сумов','55 сумов','150 сумов'],
    correct:'Верно. 50 + 50 = 100 сумов.', wrong:'Сложи две монеты по 50: сколько 50 + 50?', rule:'50 + 50 = 100 сумов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_35_01(props) {
  return (
    <React.Fragment>
