// Dars 35 · Amaliyot 06 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 06 · MC · 500 = 5×100 ===== */
const D06 = makeMC({ tag:'equal500', level:'🟡', correctIdx:0, half:true, fs:22 });
D06.T = {
  uz: { eyebrow:'Teng qiymat', setup:'Katta tangani mayda tangalar bilan almashtirish mumkin.', ask:'500 so‘m nechta 100 so‘mlik tangaga teng?', opts:['5','50','2','10'],
    correct:"To'g'ri. 5 ta 100 so‘mlik = 500 so‘m.", wrong:'100 dan nechta olsak 500 bo‘ladi? 100, 200, 300, … sanang.', rule:'500 so‘m = 5 × 100 so‘m.' },
  ru: { eyebrow:'Равная стоимость', setup:'Крупную монету можно разменять мелкими.', ask:'Скольким монетам по 100 сумов равны 500 сумов?', opts:['5','50','2','10'],
    correct:'Верно. 5 монет по 100 = 500 сумов.', wrong:'Сколько раз по 100 будет 500? Считай: 100, 200, 300, …', rule:'500 сумов = 5 × 100 сумов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_35_06(props) {
  return (
    <React.Fragment>
