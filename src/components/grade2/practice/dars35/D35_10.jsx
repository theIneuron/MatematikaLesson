// Dars 35 · Amaliyot 10 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 10 · IMZO CoinTray · 700 ===== */
const D10 = makeCoinTray({ tag:'tray700', level:'🔴', target:700, coins:[100,200,500] });
D10.T = {
  uz: { eyebrow:'Tanga-savat', setup:"Jasur 700 so'mlik o‘yinchoq olmoqchi.", ask:'Aynan 700 so‘m yig‘ing (masalan 500 + 200).', empty:'Tangalarni bu yerga soling', som:"so'm", correct:"To'g'ri. 700 so‘m yig‘ildi (500 + 200).", wrong:'Yig‘indi aynan 700 bo‘lsin: eng yirik tangadan boshlang (500), so‘ng qo‘shing.', rule:'700 = 500 + 200 (yoki 500 + 100 + 100).' },
  ru: { eyebrow:'Копилка монет', setup:'Джасур хочет купить игрушку за 700 сумов.', ask:'Собери ровно 700 сумов (например 500 + 200).', empty:'Клади монеты сюда', som:'сум', correct:'Верно. Собрано 700 сумов (500 + 200).', wrong:'Сумма ровно 700: начни с самой крупной (500), потом добавь.', rule:'700 = 500 + 200 (или 500 + 100 + 100).' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_35_10(props) {
  return (
    <React.Fragment>
