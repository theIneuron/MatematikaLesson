// Dars 35 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · MC · qaytim ===== */
const D08 = makeMC({ tag:'change', level:'🔴', correctIdx:0, half:true, fs:20 });
D08.T = {
  uz: { eyebrow:'Qaytim', setup:'Anvarda 500 so‘m bor edi. U 300 so‘mlik ruchka sotib oldi.', ask:'Sotuvchi Anvarga qancha qaytim beradi? (500 dan 300 ni ayiring)', opts:['200 so‘m','800 so‘m','300 so‘m','100 so‘m'],
    correct:"To'g'ri. 500 − 300 = 200 so‘m qaytim.", wrong:'Bergan pulidan (500) narx (300) ni ayiring: qancha qaytadi?', rule:'Qaytim = 500 − 300 = 200 so‘m.' },
  ru: { eyebrow:'Сдача', setup:'У Анвара было 500 сумов. Он купил ручку за 300 сумов.', ask:'Сколько сдачи даст продавец? (вычти из 500 число 300)', opts:['200 сумов','800 сумов','300 сумов','100 сумов'],
    correct:'Верно. 500 − 300 = 200 сумов сдачи.', wrong:'Из отданных денег (500) вычти цену (300): сколько вернётся?', rule:'Сдача = 500 − 300 = 200 сумов.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_35_08(props) {
  return (
    <React.Fragment>
