// Dars 25 · Amaliyot 03 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 03 · TrueFalse · togri ===== */
const D03 = makeTrueFalse({ tag:'tf_togri', level:'🟢', answer:true, stage:lineStage('togri') });
D03.T = {
  uz: { eyebrow:"To'g'ri yoki noto'g'ri", setup:'Bu chiziqning ikkala tomonida ham o‘q bor.', ask:'Ikkala tomoni cheksiz davom etadigan bu chiziq — to‘g‘ri chiziq. Bu fikr to‘g‘rimi?', yes:'To‘g‘ri', no:'Noto‘g‘ri',
    correct:"To'g'ri javob: To‘g‘ri. Ikki tomon cheksiz — bu to‘g‘ri chiziq.", wrong:'Ikkala uchida ham o‘q bor, nuqta yo‘q. Bunday chiziq to‘g‘ri chiziq deyiladi.', rule:'To‘g‘ri chiziq — ikkala tomoni cheksiz (ikki o‘q).' },
  ru: { eyebrow:'Верно или неверно', setup:'У этой линии стрелки с обеих сторон.', ask:'Линия, обе стороны которой бесконечны, — это прямая. Верно ли это?', yes:'Верно', no:'Неверно',
    correct:'Правильно: Верно. Обе стороны бесконечны — это прямая.', wrong:'На обоих концах стрелки, точек нет. Такая линия называется прямой.', rule:'Прямая — обе стороны бесконечны (две стрелки).' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_25_03(props) {
  return (
    <React.Fragment>
