// Dars 25 · Amaliyot 08 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 08 · Match · ta'rif ↔ nom ===== */
const D08 = makeMatch({ tag:'def_match', level:'🔴' });
D08.T = {
  uz: { eyebrow:'Ta‘rifni ulash', setup:'Har bir ta‘rifni to‘g‘ri chiziq nomiga ulang.', ask:'Chapdagi ta‘rifni bosing, so‘ng o‘ngdan mos nomni tanlang:',
    left:[{ label:'Ikki uchi nuqta', match:2 }, { label:'Bir uchi nuqta, bir o‘q', match:0 }, { label:'Ikki tomoni o‘q', match:1 }],
    right:['Nur',"To'g'ri chiziq",'Kesma'],
    correct:"To'g'ri. Ikki nuqta — kesma; bir nuqta+o‘q — nur; ikki o‘q — to‘g‘ri chiziq.", wrong:'Uchlardagi belgilarga qarang: nuqta chegara, o‘q cheksizlik.', rule:'2 nuqta=kesma · 1 nuqta+o‘q=nur · 2 o‘q=to‘g‘ri chiziq.' },
  ru: { eyebrow:'Соедини определение', setup:'Соедини каждое определение с названием линии.', ask:'Нажми определение слева, затем выбери название справа:',
    left:[{ label:'Две точки на концах', match:2 }, { label:'Точка и стрелка', match:0 }, { label:'Две стрелки', match:1 }],
    right:['Луч','Прямая','Отрезок'],
    correct:'Верно. Две точки — отрезок; точка+стрелка — луч; две стрелки — прямая.', wrong:'Смотри на концы: точка — граница, стрелка — бесконечность.', rule:'2 точки=отрезок · точка+стрелка=луч · 2 стрелки=прямая.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_25_08(props) {
  return (
    <React.Fragment>
