// Dars 25 · Amaliyot 02 — mustaqil topshiriq fayli (monolitdan bo'lindi).
...
/* ===== 02 · MC · nur id ===== */
const D02 = makeMC({ tag:'id_nur', level:'🟢', correctIdx:1, half:true, fs:16, mono:false, stage:lineStage('nur') });
D02.T = {
  uz: { eyebrow:'Chiziq turi', setup:'Bu chiziqning bir uchi nuqtadan boshlanadi, ikkinchi tomoni esa o‘q bilan cheksiz davom etadi.', ask:'Bir uchi nuqta, ikkinchi tomoni cheksiz — bu qanday chiziq?', opts:['Kesma','Nur',"To'g'ri chiziq",'Doira'],
    correct:"To'g'ri. Bir uchi nuqta, bir tomoni cheksiz — bu nur.", wrong:'Bir tomonida nuqta, ikkinchi tomonida o‘q (cheksiz). Bu qaysi chiziq?', rule:'Nur — bir uchi nuqta, bir tomoni cheksiz.' },
  ru: { eyebrow:'Тип линии', setup:'Эта линия начинается в точке, а другой стороной бесконечно идёт со стрелкой.', ask:'Один конец — точка, другая сторона бесконечна. Какая это линия?', opts:['Отрезок','Луч','Прямая','Круг'],
    correct:'Верно. Одна точка, одна бесконечная сторона — это луч.', wrong:'С одной стороны точка, с другой стрелка (бесконечность). Какая линия?', rule:'Луч — один конец точка, одна сторона бесконечна.' },
};
...
const __FX_CSS = `
      ...
      `;
export default function Task_25_02(props) {
  return (
    <React.Fragment>
