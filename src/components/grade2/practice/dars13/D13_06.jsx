// Dars 13 · Amaliyot 06 — mustaqil jsx-question (per-task split).
...
/* ===== 06 · match_conv · match · matchconv ===== */
const D06 = makeMatch({ tag:'matchconv', level:'🟡' });

D06.T = {
  uz: { eyebrow:'Juftlab ulash', setup:"Har ko'paytirishni mos qo'shishga ulang.", ask:"Chapdagini bosing, so'ng o'ngdan mosini tanlang:",
    left:[{ label:'2 × 3', match:1 }, { label:'4 × 2', match:0 }, { label:'3 × 5', match:2 }],
    right:['2 + 2 + 2 + 2','3 + 3','5 + 5 + 5'],
    correct:"To'g'ri. 2 × 3 = 3 + 3; 4 × 2 = 2 + 2 + 2 + 2; 3 × 5 = 5 + 5 + 5.", wrong:"Necha marta olinsa — shuncha son qo'shiladi. 2 × 3 — 3 ni ikki marta.", rule:'2 × 3 = 3 + 3, 4 × 2 = 2+2+2+2, 3 × 5 = 5+5+5.' },
  ru: { eyebrow:'Соедини пары', setup:'Соедини каждое умножение с нужным сложением.', ask:'Нажми слева, затем выбери справа:',
    left:[{ label:'2 × 3', match:1 }, { label:'4 × 2', match:0 }, { label:'3 × 5', match:2 }],
    right:['2 + 2 + 2 + 2','3 + 3','5 + 5 + 5'],
    correct:'Верно. 2 × 3 = 3 + 3; 4 × 2 = 2 + 2 + 2 + 2; 3 × 5 = 5 + 5 + 5.', wrong:'Сколько раз берём — столько раз складываем. 2 × 3 — 3 дважды.', rule:'2 × 3 = 3 + 3, 4 × 2 = 2+2+2+2, 3 × 5 = 5+5+5.' },
};
...
D13_06.audio = {
  uz: { intro: "Har ko'paytirishni mos qo'shishga ulang. Chapdagini bosing, so'ng o'ngdan mosini tanlang.", on_correct: "To'g'ri. 2 ko'paytirish 3 teng 3 qo'shish 3; 4 ko'paytirish 2 teng 2 qo'shish 2 qo'shish 2 qo'shish 2; 3 ko'paytirish 5 teng 5 qo'shish 5 qo'shish 5.", on_wrong: "Necha marta olinsa, shuncha son qo'shiladi. 2 ko'paytirish 3, 3 ni ikki marta." },
  ru: { intro: "Соедини каждое умножение с нужным сложением. Нажми слева, затем выбери справа.", on_correct: "Верно. 2 умножить на 3 равно 3 плюс 3; 4 умножить на 2 равно 2 плюс 2 плюс 2 плюс 2; 3 умножить на 5 равно 5 плюс 5 плюс 5.", on_wrong: "Сколько раз берём, столько раз складываем. 2 умножить на 3, 3 дважды." },
};
