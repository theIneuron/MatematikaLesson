// Dars 13 · Amaliyot 01 — mustaqil jsx-question (per-task split).
...
/* ===== 01 · array_mc · MC · array ===== */
const D01 = makeMC({ tag:'array', level:'🟢', correctIdx:0, half:true, fs:22, stage:jupArr(3,4,(t)=>t.scene) });

D01.T = {
  uz: { eyebrow:'Massiv', setup:"Kema issiqxonasida 3 qatorda 4 tadan ko'chat.", scene:'3 qator × 4 tadan', ask:"Jami nechta ko'chat? (3 marta 4)", opts:['12','7','9','3'],
    correct:"To'g'ri. 3 marta 4 = 3 × 4 = 12. Teng qatorlarni qo'shdik.", wrong:"Qo'shmang, ko'paytiring: 4 + 4 + 4 — nechta bo'ladi? Har qatorda 4 tadan.", rule:"Teng qatorlar yig'indisi — ko'paytirish: 3 × 4 = 12." },
  ru: { eyebrow:'Массив', setup:'В теплице корабля 3 ряда по 4 ростка.', scene:'3 ряда × по 4', ask:'Сколько всего ростков? (3 раза по 4)', opts:['12','7','9','3'],
    correct:'Верно. 3 раза по 4 = 3 × 4 = 12. Сложили равные ряды.', wrong:'Не складывай, а умножай: 4 + 4 + 4 — сколько? В каждом ряду по 4.', rule:'Сумма равных рядов — умножение: 3 × 4 = 12.' },
};
