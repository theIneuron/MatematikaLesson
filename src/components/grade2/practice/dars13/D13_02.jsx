// Dars 13 · Amaliyot 02 — mustaqil jsx-question (per-task split).
...
/* ===== 02 · add2mult · MC · add2mult ===== */
const D02 = makeMC({ tag:'add2mult', level:'🟢', correctIdx:0, half:true, fs:20,
  stage:(t)=>(<div style={{ textAlign:'center', ...S.mono, fontSize:34, fontWeight:800, color:C.gold }}>4 + 4 + 4</div>) });

D02.T = {
  uz: { eyebrow:"Ko'paytirish yozuvi", setup:"4 uch marta qo'shilyapti.", ask:"4 + 4 + 4 ni ko'paytirish bilan qanday yozamiz?", opts:['3 × 4','4 + 3','3 + 4','4 × 4'],
    correct:"To'g'ri. 4 uch marta olindi: 3 × 4. Necha qator, shuncha marta.", wrong:"4 nechchi marta qo'shildi? Shuncha marta 4 — ko'paytma.", rule:'4 + 4 + 4 = 3 marta 4 = 3 × 4.' },
  ru: { eyebrow:'Запись умножения', setup:'4 складывается три раза.', ask:'Как записать 4 + 4 + 4 умножением?', opts:['3 × 4','4 + 3','3 + 4','4 × 4'],
    correct:'Верно. 4 взяли три раза: 3 × 4.', wrong:'Сколько раз сложили 4? Столько раз по 4 — умножение.', rule:'4 + 4 + 4 = 3 раза по 4 = 3 × 4.' },
};
