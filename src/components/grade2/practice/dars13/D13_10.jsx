// Dars 13 · Amaliyot 10 — mustaqil jsx-question (per-task split).
...
/* ===== 10 · pickexpr · MC · pickexpr ===== */
const D10 = makeMC({ tag:'pickexpr', level:'🔴', correctIdx:0, half:true, fs:20, stage:jupArr(4,3,(t)=>t.scene) });

D10.T = {
  uz: { eyebrow:'Mos ifoda', setup:"Massivda 4 qator, har birida 3 tadan ko'chat.", scene:'4 qator × 3 tadan', ask:"Qaysi ifoda JAMI ni to'g'ri beradi?", opts:['4 × 3','4 + 3','3 − 4','4 × 4'],
    correct:"To'g'ri. 4 × 3 = 12. To'rt qator, har birida 3 tadan.", wrong:"Necha qator? Har qatorda nechta? Qator sonini bittadagi songa ko'paytiring.", rule:'4 qator × 3 tadan = 4 × 3 = 12.' },
  ru: { eyebrow:'Верное выражение', setup:'В массиве 4 ряда по 3 ростка.', scene:'4 ряда × по 3', ask:'Какое выражение верно даёт ВСЕГО?', opts:['4 × 3','4 + 3','3 − 4','4 × 4'],
    correct:'Верно. 4 × 3 = 12. Четыре ряда по 3.', wrong:'Сколько рядов? Сколько в ряду? Умножь число рядов на число в ряду.', rule:'4 ряда × по 3 = 4 × 3 = 12.' },
};
