// Dars 13 · Amaliyot 08 — mustaqil jsx-question (per-task split).
...
/* ===== 08 · masala (Zuhra) · MC · word ===== */
const D08 = makeMC({ tag:'word', level:'🔴', correctIdx:0, half:true, fs:22, stage:jupArr(3,5,(t)=>t.scene) });

D08.T = {
  uz: { eyebrow:'Masala', setup:"Zuhra 3 qatorga, har biriga 5 tadan ko'chat ekdi.", scene:'Zuhra · 3 qator × 5', ask:"Zuhra jami nechta ko'chat ekdi?", opts:['15','8','20','53'],
    correct:"To'g'ri. 3 × 5 = 15. Uch qator, har birida 5 tadan.", wrong:'Har qatorda 5 tadan, 3 qator. 5 ni uch marta oling.', rule:'3 × 5 = 15.' },
  ru: { eyebrow:'Задача', setup:'Зухра посадила 3 ряда по 5 ростков.', scene:'Зухра · 3 ряда × 5', ask:'Сколько всего ростков посадила Зухра?', opts:['15','8','20','53'],
    correct:'Верно. 3 × 5 = 15. Три ряда по 5.', wrong:'В каждом ряду по 5, рядов 3. Возьми 5 три раза.', rule:'3 × 5 = 15.' },
};
...
D13_08.audio = {
  uz: { intro: "Zuhra 3 qatorga, har biriga 5 tadan ko'chat ekdi. Zuhra jami nechta ko'chat ekdi?", on_correct: "To'g'ri. 3 ko'paytirish 5 teng 15. Uch qator, har birida 5 tadan.", on_wrong: "Har qatorda 5 tadan, 3 qator. 5 ni uch marta oling." },
  ru: { intro: "Зухра посадила 3 ряда по 5 ростков. Сколько всего ростков посадила Зухра?", on_correct: "Верно. 3 умножить на 5 равно 15. Три ряда по 5.", on_wrong: "В каждом ряду по 5, рядов 3. Возьми 5 три раза." },
};
