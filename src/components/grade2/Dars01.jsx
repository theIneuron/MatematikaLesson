...
const CONTENT = {
  ...
  s4: {
    ...
    info: { ru: 'Десятки — слева, единицы — справа.', uz: "O'nliklar — chapda, birliklar — o'ngda." },
  ...
  s6: {
    ...
    info_badge: { ru: 'Полезно', uz: 'Foydali' },
    info: { ru: 'Правее — больше. Прыжок — десять, шаг — один.', uz: "O'ngda — kattaroq. Sakrash — o'n, qadam — bir." },
    audio: {
      ru: [
