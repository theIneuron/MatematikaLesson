...
const LESSON_META = {
  ...
  lessonTitle: { ru: 'Урок 27. Многоугольники', uz: "27-dars. Ko'pburchaklar" }
};
...
const CONTENT = {
  ...
  s0: {
    ...
    q: { ru: 'Экипаж соединил три прямые палочки — вышла замкнутая фигура: три стороны и три угла. Как называется такая фигура?', uz: "Ekipaj uchta to'g'ri tayoqchani uladi — yopiq shakl chiqdi: uchta tomon va uchta burchak. Bunday shakl qanday ataladi?" },
  ...
  sTBL: {
    ...
    audio: {
      ...
      uz: [
        "Kalitni yodla: shakl nomi — tomonlar soniga qarab.",
