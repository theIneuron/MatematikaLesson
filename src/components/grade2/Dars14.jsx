...
// 2-SINF · syujet-qobiq v3: YUPITER orbitasi, KEMA ISSIQXONASI. Program d.16 (SYUJET_2SINF.md Б3).
// Baza: Dars13.jsx (issiqxona sahnasi + geo/plant ArrayViz + jadval-yordamchi infra meros).
...
// DUNYO: Yupiter orbitasi, KEMA ISSIQXONASI — teng 2/3-lik guruhlarда hosil. Yupiter panorama oynadan.
...
const CONTENT = {
  // s0 — HOOK (scope: hook): 4 qator × 2 ko'chat = 8 (distraktor 6 = 4+2)
  s0: {
    eyebrow: { ru: 'Миссия', uz: 'Missiya' },
    topic: { ru: 'Тема: Таблица на 2 и 3', uz: "Mavzu: 2 va 3 ga ko'paytirish" },
    lead: { ru: 'Сколько всего ростков?', uz: "Jami qancha ko'chat?" },
    q: { ru: '4 ряда по 2 ростка. Сколько всего?', uz: "4 qatorda 2 tadan ko'chat. Jami nechta?" },
    opt0: { ru: '6', uz: '6' },     // distraktor = 4+2 (ko'paytirish o'rniga qo'shish)
    opt1: { ru: '8', uz: '8' },     // to'g'ri (idx1 = correct-key)
    opt2: { ru: 'Не знаю', uz: 'Bilmayman' },
    audio: {
      intro: {
        ru: [
          'Сегодня будем умножать на два и на три. Корабль Бита на орбите Юпитера, в теплице растёт урожай.',
          'В теплице четыре ряда, в каждом по два ростка. Ряды по два — считаем на два.',
          'Сколько всего ростков? Считать по одному долго. Есть быстрый способ.',
          'Послушай два ответа. Первый — шесть. Второй — восемь. Или ты пока не знаешь. Выбери свой ответ.'
        ],
        uz: [
          "Bugun ikkiga va uchga ko'paytiramiz. Bitning kemasi Yupiter orbitasida, issiqxonada hosil o'sadi.",
          "Issiqxonada to'rtta qator, har birida ikkitadan ko'chat. Ikkitadan qatorlar — ikkiga sanaymiz.",
          "Jami nechta ko'chat? Bittalab sanash uzoq. Tez yo'li bor.",
          "Ikki javobni tinglang. Birinchi — olti. Ikkinchi — sakkiz. Yoki hali bilmaysiz. O'z javobingizni tanlang."
        ]
      },
      on_correct: { ru: 'Верно. Четыре ряда по два. Два, четыре, шесть, восемь. Это четыре раза по два — восемь.', uz: "To'g'ri. To'rtta qator, ikkitadan. Ikki, to'rt, olti, sakkiz. Bu to'rt marta ikki — sakkiz." },
      on_wrong: { ru: 'Тут ряды по два. Их считают на два: два, четыре, шесть, восемь. Сейчас научимся.', uz: "Bu yerda ikkitadan qatorlar. Ularni ikkiga sanaymiz: ikki, to'rt, olti, sakkiz. Hozir o'rganamiz." },
  ...
  s2: {
    eyebrow: { ru: 'Считаем на 2', uz: 'Ikkiga sanaymiz' },
    lead: { ru: '4 ряда по 2 ростка.', uz: "4 qatorda 2 tadan ko'chat." },
    info_badge: { ru: 'Главное', uz: 'Asosiy' },
  ...
  s3: {
    ...
    rule: { ru: 'Умножить на 2 — считать по два. Прибавляем по 2: 2, 4, 6, 8, 10, 12, 14, 16, 18. Сколько раз взяли по 2 — столько умножаем на 2.', uz: "2 ga ko'paytirish — ikkitadan sanash. 2 tadan qo'shamiz: 2, 4, 6, 8, 10, 12, 14, 16, 18. Necha marta 2 olsak — shuncha 2 ga ko'paytiramiz." },
    check_q: { ru: '3 ряда по 2. Сколько всего?', uz: "3 qatorda 2 tadan. Jami nechta?" },
    opts: [{ ru: '6', uz: '6', ok: true }, { ru: '5', uz: '5' }, { ru: '4', uz: '4' }],
    wrong: { ru: 'Считай на два: два, четыре, шесть.', uz: "Ikkiga sana: ikki, to'rt, olti." },
  ...
  s4: {
    ...
    opts: [{ ru: '6', uz: '6', ok: true }, { ru: '5', uz: '5' }, { ru: '4', uz: '4' }],
    wrong: { ru: 'Считай на три: три, шесть.', uz: "Uchga sana: uch, olti." },
  ...
  s5: {
    ...
    lead: { ru: 'Сосчитай на 2.', uz: "Ikkiga sanab top." },
    ...
    r: 4, c: 2,
    wrong: { ru: 'Считай на два: два, четыре, шесть, восемь.', uz: "Ikkiga sana: ikki, to'rt, olti, sakkiz." },
    ...
    audio: {
      ...
      on_wrong: { ru: 'Считай на два: два, четыре, шесть, восемь.', uz: "Ikkiga sana: ikki, to'rt, olti, sakkiz." }
    }
  },
  ...
  s6: {
    ...
    by: 2, blank: 4,
    wrong: { ru: 'К прошлой клетке прибавь 2.', uz: "Avvalgi katakka 2 qo'sh." },
    ...
    audio: {
      ...
      on_wrong: { ru: 'Прибавь к прошлой клетке два.', uz: "Avvalgi katakka ikki qo'sh." }
    }
  },

  // s7 — MASHQ (ARRAY ×3, 3 round)
  s7: {
    eyebrow: { ru: 'Практика', uz: 'Mashq' },
    lead: { ru: 'Сосчитай на 3.', uz: "Uchga sanab top." },
    rounds: [ { r: 2, c: 3 }, { r: 4, c: 3 }, { r: 3, c: 3 } ],
    wrong: { ru: 'Считай на три: три, шесть, девять.', uz: "Uchga sana: uch, olti, to'qqiz." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Тренировка на три. Считай по три: три, шесть, девять.', uz: "Uchga mashq. Uchtadan sana: uch, olti, to'qqiz." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Считай на три.', uz: "Uchga sana." }
    }
  },

  // s8 — MASHQ (TABLE-FILL ×2, 3 round)
  s8: {
    eyebrow: { ru: 'Заполни таблицу', uz: "Jadvalni to'ldir" },
    lead: { ru: 'Заполни пустую клетку.', uz: "Bo'sh katakni to'ldiring." },
    rounds: [ { by: 2, blank: 3 }, { by: 2, blank: 5 }, { by: 2, blank: 2 } ],
    wrong: { ru: 'К прошлой клетке прибавь 2.', uz: "Avvalgi katakka 2 qo'sh." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Заполняй таблицу на два. Каждая клетка на два больше прошлой.', uz: "Ikkiga jadvalni to'ldir. Har katak avvalgidan ikki ko'p." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Прибавь к прошлой клетке два.', uz: "Avvalgi katakka ikki qo'sh." }
    }
  },
  ...
  s9: {
    eyebrow: { ru: 'Практика', uz: 'Mashq' },
    lead: { ru: 'Сосчитай на 2 или на 3.', uz: "2 yoki 3 ga sanab top." },
    rounds: [ { r: 5, c: 2 }, { r: 2, c: 3 }, { r: 6, c: 2 } ],
    wrong: { ru: 'Смотри, по сколько в ряду: по два или по три.', uz: "Qatorda nechtadan qara: ikkitadan yoki uchtadan." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Ряды разные: где по два, где по три. Считай верно.', uz: "Qatorlar har xil: qayerda ikkitadan, qayerda uchtadan. To'g'ri sana." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Смотри, по сколько в ряду.', uz: "Qatorda nechtadan qara." }
    }
  },

  // s10 — MASHQ (TABLE-FILL ×3, 3 round)
  s10: {
    eyebrow: { ru: 'Заполни таблицу', uz: "Jadvalni to'ldir" },
    lead: { ru: 'Заполни пустую клетку.', uz: "Bo'sh katakni to'ldiring." },
    rounds: [ { by: 3, blank: 2 }, { by: 3, blank: 4 }, { by: 3, blank: 3 } ],
    wrong: { ru: 'К прошлой клетке прибавь 3.', uz: "Avvalgi katakka 3 qo'sh." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Теперь таблица на три. Каждая клетка на три больше прошлой.', uz: "Endi uchga jadval. Har katak avvalgidan uch ko'p." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Прибавь к прошлой клетке три.', uz: "Avvalgi katakka uch qo'sh." }
    }
  },
  ...
  s11: {
    eyebrow: { ru: 'Практика', uz: 'Mashq' },
    lead: { ru: 'Сосчитай на 2 или на 3.', uz: "2 yoki 3 ga sanab top." },
    rounds: [ { r: 3, c: 2 }, { r: 5, c: 3 }, { r: 4, c: 2 } ],
    wrong: { ru: 'Смотри, по сколько в ряду: по два или по три.', uz: "Qatorda nechtadan qara: ikkitadan yoki uchtadan." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Последняя тренировка перед задачей. Считай на два и на три.', uz: "Masaladan oldingi oxirgi mashq. Ikki va uchga sanang." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Смотри, по сколько в ряду.', uz: "Qatorda nechtadan qara." }
    }
  },
  ...
  s13: {
    ...
    story: { ru: 'Зухра посадила ростки: 4 ряда, в каждом по 3. Сколько всего ростков?', uz: "Zuhra ko'chat ekdi: 4 qator, har birida 3 tadan. Jami nechta ko'chat?" },
    r: 4, c: 3,
    wrong: { ru: 'Считай на три: три, шесть, девять, двенадцать.', uz: "Uchga sana: uch, olti, to'qqiz, o'n ikki." },
    done_text: { ru: 'Верно! 4 раза по 3 это 12.', uz: "To'g'ri! 4 marta 3 — 12." },
    audio: {
      intro: { ru: 'Помоги Зухре. Она посадила четыре ряда, в каждом по три ростка. Сколько всего? Сосчитай на три.', uz: "Zuhraga yordam bering. U to'rtta qator ekdi, har birida uchtadan ko'chat. Jami nechta? Uchga sanang." },
      on_correct: { ru: 'Верно. У Зухры двенадцать ростков.', uz: "To'g'ri. Zuhrada o'n ikki ko'chat." },
      on_wrong: { ru: 'Считай на три: три, шесть, девять, двенадцать.', uz: "Uchga sana: uch, olti, to'qqiz, o'n ikki." }
    }
  },
  ...
  s14: {
    ...
    rounds: [ { r: 3, c: 3 }, { r: 6, c: 2 }, { r: 4, c: 3 } ],
    wrong: { ru: 'Считай на 2 или на 3.', uz: "2 yoki 3 ga sana." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    ...
    audio: {
      intro: { ru: 'Финальная проверка. Где по два, где по три — считай верно.', uz: "Yakuniy tekshiruv. Qayerda ikkitadan, qayerda uchtadan — to'g'ri sanang." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Смотри, по сколько в ряду.', uz: "Qatorda nechtadan qara." }
    }
  },
  ...
  s15: {
    ...
    audio: {
      ru: 'Миссия выполнена. На орбите Юпитера мы научились умножать на два и на три. Запомни. На два считаем по два: два, четыре, шесть, восемь. На три — по три: три, шесть, девять, двенадцать. Урожай в теплице сосчитан. В следующий раз выучим таблицу на четыре и на пять.',
      uz: "Missiya bajarildi. Yupiter orbitasida ikkiga va uchga ko'paytirishni o'rgandik. Yodda tuting. Ikkiga ikkitadan sanaymiz: ikki, to'rt, olti, sakkiz. Uchga uchtadan: uch, olti, to'qqiz, o'n ikki. Issiqxonadagi hosil sanaldi. Keyingi safar to'rtga va beshga ko'paytirish jadvalini o'rganamiz."
    }
  }
};
...
const BRIDGES = {
  ...
  s7:  { ru: 'Переходим к тройкам.', uz: "Uchliklarga o'tamiz." },
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 2.2vw, 16px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ padding: 'clamp(8px, 1.8vw, 14px)', overflow: 'hidden' }}>
          <YupiterScene answer={picked !== null ? 8 : null}/>
        </div>
...
const ShipGreenhouse = ({ arrive = false, celebrate = false, bubbleNode, charNode }) => (
  <div className="d2-scene" style={{ background: 'linear-gradient(180deg,#E4E9DF 0%,#D2DACC 52%,#BEC6B6 100%)' }}>
    ...
    {/* PODIUM + markaziy 4×2 (SANALADIGAN, ajratilgan) */}
    <div style={{ position: 'absolute', left: '50%', bottom: '3%', transform: 'translateX(-50%)', zIndex: 5, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(4px,1.2vw,8px)', padding: 'clamp(4px,1vw,7px)', borderRadius: 12, background: 'rgba(255,246,222,0.1)', boxShadow: '0 0 0 2px rgba(255,214,120,0.5), 0 6px 16px rgba(0,0,0,0.3)' }}>
        {[0, 1, 2, 3].map((ri) => <PlanterRow key={ri} n={2} celebrate={celebrate} ri={ri}/>)}
      </div>
      {/* podium plita */}
    ...
    <ShipGreenhouse celebrate
      bubbleNode={(
        <div style={{ position: 'absolute', left: '16%', top: '30%', transform: 'translateX(-50%)', zIndex: 7, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
          ...
          <div className="g1-pop-in" style={{ display: 'flex', alignItems: 'center', gap: 7, minWidth: 'clamp(52px,11vw,72px)', height: 'clamp(38px,7.4vw,50px)', padding: '0 clamp(10px,2vw,15px)', justifyContent: 'center', borderRadius: 12, fontFamily: "'JetBrains Mono', monospace", fontWeight: 800, fontSize: 'clamp(22px,4.6vw,30px)', background: T.successSoft, color: T.success, border: `2.5px solid ${T.success}`, boxShadow: '0 4px 14px -4px rgba(31,122,77,0.5)' }}>
            8<span style={{ fontSize: 'clamp(17px,3.4vw,23px)' }}>✓</span>
          </div>
        </div>
      )}
      charNode={(
