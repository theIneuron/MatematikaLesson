...
// 2-SINF · syujet-qobiq v3: YUPITER orbitasi, KEMA ISSIQXONASI. Program d.17 (SYUJET_2SINF.md Б3).
// Baza: Dars14.jsx (×2/×3 jadvali — issiqxona sahnasi + geo/plant ArrayViz + TableFill + jadval-yordamchi).
...
// DUNYO: Yupiter orbitasi, KEMA ISSIQXONASI — teng 4/5-lik guruhlarда hosil. Yupiter panorama oynadan.
...
const CONTENT = {
  // s0 — HOOK (scope: hook): 4 qator × 4 ko'chat = 16 (distraktor 8 = 4+4)
  s0: {
    eyebrow: { ru: 'Миссия', uz: 'Missiya' },
    topic: { ru: 'Тема: Таблица на 4 и 5', uz: "Mavzu: 4 va 5 ga ko'paytirish" },
    lead: { ru: 'Сколько всего ростков?', uz: "Jami qancha ko'chat?" },
    q: { ru: '4 ряда по 4 ростка. Сколько всего?', uz: "4 qatorda 4 tadan ko'chat. Jami nechta?" },
    ...
    audio: {
      intro: {
        ru: [
          'Сегодня будем умножать на четыре и на пять. Корабль Бита на орбите Юпитера, в теплице растёт урожай.',
          'В теплице четыре ряда, в каждом по четыре ростка. Ряды по четыре — считаем на четыре.',
        ...
        uz: [
          "Bugun to'rtga va beshga ko'paytiramiz. Bitning kemasi Yupiter orbitasida, issiqxonada hosil o'sadi.",
          "Issiqxonada to'rtta qator, har birida to'rttadan ko'chat. To'rttadan qatorlar — to'rtga sanaymiz.",
  ...
  s2: {
    eyebrow: { ru: 'Считаем на 4', uz: 'To\'rtga sanaymiz' },
    lead: { ru: '4 ряда по 4 ростка.', uz: "4 qatorda 4 tadan ko'chat." },
    info_badge: { ru: 'Главное', uz: 'Asosiy' },
    info: { ru: '4 ряда по 4: 4, 8, 12, 16. Это 4 × 4 = 16.', uz: "4 qator, 4 tadan: 4, 8, 12, 16. Bu 4 × 4 = 16." },
    audio: {
      ru: [
  ...
  s3: {
    ...
    rule: { ru: 'Умножить на 4 — считать по четыре. Прибавляем по 4: 4, 8, 12, 16, 20, 24. Сколько раз взяли по 4 — столько умножаем на 4.', uz: "4 ga ko'paytirish — to'rttadan sanash. 4 tadan qo'shamiz: 4, 8, 12, 16, 20, 24. Necha marta 4 olsak — shuncha 4 ga ko'paytiramiz." },
    check_q: { ru: '3 ряда по 4. Сколько всего?', uz: "3 qatorda 4 tadan. Jami nechta?" },
    opts: [{ ru: '12', uz: '12', ok: true }, { ru: '10', uz: '10' }, { ru: '8', uz: '8' }],
    wrong: { ru: 'Считай на четыре: четыре, восемь, двенадцать.', uz: "To'rtga sana: to'rt, sakkiz, o'n ikki." },
  ...
  s4: {
    ...
    wrong: { ru: 'Считай на пять: пять, десять.', uz: "Beshga sana: besh, o'n." },
  ...
  s5: {
    ...
    lead: { ru: 'Сосчитай на 4.', uz: "To'rtga sanab top." },
    ...
    r: 4, c: 4,
    wrong: { ru: 'Считай на четыре: четыре, восемь, двенадцать, шестнадцать.', uz: "To'rtga sana: to'rt, sakkiz, o'n ikki, o'n olti." },
    ...
    audio: {
      ...
      on_wrong: { ru: 'Считай на четыре: четыре, восемь, двенадцать, шестнадцать.', uz: "To'rtga sana: to'rt, sakkiz, o'n ikki, o'n olti." }
    }
  },
  ...
  s6: {
    ...
    by: 4, blank: 4,
    wrong: { ru: 'К прошлой клетке прибавь 4.', uz: "Avvalgi katakka 4 qo'sh." },
    ...
    audio: {
      ...
      on_wrong: { ru: 'Прибавь к прошлой клетке четыре.', uz: "Avvalgi katakka to'rt qo'sh." }
    }
  },

  // s7 — MASHQ (ARRAY ×5, 3 round)
  s7: {
    eyebrow: { ru: 'Практика', uz: 'Mashq' },
    lead: { ru: 'Сосчитай на 5.', uz: "Beshga sanab top." },
    rounds: [ { r: 2, c: 5 }, { r: 4, c: 5 }, { r: 3, c: 5 } ],
    wrong: { ru: 'Считай на пять: пять, десять, пятнадцать.', uz: "Beshga sana: besh, o'n, o'n besh." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Тренировка на пять. Считай по пять: пять, десять, пятнадцать.', uz: "Beshga mashq. Beshtadan sana: besh, o'n, o'n besh." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Считай на пять. В конце ноль или пять.', uz: "Beshga sana. Oxiri nol yoki besh." }
    }
  },

  // s8 — MASHQ (TABLE-FILL ×4, 3 round)
  s8: {
    eyebrow: { ru: 'Заполни таблицу', uz: "Jadvalni to'ldir" },
    lead: { ru: 'Заполни пустую клетку.', uz: "Bo'sh katakni to'ldiring." },
    rounds: [ { by: 4, blank: 3 }, { by: 4, blank: 5 }, { by: 4, blank: 2 } ],
    wrong: { ru: 'К прошлой клетке прибавь 4.', uz: "Avvalgi katakka 4 qo'sh." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Заполняй таблицу на четыре. Каждая клетка на четыре больше прошлой.', uz: "To'rtga jadvalni to'ldir. Har katak avvalgidan to'rt ko'p." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Прибавь к прошлой клетке четыре.', uz: "Avvalgi katakka to'rt qo'sh." }
    }
  },
  ...
  s9: {
    eyebrow: { ru: 'Практика', uz: 'Mashq' },
    lead: { ru: 'Сосчитай на 4 или на 5.', uz: "4 yoki 5 ga sanab top." },
    rounds: [ { r: 5, c: 4 }, { r: 2, c: 5 }, { r: 6, c: 4 } ],
    wrong: { ru: 'Смотри, по сколько в ряду: по четыре или по пять.', uz: "Qatorda nechtadan qara: to'rttadan yoki beshtadan." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Ряды разные: где по четыре, где по пять. Считай верно.', uz: "Qatorlar har xil: qayerda to'rttadan, qayerda beshtadan. To'g'ri sana." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Смотри, по сколько в ряду.', uz: "Qatorda nechtadan qara." }
    }
  },

  // s10 — MASHQ (TABLE-FILL ×5, 3 round)
  s10: {
    eyebrow: { ru: 'Заполни таблицу', uz: "Jadvalni to'ldir" },
    lead: { ru: 'Заполни пустую клетку.', uz: "Bo'sh katakni to'ldiring." },
    rounds: [ { by: 5, blank: 2 }, { by: 5, blank: 4 }, { by: 5, blank: 3 } ],
    wrong: { ru: 'К прошлой клетке прибавь 5.', uz: "Avvalgi katakka 5 qo'sh." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Теперь таблица на пять. Каждая клетка на пять больше прошлой.', uz: "Endi beshga jadval. Har katak avvalgidan besh ko'p." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Прибавь к прошлой клетке пять.', uz: "Avvalgi katakka besh qo'sh." }
    }
  },
  ...
  s11: {
    eyebrow: { ru: 'Практика', uz: 'Mashq' },
    lead: { ru: 'Сосчитай на 4 или на 5.', uz: "4 yoki 5 ga sanab top." },
    rounds: [ { r: 3, c: 4 }, { r: 5, c: 5 }, { r: 4, c: 4 } ],
    wrong: { ru: 'Смотри, по сколько в ряду: по четыре или по пять.', uz: "Qatorda nechtadan qara: to'rttadan yoki beshtadan." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Последняя тренировка перед задачей. Считай на четыре и на пять.', uz: "Masaladan oldingi oxirgi mashq. To'rt va beshga sanang." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Смотри, по сколько в ряду.', uz: "Qatorda nechtadan qara." }
    }
  },
  ...
  s13: {
    ...
    story: { ru: 'Зухра посадила ростки: 4 ряда, в каждом по 5. Сколько всего ростков?', uz: "Zuhra ko'chat ekdi: 4 qator, har birida 5 tadan. Jami nechta ko'chat?" },
    r: 4, c: 5,
    wrong: { ru: 'Считай на пять: пять, десять, пятнадцать, двадцать.', uz: "Beshga sana: besh, o'n, o'n besh, yigirma." },
    done_text: { ru: 'Верно! 4 раза по 5 это 20.', uz: "To'g'ri! 4 marta 5 — 20." },
    audio: {
      intro: { ru: 'Помоги Зухре. Она посадила четыре ряда, в каждом по пять ростков. Сколько всего? Сосчитай на пять.', uz: "Zuhraga yordam bering. U to'rtta qator ekdi, har birida beshtadan ko'chat. Jami nechta? Beshga sanang." },
      on_correct: { ru: 'Верно. У Зухры двадцать ростков.', uz: "To'g'ri. Zuhrada yigirma ko'chat." },
      on_wrong: { ru: 'Считай на пять: пять, десять, пятнадцать, двадцать.', uz: "Beshga sana: besh, o'n, o'n besh, yigirma." }
    }
  },
  ...
  s14: {
    ...
    rounds: [ { r: 3, c: 5 }, { r: 6, c: 4 }, { r: 4, c: 5 } ],
    wrong: { ru: 'Считай на 4 или на 5.', uz: "4 yoki 5 ga sana." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    ...
    audio: {
      intro: { ru: 'Финальная проверка. Где по четыре, где по пять — считай верно.', uz: "Yakuniy tekshiruv. Qayerda to'rttadan, qayerda beshtadan — to'g'ri sanang." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Смотри, по сколько в ряду.', uz: "Qatorda nechtadan qara." }
    }
  },
  ...
  s15: {
    ...
    audio: {
      ru: 'Миссия выполнена. На орбите Юпитера мы научились умножать на четыре и на пять. Запомни. На четыре считаем по четыре: четыре, восемь, двенадцать, шестнадцать. На пять — по пять, и в конце всегда ноль или пять: пять, десять, пятнадцать, двадцать. Урожай в теплице сосчитан. В следующий раз выучим таблицу на шесть и на семь.',
      uz: "Missiya bajarildi. Yupiter orbitasida to'rtga va beshga ko'paytirishni o'rgandik. Yodda tuting. To'rtga to'rttadan sanaymiz: to'rt, sakkiz, o'n ikki, o'n olti. Beshga beshtadan, oxiri doim nol yoki besh: besh, o'n, o'n besh, yigirma. Issiqxonadagi hosil sanaldi. Keyingi safar oltiga va yettiga ko'paytirish jadvalini o'rganamiz."
    }
  }
};
...
const BRIDGES = {
  ...
  s7:  { ru: 'Переходим к пятёркам.', uz: "Beshliklarga o'tamiz." },
...
const ShipGreenhouse = ({ arrive = false, celebrate = false, bubbleNode, charNode }) => (
  <div className="d2-scene" style={{ background: 'linear-gradient(180deg,#E4E9DF 0%,#D2DACC 52%,#BEC6B6 100%)' }}>
    ...
    {/* PODIUM + markaziy 4×4 (SANALADIGAN, ajratilgan) */}
    <div style={{ position: 'absolute', left: '50%', bottom: '3%', transform: 'translateX(-50%)', zIndex: 5, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(4px,1.2vw,8px)', padding: 'clamp(4px,1vw,7px)', borderRadius: 12, background: 'rgba(255,246,222,0.1)', boxShadow: '0 0 0 2px rgba(255,214,120,0.5), 0 6px 16px rgba(0,0,0,0.3)' }}>
        {[0, 1, 2, 3].map((ri) => <PlanterRow key={ri} n={4} celebrate={celebrate} ri={ri}/>)}
      </div>
      {/* podium plita */}
