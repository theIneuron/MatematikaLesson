...
// ============================================================================
// ░░ 2-SINF · Dars15 — "Таблица на 4 и 5" (mul-2-15-v1) · Б3 (YUPITER) · spec: ETALON_2SINF.md §11 ░░
// 2-SINF · syujet-qobiq v3: YUPITER orbitasi, KEMA KOMANDA-KO'PRIGI. Program d.17 (SYUJET_2SINF.md Б3).
// Baza: Dars14.jsx (×2/×3 jadvali — ko'prik sahnasi + panel ArrayViz + TableFill + jadval-yordamchi).
...
// YADRO: ×4 VA ×5 JADVALI — to'rttadan/beshtadan teng guruhlar → SKIP-SANASH (4,8,12,16...; 5,10,15,20...)
//   → ×4 va ×5 jadvali. Sonlar: 1..6 × 4 (≤24), 1..6 × 5 (≤30). ×5 nishoni: oxiri 0 yoki 5.
// DUNYO: Yupiter orbitasi, KEMA KOMANDA-KO'PRIGI — teng 4/5-lik guruhlarда quyosh panellari. Yupiter panorama oynadan.
...
//   (quyosh paneli) + skip-sanash bilan mahsulot; TableFill: skip-sanash qatorining bo'sh katagini to'ldirish.
//   Sanaladigan obyekt hamma joyda = quyosh paneli. Ko'paytirish-jadvali yordamchisi har test slaydidа.
// Misconception'lar: M1 ×4 o'rniga +4 (qo'shish) · M2 skip-sanashда bitta o'tkazib yuborish · M3 ×5 o'rniga ×4.
//
...
const LESSON_META = {
  lessonId: 'grade2-15',
  lessonTitle: { ru: 'Урок 15. Таблица на 4 и 5', uz: "15-dars. 4 va 5 ga ko'paytirish jadvali", en: 'Lesson 15. The 4 and 5 times tables' }
};
// STRUKTURA: s0 hook · s1–s4 tushuntirish (×4, ×5) · sTBL jadval-to'ldirish · s5–s11 mashq (array+table-fill miks) · s13 masala · s14 final · s15 xulosa.
...
const CONTENT = {
  // s0 — HOOK (scope: hook): 4 qator × 4 panel = 16 (distraktor 8 = 4+4)
  s0: {
    eyebrow: { ru: 'Миссия', uz: 'Missiya', en: 'Mission' },
    topic: { ru: 'Тема: Таблица на 4 и 5', uz: "Mavzu: 4 va 5 ga ko'paytirish", en: 'Topic: The 4 and 5 times tables' },
    lead: { ru: 'Сколько всего панелей?', uz: 'Jami qancha panel?', en: 'How many panels are there in all?' },
    q: { ru: '4 ряда по 4 панели. Сколько всего?', uz: '4 qatorda 4 tadan panel. Jami nechta?', en: '4 rows of 4 panels. How many are there in all?' },
    opt0: { ru: '8', uz: '8', en: '8' },     // distraktor = 4+4 (ko'paytirish o'rniga qo'shish)
    opt1: { ru: '16', uz: '16', en: '16' },   // to'g'ri (idx1 = correct-key)
    opt2: { ru: 'Не знаю', uz: 'Bilmayman', en: "I don't know" },
    audio: {
      intro: {
        ru: [
          'Сегодня будем умножать на четыре и на пять. Корабль Бита на орбите Юпитера разворачивает солнечные панели.',
          'Снаружи четыре ряда, в каждом по четыре панели. Ряды по четыре, считаем на четыре.',
          'Сколько всего панелей? Считать по одному долго. Есть быстрый способ.',
          'Послушай два ответа. Первый, восемь. Второй, шестнадцать. Или ты пока не знаешь. Выбери свой ответ.'
        ],
        uz: [
          "Bugun to'rtga va beshga ko'paytiramiz. Bitning kemasi Yupiter orbitasida quyosh panellarini yoyadi.",
          "Tashqarida to'rtta qator, har birida to'rttadan panel. To'rttadan qatorlar, to'rtga sanaymiz.",
          "Jami nechta panel? Bittalab sanash uzoq. Tez yo'li bor.",
          "Ikki javobni tinglang. Birinchi, sakkiz. Ikkinchi, o'n olti. Yoki hali bilmaysiz. O'z javobingizni tanlang."
        ],
        en: ["Today we will multiply by four and by five. Bit's ship is in orbit around Jupiter, unfolding its solar panels.", 'Outside there are four rows with four panels in each. The rows have four in them, so we count in fours.', 'How many panels are there in all? Counting one by one takes long. There is a fast way.', 'Listen to two answers. First, eight. Second, sixteen. Or maybe you do not know yet. Choose your answer.']
      },
      on_correct: { ru: 'Верно. Четыре ряда по четыре. Четыре, восемь, двенадцать, шестнадцать. Это четыре раза по четыре, шестнадцать.', uz: "To'g'ri. To'rtta qator, to'rttadan. To'rt, sakkiz, o'n ikki, o'n olti. Bu to'rt marta to'rt, o'n olti.", en: 'That is right. Four rows of four. Four, eight, twelve, sixteen. That is four times four, sixteen.' },
      on_wrong: { ru: 'Тут ряды по четыре. Их считают на четыре: четыре, восемь, двенадцать, шестнадцать. Сейчас научимся.', uz: "Bu yerda to'rttadan qatorlar. Ularni to'rtga sanaymiz: to'rt, sakkiz, o'n ikki, o'n olti. Hozir o'rganamiz.", en: 'These rows have four in each. You count them in fours: four, eight, twelve, sixteen. We will learn it now.' },
      on_unknown: { ru: 'Ничего. Научимся считать на четыре и на пять.', uz: "Hechqisi yo'q. To'rtga va beshga sanashni o'rganamiz.", en: 'No problem. We will learn to count in fours and in fives.' }
    }
  },

  // s1 — TUSHUNTIRISH-1: NEGA to'rtga sanash — 4 tadan skip-sanash (4,8,12,16 = 4 marta 4)
  s1: {
    eyebrow: { ru: 'Считаем на 4', uz: 'To\'rtga sanaymiz', en: 'Counting in 4s' },
    lead: { ru: 'Как считать на 4?', uz: "To'rtga qanday sanaymiz?", en: 'How do you count in 4s?' },
    body: { ru: 'В каждом ряду по 4. Не считаем по одному — считаем на четыре: 4, 8, 12, 16. Каждый раз прибавляем 4. Это 4 раза по 4, то есть 4 × 4 = 16.', uz: "Har qatorda 4 tadan. Bittalab emas — to'rttadan sanaymiz: 4, 8, 12, 16. Har safar 4 qo'shamiz. Bu 4 marta 4, ya'ni 4 × 4 = 16.", en: 'There are 4 in each row. We do not count one by one, we count in fours: 4, 8, 12, 16. Each time we add 4. That is 4 times 4, which is 4 × 4 = 16.' },
    info_badge: { ru: 'Главное', uz: 'Asosiy', en: 'The main thing' },
    info: { ru: 'Считать на 4 — прибавлять по 4: 4, 8, 12, 16, 20…', uz: "To'rtga sanash — 4 tadan qo'shib borish: 4, 8, 12, 16, 20…", en: 'Counting in 4s means adding 4 each time: 4, 8, 12, 16, 20…' },
    audio: {
      ru: [
        'Как быстро сосчитать ряды по четыре? Считаем на четыре.',
        'Четыре, восемь, двенадцать, шестнадцать. Каждый раз прибавляем четыре.',
        'Четыре раза взяли по четыре. Это четыре умножить на четыре, шестнадцать.'
      ],
      uz: [
        "To'rttadan qatorlarni qanday tez sanaymiz? To'rtga sanaymiz.",
        "To'rt, sakkiz, o'n ikki, o'n olti. Har safar to'rt qo'shamiz.",
        "To'rt marta to'rttadan oldik. Bu to'rt marta to'rt, o'n olti."
      ],
      en: ['How do you count rows of four quickly? We count in fours.', 'Four, eight, twelve, sixteen. Each time we add four.', 'Four was taken four times. That is four multiplied by four, sixteen.']
    }
  },

  // s2 — TUSHUNTIRISH-2 (ishlab ko'rsatish): 4 qator × 4 → skip 4,8,12,16 = 16
  s2: {
    eyebrow: { ru: 'Считаем на 4', uz: 'To\'rtga sanaymiz', en: 'Counting in 4s' },
    lead: { ru: '4 ряда по 4 панели.', uz: "4 qatorda 4 tadan panel.", en: '4 rows of 4 panels.' },
    info_badge: { ru: 'Главное', uz: 'Asosiy', en: 'The main thing' },
    info: { ru: '4, 8, 12, 16 — это 4 × 4 = 16.', uz: "4, 8, 12, 16 — bu 4 × 4 = 16.", en: '4, 8, 12, 16, that is 4 × 4 = 16.' },
    audio: {
      ru: [
        'Четыре ряда, в каждом по четыре. Сосчитаем на четыре.',
        'Считаем: четыре, восемь, двенадцать. Прибавляем по четыре.',
        'Ещё один ряд: шестнадцать. Всего шестнадцать.',
        'Четыре раза по четыре это шестнадцать. Четыре умножить на четыре, шестнадцать.'
      ],
      uz: [
        "To'rtta qator, har birida to'rttadan. To'rtga sanaymiz.",
        "Sanaymiz: to'rt, sakkiz, o'n ikki. To'rttadan qo'shamiz.",
        "Yana bir qator: o'n olti. Jami o'n olti.",
        "To'rt marta to'rttadan, o'n olti. To'rt marta to'rt, o'n olti."
      ],
      en: ['Four rows with four in each. Let us count them in fours.', 'We count: four, eight, twelve. We add four each time.', 'One more row: sixteen. That is sixteen in all.', 'Four times four is sixteen. Four multiplied by four, sixteen.']
    }
  },

  // s3 — QOIDA: to'rtga sanash (4 tadan) + check (3 qator × 4 = 12)
  s3: {
    eyebrow: { ru: 'Правило', uz: 'Qoida', en: 'Rule' },
    rule: { ru: 'Умножить на 4 — считать по четыре: 4, 8, 12, 16, 20, 24.', uz: "4 ga ko'paytirish — to'rttadan sanash: 4, 8, 12, 16, 20, 24.", en: 'Multiplying by 4 means counting in fours: 4, 8, 12, 16, 20, 24.' },
    check_q: { ru: '3 ряда по 4. Сколько всего?', uz: "3 qatorda 4 tadan. Jami nechta?", en: '3 rows of 4. How many are there in all?' },
    opts: [{ ru: '12', uz: '12', en: '12', ok: true }, { ru: '10', uz: '10', en: '10' }, { ru: '8', uz: '8', en: '8' }],
    wrong: { ru: 'Считай на четыре: четыре, восемь, двенадцать.', uz: "To'rtga sanang: to'rt, sakkiz, o'n ikki.", en: 'Count in fours: four, eight, twelve.' },
    check_ok: { ru: 'Верно! 3 раза по 4 это 12.', uz: "To'g'ri! 3 marta 4 — 12.", en: 'That is right! 3 times 4 is 12.' },
    audio: {
      ru: [
        'Запишем правило. Слушай и запомни.',
        'Умножить на четыре, значит считать по четыре.',
        'Прибавляем по четыре: четыре, восемь, двенадцать, шестнадцать, двадцать.',
        'Сколько раз взяли по четыре, столько умножаем на четыре.',
        'А теперь сам. Три ряда по четыре. Сколько всего?'
      ],
      uz: [
        "Qoidani yozamiz. Tinglang va yodlang.",
        "To'rtga ko'paytirish, to'rttadan sanash demakdir.",
        "To'rttadan qo'shamiz: to'rt, sakkiz, o'n ikki, o'n olti, yigirma.",
        "Necha marta to'rttadan oldik, shuncha to'rtga ko'paytiramiz.",
        "Endi o'zingiz. Uch qatorda to'rttadan. Jami nechta?"
      ],
      en: ['Let us write down the rule. Listen and remember.', 'Multiplying by four means counting in fours.', 'We add four each time: four, eight, twelve, sixteen, twenty.', 'However many times we take four, that is what we multiply four by.', 'And now on your own. Three rows of four. How many are there in all?']
    }
  },

  // s4 — TUSHUNTIRISH-3 (beshga sanash): 4 qator × 5 → skip 5,10,15,20 = 20 + check; nishon oxiri 0/5
  s4: {
    eyebrow: { ru: 'Считаем на 5', uz: 'Beshga sanaymiz', en: 'Counting in 5s' },
    lead: { ru: 'Теперь на 5. 4 ряда по 5.', uz: "Endi beshga. 4 qatorda 5 tadan.", en: 'Now in 5s. 4 rows of 5.' },
    body: { ru: '4 ряда по 5: 5, 10, 15, 20. Прибавляем по 5. Это 4 × 5 = 20.', uz: "4 qator, 5 tadan: 5, 10, 15, 20. 5 tadan qo'shamiz. Bu 4 × 5 = 20.", en: '4 rows of 5: 5, 10, 15, 20. We add 5 each time. That is 4 × 5 = 20.' },
    warn: { ru: 'На 5 в конце всегда 0 или 5: 5, 10, 15, 20, 25.', uz: "Beshga oxiri doim 0 yoki 5: 5, 10, 15, 20, 25.", en: 'In the 5s the last digit is always 0 or 5: 5, 10, 15, 20, 25.' },
    check_q: { ru: '2 ряда по 5. Сколько всего?', uz: "2 qatorda 5 tadan. Jami nechta?", en: '2 rows of 5. How many are there in all?' },
    opts: [{ ru: '10', uz: '10', en: '10', ok: true }, { ru: '9', uz: '9', en: '9' }, { ru: '8', uz: '8', en: '8' }],
    wrong: { ru: 'Считай на пять: пять, десять.', uz: "Beshga sanang: besh, o'n.", en: 'Count in fives: five, ten.' },
    check_ok: { ru: 'Верно! 2 раза по 5 это 10.', uz: "To'g'ri! 2 marta 5 — 10.", en: 'That is right! 2 times 5 is 10.' },
    audio: {
      ru: [
        'Теперь научимся считать на пять. Четыре ряда по пять.',
        'Считаем по пять: пять, десять, пятнадцать, двадцать.',
        'На пять легко: в конце всегда ноль или пять. Четыре умножить на пять это двадцать.',
        'Сосчитай сам. Два ряда по пять. Сколько всего?'
      ],
      uz: [
        "Endi beshga sanashni o'rganamiz. To'rtta qatorda beshtadan.",
        "Beshtadan sanaymiz: besh, o'n, o'n besh, yigirma.",
        "Beshga oson: oxiri doim nol yoki besh. To'rt marta besh, yigirma.",
        "O'zingiz sanang. Ikki qatorda beshtadan. Jami nechta?"
      ],
      en: ['Now let us learn to count in fives. Four rows of five.', 'We count in fives: five, ten, fifteen, twenty.', 'Fives are easy, because the last digit is always zero or five. Four multiplied by five is twenty.', 'Count it yourself. Two rows of five. How many are there in all?']
    }
  },

  // sTBL — TUSHUNTIRISH: 4 ga jadvalni skip-sanash bilan QURAMIZ (4,8,12,16,20,24 — bosqichli)
  sTBL: {
    eyebrow: { ru: 'Таблица на 4', uz: "4 ga jadval", en: 'The 4 times table' },
    lead: { ru: 'Строим таблицу на 4', uz: "4 ga jadvalni quramiz", en: 'Building the 4 times table' },
    info_badge: { ru: 'Главное', uz: 'Asosiy', en: 'The main thing' },
    info: { ru: 'Каждая клетка на 4 больше: 4, 8, 12, 16, 20, 24.', uz: "Har katak avvalgidan 4 ko'p: 4, 8, 12, 16, 20, 24.", en: 'Each box is 4 more than the one before: 4, 8, 12, 16, 20, 24.' },
    audio: {
      ru: [
        'Построим таблицу умножения на четыре. Прибавляем по четыре.',
        'Один раз по четыре это четыре. Два раза это восемь. Три раза это двенадцать.',
        'Дальше: шестнадцать, двадцать, двадцать четыре. Каждый раз прибавляем четыре.',
        'Так получается таблица на четыре: четыре, восемь, двенадцать, шестнадцать, двадцать, двадцать четыре. Её можно открыть в помощь.'
      ],
      uz: [
        "To'rtga ko'paytirish jadvalini quramiz. To'rttadan qo'shamiz.",
        "Bir marta to'rt, to'rt. Ikki marta, sakkiz. Uch marta, o'n ikki.",
        "Keyin: o'n olti, yigirma, yigirma to'rt. Har safar to'rt qo'shamiz.",
        "Shunday to'rtga jadval chiqadi: to'rt, sakkiz, o'n ikki, o'n olti, yigirma, yigirma to'rt. Uni yordam uchun ochsa bo'ladi."
      ],
      en: ['Let us build the four times table. We add four each time.', 'One time four is four. Two times is eight. Three times is twelve.', 'Then: sixteen, twenty, twenty four. Each time we add four.', 'That gives the four times table: four, eight, twelve, sixteen, twenty, twenty four. You can open it whenever you need help.']
    }
  },

  // s5 — MASHQ-single (ARRAY ×4): 4 qator × 4 = 16
  s5: {
    eyebrow: { ru: 'Практика', uz: 'Mashq', en: 'Practice' },
    lead: { ru: 'Сосчитай на 4.', uz: "To'rtga sanab toping.", en: 'Count in 4s.' },
    transition: { ru: 'Объяснение мы закончили. Теперь потренируйся: считай на 4 и на 5.', uz: "Tushuntirishni tugatdik. Endi mashq qiling: 4 va 5 ga sanang.", en: 'We have finished explaining. Now practise: count in 4s and in 5s.' },
    r: 4, c: 4,
    wrong: { ru: 'Считай на четыре: четыре, восемь, двенадцать, шестнадцать.', uz: "To'rtga sanang: to'rt, sakkiz, o'n ikki, o'n olti.", en: 'Count in fours: four, eight, twelve, sixteen.' },
    done_text: { ru: 'Верно! 4 раза по 4 это 16.', uz: "To'g'ri! 4 marta 4 — 16.", en: 'That is right! 4 times 4 is 16.' },
    audio: {
      intro: { ru: 'Тренировка. Четыре ряда по четыре. Сосчитай на четыре.', uz: "Mashq. To'rtta qatorda to'rttadan. To'rtga sanang.", en: 'Practice. Four rows of four. Count them in fours.' },
      on_correct: { ru: 'Верно. Четыре умножить на четыре это шестнадцать.', uz: "To'g'ri. To'rt marta to'rt, o'n olti.", en: 'That is right. Four multiplied by four is sixteen.' },
      on_wrong: { ru: 'Считай на четыре: четыре, восемь, двенадцать, шестнадцать.', uz: "To'rtga sanang: to'rt, sakkiz, o'n ikki, o'n olti.", en: 'Count in fours: four, eight, twelve, sixteen.' }
    }
  },

  // s6 — MASHQ-single (TABLE-FILL ×4): 4,8,12,[16],20,24 — bo'sh katakni to'ldir
  s6: {
    ...
    by: 4, blank: 4,
    wrong: { ru: 'К прошлой клетке прибавь 4.', uz: "Avvalgi katakka 4 qo'shing.", en: 'Add 4 to the box before.' },
    done_text: { ru: 'Верно!', uz: "To'g'ri!", en: 'Correct!' },
    audio: {
      intro: { ru: 'Это таблица на четыре. Одна клетка пустая. К прошлой клетке прибавь четыре и нажми ответ.', uz: "Bu to'rtga jadval. Bir katak bo'sh. Avvalgi katakka to'rt qo'shib, javobni bosing.", en: 'This is the four times table. One box is empty. Add four to the box before and tap the answer.' },
      on_correct: { ru: 'Верно.', uz: "To'g'ri.", en: 'Correct.' },
      on_wrong: { ru: 'Прибавь к прошлой клетке четыре.', uz: "Avvalgi katakka to'rt qo'shing.", en: 'Add four to the box before.' }
    }
  },

  // s7 — MASHQ (YETISHMAGAN KO'PAYTUVCHI, 3 round): a × ? = p / ? × a = p. Yetishmagan ko'paytuvchini top.
  // Distraktorlar: qo'shni ko'paytuvchi (ans±1) va mahsulot-ayirma (product-known). round.q = DISPLAY. Natija ≤45.
  s7: {
    ...
    rounds: [
      { known: 4, ans: 5, side: 'right', q: { ru: 'Сколько рядов по 4 дают 20?', uz: "Nechta 4 talik qator 20 beradi?", en: 'How many rows of 4 make 20?' } },
      { known: 5, ans: 4, side: 'left',  q: { ru: 'Сколько раз по 5, чтобы вышло 20?', uz: "Necha marta 5 olsak 20 chiqadi?", en: 'How many times 5 makes 20?' } },
      { known: 5, ans: 5, side: 'right', q: { ru: 'Сколько рядов по 5 дают 25?', uz: "Nechta 5 talik qator 25 beradi?", en: 'How many rows of 5 make 25?' } }
    ],
    ...
    audio: {
      ...
      on_correct: { ru: 'Верно.', uz: "To'g'ri.", en: 'Correct.' },
      on_wrong: { ru: 'Считай по группам, пока не дойдёшь до нужного числа.', uz: "Guruhlab sanang, kerakli songa yetguncha.'n, o'n besh, yigirma.", en: 'Count in groups until you reach the number you need.' }
    }
  },

  // s8 — MASHQ (MOSLASH): 4 juft — chapda JAVOB (num=mahsulot), o'ngda YOZUV (form=ifoda DISPLAY).
  // O'ng ustun mount'da aralashadi. ALL-OR-NOTHING (MatchBody). «Maslahat» javob bermaydi. ×4/×5 faktlar.
  s8: {
  ...
  // s9 — MASHQ (ARRAY miks ×4/×5, 3 round)
  s9: {
    eyebrow: { ru: 'Практика', uz: 'Mashq', en: 'Practice' },
    lead: { ru: 'Сосчитай на 4 или на 5.', uz: "4 yoki 5 ga sanab toping.", en: 'Count in 4s or in 5s.' },
    rounds: [ { r: 5, c: 4 }, { r: 2, c: 5 }, { r: 6, c: 4 } ],
    wrong: { ru: 'Смотри, по сколько в ряду: по четыре или по пять.', uz: "Qatorda nechtadan qarang: to'rttadan yoki beshtadan.", en: 'Look at how many are in a row: four or five.' },
    done_text: { ru: 'Верно!', uz: "To'g'ri!", en: 'Correct!' },
    audio: {
      intro: { ru: 'Ряды разные: где по четыре, где по пять. Считай верно.', uz: "Qatorlar har xil: qayerda to'rttadan, qayerda beshtadan. To'g'ri sanang.", en: 'The rows are different, some have four and some have five. Count the right way.' },
      on_correct: { ru: 'Верно.', uz: "To'g'ri.", en: 'Correct.' },
      on_wrong: { ru: 'Смотри, по сколько в ряду.', uz: "Qatorda nechtadan qarang.", en: 'Look at how many are in a row.' }
    }
  },

  // s10 — MASHQ (ORTIQCHASINI TOP, 3 round): 4 ifodadan 3 tasi nishonga TENG, biri EMAS (a*b).
  ...
  s10: {
    ...
    rounds: [
      { target: 20, exprs: [{ a: 4, b: 5 }, { a: 5, b: 4 }, { a: 10, b: 2 }, { a: 4, b: 4 }], q: { ru: 'Что НЕ равно 20?', uz: "Qaysi biri 20 ga TENG EMAS?", en: 'Which one is NOT equal to 20?' } },
      { target: 16, exprs: [{ a: 4, b: 4 }, { a: 8, b: 2 }, { a: 2, b: 8 }, { a: 3, b: 5 }], q: { ru: 'Что НЕ равно 16?', uz: "Qaysi biri 16 ga TENG EMAS?", en: 'Which one is NOT equal to 16?' } },
      { target: 20, exprs: [{ a: 5, b: 4 }, { a: 4, b: 5 }, { a: 2, b: 10 }, { a: 5, b: 5 }], q: { ru: 'Что НЕ равно 20?', uz: "Qaysi biri 20 ga TENG EMAS?", en: 'Which one is NOT equal to 20?' } }
    ],
    wrong: { ru: 'Посчитай каждую запись и сравни с числом.', uz: "Har yozuvni sanab, son bilan solishtiring.", en: 'Work out each sum and compare it with the number.' },
    done_text: { ru: 'Верно!', uz: "To'g'ri!", en: 'Correct!' },
    audio: {
  ...
  // s11 — MASHQ (XATONI TOP / skip-sanash, 3 round): skip-qatorda bitta buzuq mahsulot bor.
  ...
  s11: {
    ...
    rounds: [
      { seq: [5, 10, 15, 25], badIdx: 3, right: 20, q: { ru: 'Считаем на 5.', uz: "Beshga sanaymiz.", en: 'We are counting in 5s.' }, fix: { ru: '5, 10, 15, 20 — прибавляем по 5.', uz: "5, 10, 15, 20 — beshtadan qo'shamiz.", en: '5, 10, 15, 20, we add 5 each time.' } },
      { seq: [4, 8, 16, 16], badIdx: 2, right: 12, q: { ru: 'Считаем на 4.', uz: "To'rtga sanaymiz.", en: 'We are counting in 4s.' }, fix: { ru: '4, 8, 12, 16 — прибавляем по 4.', uz: "4, 8, 12, 16 — to'rttadan qo'shamiz.", en: '4, 8, 12, 16, we add 4 each time.' } },
      { seq: [5, 15, 15, 20], badIdx: 1, right: 10, q: { ru: 'Считаем на 5.', uz: "Beshga sanaymiz.", en: 'We are counting in 5s.' }, fix: { ru: '5, 10, 15, 20 — прибавляем по 5.', uz: "5, 10, 15, 20 — beshtadan qo'shamiz.", en: '5, 10, 15, 20, we add 5 each time.' } }
    ],
  ...
  s12: {
    ...
    lead: { ru: 'Зухра ставит панели.', uz: "Zuhra panel o'rnatadi.", en: 'Zuhra is fitting the panels.' },
    manifest_label: { ru: 'панели', uz: 'panel', en: 'panels' },
    audio: {
      ru: 'Зухра ставит ровные ряды.',
      uz: "Zuhra teng qatorlar o'rnatadi.",
      en: 'Zuhra is fitting them in even rows.'
    }
  },

  // s13 — MASALA (scored, array): Zuhra 4 qator × 5 = 20
  s13: {
    eyebrow: { ru: 'Задача', uz: 'Masala', en: 'Word problem' },
    lead: { ru: 'Помоги Зухре.', uz: "Zuhraga yordam bering.", en: 'Help Zuhra.' },
    story: { ru: 'Зухра поставила 4 ряда по 5 панелей. Сколько всего?', uz: "Zuhra 4 qatorda 5 tadan panel o'rnatdi. Jami nechta?", en: 'Zuhra fitted 4 rows of 5 panels. How many are there in all?' },
    r: 4, c: 5,
    wrong: { ru: 'Считай на пять: пять, десять, пятнадцать, двадцать.', uz: "Beshga sanang: besh, o'n, o'n besh, yigirma.", en: 'Count in fives: five, ten, fifteen, twenty.' },
    done_text: { ru: 'Верно! 4 раза по 5 это 20.', uz: "To'g'ri! 4 marta 5 — 20.", en: 'That is right! 4 times 5 is 20.' },
    audio: {
      intro: { ru: 'Помоги Зухре. Она установила четыре ряда, в каждом по пять панелей. Сколько всего? Сосчитай на пять.', uz: "Zuhraga yordam bering. U to'rtta qator o'rnatdi, har birida beshtadan panel. Jami nechta? Beshga sanang.", en: 'Help Zuhra. She fitted four rows with five panels in each. How many are there in all? Count them in fives.' },
      on_correct: { ru: 'Верно. У Зухры двадцать панелей.', uz: "To'g'ri. Zuhrada yigirma panel.", en: 'That is right. Zuhra has twenty panels.' },
      on_wrong: { ru: 'Считай на пять: пять, десять, пятнадцать, двадцать.', uz: "Beshga sanang: besh, o'n, o'n besh, yigirma.", en: 'Count in fives: five, ten, fifteen, twenty.' }
    }
  },

  // s14 — FINAL (scored, ARALASH 3 round: massiv + yetishmagan-ko'paytuvchi + moslash) + FactCard Yupiter.
  // FinalMixStage round.kind bo'yicha body tanlaydi (array / missing / match). Natija ≤45.
  s14: {
    eyebrow: { ru: 'Финал', uz: 'Final', en: 'Final' },
    lead: { ru: 'Финальная проверка.', uz: "Yakuniy tekshiruv.", en: 'The final check.' },
    rounds: [
      { kind: 'array', r: 4, c: 5, q: { ru: 'Сколько всего?', uz: 'Jami nechta?', en: 'How many in all?' } },
      { kind: 'missing', known: 4, ans: 5, side: 'right', q: { ru: 'Сколько рядов по 4 дают 20?', uz: "Nechta 4 talik qator 20 beradi?", en: 'How many rows of 4 make 20?' } },
      { kind: 'match', pairs: [{ num: 16, form: '4 × 4' }, { num: 20, form: '4 × 5' }, { num: 25, form: '5 × 5' }, { num: 12, form: '4 × 3' }] }
    ],
    wrong: { ru: 'Считай на 4 или на 5.', uz: "4 yoki 5 ga sanang.", en: 'Count in 4s or in 5s.' },
    done_text: { ru: 'Верно!', uz: "To'g'ri!", en: 'Correct!' },
    ...
    audio: {
      intro: { ru: 'Финальная проверка. Три задания разного вида. Считай на четыре и на пять.', uz: "Yakuniy tekshiruv. Uch xil topshiriq. To'rt va beshga sanang.", en: 'The final check. Three different kinds of task. Count in fours and in fives.' },
      on_correct: { ru: 'Верно.', uz: "To'g'ri.", en: 'Correct.' },
  ...
  s15: {
    ...
    cando: { ru: 'Теперь ты умножаешь на 4 и на 5!', uz: "Endi siz 4 ga va 5 ga ko'paytirasiz!", en: 'Now you can multiply by 4 and by 5!' },
    // QOIDA recap (ko'rinadigan):
    rule_recap: { ru: 'На 4 считаем по четыре, на 5 — по пять. 4 × 4 = 16, 4 × 5 = 20.', uz: "4 ga to'rttadan, 5 ga beshtadan sanaymiz. 4 × 4 = 16, 4 × 5 = 20.", en: 'For 4 we count in fours, for 5 in fives. 4 × 4 = 16, 4 × 5 = 20.' },
    conn_label_refs: { ru: 'Опирается на', uz: 'Tayanadi', en: 'Builds on' },
    conn_refs: { ru: 'урок 14: таблица ×2 и ×3', uz: "14-dars: ×2 va ×3 jadvali", en: 'lesson 14: the 2 and 3 times tables' },
    conn_label_next: { ru: 'Дальше', uz: 'Keyingi', en: 'Next' },
    conn_next: { ru: 'дальше: таблица ×6 и ×7', uz: "keyingi: ×6 va ×7 jadvali", en: 'next: the 6 and 7 times tables' },
    audio: {
      ru: 'Миссия выполнена. На орбите Юпитера мы научились умножать на четыре и на пять. Запомни. На четыре считаем по четыре: четыре, восемь, двенадцать, шестнадцать. На пять, по пять, и в конце всегда ноль или пять: пять, десять, пятнадцать, двадцать. Панели на корабле сосчитаны. В следующий раз выучим таблицу на шесть и на семь.',
      uz: "Missiya bajarildi. Yupiter orbitasida to'rtga va beshga ko'paytirishni o'rgandik. Yodda tuting. To'rtga to'rttadan sanaymiz: to'rt, sakkiz, o'n ikki, o'n olti. Beshga beshtadan, oxiri doim nol yoki besh: besh, o'n, o'n besh, yigirma. Kemadagi quyosh panellari sanaldi. Keyingi safar oltiga va yettiga ko'paytirish jadvalini o'rganamiz.",
      en: 'Mission complete. In orbit around Jupiter we learned to multiply by four and by five. Remember. For four we count in fours: four, eight, twelve, sixteen. For five, in fives, and the last digit is always zero or five: five, ten, fifteen, twenty. The panels on the ship are counted. Next time we will learn the six and seven times tables.'
    }
  }
};
...
const BRIDGES = {
  ...
  s12: { ru: 'Зухра ставит панели.', uz: "Zuhra panel o'rnatadi.", en: 'Zuhra is fitting the panels.' },
  ...
  s15: { ru: 'Панели на корабле сосчитаны!', uz: "Kemadagi panellar sanaldi!", en: 'The panels on the ship are counted!' }
};

// s15 payoff (xulosadan oldin aytiladi)
const S15_PAYOFF = {
  ru: 'Массив солнечных панелей корабля собран умножением. У этой огромной планеты впереди новые задачи! Спасибо за помощь.',
  uz: "Kemaning quyosh panellari massivi ko'paytirib sanaldi. Bu ulkan sayyora atrofida yangi masalalar oldinda! Yordamingiz uchun rahmat.",
  en: "The ship's array of solar panels is put together by multiplying. New tasks lie ahead at this huge planet! Thank you for your help."
};
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 2.2vw, 16px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ padding: 'clamp(8px, 1.8vw, 14px)', overflow: 'hidden' }}>
          <YupiterScene answer={picked !== null ? 16 : null}/>
        </div>
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 'clamp(12px, 2.4vw, 18px)', padding: 'clamp(16px, 3vw, 24px)', minHeight: 'clamp(200px, 46vw, 280px)' }}>
          <ArrayViz r={4} c={4} reveal={reveal}/>
        </div>
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <ArrayViz r={3} c={4} reveal={done ? 3 : 1}/>
        </div>
  ...
  return (
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <ArrayViz r={4} c={5} reveal={reveal}/>
        </div>
  ...
  return (
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 2.4vw, 16px)', position: 'relative' }}>
        ...
        {/* Yakun sahnasi: Yupiter orbitasida panel massivi ko'paytirib sanaldi (4×4=16) + ✓ */}
        <div className="fade-up delay-1">
          <YupiterField label={{ ru: 'Панели собраны', uz: 'Panellar ulandi', en: 'The panels are in place' }}/>
        </div>
      </div>
    </Stage>
  );
...
// R qator × C panel; bola bir qatorni sanaydi → teng qatorlar → takroriy qo'shish
// (C+C+C) → «R marta C» = «R × C». ArrayViz reveal 0-3. Mashq: ArrayStage (bitta MC + reveal).
// ============================================================
const ARR_CELL = 'clamp(20px,4.8vw,30px)';
// PanelCell — sanaladigan quyosh paneli (soddalashtirilgan SolarPanel): ko'k kremniy to'r + kumush ramka.
const PanelCell = ({ s = 22 }) => (
  <svg viewBox="0 0 24 24" width={s} height={s} aria-hidden="true" style={{ display: 'block', overflow: 'visible' }}>
    <defs>
      <linearGradient id="d15cell" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#3172DE"/><stop offset="0.5" stopColor="#1B47A8"/><stop offset="1" stopColor="#0E2A6E"/></linearGradient>
    </defs>
    <ellipse cx="12" cy="23" rx="8" ry="1.3" fill="rgba(0,0,0,0.22)"/>
    <rect x="2" y="2" width="20" height="20" rx="2.4" fill="#C6D0DC" stroke="#7C8798" strokeWidth="0.8"/>
    <rect x="3.6" y="3.6" width="16.8" height="16.8" rx="1" fill="url(#d15cell)"/>
    <g stroke="#8FBAF6" strokeWidth="0.6" opacity="0.85"><line x1="9" y1="3.6" x2="9" y2="20.4"/><line x1="15" y1="3.6" x2="15" y2="20.4"/><line x1="3.6" y1="9" x2="20.4" y2="9"/><line x1="3.6" y1="15" x2="20.4" y2="15"/></g>
    <path d="M3.6 3.6 L10 3.6 L3.6 10 Z" fill="rgba(255,255,255,0.28)"/>
  </svg>
);
// ArrayViz — sanaladigan obyekt = quyosh paneli. variant 'geo' (mashq/tushuntirish, siyan urg'u) yoki
// 'panel' (masala/yakuniy test, oltin-quvvat urg'u). reveal 0-3: massiv→qator-struktura→takroriy qo'shish→R×C.
const ArrayViz = ({ r, c, reveal = 0, variant = 'geo' }) => {
  const t = useT();
  const total = r * c;
  const solar = variant === 'panel';
  const rowHi = solar ? 'rgba(255,200,110,0.55)' : 'rgba(90,214,180,0.55)';
  const rowBg = solar ? 'rgba(255,200,110,0.1)' : 'rgba(90,214,180,0.1)';
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(8px,1.8vw,12px)' }}>
      {/* massiv — teng qatorlar (quyosh panellari) */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(5px,1.4vw,9px)', padding: 'clamp(9px,2.2vw,15px)', borderRadius: 14, background: 'linear-gradient(180deg,#122234,#0A1420)', border: `2px solid ${solar ? '#3E5170' : '#243C52'}`, boxShadow: 'inset 0 2px 10px rgba(0,0,0,0.5), 0 0 0 1px rgba(90,180,220,0.14)' }}>
        {Array.from({ length: r }).map((_, ri) => (
          <div key={ri} style={{ display: 'flex', gap: 'clamp(6px,1.6vw,11px)', justifyContent: 'center', alignItems: 'center', padding: '2px clamp(5px,1.4vw,9px)', borderRadius: 8, background: reveal >= 1 ? rowBg : 'transparent', boxShadow: reveal >= 1 ? `inset 0 0 0 1.5px ${rowHi}` : 'none', transition: 'all .3s' }}>
            {Array.from({ length: c }).map((_, ci) => (
              <span key={ci} style={{ width: ARR_CELL, height: ARR_CELL, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}><PanelCell s={22}/></span>
            ))}
          </div>
        ))}
      </div>
      {reveal >= 1 && <p className="fade-up" style={{ margin: 0, fontWeight: 800, fontSize: 'clamp(13px,2vw,16px)', color: solar ? '#E0A94A' : '#2FB584' }}>{t({ ru: `${r} ${r === 1 ? 'ряд' : r < 5 ? 'ряда' : 'рядов'} по ${c}`, uz: `${r} qator, ${c} tadan` })}</p>}
      {reveal >= 2 && (
        <div className="g1-pop-in" style={{ display: 'flex', alignItems: 'center', gap: 'clamp(3px,1vw,6px)', flexWrap: 'wrap', justifyContent: 'center', fontFamily: "'JetBrains Mono', monospace", fontWeight: 800, fontSize: 'clamp(16px,3.2vw,23px)' }}>
          {Array.from({ length: r }).map((_, i) => (<React.Fragment key={i}>{i > 0 && <span style={{ color: T.ink3 }}>+</span>}<span style={{ color: '#2FB584' }}>{c}</span></React.Fragment>))}
...
const ACase = (props) => <ArrayStage props={props} cKey="s13" variant="panel"/>;
// A7 (yetishmagan-ko'paytuvchi), A8 (moslash), A10 (ortiqchasini top), A11 (xatoni top), A14 (final miks)
// — quyida YANGI test-mexanikalari blokida.
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        <div className="fade-up" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(7px,1.6vw,11px)' }}>
          ...
          {showTable && <MultTable max={6} hr={by} hc={blank}/>}
        </div>
        {wrong.size > 0 && !solved && <div className="frame-tip fade-up"><Reaction state="wrong" praise={t(cur.wrong || c.wrong)}/></div>}
        {solved && <div ref={revealRef} className="frame-success fade-up"><Reaction state="correct" praise={t(cur.done_text || c.done_text)}/></div>}
        {solved && !isLast && <NextExBtn onClick={nextRound} label={t(NEXT_EX)}/>}
...
// ============================================================
// YANGI TEST-MEXANIKALARI (ko'paytirish bloki ETALONI, Dars14'dan ko'chirildi).
  ...
  return (
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        {rounds.length > 1 && <RoundDots ri={ri} total={rounds.length}/>}
        {renderBody(ctx)}
        {/* KO'PAYTIRISH JADVALI yordamchisi — dars imzosi (o'quvchi hali jadvalni bilmaydi) */}
        <div className="fade-up" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(7px,1.6vw,11px)' }}>
          <button onClick={() => setShowTable((s) => !s)} style={{ padding: 'clamp(8px,1.7vw,12px) clamp(16px,3vw,22px)', fontSize: 'clamp(13px,1.9vw,15px)', fontWeight: 800, display: 'inline-flex', alignItems: 'center', gap: 8, color: T.accent, background: '#FFF3EC', border: '2px solid #fe5b1a', borderRadius: 999, cursor: 'pointer', transition: 'all .2s', boxShadow: showTable ? 'none' : '0 3px 12px -4px rgba(254,91,26,0.45)' }}>
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontWeight: 800, color: T.accent }}>×</span>{showTable ? t(TBL_HIDE) : t(TBL_SHOW)}
          </button>
  ...
  return (
    <>
      <div className="frame fade-up delay-1" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: 'clamp(14px, 2.6vw, 20px)' }}>
        <ArrayViz r={r} c={cc} reveal={solved ? 3 : 0} variant="panel"/>
      </div>
      {!solved && (
        <>
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 'clamp(10px, 2vw, 14px)', padding: 'clamp(14px, 2.8vw, 22px)', minHeight: 'clamp(190px, 44vw, 260px)', overflowX: 'auto' }}>
          <TableRow by={4} upto={6} fill={fill}/>
          {done && <div className="g1-pop-in" style={{ fontFamily: "'JetBrains Mono', monospace", fontWeight: 800, fontSize: 'clamp(17px,3.6vw,26px)', color: T.success, letterSpacing: '.06em' }}>4, 8, 12, 16, 20, 24</div>}
        </div>
        {done && <div ref={revealRef}><InfoNote badge={t(c.info_badge)} text={t(c.info)}/></div>}
      </div>
    </Stage>
...
// sirt yo'q, kema QO'NA OLMAYDI. Shuning uchun ekipaj Yupiter ORBITASIDA uchadi, kema tashqarisidagi
// QUYOSH PANELLARI (teng qatorlarда) quvvat yig'adi; Yupiter ILLYUMINATORdan ko'rinadi.
// ============================================================
...
// ============================================================
// QUYOSH PANELLARI SAHNASI (s0 hook + s15 xulosa) — issiqxona o'rniga
// kema tashqarisidagi fotovoltaik panel massivi. 4×4=16 sanaladigan panjara.
// ============================================================
// SolarPanel — hajmli fotovoltaik panel: ko'k kremniy hujayralar to'ri + kumush ramka + porlash aksi.
const SolarPanel = ({ s = 26 }) => (
  <svg viewBox="0 0 30 30" width={s} height={s} style={{ display: 'block', overflow: 'visible' }} aria-hidden="true">
    <defs>
      <linearGradient id="d15pcell" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#3172DE"/><stop offset="0.5" stopColor="#1B47A8"/><stop offset="1" stopColor="#0E2A6E"/></linearGradient>
      <linearGradient id="d15pframe" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#EAF0F8"/><stop offset="0.5" stopColor="#AEB9C8"/><stop offset="1" stopColor="#7C8798"/></linearGradient>
    </defs>
    <ellipse cx="15" cy="28.6" rx="10" ry="1.8" fill="rgba(0,0,0,0.24)"/>
    <rect x="2" y="2" width="26" height="26" rx="2.6" fill="url(#d15pframe)" stroke="#6C7788" strokeWidth="0.9"/>
    <rect x="4.2" y="4.2" width="21.6" height="21.6" rx="1.2" fill="url(#d15pcell)"/>
    <g stroke="#8FBAF6" strokeWidth="0.7" opacity="0.85">
      <line x1="11.4" y1="4.2" x2="11.4" y2="25.8"/><line x1="18.6" y1="4.2" x2="18.6" y2="25.8"/>
      <line x1="4.2" y1="11.4" x2="25.8" y2="11.4"/><line x1="4.2" y1="18.6" x2="25.8" y2="18.6"/>
    </g>
    <path d="M4.2 4.2 L13 4.2 L4.2 13 Z" fill="rgba(255,255,255,0.30)"/>
    <path d="M21 4.2 L25.8 4.2 L25.8 9 Z" fill="rgba(255,255,255,0.15)"/>
  </svg>
);
// Quvvat-akkumulyatori (floor burchagi — dekorativ). Zaryad chiziqlari yonadi.
const PowerCell = ({ w }) => (
  <svg viewBox="0 0 40 52" width={w} style={{ display: 'block', overflow: 'visible' }} aria-hidden="true">
    <defs><linearGradient id="d15batt" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stopColor="#3A4658"/><stop offset="0.5" stopColor="#5E6A7C"/><stop offset="1" stopColor="#28323F"/></linearGradient></defs>
    <ellipse cx="20" cy="50" rx="13" ry="2.2" fill="rgba(0,0,0,0.22)"/>
    <rect x="14" y="3" width="12" height="6" rx="2" fill="#28323F" stroke="#161D26" strokeWidth="1"/>
    <rect x="7" y="8" width="26" height="41" rx="3" fill="url(#d15batt)" stroke="#161D26" strokeWidth="1.2"/>
    {[0, 1, 2].map((i) => <rect key={i} x="11" y={13 + i * 11} width="18" height="7" rx="1.5" fill={i < 2 ? '#6EF29B' : '#2E7A50'} className={i === 1 ? 'd13-led' : ''}/>)}
    <path d="M20.5 39 L24 39 L21.5 44 L25 44 L19 51 L21 45 L18 45 Z" fill="#FFC23C"/>
  </svg>
);
// 4×4 fotovoltaik massiv — DISPLEY/HOLOGRAM ko'rinish (kema boshqaruv EKRANI ichida, sanaladigan).
// Yassi ko'k-hologram panjara: 4 qator × 4 panel = 16, skan-chiziqlar + siyan porlash.
const PanelArrayDisplay = ({ celebrate = false }) => (
  <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: 'clamp(2px,0.7vw,4px)', padding: 'clamp(3px,0.9vw,6px)', borderRadius: 7, background: 'rgba(26,58,104,0.42)', border: '1.5px solid rgba(126,204,255,0.6)', boxShadow: '0 0 0 1px rgba(126,204,255,0.22), 0 0 13px rgba(96,176,255,0.42), inset 0 0 16px rgba(60,140,230,0.28)' }}>
    {/* skan-chiziqlar (hologram displey) */}
    <div aria-hidden="true" style={{ position: 'absolute', inset: 0, borderRadius: 7, background: 'repeating-linear-gradient(0deg, rgba(150,210,255,0.09) 0 1.5px, transparent 1.5px 5px)', pointerEvents: 'none', zIndex: 2 }}/>
    {[0, 1, 2, 3].map((ri) => (
      <div key={ri} style={{ display: 'flex', gap: 'clamp(3px,1vw,6px)', justifyContent: 'center' }}>
        {[0, 1, 2, 3].map((ci) => (
          <span key={ci} className={celebrate ? 'g1-pop-in' : ''} style={{ display: 'inline-flex', zIndex: 1, animationDelay: celebrate ? `${0.2 + (ri * 4 + ci) * 0.05}s` : undefined, filter: 'drop-shadow(0 0 2px rgba(126,204,255,0.75))' }}>
            <span className="d13-sway" style={{ display: 'inline-block', transformOrigin: '50% 100%', animationDelay: `${(ri * 4 + ci) * 0.3}s` }}><SolarPanel s={16}/></span>
          </span>
        ))}
      </div>
    ))}
...
// BridgeConsole — qiya boshqaruv konsoli (old plan): LED qatori + tugma-panjara + slayderlar. Sovuq po'lat-ko'k.
// (Dars14 «ShipMoonDeck» etaloniga izchil — HTML/CSS-perspektiva konsoli.)
const BridgeConsole = ({ w = '100%' }) => (
  <div style={{ width: w, transform: 'perspective(360px) rotateX(49deg)', transformOrigin: 'bottom center' }} aria-hidden="true">
    <div style={{ borderRadius: '12px 12px 6px 6px', background: 'linear-gradient(180deg,#3C4B65,#212C3F)', border: '1.5px solid #4E6180', borderBottomColor: '#141C29', boxShadow: '0 -5px 14px rgba(0,0,0,0.42)', padding: 'clamp(6px,1.6vw,10px) clamp(9px,2.2vw,15px)', display: 'flex', flexDirection: 'column', gap: 'clamp(5px,1.3vw,8px)' }}>
      <div style={{ display: 'flex', gap: 'clamp(5px,1.3vw,8px)', justifyContent: 'center' }}>
        {['#7DDCF2', '#6EF29B', '#FFC23C', '#7DDCF2', '#FF7A9C', '#6EF29B'].map((c, i) => <span key={i} className="d13-led" style={{ width: 'clamp(5px,1.3vw,8px)', height: 'clamp(5px,1.3vw,8px)', borderRadius: '50%', background: c, boxShadow: `0 0 6px ${c}`, animationDelay: `${i * 0.18}s` }}/>)}
      </div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(8,1fr)', gap: 'clamp(3px,0.9vw,5px)' }}>
        {Array.from({ length: 16 }).map((_, i) => <span key={i} style={{ height: 'clamp(7px,1.7vw,11px)', borderRadius: 3, background: 'linear-gradient(180deg,#5E7290,#32425C)', boxShadow: 'inset 0 1px 1px rgba(255,255,255,0.15)' }}/>)}
      </div>
      <div style={{ display: 'flex', gap: 'clamp(10px,2.4vw,16px)', justifyContent: 'center' }}>
        {[32, 66, 48, 20].map((p, i) => (
          <div key={i} style={{ position: 'relative', width: 'clamp(26px,6vw,42px)', height: 'clamp(4px,1vw,6px)', borderRadius: 3, background: '#141C29' }}>
            <span style={{ position: 'absolute', left: `${p}%`, top: '50%', transform: 'translate(-50%,-50%)', width: 'clamp(6px,1.5vw,9px)', height: 'clamp(9px,2.1vw,13px)', borderRadius: 3, background: 'linear-gradient(180deg,#A6BAD2,#5A6C86)', boxShadow: '0 1px 3px rgba(0,0,0,0.5)' }}/>
          </div>
        ))}
      </div>
    </div>
...
// CaptainChair — kapitan o'rindig'i silueti (orqadan): ko'prik markazida, panorama-ekranga qaragan.
// (Dars14 «ShipMoonDeck» etaloniga izchil.)
const CaptainChair = () => (
  <svg viewBox="0 0 60 80" style={{ width: '100%', height: 'auto', display: 'block' }} aria-hidden="true">
    <ellipse cx="30" cy="77" rx="19" ry="3.4" fill="rgba(0,0,0,0.34)"/>
    <rect x="27" y="48" width="6" height="26" rx="3" fill="#161E2B"/>
    <rect x="18" y="72" width="24" height="5" rx="2.5" fill="#212C3D"/>
    <rect x="15" y="43" width="30" height="9" rx="4" fill="#2A3547"/>
    <path d="M17 46 Q17 9 30 7 Q43 9 43 46 Z" fill="#2E3B50" stroke="#3F5170" strokeWidth="1"/>
    <path d="M22 44 Q22 15 30 14 Q38 15 38 44 Z" fill="#1F2A3A"/>
    <rect x="11" y="33" width="5" height="15" rx="2.5" fill="#283244"/>
    <rect x="44" y="33" width="5" height="15" rx="2.5" fill="#283244"/>
  </svg>
);
// NavDisplay — devor navigatsiya/status displeyi: sovuq ko'k ekran + ma'lumot qatorlari + indikator-LED.
// (Dars14 «ShipMoonDeck» etaloniga izchil — eski NavReadout o'rniga.)
const NavDisplay = ({ tone = 'cyan' }) => {
  const c = tone === 'green' ? '#6EF29B' : '#7DDCF2';
  return (
    <div style={{ borderRadius: 5, background: 'linear-gradient(180deg,#101A29,#0A101C)', border: '1.6px solid #34435C', boxShadow: '0 2px 6px rgba(0,0,0,0.45), inset 0 0 10px rgba(90,160,210,0.14)', padding: 'clamp(3px,0.9vw,5px)', display: 'flex', flexDirection: 'column', gap: 'clamp(2px,0.7vw,4px)', fontFamily: "'JetBrains Mono', monospace" }} aria-hidden="true">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <span style={{ fontSize: 'clamp(6px,1.3vw,8px)', color: c, fontWeight: 800, letterSpacing: '.06em', textShadow: `0 0 5px ${c}` }}>NAV</span>
        <span className="d13-led" style={{ width: 'clamp(3px,0.8vw,5px)', height: 'clamp(3px,0.8vw,5px)', borderRadius: '50%', background: c, boxShadow: `0 0 5px ${c}` }}/>
      </div>
      {[74, 46, 90, 60].map((w, i) => <div key={i} style={{ height: 'clamp(2px,0.6vw,3px)', width: `${w}%`, borderRadius: 2, background: i === 1 ? '#6EF29B' : 'rgba(125,220,242,0.5)' }}/>)}
    </div>
  );
};
// MOON_TONES / MoonBall — Dars14 «ShipMoonDeck» etaloniga izchil: ambient erkin-suzuvchi shar (dekor).
const MOON_TONES = {
  ice:  ['#F2F8FF', '#A9C4E2', '#4E6A8E'],
  tan:  ['#F6EACB', '#CBAA72', '#7C6038'],
  grey: ['#ECEFF4', '#AAB2C0', '#5C6374'],
  rust: ['#F6D6B6', '#CE9468', '#7E5234'],
};
const MoonBall = ({ w = 'clamp(22px,5.6vw,34px)', tone = 'grey' }) => {
  const idRef = useRef('mb' + Math.random().toString(36).slice(2, 8));
  const id = idRef.current;
  const [a, b, c] = MOON_TONES[tone] || MOON_TONES.grey;
  return (
    <svg viewBox="0 0 40 40" style={{ width: w, height: 'auto', display: 'block', overflow: 'visible' }} aria-hidden="true">
      <defs>
        <radialGradient id={`${id}s`} cx="36%" cy="30%" r="74%"><stop offset="0" stopColor={a}/><stop offset="54%" stopColor={b}/><stop offset="100%" stopColor={c}/></radialGradient>
        <radialGradient id={`${id}d`} cx="70%" cy="76%" r="62%"><stop offset="42%" stopColor="rgba(12,16,30,0)"/><stop offset="100%" stopColor="rgba(12,16,30,0.4)"/></radialGradient>
        <radialGradient id={`${id}h`} cx="50%" cy="50%" r="50%"><stop offset="62%" stopColor="rgba(170,200,255,0)"/><stop offset="100%" stopColor="rgba(170,200,255,0.45)"/></radialGradient>
      </defs>
      <circle cx="20" cy="19" r="18.5" fill={`url(#${id}h)`}/>
      <circle cx="20" cy="19" r="15" fill={`url(#${id}s)`}/>
      {[[14, 13, 2.6], [26, 21, 2.0], [16, 25, 1.6], [23, 14, 1.2]].map(([cx, cy, r], i) => (
        <g key={i}>
          <circle cx={cx} cy={cy} r={r} fill="rgba(28,24,38,0.20)"/>
          <path d={`M${cx - r} ${cy} A ${r} ${r} 0 0 1 ${cx + r} ${cy}`} fill="none" stroke="rgba(255,255,255,0.30)" strokeWidth="0.55"/>
        </g>
      ))}
      <circle cx="20" cy="19" r="15" fill={`url(#${id}d)`}/>
      <path d="M9 12.5 A15 15 0 0 1 23 5" fill="none" stroke="rgba(255,255,255,0.55)" strokeWidth="1.1" strokeLinecap="round"/>
    </svg>
  );
};
// KEMA KOMANDA-KO'PRIGI (Yupiter orbitasida) — sovuq po'lat-ko'k boshqaruv deki.
// MUHIT Dars14 «ShipMoonDeck» etaloniga AYNAN izchil: po'lat-ko'k qorong'i palitra, shift status-LED
// qatori, yon-devor NavDisplay×2, metall-ramkali panorama-oyna, po'lat-ko'k pol + sovuq perspektiva-grid,
// markaziy kapitan-o'rindig'i, bitta qiya BridgeConsole (old plan), erkin-suzuvchi MoonBall + SensorPanel.
// FARQ FAQAT MONITOR ICHIDA: markazda MoonBlip yo'ldoshlar o'rniga 4×4 PanelArrayDisplay (16 panel).
const ShipSolarBay = ({ arrive = false, celebrate = false, bubbleNode, charNode }) => (
  <div className="d2-scene" style={{ background: 'linear-gradient(180deg,#2A3650 0%,#1B2436 54%,#121A28 100%)' }}>
    {/* SHIFT — po'lat-ko'k boshqaruv ko'prigi shifti + sovuq status-LED qatori (ambient) */}
    <div style={{ position: 'absolute', left: 0, right: 0, top: 0, height: '11%', background: 'linear-gradient(180deg,#38475F,#232E42)', boxShadow: '0 3px 8px rgba(0,0,0,0.34)', zIndex: 6 }}>
      <div style={{ position: 'absolute', left: '7%', right: '7%', bottom: 2, height: 'clamp(4px,1vw,7px)', borderRadius: 3, background: 'linear-gradient(180deg,#7DDCF2,#2C6E86)', boxShadow: '0 0 11px rgba(125,220,242,0.55)' }}/>
      {[14, 30, 46, 62, 78, 92].map((x, i) => <div key={x} style={{ position: 'absolute', left: `${x}%`, top: '28%', transform: 'translateX(-50%)', width: 'clamp(5px,1.2vw,8px)', height: 'clamp(5px,1.2vw,8px)', borderRadius: '50%', background: i % 3 === 1 ? '#6EF29B' : '#7DDCF2', boxShadow: `0 0 8px 2px ${i % 3 === 1 ? 'rgba(110,242,155,0.7)' : 'rgba(125,220,242,0.7)'}` }}/>)}
    </div>
    {/* yon devorlar (po'lat panel) + NAVIGATSIYA/STATUS displeylari */}
    <div aria-hidden="true" style={{ position: 'absolute', left: 0, top: '11%', bottom: 0, width: '7%', background: 'linear-gradient(90deg,#2E3A50,#1E2839)', boxShadow: 'inset -2px 0 6px rgba(0,0,0,0.4)', zIndex: 1 }}/>
    <div aria-hidden="true" style={{ position: 'absolute', right: 0, top: '11%', bottom: 0, width: '7%', background: 'linear-gradient(270deg,#2E3A50,#1E2839)', boxShadow: 'inset 2px 0 6px rgba(0,0,0,0.4)', zIndex: 1 }}/>
    <div style={{ position: 'absolute', left: '0.7%', top: '19%', width: 'clamp(28px,6.6vw,44px)', zIndex: 2 }}><NavDisplay tone="cyan"/></div>
    <div style={{ position: 'absolute', left: '0.7%', top: '38%', width: 'clamp(28px,6.6vw,44px)', zIndex: 2 }}><NavDisplay tone="green"/></div>
    ...
    <div style={{ position: 'absolute', left: '7%', right: '7%', top: '12%', height: '42%', borderRadius: 10, overflow: 'hidden', boxShadow: '0 5px 14px rgba(0,0,0,0.26)', zIndex: 2, border: 'clamp(5px,1.4vw,8px) solid', borderColor: '#CFD6E0 #9AA2AE #7E8692 #B6BEC8' }}>
      ...
      {/* MARKAZIY DISPLEY — monitor ichida: 4 qator × 4 panel = 16 (SANALADIGAN, mavzu-farqi) */}
      <div style={{ position: 'absolute', left: '49.5%', top: '54%', transform: 'translate(-50%,-50%)', zIndex: 2 }}><PanelArrayDisplay celebrate={celebrate}/></div>
    </div>
    {/* POL — po'lat-ko'k boshqaruv-deki + sovuq perspektiva grid */}
    <div style={{ position: 'absolute', left: 0, right: 0, bottom: 0, height: '42%', background: 'linear-gradient(180deg,#26324A 0%,#1A2334 48%,#121A28 100%)', boxShadow: 'inset 0 6px 14px rgba(0,0,0,0.32)', zIndex: 3 }}>
      <div style={{ position: 'absolute', left: 0, right: 0, top: 0, height: 'clamp(4px,1vw,7px)', background: 'linear-gradient(180deg,#3A4A64,#212C3F)' }}/>
      {[16, 32, 50, 68, 84].map((x) => <div key={x} style={{ position: 'absolute', bottom: 0, left: `${x}%`, width: 1, height: '74%', background: 'rgba(120,185,225,0.22)', transform: `skewX(${(x - 50) * 0.55}deg)`, transformOrigin: 'bottom' }}/>)}
      {[30, 58, 86].map((yt, i) => <div key={i} style={{ position: 'absolute', left: '4%', right: '4%', top: `${yt}%`, height: 1, background: 'rgba(120,185,225,0.13)' }}/>)}
    </div>
    {/* KAPITAN O'RINDIG'I SILUETI — markaz, panorama-ekranga qaragan (orqa plan) */}
    <div style={{ position: 'absolute', left: '50%', bottom: '25%', transform: 'translateX(-50%)', width: 'clamp(44px,10.5vw,70px)', zIndex: 3 }}><CaptainChair/></div>
    {/* KOMANDA-KONSOLI — qiya boshqaruv paneli (old plan, o'ng-markaz) */}
    <div style={{ position: 'absolute', left: '31%', right: '10%', bottom: '3%', zIndex: 4 }}><BridgeConsole/></div>
    {/* ERKIN SUZUVCHI SHAR — bitta, ambient dekor (o'ng burchak) */}
    <div className="d13-hover" style={{ position: 'absolute', right: '9%', top: '62%', zIndex: 4, animationDuration: '5.9s', animationDelay: '1.4s' }}><MoonBall w="clamp(18px,4.4vw,26px)" tone="ice"/></div>
    {/* DATCHIK-PANEL (o'ng devor) — kema texnikasi */}
    <div style={{ position: 'absolute', right: '0.6%', top: '56%', width: 'clamp(30px,7vw,48px)', zIndex: 4 }}><SensorPanel w="100%"/></div>
    {bubbleNode}
    {/* PERSONAJ — «?»/tablo tagida (chapda, old planда, z-index baland) */}
    {charNode}
  </div>
);
// s0 — YUPITER ORBITASIGA KELISH: illyuminatorda Yupiter ochiladi; quyosh panellari 4×4 massiv + jami "?".
...
// s15 — KEMA QUVVAT-MODULI (xulosa): panellar ko'paytirib sanaldi + yashil ✓ tablo.
const YupiterField = ({ label }) => {
  const t = useT();
  return (
    <ShipSolarBay celebrate
      bubbleNode={(
        <div style={{ position: 'absolute', left: '16%', top: '30%', transform: 'translateX(-50%)', zIndex: 7, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
          ...
          <div className="g1-pop-in" style={{ display: 'flex', alignItems: 'center', gap: 7, minWidth: 'clamp(52px,11vw,72px)', height: 'clamp(38px,7.4vw,50px)', padding: '0 clamp(10px,2vw,15px)', justifyContent: 'center', borderRadius: 12, fontFamily: "'JetBrains Mono', monospace", fontWeight: 800, fontSize: 'clamp(22px,4.6vw,30px)', background: T.successSoft, color: T.success, border: `2.5px solid ${T.success}`, boxShadow: '0 4px 14px -4px rgba(31,122,77,0.5)' }}>
            16<span style={{ fontSize: 'clamp(17px,3.4vw,23px)' }}>✓</span>
          </div>
        </div>
      )}
      charNode={(
...
/* --- Dars13 kema-ko'prik jonli/3D animatsiyalari --- */
...
@media (prefers-reduced-motion: reduce) {
  .d13-jhalo, .d13-jband, .d13-sway, .d13-moon1, .d13-moon2, .d13-sheen, .d13-hover, .d13-bubble, .d13-led, .d13-wave { animation: none; }
}
