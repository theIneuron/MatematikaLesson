...
// ============================================================================
// ░░ 2-SINF · Dars18R — "Закрепление · перестановка множителей" (mul-2-18-v1) · Б3 (YUPITER) · ETALON §11 ░░
// 2-SINF · syujet-qobiq v3: YUPITER orbitasi, KEMA YUK BO'LIMI (OMBOR). Program d.20 (SYUJET_2SINF.md Б3 yakuni).
// Baza: Dars17.jsx (×8/×9 jadvali — yuk-bo'lim sahnasi + geo/case ArrayViz + TableFill + jadval-yordamchi max=9).
...
// DUNYO: Yupiter orbitasi, kema YUK BO'LIMI (ombor) — yig'ilgan yuk qutilarga terilganda o'rin almashadi.
...
const LESSON_META = {
  lessonId: 'grade2-18',
  lessonTitle: { ru: 'Урок 18. Закрепление — перестановка множителей', uz: "18-dars. Mustahkamlash — o'rin almashish (a×b=b×a)", en: 'Lesson 18. Practice: swapping the numbers round' }
};
// STRUKTURA: s0 hook (burilish) · s1–s4 tushuntirish (o'rin almashish a×b=b×a) · sTBL to'liq jadval · s5–s11 mashq (teng?/burilish/aralash-jadval miks) · s13 masala · s14 final · s15 xulosa (Б3 yakuni).
...
const CONTENT = {
  // s0 — HOOK (scope: hook): 3 qator × 5 = 15; qutilar burilsa (5 qator × 3) baribir 15 (distraktor 8 = 3+5)
  s0: {
    eyebrow: { ru: 'Миссия', uz: 'Missiya', en: 'Mission' },
    topic: { ru: 'Тема: Перестановка множителей', uz: "Mavzu: O'rin almashish", en: 'Topic: Swapping the numbers round' },
    lead: { ru: 'Сколько всего ящиков?', uz: "Jami qancha quti?", en: 'How many boxes are there in all?' },
    q: { ru: '3 ряда по 5 → 5 рядов по 3. Сколько всего?', uz: "3 qator 5 tadan → 5 qator 3 tadan. Jami nechta?", en: '3 rows of 5 → 5 rows of 3. How many are there in all?' },
    opt0: { ru: '8', uz: '8', en: '8' },     // distraktor = 3+5 (qo'shish)
    opt1: { ru: '15', uz: '15', en: '15' },   // to'g'ri (o'zgarmaydi)
    opt2: { ru: 'Не знаю', uz: 'Bilmayman', en: "I don't know" },
    audio: {
      intro: {
        ru: [
          'Мы выучили всю таблицу умножения. Корабль Бита на орбите Юпитера, груз уложен в ящики и расставлен в трюме.',
          'Было три ряда, в каждом по пять. А теперь ящики переставили: пять рядов по три.',
          'Изменится ли всего? Считать заново долго. Есть хитрость.',
          'Послушай два ответа. Первый, восемь. Второй, пятнадцать. Или ты пока не знаешь. Выбери свой ответ.'
        ],
        uz: [
          "Butun ko'paytirish jadvalini o'rgandik. Bitning kemasi Yupiter orbitasida, yuk qutilarga terilib omborga joylandi.",
          "Uch qator, har birida beshtadan edi. Endi qutilar boshqacha terildi: besh qator, uchtadan.",
          "Jami o'zgaradimi? Qaytadan sanash uzoq. Bir qulaylik bor.",
          "Ikki javobni tinglang. Birinchi, sakkiz. Ikkinchi, o'n besh. Yoki hali bilmaysiz. O'z javobingizni tanlang."
        ],
        en: ["We have learned the whole multiplication table. Bit's ship is in orbit around Jupiter, and the cargo is packed into boxes and stacked in the hold.", 'There were three rows with five in each. Now the boxes have been rearranged: five rows of three.', 'Will the total change? Counting it all again takes long. There is a trick.', 'Listen to two answers. First, eight. Second, fifteen. Or maybe you do not know yet. Choose your answer.']
      },
      on_correct: { ru: 'Верно. Три на пять и пять на три, одно и то же, пятнадцать. Порядок множителей не меняет ответ.', uz: "To'g'ri. Uch marta besh va besh marta uch, bir xil, o'n besh. Ko'paytiruvchilar tartibi javobni o'zgartirmaydi.", en: 'That is right. Three times five and five times three are the same, fifteen. The order does not change the answer.' },
      on_wrong: { ru: 'Тут не складывают. Переставили ряды, но всего осталось столько же: пятнадцать. Сейчас поймём почему.', uz: "Bu yerda qo'shilmaydi. Qatorlar o'rin almashdi, lekin jami o'shancha qoldi: o'n besh. Hozir sababini tushunamiz.", en: 'Nothing was added here. The rows were turned round but there are still just as many, fifteen. Now we will see why.' },
      on_unknown: { ru: 'Ничего. Разберёмся, почему от перестановки ответ не меняется.', uz: "Hechqisi yo'q. Nega o'rin almashsa javob o'zgarmasligini tushunamiz.", en: 'No problem. Let us see why swapping them round does not change the answer.' }
    }
  },

  // s1 — TUSHUNTIRISH-1: O'RIN ALMASHISH — massivni bursak jami o'zgarmaydi (3×5 = 5×3 = 15)
  s1: {
    eyebrow: { ru: 'Перестановка', uz: "O'rin almashish", en: 'Swapping' },
    lead: { ru: 'Повернём — что изменится?', uz: "Bursak — nima o'zgaradi?", en: 'Turn it round, what changes?' },
    body: { ru: 'Вот 3 ряда по 5 — это 3 × 5 = 15. Повернём массив: станет 5 рядов по 3 — это 5 × 3. Ящики те же, всего снова 15. Порядок множителей не меняет произведение: 3 × 5 = 5 × 3.', uz: "Mana 3 qator, 5 tadan — bu 3 × 5 = 15. Massivni buramiz: 5 qator, 3 tadan bo'ladi — bu 5 × 3. Qutilar o'sha, jami yana 15. Ko'paytiruvchilar tartibi ko'paytmani o'zgartirmaydi: 3 × 5 = 5 × 3.", en: 'Here are 3 rows of 5, which is 3 × 5 = 15. Turn the array round and it becomes 5 rows of 3, which is 5 × 3. The boxes are the same and there are still 15. The order does not change the answer: 3 × 5 = 5 × 3.' },
    info_badge: { ru: "Вспомним правило", uz: "Eslaymiz", en: 'Let us remember the rule' },
    info: { ru: 'Множители можно менять местами: a × b = b × a.', uz: "Ko'paytiruvchilarni o'rin almashtirsa bo'ladi: a × b = b × a.", en: 'The numbers can swap places: a × b = b × a.' },
    audio: {
      ru: [
        'Вот три ряда по пять. Это три умножить на пять, пятнадцать.',
        'Повернём массив. Теперь пять рядов по три. Ящики те же самые.',
        'Всего снова пятнадцать. От перестановки множителей произведение не меняется.'
      ],
      uz: [
        "Mana uch qator, beshtadan. Bu uch marta besh, o'n besh.",
        "Massivni buramiz. Endi besh qator, uchtadan. Qutilar o'sha-o'sha.",
        "Jami yana o'n besh. O'rin almashsa, ko'paytma o'zgarmaydi."
      ],
      en: ['Here are three rows of five. That is three multiplied by five, fifteen.', 'Let us turn the array round. Now it is five rows of three. The boxes are the very same ones.', 'There are fifteen again. Swapping the numbers round does not change the answer.']
    }
  },

  // s2 — TUSHUNTIRISH-2 (yana bir misol): 2 qator × 6 → bursak 6 qator × 2 = 12
  s2: {
    eyebrow: { ru: 'Перестановка', uz: "O'rin almashish", en: 'Swapping' },
    lead: { ru: 'Ещё пример: 2 × 6.', uz: "Yana misol: 2 × 6.", en: 'One more example: 2 × 6.' },
    info_badge: { ru: "Вспомним правило", uz: "Eslaymiz", en: 'Let us remember the rule' },
    info: { ru: '2 × 6 и 6 × 2 — это одно и то же: 12.', uz: "2 × 6 va 6 × 2 — bir xil: 12.", en: '2 × 6 and 6 × 2 are the same thing: 12.' },
    audio: {
      ru: [
        'Возьмём два ряда по шесть. Это два умножить на шесть, двенадцать.',
        'Повернём. Теперь шесть рядов по два. Кружочки те же.',
        'Всего опять двенадцать. Два на шесть равно шесть на два.'
      ],
      uz: [
        "Ikki qator, oltitadan olamiz. Bu ikki marta olti, o'n ikki.",
        "Buraymiz. Endi olti qator, ikkitadan. Doiralar o'sha-o'sha.",
        "Jami yana o'n ikki. Ikki marta olti, olti marta ikkiga teng."
      ],
      en: ['Let us take two rows of six. That is two multiplied by six, twelve.', 'Turn it round. Now it is six rows of two. The circles are the same ones.', 'There are twelve again. Two times six is the same as six times two.']
    }
  },

  // s3 — QOIDA: o'rin almashish (a×b = b×a) + check MC (6×2, chunki 2×6 ni bilamiz = 12)
  s3: {
    eyebrow: { ru: 'Правило', uz: 'Qoida', en: 'Rule' },
    rule: { ru: 'Порядок множителей не меняет произведение: a × b = b × a.', uz: "Ko'paytiruvchilar tartibi ko'paytmani o'zgartirmaydi: a × b = b × a.", en: 'The order does not change the answer: a × b = b × a.' },
    check_q: { ru: '2 × 6 = 12. Тогда 6 × 2 = ?', uz: "2 × 6 = 12. Unda 6 × 2 = ?", en: '2 × 6 = 12. So 6 × 2 = ?' },
    opts: [{ ru: '12', uz: '12', en: '12', ok: true }, { ru: '10', uz: '10', en: '10' }, { ru: '8', uz: '8', en: '8' }],
    wrong: { ru: 'Переставь множители — ответ тот же.', uz: "Ko'paytiruvchilarni o'rin almashtir — javob o'sha.", en: 'Swap the numbers round and the answer is the same.' },
    check_ok: { ru: 'Верно! 6 × 2 = 12, как и 2 × 6.', uz: "To'g'ri! 6 × 2 = 12, xuddi 2 × 6 kabi.", en: 'That is right! 6 × 2 = 12, just like 2 × 6.' },
    audio: {
      ru: [
        'Запишем правило. Слушай и запомни.',
        'Множители можно менять местами. Произведение не меняется.',
        'Если знаешь два на шесть, то знаешь и шесть на два.',
        'Проверь. Два на шесть это двенадцать. Тогда сколько шесть на два?'
      ],
      uz: [
        "Qoidani yozamiz. Tinglang va yodlang.",
        "Ko'paytiruvchilarni o'rin almashtirsa bo'ladi. Ko'paytma o'zgarmaydi.",
        "Ikki marta oltini bilsangiz, olti marta ikkini ham bilasiz.",
        "Tekshir. Ikki marta olti, o'n ikki. Unda olti marta ikki nechta?"
      ],
      en: ['Let us write down the rule. Listen and remember.', 'The numbers can swap places. The answer does not change.', 'If you know two times six, then you know six times two as well.', 'Check it. Two times six is twelve. So how much is six times two?']
    }
  },

  // s4 — TUSHUNTIRISH-3 (qulaylik sifatida qo'llash): qiyinni oson orqali — 7×2 ni 2×7 orqali + check
  s4: {
    eyebrow: { ru: 'Хитрость', uz: 'Qulaylik', en: 'A handy trick' },
    lead: { ru: 'Считай удобной стороной.', uz: "Qulay tomondan sanang.", en: 'Count it the easier way round.' },
    body: { ru: '9 × 2 кажется трудным. Но 2 × 9 посчитать легко: 9, 18. Значит и 9 × 2 = 18. Выбирай, как удобнее считать.', uz: "9 × 2 qiyin ko'rinadi. Lekin 2 × 9 ni sanash oson: 9, 18. Demak 9 × 2 = 18 ham. Qaysi tomondan sanash qulay — shundan sanang.", en: '9 × 2 looks hard. But 2 × 9 is easy to count: 9, 18. So 9 × 2 = 18 as well. Choose whichever way is easier to count.' },
    warn: { ru: 'Всегда можно взять ту сторону, что легче: 8 × 2 это 2 × 8.', uz: "Doim qulayroq tomonni olsa bo'ladi: 8 × 2 — bu 2 × 8.", en: 'You can always take the easier way round: 8 × 2 is the same as 2 × 8.' },
    check_q: { ru: '3 × 4 = 12. Тогда 4 × 3 = ?', uz: "3 × 4 = 12. Unda 4 × 3 = ?", en: '3 × 4 = 12. So 4 × 3 = ?' },
    opts: [{ ru: '12', uz: '12', en: '12', ok: true }, { ru: '10', uz: '10', en: '10' }, { ru: '7', uz: '7', en: '7' }],
    wrong: { ru: 'Переставь: 4 × 3 столько же, сколько 3 × 4.', uz: "O'rin almashtir: 4 × 3 — 3 × 4 bilan bir xil.", en: 'Swap them round: 4 × 3 is just as much as 3 × 4.' },
    check_ok: { ru: 'Верно! 4 × 3 = 12.', uz: "To'g'ri! 4 × 3 = 12.", en: 'That is right! 4 × 3 = 12.' },
    audio: {
      ru: [
        'Перестановку удобно использовать для счёта.',
        'Девять на два кажется трудным. А два на девять легко: девять, восемнадцать.',
        'Значит девять на два тоже восемнадцать. Бери сторону, что легче.',
        'Проверь. Три на четыре это двенадцать. Тогда сколько четыре на три?'
      ],
      uz: [
        "O'rin almashishni sanashda ishlatish qulay.",
        "To'qqiz marta ikki qiyin ko'rinadi. Ikki marta to'qqiz esa oson: to'qqiz, o'n sakkiz.",
        "Demak to'qqiz marta ikki ham o'n sakkiz. Qulay tomonni ol.",
        "Tekshir. Uch marta to'rt, o'n ikki. Unda to'rt marta uch nechta?"
      ],
      en: ['Swapping them round is handy when you count.', 'Nine times two looks hard. But two times nine is easy: nine, eighteen.', 'So nine times two is eighteen as well. Take whichever way is easier.', 'Check it. Three times four is twelve. So how much is four times three?']
    }
  },

  // sTBL — TUSHUNTIRISH: TO'LIQ ko'paytirish jadvali (1..9); simmetriya a×b = b×a (jadval oynasi kabi)
  sTBL: {
    eyebrow: { ru: 'Вся таблица', uz: "Butun jadval", en: 'The whole table' },
    lead: { ru: 'Вся таблица умножения', uz: "Butun ko'paytirish jadvali", en: 'The whole multiplication table' },
    info_badge: { ru: "Вспомним правило", uz: "Eslaymiz", en: 'Let us remember the rule' },
    info: { ru: 'Таблица симметрична: 3 × 5 и 5 × 3 — одна клетка.', uz: "Jadval simmetrik: 3 × 5 va 5 × 3 — bir katak.", en: 'The table is a mirror image: 3 × 5 and 5 × 3 give the same box.' },
    audio: {
      ru: [
        'Вот вся таблица умножения, от одного до девяти.',
        'Смотри: клетка три на пять и клетка пять на три дают одно и то же число.',
        'Поэтому учить нужно вдвое меньше. Эту таблицу можно открывать в помощь.'
      ],
      uz: [
        "Mana butun ko'paytirish jadvali, birdan to'qqizgacha.",
        "Qara: uch marta besh katagi va besh marta uch katagi bir xil sonni beradi.",
        "Shuning uchun ikki barobar kam yodlash kerak. Bu jadvalni yordam uchun ochsa bo'ladi."
      ],
      en: ['Here is the whole multiplication table, from one to nine.', 'Look, the box for three times five and the box for five times three give the same number.', 'So there is half as much to learn. You can open this table whenever you need help.']
    }
  },

  // s5 — MASHQ-single (COMMUTE teng?): 3×4 va 4×3 → Ha (o'rin almashish)
  s5: {
    eyebrow: { ru: 'Практика', uz: 'Mashq', en: 'Practice' },
    lead: { ru: 'Эти два равны?', uz: "Bu ikkalasi teng bo'ladimi?", en: 'Are these two equal?' },
    transition: { ru: 'Объяснение мы закончили. Теперь потренируйся: где равно, а где нет.', uz: "Tushuntirishni tugatdik. Endi mashq qiling: qayerda teng, qayerda yo'q.", en: 'We have finished explaining. Now practise: which ones are equal and which are not.' },
    a: 3, b: 4, e: 4, f: 3,
    wrong: { ru: 'Переставили множители — произведение то же.', uz: "Ko'paytiruvchilar o'rin almashdi — ko'paytma o'sha.", en: 'The numbers were swapped round, so the answer is the same.' },
    done_text: { ru: 'Верно! 3 × 4 = 4 × 3 = 12.', uz: "To'g'ri! 3 × 4 = 4 × 3 = 12.", en: 'That is right! 3 × 4 = 4 × 3 = 12.' },
    audio: {
      intro: { ru: 'Тренировка. Слева три на четыре, справа четыре на три. Они равны?', uz: "Mashq. Chapda uch marta to'rt, o'ngda to'rt marta uch. Ular teng bo'ladimi?", en: 'Practice. On the left three times four, on the right four times three. Are they equal?' },
      on_correct: { ru: 'Верно. Это одно и то же, двенадцать.', uz: "To'g'ri. Bu bir xil, o'n ikki.", en: 'That is right. They are the same thing, twelve.' },
      on_wrong: { ru: 'Переставили ряды и столбцы, всего столько же.', uz: "Qator va ustun o'rin almashdi, jami o'shancha.", en: 'The rows and the columns were swapped, and there are still just as many.' }
    }
  },
  ...
  // s7 — MASHQ (YETISHMAGAN KO'PAYTUVCHI, 3 round): 3×?=15, ?×5=15, 4×?=24 (natija ≤40)
  s7: {
    eyebrow: { ru: 'Найди множитель', uz: "Ko'paytiruvchini toping", en: 'Find the missing number' },
    lead: { ru: 'Какое число пропало?', uz: "Qaysi son yo'qolgan?", en: 'Which number is missing?' },
    rounds: [
      { known: 3, ans: 5, side: 'right', q: { ru: 'Сколько раз по 3 дают 15?', uz: "Nechta 3 talik qator 15 beradi?", en: 'How many times 3 makes 15?' } },
      { known: 5, ans: 3, side: 'left',  q: { ru: 'Сколько раз по 5, чтобы вышло 15?', uz: "Necha marta 5 olsak 15 chiqadi?", en: 'How many times 5 makes 15?' } },
      { known: 4, ans: 6, side: 'right', q: { ru: 'Сколько раз по 4 дают 24?', uz: "Nechta 4 talik qator 24 beradi?", en: 'How many times 4 makes 24?' } }
    ],
    ...
    audio: {
      ...
      on_correct: { ru: 'Верно.', uz: "To'g'ri.", en: 'Correct.' },
      on_wrong: { ru: 'Считай по группам, пока не выйдет нужное число.', uz: "Guruhlab sanang, kerakli son chiqquncha.", en: 'Count in groups until you reach the number you need.' }
    }
  },
  ...
  // s9 — MASHQ (ARRAY aralash jadval, 3 round)
  s9: {
    eyebrow: { ru: 'Практика', uz: 'Mashq', en: 'Practice' },
    lead: { ru: 'Сосчитай умножением.', uz: "Ko'paytirib sanang.", en: 'Count it by multiplying.' },
    rounds: [ { r: 3, c: 7 }, { r: 4, c: 6 }, { r: 2, c: 9 } ],
    wrong: { ru: 'Смотри, сколько рядов и по сколько в ряду.', uz: "Necha qator va nechtadan ekanini qarang.", en: 'Look at how many rows there are and how many are in each row.' },
    done_text: { ru: 'Верно!', uz: "To'g'ri!", en: 'Correct!' },
    audio: {
      intro: { ru: 'Вся таблица вперемешку. Считай ряды умножением.', uz: "Butun jadval aralash. Qatorlarni ko'paytirib sanang.", en: 'The whole table mixed up. Count the rows by multiplying.' },
      on_correct: { ru: 'Верно.', uz: "To'g'ri.", en: 'Correct.' },
      on_wrong: { ru: 'Сколько рядов, столько раз бери число.', uz: "Necha qator, shuncha marta sonni oling.", en: 'However many rows there are, take the number that many times.' }
    }
  },

  // s10 — MASHQ (COMMUTE teng?, 3 round)
  s10: {
    eyebrow: { ru: 'Практика', uz: 'Mashq', en: 'Practice' },
    lead: { ru: 'Эти два равны?', uz: "Bu ikkalasi teng bo'ladimi?", en: 'Are these two equal?' },
    rounds: [ { a: 5, b: 3, e: 3, f: 5 }, { a: 4, b: 6, e: 6, f: 4 }, { a: 8, b: 2, e: 2, f: 9 } ],
    wrong: { ru: 'Проверь множители в обоих.', uz: "Ikkalasidagi ko'paytiruvchilarni tekshiring.", en: 'Check the numbers in both of them.' },
    done_text: { ru: 'Верно!', uz: "To'g'ri!", en: 'Correct!' },
    audio: {
      intro: { ru: 'Снова: равны или нет? Смотри на множители.', uz: "Yana: teng yoki yo'q? Ko'paytiruvchilarga qarang.", en: 'Again: equal or not? Look at the numbers.' },
      on_correct: { ru: 'Верно.', uz: "To'g'ri.", en: 'Correct.' },
      on_wrong: { ru: 'Если множители не те же, не равны.', uz: "Ko'paytiruvchilar o'sha bo'lmasa, teng emas.", en: 'If the numbers are not the same, they are not equal.' }
    }
  },

  // s11 — MASHQ (ORTIQCHASINI TOP, 3 round): 3 ifoda nishonga TENG (o'rin almashgan juftlar), biri EMAS.
  s11: {
    ...
    rounds: [
      { target: 24, exprs: [{ a: 4, b: 6 }, { a: 6, b: 4 }, { a: 3, b: 8 }, { a: 5, b: 5 }], q: { ru: 'Что НЕ равно 24?', uz: "Qaysi biri 24 ga TENG EMAS?", en: 'Which one is NOT equal to 24?' } },
      { target: 12, exprs: [{ a: 3, b: 4 }, { a: 4, b: 3 }, { a: 2, b: 6 }, { a: 5, b: 3 }], q: { ru: 'Что НЕ равно 12?', uz: "Qaysi biri 12 ga TENG EMAS?", en: 'Which one is NOT equal to 12?' } },
      { target: 18, exprs: [{ a: 3, b: 6 }, { a: 6, b: 3 }, { a: 2, b: 9 }, { a: 4, b: 5 }], q: { ru: 'Что НЕ равно 18?', uz: "Qaysi biri 18 ga TENG EMAS?", en: 'Which one is NOT equal to 18?' } }
    ],
  ...
  s12: {
    ...
    lead: { ru: 'Зухра расставляет ящики.', uz: "Zuhra qutilarni teradi.", en: 'Zuhra is stacking boxes.' },
    manifest_label: { ru: 'ящики', uz: 'quti', en: 'boxes' },
    audio: {
      ru: 'Зухра ставит ровные ряды ящиков.',
      uz: "Zuhra qutilarni teng qatorlarga teradi.",
      en: 'Zuhra is stacking the boxes in even rows.'
    }
  },

  // s13 — MASALA (scored, array): Zuhra qutilarni terdi 4 qator × 6 = 24 (ombor)
  s13: {
    eyebrow: { ru: 'Задача', uz: 'Masala', en: 'Word problem' },
    lead: { ru: 'Помоги Зухре.', uz: "Zuhraga yordam bering.", en: 'Help Zuhra.' },
    story: { ru: 'Зухра сложила ящики: 4 ряда по 6. Сколько всего?', uz: "Zuhra qutilarni terdi: 4 qator, 6 tadan. Jami nechta?", en: 'Zuhra stacked the boxes: 4 rows of 6. How many are there in all?' },
    r: 4, c: 6,
    ...
    audio: {
      intro: { ru: 'Помоги Зухре. Она сложила ящики: четыре ряда, в каждом по шесть. Сколько всего? Сосчитай умножением.', uz: "Zuhraga yordam bering. U qutilarni terdi: to'rtta qator, har birida oltitadan. Jami nechta? Ko'paytirib sanang.", en: 'Help Zuhra. She stacked the boxes in four rows with six in each. How many are there in all? Count them by multiplying.' },
      on_correct: { ru: 'Верно. У Зухры двадцать четыре ящика.', uz: "To'g'ri. Zuhrada yigirma to'rt quti.", en: 'That is right. Zuhra has twenty four boxes.' },
  ...
  // s14 — FINAL (scored, ARALASH 3 round: TENG? (commute) + ortiqchasini top + moslash) + FactCard Yupiter.
  // FinalMixStage round.kind bo'yicha body tanlaydi (commute / oddone / match). Kommutativlik birinchi raund.
  s14: {
    eyebrow: { ru: 'Финал', uz: 'Final', en: 'Final' },
    lead: { ru: 'Финальная проверка.', uz: "Yakuniy tekshiruv.", en: 'The final check.' },
    rounds: [
      { kind: 'commute', a: 4, b: 6, e: 6, f: 4, q: { ru: 'Эти два равны?', uz: "Bu ikkalasi teng bo'ladimi?", en: 'Are these two equal?' } },
      { kind: 'oddone', target: 18, exprs: [{ a: 3, b: 6 }, { a: 6, b: 3 }, { a: 2, b: 9 }, { a: 4, b: 5 }], q: { ru: 'Что НЕ равно 18?', uz: "Qaysi biri 18 ga TENG EMAS?", en: 'Which one is NOT equal to 18?' } },
      { kind: 'match', pairs: [{ num: 15, form: '3 × 5' }, { num: 24, form: '4 × 6' }, { num: 12, form: '2 × 6' }, { num: 20, form: '5 × 4' }] }
    ],
    wrong: { ru: 'Проверь внимательно каждую запись.', uz: "Har yozuvni diqqat bilan tekshiring.", en: 'Check each sum carefully.' },
    done_text: { ru: 'Верно!', uz: "To'g'ri!", en: 'Correct!' },
    ...
    audio: {
      intro: { ru: 'Финальная проверка. Три разных задания вперемешку. Считай верно.', uz: "Yakuniy tekshiruv. Uchta har xil topshiriq aralash. To'g'ri sanang.", en: 'The final check. Three different tasks mixed up. Count carefully.' },
      on_correct: { ru: 'Верно.', uz: "To'g'ri.", en: 'Correct.' },
      on_wrong: { ru: 'Проверь внимательно и посчитай ещё раз.', uz: "Diqqat bilan tekshiring va yana sanang.", en: 'Check it carefully and work it out again.' }
    }
  },
  ...
  s15: {
    ...
    cando: { ru: 'Теперь ты знаешь всю таблицу и умеешь переставлять множители!', uz: "Endi siz butun jadvalni bilasiz va ko'paytiruvchilarni o'rin almashtira olasiz!", en: 'Now you know the whole table and you can swap the numbers round!' },
    // QOIDA recap (ko'rinadigan):
    rule_recap: { ru: 'Порядок множителей не меняет ответ: a × b = b × a. Считай удобной стороной.', uz: "Ko'paytiruvchilar tartibi javobni o'zgartirmaydi: a × b = b × a. Qulay tomondan sanang.", en: 'The order does not change the answer: a × b = b × a. Count it the easier way round.' },
    conn_label_refs: { ru: 'Опирается на', uz: 'Tayanadi', en: 'Builds on' },
    conn_refs: { ru: 'уроки 13–17: вся таблица умножения', uz: "13–17-darslar: butun ko'paytirish jadvali", en: 'lessons 13-17: the whole multiplication table' },
    conn_label_next: { ru: 'Дальше', uz: 'Keyingi', en: 'Next' },
    conn_next: { ru: 'дальше: деление', uz: "keyingi: bo'lish", en: 'next: dividing' },
    audio: {
      ru: 'Миссия выполнена. Мы закрепили всю таблицу умножения и узнали важное правило. Порядок множителей не меняет ответ: три на пять равно пять на три. Можно считать той стороной, что удобнее. Груз на корабле разложен по ящикам. Дальше научимся делить.',
      uz: "Missiya bajarildi. Butun ko'paytirish jadvalini mustahkamladik va muhim qoidani bildik. Ko'paytiruvchilar tartibi javobni o'zgartirmaydi: uch marta besh, besh marta uchga teng. Qulay tomondan sanash mumkin. Kemadagi yuk qutilarga terildi. Keyin bo'lishni o'rganamiz.",
      en: 'Mission complete. We practised the whole multiplication table and learned an important rule. The order does not change the answer: three times five is the same as five times three. You can count whichever way is easier. The cargo on the ship is packed into boxes. Next we will learn to divide.'
    }
  }
};
...
const BRIDGES = {
  s1:  { ru: 'Повернём массив и посмотрим.', uz: "Massivni burib ko'ramiz.", en: 'Let us turn the array round and see.' },
  s2:  { ru: 'Возьмём ещё пример.', uz: 'Yana bir misol olamiz.', en: 'Let us take one more example.' },
  s3:  { ru: 'Запишем это правилом.', uz: 'Buni qoida qilib olamiz.', en: 'Let us write this down as a rule.' },
  s4:  { ru: 'Пригодится для счёта.', uz: 'Sanashda asqotadi.', en: 'It comes in handy when counting.' },
  sTBL: { ru: 'Посмотрим всю таблицу.', uz: 'Butun jadvalga qaraymiz.', en: 'Let us look at the whole table.' },
  ...
  s7:  { ru: 'Найди пропавшее число.', uz: "Yo'qolgan sonni toping.", en: 'Find the missing number.' },
  s8:  { ru: 'Соедини записи с ответами.', uz: "Yozuvlarni javob bilan tutashtir.", en: 'Match the sums with the answers.' },
  s9:  { ru: 'Вся таблица вперемешку.', uz: "Butun jadval aralash.", en: 'The whole table mixed up.' },
  s10: { ru: 'Ещё про равенство.', uz: 'Yana tenglik haqida.', en: 'More about being equal.' },
  s11: { ru: 'Найди лишнюю запись.', uz: 'Ortiqcha yozuvni toping.', en: 'Find the odd one out.' },
  s12: { ru: 'Зухра складывает ящики.', uz: 'Zuhra qutilarni teradi.', en: 'Zuhra is stacking the boxes.' },
  ...
  s15: { ru: 'Груз разложен по ящикам!', uz: "Yuk qutilarga terildi!", en: 'The cargo is packed into boxes!' }
};

// s15 payoff (xulosadan oldin aytiladi)
const S15_PAYOFF = {
  ru: 'Ящики в трюме корабля сосчитаны умножением. У этой огромной планеты впереди новые задачи! Спасибо за помощь.',
  uz: "Kema omboridagi qutilar ko'paytirib sanaldi. Bu ulkan sayyora atrofida yangi masalalar oldinda! Yordamingiz uchun rahmat.",
  en: "The boxes in the ship's hold are counted by multiplying. New tasks lie ahead at this huge planet! Thank you for your help."
};
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 2.2vw, 16px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ padding: 'clamp(8px, 1.8vw, 14px)', overflow: 'hidden' }}>
          <YupiterScene answer={picked !== null ? 15 : null}/>
        </div>
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        <div className="frame fade-up delay-1" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 'clamp(12px, 2.4vw, 18px)', padding: 'clamp(16px, 3vw, 24px)', minHeight: 'clamp(200px, 46vw, 280px)' }}>
          <CommuteViz r={2} c={6} reveal={reveal}/>
        </div>
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <CommuteViz r={2} c={6} reveal={done ? 2 : 1}/>
        </div>
  ...
  return (
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <CommuteViz r={2} c={9} reveal={reveal}/>
        </div>
  ...
  return (
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 2.4vw, 16px)', position: 'relative' }}>
        ...
        {/* Yakun sahnasi: yuk bo'limidа qutilar ko'paytirib sanaldi (3×5=15) + ✓ */}
        <div className="fade-up delay-1">
          <YupiterField label={{ ru: 'Ящики сосчитаны', uz: 'Qutilar sanaldi', en: 'The boxes are counted' }}/>
        </div>
      </div>
    </Stage>
  );
...
// R qator × C quti; bola bir qatorni sanaydi → teng qatorlar → takroriy qo'shish
// (C+C+C) → «R marta C» = «R × C». ArrayViz reveal 0-3. Mashq: ArrayStage (bitta MC + reveal).
// ============================================================
// CrateCell — ixcham 3D yuk qutisi (massiv katagi + sahna rekviziti): old yuz + qopqoq (yuqoridan) +
// tasma-xoch + markaziy yorliq. SIMMETRIK: massiv burilganda (R×C ↔ C×R) ikkala orientatsiyada ham
// toza ko'rinadi (kommutativlik). s number yoki '100%' (clamp-wrapper ichida). tint/edge — quti rangi.
// (E'tibor: s0 Mars-sahnasidagi CargoCrate — boshqa, raqamli konteyner komponenti.)
const CrateCell = ({ s = 24, tint = '#C98A3C', edge = '#7A4E1A' }) => (
  <svg viewBox="0 0 30 30" width={s} height={s} aria-hidden="true" style={{ display: 'block', overflow: 'visible' }}>
    <ellipse cx="15" cy="27.6" rx="10.5" ry="1.9" fill="rgba(0,0,0,0.26)"/>
    {/* qopqoq (yuqori yuz — trapetsiya) */}
    <path d="M5 9.5 L9 5 L21 5 L25 9.5 Z" fill={tint} stroke={edge} strokeWidth="0.8"/>
    <path d="M5 9.5 L9 5 L21 5 L25 9.5 Z" fill="rgba(255,255,255,0.30)"/>
    {/* old yuz */}
    <rect x="5" y="9.5" width="20" height="16.6" rx="1.2" fill={tint} stroke={edge} strokeWidth="0.9"/>
    {/* pastki soya */}
    <rect x="5" y="21.4" width="20" height="4.7" rx="1.2" fill="rgba(0,0,0,0.15)"/>
    {/* tasma — vertikal + gorizontal (xoch) */}
    <rect x="13.3" y="9.5" width="3.4" height="16.6" fill="rgba(0,0,0,0.22)"/>
    <rect x="5" y="15.2" width="20" height="3.2" fill="rgba(0,0,0,0.22)"/>
    {/* markaziy yorliq (yuk muhri) */}
    <rect x="11.6" y="14" width="6.8" height="5.6" rx="0.9" fill="#F4ECD8" stroke={edge} strokeWidth="0.5"/>
    <rect x="12.8" y="15.5" width="4.4" height="0.9" rx="0.45" fill={edge} opacity="0.6"/>
    <rect x="12.8" y="17.2" width="3" height="0.9" rx="0.45" fill={edge} opacity="0.4"/>
    {/* yuqori qirra yorug'i */}
    <rect x="6.2" y="9.7" width="17.6" height="1.3" rx="0.65" fill="rgba(255,255,255,0.4)"/>
  </svg>
);
const ARR_CELL = 'clamp(20px,4.8vw,30px)';
// ArrayViz — variant 'geo' (po'lat-ko'k yuk qutilari massivi — tushuntirish/mashq) yoki
// 'plant' (amber yuk qutilari, yakuniy test-kadr). Har ikki variantда katak = CrateCell.
// reveal 0-3: massiv→qator-struktura→takroriy qo'shish→R×C.
const ArrayViz = ({ r, c, reveal = 0, variant = 'geo' }) => {
  ...
  const rowBg = plant ? 'rgba(255,220,120,0.1)' : 'rgba(90,214,180,0.1)';
  const crateTint = plant ? '#D79A45' : '#6E93B4';
  const crateEdge = plant ? '#7A4E1A' : '#3B566B';
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(8px,1.8vw,12px)' }}>
      {/* massiv — teng qatorlar (yuk qutilari) */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: plant ? 'clamp(4px,1.2vw,7px)' : 'clamp(5px,1.4vw,9px)', padding: 'clamp(9px,2.2vw,15px)', borderRadius: 14, background: plant ? 'linear-gradient(180deg,#241C15,#12100B)' : 'linear-gradient(180deg,#122234,#0A1420)', border: `2px solid ${plant ? '#3A2A18' : '#243C52'}`, boxShadow: 'inset 0 2px 10px rgba(0,0,0,0.5), 0 0 0 1px rgba(90,180,220,0.14)' }}>
          ...
          <div key={ri} style={{ display: 'flex', gap: plant ? 'clamp(3px,1vw,6px)' : 'clamp(6px,1.6vw,11px)', justifyContent: 'center', alignItems: 'center', padding: '2px clamp(5px,1.4vw,9px)', borderRadius: 8, background: reveal >= 1 ? rowBg : 'transparent', boxShadow: reveal >= 1 ? `inset 0 0 0 1.5px ${rowHi}` : 'none', transition: 'all .3s' }}>
            {Array.from({ length: c }).map((_, ci) => (
              <span key={ci} style={{ width: ARR_CELL, height: ARR_CELL, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                <CrateCell s={26} tint={crateTint} edge={crateEdge}/>
              </span>))}
          </div>
        ))}
      </div>
...
// MiniArray katagi = kichik CrateCell. Massiv burilganda (R×C ↔ C×R) quti simmetrik — toza ko'rinadi.
const MiniArray = ({ rows, cols }) => (
  <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(3px,1vw,5px)', padding: 'clamp(6px,1.6vw,10px)', borderRadius: 11, background: 'linear-gradient(180deg,#1B2A36,#0C161E)', border: '2px solid #2C4658', boxShadow: 'inset 0 2px 8px rgba(0,0,0,0.5)' }}>
    {Array.from({ length: rows }).map((_, ri) => (
      <div key={ri} style={{ display: 'flex', gap: 'clamp(3px,1.1vw,6px)', justifyContent: 'center' }}>
        {Array.from({ length: cols }).map((_, ci) => (
          <span key={ci} style={{ width: 'clamp(13px,3.1vw,18px)', height: 'clamp(13px,3.1vw,18px)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}><CrateCell s="100%" tint="#D79A45" edge="#7A4E1A"/></span>
        ))}
      </div>
    ))}
  </div>
...
// A11 → OddOneStage, A14 → FinalMixStage (D14 turlari); wrapperlar pastroqда (BodyStage blokidan keyin).
...
// A8 → MatchStage (D14 turi); wrapper commute/oddone/final bloki bilan birga pastroqda.
...
const A5 = (props) => <CommuteStage props={props} cKey="s5"/>;
const A10 = (props) => <CommuteStage props={props} cKey="s10"/>;

// ============================================================
// D14'DAN KO'CHIRILGAN TEST-TURLARI — test-format xilma-xilligi (metodist 2026-07-16).
// Kommutativlik IMZO-mexanikasi (CommuteStage: A5/A10) DOMINANT qoladi; bu turlar uni
// almashtirmaydi, faqat A7/A8/A11/A14 slaydlariga xilma-xillik qo'shadi.
// BodyStage — umumiy raund-o'ramchi (audio + raund-boshqaruv + hisobot + jadval-yordamchi).
  ...
  return (
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        {rounds.length > 1 && <RoundDots ri={ri} total={rounds.length}/>}
        {renderBody(ctx)}
        {/* KO'PAYTIRISH JADVALI yordamchisi — dars imzosi (o'quvchi jadvalni ochib ishlata oladi) */}
        <div className="fade-up" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(7px,1.6vw,11px)' }}>
          <button onClick={() => setShowTable((s) => !s)} style={{ padding: 'clamp(8px,1.7vw,12px) clamp(16px,3vw,22px)', fontSize: 'clamp(13px,1.9vw,15px)', fontWeight: 800, display: 'inline-flex', alignItems: 'center', gap: 8, color: T.accent, background: '#FFF3EC', border: '2px solid #fe5b1a', borderRadius: 999, cursor: 'pointer', transition: 'all .2s', boxShadow: showTable ? 'none' : '0 3px 12px -4px rgba(254,91,26,0.45)' }}>
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontWeight: 800, color: T.accent }}>×</span>{showTable ? t(TBL_HIDE) : t(TBL_SHOW)}
          </button>
...
// ── MissingFactorBody — «YETISHMAGAN KO'PAYTUVCHI»: a × ? = p yoki ? × a = p.
// round = { known, ans, side:'right'|'left', q }. product = known*ans (DISPLAY). MC = yetishmagan
// ko'paytuvchini tanlash (tap-birinchi). Distraktor: qo'shni ko'paytuvchi (ans±1) + mahsulot-ayirma.
...
// ── MultOddOneBody — «ORTIQCHASINI TOP» (odd-one-out): 4 ifodadan 3 tasi nishonga TENG, biri EMAS.
// Kommutativlikка mos: o'rin almashgan juftlar (4×6, 6×4) bir xil, biri farq. round = { target, exprs:[{a,b}×4], q }.
// To'g'ri -> ortiqcha QIZIL (haqiqiy natijasi), qolgani YASHIL (=nishon). Xato -> «Maslahat». Ifoda `a × b` — DISPLAY.
...
// ── CommuteBody — «TENG?» commute mexanikasi BodyStage-mos ko'rinishда (FinalMix uchun). round = { a,b,e,f,q }.
const CommuteBody = ({ round, canAct, onSolved, onWrongTry, revealRef, wrongText, doneText }) => {
  const t = useT();
  const sfx = useSfx();
  const p1 = round.a * round.b, p2 = round.e * round.f;
  const isEqual = p1 === p2;
  const [solved, setSolved] = useState(false);
  const [wrong, setWrong] = useState(false);
  const wrongRef = useRef(0);
  const pick = (choiceYes) => {
    if (!canAct || solved) return;
    const ok = choiceYes === isEqual;
    if (ok) { sfx.playCorrect(); setSolved(true); onSolved(wrongRef.current === 0, isEqual ? 'ha' : 'yoq'); }
    else { sfx.playWrong(); wrongRef.current += 1; setWrong(true); onWrongTry(); }
  };
  const pairLabel = (a, b) => (
    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontWeight: 800, fontSize: 'clamp(14px,2.6vw,20px)', color: '#2FB584' }}>{a} × {b}</span>
  );
  return (
    <>
      <div className="frame fade-up delay-1" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: 'clamp(12px, 2.4vw, 18px)', overflowX: 'auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 'clamp(8px,2vw,16px)', justifyContent: 'center' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}><MiniArray rows={round.a} cols={round.b}/>{pairLabel(round.a, round.b)}{solved && <span className="mono" style={{ color: T.ink3, fontWeight: 800 }}>{p1}</span>}</div>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontWeight: 800, fontSize: 'clamp(20px,4.6vw,30px)', color: solved ? (isEqual ? T.success : '#C1381A') : T.ink3 }}>{solved ? (isEqual ? '=' : '≠') : '?'}</span>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}><MiniArray rows={round.e} cols={round.f}/>{pairLabel(round.e, round.f)}{solved && <span className="mono" style={{ color: T.ink3, fontWeight: 800 }}>{p2}</span>}</div>
        </div>
      </div>
      {!solved && (
        <>
          <p className="mono fade-up" style={{ margin: 0, fontWeight: 700, color: T.accent, fontSize: 'clamp(13px,1.9vw,15px)', textAlign: 'center' }}>{t(round.q || COMMUTE_Q)}</p>
          <div className="fade-up" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'clamp(8px,1.6vw,12px)' }}>
            <button className="option" disabled={!canAct} onClick={() => pick(true)} style={ARR_OPT}>{t(YESNO.yes)}</button>
            <button className="option" disabled={!canAct} onClick={() => pick(false)} style={ARR_OPT}>{t(YESNO.no)}</button>
          </div>
      ...
      {wrong && !solved && <div className="frame-tip fade-up"><Reaction state="wrong" praise={wrongText}/></div>}
      {solved && <div ref={revealRef} className="frame-success fade-up"><Reaction state="correct" praise={doneText}/></div>}
    </>
  );
};
...
// sirt yo'q, kema QO'NA OLMAYDI. Shuning uchun ekipaj Yupiter ORBITASIDA uchadi,
// yuk KEMA ICHIDAGI YUK BO'LIMIDA (teng qator-paletkalarda) terib joylanadi; Yupiter ILLYUMINATORdan ko'rinadi.
// ============================================================
...
// Yuk-kran ilgagi — shiftdan trosda tushadi, uchida kichik konteyner; sekin tebranadi (d13-vine).
const CraneHook = ({ flip = false }) => (
  <svg viewBox="0 0 22 74" width="100%" style={{ display: 'block', overflow: 'visible', transform: flip ? 'scaleX(-1)' : 'none' }} aria-hidden="true">
    <line x1="11" y1="0" x2="11" y2="30" stroke="#7E8894" strokeWidth="2"/>
    <path d="M11 30 q6 5 0 11 q-6 6 1 11" stroke="#B7BFC9" strokeWidth="2.4" fill="none" strokeLinecap="round"/>
    <rect x="4" y="49" width="14" height="12" rx="1.6" fill="#C98A3C" stroke="#7A4E1A" strokeWidth="0.9"/>
    <rect x="4" y="53.5" width="14" height="3" fill="rgba(0,0,0,0.22)"/>
    <rect x="9.6" y="49" width="2.8" height="12" fill="rgba(0,0,0,0.22)"/>
    <rect x="5" y="49.4" width="12" height="1.1" rx="0.5" fill="rgba(255,255,255,0.4)"/>
  </svg>
);
// Bitta paletka-qatori (yuk rafi): metall raf + n ta yuk qutisi teng qatorda (bayramда sakraydi).
const CrateRow = ({ n = 4, celebrate = false, ri = 0 }) => (
  <div style={{ position: 'relative', display: 'flex', gap: 'clamp(5px,1.6vw,10px)', justifyContent: 'center', padding: '0 clamp(10px,2.6vw,16px) clamp(6px,1.6vw,9px)', borderRadius: '4px 4px 6px 6px', background: 'linear-gradient(180deg,#8A94A2 0%,#5C6672 42%,#3A424C 100%)', boxShadow: 'inset 0 -3px 5px rgba(0,0,0,0.45), inset 0 2px 2px rgba(255,255,255,0.22), 0 4px 8px rgba(0,0,0,0.45)', border: '1.5px solid #232A32', borderTop: '3px solid #AEB6C0' }}>
    {/* raf yuzasi (rifli metall) */}
    <div style={{ position: 'absolute', left: 4, right: 4, top: 3, height: 'clamp(4px,1.1vw,7px)', borderRadius: 2, background: 'repeating-linear-gradient(90deg,#3A424C 0 4px,#2A313A 4px 8px)', boxShadow: 'inset 0 1px 3px rgba(0,0,0,0.5)' }}/>
    {Array.from({ length: n }).map((_, ci) => (
      <span key={ci} className={celebrate ? 'g1-pop-in' : ''} style={{ width: 'clamp(19px,4.8vw,29px)', marginTop: 'clamp(-15px,-3.4vw,-12px)', zIndex: 1, animationDelay: celebrate ? `${0.2 + (ri * 4 + ci) * 0.05}s` : undefined }}>
        <CrateCell s="100%" tint="#D79A45" edge="#7A4E1A"/>
      </span>
    ))}
  </div>
);
// Burchak yuk-uyumi (floor burchagi — dekorativ, sanaladigan qatorlardan farqli): uch quti ustma-ust.
const StackedCrates = ({ w = 44 }) => (
  <div style={{ width: w, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(1px,0.4vw,3px)' }} aria-hidden="true">
    <div style={{ width: '58%' }}><CrateCell s="100%" tint="#C98A3C" edge="#7A4E1A"/></div>
    <div style={{ display: 'flex', gap: 'clamp(1px,0.4vw,3px)', width: '100%', justifyContent: 'center' }}>
      <div style={{ width: '50%' }}><CrateCell s="100%" tint="#B87C34" edge="#6E4418"/></div>
      <div style={{ width: '50%' }}><CrateCell s="100%" tint="#D79A45" edge="#7A4E1A"/></div>
    </div>
  </div>
);
// Shiftdan osilgan yuk-konteyner (strap bilan osilgan, pastida ilmoq).
const CargoNet = ({ w = 32 }) => (
  <svg viewBox="0 0 34 58" width={w} style={{ display: 'block', overflow: 'visible' }} aria-hidden="true">
    <path d="M17 0 L10 16 M17 0 L24 16" stroke="#7E8894" strokeWidth="1.4"/>
    <rect x="7" y="16" width="20" height="18" rx="2" fill="#C98A3C" stroke="#7A4E1A" strokeWidth="1"/>
    <rect x="7" y="23" width="20" height="3.4" fill="rgba(0,0,0,0.22)"/>
    <rect x="15.4" y="16" width="3.2" height="18" fill="rgba(0,0,0,0.22)"/>
    <rect x="8" y="16.5" width="18" height="1.4" rx="0.7" fill="rgba(255,255,255,0.4)"/>
    <path d="M13 34 q4 6 8 0" stroke="#6A7480" strokeWidth="1.2" fill="none"/>
  </svg>
);
// KEMA YUK BO'LIMI (Yupiter orbitasida) — SANOAT-TEXNIK interyer: shift + yon devor + pol yorug' metall;
// PANORAMA OYNA (illyuminator) da koinot + Yupiter (faqat oyna ichi qorong'i). Shiftga o'rnatilgan
// ish-chiroqlari (amber). Raf-stelaj, yuk-kran ilgagi, konteyner, paletka + markaziy 3×5 quti-massiv
// (sanaladigan). Issiqxona (grow-lampa/o'simlik/yashil tus) YO'Q. Element jonli/3D (halo/yo'ldosh/nur/suzish).
// Devor rafi (ikki qavat) — har qavatда kichik yuk qutilari.
const CargoRack = () => (
  <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(4px,1.1vw,7px)' }}>
    {[0, 1].map((sh) => (
      <div key={sh} style={{ position: 'relative', width: 'clamp(30px,7.6vw,46px)', height: 'clamp(15px,3.6vw,22px)', borderRadius: '2px 2px 3px 3px', background: 'linear-gradient(180deg,#7E8894,#4A525C)', border: '1px solid #2A313A', boxShadow: '0 2px 3px rgba(0,0,0,0.4)', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-around', padding: '0 2px 2px' }}>
        <div style={{ position: 'absolute', left: 2, right: 2, top: 2, height: '30%', borderRadius: 2, background: 'repeating-linear-gradient(90deg,#3A424C 0 3px,#2A313A 3px 6px)' }}/>
        {[0, 1, 2].map((i) => <span key={i} style={{ width: 'clamp(7px,1.8vw,11px)', height: '76%', zIndex: 1 }}><CrateCell s="100%" tint={i % 2 ? '#C98A3C' : '#B87C34'} edge="#6E4418"/></span>)}
      </div>
    ))}
  </div>
);
// Yuk aravasi (dolly) — ikki g'ildirak + tik ramka + ustidagi quti (floorда rekvizit).
const Dolly = ({ w }) => (
  <svg viewBox="0 0 42 42" width={w} style={{ display: 'block', overflow: 'visible' }} aria-hidden="true">
    <path d="M10 3 L10 34 M16 3 L16 34" stroke="#6A7480" strokeWidth="2" strokeLinecap="round"/>
    <path d="M10 34 L30 34" stroke="#6A7480" strokeWidth="2" strokeLinecap="round"/>
    <rect x="12" y="9" width="20" height="16" rx="1.5" fill="#C98A3C" stroke="#7A4E1A" strokeWidth="1"/>
    <rect x="12" y="15" width="20" height="3" fill="rgba(0,0,0,0.22)"/>
    <rect x="20.4" y="9" width="3.2" height="16" fill="rgba(0,0,0,0.22)"/>
    <rect x="13" y="9.4" width="18" height="1.2" rx="0.6" fill="rgba(255,255,255,0.4)"/>
    <circle cx="12" cy="36" r="4.6" fill="#2A313A" stroke="#565E68" strokeWidth="1.4"/><circle cx="12" cy="36" r="1.6" fill="#565E68"/>
  </svg>
);
// (WaterTank/GardenDrone/ScenePlant — o'simlik-rekvizit — YUK BO'LIMI retemasida olib tashlandi.)
// Harorat-namlik klimat-paneli (devor — sovutilgan yuk uchun).
const SensorPanel = ({ w }) => (
...
// (Butterfly — kapalak — YUK BO'LIMI retemasida olib tashlandi; o'rniga suzuvchi qutilar.)
...
const CARGO_LIGHTS = [22, 50, 78];
const CargoHold = ({ arrive = false, celebrate = false, bubbleNode, charNode }) => (
  <div className="d2-scene" style={{ background: 'linear-gradient(180deg,#E6ECF2 0%,#D4DCE6 52%,#BEC8D4 100%)' }}>
    {/* SHIFT (yorug') + ogohlantirish-tasma (yuk-zonasi) */}
    <div style={{ position: 'absolute', left: 0, right: 0, top: 0, height: '11%', background: 'linear-gradient(180deg,#EEF2F6,#C4CCD6)', boxShadow: '0 3px 8px rgba(0,0,0,0.16)', zIndex: 6 }}>
      <div style={{ position: 'absolute', left: '7%', right: '7%', bottom: 2, height: 'clamp(4px,1vw,7px)', borderRadius: 3, background: 'repeating-linear-gradient(45deg,#E8B84A 0 9px,#2A313A 9px 18px)' }}/>
    </div>
    ...
    {/* SHIFT ISH-CHIROQLARI — amber sanoat panellari + yumshoq nur-konus (grow-lampa/sim/tomchi EMAS) */}
    {CARGO_LIGHTS.map((x, i) => (
      <React.Fragment key={i}>
        <div style={{ position: 'absolute', left: `${x}%`, top: '12.5%', transform: 'translateX(-50%)', zIndex: 3, width: 'clamp(46px,12vw,74px)', height: 'clamp(6px,1.6vw,10px)', borderRadius: 3, background: 'linear-gradient(180deg,#FFF4DC,#F0C878)', border: '1px solid #C79A54', boxShadow: '0 2px 6px rgba(0,0,0,0.18), 0 0 14px 3px rgba(255,210,130,0.6)' }}>
          <div className="d13-glow" style={{ position: 'absolute', inset: '1.5px 4px', borderRadius: 2, background: 'linear-gradient(180deg,#FFFFFF,#FFE7B0)' }}/>
        </div>
        <div className="d13-beam" aria-hidden="true" style={{ position: 'absolute', left: `${x}%`, top: '13%', transform: 'translateX(-50%)', zIndex: 2, width: 'clamp(72px,20vw,120px)', height: 'clamp(50px,15vw,92px)', background: 'radial-gradient(ellipse at 50% 0%, rgba(255,220,150,0.28), transparent 70%)', pointerEvents: 'none' }}/>
      </React.Fragment>
    ))}
    {/* YUK-KRAN ILGAGI + osilgan konteyner (o'ng, shiftdan) */}
    <div className="d13-vine" style={{ position: 'absolute', right: '23%', top: '10%', width: 'clamp(18px,4.8vw,28px)', transformOrigin: '50% 0%', zIndex: 6, animationDuration: '5.6s' }}><CraneHook flip/></div>
    <div className="d13-vine d13-vine2" style={{ position: 'absolute', right: '6.5%', top: '10%', width: 'clamp(24px,6.4vw,40px)', transformOrigin: '50% 0%', zIndex: 6 }}><CargoNet w="100%"/></div>
    {/* DEVOR RAFI (o'ng yon, kattaroq) */}
    <div style={{ position: 'absolute', right: '0.5%', top: '25%', transform: 'scale(1.32)', transformOrigin: 'right top', zIndex: 4 }}><CargoRack/></div>
    {/* O'NG BURCHAK YUK-UYUMI + yuk aravasi */}
    <div style={{ position: 'absolute', right: '2%', bottom: '2%', width: 'clamp(40px,10.4vw,64px)', zIndex: 4 }}><StackedCrates w="100%"/></div>
    <div style={{ position: 'absolute', right: '18%', bottom: '3%', width: 'clamp(32px,8vw,50px)', zIndex: 4 }}><Dolly w="100%"/></div>
    {/* KLIMAT-PANEL (o'ng devor) */}
    <div style={{ position: 'absolute', right: '0.5%', top: '57%', width: 'clamp(34px,8.4vw,54px)', zIndex: 4 }}><SensorPanel w="100%"/></div>
    {/* PALETKA + markaziy 3×5 quti-massiv (SANALADIGAN, ajratilgan) */}
    <div style={{ position: 'absolute', left: '50%', bottom: '3%', transform: 'translateX(-50%)', zIndex: 5, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(4px,1.2vw,8px)', padding: 'clamp(4px,1vw,7px)', borderRadius: 12, background: 'rgba(232,240,250,0.1)', boxShadow: '0 0 0 2px rgba(230,184,74,0.5), 0 6px 16px rgba(0,0,0,0.3)' }}>
        {[0, 1, 2].map((ri) => <CrateRow key={ri} n={5} celebrate={celebrate} ri={ri}/>)}
      </div>
      {/* paletka plita */}
      <div style={{ marginTop: -1, width: '116%', height: 'clamp(9px,2.4vw,15px)', borderRadius: '4px 4px 7px 7px', background: 'linear-gradient(180deg,#E8ECF2,#ACB4C0)', boxShadow: '0 6px 13px rgba(0,0,0,0.3), 0 0 0 2px rgba(230,184,74,0.45), inset 0 1px 2px rgba(255,255,255,0.6)' }}/>
    </div>
    {/* SUZUVCHI QUTILAR (nol tortishish) — sahna bo'ylab suzadi */}
    <div className="d13-hover" style={{ position: 'absolute', left: '67%', top: '40%', width: 'clamp(30px,7.2vw,44px)', zIndex: 6 }}><CrateCell s="100%" tint="#D79A45" edge="#7A4E1A"/></div>
    <div className="d13-fly" style={{ position: 'absolute', left: '27%', top: '39%', width: 'clamp(20px,4.6vw,28px)', zIndex: 6 }}><CrateCell s="100%" tint="#C98A3C" edge="#7A4E1A"/></div>
    {bubbleNode}
    {/* PERSONAJ — «?»/tablo tagida (chapda, old planда, z-index baland) */}
    {charNode}
  </div>
);
// s0 — YUPITER ORBITASIGA KELISH: illyuminatorda Yupiter ochiladi; yuk bo'limi 3×5 quti + jami "?".
...
// s15 — KEMA YUK BO'LIMI (xulosa): qutilar ko'paytirib sanaldi + yashil ✓ tablo.
...
/* --- Yuk-bo'lim sahnasi jonli/3D animatsiyalari (Yupiter biom) --- */
...
@media (prefers-reduced-motion: reduce) {
  .d13-jhalo, .d13-jband, .d13-moon1, .d13-moon2, .d13-vine, .d13-vine2, .d13-glow, .d13-beam, .d13-sheen, .d13-hover, .d13-led, .d13-fly, .d13-wave { animation: none; }
}
