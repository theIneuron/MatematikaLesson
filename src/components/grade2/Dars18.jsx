...
const LESSON_META = {
  ...
  lessonTitle: { ru: 'Урок 18. Закрепление. Перестановка множителей', uz: "18-dars. Mustahkamlash. Ko'paytiruvchilar o'rin almashishi" }
};
...
const CONTENT = {
  ...
  s0: {
    ...
    q: { ru: 'Было 3 ряда по 5. Переставили — 5 рядов по 3. Сколько всего?', uz: "3 qator, 5 tadan edi. Boshqacha terildi — 5 qator, 3 tadan. Jami nechta?" },
    ...
    audio: {
      intro: {
        ru: [
          'Мы выучили всю таблицу умножения. Корабль Бита на орбите Юпитера, урожай собран и разложен по ящикам.',
        ...
        uz: [
          "Butun ko'paytirish jadvalini o'rgandik. Bitning kemasi Yupiter orbitasida, hosil yig'ilib qutilarga terildi.",
  ...
  s1: {
    ...
    body: { ru: 'Вот 3 ряда по 5 — это 3 × 5 = 15. Повернём массив: станет 5 рядов по 3 — это 5 × 3. Ростки те же, всего снова 15. Порядок множителей не меняет произведение: 3 × 5 = 5 × 3.', uz: "Mana 3 qator, 5 tadan — bu 3 × 5 = 15. Massivni buramiz: 5 qator, 3 tadan bo'ladi — bu 5 × 3. Ko'chatlar o'sha, jami yana 15. Ko'paytiruvchilar tartibi ko'paytmani o'zgartirmaydi: 3 × 5 = 5 × 3." },
    ...
    audio: {
      ru: [
        ...
        'Повернём массив. Теперь пять рядов по три. Ростки те же самые.',
      ...
      uz: [
        ...
        "Massivni buramiz. Endi besh qator, uchtadan. Ko'chatlar o'sha-o'sha.",
  ...
  s3: {
    ...
    rule: { ru: 'Множители можно менять местами — произведение не меняется: a × b = b × a. Если знаешь 2 × 6 = 12, то и 6 × 2 = 12.', uz: "Ko'paytiruvchilarni o'rin almashtirsa bo'ladi — ko'paytma o'zgarmaydi: a × b = b × a. 2 × 6 = 12 ni bilsang, 6 × 2 = 12 ham." },
    ...
    audio: {
      ...
      uz: [
        ...
        "Ikki marta oltini bilsang, olti marta ikkini ham bilasan.",
  ...
  s4: {
    ...
    lead: { ru: 'Считай удобной стороной.', uz: "Qulay tomondan sana." },
    body: { ru: '9 × 2 кажется трудным. Но 2 × 9 посчитать легко: 9, 18. Значит и 9 × 2 = 18. Выбирай, как удобнее считать.', uz: "9 × 2 qiyin ko'rinadi. Lekin 2 × 9 ni sanash oson: 9, 18. Demak 9 × 2 = 18 ham. Qaysi tomondan sanash qulay — shundan sana." },
  ...
  sTBL: {
    ...
    info_badge: { ru: 'Главное', uz: 'Asosiy' },
    info: { ru: 'Таблица симметрична: 3 × 5 и 5 × 3 — одна и та же клетка. Её можно открыть в помощь.', uz: "Jadval simmetrik: 3 × 5 va 5 × 3 — bir xil katak. Uni yordam uchun ochsa bo'ladi." },
    audio: {
      ru: [
  ...
  s6: {
    ...
    by: 6, blank: 4,
    wrong: { ru: 'К прошлой клетке прибавь 6.', uz: "Avvalgi katakka 6 qo'sh." },
    ...
    audio: {
      ...
      on_wrong: { ru: 'Прибавь к прошлой клетке шесть.', uz: "Avvalgi katakka olti qo'sh." }
    }
  },

  // s7 — MASHQ (COMMUTE teng?, 3 round: Ha/Yo'q aralash)
  s7: {
    eyebrow: { ru: 'Практика', uz: 'Mashq' },
    lead: { ru: 'Эти два равны?', uz: "Bu ikkalasi teng bo'ladimi?" },
    rounds: [ { a: 2, b: 6, e: 6, f: 2 }, { a: 3, b: 5, e: 5, f: 4 }, { a: 7, b: 2, e: 2, f: 7 } ],
    wrong: { ru: 'Проверь: одинаковые ли множители, только переставленные?', uz: "Tekshir: ko'paytiruvchilar bir xilmi, faqat o'rni almashganmi?" },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Равны или нет? Если те же множители переставлены — равны. Если числа другие — нет.', uz: "Teng yoki yo'q? Agar o'sha ko'paytiruvchilar o'rin almashgan bo'lsa — teng. Sonlar boshqa bo'lsa — yo'q." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Сравни множители в обоих.', uz: "Ikkalasidagi ko'paytiruvchilarni solishtir." }
    }
  },

  // s8 — MASHQ (TABLE-FILL aralash jadval ×3/×6/×4, 3 round)
  s8: {
    eyebrow: { ru: 'Заполни таблицу', uz: "Jadvalni to'ldir" },
    lead: { ru: 'Заполни пустую клетку.', uz: "Bo'sh katakni to'ldiring." },
    rounds: [ { by: 3, blank: 4 }, { by: 6, blank: 3 }, { by: 4, blank: 5 } ],
    wrong: { ru: 'Смотри, на сколько растёт строка.', uz: "Qator nechtadan o'sishini qara." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Разные таблицы. Смотри, на сколько прибавляет каждая строка.', uz: "Har xil jadvallar. Har qator nechtadan qo'shishini qara." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Прибавь к прошлой клетке столько же.', uz: "Avvalgi katakka shuncha qo'sh." }
    }
  },
  ...
  s9: {
    ...
    wrong: { ru: 'Смотри, сколько рядов и по сколько в ряду.', uz: "Necha qator va nechtadan ekanini qara." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Вся таблица вперемешку. Считай ряды умножением.', uz: "Butun jadval aralash. Qatorlarni ko'paytirib sana." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
  ...
  s10: {
    ...
    wrong: { ru: 'Проверь множители в обоих.', uz: "Ikkalasidagi ko'paytiruvchilarni tekshir." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Снова: равны или нет? Смотри на множители.', uz: "Yana: teng yoki yo'q? Ko'paytiruvchilarga qara." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Если множители не те же — не равны.', uz: "Ko'paytiruvchilar o'sha bo'lmasa — teng emas." }
    }
  },

  // s11 — MASHQ (ARRAY aralash jadval, 3 round)
  s11: {
    eyebrow: { ru: 'Практика', uz: 'Mashq' },
    lead: { ru: 'Сосчитай умножением.', uz: "Ko'paytirib sanang." },
    rounds: [ { r: 6, c: 3 }, { r: 2, c: 8 }, { r: 4, c: 5 } ],
    wrong: { ru: 'Смотри, сколько рядов и по сколько в ряду.', uz: "Necha qator va nechtadan ekanini qara." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Последняя тренировка перед задачей. Считай умножением.', uz: "Masaladan oldingi oxirgi mashq. Ko'paytirib sana." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Сколько рядов, столько раз бери число.', uz: "Necha qator, shuncha marta sonni ol." }
    }
  },
  ...
  s13: {
    ...
    story: { ru: 'Зухра сложила ящики: 4 ряда, в каждом по 6. Сколько всего ящиков?', uz: "Zuhra qutilarni terdi: 4 qator, har birida 6 tadan. Jami nechta quti?" },
    r: 4, c: 6,
    wrong: { ru: 'Считай на шесть: шесть, двенадцать, восемнадцать, двадцать четыре.', uz: "Oltiga sana: olti, o'n ikki, o'n sakkiz, yigirma to'rt." },
    ...
    audio: {
      ...
      on_wrong: { ru: 'Считай на шесть: шесть, двенадцать, восемнадцать, двадцать четыре.', uz: "Oltiga sana: olti, o'n ikki, o'n sakkiz, yigirma to'rt." }
    }
  },

  // s14 — FINAL (scored, 3 round array aralash jadval + FactCard Yupiter)
  s14: {
    eyebrow: { ru: 'Финал', uz: 'Final' },
    lead: { ru: 'Финальная проверка.', uz: "Yakuniy tekshiruv." },
    rounds: [ { r: 3, c: 6 }, { r: 4, c: 7 }, { r: 6, c: 4 } ],
    wrong: { ru: 'Считай умножением, вся таблица.', uz: "Ko'paytirib sana, butun jadval." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    ...
    audio: {
      intro: { ru: 'Финальная проверка. Вся таблица вперемешку. Считай верно.', uz: "Yakuniy tekshiruv. Butun jadval aralash. To'g'ri sana." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Смотри, сколько рядов и по сколько.', uz: "Necha qator va nechtadan ekanini qara." }
    }
  },
  ...
  s15: {
    ...
    rule_recap: { ru: 'Порядок множителей не меняет ответ: a × b = b × a. Считай удобной стороной.', uz: "Ko'paytiruvchilar tartibi javobni o'zgartirmaydi: a × b = b × a. Qulay tomondan sana." },
    ...
    audio: {
      ru: 'Миссия выполнена. Мы закрепили всю таблицу умножения и узнали важное правило. Порядок множителей не меняет ответ: три на пять равно пять на три. Можно считать той стороной, что удобнее. Урожай на корабле разложен по ящикам. Дальше научимся делить.',
      uz: "Missiya bajarildi. Butun ko'paytirish jadvalini mustahkamladik va muhim qoidani bildik. Ko'paytiruvchilar tartibi javobni o'zgartirmaydi: uch marta besh — besh marta uchga teng. Qulay tomondan sanash mumkin. Kemadagi hosil qutilarga terildi. Keyin bo'lishni o'rganamiz."
    }
  }
};
...
const BRIDGES = {
  ...
  s7:  { ru: 'Ещё раз: равны или нет?', uz: "Yana: teng yoki yo'q?" },
  ...
  s15: { ru: 'Урожай разложен по ящикам!', uz: "Hosil qutilarga terildi!" }
};
...
const A7 = (props) => <CommuteStage props={props} cKey="s7"/>;
