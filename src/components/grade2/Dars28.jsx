...
const CONTENT = {
  ...
  s1: {
    ...
    info: { ru: 'Ставь начало на 0 и читай число у конца. Сантиметр (см) — для маленьких предметов.', uz: "Boshni 0 ga qo'y va oxiridagi sonni o'qi. Santimetr (sm) — kichik narsalar uchun." },
    audio: {
      ru: [
  ...
  s5: {
    ...
    mode: 'ruler', cm: 4,
    wrong: { ru: 'Начало на нуле — смотри, у какого числа конец.', uz: "Boshi nolda — oxiri qaysi songa to'g'ri kelishiga qara." },
    done_text: { ru: 'Верно! Конец у четвёрки.', uz: "To'g'ri! Oxiri to'rtda." },
    audio: {
      intro: { ru: 'Тренировка. Начало на нуле — прочитай число у конца.', uz: "Mashq. Boshi nolda — oxiridagi sonni o'qi." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Смотри, у какого числа конец предмета.', uz: "Buyum oxiri qaysi songa to'g'ri kelishiga qara." }
    }
  },
  ...
  s6: {
    ...
    wrong: { ru: 'Начало на нуле — читай число у конца.', uz: "Boshi nolda — oxiridagi sonni o'qi." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Измеряй по линейке. Читай число у конца предмета.', uz: "Chizg'ich bilan o'lcha. Buyum oxiridagi sonni o'qi." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Смотри только на конец предмета.', uz: "Faqat buyumning oxiriga qara." }
    }
  },
  ...
  s7: {
    ...
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Посмотри на предмет и выбери удобную единицу.', uz: "Buyumga qarab qulay birlikni tanla." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
  ...
  s8: {
    ...
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Считай по десять: в дециметре десять сантиметров.', uz: "O'ntadan sana: detsimetrda o'nta santimetr bor." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
  ...
  s9: {
    ...
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Снова измеряй по линейке.', uz: "Yana chizg'ich bilan o'lcha." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Читай число у конца предмета.', uz: "Buyum oxiridagi sonni o'qi." }
    }
  },
  ...
  s10: {
    ...
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Снова выбери удобную единицу для предмета.', uz: "Yana buyum uchun qulay birlikni tanla." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
  ...
  s11: {
    ...
    wrong: { ru: 'Считай по десять.', uz: "O'ntadan sana." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Последняя тренировка перед задачей. Считай по десять.', uz: "Masaladan oldingi oxirgi mashq. O'ntadan sana." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
  ...
  s13: {
    ...
    wrong: { ru: 'Начало на нуле — смотри число у конца детали.', uz: "Boshi nolda — detal oxiridagi songa qara." },
    ...
    audio: {
      ...
      on_wrong: { ru: 'Смотри, у какого числа конец детали.', uz: "Detal oxiri qaysi songa to'g'ri kelishiga qara." }
    }
  },
  ...
  s14: {
    ...
    audio: {
      intro: { ru: 'Финальная проверка. Читай число у конца предмета.', uz: "Yakuniy tekshiruv. Buyum oxiridagi sonni o'qi." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Начало на нуле — смотри конец.', uz: "Boshi nolda — oxiriga qara." }
    }
  },
