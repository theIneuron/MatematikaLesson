...
const CONTENT = {
  ...
  s2: {
    ...
    info_badge: { ru: 'Главное', uz: 'Asosiy' },
    info: { ru: 'Единицы: 9 минус 5 это 4. Десятки: 5 минус 2 это 3. Вместе — 34.', uz: "Birliklar: 9 ayir 5 — 4. O'nliklar: 5 ayir 2 — 3. Birgalikda — 34." },
    audio: {
      ru: [
  ...
  s3: {
    ...
    rule: { ru: 'Вычитаем по разрядам: сначала единицы, потом десятки. Единицы под единицами, десятки под десятками. Ведь каждое число состоит из десятков и единиц.', uz: "Xonalab ayiramiz: avval birliklar, keyin o'nliklar. Birlik ostiga birlik, o'nlik ostiga o'nlik. Chunki har son o'nlik va birliklardan tuzilgan." },
    check_q: { ru: 'Вычти единицы: 9 − 5 = ?', uz: "Birliklarni ayir: 9 − 5 = ?" },
    opts: [{ ru: '4', uz: '4', ok: true }, { ru: '14', uz: '14' }, { ru: '5', uz: '5' }, { ru: '3', uz: '3' }],
    wrong: { ru: 'Вычитаем только единицы: девять минус пять это четыре.', uz: "Faqat birliklarni ayiramiz: to'qqiz ayir besh — to'rt." },
    ...
    audio: {
      ...
      uz: [
        ...
        "Endi o'zingiz. Birliklarni ayiring: to'qqiz ayir besh."
      ]
    }
  },
  ...
  s4: {
    ...
    body: { ru: 'Единицы: 8 минус 6 это 2. Десятки: 6 минус 1 это 5. Получилось 52.', uz: "Birliklar: 8 ayir 6 — 2. O'nliklar: 6 ayir 1 — 5. 52 bo'ldi." },
    warn: { ru: 'Не путай разряды! Каждый столбик отдельно.', uz: "Xonalarni aralashtirma! Har ustun alohida." },
    check_q: { ru: 'Вычти десятки: 6 − 1 = ?', uz: "O'nliklarni ayir: 6 − 1 = ?" },
    opts: [{ ru: '5', uz: '5', ok: true }, { ru: '7', uz: '7' }, { ru: '50', uz: '50' }],
    wrong: { ru: 'Вычитаем десятки: шесть минус один это пять.', uz: "O'nliklarni ayiramiz: olti ayir bir — besh." },
    ...
    audio: {
      ...
      uz: [
        ...
        "Birliklar: sakkiz ayir olti — ikki.",
        "O'nliklar: olti ayir bir — besh. Ellik ikki bo'ldi.",
        "O'nliklarni o'zingiz ayiring: olti ayir bir."
      ]
    }
  },
  ...
  s5: {
    ...
    wrong: { ru: 'Единицы: 7 минус 1 это 6. Десятки: 4 минус 2 это 2. Всего 26.', uz: "Birliklar: 7 ayir 1 — 6. O'nliklar: 4 ayir 2 — 2. Jami 26." },
    ...
    audio: {
      ...
      uz: [
        ...
        "Birliklar: yetti ayir bir — olti. O'nliklar: to'rt ayir ikki — ikki.",
  ...
  s6: {
    ...
    wrong: { ru: 'Единицы: 8 минус 7 это 1. Десятки: 8 минус 2 это 6. Всего 61.', uz: "Birliklar: 8 ayir 7 — 1. O'nliklar: 8 ayir 2 — 6. Jami 61." },
    done_text: { ru: 'Верно! 88 − 27 = 61.', uz: "To'g'ri! 88 − 27 = 61." },
    audio: {
      intro: { ru: 'Проверь себя перед практикой. Вычти из восьмидесяти восьми двадцать семь.', uz: "Mashqdan oldin o'zingizni sina. Sakson sakkizdan yigirma yettini ayir." },
  ...
  s7: {
    ...
    wrong: { ru: 'Вычитай по столбикам: единицы из единиц, десятки из десятков.', uz: "Ustunlab ayir: birlikdan birlik, o'nlikdan o'nlik." },
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Объяснение мы закончили, теперь тренировка. Вычитай столбиком: сначала единицы, потом десятки.', uz: "Tushuntirishni tugatdik, endi trenirovka. Ustunlab ayir: avval birliklar, keyin o'nliklar." },
  ...
  s10: {
    ...
    done_text: { ru: 'Верно!', uz: "To'g'ri!" },
    audio: {
      intro: { ru: 'Ещё примеры на вычитание. Считай столбиком.', uz: "Yana ayirish misollari. Ustunlab sana." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
  ...
  s12: {
    ...
    audio: {
      ...
      uz: "Anvar konteynerni bo'shatadi. Unda yetmish sakkiz quti bor edi. O'ttiz oltitasini bazaga jo'natdi. Nechta qoldi? Ustunlab ayir."
    }
  },
  ...
  s13: {
    ...
    wrong: { ru: 'Единицы: 8 минус 6 это 2. Десятки: 7 минус 3 это 4. Осталось 42.', uz: "Birliklar: 8 ayir 6 — 2. O'nliklar: 7 ayir 3 — 4. Qoldi 42." },
    done_text: { ru: 'Верно! 78 − 36 = 42 ящика.', uz: "To'g'ri! 78 − 36 = 42 quti." },
    audio: {
      intro: { ru: 'В контейнере было семьдесят восемь ящиков, тридцать шесть отправили. Вычти столбиком.', uz: "Konteynerda yetmish sakkiz quti bor edi, o'ttiz oltitasi jo'natildi. Ustunlab ayir." },
    ...
    <Stage eyebrow={c.eyebrow} screen={props.screen} totalScreens={TOTAL_SCREENS} navContent={navContent} audioState={audio}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 14px)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <ColumnSub a={59} b={25} sum={done ? 34 : null} emph={done ? null : 'units'}/>
        </div>
  ...
  return (
    <div className="d2-scene" style={{ background: 'radial-gradient(ellipse at 50% 20%, #34180f 0%, #140a08 78%)' }}>
      ...
      <div style={{ position: 'absolute', left: '48%', bottom: '17%', transform: 'translateX(-50%)', display: 'flex', alignItems: 'center', gap: 'clamp(5px,1.4vw,10px)', zIndex: 5 }}>
        <CargoCrate n={59} ca="#FF9166" cb="#FF4F28" br="#C1381A"/>
