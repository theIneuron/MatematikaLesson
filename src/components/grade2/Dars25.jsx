  ...
  if (kind === 'horizon') return ( // UFQ CHIZIG'I — yo'ldosh ufqi: butun kadr bo'ylab, ikki chetdan tashqariga chiqadi; uchi YO'Q (to'g'ri chiziq)
    <svg viewBox="0 0 220 68" style={{ width: '100%', maxWidth: 320, height: 'auto', display: 'block', overflow: 'visible' }} aria-hidden="true">
      <defs>
        ...
        <linearGradient id="d26hz" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#FFFFFF"/><stop offset="0.45" stopColor="#8FE6EC"/><stop offset="1" stopColor="#6D5CE7"/></linearGradient>
      ...
      <rect x="0" y="22" width="220" height="30" fill="rgba(109,92,231,0.16)"/>
      <rect x="0" y="28" width="220" height="19" fill="rgba(109,92,231,0.26)"/>
