...
// ============================================================================
// ░░ 2-SINF · Dars25 — "Деление через повторное вычитание" (div-repsub-2-25) · Б4 (SATURN, bo'lish YAKUNI) · spec: BUILD_HOLATI_2SINF §6 ░░
...
const LESSON_META = {
  lessonId: 'div-repsub-2-25',
  lessonTitle: { ru: 'Урок 25. Деление через повторное вычитание', uz: "25-dars. Takroriy ayirish orqali bo'lish" }
};
...
const CONTENT = {
  ...
  s0: {
    ...
    topic: { ru: 'Тема: Деление через повторное вычитание', uz: "Mavzu: Takroriy ayirish orqali bo'lish" },
    lead: { ru: 'Сколько раз отнимем?', uz: "Necha marta ayiramiz?" },
    q: { ru: 'В лагере 15 кристаллов. Анвар и Зухра берут по 3 в коробку. Сколько раз возьмут, пока не кончатся?', uz: "Lagerda 15 ta kristall bor. Anvar va Zuhra 3 tadan qutiga oladi. Tugaguncha necha marta olishadi?" },
    opt0: { ru: '3', uz: '3' },   // distraktor = ayirilgan son (M1)
    opt1: { ru: '5', uz: '5' },   // to'g'ri (15÷3)
    ...
    audio: {
      ...
      on_correct: { ru: 'Верно. По три пять раз — пятнадцать кончится. Это деление: пятнадцать на три это пять.', uz: "To'g'ri. Uchtadan besh marta olsak — o'n besh tugaydi. Bu bo'lish: o'n beshni uchga bo'lsak besh." },
      on_wrong: { ru: 'Три — это сколько берём за раз. А вопрос — сколько раз. По три пять раз. Сейчас разберём.', uz: "Uch — bu har safar olingan son. Savol — necha marta. Uchtadan besh marta olamiz. Hozir o'rganamiz." },
      on_unknown: { ru: 'Ничего. Научимся делить через повторное вычитание.', uz: "Hechqisi yo'q. Takroriy ayirish bilan bo'lishni o'rganamiz." }
    }
  },
  ...
  s1: {
    ...
    lead: { ru: 'Отнимаем по 3, пока не станет 0.', uz: "0 bo'lguncha 3 tadan ayiramiz." },
    body: { ru: 'Начни с 12 и прыгай назад по 3: 12 − 3 − 3 − 3 − 3 = 0. Прыжков четыре — значит 12 ÷ 3 = 4.', uz: "12 dan boshlab orqaga 3 talik sakra: 12 − 3 − 3 − 3 − 3 = 0. Sakrash to'rtta — demak 12 ÷ 3 = 4." },
    info_badge: { ru: 'Ключ', uz: 'Kalit' },
    info: { ru: 'Сколько раз отняли — столько и в ответе деления.', uz: "Necha marta ayirsak — bo'lish javobi ham shuncha." },
    audio: {
      ru: [
  ...
  s2: {
    ...
    lead: { ru: 'Теперь отнимаем по 5.', uz: "Endi 5 tadan ayiramiz." },
    info_badge: { ru: 'Ключ', uz: 'Kalit' },
    info: { ru: 'Отнимаем одно и то же число, считаем разы.', uz: "Bir xil sonni ayiramiz, martalarni sanaymiz." },
    audio: {
      ru: [
  ...
  s3: {
    ...
    rule: { ru: 'Деление — это отнимать одно и то же число, пока не станет 0. Сколько раз отняли — таков ответ деления.', uz: "Bo'lish — nol bo'lguncha bir xil sonni takror ayirish. Necha marta ayirsak — bo'lish javobi shu." },
    check_q: { ru: 'Отнимаем по 2 от 10 до нуля. Сколько раз?', uz: "10 dan 2 tadan nolgacha ayiramiz. Necha marta?" },
    opts: [{ ru: '5', uz: '5', ok: true }, { ru: '2', uz: '2' }, { ru: '8', uz: '8' }],
    wrong: { ru: 'Считай, сколько раз отнял по 2, а не само число 2.', uz: "2 sonini emas, 2 tadan necha marta ayirganingni sana." },
    check_ok: { ru: 'Верно! 10 ÷ 2 = 5.', uz: "To'g'ri! 10 ÷ 2 = 5." },
    audio: {
      ru: [
        'Запишем главное. Слушай и запомни.',
        'Деление — это отнимать одно и то же число, пока не станет ноль.',
        'Сколько раз отняли — таков ответ деления.',
        'Проверь. Отнимаем по два от десяти до нуля. Сколько раз?'
      ],
      uz: [
        "Asosiyni yozamiz. Tinglang va yodlang.",
        "Bo'lish — nol bo'lguncha bir xil sonni takror ayirish.",
        "Necha marta ayirsak — bo'lish javobi shu.",
        "Tekshir. O'ndan ikkitadan nolgacha ayiramiz. Necha marta?"
      ]
    }
  },
  ...
  s4: {
    ...
    lead: { ru: 'Ответ — сколько раз, а не число.', uz: "Javob — necha marta, ayirilgan son emas." },
    body: { ru: 'От 18 отнимаем по 3 до нуля — получается 6 раз. Ответ — 6 (прыжки), а не 3 (что отнимали).', uz: "18 dan 3 tadan nolgacha ayiramiz — 6 marta bo'ladi. Javob — 6 (sakrashlar), 3 emas (ayirilgan son)." },
    warn: { ru: 'Считаем прыжки, а не то число, которое отнимаем.', uz: "Ayirilgan sonni emas, sakrashlarni sanaymiz." },
    check_q: { ru: 'Отнимаем по 3 от 18 до нуля. Сколько раз?', uz: "18 dan 3 tadan nolgacha ayiramiz. Necha marta?" },
    opts: [{ ru: '6', uz: '6', ok: true }, { ru: '3', uz: '3' }, { ru: '15', uz: '15' }],
    wrong: { ru: 'Три — это что отнимаем. Считай прыжки до нуля.', uz: "Uch — bu ayirilgan son. Nolgacha sakrashlarni sana." },
    check_ok: { ru: 'Верно! 18 ÷ 3 = 6.', uz: "To'g'ri! 18 ÷ 3 = 6." },
    audio: {
      ru: [
  ...
  sTBL: {
    ...
    lead: { ru: 'Быстрее — по таблице.', uz: "Tezroq — jadval bilan." },
    info_badge: { ru: 'Ключ', uz: 'Kalit' },
    info: { ru: 'Повторное вычитание показывает, что такое деление. Чтобы не считать каждый раз, вспомни таблицу деления.', uz: "Takroriy ayirish bo'lish nimaligini ko'rsatadi. Har safar sanamaslik uchun bo'lish jadvalini esla." },
    audio: {
      ru: [
  ...
  s5: {
    ...
    lead: { ru: 'Считай прыжки.', uz: "Sakrashlarni sana." },
    transition: { ru: 'Объяснение закончили. Теперь порешаем.', uz: "Tushuntirishni tugatdik. Endi yechamiz." },
    total: 18, step: 3,
    story: { ru: 'От 18 прыгай назад по 3 до нуля. Сколько прыжков?', uz: "18 dan orqaga 3 talik nolgacha sakra. Nechta sakrash?" },
    wrong: { ru: 'Считай, сколько троек в восемнадцати, а не число 3.', uz: "3 sonini emas, o'n sakkizda nechta uchlik borligini sana." },
    done_text: { ru: 'Верно! 18 ÷ 3 = 6.', uz: "To'g'ri! 18 ÷ 3 = 6." },
    audio: {
      intro: { ru: 'От восемнадцати прыгай назад по три до нуля. Сколько получится прыжков?', uz: "O'n sakkizdan orqaga uch talik nolgacha sakra. Nechta sakrash chiqadi?" },
      on_correct: { ru: 'Верно. Шесть прыжков.', uz: "To'g'ri. Oltita sakrash." },
      on_wrong: { ru: 'Считай прыжки по три до нуля.', uz: "Nolgacha uch talik sakrashlarni sana." }
    }
  },
  ...
  s6: {
    ...
    lead: { ru: 'Считай прыжки.', uz: "Sakrashlarni sana." },
    total: 20, step: 4,
    story: { ru: 'От 20 прыгай назад по 4 до нуля. Сколько прыжков?', uz: "20 dan orqaga 4 talik nolgacha sakra. Nechta sakrash?" },
    wrong: { ru: 'Считай четвёрки: сколько их в двадцати.', uz: "To'rtliklarni sana: yigirmada nechta." },
    done_text: { ru: 'Верно! 20 ÷ 4 = 5.', uz: "To'g'ri! 20 ÷ 4 = 5." },
    audio: {
      intro: { ru: 'От двадцати прыгай назад по четыре до нуля. Сколько прыжков?', uz: "Yigirmadan orqaga to'rt talik nolgacha sakra. Nechta sakrash?" },
      on_correct: { ru: 'Верно. Пять прыжков.', uz: "To'g'ri. Beshta sakrash." },
      on_wrong: { ru: 'Сколько четвёрок в двадцати?', uz: "Yigirmada nechta to'rtlik bor?" }
    }
  },
  ...
  s7: {
    ...
    a: 3, b: 8, by: 3,
    story: { ru: 'Кристаллы сложили в массив 3 × 8 = 24. Сколько в каждом из 3 рядов?', uz: "Kristallar 3 × 8 = 24 massivga terildi. 3 qatorning har birida nechta?" },
    wrong: { ru: '3 × 8 = 24, значит 24 ÷ 3 = 8.', uz: "3 × 8 = 24, demak 24 ÷ 3 = 8." },
    done_text: { ru: 'Верно! 24 ÷ 3 = 8.', uz: "To'g'ri! 24 ÷ 3 = 8." },
    audio: {
      intro: { ru: 'Кристаллы сложили в три ряда, всего двадцать четыре. Сколько в каждом ряду? Найди через умножение.', uz: "Kristallar uch qatorga terildi, jami yigirma to'rt. Har qatorda nechta? Ko'paytirish orqali top." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Три умножить на сколько будет двадцать четыре?', uz: "Uchni nechaga ko'paytirsak yigirma to'rt bo'ladi?" }
    }
  },
  ...
  s8: {
    ...
    lead: { ru: 'Считай прыжки.', uz: "Sakrashlarni sana." },
    total: 24, step: 6,
    story: { ru: 'От 24 прыгай назад по 6 до нуля. Сколько прыжков?', uz: "24 dan orqaga 6 talik nolgacha sakra. Nechta sakrash?" },
    wrong: { ru: 'Считай шестёрки: сколько их в двадцати четырёх.', uz: "Oltiliklarni sana: yigirma to'rtda nechta." },
    done_text: { ru: 'Верно! 24 ÷ 6 = 4.', uz: "To'g'ri! 24 ÷ 6 = 4." },
    audio: {
      intro: { ru: 'От двадцати четырёх прыгай назад по шесть до нуля. Сколько прыжков?', uz: "Yigirma to'rtdan orqaga olti talik nolgacha sakra. Nechta sakrash?" },
      on_correct: { ru: 'Верно. Четыре прыжка.', uz: "To'g'ri. To'rtta sakrash." },
      on_wrong: { ru: 'Сколько шестёрок в двадцати четырёх?', uz: "Yigirma to'rtda nechta oltilik bor?" }
    }
  },
  ...
  s9: {
    ...
    lead: { ru: 'Считай прыжки.', uz: "Sakrashlarni sana." },
    total: 28, step: 7,
    story: { ru: 'От 28 прыгай назад по 7 до нуля. Сколько прыжков?', uz: "28 dan orqaga 7 talik nolgacha sakra. Nechta sakrash?" },
    wrong: { ru: 'Считай семёрки: сколько их в двадцати восьми.', uz: "Yettiliklarni sana: yigirma sakkizda nechta." },
    done_text: { ru: 'Верно! 28 ÷ 7 = 4.', uz: "To'g'ri! 28 ÷ 7 = 4." },
    audio: {
      intro: { ru: 'От двадцати восьми прыгай назад по семь до нуля. Сколько прыжков?', uz: "Yigirma sakkizdan orqaga yetti talik nolgacha sakra. Nechta sakrash?" },
      on_correct: { ru: 'Верно. Четыре прыжка.', uz: "To'g'ri. To'rtta sakrash." },
      on_wrong: { ru: 'Сколько семёрок в двадцати восьми?', uz: "Yigirma sakkizda nechta yettilik bor?" }
    }
  },
  ...
  s10: {
    ...
    lead: { ru: 'Найди деление через умножение.', uz: "Ko'paytirish orqali bo'lishni top." },
    a: 6, b: 5, by: 6,
    story: { ru: 'Кристаллы сложили в массив 6 × 5 = 30. Сколько в каждом из 6 рядов?', uz: "Kristallar 6 × 5 = 30 massivga terildi. 6 qatorning har birida nechta?" },
    wrong: { ru: '6 × 5 = 30, значит 30 ÷ 6 = 5.', uz: "6 × 5 = 30, demak 30 ÷ 6 = 5." },
    done_text: { ru: 'Верно! 30 ÷ 6 = 5.', uz: "To'g'ri! 30 ÷ 6 = 5." },
    audio: {
      intro: { ru: 'Кристаллы сложили в шесть рядов, всего тридцать. Сколько в каждом ряду? Найди через умножение.', uz: "Kristallar olti qatorga terildi, jami o'ttiz. Har qatorda nechta? Ko'paytirish orqali top." },
      on_correct: { ru: 'Верно.', uz: "To'g'ri." },
      on_wrong: { ru: 'Шесть умножить на сколько будет тридцать?', uz: "Oltini nechaga ko'paytirsak o'ttiz bo'ladi?" }
    }
  },
  ...
  s11: {
    ...
    lead: { ru: 'Считай прыжки.', uz: "Sakrashlarni sana." },
    total: 45, step: 9,
    story: { ru: 'От 45 прыгай назад по 9 до нуля. Сколько прыжков?', uz: "45 dan orqaga 9 talik nolgacha sakra. Nechta sakrash?" },
    wrong: { ru: 'Считай девятки: сколько их в сорока пяти.', uz: "To'qqizliklarni sana: qirq beshda nechta." },
    done_text: { ru: 'Верно! 45 ÷ 9 = 5.', uz: "To'g'ri! 45 ÷ 9 = 5." },
    audio: {
      intro: { ru: 'От сорока пяти прыгай назад по девять до нуля. Сколько прыжков?', uz: "Qirq beshdan orqaga to'qqiz talik nolgacha sakra. Nechta sakrash?" },
      on_correct: { ru: 'Верно. Пять прыжков.', uz: "To'g'ri. Beshta sakrash." },
      on_wrong: { ru: 'Сколько девяток в сорока пяти?', uz: "Qirq beshda nechta to'qqizlik bor?" }
    }
  },
  ...
  s12: {
    eyebrow: { ru: 'Задача', uz: 'Masala' },
    lead: { ru: 'Анвар раскладывает кристаллы.', uz: "Anvar kristallarni teradi." },
  ...
  s13: {
    ...
    total: 18, step: 6,
    story: { ru: 'Зухра кладёт 18 кристаллов по 6 в коробку. Сколько коробок? Прыгай назад по 6.', uz: "Zuhra 18 ta kristallni har qutiga 6 tadan soladi. Nechta quti? Orqaga 6 talik sakra." },
    wrong: { ru: 'Считай, сколько раз отнял по 6 от 18.', uz: "18 dan 6 tadan necha marta ayirganingni sana." },
    done_text: { ru: 'Верно! 18 ÷ 6 = 3, три коробки.', uz: "To'g'ri! 18 ÷ 6 = 3, uchta quti." },
    audio: {
      intro: { ru: 'Помоги Зухре. Она кладёт восемнадцать кристаллов по шесть в коробку. Сколько выйдет коробок? Прыгай назад по шесть.', uz: "Zuhraga yordam bering. U o'n sakkiz kristallni har qutiga oltitadan soladi. Nechta quti chiqadi? Orqaga olti talik sakra." },
      on_correct: { ru: 'Верно. Три коробки.', uz: "To'g'ri. Uchta quti." },
      on_wrong: { ru: 'Сколько шестёрок в восемнадцати?', uz: "O'n sakkizda nechta oltilik bor?" }
    }
  },
  ...
  s14: {
    ...
    lead: { ru: 'Считай прыжки.', uz: "Sakrashlarni sana." },
    total: 42, step: 7,
    story: { ru: 'От 42 прыгай назад по 7 до нуля. Сколько прыжков?', uz: "42 dan orqaga 7 talik nolgacha sakra. Nechta sakrash?" },
    wrong: { ru: 'Считай семёрки: сколько их в сорока двух.', uz: "Yettiliklarni sana: qirq ikkida nechta." },
    done_text: { ru: 'Верно! 42 ÷ 7 = 6.', uz: "To'g'ri! 42 ÷ 7 = 6." },
    fact_badge: { ru: 'Знаешь?', uz: 'Bilasizmi?' },
    fact_text: { ru: 'Кольца Сатурна — из миллиардов кусочков льда и камня: от песчинки до целого дома.', uz: "Saturn halqalari milliardlab muz va tosh bo'laklaridan — qum donasidan uy kattaligigacha." },
    fact_audio: { ru: 'Кольца Сатурна сделаны из миллиардов кусочков льда и камня — от маленькой песчинки до целого дома.', uz: "Saturn halqalari milliardlab muz va tosh bo'laklaridan yasalgan — mayda qum donasidan butun uy kattaligigacha." },
    audio: {
      intro: { ru: 'Финальная проверка. От сорока двух прыгай назад по семь до нуля. Сколько прыжков?', uz: "Yakuniy tekshiruv. Qirq ikkidan orqaga yetti talik nolgacha sakra. Nechta sakrash?" },
      on_correct: { ru: 'Верно. Шесть прыжков.', uz: "To'g'ri. Oltita sakrash." },
      on_wrong: { ru: 'Сколько семёрок в сорока двух?', uz: "Qirq ikkida nechta yettilik bor?" }
    }
  },
  ...
  s15: {
    ...
    cando: { ru: 'Теперь ты понимаешь деление и как повторное вычитание!', uz: "Endi siz bo'lishni takroriy ayirish sifatida ham tushunasiz!" },
    // QOIDA recap (ko'rinadigan):
    rule_recap: { ru: 'Деление — это отнимать одно и то же число до нуля. Сколько раз отнял — таков ответ. А быстрее — по таблице.', uz: "Bo'lish — nolgacha bir xil sonni ayirish. Necha marta ayirsang — javob shu. Tezroq esa — jadval bilan." },
    conn_label_refs: { ru: 'Опирается на', uz: 'Tayanadi' },
    conn_refs: { ru: 'уроки 19–24: деление', uz: "19–24-darslar: bo'lish" },
...
const BRIDGES = {
  s1:  { ru: 'Отнимаем по 3 до нуля.', uz: "Nolgacha 3 tadan ayiramiz." },
  s2:  { ru: 'Ещё пример — по 5.', uz: "Yana misol — 5 tadan." },
  ...
  s7:  { ru: 'Найди через умножение.', uz: "Ko'paytirish orqali top." },
  s8:  { ru: 'Прыжки по 6.', uz: "6 talik sakrashlar." },
  s9:  { ru: 'Прыжки по 7.', uz: "7 talik sakrashlar." },
  s10: { ru: 'Снова через умножение.', uz: "Yana ko'paytirish orqali." },
  s11: { ru: 'Число побольше.', uz: "Kattaroq son." },
  s12: { ru: 'Анвар раскладывает кристаллы.', uz: "Anvar kristallarni teradi." },
  s13: { ru: 'Помоги Зухре.', uz: "Zuhraga yordam bering." },
  s14: { ru: 'Финальная проверка.', uz: 'Yakuniy tekshiruv.' },
  s15: { ru: 'Весь блок деления пройден!', uz: "Butun bo'lish bloki o'tildi!" }
};
