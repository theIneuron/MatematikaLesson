...
const S15 = {
  ...
  audio: [
    ...
    A('s1',
      "Bugun uch narsa qilindi. Asos va yon tomonni ajratib bilishni o'rgandingiz.",
      'Сегодня сделано три вещи. Ты научился различать основание и боковую сторону.',
      'Three things are done today. You learned to tell the base from the leg.'),
    A('s1b',
      "Trapetsiyaning ikki shartli alomatini ko'rdingiz va to'g'ri burchakli trapetsiyada ikkinchi burchak o'zi kelib chiqishini isbotladingiz.",
      'Ты увидел двухусловный признак трапеции и доказал, что в прямоугольной трапеции второй угол выходит сам.',
      'You saw the two-condition criterion for a trapezoid and proved that in a right trapezoid the second angle follows on its own.'),
    A('s2',
