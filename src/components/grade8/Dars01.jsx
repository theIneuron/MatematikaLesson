...
const S2 = {
  ...
  props: {
    ...
    proof: {
      ...
      rows: [
        // ЧЕТЫРЕ строки на четыре карточки (методист, 2026-08-17). Ученик
        // выбирал из четырёх записей, и в проверке обязаны быть все четыре:
        // если одна пропала, непонятно, куда она делась и считается ли.
        { v: '3a − 4', left: '5', right: '11' },
        { v: <Frac num="a + 1" den="2"/>, left: '2', right: '3' },
        { v: <Frac num="7" den="a − 5"/>, left: <Frac num="−7" den="2"/>, dead: true },
        { v: 'a · a + a', left: '12', right: '30' },
      ],
    },
    after: L(
