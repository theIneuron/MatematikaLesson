...
const CONTENT = {
  ...
  s7: {
    ...
    lead: { ru: 'Картинки нет — сложи цифры каждой цены в уме.', uz: "Rasm yo'q — har bir narxning raqamlarini xayolan qo'shing." },
    items: [
      { num: '21' },
      { num: '33' },
      { num: '45' },
    ...
    audio: {
      intro: { ru: 'Картинки нет, складывай цифры в уме. Найди цену, которую трое не смогут разделить поровну.', uz: "Rasm yo'q, raqamlarni xayolan qo'shing. Uch kishi teng bo'la olmaydigan narxni toping." },
  ...
  s11: {
    ...
    lead: { ru: 'Для каждой цены выбери верную строку. Картинки нет — складывай цифры.', uz: "Har bir narx uchun to'g'ri qatorni tanlang. Rasm yo'q — raqamlarni qo'shing." },
    pairs: [
  ...
  s12: {
    ...
    lead: { ru: 'Разбери цены на две группы по сумме цифр. Картинки нет.', uz: "Narxlarni raqamlari yig'indisiga qarab ikki guruhga ajrating. Rasm yo'q." },
  ...
  s13: {
    ...
    context: { ru: 'На ценнике стёрлась одна цифра: 4?2 тысячи сумов. Картинки нет.', uz: "Narx yorlig'ida bitta raqam o'chib qolgan: 4?2 ming so'm. Rasm yo'q." },
