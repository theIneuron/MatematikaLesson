...
const ITEM = {
  ...
  "prompt": {
    ...
    "en": "Match each pair of fractions with its least common denominator."
  },
  "left": [
    "1/4 va 1/10",
    "1/9 va 1/15",
  ...
  "translationsEn": {
    "1/4 va 1/10": "1/4 and 1/10",
    "1/9 va 1/15": "1/9 and 1/15",
    "1/14 va 1/21": "1/14 and 1/21"
  },
  "explanation": {
    ...
    "en": "LCM(4, 10) = 20, LCM(9, 15) = 45, LCM(14, 21) = 42."
  }
};
