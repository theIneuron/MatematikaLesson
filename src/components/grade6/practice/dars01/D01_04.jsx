...
const ITEM = {
  "type": "choice",
  "topic": {
    "uz": "Karrali sonni topish",
    "ru": "Практика к уроку 1. Делители и кратные",
    "en": "Finding a multiple"
  },
  "prompt": {
    "uz": "7 ga karrali sonni toping.",
    "ru": "Найдите число, кратное 7.",
    "en": "Find a multiple of 7."
  },
  "options": [
    "32",
    "35",
  ...
  "explanation": {
    ...
    "en": "35 = 7 × 5. So 35 is a multiple of 7."
  }
};
