...
const ITEM = {
  type: 'bool',
  topic: { uz: "Karralilikni tekshirish", ru: 'Практика к уроку 1. Делители и кратные' },
  prompt: { uz: "54 soni 6 ga karrali.", ru: 'Верно ли, что число 54 кратно 6?' },
  options: ["Ha", "Yo'q"],
  answer: "Ha",
  translationsRu: { Ha: 'Да', "Yo'q": 'Нет' },
  explanation: {
