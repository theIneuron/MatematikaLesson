...
const ITEM = {
  ...
  "topic": {
    ...
    "en": "Results of the calculations"
  },
  "prompt": {
    ...
    "en": "Work out the operations with decimals and pair each one with its own correct answer."
  },
  "left": [
    "3,6 × 1,5",
    "9,24 : 2,2",
  ...
  "explanation": {
    ...
    "en": "3,6 × 1,5 = 5,4; 9,24 : 2,2 = 4,2; 0,84 : 0,7 = 1,2."
  }
};
