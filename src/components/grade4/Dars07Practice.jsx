...
const UI = {
  ...
  retry: { ru: 'Попробовать ещё раз', uz: "Yana urinib ko'ring" },
  ...
  resetMatches: { ru: 'Сбросить пары', uz: 'Juftliklarni tozalash' },
  constructHint: {
...
const TASKS = [
  {
    ...
    setup: { ru: 'На панели появился римский знак.', uz: "Panelda Rim belgisi paydo bo'ldi." },
    prompt: { ru: 'Какое значение сохраняет знак V?', uz: 'V belgisi qaysi qiymatni saqlaydi?' },
    options: [
      {
        text: { ru: '1', uz: '1' },
        wrong: {
    ...
    correctText: { ru: 'Верно. Римский знак V обозначает пять.', uz: "To'g'ri. Rim yozuvidagi V belgisi beshni bildiradi." },
    rule: {
  ...
  },
  {
    ...
    setup: { ru: 'Четыре кода записаны двумя способами.', uz: "To'rtta kod ikki xil usulda yozilgan." },
    prompt: { ru: 'Соедини число с его римской записью.', uz: 'Sonni uning Rim yozuvi bilan moslashtiring.' },
    pairs: [
      { id: 'a', left: { ru: '3', uz: '3' }, right: { ru: 'III', uz: 'III' } },
      { id: 'b', left: { ru: '7', uz: '7' }, right: { ru: 'VII', uz: 'VII' } },
      { id: 'c', left: { ru: '12', uz: '12' }, right: { ru: 'XII', uz: 'XII' } },
      { id: 'd', left: { ru: '17', uz: '17' }, right: { ru: 'XVII', uz: 'XVII' } },
    ],
    wrongText: {
  ...
  },
  {
    ...
    setup: { ru: 'Для табло нужно собрать римскую запись числа 16.', uz: 'Tablo uchun 16 sonining Rim yozuvini tuzish kerak.' },
    prompt: { ru: 'Собери число 16 из карточек.', uz: 'Kartalardan 16 sonini yasang.' },
    cards: [
      { id: 'x1', symbol: 'X' },
      { id: 'v1', symbol: 'V' },
      { id: 'i1', symbol: 'I' },
    ...
    correctText: { ru: 'Верно: XVI — это 10 + 5 + 1, то есть 16.', uz: "To'g'ri: XVI — 10 + 5 + 1, ya'ni 16." },
    rule: {
  ...
  },
  {
    ...
    setup: { ru: 'Одинаковая цифра 3 заняла разные места.', uz: "Bir xil 3 raqami turli o'rinlarni egalladi." },
    prompt: { ru: 'Каковы значения цифры 3 в числах 36 и 63?', uz: '36 va 63 sonlaridagi 3 raqamining qiymatlari qanday?' },
    options: [
      { text: { ru: '30 и 3', uz: '30 va 3' }, correct: true },
      {
        text: { ru: '3 и 30', uz: '3 va 30' },
        wrong: { ru: 'Значения переставлены. Сначала проверь место цифры 3 в числе 36.', uz: "Qiymatlar o'rni almashgan. Avval 36 sonidagi 3 raqamining o'rnini tekshiring." },
      },
      {
        text: { ru: '3 и 3', uz: '3 va 3' },
        wrong: { ru: 'В десятичной записи место цифры меняет её значение.', uz: "O'nlik yozuvda raqamning o'rni uning qiymatini o'zgartiradi." },
      },
      {
        text: { ru: '300 и 30', uz: '300 va 30' },
        wrong: { ru: 'Оба значения сдвинуты на один разряд влево. Посчитай цифры справа от тройки.', uz: "Ikkala qiymat ham bir xona chapga siljigan. Uchdan o'ngdagi raqamlarni sanang." },
      },
    ],
    correctText: { ru: 'Верно. В числе 36 цифра 3 означает 30, а в числе 63 — 3.', uz: "To'g'ri. 36 sonida 3 raqami 30 ni, 63 sonida esa 3 ni bildiradi." },
    rule: { ru: 'В позиционной системе значение цифры зависит от её места.', uz: "Pozitsion sistemada raqam qiymati uning o'rniga bog'liq." },
  },
  {
    id: '05', kind: 'numpad', level: '🟡', answer: '4000', maxLen: 4,
    figure: '4 204 = □ + 200 + 4',
    setup: { ru: 'В разложении числа пропало одно слагаемое.', uz: "Sonning yoyiq yozuvida bitta qo'shiluvchi yo'qoldi." },
    prompt: { ru: 'Какое число нужно поставить вместо квадрата?', uz: "Kvadrat o'rniga qaysi sonni qo'yish kerak?" },
    wrongByAnswer: {
      4: { ru: 'Записана сама цифра, а не её значение. Определи разряд левой четвёрки.', uz: "Raqamning o'zi yozilgan, qiymati emas. Chapdagi to'rt qaysi xonada turganini aniqlang." },
      40: { ru: 'Это значение цифры 4 в десятках. В числе 4 204 она стоит намного левее.', uz: "Bu 4 raqamining o'nlar xonasidagi qiymati. 4 204 sonida u ancha chapda turibdi." },
      400: { ru: 'Это значение цифры 4 в сотнях. Посчитай, сколько цифр находится справа от левой четвёрки.', uz: "Bu 4 raqamining yuzlar xonasidagi qiymati. Chapdagi to'rtdan o'ngda nechta raqam borligini sanang." },
    },
    hints: [
      { ru: 'Определи разряд левой цифры 4 по её месту в числе.', uz: "Chapdagi 4 raqamining xonasini son ichidagi o'rniga qarab aniqlang." },
      { ru: 'Справа от левой четвёрки три цифры. Значит, она показывает количество тысяч.', uz: "Chapdagi to'rtdan o'ngda uchta raqam bor. Demak, u minglar miqdorini bildiradi." },
    ],
    correctText: { ru: 'Верно: 4 204 = 4 000 + 200 + 4.', uz: "To'g'ri: 4 204 = 4 000 + 200 + 4." },
    rule: { ru: 'Развёрнутая запись показывает значение каждой цифры по её разряду.', uz: "Yoyiq yozuv har bir raqamning xona bo'yicha qiymatini ko'rsatadi." },
  },
  {
    id: '06', kind: 'mc', level: '🟡', figure: '74  ·  XV', wideOptions: true,
    setup: { ru: 'Два маршрутных кода записаны разными системами.', uz: "Ikki yo'nalish kodi turli sistemalarda yozilgan." },
    prompt: { ru: 'Как правильно проверить каждый код?', uz: "Har bir kodni qanday to'g'ri tekshirish mumkin?" },
    options: [
      {
        text: { ru: '74 = 7 десятков + 4 единицы; XV = 10 + 5', uz: "74 = 7 o'nlik + 4 birlik; XV = 10 + 5" },
        correct: true,
      },
      {
        text: { ru: '74 = 7 + 4; XV = 1 десяток + 5 единиц', uz: "74 = 7 + 4; XV = 1 o'nlik + 5 birlik" },
        wrong: { ru: 'Способы перепутаны. В числе 74 цифра 7 имеет разрядное значение, а X — римский знак.', uz: "Usullar aralashib ketgan. 74 sonida 7 xona qiymatiga ega, X esa Rim belgisidir." },
      },
      {
        text: { ru: 'Оба кода нужно разложить по десятичным разрядам', uz: "Ikkala kodni ham o'nlik xonalarga ajratish kerak" },
        wrong: { ru: 'У римской записи нет десятичных разрядов единиц и десятков.', uz: "Rim yozuvida o'nlik sistemadagi birlar va o'nlar xonalari yo'q." },
      },
      {
        text: { ru: 'В обоих кодах нужно просто сложить написанные цифры', uz: "Ikkala kodda ham yozilgan raqamlarni shunchaki qo'shish kerak" },
        wrong: { ru: 'В записи 74 цифра 7 означает не семь, а семь десятков.', uz: "74 yozuvida 7 raqami yettini emas, yetti o'nlikni bildiradi." },
      },
    ],
    correctText: { ru: 'Верно. Десятичный код проверен по разрядам, а римский — по значениям знаков.', uz: "To'g'ri. O'nlik kod xonalar orqali, Rim kodi esa belgilar qiymati orqali tekshirildi." },
    rule: { ru: 'Для разных систем счисления нужны разные способы разбора записи.', uz: 'Turli sanoq sistemalaridagi yozuvlar turli usulda tahlil qilinadi.' },
  },
  {
    id: '07', kind: 'sort', level: '🟡',
    setup: { ru: 'Записи смешались на двух терминалах.', uz: 'Yozuvlar ikki terminalda aralashib ketdi.' },
    prompt: { ru: 'Раздели записи по системам счисления.', uz: "Yozuvlarni sanoq sistemalari bo'yicha ajrating." },
    bins: [
      { id: 'pos', label: { ru: 'Позиционная', uz: 'Pozitsion' } },
      { id: 'nonpos', label: { ru: 'Непозиционная', uz: 'Nopozitsion' } },
    ],
    items: [
    ...
    correctText: { ru: 'Верно. Десятичные числа и римские записи разделены по двум системам.', uz: "To'g'ri. O'nlik sonlar va Rim yozuvlari ikki sistemaga ajratildi." },
    rule: { ru: 'В десятичной записи значение цифры зависит от разряда; римский знак сохраняет своё значение.', uz: "O'nlik yozuvda raqam qiymati xonaga bog'liq; Rim belgisi esa o'z qiymatini saqlaydi." },
  },
  {
    id: '08', kind: 'mc', level: '🔴', figure: '222  ·  III', wideOptions: true,
    setup: { ru: 'В обеих записях один знак повторяется три раза.', uz: 'Ikkala yozuvda ham bitta belgi uch marta takrorlangan.' },
    prompt: { ru: 'Какое сравнение верно?', uz: "Qaysi taqqoslash to'g'ri?" },
    options: [
      {
        text: { ru: 'В 222 цифры означают 200, 20 и 2; в III каждый знак I означает 1', uz: '222 da raqamlar 200, 20 va 2 ni; III da har bir I belgisi 1 ni bildiradi' },
        correct: true,
      },
      {
        text: { ru: 'В обеих записях каждый повторённый знак имеет одно и то же значение', uz: 'Ikkala yozuvda ham takrorlangan har bir belgi bir xil qiymatga ega' },
        wrong: { ru: 'В числе 222 одинаковые цифры стоят в разных разрядах.', uz: "222 sonida bir xil raqamlar turli xonalarda turibdi." },
      },
      {
        text: { ru: 'В обеих записях место знака меняет его значение', uz: "Ikkala yozuvda ham belgining o'rni uning qiymatini o'zgartiradi" },
        wrong: { ru: 'В записи III каждый знак I сохраняет значение один.', uz: 'III yozuvida har bir I belgisi bir qiymatini saqlaydi.' },
      },
      {
        text: { ru: '222 — непозиционная запись, а III — позиционная', uz: '222 — nopozitsion yozuv, III esa pozitsion yozuv' },
        wrong: { ru: 'Названия систем переставлены. Проверь, где значение цифры зависит от разряда.', uz: "Sistemalar nomi almashgan. Qayerda raqam qiymati xonaga bog'liqligini tekshiring." },
      },
    ],
    correctText: { ru: 'Верно. В 222 место меняет значение цифры, а каждый знак I сохраняет значение один.', uz: "To'g'ri. 222 da o'rin raqam qiymatini o'zgartiradi, har bir I belgisi esa bir qiymatini saqlaydi." },
    rule: { ru: 'Повтор одинаковых знаков по-разному работает в позиционной и непозиционной записи.', uz: 'Bir xil belgining takrorlanishi pozitsion va nopozitsion yozuvda turlicha ishlaydi.' },
  },
  {
    id: '09', kind: 'mc', level: '🔴', figure: 'XIX', wideOptions: true,
    setup: { ru: 'Аналитик решил: второй знак X из-за своего места означает 100.', uz: "Tahlilchi ikkinchi X belgisi o'rni sabab 100 ni bildiradi, deb o'yladi." },
    prompt: { ru: 'Где находится первая ошибка в рассуждении?', uz: 'Fikrlashdagi birinchi xato qayerda?' },
    options: [
      {
        text: { ru: 'В римской записи X всегда означает 10, а пара IX означает 9', uz: "Rim yozuvida X har doim 10 ni, IX juftligi esa 9 ni bildiradi" },
        correct: true,
      },
      {
        text: { ru: 'Знак I между двумя X нужно прибавить к обоим знакам', uz: "Ikki X orasidagi I belgisini ikkala belgiga ham qo'shish kerak" },
        wrong: { ru: 'Один знак нельзя одновременно использовать в двух действиях. Сначала найди разрешённую пару.', uz: "Bitta belgini bir vaqtning o'zida ikki amalda ishlatib bo'lmaydi. Avval ruxsat etilgan juftlikni toping." },
      },
      {
        text: { ru: 'Правый знак всегда получает значение следующего десятичного разряда', uz: "O'ngdagi belgi har doim keyingi o'nlik xona qiymatini oladi" },
        wrong: { ru: 'Это правило десятичной позиционной записи, а не римских знаков.', uz: "Bu o'nlik pozitsion yozuv qoidasi, Rim belgilarining qoidasi emas." },
      },
      {
        text: { ru: 'Ошибки нет: XIX равно 111', uz: "Xato yo'q: XIX 111 ga teng" },
        wrong: { ru: 'Римские знаки нельзя читать как десятичные цифры, стоящие рядом.', uz: "Rim belgilarini yonma-yon turgan o'nlik raqamlar kabi o'qib bo'lmaydi." },
      },
    ],
    correctText: { ru: 'Верно. XIX = X + IX = 10 + 9 = 19; оба знака X сохраняют значение 10.', uz: "To'g'ri. XIX = X + IX = 10 + 9 = 19; ikkala X belgisi ham 10 qiymatini saqlaydi." },
    rule: { ru: 'Не переноси правило разрядов десятичной системы на римскую запись.', uz: "O'nlik sistemaning xona qoidasini Rim yozuviga ko'chirmang." },
  },
  {
    id: '10', kind: 'mc', level: '🔴', figure: '707  ·  XIV', wideOptions: true,
    setup: { ru: 'Два городских кода нужно проверить и объяснить.', uz: 'Ikki shahar kodini tekshirish va tushuntirish kerak.' },
    prompt: { ru: 'Какой план проверки надёжен?', uz: 'Qaysi tekshirish rejasi ishonchli?' },
    options: [
      {
        text: { ru: '707 = 700 + 0 + 7; XIV = X + IV = 10 + 4 = 14', uz: '707 = 700 + 0 + 7; XIV = X + IV = 10 + 4 = 14' },
        correct: true,
      },
      {
        text: { ru: 'Оба кода разложить по сотням, десяткам и единицам', uz: "Ikkala kodni ham yuzlar, o'nlar va birlar xonasiga ajratish" },
        wrong: { ru: 'У записи XIV нет десятичных разрядов. Для неё проверь значения и порядок римских знаков.', uz: "XIV yozuvida o'nlik xonalar yo'q. Unda Rim belgilarining qiymati va tartibini tekshiring." },
      },
      {
        text: { ru: 'В обоих кодах сложить значения всех написанных знаков', uz: "Ikkala kodda ham yozilgan barcha belgilar qiymatini qo'shish" },
        wrong: { ru: 'В числе 707 значение цифры задаёт разряд, а в паре IV действует вычитание.', uz: "707 sonida raqam qiymatini xona belgilaydi, IV juftligida esa ayirish ishlaydi." },
      },
      {
        text: { ru: '707 прочитать как римскую запись, а XIV разложить по разрядам', uz: "707 ni Rim yozuvi kabi o'qish, XIV ni esa xonalarga ajratish" },
        wrong: { ru: 'Способы проверки поменялись местами. Сначала определи систему каждой записи.', uz: "Tekshirish usullari o'rni almashgan. Avval har bir yozuvning sistemasini aniqlang." },
      },
    ],
    correctText: { ru: 'Верно. Для каждого кода выбран способ, соответствующий его системе счисления.', uz: "To'g'ri. Har bir kod uchun uning sanoq sistemasiga mos usul tanlandi." },
    rule: { ru: 'Сначала определи систему записи, затем применяй её правило чтения.', uz: "Avval yozuv sistemasini aniqlang, keyin uning o'qish qoidasini qo'llang." },
  },
];
        ...
        {Array.from({ length: task.slotCount }, (_, index) => {
          ...
          return (
            <button
              ...
              aria-label={card
                ? `${index + 1}: ${card.symbol}`
                : (lang === 'uz' ? `${index + 1}-bo'sh joy` : `${index + 1}-е пустое место`)}
            ...
            <div className="p4-sort-bin-items">
              {order.filter((item) => assignments[item.id] === bin.id).map((item) => (
                <button
                  ...
                  disabled={solved}
                  aria-label={lang === 'uz' ? `${item.text} kartasini qaytarish` : `Вернуть карточку ${item.text}`}
                  onClick={() => {
                    setAssignments((old) => {
                      const next = { ...old };
                      delete next[item.id];
...
export default function Grade4Dars07Practice({ lang: langProp, onFinished }) {
  ...
  return (
    <div className="p4-root">
      <style>{STYLES}</style>
      {preview && (
        <div className="p4-lang" aria-label="Language">
          {['ru', 'uz'].map((code) => (
            <button
              key={code}
              type="button"
      ...
      <header className="p4-head">
        <div
          ...
          aria-label={lang === 'uz' ? 'Bajarilgan topshiriqlar' : 'Выполненные задания'}
        >
