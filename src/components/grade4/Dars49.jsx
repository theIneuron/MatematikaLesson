...
function ConversionVisual({ c, frame }) { const visual = <ConversionVisualContent c={c} frame={frame}/>; const sceneName = String(c?.scene ?? ''); return /(^|-)hook($|-)/.test(sceneName) ? visual : <div className="canonical-visual-frame" data-g4-role="visual-frame" data-g4-scene={sceneName} style={{ position: 'relative', isolation: 'isolate', minWidth: 0, maxWidth: '100%', height: '100%', overflow: 'hidden' }}>{visual}</div>; }
...
@media(max-width:639.98px){
  ...
  .lesson-root .canonical-visual-frame>.conversion-visual{width:200%;height:200%;transform:scale(.49)}
...
@media(min-width:640px){
  .lesson-root .canonical-visual-frame[data-g4-scene="logic-final"]>.conversion-visual{position:absolute;inset:0 auto auto 0;width:117.647%;height:117.647%;max-width:none;min-height:0;transform:scale(.85);transform-origin:top left}
