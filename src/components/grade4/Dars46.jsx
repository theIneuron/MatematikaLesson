...
@media(min-width:640px) and (max-width:1100px){
  .lesson-root .canonical-visual-frame[data-g4-scene="fraction-case"]>.conversion-visual{position:absolute;inset:0 auto auto 0;width:117.647%;height:117.647%;max-width:none;min-height:0;transform:scale(.85);transform-origin:top left}
}
