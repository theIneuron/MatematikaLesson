...
Tekshiruv: `npm run lint:grade4:trilingual` faqat migratsiya targetlari va ularning audit/smoke infratuzilmasini lint qiladi. `npm run audit:grade4:trilingual` migratsiya scope'idagi Dars01–Dars30 va Dars01Practice–Dars21Practice komponentlari uchun til to'liqligi, selectorlar, theory audio parity va practice audio-free kontraktini tekshiradi. `npm run test:grade4:browser:trilingual` shu 51 route'ni UZ/RU/EN va belgilangan viewportlarda tekshiradi. `npm run audit:grade4` esa kengaytirilgan kurs auditini, jumladan Dars31–51 uchun 15 slayd/50 avtomatik frame kontraktini ham ishga tushiradi.
