...
.finale-proof > span, .finale-bridge strong { color: ${T.success}; font: 900 13px/1.2 'JetBrains Mono', monospace; letter-spacing: .1em; }
.finale-proof > strong { color: ${T.navy}; font: 800 19px/1 'JetBrains Mono', monospace; white-space: nowrap; }
.finale-proof p, .finale-bridge p { color: ${T.ink2}; font-size: 15px; line-height: 1.35; overflow-wrap: anywhere; }
...
@media (max-width: 639.98px) and (max-height: 700px) {
  ...
  .finale-proof > span, .finale-bridge strong { font-size: 11px; }
  .finale-proof > strong { font-size: 16px; }
  .finale-proof p, .finale-bridge p { font-size: 12px; line-height: 1.2; }
