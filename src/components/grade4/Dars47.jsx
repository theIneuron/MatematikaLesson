...
function Screen14({ screen, answers, onPrev, finishLesson }) {
  ...
  return <Stage screen={screen} audio={audio} onPrev={onPrev} onNext={finishLesson} finish><div className="stack"><Heading c={c} state="happy" showBit/><section className="model-card summary-card"><ConversionVisual c={c} frame={audio.frame}/><RevealFrames frames={c.frames} frame={audio.frame}/></section><G4TitleReward unlocked={unlocked} title={{"uz":"Tengsizliklar tadqiqotchisi","ru":"Исследователь неравенств","en":"Inequality investigator"}} answers={answers}/></div></Stage>;
}
