...
const CONTENT = {
  "s0": {
    ...
    "audio": {
      "intro": {
        "uz": [
          "Salom, do'stim! Bugun to'g'ri to'rtburchak va kvadratning xossalarini o'rganamiz. Sahnada to'g'ri to'rtburchak turibdi.",
          "Kvadrat uning ichiga joylashadi.",
          "Har bir kvadrat to'g'ri to'rtburchakmi."
        ],
        "ru": [
          "Привет, друг! Сегодня мы изучим свойства прямоугольника и квадрата. На сцене находится прямоугольник.",
          "Квадрат помещается внутрь него.",
          "Каждый ли квадрат является прямоугольником?"
        ],
        "en": [
          "Hey, buddy! Today we'll learn about the properties of rectangles and squares. A rectangle is shown on the stage.",
