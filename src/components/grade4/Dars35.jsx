...
const ANSWER_ORDINAL_BY_SCREEN = Object.freeze({ 8: 1, 9: 2, 10: 3, 12: 4, 13: 5 });
...
const HOOK_RETRY = bi(
  "Tomonlar va burchaklar uchburchakni ikki xil belgi bo'yicha tasniflaydi.",
  'Стороны и углы классифицируют треугольник по двум разным признакам.',
  'Sides and angles classify a triangle by two different properties.',
);
const REFLECTION = {
...
const LESSON_KIND = "triangle";
const LESSON_META = { lessonId: "geometry-4-35-v1", slug: "dars35-uchburchak-turlari", lessonTitle: {"uz":"Uchburchak turlari","ru":"Виды треугольников","en":"Types of triangles"}, skillTags: ["triangle-sides","triangle-angles","dual-classification","property-marks"] };
const CONTENT = {
  "s0": {
    "eyebrow": {
      "uz": "Muammo",
    ...
    "title": {
      "uz": "Bitta uchburchak - ikki nom",
      "ru": "Один треугольник - два названия",
      "en": "One triangle - two names"
    },
    "scene": "triangle-hook",
    "closedSet": true,
    "correctIndex": 0,
    "frames": [
      {
        "uz": "Uchburchakning ikki tomoni teng",
        "ru": "Две стороны треугольника равны",
        "en": "Two sides of the triangle are equal"
      },
      {
        "uz": "Bitta burchagi 90°",
        "ru": "Один угол равен 90°",
        "en": "One angle is 90°"
      },
      {
        "uz": "Uni qanday ikki usulda nomlaymiz?",
        "ru": "Как назвать его двумя способами?",
        "en": "How can we name it in two ways?"
      }
    ],
    "question": {
      "uz": "Uchburchak ikkita nomga ega bo'lishi mumkinmi?",
      "ru": "Может ли треугольник иметь два названия?",
      "en": "Can a triangle have two names?"
    },
    "options": [
      {
        "uz": "Ha, ikki belgi bo'yicha",
        "ru": "Да, по двум признакам",
        "en": "Yes, using two properties"
      },
      {
        "uz": "Yo'q, faqat bitta nom bo'ladi",
        "ru": "Нет, бывает только одно название",
        "en": "No, it can have only one name"
      },
      {
        "uz": "Faqat katta uchburchaklarda",
        "ru": "Только у больших треугольников",
        "en": "Only for large triangles"
      }
    ],
    "neutral": {
      "uz": "Taxmin saqlandi. Avval tomonlar, keyin burchaklar bo'yicha tekshiramiz.",
      "ru": "Гипотеза сохранена. Сначала проверим стороны, затем углы.",
      "en": "Estimate saved. We will check sides first, then angles."
    },
    "audio": {
      "intro": {
        "uz": [
          "Uchburchakning ikki tomonida tenglik belgilari bor.",
          "Bitta burchak to'qson daraja deb belgilangan.",
          "Uni qanday ikki usulda nomlaymiz."
        ],
        "ru": [
          "На двух сторонах треугольника стоят одинаковые отметки.",
          "Один угол отмечен как девяносто градусов.",
          "Как назовём его двумя способами?"
        ],
        "en": [
          "Two sides of the triangle have matching marks.",
          "One angle is marked as ninety degrees.",
          "How can we name it in two ways?"
        ]
      }
    }
  },
  "s1": {
    ...
    "title": {
      "uz": "Uchburchak anatomiyasi",
      "ru": "Строение треугольника",
      "en": "Triangle anatomy"
    },
    "scene": "triangle-parts",
    "frames": [
      {
        "uz": "3 ta tomon",
        "ru": "3 стороны",
      ...
      {
        "uz": "Mos qismlarni rang bilan ajrating",
        "ru": "Выделите соответствующие части цветом",
        "en": "Highlight matching parts with colour"
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Uch tomon yopiq shakl hosil qiladi tutashuvlar uchlar ochilishlar esa burchaklardir. Uchta tomon.",
          "Uchta uch",
          "Uchta burchak.",
          "Mos qismlarni rang bilan ajrating."
        ],
        "ru": [
          "Три стороны образуют замкнутую фигуру их соединения являются вершинами а раскрытия углами. Три стороны.",
          "Три вершины",
          "Три угла.",
          "Выделите соответствующие части цветом."
        ],
        "en": [
          "Three sides form a closed shape their joins are vertices and their openings are angles. Three sides.",
          "Three vertices",
          "Three angles.",
          "Highlight matching parts with colour."
        ]
      }
    }
  },
  "s2": {
    ...
    "scene": "triangle-equal",
    "frames": [
      {
        "uz": "Barcha tomonlarda bir xil belgi",
        "ru": "На всех сторонах одинаковые отметки",
        "en": "All sides have the same marks"
      },
      {
        "uz": "a = b = c",
        "ru": "a = b = c",
      ...
      {
        "uz": "Uchala tomon teng",
        "ru": "Все три стороны равны",
        "en": "All three sides are equal"
      },
      {
    ...
    "audio": {
      "intro": {
        "uz": [
          "Uchala tomon teng bo'lsa uchburchak teng tomonli deb tasniflanadi. Barcha tomonlarda bir xil belgi.",
          "A teng b teng c",
          "Uchala tomon teng.",
          "Teng tomonli uchburchak."
        ],
        "ru": [
          "Если равны все три стороны треугольник является равносторонним. На всех сторонах одинаковые отметки.",
          "A равно b равно c",
          "Все три стороны равны.",
          "Равносторонний треугольник."
        ],
        "en": [
          "When all three sides are equal the triangle is equilateral. All sides have the same marks.",
          "A equals b equals c",
  ...
  "s3": {
    ...
    "frames": [
      {
        "uz": "Ikki tomonda bir xil belgi",
        "ru": "На двух сторонах одинаковые отметки",
        "en": "Two sides have the same marks"
      },
      {
        "uz": "a = b",
        "ru": "a = b",
      ...
      {
        "uz": "Ikki tomon teng",
        "ru": "Две стороны равны",
        "en": "Two sides are equal"
      },
      {
    ...
    "audio": {
      "intro": {
        "uz": [
          "Aynan ikki tomon teng bo'lsa uchburchak teng yonli bo'ladi. Ikki tomonda bir xil belgi.",
          "A teng b",
          "Ikki tomon teng.",
          "Teng yonli uchburchak."
        ],
        "ru": [
          "Если равны две стороны треугольник является равнобедренным. На двух сторонах одинаковые отметки.",
          "A равно b",
          "Две стороны равны.",
          "Равнобедренный треугольник."
        ],
        "en": [
          "When two sides are equal the triangle is isosceles. Two sides have the same marks.",
          "A equals b",
          "Two sides are equal.",
          "Isosceles triangle."
        ]
  ...
  "s4": {
    ...
    "scene": "triangle-scalene",
    "frames": [
      {
        "uz": "Uch xil uzunlik",
        "ru": "Три разные длины",
        "en": "Three different lengths"
      },
      {
        "uz": "a ≠ b, b ≠ c, a ≠ c",
        "ru": "a ≠ b, b ≠ c, a ≠ c",
      ...
      {
        "uz": "Barcha tomonlar turli",
        "ru": "Все стороны разные",
        "en": "All sides are different"
      },
      {
        "uz": "Turli tomonli uchburchak",
        "ru": "Разносторонний треугольник",
        "en": "Scalene triangle"
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Uchala tomon uzunligi turlicha bo'lsa uchburchak turli tomonli bo'ladi. Uch xil uzunlik.",
          "A va b turlicha, b va c turlicha, a va c ham turlicha",
          "Barcha tomonlar turli.",
          "Turli tomonli uchburchak."
        ],
        "ru": [
          "Если длины всех трёх сторон различны треугольник разносторонний. Три разные длины.",
          "A не равно b, b не равно c, a не равно c",
          "Все стороны разные.",
          "Разносторонний треугольник."
        ],
        "en": [
          "When all three side lengths differ the triangle is scalene. Three different lengths.",
          "A differs from b, b differs from c, and a differs from c",
  ...
  "s5": {
    ...
    "frames": [
      {
        "uz": "Barcha burchaklari o'tkir",
        "ru": "Все углы острые",
        "en": "All angles are acute"
      },
      {
        "uz": "Bitta burchagi 90°",
        "ru": "Один угол равен 90°",
      ...
      {
        "uz": "Bitta burchagi o'tmas",
        "ru": "Один угол тупой",
        "en": "One angle is obtuse"
      },
      {
        "uz": "O'tkir, to'g'ri yoki o'tmas burchakli",
        "ru": "Остроугольный, прямоугольный или тупоугольный",
        "en": "Acute-angled, right-angled or obtuse-angled"
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Burchaklar bo'yicha tasnif eng katta burchakning o'tkir to'g'ri yoki o'tmasligiga qaraydi. Barcha burchaklari o'tkir.",
          "Bitta burchagi to'qson daraja",
          "Bitta burchagi o'tmas.",
          "O'tkir to'g'ri yoki o'tmas burchakli."
        ],
        "ru": [
          "Классификация по углам зависит от того является ли наибольший угол острым прямым или тупым. Все углы острые.",
          "Один угол составляет девяносто градусов",
          "Один угол тупой.",
          "Остроугольный прямоугольный или тупоугольный."
        ],
        "en": [
          "Classification by angles depends on whether the largest angle is acute right or obtuse. All angles are acute.",
          "One angle is ninety degrees",
          "One angle is obtuse.",
  ...
  "s6": {
    ...
    "title": {
      "uz": "Ikki tasnif",
      "ru": "Две классификации",
      "en": "Two classifications"
    },
    "scene": "triangle-rule",
    "frames": [
      {
        "uz": "Avval tomonlarga qarang",
        "ru": "Сначала посмотрите на стороны",
        "en": "First look at the sides"
      },
      {
        "uz": "Birinchi nomni bering",
        "ru": "Дайте первое название",
        "en": "Give the first label"
      },
      {
        "uz": "Keyin burchaklarga qarang",
        "ru": "Затем посмотрите на углы",
        "en": "Then look at the angles"
      },
      {
        "uz": "Ikkinchi nomni bering",
        "ru": "Дайте второе название",
        "en": "Give the second label"
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Ikki tasnifni aralashtirmaslik uchun avval tomon belgilarini keyin burchaklarni tekshiramiz. Avval tomonlarga qarang.",
          "Birinchi nomni bering",
          "Keyin burchaklarga qarang.",
          "Ikkinchi nomni bering."
        ],
        "ru": [
          "Чтобы не смешать классификации сначала проверяют стороны затем углы. Сначала посмотрите на стороны.",
          "Дайте первое название",
          "Затем посмотрите на углы.",
          "Дайте второе название."
        ],
        "en": [
          "To keep the classifications separate inspect the sides first and then the angles. First look at the sides.",
          "Give the first label",
          "Then look at the angles.",
          "Give the second label."
        ]
      }
    }
  },
  "s7": {
    ...
    "title": {
      "uz": "Ko'prik tayanchi pasporti",
      "ru": "Паспорт опоры моста",
      "en": "Bridge support profile"
    },
    "scene": "triangle-payoff",
    "frames": [
      {
        "uz": "Ikki teng katet: 5 va 5",
        "ru": "Два равных катета: 5 и 5",
        "en": "Two equal legs: 5 and 5"
      },
      {
        "uz": "Ikki tomon teng",
        "ru": "Две стороны равны",
    ...
    "audio": {
      "intro": {
        "uz": [
          "Tayanchdagi ikki teng katet va to'g'ri burchak unga ikkita mustaqil nom beradi. Ikki teng katet besh va besh.",
          "Ikki tomon teng",
          "Bitta burchak to'qson daraja.",
          "Teng yonli.",
          "To'g'ri burchakli."
        ],
        "ru": [
          "Два равных катета и прямой угол опоры дают ей два независимых названия. Два равных катета, пять и пять.",
          "Две стороны равны",
          "Один угол составляет девяносто градусов.",
          "Равнобедренный.",
          "Прямоугольный."
        ...
        "en": [
          "Two equal legs and a right angle give the support two independent labels. Two equal legs, five and five.",
          "Two sides are equal",
          "One angle is ninety degrees.",
          "Isosceles.",
          "Right angled."
  ...
  "s8": {
    ...
    "frames": [
      ...
      {
        "uz": "Eng aniq nomini tanlang",
        "ru": "Выберите наиболее точное название",
        "en": "Choose the most precise name"
      }
    ],
    "question": {
      "uz": "Tomonlariga ko'ra eng aniq nomi qaysi?",
      "ru": "Какое название по сторонам наиболее точное?",
      "en": "What is its most precise name by sides?"
    },
    "options": [
      {
        "uz": "Teng tomonli",
    ...
    "closedSet": true,
    "proof": {
      "uz": "6 = 6 = 6, barcha tomonlar teng",
      "ru": "6 = 6 = 6, все стороны равны",
      "en": "6 = 6 = 6, so all sides are equal"
    },
    "feedbackAudio": [
      {
        "uz": "To'g'ri. Olti teng olti teng olti barcha tomonlar teng.",
        "ru": "Верно. Шесть равно шесть равно шесть все стороны равны.",
        "en": "Correct. Six equals six equals six so all sides are equal."
      },
      {
        "uz": "Yana bir qarang: Uchala tomon ham teng. Bu tasnifda bunday uchburchakning aniq nomi teng tomonli.",
        "ru": "Посмотрите ещё раз: Равны все три стороны. В этой классификации такой треугольник называется равносторонним.",
        "en": "Look again: All three sides are equal. In this classification, the precise name is equilateral."
      },
      {
        "uz": "Yana bir qarang: Turli tomonli uchburchakda uchala tomon har xil bo'ladi. Bu yerda olti, olti va olti teng.",
        "ru": "Посмотрите ещё раз: У разностороннего треугольника все стороны различны. Здесь стороны шесть, шесть и шесть равны.",
        "en": "Look again: A scalene triangle has three different side lengths. Here, six, six and six are equal."
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Uchburchak tomonlari olti, olti va olti birlik.",
          "Tomonlariga ko'ra eng aniq nomini tanlang."
        ],
        "ru": [
          "Стороны треугольника равны шести, шести и шести единицам.",
          "Выберите наиболее точное название по сторонам."
        ],
        "en": [
          "The triangle sides are six, six and six units.",
          "Choose its most precise name by sides."
        ]
      },
      "on_correct": {
        "uz": "To'g'ri. Olti teng olti teng olti barcha tomonlar teng.",
  ...
  "s9": {
    ...
    "question": {
      "uz": "Tomonlariga ko'ra turi?",
      "ru": "Каков вид по сторонам?",
      "en": "What is its type by sides?"
    },
    "options": [
      {
        "uz": "Teng tomonli",
    ...
    "closedSet": true,
    "proof": {
      "uz": "5 = 5, ikki tomon teng",
      "ru": "5 = 5, две стороны равны",
      "en": "5 = 5, so two sides are equal"
    },
    "feedbackAudio": [
      {
        "uz": "Yana bir qarang: Teng tomonli uchburchakda uchala tomon teng bo'ladi. Bu yerda uchinchi tomon sakkiz, qolganlari besh.",
        "ru": "Посмотрите ещё раз: У равностороннего треугольника равны все три стороны. Здесь третья сторона равна восьми, а остальные равны пяти.",
        "en": "Look again: An equilateral triangle has three equal sides. Here, the third side is eight while the other two are five."
      },
      {
        "uz": "To'g'ri. Besh teng besh ikki tomon teng.",
        "ru": "Верно. Пять равно пять две стороны равны.",
        "en": "Correct. Five equals five so two sides are equal."
      },
      {
        "uz": "Yana bir qarang: Turli tomonli uchburchakda teng tomonlar bo'lmaydi. Bu yerda ikki tomon beshga teng.",
        "ru": "Посмотрите ещё раз: У разностороннего треугольника нет равных сторон. Здесь две стороны равны пяти.",
        "en": "Look again: A scalene triangle has no equal side lengths. Here, two sides are both five."
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Uchburchak tomonlari besh, besh va sakkiz birlik.",
          "Tomonlariga ko'ra turini tanlang."
        ],
        "ru": [
          "Стороны треугольника равны пяти, пяти и восьми единицам.",
          "Выберите вид по сторонам."
        ],
        "en": [
          "The triangle sides are five, five and eight units.",
          "Choose its type by sides."
        ]
      },
      "on_correct": {
        "uz": "To'g'ri. Besh teng besh ikki tomon teng.",
  ...
  "s10": {
    ...
    "closedSet": true,
    "proof": {
      "uz": "4, 5, 6 - barcha tomonlar turli",
      "ru": "4, 5, 6 - все стороны разные",
      "en": "4, 5, 6 - all sides are different"
    },
    "feedbackAudio": [
      {
        "uz": "Yana bir qarang: Teng tomonli uchburchakda uchala tomon teng bo'ladi. To'rt, besh va olti esa har xil.",
        "ru": "Посмотрите ещё раз: У равностороннего треугольника равны все три стороны. Длины четыре, пять и шесть различны.",
        "en": "Look again: An equilateral triangle has three equal sides. The lengths four, five and six are all different."
      },
      {
        "uz": "Yana bir qarang: Teng yonli uchburchakda kamida ikki tomon teng bo'ladi. To'rt, besh va olti orasida teng juft yo'q.",
        "ru": "Посмотрите ещё раз: У равнобедренного треугольника хотя бы две стороны равны. Среди четырёх, пяти и шести нет равной пары.",
        "en": "Look again: An isosceles triangle has at least two equal sides. There is no equal pair among four, five and six."
      },
      {
        "uz": "To'g'ri. To'rt besh va olti uzunliklari barcha tomonlar turli ekanini bildiradi.",
        "ru": "Верно. Длины четыре пять и шесть означают что все стороны разные.",
        "en": "Correct. The lengths four five and six show that all sides are different."
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Uchburchak tomonlari to'rt, besh va olti birlik.",
          "Tomonlariga ko'ra turini tanlang."
        ],
        "ru": [
          "Стороны треугольника равны четырём, пяти и шести единицам.",
          "Выберите вид по сторонам."
        ],
        "en": [
          "The triangle sides are four, five and six units.",
          "Choose its type by sides."
        ]
      },
      "on_correct": {
  ...
  "s11": {
    ...
    "scene": "triangle-right",
    "frames": [
      {
        "uz": "Burchaklar: 45°, 45°, 90°",
        "ru": "Углы: 45°, 45°, 90°",
        "en": "Angles: 45°, 45°, 90°"
      },
      {
        "uz": "Ikkala tasnifni tanlang",
        "ru": "Выберите обе классификации",
        "en": "Choose both classifications"
      }
    ],
    "question": {
      "uz": "Qaysi ikki nom mos?",
      "ru": "Какие два названия подходят?",
      "en": "Which two labels fit?"
    },
    "options": [
      {
        "uz": "Faqat teng yonli",
        "ru": "Только равнобедренный",
        "en": "Only isosceles"
      },
      {
        "uz": "Faqat to'g'ri burchakli",
        "ru": "Только прямоугольный",
        "en": "Only right-angled"
      },
      {
        "uz": "Teng yonli va to'g'ri burchakli",
        "ru": "Равнобедренный и прямоугольный",
        "en": "Isosceles and right-angled"
      }
    ],
    "correctIndex": 2,
    "closedSet": true,
    "proof": {
      "uz": "Ikki burchak teng va bitta burchak 90°",
      "ru": "Два угла равны, и один угол равен 90°",
      "en": "Two angles are equal and one angle is 90°"
    },
    "feedbackAudio": [
      {
        "uz": "Yana bir qarang: Faqat teng yonli deyish to'qson darajali burchakni unutadi. Tomonlariga ko'ra teng yonli, burchaklariga ko'ra to'g'ri burchakli.",
        "ru": "Посмотрите ещё раз: Если назвать его только равнобедренным, угол в девяносто градусов останется без внимания. По углам он прямоугольный.",
        "en": "Look again: Saying only isosceles ignores the ninety-degree angle. By sides it is isosceles, and by angles it is right-angled."
      },
      {
        "uz": "Yana bir qarang: Faqat to'g'ri burchakli deyish ikkita qirq besh darajali burchakni unutadi. Tomonlariga ko'ra u teng yonli.",
        "ru": "Посмотрите ещё раз: Если назвать его только прямоугольным, два угла по сорок пять градусов останутся без внимания. По сторонам он равнобедренный.",
        "en": "Look again: Saying only right-angled ignores the two forty-five-degree angles. By sides, it is also isosceles."
      },
      {
        "uz": "To'g'ri. Ikki burchak teng va bitta burchak to'qson daraja.",
        "ru": "Верно. Два угла равны, а один угол составляет девяносто градусов.",
        "en": "Correct. Two angles are equal and one angle is ninety degrees."
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Uchburchak burchaklari qirq besh, qirq besh va to'qson gradus.",
          "Mos ikkita tasnifni tanlang."
        ],
        "ru": [
          "Углы треугольника равны сорока пяти, сорока пяти и девяноста градусам.",
          "Выберите две подходящие классификации."
        ],
        "en": [
          "The triangle angles are forty five, forty five and ninety degrees.",
          "Choose the two matching classifications."
        ]
      },
      "on_correct": {
        "uz": "To'g'ri. Ikki burchak teng va bitta burchak to'qson daraja.",
  ...
  "s12": {
    ...
    "title": {
      "uz": "Bit rasmning burilishiga ishondi",
      "ru": "Бит поверил положению рисунка",
      "en": "Bit trusted the picture's orientation"
    },
    "scene": "triangle-rotate",
    "frames": [
      {
        "uz": "Bit rasmning turishiga qarab nom berdi",
        "ru": "Бит назвал фигуру по её положению",
        "en": "Bit labelled the shape by its orientation"
      },
      {
        "uz": "Burilgandan keyin xossalarni solishtiring",
        "ru": "Сравните свойства после поворота",
        "en": "Compare the properties after rotation"
      }
    ],
    "question": {
      "uz": "Burilganda nima o'zgardi?",
      "ru": "Что изменилось при повороте?",
      "en": "What changed after rotation?"
    },
    "options": [
      {
        "uz": "Xossalar o'zgardi",
        "ru": "Свойства изменились",
        "en": "The properties changed"
      },
      {
        "uz": "Xossalar o'zgarmadi",
        "ru": "Свойства не изменились",
        "en": "The properties did not change"
      },
      {
        "uz": "Tomonlar soni kamaydi",
        "ru": "Сторон стало меньше",
        "en": "There are fewer sides"
      }
    ],
    "correctIndex": 1,
    "closedSet": true,
    "proof": {
      "uz": "Burilish figuraning xossalarini o'zgartirmaydi",
      "ru": "Поворот не меняет свойства фигуры",
      "en": "Rotation does not change a shape's properties"
    },
    "feedbackAudio": [
      {
        "uz": "Yana bir qarang: Burilish faqat uchburchakning yo'nalishini o'zgartiradi. Uning tomon uzunliklari va burchaklari saqlanadi.",
        "ru": "Посмотрите ещё раз: Поворот меняет только положение треугольника. Длины его сторон и углы сохраняются.",
        "en": "Look again: Rotation changes only the triangle's orientation. Its side lengths and angles remain unchanged."
      },
      {
        "uz": "To'g'ri. Burilish figuraning xossalarini o'zgartirmaydi.",
        "ru": "Верно. Поворот не меняет свойства фигуры.",
        "en": "Correct. Rotation does not change a shape's properties."
      },
      {
        "uz": "Yana bir qarang: Burilish tomonlar sonini o'zgartira olmaydi. Uchburchakda burilishdan oldin ham, keyin ham uchta tomon bor.",
        "ru": "Посмотрите ещё раз: Поворот не может изменить число сторон. До и после поворота у треугольника остаются три стороны.",
        "en": "Look again: Rotation cannot change the number of sides. The triangle has three sides before and after the turn."
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Bit uchburchakka uning rasmdagi holatiga qarab nom berdi.",
          "To'qson gradus burilgandan keyingi xossalarni solishtiring."
        ],
        "ru": [
          "Бит назвал треугольник по его положению на рисунке.",
          "Сравните свойства после поворота на девяносто градусов."
        ],
        "en": [
          "Bit named the triangle from its position in the picture.",
          "Compare its properties after a ninety-degree rotation."
        ]
      },
      "on_correct": {
        "uz": "To'g'ri. Burilish figuraning xossalarini o'zgartirmaydi.",
  ...
  "s13": {
    ...
    "frames": [
      {
        "uz": "Ikki teng tomon belgisi",
        "ru": "Отметки двух равных сторон",
        "en": "Marks on two equal sides"
      },
      {
        "uz": "Bitta 90° burchak",
        "ru": "Один угол 90°",
      ...
      {
        "uz": "Tomon va burchak bo'yicha nomlang",
        "ru": "Назовите по сторонам и углам",
        "en": "Name it by sides and angles"
      }
    ],
    "question": {
      "uz": "Ikki tasnifni tanlang.",
      "ru": "Выберите две классификации.",
      "en": "Choose both classifications."
    },
    "options": [
      {
      ...
      {
        "uz": "Teng tomonli va o'tkir burchakli",
        "ru": "Равносторонний и остроугольный",
        "en": "Equilateral and acute-angled"
      },
      {
        "uz": "Turli tomonli va o'tmas burchakli",
        "ru": "Разносторонний и тупоугольный",
        "en": "Scalene and obtuse-angled"
      }
    ],
    "correctIndex": 0,
    "closedSet": true,
    "proof": {
      "uz": "Ikki tomon teng va bitta burchak 90°",
      "ru": "Две стороны равны, и один угол равен 90°",
      "en": "Two sides are equal and one angle is 90°"
    },
    "feedbackAudio": [
      {
        "uz": "To'g'ri. Ikki tomon teng va bitta burchak to'qson daraja.",
        "ru": "Верно. Две стороны равны, а один угол составляет девяносто градусов.",
        "en": "Correct. Two sides are equal and one angle is ninety degrees."
      },
      {
        "uz": "Yana bir qarang: To'qson darajali burchak sabab uchburchak o'tkir burchakli emas. Faqat ikki tomon teng, shuning uchun u teng tomonli ham emas.",
        "ru": "Посмотрите ещё раз: Из-за угла в девяносто градусов треугольник не остроугольный. Равны только две стороны, поэтому он не равносторонний.",
        "en": "Look again: The ninety-degree angle means the triangle is not acute-angled. Only two sides are equal, so it is not equilateral."
      },
      {
        "uz": "Yana bir qarang: Tenglik belgilari turli tomonli nomini rad etadi. To'qson darajali burchak esa o'tmas emas, to'g'ri burchak.",
        "ru": "Посмотрите ещё раз: Отметки равенства исключают разносторонний треугольник. Угол в девяносто градусов является прямым, а не тупым.",
        "en": "Look again: The equal-side marks rule out scalene. A ninety-degree angle is right, not obtuse."
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Uchburchakning ikkita teng tomoni belgilangan.",
          "Bitta burchak to'qson gradus.",
          "Uni tomonlari va burchaklariga ko'ra nomlang."
        ],
        "ru": [
          "У треугольника отмечены две равные стороны.",
          "Один угол равен девяноста градусам.",
          "Назовите его по сторонам и углам."
        ],
        "en": [
          "Two equal sides are marked on the triangle.",
          "One angle measures ninety degrees.",
          "Name it by its sides and angles."
        ]
      },
      "on_correct": {
        "uz": "To'g'ri. Ikki tomon teng va bitta burchak to'qson daraja.",
  ...
  "s14": {
    ...
    "title": {
      "uz": "Uchburchaklar katalogi",
      "ru": "Каталог треугольников",
      "en": "Triangle catalogue"
    },
    "scene": "triangle-final",
    "frames": [
      {
        "uz": "3 tomon, 3 uch, 3 burchak",
        "ru": "3 стороны, 3 вершины, 3 угла",
        "en": "3 sides, 3 vertices, 3 angles"
      },
      {
        "uz": "Tomonlariga ko'ra",
        "ru": "По сторонам",
        "en": "By sides"
      },
      {
      ...
      {
        "uz": "Bitta shaklga ikki nom",
        "ru": "Одна фигура имеет два названия",
        "en": "One shape has two labels"
      },
      {
        "uz": "Keyingi mavzu: to'rtburchaklar",
        "ru": "Следующая тема: четырёхугольники",
        "en": "Next topic: quadrilaterals"
      }
    ],
    "rewardTitle": {
      "uz": "Uchburchaklar katalogi ustasi",
      "ru": "Мастер каталога треугольников",
      "en": "Triangle catalogue expert"
    },
    "audio": {
      "intro": {
        "uz": [
          "Bir uchburchakning ikki nomi qarama qarshi emas chunki ular turli xossalarni tasvirlaydi. Uch tomon uch uch uch burchak.",
          "Tomonlariga ko'ra",
          "Burchaklariga ko'ra.",
          "Bitta shaklga ikki nom.",
          "Keyingi mavzu to'rtburchaklar."
        ],
        "ru": [
          "Два названия одного треугольника не противоречат друг другу потому что описывают разные свойства. Три стороны три вершины три угла.",
          "По сторонам",
          "По углам.",
          "Одна фигура имеет два названия.",
          "Следующая тема четырёхугольники."
        ],
        "en": [
          "Two labels for one triangle do not conflict because they describe different properties. Three sides three vertices three angles.",
          "By sides",
          "By angles.",
          "One shape has two labels.",
...
const RIGHT_ISOSCELES_VERTICES = [[95, 140], [95, 35], [200, 140]];
const RIGHT_ISOSCELES_SCENES = new Set(['triangle-hook', 'triangle-payoff', 'triangle-right', 'triangle-case']);
const trianglePointString = (vertices) => vertices.map(([x, y]) => `${x},${y}`).join(' ');
function TriangleScene({ scene, frame, p }) {
  const rightIsosceles = RIGHT_ISOSCELES_SCENES.has(scene);
  const variant = scene.includes('equal') ? 'equal' : scene.includes('iso') || scene.includes('hook') || scene.includes('case') || scene.includes('payoff') ? 'iso' : scene.includes('right') ? 'right' : scene.includes('angles') ? 'angles' : 'scalene';
  if (variant === 'angles') {
    return <svg viewBox="0 0 300 175"><polygon className="tv-shape" points="20,140 78,54 136,140" style={{opacity:frame>=0?1:.15}}/><polygon className="tv-shape" points="98,140 98,54 182,140" style={{opacity:frame>0?1:.15}}/><polygon className="tv-shape" points="164,140 211,82 282,140" style={{opacity:frame>1?1:.15}}/>{frame>2&&<circle className="tv-pulse" cx="150" cy="86" r="10"/>}</svg>;
  }
  const rotate = scene === 'triangle-rotate' ? 90 * p : 0;
  if (rightIsosceles) {
    const rightMarkerFrame = scene === 'triangle-payoff' ? 2 : scene === 'triangle-right' ? 0 : 1;
    return <svg viewBox="0 0 300 175"><g style={{transformOrigin:'150px 95px',transform:`rotate(${rotate}deg)`,transition:'transform .6s ease'}}><polygon className="tv-shape" points={trianglePointString(RIGHT_ISOSCELES_VERTICES)}/><path className="tv-path" d="M87 88h16"/><path className="tv-path" d="M148 132v16"/>{frame>=rightMarkerFrame&&<path className="tv-right" d="M95 120h20v20"/>}{frame>3&&<circle className="tv-pulse" cx="145" cy="88" r="10"/>}</g></svg>;
  }
  const points = variant === 'equal' ? '55,140 150,28 245,140' : variant === 'iso' ? '45,140 150,42 255,140' : '38,140 122,35 264,140';
  const early = scene === 'triangle-case' ? 0 : 1;
  return <svg viewBox="0 0 300 175"><g style={{transformOrigin:'150px 95px',transform:`rotate(${rotate}deg)`,transition:'transform .6s ease'}}><polygon className="tv-shape" points={points}/><path className="tv-path" d="M86 94l12 8" style={{opacity:frame>=early?1:.16}}/><path className="tv-path" d="M202 102l12-8" style={{opacity:frame>early?1:.16}}/>{variant==='equal'&&<path className="tv-path" d="M142 140v-14" style={{opacity:frame>early+1?1:.16}}/>}{frame>3&&<circle className="tv-pulse" cx="150" cy="78" r="10"/>}</g></svg>;
}
...
function HookScreen({ screen, storedAnswer, onAnswer, onPrev, onNext }) { const t = useT(); const c = CONTENT.s0; const audio = useNarration(c.audio, screen); const [picked, setPicked] = useState(storedAnswer?.studentAnswerIndex ?? null); const [attempts, setAttempts] = useState(storedAnswer?.attempts ?? 0); const [wrongChoices, setWrongChoices] = useState(storedAnswer?.wrongChoices ?? []); const answerReady = isAudioReady(audio); const optionOrder = buildOptionOrder(c.options.length, c.correctIndex, LESSON_META.lessonId, 0); const solved = picked === c.correctIndex; const choose = (index) => { if (!answerReady || solved || wrongChoices.includes(index)) return; const ok = index === c.correctIndex; const nextAttempts = attempts + 1; const nextWrongChoices = ok ? wrongChoices : [...wrongChoices, index]; setPicked(index); setAttempts(nextAttempts); setWrongChoices(nextWrongChoices); audio.pushOneOff(t(ok ? HOOK_FEEDBACK : HOOK_RETRY)); onAnswer({ stage: SCREEN_META[screen].scope, screenIdx: screen, question: t(c.question), options: c.options.map((option) => t(option)), correctIndex: c.correctIndex, correctAnswer: t(c.options[c.correctIndex]), studentAnswerIndex: index, studentAnswer: t(c.options[index]), correct: ok, firstTry: storedAnswer?.firstTry === false ? false : nextAttempts === 1 && ok, attempts: nextAttempts, wrongChoices: nextWrongChoices }); }; return <Stage screen={screen} audio={audio} onPrev={onPrev} onNext={onNext} canAdvance={solved}><div className="stack hook-stack" data-g4-screen="hook"><Heading c={c} state={solved ? 'nod' : picked !== null ? 'awkward' : 'think'} showBit hook/><h2 className="hook-question-prompt" data-g4-role="hook-question">{t(c.question)}</h2><section className="model-card hook-card" data-g4-role="hook-scene"><div className="hook-scene-visual" data-g4-role="visual-frame"><LessonVisual scene={c.scene} frame={audio.frame} screen={screen}/><div className="hook-frame-bit" data-g4-role="hook-bit"><BitSVG state="think"/></div></div></section><RevealFrames frames={c.frames} frame={audio.frame}/><section className="question hook-question" data-g4-role="answer-card" aria-live="polite"><h2>{t(c.question)}</h2><div className="options">{optionOrder.map((sourceIndex, displayIndex) => { const option = c.options[sourceIndex]; return <button type="button" data-g4-source-index={sourceIndex} data-g4-correct={sourceIndex === c.correctIndex ? 'true' : 'false'} data-g4-role="answer-card" className={'option ' + (solved && sourceIndex === c.correctIndex ? 'right' : wrongChoices.includes(sourceIndex) ? 'bad' : picked === sourceIndex ? 'picked' : '')} disabled={!answerReady || solved || wrongChoices.includes(sourceIndex)} onClick={() => choose(sourceIndex)} key={sourceIndex}><b>{String.fromCharCode(65 + displayIndex)}</b><span>{t(option)}</span></button>; })}</div><div className="feedback-slot hook-feedback-slot">{picked !== null && <div className={'feedback open ' + (solved ? 'correct' : 'wrong')} data-g4-role={solved ? 'feedback-frame bit-answer-comment' : 'feedback-frame'} data-g4-feedback={solved ? 'solution' : 'wrong'}><span className="feedback-bit" data-g4-role="feedback-bit"><BitSVG state={solved ? 'nod' : 'awkward'}/></span><p data-g4-role={solved ? 'bit-answer-comment' : undefined}>{t(solved ? HOOK_FEEDBACK : HOOK_RETRY)}{solved && <span><b className="proof-label">{t(SOLUTION_LABEL)}</b>{t(c.options[c.correctIndex])}</span>}</p></div>}</div></section></div></Stage>; }
...
.lesson-root .feedback[data-g4-role~="feedback-frame"]{width:100%!important;max-width:100%!important;min-width:0!important;height:auto!important;min-height:88px!important;padding:8px 15px 8px 9px!important;border-radius:18px!important;display:grid!important;grid-template-columns:62px minmax(0,1fr)!important;align-items:center!important;gap:12px!important;overflow:hidden}
...
.lesson-root .feedback[data-g4-role~="feedback-frame"] p{min-width:0;margin:0;font-family:'Manrope',system-ui,sans-serif!important;font-size:15px!important;line-height:1.42!important;text-align:left;overflow-wrap:anywhere}
...
.hook-stack>.question:has([data-g4-feedback="solution"]) .options{display:none!important}
.lesson-root .model-card,.lesson-root .question,.lesson-root .test-model{min-width:0}
.lesson-root .question{grid-template-columns:minmax(0,1fr)}
.lesson-root .stage-content,.lesson-root .stage-body,.lesson-root .stack,.lesson-root .test-layout{min-width:0;max-width:100%}
.lesson-root .feedback-slot,.lesson-root .feedback-stack{width:100%;max-width:100%;min-width:0}
@media(min-width:640px){.lesson-root .test-layout{width:100%;grid-template-columns:minmax(0,.86fr) minmax(0,1.14fr)}.lesson-root .options{grid-template-columns:repeat(3,minmax(0,1fr))}}
...
.stage-hook [data-g4-role="answer-card"]{font-size:14px}
