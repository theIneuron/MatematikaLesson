...
function ChoiceExercise({ screen, choiceOrdinal = ({ 8: 0, 10: 1, 12: 2 }[screen] ?? 0), shuffleOptions = true, storedAnswer, onAnswer, onNext, onPrev, visual = null }) {
  ...
  const optionOrder = shuffleOptions ? buildOptionOrder(c.options.length, c.correctIndex, LESSON_META.lessonId, choiceOrdinal) : null;
...
function Screen8(props) { return <ChoiceExercise {...props} shuffleOptions={false} visual={<div className="data-row"><span>12</span><span>17</span><span>18</span><span>20</span><span>28</span></div>}/>; }
