...
.hook-scene-visual{display:grid!important;grid-template-rows:auto minmax(0,1fr)!important;gap:4px!important}
.hook-scene-visual>.frame-notes{grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:4px!important}
.hook-scene-visual>.frame-notes .frame-note{min-height:40px!important;padding:3px!important;grid-template-columns:21px minmax(0,1fr)!important;gap:3px!important}
.hook-scene-visual>.frame-notes .frame-note>b{width:20px!important;height:20px!important}.hook-scene-visual>.frame-notes .frame-note span{font-size:8px!important;line-height:1.08!important}
.hook-scene-visual>.hook-model{height:100%!important;min-height:0!important;padding:3px!important;gap:2px!important}
.hook-scene-visual>.hook-model .decimal-strip{height:72px!important;min-height:72px!important}.hook-scene-visual>.hook-model .model-label{padding:1px 7px!important;font-size:10px!important;line-height:1!important}
@media(max-width:639.98px){.hook-scene-visual>.hook-model .decimal-strip{height:50px!important;min-height:50px!important}}
