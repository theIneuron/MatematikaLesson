...
const ANSWER_ORDINAL_BY_SCREEN = Object.freeze({ 8: 0, 9: 1, 10: 2, 12: 3, 13: 4 });
...
const LESSON_KIND = "volume";
const LESSON_META = { lessonId: "measure-4-32-v1", slug: "dars32-hajm-birliklari", lessonTitle: {"uz":"Hajm birliklari","ru":"Единицы объёма","en":"Units of volume"}, skillTags: ["unit-cube","cubic-units","volume-conversion","litre-link"] };
const CONTENT = {
  "s0": {
    "eyebrow": {
      "uz": "Muammo",
    ...
    "title": {
      "uz": "Faqat old qatlammi?",
      "ru": "Только передний слой?",
      "en": "Only the front layer?"
    },
    "scene": "volume-hook",
    "closedSet": true,
    "frames": [
      {
        "uz": "Old qatlamda 12 ta kub",
        "ru": "В переднем слое 12 кубиков",
        "en": "The front layer has 12 cubes"
      },
      {
        "uz": "Kuboid chuqurlikka davom etadi",
        "ru": "Кубоид продолжается в глубину",
        "en": "The cuboid continues backwards"
      },
      {
        "uz": "Orqadagi qatlamlar-chi?",
        "ru": "А что с задними слоями?",
        "en": "What about the layers behind?"
      }
    ],
    "question": {
      "uz": "Kuboid hajmini topishda nimani sanaymiz?",
      "ru": "Что считаем, чтобы найти объём кубоида?",
      "en": "What do we count to find the cuboid's volume?"
    },
    "options": [
      {
        "uz": "Faqat old qatlamdagi kublar",
        "ru": "Только кубики переднего слоя",
        "en": "Only the cubes in the front layer"
      },
      {
        "uz": "Barcha qatlamlardagi kublar",
        "ru": "Кубики во всех слоях",
        "en": "The cubes in every layer"
      },
      {
        "uz": "Faqat orqa qatlamdagi kublar",
        "ru": "Только кубики заднего слоя",
        "en": "Only the cubes in the back layer"
      }
    ],
    "neutral": {
      "uz": "Taxmin saqlandi. Qatlamlarni birlik kublar bilan sanaymiz.",
      "ru": "Гипотеза сохранена. Посчитаем слои единичными кубами.",
      "en": "Estimate saved. We will count the layers using unit cubes."
    },
    "audio": {
      "intro": {
        "uz": [
          "Old qatlamda o'n ikkita kub ko'rinadi.",
          "Kuboid chuqurlikka davom etadi.",
          "Orqadagi qatlamlarni ham sanash kerakmi."
        ],
        "ru": [
          "В переднем слое видно двенадцать кубиков.",
          "Кубоид продолжается в глубину.",
          "Нужно ли считать и задние слои?"
        ],
        "en": [
          "Twelve cubes are visible in the front layer.",
          "The cuboid continues backwards.",
          "Should we count the layers behind as well?"
        ]
      }
    }
  },
  "s1": {
    ...
    "title": {
      "uz": "Uzunlik, yuza, hajm",
      "ru": "Длина, площадь, объём",
      "en": "Length, area, volume"
    },
    "scene": "volume-dimensions",
    "frames": [
      {
        "uz": "Uzunlik - chiziq: cm",
        "ru": "Длина - линия: см",
        "en": "Length - line: cm"
      },
      {
        "uz": "Yuza - sirt: cm²",
        "ru": "Площадь - поверхность: см²",
        "en": "Area - surface: cm²"
      },
      {
        "uz": "Hajm - egallangan joy: cm³",
        "ru": "Объём - занятое пространство: см³",
        "en": "Volume - space occupied: cm³"
      },
      {
        "uz": "O'lchamga mos birlikni tanlang",
        "ru": "Выберите единицу по измерению",
        "en": "Choose the unit for the dimension"
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Chiziq uzunlikni birlik kvadrat yuzani birlik kub esa egallangan fazoni o'lchaydi. Uzunlik chiziq bilan ifodalanadi va santimetrda o'lchanadi.",
          "Yuza sirtni bildiradi va kvadrat santimetrda o'lchanadi",
          "Hajm egallangan joyni bildiradi va kub santimetrda o'lchanadi.",
          "O'lchamga mos birlikni tanlang."
        ],
        "ru": [
          "Линия измеряет длину единичный квадрат площадь а единичный куб занятое пространство. Длина изображается линией и измеряется в сантиметрах.",
          "Площадь описывает поверхность и измеряется в квадратных сантиметрах",
          "Объём описывает занятое пространство и измеряется в кубических сантиметрах.",
          "Выберите единицу по измерению."
        ],
        "en": [
          "Length is shown by a line and measured in centimetres. A unit square measures area, and a unit cube measures occupied space.",
          "Area describes a surface and is measured in square centimetres. A unit cube is needed for occupied space.",
          "Volume describes occupied space and is measured in cubic centimetres.",
          "Choose the unit for the dimension."
        ]
      }
    }
  },
  "s2": {
    ...
    "frames": [
      ...
      {
        "uz": "Bir uchda 1 cm li uchta qirra uchrashadi",
        "ru": "В одной вершине сходятся три ребра по 1 см",
        "en": "Three 1 cm edges meet at one vertex"
      },
      {
        "uz": "1 × 1 × 1",
        "ru": "1 × 1 × 1",
    ...
    "audio": {
      "intro": {
        "uz": [
          "Birlik kubning har bir qirrasi bir santimetr. Uning hajmi kub birlikda yoziladi.",
          "Bir uchda bir santimetrli uchta qirra uchrashadi.",
          "Bir ko'paytirilsin bir ko'paytirilsin bir.",
          "Bir kub santimetr."
        ],
        "ru": [
          "Каждое ребро единичного куба равно одному сантиметру. Его объём записывают кубической единицей.",
          "В одной вершине сходятся три ребра по одному сантиметру.",
          "Один умножить на один умножить на один.",
          "Один кубический сантиметр."
        ],
        "en": [
          "Every edge of a unit cube is one centimetre. Its volume is written in cubic units.",
          "Three one-centimetre edges meet at one vertex.",
          "One multiplied by one multiplied by one.",
  ...
  "s3": {
    ...
    "frames": [
      {
        "uz": "Bir qatlam: 4 × 3 = 12 kub",
        "ru": "Один слой: 4 × 3 = 12 кубиков",
        "en": "One layer: 4 × 3 = 12 cubes"
      },
      {
        "uz": "2 ta qatlam",
        "ru": "2 слоя",
    ...
    "audio": {
      "intro": {
        "uz": [
          "Avval bitta qatlamdagi kublar sanaladi so'ng qatlamlar soniga ko'paytiriladi. Bir qatlam to'rt ko'paytirilsin uch teng o'n ikki kub.",
          "Ikkita qatlam",
          "O'n ikki ko'paytirilsin ikki teng yigirma to'rt kub.",
          "Hajm yigirma to'rt kub santimetr."
        ],
        "ru": [
          "Сначала считают кубики в одном слое затем умножают на число слоёв. Один слой четыре умножить на три равно двенадцать кубиков.",
          "Два слоя",
          "Двенадцать умножить на два равно двадцать четыре кубика.",
          "Объём двадцать четыре кубических сантиметра."
        ],
        "en": [
          "First count the cubes in one layer then multiply by the number of layers. One layer four multiplied by three equals twelve cubes.",
          "Two layers",
          "Twelve multiplied by two equals twenty four cubes.",
          "Volume twenty four cubic centimetres."
        ]
      }
    }
  },
  "s4": {
    ...
    "title": {
      "uz": "Qaysi birlik qulay?",
      "ru": "Какая единица удобна?",
      "en": "Which unit is suitable?"
    },
    "scene": "volume-choice",
    "frames": [
      {
    ...
    "audio": {
      "intro": {
        "uz": [
          "Buyum kattalashgani sari qulay kub birlik ham kattalashadi birlik obyektga mos bo'lishi kerak. Tugma kub millimetr.",
          "Qalamdon kub santimetr",
          "Akvarium kub detsimetr.",
          "Xona kub metr."
        ],
        "ru": [
          "С ростом предмета удобная кубическая единица тоже увеличивается единица должна подходить объекту. Пуговица кубических миллиметров.",
          "Пенал кубических сантиметров",
          "Аквариум кубических дециметров.",
          "Комната кубических метров."
        ],
        "en": [
          "As an object grows the convenient cubic unit grows too the unit should suit the object. Button cubic millimetres.",
          "Pencil case cubic centimetres",
          "Aquarium cubic decimetres.",
          "Room cubic metres."
        ]
      }
    }
  ...
  "s5": {
    ...
    "title": {
      "uz": "Bir kub detsimetr",
      "ru": "Один кубический дециметр",
      "en": "One cubic decimetre"
    },
    "scene": "volume-dm",
    "frames": [
      {
    ...
    "audio": {
      "intro": {
        "uz": [
          "Detsimetrning har bir yo'nalishida o'nta santimetr bor shuning uchun uch o'lcham birgalikda hisoblanadi. Bir detsimetr teng o'n santimetr.",
          "O'n ko'paytirilsin o'n teng bir yuz kvadrat santimetr",
          "Bir yuz ko'paytirilsin o'n teng bir ming kub santimetr.",
          "Bir kub detsimetr teng bir ming kub santimetr."
        ],
        "ru": [
          "В каждом направлении дециметра по десять сантиметров поэтому учитываются сразу три измерения. Один дециметр равно десять сантиметров.",
          "Десять умножить на десять равно сто квадратных сантиметров",
          "Сто умножить на десять равно одна тысяча кубических сантиметров.",
          "Один кубический дециметр равно одна тысяча кубических сантиметров."
        ],
        "en": [
          "A decimetre has ten centimetres in each direction so all three dimensions must be counted. One decimetre equals ten centimetres.",
          "Ten multiplied by ten gives one hundred square centimetres. A third factor of ten counts the depth.",
          "One hundred multiplied by ten equals one thousand cubic centimetres.",
          "One cubic decimetre equals one thousand cubic centimetres."
        ]
      }
    }
  },
  "s6": {
    ...
    "title": {
      "uz": "Kub detsimetr va litr",
      "ru": "Кубический дециметр и литр",
      "en": "Cubic decimetre and litre"
    },
    "scene": "volume-litre",
    "frames": [
      {
        "uz": "1 dm³ idish",
        "ru": "Сосуд объёмом 1 дм³",
        "en": "A 1 dm³ container"
      },
      {
        "uz": "Suv idishni to'ldiradi",
        "ru": "Вода заполняет сосуд",
        "en": "Water fills the container"
      },
      {
        "uz": "Bu 1 litr",
        "ru": "Это 1 литр",
    ...
    "audio": {
      "intro": {
        "uz": [
          "Bir kub detsimetrli idishni to'ldirgan suv hajmi aynan bir litr bo'ladi. Bir kub detsimetr idish.",
          "Suv idishni to'ldiradi",
          "Bu bir litr.",
          "Bir kub detsimetr teng bir litr."
        ],
        "ru": [
          "Вода заполняющая сосуд объёмом один кубический дециметр имеет объём один литр. Сосуд объёмом один кубический дециметр.",
          "Вода заполняет сосуд",
          "Это один литр.",
          "Один кубический дециметр равно один литр."
        ],
        "en": [
          "Water filling one cubic decimetre has a volume of exactly one litre. A one cubic decimetre container.",
          "Water fills the container",
          "This is one litre.",
          "One cubic decimetre equals one litre."
        ]
      }
    }
  },
  "s7": {
    ...
    "frames": [
      ...
      {
        "uz": "Bir qatlam: 4 × 3 = 12; balandlik: 2 qatlam",
        "ru": "Один слой: 4 × 3 = 12; высота: 2 слоя",
        "en": "One layer: 4 × 3 = 12; height: 2 layers"
      },
      {
        "uz": "12 × 2 = 24",
        "ru": "12 × 2 = 24",
    ...
    "audio": {
      "intro": {
        "uz": [
          "To'g'ri burchakli qutida qatordagi kublar qatorlar va qatlamlar soni o'zaro ko'paytiriladi. Uzunlik to'rt santimetr.",
          "En uch santimetr",
          "Bir qatlamda to'rt karra uch, ya'ni o'n ikkita kub bor. Balandlik ikki qatlam.",
          "O'n ikki ko'paytirilsin ikki teng yigirma to'rt.",
          "Javob yigirma to'rt kub santimetr."
        ],
        "ru": [
          "В прямоугольной коробке перемножают число кубиков в ряду число рядов и число слоёв. Длина четыре сантиметра.",
          "Ширина три сантиметра",
          "В одном слое четыре умножить на три, то есть двенадцать кубиков. Высота равна двум слоям.",
          "Двенадцать умножить на два равно двадцать четыре.",
          "Ответ двадцать четыре кубических сантиметра."
        ],
        "en": [
          "For a cuboid multiply cubes per row rows per layer and the number of layers. Length four centimetres.",
          "Width three centimetres",
          "One layer has four times three, or twelve cubes. The height is two layers.",
          "Twelve multiplied by two equals twenty four.",
          "Answer twenty four cubic centimetres."
        ]
      }
    }
  },
  "s8": {
    ...
    "frames": [
      {
        "uz": "Qalamdon hajmi",
        "ru": "Объём пенала",
        "en": "Volume of a pencil case"
      },
      {
        "uz": "Mos birlikni tanlang",
        "ru": "Выберите подходящую единицу",
        "en": "Choose the suitable unit"
      }
    ],
    "question": {
      "uz": "Qaysi birlik mos?",
      "ru": "Какая единица подходит?",
      "en": "Which unit is suitable?"
    },
    "options": [
      {
    ...
    "closedSet": true,
    "proof": {
      "uz": "Hajm kub birlikda yoziladi: cm³",
      "ru": "Объём записывают в кубических единицах: см³",
      "en": "Volume uses cubic units: cm³"
    },
    "feedbackAudio": [
      {
        "uz": "Yana bir qarang: Santimetr faqat uzunlikni o'lchaydi. Qutining uch o'lchamli hajmi uchun kub santimetr kerak.",
        "ru": "Посмотрите ещё раз: Сантиметр измеряет только длину. Для трёхмерного объёма коробки нужен кубический сантиметр.",
        "en": "Look again: Centimetres measure length only. The three-dimensional volume of the box needs cubic centimetres."
      },
      {
        "uz": "Yana bir qarang: Kvadrat santimetr yuzani, ya'ni ikki o'lchamni bildiradi. Hajm uchun uchinchi o'lcham va kub santimetr kerak.",
        "ru": "Посмотрите ещё раз: Квадратный сантиметр обозначает площадь в двух измерениях. Для объёма нужен кубический сантиметр.",
        "en": "Look again: Square centimetres measure area in two dimensions. Volume needs a third dimension and cubic centimetres."
      },
      {
        "uz": "To'g'ri. Hajm kub birlikda, ya'ni kub santimetrda yoziladi.",
        "ru": "Верно. Объём записывают в кубических единицах, например в кубических сантиметрах.",
        "en": "Correct. Volume is written in cubic units, such as cubic centimetres."
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Qalam qutisining hajmi uchun mos birlik kerak.",
          "Mos birlikni tanlang."
        ],
        "ru": [
          "Для объёма пенала нужна подходящая единица.",
          "Выберите подходящую единицу."
        ],
        "en": [
          "The volume of a pencil case needs a suitable unit.",
  ...
  "s9": {
    ...
    "title": {
      "uz": "Kubchalarni sanang",
      "ru": "Посчитайте кубики",
      "en": "Count the cubes"
    },
    "scene": "volume-layers-30",
    "frames": [
      {
        "uz": "5 × 2 × 3 kub",
        "ru": "5 × 2 × 3 кубика",
      ...
      {
        "uz": "Kubchalar sonini toping",
        "ru": "Найдите число кубиков",
        "en": "Find the number of cubes"
      }
    ],
    "question": {
      "uz": "Hajm qancha?",
      "ru": "Чему равен объём?",
      "en": "What is the volume?"
    },
    "options": [
      {
        "uz": "10 cm³",
    ...
    "feedbackAudio": [
      {
        "uz": "Yana bir qarang: Beshni ikkiga ko'paytirish faqat bitta qatlamni sanaydi. Uchta qatlamda jami o'ttiz kub bor.",
        "ru": "Посмотрите ещё раз: Умножение пяти на два считает только один слой. В трёх слоях всего тридцать кубиков.",
        "en": "Look again: Five times two counts only one layer. Three layers contain thirty cubes altogether."
      },
      {
        "uz": "To'g'ri. Besh ko'paytirilsin ikki ko'paytirilsin uch teng o'ttiz kub santimetr.",
        "ru": "Верно. Пять умножить на два умножить на три равно тридцать кубических сантиметров.",
        "en": "Correct. Five multiplied by two multiplied by three equals thirty cubic centimetres."
      },
      {
        "uz": "Yana bir qarang: Oltmish natijada bir o'lcham ikki marta sanalgan. Har kubni bir marta sanasak, jami o'ttiz kub chiqadi.",
        "ru": "Посмотрите ещё раз: В результате шестьдесят одно измерение посчитано дважды. При однократном подсчёте каждого кубика получаем тридцать.",
        "en": "Look again: A dimension was counted twice to get sixty. Counting each cube once gives thirty."
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Kuboidning uzunligi beshta, kengligi ikkita, balandligi uchta birlik kub.",
          "Kubchalar sonini toping."
        ],
        "ru": [
          "Длина кубоида пять, ширина два, высота три единичных кубика.",
          "Найдите число кубиков."
        ],
        "en": [
          "A cuboid is five unit cubes long, two wide and three high.",
  ...
  "s10": {
    ...
    "frames": [
      ...
      {
        "uz": "Kub santimetrga aylantiring",
        "ru": "Преобразуйте в кубические сантиметры",
        "en": "Convert to cubic centimetres"
      }
    ],
    "question": {
      "uz": "Necha kub santimetr?",
      "ru": "Сколько кубических сантиметров?",
      "en": "How many cubic centimetres?"
    },
    "options": [
      {
        "uz": "200 cm³",
    ...
    "feedbackAudio": [
      {
        "uz": "Yana bir qarang: Ikki yuz natijada faqat ikkita o'n ko'paytuvchi ishlatilgan. Kub birlikning uch o'lchami ikki mingni beradi.",
        "ru": "Посмотрите ещё раз: В числе двести использованы только два множителя десять. Три измерения кубической единицы дают две тысячи.",
        "en": "Look again: Two hundred uses only two factors of ten. The three dimensions of a cubic unit give two thousand."
      },
      {
        "uz": "To'g'ri. Ikki kub detsimetr ikki ming kub santimetrga teng.",
        "ru": "Верно. Два кубических дециметра равны двум тысячам кубических сантиметров.",
        "en": "Correct. Two cubic decimetres equal two thousand cubic centimetres."
      },
      {
        "uz": "Yana bir qarang: Yigirma ming natijada to'rtta o'n ko'paytuvchi ishlatilgan. Hajmning uch o'lchami ikki mingni beradi.",
        "ru": "Посмотрите ещё раз: В числе двадцать тысяч использованы четыре множителя десять. Три измерения объёма дают две тысячи.",
        "en": "Look again: Twenty thousand uses four factors of ten. The three dimensions of volume give two thousand."
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Ikki kub detsimetr necha kub santimetrga teng?",
          "Kub santimetrlardagi qiymatni tanlang."
        ],
        "ru": [
          "Скольким кубическим сантиметрам равны два кубических дециметра?",
          "Выберите значение в кубических сантиметрах."
        ],
        "en": [
          "How many cubic centimetres equal two cubic decimetres?",
          "Choose the value in cubic centimetres."
        ]
      },
      "on_correct": {
        "uz": "To'g'ri. Ikki kub detsimetr ikki ming kub santimetrga teng.",
  ...
  "s11": {
    ...
    "title": {
      "uz": "Litr bilan teng hajm",
      "ru": "Равный объём в литрах",
      "en": "Equal volume in litres"
    },
    "scene": "volume-litre",
    "frames": [
      {
      ...
      {
        "uz": "Litr bilan teng hajmni toping",
        "ru": "Найдите равный объём в литрах",
        "en": "Find the equal volume in litres"
      }
    ],
    "question": {
      "uz": "Necha litr?",
    ...
    "feedbackAudio": [
      {
        "uz": "To'g'ri. Uch kub detsimetr uch litrga teng.",
        "ru": "Верно. Три кубических дециметра равны трём литрам.",
        "en": "Correct. Three cubic decimetres equal three litres."
      },
      {
        "uz": "Yana bir qarang: O'ttiz litr natijada ortiqcha o'nga ko'paytirilgan. Bir kub detsimetr bir litr, demak uch kub detsimetr uch litr.",
        "ru": "Посмотрите ещё раз: Для получения тридцати литров лишний раз умножили на десять. Один кубический дециметр равен одному литру.",
        "en": "Look again: Thirty litres includes an unnecessary multiplication by ten. One cubic decimetre equals one litre, so three cubic decimetres equals three litres."
      },
      {
        "uz": "Yana bir qarang: Uch yuz litr natijada ortiqcha yuzga ko'paytirilgan. Bir kub detsimetr bir litr, demak uch kub detsimetr uch litr.",
        "ru": "Посмотрите ещё раз: Для получения трёхсот литров лишний раз умножили на сто. Один кубический дециметр равен одному литру.",
        "en": "Look again: Three hundred litres includes an unnecessary multiplication by one hundred. One cubic decimetre equals one litre, so three cubic decimetres equals three litres."
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Uch kub detsimetr necha litrga teng?",
          "Litrlardagi qiymatni tanlang."
        ],
        "ru": [
          "Скольким литрам равны три кубических дециметра?",
          "Выберите значение в литрах."
        ],
        "en": [
          "How many litres equal three cubic decimetres?",
          "Choose the value in litres."
        ]
      },
      "on_correct": {
        "uz": "To'g'ri. Uch kub detsimetr uch litrga teng.",
  ...
  "s12": {
    ...
    "title": {
      "uz": "Bit uchinchi o'lchamni unutdi",
      "ru": "Бит забыл третье измерение",
      "en": "Bit forgot the third dimension"
    },
    "scene": "volume-bit",
    "frames": [
      {
    ...
    "question": {
      "uz": "Bitning javobini to'g'rilang.",
      "ru": "Исправьте ответ Бита.",
      "en": "Correct Bit's answer."
    },
    "options": [
      {
        "uz": "20 cm³",
    ...
    "feedbackAudio": [
      {
        "uz": "Yana bir qarang: Yigirma natijada faqat bitta o'n ko'paytuvchi olingan. Uch o'lcham uchun uchta o'n ko'paytuvchi kerak.",
        "ru": "Посмотрите ещё раз: В числе двадцать использован только один множитель десять. Для трёх измерений нужны три таких множителя.",
        "en": "Look again: Twenty uses only one factor of ten. Three dimensions need three factors of ten."
      },
      {
        "uz": "Yana bir qarang: Ikki yuz natijada ikkita o'n ko'paytuvchi olingan. Uchinchi o'lcham ham kerak, shunda ikki ming chiqadi.",
        "ru": "Посмотрите ещё раз: В числе двести использованы два множителя десять. Нужно учесть третье измерение, тогда получится две тысячи.",
        "en": "Look again: Two hundred uses two factors of ten. The third dimension is also needed, giving two thousand."
      },
      {
        "uz": "To'g'ri. Ikki kub detsimetr ikki ming kub santimetrga teng.",
        "ru": "Верно. Два кубических дециметра равны двум тысячам кубических сантиметров.",
    ...
    "audio": {
      "intro": {
        "uz": [
          "Bit ikki kub detsimetr ikki yuz kub santimetrga teng deb yozdi.",
          "Bitning xatosini toping."
        ],
        "ru": [
          "Бит записал, что два кубических дециметра равны двумстам кубическим сантиметрам.",
          "Найдите ошибку Бита."
        ],
        "en": [
          "Bit wrote that two cubic decimetres equal two hundred cubic centimetres.",
          "Find Bit's mistake."
        ]
      },
      "on_correct": {
  ...
  "s13": {
    ...
    "frames": [
      {
        "uz": "Bak: 4 dm × 3 dm × 2 dm",
        "ru": "Бак: 4 дм × 3 дм × 2 дм",
        "en": "Tank: 4 dm × 3 dm × 2 dm"
      },
      {
        "uz": "4 × 3 × 2 = ? dm³",
        "ru": "4 × 3 × 2 = ? дм³",
      ...
      {
        "uz": "Necha litr suv sig'adi?",
        "ru": "Сколько литров воды поместится?",
        "en": "How many litres of water will it hold?"
      }
    ],
    "question": {
      "uz": "Bakka necha litr suv sig'adi?",
      "ru": "Сколько литров воды вмещает бак?",
      "en": "How many litres of water does the tank hold?"
    },
    "options": [
      {
        "uz": "9 l",
    ...
    "feedbackAudio": [
      {
        "uz": "Yana bir qarang: To'qqiz soni to'rt, uch va ikkini qo'shishdan chiqqan. Hajmda o'lchamlar qo'shilmaydi, ko'paytiriladi va yigirma to'rt chiqadi.",
        "ru": "Посмотрите ещё раз: Девять получено сложением четырёх, трёх и двух. Для объёма измерения умножают и получают двадцать четыре.",
        "en": "Look again: Nine comes from adding four, three and two. For volume, multiply the dimensions to get twenty four."
      },
      {
        "uz": "To'g'ri. To'rtni uchga va ikkiga ko'paytirsak, yigirma to'rt kub detsimetr, ya'ni yigirma to'rt litr hosil bo'ladi.",
        "ru": "Верно. Четыре умножаем на три и на два. Получаем двадцать четыре кубических дециметра, то есть двадцать четыре литра.",
        "en": "Correct. Four multiplied by three and by two gives twenty four cubic decimetres, which equals twenty four litres."
      },
      {
        "uz": "Yana bir qarang: Yigirma to'rt kub detsimetr allaqachon yigirma to'rt litrga teng. Ikki yuz qirq litrda ortiqcha o'nga ko'paytirilgan.",
        "ru": "Посмотрите ещё раз: Двадцать четыре кубических дециметра уже равны двадцати четырём литрам. В результате двести сорок выполнено лишнее умножение на десять.",
        "en": "Look again: Twenty four cubic decimetres already equals twenty four litres. The result two hundred and forty includes an unnecessary multiplication by ten."
      }
    ],
    "audio": {
      "intro": {
        "uz": [
          "Bakning o'lchamlari to'rt detsimetr, uch detsimetr va ikki detsimetr.",
          "To'rt karra uch karra ikki kub detsimetr nechaga teng?",
          "Bak necha litr suv sig'diradi?"
        ],
        "ru": [
          "Размеры бака четыре дециметра, три дециметра и два дециметра.",
          "Чему равно четыре умножить на три и умножить на два кубических дециметра?",
          "Сколько литров воды вмещает бак?"
        ],
        "en": [
          "The tank measures four decimetres by three decimetres by two decimetres.",
          "What is four times three times two cubic decimetres?",
          "How many litres of water does the tank hold?"
        ]
      },
      "on_correct": {
        "uz": "To'g'ri. To'rtni uchga va ikkiga ko'paytirsak, yigirma to'rt kub detsimetr, ya'ni yigirma to'rt litr hosil bo'ladi.",
  ...
  "s14": {
    ...
    "frames": [
      ...
      {
        "uz": "Keyingi mavzu: burchaklar",
        "ru": "Следующая тема: углы",
        "en": "Next topic: angles"
      }
    ],
    "rewardTitle": {
      "uz": "Hajm birliklari me'mori",
      "ru": "Архитектор единиц объёма",
      "en": "Volume unit architect"
    },
    "audio": {
      "intro": {
        "uz": [
          "Hajm birlik kublar sonini bildiradi va birlik belgisi uch o'lcham hisoblanganini ko'rsatadi. Birlik kub.",
          "Qatlamlar",
          "Kub santimetr kub detsimetr kub metr.",
          "Bir kub detsimetr teng bir ming kub santimetr teng bir litr.",
          "Keyingi mavzu burchaklar."
        ],
        "ru": [
          "Объём показывает число единичных кубов а кубический знак напоминает о трёх измерениях. Единичный куб.",
          "Слои",
          "Кубических сантиметров кубических дециметров кубических метров.",
          "Один кубический дециметр равно одна тысяча кубических сантиметров равно один литр.",
          "Следующая тема углы."
        ],
        "en": [
          "Volume counts unit cubes and the cubic symbol records that three dimensions were used. Unit cube.",
          "Layers",
          "Cubic centimetres cubic decimetres cubic metres.",
          "One cubic decimetre equals one thousand cubic centimetres equals one litre.",
          "Next topic angles."
        ]
      }
    }
...
function VolumeDmScene({ frame, screen }) {
  const t = useT();
  const blocks = screen === 10 ? 2 : 1;
  const unitCubeCount = 10 * 10 * 10;
  const totalCubeCount = blocks * unitCubeCount;
  const size = blocks === 2 ? 76 : 96;
  const gap = 22;
  const startX = (300 - blocks * size - (blocks - 1) * gap) / 2;
  const startY = blocks === 2 ? 29 : 20;
  const cell = size / 10;
  const revealedCells = screen === 10 || frame > 0 ? 100 : 10;
  const layersVisible = screen === 10 ? frame > 0 : frame > 1;
  const layerLabel = t(bi('Har blok: 10 qatlam (sxema)', 'Каждый блок: 10 слоёв (схема)', 'Each block: 10 layers (schematic)'));
  return <svg viewBox="0 0 300 175" data-unit-cubes={unitCubeCount} data-total-cubes={totalCubeCount}>
    {screen===10&&<text x="150" y="17" textAnchor="middle">2 dm³</text>}
    {Array.from({length:blocks},(_,block)=>{
      const x=startX+block*(size+gap);
      return <g key={block}>
        {layersVisible&&[4,3,2,1].map((offset)=><rect key={offset} className="tv-cube-wire" x={x+offset*3} y={startY-offset*3} width={size} height={size}/>)}
        <rect className="tv-outline" x={x} y={startY} width={size} height={size}/>
        {Array.from({length:100},(_,index)=>{
          const col=index%10;
          const row=Math.floor(index/10);
          return <rect key={index} className="tv-cell" x={x+col*cell} y={startY+row*cell} width={cell} height={cell} style={{opacity:index<revealedCells?.82:.08}}/>;
        })}
        <text x={x+size/2} y={startY+size+16} textAnchor="middle">10 × 10</text>
      </g>;
    })}
    {layersVisible&&<text x="150" y="153" textAnchor="middle">{layerLabel}</text>}
    {screen===5&&frame>1&&<text x="150" y="171" textAnchor="middle">10 × 10 × 10 = 1000</text>}
  </svg>;
}
function VolumeLayers30Scene({ frame }) {
  const columns = 5;
  const rows = 2;
  const layers = 3;
  const cubesPerLayer = columns * rows;
  const totalCubes = cubesPerLayer * layers;
  const activeLayers = frame === 0 ? 1 : layers;
  return <svg viewBox="0 0 300 175" data-cubes-per-layer={cubesPerLayer} data-total-cubes={totalCubes}>
    {Array.from({length:layers},(_,layer)=><g key={layer} style={{opacity:layer<activeLayers?1:.2,transition:'opacity .45s'}}>
      {Array.from({length:cubesPerLayer},(_,index)=>{
        const col=index%columns;
        const row=Math.floor(index/columns);
        return <rect key={index} className="tv-cell" x={50+col*30+layer*8} y={13+row*22+layer*52} width="28" height="20"/>;
      })}
      <text x="245" y={33+layer*52}>{layer+1}</text>
    </g>)}
  </svg>;
}
function VolumeScene({ scene, frame, p, screen }) {
  if (scene === 'volume-dm') return <VolumeDmScene frame={frame} screen={screen}/>;
  if (scene === 'volume-layers-30') return <VolumeLayers30Scene frame={frame}/>;
  ...
  const total = 24;
  const active = scene === 'volume-hook' ? (frame < 2 ? 12 : 24) : Math.max(1,Math.ceil(total*p));
  return <div className="tv-layer-wrap">{Array.from({length:total},(_,i)=><i key={i} className={i<active?'active':''} style={{transform:`translateY(${-Math.floor(i/12)*4}px)`}}/> )}</div>;
}
...
function LessonVisual({ scene, frame, screen }) { const t=useT(); const c=CONTENT[`s${screen}`]; const safeFrame=Math.min(frame,c.frames.length-1); const label=t(c.frames[safeFrame]); const p=(safeFrame+1)/FRAME_COUNTS[screen]; let visual; if(LESSON_KIND==='measure') visual=<MeasureScene scene={scene} frame={safeFrame} p={p}/>; else if(LESSON_KIND==='volume') visual=<VolumeScene scene={scene} frame={safeFrame} p={p} screen={screen}/>; else if(LESSON_KIND==='angle') visual=<AngleScene scene={scene} frame={safeFrame} p={p}/>; else if(LESSON_KIND==='protractor') visual=<ProtractorScene scene={scene} frame={safeFrame} p={p}/>; else if(LESSON_KIND==='triangle') visual=<TriangleScene scene={scene} frame={safeFrame} p={p}/>; else if(LESSON_KIND==='quadrilateral') visual=<QuadScene scene={scene} frame={safeFrame} p={p}/>; else visual=<PerimeterScene scene={scene} frame={safeFrame} p={p} screen={screen}/>; return <div className={`conversion-visual topic-visual ${LESSON_KIND}-visual scene-${scene}`} data-g4-role="visual-frame" aria-label={label}>{visual}<strong>{label}</strong></div>; }
...
.lesson-root .volume-visual{font-family:'JetBrains Mono',monospace!important}
