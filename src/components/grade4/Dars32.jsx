...
const CONTENT = {
  ...
  s15: {
    ...
    question: { uz: "Jismning hajmi nima bilan o'lchanadi?", ru: "Чем измеряется объём тела?", en: "What is the volume of a body measured by?" },
    stem: { uz: "Hajmni topish uchun men...", ru: "Чтобы найти объём, я...", en: "To find the volume, I..." },
    correctIndex: 0,
    options: [
      { uz: "unga sig'adigan birlik kublar sonini topaman", ru: "нахожу число единичных кубов, которые в него помещаются", en: "find the number of unit cubes that fit inside it" },
      { uz: "uning eng uzun tomonini o'lchayman", ru: "измеряю его самую длинную сторону", en: "measure its longest side" },
      { uz: "uning og'irligini tarozida topaman", ru: "нахожу его вес на весах", en: "find its weight on the scales" },
    ],
    feedback: [
      { uz: "To'g'ri. Hajm sig'adigan birlik kublar soni bilan o'lchanadi.", ru: "Верно. Объём измеряется числом помещающихся единичных кубов.", en: "Right. Volume is measured by the number of unit cubes that fit." },
      { uz: "Bitta tomon uzunlikni beradi. Hajm esa uchala o'lchovga bog'liq.", ru: "Одна сторона даёт длину. А объём зависит от всех трёх измерений.", en: "One side gives a length. Volume depends on all three measurements." },
      { uz: "Og'irlik boshqa kattalik. Hajm jism egallagan joyni ko'rsatadi.", ru: "Вес это другая величина. Объём показывает занятое телом место.", en: "Weight is a different quantity. Volume shows the space the body takes up." },
    ],
    feedbackAudio: [
      { uz: "To'g'ri. Hajm birlik kublar soni bilan o'lchanadi.", ru: "Верно. Объём измеряется числом единичных кубов.", en: "Right. Volume is measured by the number of unit cubes." },
      { uz: "Bitta tomon faqat uzunlikni beradi. Hajm uchala o'lchovga bog'liq.", ru: "Одна сторона даёт только длину. Объём зависит от всех трёх измерений.", en: "One side gives only a length. Volume depends on all three measurements." },
      { uz: "Og'irlik boshqa kattalik. Hajm jism egallagan joyni ko'rsatadi.", ru: "Вес это другая величина. Объём показывает занятое телом место.", en: "Weight is a different quantity. Volume shows the space the body takes up." },
    ],
    proof: { uz: "2 000 cm³ = 2 dm³ = 2 l", ru: "2 000 см³ = 2 дм³ = 2 л", en: "2 000 cm³ = 2 dm³ = 2 l" },
    resolution: { uz: "Bir qatlamdagi kublarni qatlamlar soniga ko'paytiramiz, zinapoyada esa har qadam ming barobar.", ru: "Кубы в одном слое умножаем на число слоёв, а на лестнице каждый шаг в тысячу раз.", en: "We multiply the cubes in one layer by the number of layers, and each step on the ladder is a thousand times." },
    lead: { uz: "Usulni tanlang va hajm nima ekanini tushunganingizni ko'rsating.", ru: "Выбери способ и покажи, что понимаешь, что такое объём.", en: "Choose the method and show that you understand what volume is." },
    frames: [
