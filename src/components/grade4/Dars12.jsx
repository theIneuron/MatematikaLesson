...
const SCREEN_META = D12_FLOW.map((sourceIndex, screenIndex) => ({
...
function FinaleReward({ answers = [], complete, audio }) {
...
const Grade4Dars12 = createDivisionLesson({ meta: LESSON_META, content: D12_CONTENT, frameVector: D12_FRAME_VECTOR });
