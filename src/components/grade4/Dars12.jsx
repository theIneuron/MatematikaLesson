...
const ANSWER_ORDINAL_BY_SCREEN = Object.freeze({ 0: 0, 2: 1, 10: 2, 12: 3 });
...
@media(min-width:641px) and (min-height:701px) and (max-height:800px){.lesson-root .stage:is([data-screen="0"],[data-screen="2"],[data-screen="10"],[data-screen="12"]) .stack{gap:7px}.lesson-root .stage:is([data-screen="0"],[data-screen="2"],[data-screen="10"],[data-screen="12"]) .heading{min-height:72px}.lesson-root .stage:is([data-screen="2"],[data-screen="10"],[data-screen="12"]) .heading .bit{width:64px;height:80px}.lesson-root .stage:is([data-screen="2"],[data-screen="10"],[data-screen="12"]) .concept-visual{min-height:170px;padding:12px;gap:8px}.lesson-root .stage:is([data-screen="0"],[data-screen="2"],[data-screen="10"],[data-screen="12"]) .question{padding:12px 16px}.lesson-root .stage:is([data-screen="0"],[data-screen="2"],[data-screen="10"],[data-screen="12"]) .options{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:8px}}
`;
