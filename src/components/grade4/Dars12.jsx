...
function G4TitleReveal({ active, title, onComplete }) {
  ...
  return <div className="g4-title-reveal-overlay" role="status" aria-live="assertive"><div className="g4-title-reveal-card"><div className="g4-title-reveal-medal">★</div><h2 className="g4-title-reveal-title">{title}</h2>{reduced && <span className="sr-only">{title}</span>}</div></div>;
}
