// Dars11 · Amaliyot 06 — Sonni kasr shaklida · 🟡 · Nilufar · tag: natural_as_fraction
// jsx-question kontrakti: onReady/registerCheck/onSubmit. O'z tugmasi yo'q. Faqat react importi.
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'natural_as_fraction', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Kasr', title: 'Kasr shaklida',
    setup: "Natural sonni istalgan maxrajli kasr shaklida yozish mumkin: surat = son × maxraj.",
    ask: "4 sonini maxraji 6 bo'lgan kasr ko'rinishida qanday yoziladi?",
    opts: ["24/6", "4/6", "6/4", "10/6"],
    correct: "To'g'ri. Surat = 4 × 6 = 24, demak 4 = 24/6.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Дробь', title: 'В виде дроби',
    setup: 'Натуральное число можно записать дробью с любым знаменателем: числитель = число × знаменатель.',
    ask: 'Как записать число 4 дробью со знаменателем 6?',
    opts: ['24/6', '4/6', '6/4', '10/6'],
    correct: 'Верно. Числитель = 4 × 6 = 24, значит 4 = 24/6.',
