// Dars11 · Amaliyot 05 — Kasrni hisoblash · 🟡 · Madina · tag: div_compute
// jsx-question kontrakti: onReady/registerCheck/onSubmit. O'z tugmasi yo'q. Faqat react importi.
import React, { useState, useEffect, useRef, useCallback } from 'react';

const TARGET = 3; // 12/4 = 12 : 4 = 3
const DATA = { tag: 'div_compute', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Kasr', title: 'Qiymati',
    setup: "Kasrni bo'linma sifatida hisoblang:",
    words: "12 / 4",
    label: 'Javobni yozing:',
    live: 'Sizning javobingiz:',
    correct: "To'g'ri. 12/4 = 12 : 4 = 3 — bu butun son.",
    wrong: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Дробь', title: 'Значение',
    setup: 'Вычислите дробь как частное:',
    words: '12 / 4',
    label: 'Запишите ответ:',
    live: 'Ваш ответ:',
    correct: 'Верно. 12/4 = 12 : 4 = 3 — это целое число.',
