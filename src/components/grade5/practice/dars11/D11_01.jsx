// Dars11 · Amaliyot 01 — Bo'linma → kasr · 🟢 · Bekzod · tag: div_as_fraction
// jsx-question kontrakti: onReady/registerCheck/onSubmit. O'z tugmasi yo'q. Faqat react importi.
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'div_as_fraction', level: '🟢' };
const T = {
  uz: {
    eyebrow: 'Kasr', title: "Bo'linma",
    setup: "Bo'lish natijasini kasr bilan yozish mumkin: a : b = a/b.",
    ask: "4 : 5 bo'linmasi qaysi kasrga teng?",
    opts: ["4/5", "5/4", "4/9", "1/5"],
    correct: "To'g'ri. a : b = a/b, demak 4 : 5 = 4/5.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Дробь', title: 'Частное',
    setup: 'Результат деления можно записать дробью: a : b = a/b.',
    ask: 'Чему равно частное 4 : 5?',
    opts: ['4/5', '5/4', '4/9', '1/5'],
