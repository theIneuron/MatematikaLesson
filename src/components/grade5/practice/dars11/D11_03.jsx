// Dars11 · Amaliyot 03 — Teng taqsimlash · 🟡 · Sardor · tag: sharing
// jsx-question kontrakti: onReady/registerCheck/onSubmit. O'z tugmasi yo'q. Faqat react importi.
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'sharing', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Hayotda', title: 'Nechadan',
    setup: "5 ta bola 4 ta olmani teng taqsimlab olishdi.",
    ask: "Har bir bolaga olmaning qancha qismi tegdi?",
    opts: ["4/5", "5/4", "4/9", "1/4"],
    correct: "To'g'ri. 4 olmani 5 bolaga bo'lamiz: 4 : 5 = 4/5. Har biriga 4/5 olma.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'В жизни', title: 'По сколько',
    setup: '5 детей поровну разделили 4 яблока.',
    ask: 'Какая часть яблока досталась каждому?',
    opts: ['4/5', '5/4', '4/9', '1/4'],
  ...
  return (
    <div className="pq pq03">
      <style>{`
        ...
        .pq03 .pq-setup { font-size:16px; line-height:1.5; margin:6px 0 12px; color:#374151; }
        .pq03 .pq-ask { font-size:17px; font-weight:700; margin:0 0 12px; }
        .pq03 .pq-fb { display:flex; align-items:flex-start; gap:10px; margin-top:14px; padding:13px 15px; border-radius:14px; font-size:15px; line-height:1.45; font-weight:600; animation:pqIn .22s ease both; }
