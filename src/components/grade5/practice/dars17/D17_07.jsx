...
const D07_SEG = [{ n: 1, c: '#ffb488' }, { n: 3, c: '#86efac' }, { n: 2, c: '#c4b5fd' }]; // 1+3+2 = 6
  ...
  return (
    <div style={S.wrap}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, margin: '10px 0 6px', flexWrap: 'wrap' }}>
        <Frac num="1" den="9" size={22} color="#fe5b1a" /><span style={{ ...S.mono, fontSize: 18, fontWeight: 800, color: '#94a3b8' }}>+</span>
