// Dars06 · Amaliyot 02 — Manfiy son · 🟢 · Madina · tag: pick_negative
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'pick_negative', level: '🟢' };
const T = {
  uz: {
    eyebrow: 'Butun sonlar', title: 'Manfiy son',
    setup: "Oldida '-' ishorasi turgan sonlar manfiy sonlar deyiladi.",
    ask: 'Qaysi son manfiy?',
    opts: ['-7', '3', '0', '12'],
    correct: "To'g'ri. -7 — manfiy son (son o'qida noldan chapda).",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Целые числа', title: 'Отрицательное',
    setup: "Числа со знаком '-' называются отрицательными.",
    ask: 'Какое число отрицательное?',
    opts: ['-7', '3', '0', '12'],
    correct: 'Верно. -7 — отрицательное число (левее нуля на прямой).',
