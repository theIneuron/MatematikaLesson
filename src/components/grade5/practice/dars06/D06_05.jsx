// Dars06 · Amaliyot 05 — Harorat o'zgarishi · 🟡 · Nilufar · tag: temp_change
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'temp_change', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Harorat', title: 'Isidimi',
    setup: "Harorat o'zgarishini son o'qida kuzatish mumkin: o'ngga siljish — isish.",
    ask: "Ertalab harorat -5°C edi, tushda -2°C bo'ldi. Havo qanday o'zgardi?",
    opts: ['Isidi', 'Sovudi', "O'zgarmadi", "Aniqlab bo'lmaydi"],
    correct: "To'g'ri. -2 son o'qida -5 dan o'ngda, demak harorat ko'tarildi — havo isidi.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Температура', title: 'Потеплело ли',
    setup: 'Изменение температуры видно на прямой: сдвиг вправо — потепление.',
    ask: 'Утром было -5°C, днём стало -2°C. Как изменилась погода?',
    opts: ['Потеплело', 'Похолодало', 'Не изменилось', 'Нельзя определить'],
    correct: 'Верно. -2 правее -5 на прямой, значит температура поднялась — потеплело.',
