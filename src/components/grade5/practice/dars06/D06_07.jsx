// Dars06 · Amaliyot 07 — Eng kichik son · 🔴 · Bekzod · tag: min_negative
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'min_negative', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Butun sonlar', title: 'Eng kichik',
    setup: "Son o'qida chaproqda joylashgan son kichikroq.",
    ask: '-8, -1, -5 sonlaridan qaysi biri eng kichik?',
    opts: ['-8', '-1', '-5', '0'],
    correct: "To'g'ri. -8 son o'qida eng chapda, shuning uchun eng kichik.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Целые числа', title: 'Наименьшее',
    setup: 'Число, расположенное левее на прямой, меньше.',
    ask: 'Какое из чисел -8, -1, -5 наименьшее?',
    opts: ['-8', '-1', '-5', '0'],
    correct: 'Верно. -8 крайнее слева на прямой, поэтому наименьшее.',
