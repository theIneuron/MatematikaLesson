// Dars06 · Amaliyot 08 — Chuqurlik va balandlik · 🔴 · Nilufar · tag: depth_diff
// jsx-question kontrakti: onReady/registerCheck/onSubmit. O'z tugmasi yo'q. Faqat react importi.
import React, { useState, useEffect, useRef, useCallback } from 'react';

const TARGET = 11;
const DATA = { tag: 'depth_diff', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Dengizda', title: 'Masofa',
    setup: "Baliq dengiz sathidan 7 metr pastda (-7 m), qush esa sathdan 4 metr tepada (+4 m). Qush bilan baliq orasidagi masofa necha metr?",
    label: 'Masofani yozing (m):',
    live: 'Sizning javobingiz:',
    correct: "To'g'ri. Qushdan baliqqacha: 4 + 7 = 11 metr.",
    wrong: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'На море', title: 'Расстояние',
    setup: 'Рыба на 7 метров ниже уровня моря (-7 м), а птица на 4 метра выше (+4 м). Каково расстояние между птицей и рыбой?',
    label: 'Запишите расстояние (м):',
    live: 'Ваш ответ:',
    correct: 'Верно. От птицы до рыбы: 4 + 7 = 11 метров.',
