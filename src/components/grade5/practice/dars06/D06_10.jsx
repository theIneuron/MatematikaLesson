// Dars06 · Amaliyot 10 — Qaysi katta · 🔴 · Sardor · tag: bias_compare
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'bias_compare', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Butun sonlar', title: 'Qaysi katta',
    setup: 'Manfiy sonlarda kattaroq raqam kattaroq son degani EMAS.',
    ask: '-1 va -10 sonlaridan qaysi biri katta?',
    opts: ['-1', '-10', 'Ular teng', "Aniqlab bo'lmaydi"],
    correct: "To'g'ri. -1 son o'qida -10 dan o'ngda, shuning uchun -1 > -10.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Целые числа', title: 'Что больше',
    setup: 'У отрицательных чисел бОльшая цифра НЕ значит бОльшее число.',
    ask: 'Какое из чисел -1 и -10 больше?',
    opts: ['-1', '-10', 'Они равны', 'Нельзя определить'],
    correct: 'Верно. -1 правее -10 на прямой, поэтому -1 > -10.',
