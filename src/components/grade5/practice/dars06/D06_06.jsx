// Dars06 · Amaliyot 06 — Bank kartasi · 🟡 · Sardor · tag: bank_negative
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'bank_negative', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Hayotda', title: 'Musbat yoki manfiy',
    setup: "Kartaga pul tushishi musbat (+), yechib olish manfiy (-) son bilan yoziladi.",
    ask: 'Qaysi amaliyot manfiy son bilan ifodalanadi?',
    opts: ["Kartadan 50 000 so'm yechib olindi", "Kartaga 30 000 so'm tushdi", "Ish haqi 500 000 so'm keldi", "Sovg'a puli 20 000 so'm qo'shildi"],
    correct: "To'g'ri. Pul yechib olish — mablag'ning kamayishi, manfiy son (-50 000).",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'В жизни', title: 'Плюс или минус',
    setup: 'Поступление на карту — положительное (+), снятие — отрицательное (-) число.',
    ask: 'Какая операция обозначается отрицательным числом?',
    opts: ['С карты сняли 50 000 сум', 'На карту поступило 30 000 сум', 'Пришла зарплата 500 000 сум', 'Добавили подарок 20 000 сум'],
    correct: 'Верно. Снятие денег — уменьшение средств, отрицательное число (-50 000).',
