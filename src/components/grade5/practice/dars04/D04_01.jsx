// Dars04 · Amaliyot 01 — Yig'indidan ko'paytma · 🟢 · Madina · tag: sum_to_product
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'sum_to_product', level: '🟢' };
const T = {
  uz: {
    eyebrow: "Ko'paytirish", title: "Ko'paytma",
    setup: "Madina bir xil sonlar yig'indisini ko'rdi.",
    ask: "18 + 18 + 18 + 18 + 18 yig'indisi qaysi ko'paytmaga teng?",
    opts: ['18 × 5', '18 × 4', '5 × 5', '18 + 5'],
    correct: "To'g'ri. Beshta 18 — bu 18 × 5 = 90.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Умножение', title: 'Произведение',
    setup: 'Мадина увидела сумму одинаковых чисел.',
    ask: 'Какому произведению равна сумма 18 + 18 + 18 + 18 + 18?',
    opts: ['18 × 5', '18 × 4', '5 × 5', '18 + 5'],
    correct: 'Верно. Пять раз по 18 — это 18 × 5 = 90.',
