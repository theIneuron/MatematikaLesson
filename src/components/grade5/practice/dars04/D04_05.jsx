// Dars04 · Amaliyot 05 — Ko'paytmani toping · 🟡 · Madina · tag: product_input
import React, { useState, useEffect, useRef, useCallback } from 'react';

const TARGET = 2183;
const DATA = { tag: 'product_input', level: '🟡' };
const T = {
  uz: {
    eyebrow: "Ko'paytirish", title: "Ko'paytma",
    setup: "Madina ko'paytmani ustunda hisobladi:",
    words: '37 × 59',
    label: 'Javobni yozing:',
    live: 'Sizning javobingiz:',
    correct: "To'g'ri. 37 × 59 = 2183.",
    wrong: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Умножение', title: 'Произведение',
    setup: 'Мадина посчитала произведение столбиком:',
    words: '37 × 59',
    label: 'Запишите ответ:',
    live: 'Ваш ответ:',
    correct: 'Верно. 37 × 59 = 2183.',
