// Dars04 · Amaliyot 06 — Qutidagi sharbat · 🟡 · Nilufar · tag: word_product
import React, { useState, useEffect, useRef, useCallback } from 'react';

const TARGET = 360;
const DATA = { tag: 'word_product', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Hayotda', title: 'Jami nechta',
    setup: "Bir qutida 24 ta meva sharbati bor. Do'konda 15 ta shunday quti bor. Jami nechta sharbat bor?",
    label: 'Javobni yozing:',
    live: 'Sizning javobingiz:',
    correct: "To'g'ri. 24 × 15 = 360 ta sharbat.",
    wrong: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'В жизни', title: 'Сколько всего',
    setup: 'В одной коробке 24 сока. В магазине 15 таких коробок. Сколько всего соков?',
    label: 'Запишите ответ:',
    live: 'Ваш ответ:',
    correct: 'Верно. 24 × 15 = 360 соков.',
