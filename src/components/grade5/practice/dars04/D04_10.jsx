// Dars04 · Amaliyot 10 — Ifodani ixchamlash · 🔴 · Sardor · tag: distributive
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'distributive', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Ixchamlash', title: 'Hisobla',
    setup: "Bir xil qo'shiluvchilarni ko'paytmaga keltirish ifodani ixchamlaydi.",
    ask: '231 + 231 + 231 + 231 + 35 ni hisoblang.',
    opts: ['959', '924', '994', '1 359'],
    correct: "To'g'ri. To'rtta 231 — bu 231 × 4 = 924; 924 + 35 = 959.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Упрощение', title: 'Вычисли',
    setup: 'Замена одинаковых слагаемых произведением упрощает выражение.',
    ask: 'Вычислите 231 + 231 + 231 + 231 + 35.',
    opts: ['959', '924', '994', '1 359'],
    correct: 'Верно. Четыре раза 231 — это 231 × 4 = 924; 924 + 35 = 959.',
