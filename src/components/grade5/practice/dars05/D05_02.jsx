// Dars05 · Amaliyot 02 — Qoldiqsiz bo'linish · 🟢 · Madina · tag: divides_evenly
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'divides_evenly', level: '🟢' };
const T = {
  uz: {
    eyebrow: "Bo'lish", title: 'Qoldiqsizmi',
    setup: "Qoldiqsiz bo'linishda qoldiq nolga teng.",
    ask: "Qaysi bo'linish qoldiqsiz bajariladi?",
    opts: ['18 : 6', '12 : 5', '20 : 8', '124 : 5'],
    correct: "To'g'ri. 18 : 6 = 3, qoldiq 0. Qolganlarida qoldiq bor.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Деление', title: 'Без остатка',
    setup: 'При делении без остатка остаток равен нулю.',
    ask: 'Какое деление выполняется без остатка?',
    opts: ['18 : 6', '12 : 5', '20 : 8', '124 : 5'],
    correct: 'Верно. 18 : 6 = 3, остаток 0. У остальных есть остаток.',
