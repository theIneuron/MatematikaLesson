    ...
    <div style={S.wrap}>
      ...
      <div style={{ position: 'relative', maxHeight: ph >= 1 ? 130 : 0, opacity: ph >= 1 ? 1 : 0, overflow: 'hidden', transition: 'max-height .6s cubic-bezier(.33,1,.42,1), opacity .5s ease', marginBottom: ph >= 1 ? 14 : 0 }}>
        <div style={{ display: 'flex', gap: 10, justifyContent: 'center', minHeight: 44 }}>
          ...
          {ph >= 2 && (
            <div className="d5-pop" style={{ padding: '8px 14px', borderRadius: 12, background: '#fff4ee', border: '2px solid #ffd6bd', textAlign: 'center' }}>
              <div style={{ fontSize: 11, fontWeight: 800, color: '#fe5b1a' }}>{t.step2}</div>
              <div style={{ ...S.mono, fontSize: 20, fontWeight: 800, color: '#b83d0e' }}>800 : 8 = 100</div>
            </div>
          )}
        </div>
