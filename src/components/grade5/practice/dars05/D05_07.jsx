// Dars05 · Amaliyot 07 — Bo'linmani toping · 🔴 · Madina · tag: long_div_input
import React, { useState, useEffect, useRef, useCallback } from 'react';

const TARGET = 927;
const DATA = { tag: 'long_div_input', level: '🔴' };
const T = {
  uz: {
    eyebrow: "Bo'lish", title: "Bo'linma",
    setup: "Madina burchak usulida bo'ldi:",
    words: '6489 : 7',
    label: "Bo'linmani yozing:",
    live: 'Sizning javobingiz:',
    correct: "To'g'ri. 6489 : 7 = 927.",
    wrong: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Деление', title: 'Частное',
    setup: 'Мадина разделила уголком:',
    words: '6489 : 7',
    label: 'Запишите частное:',
    live: 'Ваш ответ:',
  ...
  return (
    <div className="pq pq07">
      <style>{`
        ...
        .pq07 .pq-setup { font-size:16px; line-height:1.5; margin:6px 0 6px; color:#374151; }
        .pq07 .pq-words { font-size:22px; font-weight:800; color:#2563eb; margin:2px 0 18px; }
      ...
      <label className="pq-label" htmlFor="pq07-in">{t.label}</label>
