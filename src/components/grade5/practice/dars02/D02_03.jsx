...
// Darslik §5.3 / Mashq 106: chapdan bir xil nomli xonalarni taqqoslash. jsx-question kontrakti.
import React, { useState, useEffect, useRef, useCallback } from 'react';

const LEFT = 36099, RIGHT = 36106;
const REL = LEFT > RIGHT ? '>' : (LEFT < RIGHT ? '<' : '=');
const DATA = { tag: 'compare_same', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Taqqoslash', title: 'Qaysi katta',
    setup: 'Madina bir xil xonali ikki sonni taqqoslamoqchi. Belgini tanlang:',
    correct: "To'g'ri. Minglar va yuzlar teng, lekin o'nlar xonasida 0 < 1, demak 36 099 < 36 106.",
  ...
  ru: {
    ...
    correct: 'Верно. Тысячи и сотни равны, но в десятках 0 < 1, значит 36 099 < 36 106.',
  ...
  return (
    <div className="pq pq03">
      <style>{`
        ...
        .pq03 .pq-nums { display:flex; justify-content:center; align-items:center; gap:20px; margin:6px 0 8px; }
        .pq03 .pq-n { font-size:32px; font-weight:800; color:#2563eb; font-variant-numeric:tabular-nums; }
        .pq03 .pq-q { font-size:30px; font-weight:800; color:#9aa1ad; min-width:28px; text-align:center; }
