// Dars02 · Amaliyot 02 — O'nlar xonasigacha yaxlitlash · 🟢 · Bekzod · tag: round_ten
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { number: 238, correct: 0, tag: 'round_ten', level: '🟢' };
const T = {
  uz: {
    eyebrow: 'Yaxlitlash', title: "O'nlargacha",
    setup: 'Bekzod 238 sonini yaxlitlamoqchi.',
    ask: "238 ni o'nlar xonasigacha yaxlitlang.",
    opts: ['240', '230', '200', '250'],
    correct: "To'g'ri. Birlar xonasida 8 (5 dan katta), shuning uchun o'nlarga 1 qo'shiladi: 238 ≈ 240.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Округление', title: 'До десятков',
    setup: 'Бекзод округляет число 238.',
    ask: 'Округлите 238 до разряда десятков.',
    opts: ['240', '230', '200', '250'],
    correct: 'Верно. В разряде единиц 8 (больше 5), поэтому десятки увеличиваются на 1: 238 ≈ 240.',
  ...
  return (
    <div className="pq pq02">
      <style>{`
        ...
        .pq02 .pq-num { text-align:center; font-size:40px; font-weight:800; color:#2563eb; letter-spacing:.04em; font-variant-numeric:tabular-nums; margin:6px 0 18px; animation:pqReveal .6s cubic-bezier(.22,1,.36,1) both; animation-delay:.1s; }
