...
const T = {
  uz: {
    eyebrow: 'Yaxlitlash', title: 'Yuzlargacha',
    setup: 'Madina 45 849 sonini yaxlitlamoqchi.',
  ...
  ru: {
    ...
    setup: 'Мадина округляет число 45 849.',
  ...
  return (
    <div className="pq pq04">
      <style>{`
        ...
        .pq04 .pq-num { text-align:center; font-size:40px; font-weight:800; color:#fe5b1a; letter-spacing:.04em; font-variant-numeric:tabular-nums; margin:6px 0 18px; animation:pqReveal .6s cubic-bezier(.22,1,.36,1) both; animation-delay:.1s; }
