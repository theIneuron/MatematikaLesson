  ...
  return (
    <div style={S.wrap}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, margin: '8px 0' }}>
        <TenStrip k={3} />
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, ...S.mono, fontSize: 20, fontWeight: 800, color: '#2563eb' }}><span>0,3</span><span style={{ color: '#94a3b8' }}>?</span><Frac num={3} den={10} size={17} color="#2563eb" /></div>
      </div>
