  ...
  return (
    <div style={S.wrap}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, margin: '10px 0 6px', flexWrap: 'wrap' }}>
        <QBox /><Frac num="4" den="5" size={20} color="#7c3aed" /><span style={{ ...S.mono, fontSize: 22, fontWeight: 800, color: '#94a3b8' }}>+</span><Mixed w={1} n={3} d={5} size={22} color="#2563eb" /><span style={{ ...S.mono, fontSize: 22, fontWeight: 800, color: '#94a3b8' }}>=</span><Mixed w={5} n={2} d={5} size={22} color="#1f2430" />
      </div>
