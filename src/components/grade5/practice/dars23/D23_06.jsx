...
export default function D23_06(props) {
  ...
  return (
    <div style={S.wrap}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 4 }}><Mixed w={1} n={4} d={5} size={18} color="#fe5b1a" /><span style={{ ...S.mono, fontWeight: 800, color: '#94a3b8' }}>+</span><Mixed w={1} n={1} d={5} size={18} color="#fe5b1a" /></div>
