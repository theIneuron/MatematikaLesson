// Dars23 · Amaliyot 08 — Butungacha to'ldir · 🟢 · tag: complete_whole
// 3 2/5 ni 4 butunga to'ldirish uchun yana 3/5 kerak: 4 − 3 2/5 = 3/5.
...
const D08_T = {
  uz: {
    eyebrow: "To'ldir", setup: "Aziza 4 litrlik idishga 3 2/5 litr suv quydi. Idishni to'ldirish uchun yana qancha suv kerak? (Sariq — bo'sh joy.)",
    ask: 'Yana qancha suv kerak? 4 − 3 2/5 = ?/5', label: 'Suratni yozing:',
    correct: "To'g'ri. 3 2/5 dan 4 gacha yana 3 ta beshdan yetishmayapti: 4 − 3 2/5 = 3/5.",
    wrong: "Rasmda sariq (bo'sh) joyga qarang — u nechta beshdan?",
    rule: "Butungacha to'ldirish uchun kasrni maxrajgacha to'ldiring. 3 2/5 → 4 uchun yana 3/5 kerak.",
  },
  ru: {
    eyebrow: 'Долей', setup: 'Азиза налила в 4-литровый сосуд 3 2/5 литра воды. Сколько ещё нужно долить, чтобы заполнить? (Жёлтое — пустое место.)',
    ask: 'Сколько воды ещё нужно? 4 − 3 2/5 = ?/5', label: 'Впиши числитель:',
    correct: 'Верно. От 3 2/5 до 4 не хватает ещё 3 пятых: 4 − 3 2/5 = 3/5.',
    wrong: 'Посмотри на жёлтое (пустое) на рисунке — сколько это пятых?',
    rule: 'Дополнение до целого: дополни дробь до знаменателя. 3 2/5 → 4 нужно ещё 3/5.',
  },
};
    ...
    <div style={S.wrap}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
        <div style={{ display: 'inline-flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
          <input value={val} onChange={(e) => setVal(e.target.value.replace(/[^\d]/g, '').slice(0, 1))} disabled={isReview || checked} inputMode="numeric" placeholder="?" style={{ width: 54, height: 44, textAlign: 'center', fontSize: 24, fontWeight: 800, borderRadius: 11, border: '2px solid ' + bd, color: '#1f2430', fontFamily: "'JetBrains Mono', monospace", background: '#fff' }} />
