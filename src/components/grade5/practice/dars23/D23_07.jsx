  ...
  return (
    <div style={S.wrap}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, margin: '8px 0', flexWrap: 'wrap' }}>
        <Mixed w={9} n={2} d={7} size={22} color="#2563eb" /><span style={{ ...S.mono, fontSize: 20, fontWeight: 800, color: '#94a3b8' }}>−</span><Mixed w={3} n={1} d={7} size={22} color="#2563eb" /><span style={{ ...S.mono, fontSize: 20, fontWeight: 800, color: '#94a3b8' }}>−</span><Mixed w={2} n={6} d={7} size={22} color="#2563eb" />
      </div>
