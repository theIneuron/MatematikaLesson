// Dars10 · Amaliyot 02 — Nechaga bo'linadi · 🟢 · Madina · tag: denom_parts
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'denom_parts', level: '🟢' };
const T = {
  uz: {
    eyebrow: "Son o'qi", title: "Bo'linmalar",
    setup: "Kasrni son o'qida belgilash uchun birlik kesma maxrajga teng qismga bo'linadi.",
    ask: "1/5 kasrini belgilash uchun birlik kesma nechaga bo'linadi?",
    opts: ['5', '1', '6', '10'],
    correct: "To'g'ri. Maxraj 5 — birlik kesma 5 ta teng qismga bo'linadi.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Числовая прямая', title: 'На сколько частей',
    setup: 'Чтобы отметить дробь, единичный отрезок делят на число частей, равное знаменателю.',
    ask: 'На сколько частей делят единичный отрезок, чтобы отметить 1/5?',
    opts: ['5', '1', '6', '10'],
    correct: 'Верно. Знаменатель 5 — единичный отрезок делят на 5 равных частей.',
