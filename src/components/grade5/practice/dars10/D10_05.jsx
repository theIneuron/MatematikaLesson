// Dars10 · Amaliyot 05 — Ikki butun orasida · 🟡 · Sardor · tag: between_integers
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'between_integers', level: '🟡' };
const T = {
  uz: {
    eyebrow: "Son o'qi", title: 'Qayerda',
    setup: "Noto'g'ri kasr ikki butun son orasida yotadi.",
    ask: "7/4 kasri son o'qida qaysi ikki butun son orasida joylashadi?",
    opts: ['1 va 2', '0 va 1', '2 va 3', '7 va 4'],
    correct: "To'g'ri. 7/4 = 1 butun va 3/4, demak 1 bilan 2 orasida.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Числовая прямая', title: 'Где находится',
    setup: 'Неправильная дробь лежит между двумя целыми числами.',
    ask: 'Между какими двумя целыми числами лежит дробь 7/4?',
    opts: ['1 и 2', '0 и 1', '2 и 3', '7 и 4'],
    correct: 'Верно. 7/4 = 1 целая и 3/4, значит между 1 и 2.',
