// Dars10 · Amaliyot 07 — Qaysi butunga yaqin · 🔴 · Nilufar · tag: nearest_integer
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'nearest_integer', level: '🔴' };
const T = {
  uz: {
    eyebrow: "Son o'qi", title: 'Yaqin butun',
    setup: "Son o'qida kasr nuqtasi ikki butun son orasida turadi.",
    ask: "5/6 nuqtasi 0 va 1 dan qaysi butun songa yaqinroq?",
    opts: ['1', '0', "O'rtada — teng", "Aniqlab bo'lmaydi"],
    correct: "To'g'ri. 5/6 — 6 ulushdan 5-si olingan, 1 gacha atigi 1 ulush qoldi: 1 ga yaqinroq.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Числовая прямая', title: 'Ближайшее целое',
    setup: 'На числовой прямой дробь стоит между двумя целыми числами.',
    ask: 'К какому целому ближе точка 5/6: к 0 или к 1?',
    opts: ['1', '0', 'Посередине — поровну', 'Нельзя определить'],
    correct: 'Верно. 5/6 — взято 5 из 6 долей, до 1 всего 1 доля: ближе к 1.',
