// Dars10 · Amaliyot 09 — Eng o'ngdagi ulush · 🔴 · Sardor · tag: farthest_right
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'farthest_right', level: '🔴' };
const T = {
  uz: {
    eyebrow: "Son o'qi", title: "Eng o'ngda",
    setup: "Son o'qida ko'proq ulush olingan nuqta o'ngroqda turadi.",
    ask: "0 dan 1 gacha oraliq 8 ta teng ulushga bo'lingan. 1/8, 5/8, 3/8 nuqtalaridan qaysi biri eng o'ngda?",
    opts: ['5/8', '3/8', '1/8', 'Hammasi teng'],
    correct: "To'g'ri. 5/8 — noldan 5 ta ulush, eng ko'p qadam, shuning uchun eng o'ngda.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Числовая прямая', title: 'Правее всех',
    setup: 'На прямой точка, где взято больше долей, стоит правее.',
    ask: 'Отрезок от 0 до 1 разделён на 8 равных долей. Какая из точек 1/8, 5/8, 3/8 находится правее всех?',
    opts: ['5/8', '3/8', '1/8', 'Все равны'],
    correct: 'Верно. 5/8 — 5 долей от нуля, больше всего шагов, поэтому правее всех.',
