// Dars10 · Amaliyot 06 — Bir bo'linma · 🟡 · Bekzod · tag: denom_meaning
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'denom_meaning', level: '🟡' };
const T = {
  uz: {
    eyebrow: "Son o'qi", title: 'Qaysi ulush',
    setup: "Birlik kesma teng bo'laklarga bo'linganda har bir bo'lak bitta ulush bo'ladi.",
    ask: "0 bilan 1 oralig'i 6 ta teng qismga bo'lingan. Har bir bo'linma qaysi kasrga teng?",
    opts: ['1/6', '6/1', '1/5', '6/6'],
    correct: "To'g'ri. 6 ta teng ulush — har biri 1/6.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Числовая прямая', title: 'Какая доля',
    setup: 'Когда единичный отрезок делят на равные части, каждая часть — одна доля.',
    ask: 'Отрезок от 0 до 1 разделён на 6 равных частей. Чему равно каждое деление?',
    opts: ['1/6', '6/1', '1/5', '6/6'],
    correct: 'Верно. 6 равных долей — каждая 1/6.',
