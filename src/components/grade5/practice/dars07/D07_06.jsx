// Dars07 · Amaliyot 06 — Manfiyning qarama-qarshisi · 🟡 · Bekzod · tag: opposite_of_neg
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'opposite_of_neg', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Butun sonlar', title: 'Qarama-qarshi',
    setup: "Manfiy songa qarama-qarshi son musbat bo'ladi.",
    ask: '-8 soniga qarama-qarshi son qaysi?',
    opts: ['8', '-8', '0', '16'],
    correct: "To'g'ri. -8 ga qarama-qarshi son — 8.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Целые числа', title: 'Противоположное',
    setup: 'Противоположное отрицательному числу — положительное.',
    ask: 'Какое число противоположно числу -8?',
    opts: ['8', '-8', '0', '16'],
    correct: 'Верно. Противоположное числу -8 — это 8.',
