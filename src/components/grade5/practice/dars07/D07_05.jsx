// Dars07 · Amaliyot 05 — Nol va manfiy · 🟡 · Sardor · tag: zero_rule
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'zero_rule', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Butun sonlar', title: 'Nol',
    setup: '0 soni har qanday manfiy sondan katta, musbat sondan esa kichik.',
    ask: 'Qaysi son katta: 0 yoki -3?',
    opts: ['0', '-3', 'Teng', "Aniqlab bo'lmaydi"],
    correct: "To'g'ri. 0 har qanday manfiy sondan katta, demak 0 > -3.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Целые числа', title: 'Ноль',
    setup: '0 больше любого отрицательного числа и меньше любого положительного.',
    ask: 'Какое число больше: 0 или -3?',
    opts: ['0', '-3', 'Равны', 'Нельзя определить'],
    correct: 'Верно. 0 больше любого отрицательного числа, значит 0 > -3.',
