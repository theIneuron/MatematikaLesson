// Dars07 · Amaliyot 10 — Ikki marta qarama-qarshi · 🔴 · Bekzod · tag: opposite_double
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'opposite_double', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Butun sonlar', title: 'Qaytadi',
    setup: "Songa qarama-qarshi sonning qarama-qarshisi — dastlabki sonning o'zi.",
    ask: '-4 ning qarama-qarshisining qarama-qarshisi qaysi son?',
    opts: ['-4', '4', '0', '8'],
    correct: "To'g'ri. -4 → 4 → -4. Ikki marta qarama-qarshi olsak, dastlabki songa qaytamiz.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Целые числа', title: 'Возврат',
    setup: 'Противоположное к противоположному числу — само исходное число.',
    ask: 'Чему равно противоположное к противоположному числа -4?',
    opts: ['-4', '4', '0', '8'],
    correct: 'Верно. -4 → 4 → -4. Дважды взяв противоположное, возвращаемся к исходному числу.',
