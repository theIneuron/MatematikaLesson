// Dars07 · Amaliyot 07 — O'sish tartibi · 🔴 · Madina · tag: order_integers
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'order_integers', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Butun sonlar', title: 'Tartibla',
    setup: "Sonlarni son o'qidagi joylashuvi bo'yicha tartiblaymiz.",
    ask: "3, -5, 0, -2 sonlarini o'sish tartibida qaysi qatorda to'g'ri joylashtirilgan?",
    opts: ['-5, -2, 0, 3', '-2, -5, 0, 3', '3, 0, -2, -5', '-5, 0, -2, 3'],
    correct: "To'g'ri. Eng kichigidan boshlaymiz: -5 < -2 < 0 < 3.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Целые числа', title: 'Упорядочи',
    setup: 'Упорядочиваем числа по их положению на прямой.',
    ask: 'В каком ряду числа 3, -5, 0, -2 расставлены по возрастанию верно?',
    opts: ['-5, -2, 0, 3', '-2, -5, 0, 3', '3, 0, -2, -5', '-5, 0, -2, 3'],
    correct: 'Верно. Начинаем с наименьшего: -5 < -2 < 0 < 3.',
