// Dars07 · Amaliyot 01 — Qarama-qarshi son · 🟢 · Bekzod · tag: opposite
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'opposite', level: '🟢' };
const T = {
  uz: {
    eyebrow: 'Butun sonlar', title: 'Qarama-qarshi',
    setup: "Ikki son qarama-qarshi bo'ladi, agar ular noldan bir xil uzoqlikda, lekin turli tomonda joylashsa.",
    ask: '5 soniga qarama-qarshi son qaysi?',
    opts: ['-5', '5', '0', '1'],
    correct: "To'g'ri. 5 ga qarama-qarshi son — -5 (noldan bir xil uzoqlikda, qarama-qarshi tomonda).",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Целые числа', title: 'Противоположное',
    setup: 'Два числа противоположны, если они на одинаковом расстоянии от нуля, но по разные стороны.',
    ask: 'Какое число противоположно числу 5?',
    opts: ['-5', '5', '0', '1'],
    correct: 'Верно. Противоположное числу 5 — это -5 (то же расстояние от нуля, но по другую сторону).',
