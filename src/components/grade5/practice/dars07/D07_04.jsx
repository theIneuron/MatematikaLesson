// Dars07 · Amaliyot 04 — Qaysi kichik · 🟡 · Nilufar · tag: compare_two_neg
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'compare_two_neg', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Butun sonlar', title: 'Qaysi kichik',
    setup: "Son o'qida chapdagi son kichikroq.",
    ask: 'Qaysi son kichik: -17 yoki -11?',
    opts: ['-17', '-11', 'Teng', "Aniqlab bo'lmaydi"],
    correct: "To'g'ri. -17 son o'qida -11 dan chapda, shuning uchun -17 < -11.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Целые числа', title: 'Что меньше',
    setup: 'На числовой прямой левее — меньше.',
    ask: 'Какое число меньше: -17 или -11?',
    opts: ['-17', '-11', 'Равны', 'Нельзя определить'],
    correct: 'Верно. -17 левее -11 на прямой, поэтому -17 < -11.',
