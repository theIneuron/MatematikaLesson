// Dars01 · Amaliyot 10 — Turli raqamlar · 🔴 · Nilufar · tag: distinct_digits
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { number: 202042004, correct: 0, tag: 'distinct_digits', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Atrofimizda', title: 'Turli raqamlar',
    setup: 'Nilufar sondagi turli raqamlarni sanamoqchi.',
    ask: '202 042 004 sonida nechta turli xil raqam ishlatilgan?',
    opts: ['3', '4', '2', '9'],
    correct: "To'g'ri. Faqat 0, 2 va 4 raqamlari bor — jami 3 xil raqam.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Вокруг нас', title: 'Разные цифры',
    setup: 'Нилуфар считает разные цифры в числе.',
    ask: 'Сколько разных цифр в числе 202 042 004?',
    opts: ['3', '4', '2', '9'],
    correct: 'Верно. Есть только цифры 0, 2 и 4 — всего 3 разные цифры.',
  ...
  return (
    <div className="pq pq10">
      <style>{`
        ...
        .pq10 .pq-num { text-align:center; font-size:40px; font-weight:800; color:#2563eb; letter-spacing:.04em; font-variant-numeric:tabular-nums; margin:6px 0 18px; animation:pqReveal .6s cubic-bezier(.22,1,.36,1) both; animation-delay:.1s; }
