// Dars01 · Amaliyot 09 — Qonuniyat · 🔴 · Madina · tag: sequence_pattern
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'sequence_pattern', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Topishmoq', title: 'Qonuniyat',
    setup: 'Madina sonlar ketma-ketligini yozdi: 20, 202, 2020, ...',
    ask: 'Keyingi son qaysi?',
    opts: ['20202', '20200', '202020', '20220'],
    correct: "To'g'ri. Har safar oxiriga navbatma-navbat 2 va 0 qo'shiladi: 2020 dan keyin 20202.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Загадка', title: 'Закономерность',
    setup: 'Мадина записала последовательность: 20, 202, 2020, ...',
    ask: 'Какое число следующее?',
    opts: ['20202', '20200', '202020', '20220'],
    correct: 'Верно. Каждый раз в конец по очереди добавляется 2 и 0: после 2020 идёт 20202.',
