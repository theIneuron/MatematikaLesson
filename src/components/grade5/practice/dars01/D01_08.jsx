// Dars01 · Amaliyot 08 — Nol sinfli sonni o'qish · 🔴 · Bekzod · tag: read_zero_class
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { number: 247108000394, correct: 0, tag: 'read_zero_class', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Atrofimizda', title: 'Nolli sinf',
    setup: 'Bu sonning minglar sinfi faqat nollardan iborat.',
    ask: "Bu son qanday o'qiladi?",
    opts: [
      "ikki yuz qirq yetti milliard bir yuz sakkiz million uch yuz to'qson to'rt",
      "ikki yuz qirq yetti milliard bir yuz sakkiz million nol ming uch yuz to'qson to'rt",
      "ikki yuz qirq yetti million bir yuz sakkiz ming uch yuz to'qson to'rt",
    ],
    correct: "To'g'ri. Minglar sinfi 000 bo'lgani uchun uning nomi o'qilmaydi: ikki yuz qirq yetti milliard bir yuz sakkiz million uch yuz to'qson to'rt.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Вокруг нас', title: 'Нулевой класс',
    setup: 'Класс тысяч этого числа состоит только из нулей.',
    ask: 'Как читается это число?',
    opts: [
      'двести сорок семь миллиардов сто восемь миллионов триста девяносто четыре',
      'двести сорок семь миллиардов сто восемь миллионов ноль тысяч триста девяносто четыре',
      'двести сорок семь миллионов сто восемь тысяч триста девяносто четыре',
    ],
    correct: 'Верно. Класс тысяч 000, поэтому его название не читается: двести сорок семь миллиардов сто восемь миллионов триста девяносто четыре.',
  ...
  return (
    <div className="pq pq08">
      <style>{`
        ...
        .pq08 .pq-num { text-align:center; font-size:32px; font-weight:800; color:#2563eb; letter-spacing:.03em; font-variant-numeric:tabular-nums; margin:6px 0 18px; animation:pqReveal .6s cubic-bezier(.22,1,.36,1) both; animation-delay:.1s; }
