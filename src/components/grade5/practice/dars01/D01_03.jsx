...
const DATA = { number: '102812443', correct: 0, tag: 'class_group', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Atrofimizda', title: 'Sinflar',
  ...
  ru: {
    eyebrow: 'Вокруг нас', title: 'Классы',
  ...
  return (
    <div className="pq pq03">
      <style>{`
        ...
        .pq03 .pq-num { text-align:center; font-size:38px; font-weight:800; color:#2563eb; letter-spacing:.14em; font-variant-numeric:tabular-nums; margin:6px 0 18px; animation:pqReveal .6s cubic-bezier(.22,1,.36,1) both; animation-delay:.1s; }
      ...
      <div className="pq-num">{DATA.number}</div>
