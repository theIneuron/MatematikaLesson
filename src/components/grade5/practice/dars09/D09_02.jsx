// Dars09 · Amaliyot 02 — Surat va maxraj · 🟢 · Madina · tag: surat_maxraj
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'surat_maxraj', level: '🟢' };
const T = {
  uz: {
    eyebrow: 'Kasr', title: 'Maxraj',
    setup: "Kasrda tepadagi son — surat, pastdagi son — maxraj.",
    ask: '3/4 kasrida maxraj qaysi son?',
    opts: ['4', '3', '7', '1'],
    correct: "To'g'ri. Pastdagi son — maxraj: 4. U butun nechaga bo'linganini bildiradi.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Дробь', title: 'Знаменатель',
    setup: 'В дроби верхнее число — числитель, нижнее — знаменатель.',
    ask: 'Какое число является знаменателем дроби 3/4?',
    opts: ['4', '3', '7', '1'],
    correct: 'Верно. Нижнее число — знаменатель: 4. Он показывает, на сколько частей разделено целое.',
