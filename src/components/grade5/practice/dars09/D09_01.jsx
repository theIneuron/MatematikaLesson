// Dars09 · Amaliyot 01 — Kasrni o'qish · 🟢 · Bekzod · tag: read_fraction
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'read_fraction', level: '🟢' };
const T = {
  uz: {
    eyebrow: 'Kasr', title: 'Qaysi kasr',
    setup: "Doira 6 ta teng bo'lakka bo'lingan, ulardan 5 tasi bo'yalgan.",
    ask: "Bo'yalgan qism qaysi kasr bilan ifodalanadi?",
    opts: ['5/6', '6/5', '5/11', '1/6'],
    correct: "To'g'ri. 6 ta ulushdan 5 tasi bo'yalgan — bu 5/6.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Дробь', title: 'Какая дробь',
    setup: 'Круг разделён на 6 равных частей, 5 из них закрашены.',
    ask: 'Какой дробью выражается закрашенная часть?',
    opts: ['5/6', '6/5', '5/11', '1/6'],
    correct: 'Верно. Из 6 долей закрашено 5 — это 5/6.',
