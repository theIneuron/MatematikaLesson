// Dars09 · Amaliyot 08 — Quymoq · 🔴 · Sardor · tag: remaining_quymoq
// jsx-question kontrakti: onReady/registerCheck/onSubmit. O'z tugmasi yo'q. Faqat react importi.
import React, { useState, useEffect, useRef, useCallback } from 'react';

const TARGET = 4;
const DATA = { tag: 'remaining_quymoq', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Hayotda', title: 'Nechta qoldi',
    setup: "Ozoda xola 20 ta quymoq pishirdi. Aziza 3/10, Nargiza 4/10, Dilnoza 1/10 qismini yedi. Necha quymoq qoldi?",
    label: 'Javobni yozing (dona):',
    live: 'Sizning javobingiz:',
    correct: "To'g'ri. Aziza 6 ta, Nargiza 8 ta, Dilnoza 2 ta yedi: 6 + 8 + 2 = 16. Qolgan: 20 − 16 = 4 quymoq.",
    wrong: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'В жизни', title: 'Сколько осталось',
    setup: 'Тётя Озода испекла 20 оладий. Азиза съела 3/10, Наргиза 4/10, Дилноза 1/10. Сколько оладий осталось?',
    label: 'Запишите ответ (шт.):',
    live: 'Ваш ответ:',
    correct: 'Верно. Азиза 6, Наргиза 8, Дилноза 2: 6 + 8 + 2 = 16. Осталось: 20 − 16 = 4 оладьи.',
  ...
  return (
    <div className="pq pq08">
      <style>{`
        ...
        .pq08 .pq-setup { font-size:16px; line-height:1.5; margin:6px 0 14px; color:#374151; }
