// Dars09 · Amaliyot 09 — Hovuz · 🔴 · Nilufar · tag: pool_fraction
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'pool_fraction', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Hayotda', title: 'Qanday qism',
    setup: "Hovuz 7 soatda suv bilan to'liq to'ladi (har soatda teng miqdorda).",
    ask: "5 soatdan keyin hovuzning qanday qismi to'lgan bo'ladi?",
    opts: ['5/7', '7/5', '2/7', '5/12'],
    correct: "To'g'ri. Butun — 7 ulush (soat), 5 tasi o'tgan — 5/7.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'В жизни', title: 'Какая часть',
    setup: 'Бассейн наполняется водой за 7 часов (за каждый час поровну).',
    ask: 'Какая часть бассейна наполнится через 5 часов?',
    opts: ['5/7', '7/5', '2/7', '5/12'],
    correct: 'Верно. Целое — 7 долей (часов), прошло 5 — это 5/7.',
