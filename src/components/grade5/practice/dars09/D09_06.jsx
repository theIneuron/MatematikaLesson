// Dars09 · Amaliyot 06 — Bo'yalmagan qism · 🟡 · Sardor · tag: unshaded_fraction
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'unshaded_fraction', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Kasr', title: "Bo'yalmagan",
    setup: "Shakl 8 ta teng bo'lakka bo'lingan, ulardan 3 tasi bo'yalgan.",
    ask: "Shaklning qanday qismi BO'YALMAGAN?",
    opts: ['5/8', '3/8', '8/5', '5/3'],
    correct: "To'g'ri. 8 dan 3 tasi bo'yalgan bo'lsa, 5 tasi bo'yalmagan — 5/8.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Дробь', title: 'Не закрашено',
    setup: 'Фигура разделена на 8 равных частей, 3 из них закрашены.',
    ask: 'Какая часть фигуры НЕ закрашена?',
    opts: ['5/8', '3/8', '8/5', '5/3'],
    correct: 'Верно. Если из 8 закрашено 3, то не закрашено 5 — это 5/8.',
