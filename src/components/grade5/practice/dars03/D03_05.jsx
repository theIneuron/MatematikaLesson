// Dars03 · Amaliyot 05 — To'g'ri ayirma · 🟡 · Bekzod · tag: sub_check
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'sub_check', level: '🟡' };
const T = {
  uz: {
    eyebrow: 'Xato top', title: "Qaysi to'g'ri",
    setup: "Ayirmani qo'shish bilan tekshirish mumkin: ayirma + ayiriluvchi = kamayuvchi.",
    ask: "Qaysi ayirma to'g'ri hisoblangan?",
    opts: ['2158 − 599 = 1559', '2601 − 765 = 1936', '10 032 − 2255 = 7877', '2201 − 345 = 1756'],
    correct: "To'g'ri. 1559 + 599 = 2158. Qolganlari xato: 2601 − 765 = 1836, 10 032 − 2255 = 7777, 2201 − 345 = 1856.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Найди ошибку', title: 'Что верно',
    setup: 'Разность можно проверить сложением: разность + вычитаемое = уменьшаемое.',
    ask: 'Какая разность вычислена верно?',
    opts: ['2158 − 599 = 1559', '2601 − 765 = 1936', '10 032 − 2255 = 7877', '2201 − 345 = 1756'],
    correct: 'Верно. 1559 + 599 = 2158. Остальные неверны: 2601 − 765 = 1836, 10 032 − 2255 = 7777, 2201 − 345 = 1856.',
