// Dars03 · Amaliyot 07 — Qulay usul · 🔴 · Nilufar · tag: qulay_add
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'qulay_add', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Qulay usul', title: "Yig'indi",
    ...
    opts: ['278', '258', '288', '368'],
    correct: "To'g'ri. (54 + 46) + (39 + 61) + 78 = 100 + 100 + 78 = 278.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Удобный способ', title: 'Сумма',
    setup: 'Сочетательный закон сложения помогает считать удобно.',
    ask: 'Вычислите 54 + 39 + 78 + 46 + 61 удобным способом.',
    opts: ['278', '258', '288', '368'],
    correct: 'Верно. (54 + 46) + (39 + 61) + 78 = 100 + 100 + 78 = 278.',
