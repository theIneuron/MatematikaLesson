// Dars03 · Amaliyot 09 — Bir necha son yig'indisi · 🔴 · Sardor · tag: multi_sum
// jsx-question kontrakti: onReady/registerCheck/onSubmit. O'z tugmasi yo'q. Faqat react importi.
import React, { useState, useEffect, useRef, useCallback } from 'react';

const TARGET = 156739;
const DATA = { tag: 'multi_sum', level: '🔴' };
const T = {
  uz: {
    eyebrow: "Qo'shish", title: "Yig'indi",
    setup: "Sardor to'rt sonning yig'indisini topmoqchi:",
    words: "40 511 + 38 872 + 294 + 77 062",
    label: "Yig'indini yozing:",
    live: 'Sizning javobingiz:',
    correct: "To'g'ri. 40 511 + 38 872 + 294 + 77 062 = 156 739.",
    wrong: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Сложение', title: 'Сумма',
    setup: 'Сардор находит сумму четырёх чисел:',
    words: '40 511 + 38 872 + 294 + 77 062',
    label: 'Запишите сумму:',
    live: 'Ваш ответ:',
    correct: 'Верно. 40 511 + 38 872 + 294 + 77 062 = 156 739.',
  ...
  return (
    <div className="pq pq09">
      <style>{`
        ...
        .pq09 .pq-fb { display:flex; align-items:flex-start; gap:10px; margin-top:16px; padding:13px 15px; border-radius:14px; font-size:15px; line-height:1.45; font-weight:600; animation:pqIn .45s ease both; }
      ...
      <label className="pq-label" htmlFor="pq09-in">{t.label}</label>
