// Dars03 · Amaliyot 10 — Yig'indidan ayirish · 🔴 · Sardor · tag: qulay_sub
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'qulay_sub', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Qulay usul', title: 'Ayirma',
    setup: "Yig'indidan sonni ayirish uchun uni bitta qo'shiluvchidan ayirish kifoya.",
    ask: '(6 642 + 1 956) − 956 ni qulay usulda hisoblang.',
    opts: ['7 642', '6 642', '8 642', '7 542'],
    correct: "To'g'ri. 6 642 + (1 956 − 956) = 6 642 + 1 000 = 7 642.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Удобный способ', title: 'Разность',
    setup: 'Чтобы вычесть число из суммы, достаточно вычесть его из одного слагаемого.',
    ask: 'Вычислите (6 642 + 1 956) − 956 удобным способом.',
    opts: ['7 642', '6 642', '8 642', '7 542'],
    correct: 'Верно. 6 642 + (1 956 − 956) = 6 642 + 1 000 = 7 642.',
