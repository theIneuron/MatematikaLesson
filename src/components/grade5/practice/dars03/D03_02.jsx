// Dars03 · Amaliyot 02 — Ayirib bo'ladimi · 🟢 · Madina · tag: can_subtract
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'can_subtract', level: '🟢' };
const T = {
  uz: {
    eyebrow: 'Ayirish', title: "Bo'ladimi",
    setup: "Natural sonlarda kamayuvchi ayiriluvchidan kichik bo'lishi mumkin emas.",
    ask: "Qaysi ayirishni bajarib bo'lmaydi?",
    opts: ['342 − 424', '654 − 444', '399 − 0', '500 − 200'],
    correct: "To'g'ri. 342 < 424 — kamayuvchi ayiriluvchidan kichik, ayirib bo'lmaydi.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Вычитание', title: 'Можно ли',
    setup: 'У натуральных чисел уменьшаемое не может быть меньше вычитаемого.',
    ask: 'Какое вычитание выполнить нельзя?',
    opts: ['342 − 424', '654 − 444', '399 − 0', '500 − 200'],
    correct: 'Верно. 342 < 424 — уменьшаемое меньше вычитаемого, вычесть нельзя.',
