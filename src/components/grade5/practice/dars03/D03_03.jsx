  ...
  return (
    <div className="pq pq03">
      <style>{`
        ...
        .pq03 .pq-eyebrow { font-size:12px; font-weight:800; letter-spacing:.04em; color:#fe5b1a; text-transform:uppercase; }
        ...
        .pq03 input.pq-cin:focus { border-color:#fb7a45; background:#fff; }
