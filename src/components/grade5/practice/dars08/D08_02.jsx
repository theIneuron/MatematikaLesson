// Dars08 · Amaliyot 02 — Daraja shakli · 🟢 · Madina · tag: write_as_power
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'write_as_power', level: '🟢' };
const T = {
  uz: {
    eyebrow: 'Daraja', title: 'Daraja shaklida',
    setup: "Bir xil ko'paytuvchilar ko'paytmasi daraja shaklida yoziladi.",
    ask: '5 × 5 × 5 × 5 × 5 ni daraja shaklida qanday yoziladi?',
    opts: ['5⁵', '5 × 5', '25', '5⁴'],
    correct: "To'g'ri. Beshta 5 ko'paytuvchi — bu 5⁵.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Степень', title: 'В виде степени',
    setup: 'Произведение одинаковых множителей записывают в виде степени.',
    ask: 'Как записать 5 × 5 × 5 × 5 × 5 в виде степени?',
    opts: ['5⁵', '5 × 5', '25', '5⁴'],
    correct: 'Верно. Пять множителей 5 — это 5⁵.',
  ...
  return (
    <div className="pq pq02">
      <style>{`
        ...
        .pq02 .pq-setup { font-size:16px; line-height:1.5; margin:6px 0 16px; color:#374151; }
