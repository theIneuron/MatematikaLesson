// Dars08 · Amaliyot 09 — Qaysi katta · 🔴 · Nilufar · tag: power_vs_power
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'power_vs_power', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Daraja', title: 'Qaysi katta',
    setup: 'Darajalarni solishtirish uchun avval ularni hisoblang.',
    ask: '3² va 2³ sonlaridan qaysi biri katta?',
    opts: ['3²', '2³', 'Teng', "Aniqlab bo'lmaydi"],
    correct: "To'g'ri. 3² = 9, 2³ = 8. 9 > 8, demak 3² katta.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Степень', title: 'Что больше',
    setup: 'Чтобы сравнить степени, сначала вычислите их.',
    ask: 'Что больше: 3² или 2³?',
    opts: ['3²', '2³', 'Равны', 'Нельзя определить'],
    correct: 'Верно. 3² = 9, 2³ = 8. 9 > 8, значит 3² больше.',
  ...
  return (
    <div className="pq pq09">
      <style>{`
        ...
        .pq09 .pq-setup { font-size:16px; line-height:1.5; margin:6px 0 16px; color:#374151; }
