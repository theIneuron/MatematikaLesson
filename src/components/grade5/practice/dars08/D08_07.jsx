// Dars08 · Amaliyot 07 — O'nning kubi · 🔴 · Bekzod · tag: cube_ten
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'cube_ten', level: '🔴' };
const T = {
  uz: {
    eyebrow: 'Daraja', title: 'Kub',
    setup: "Kub — sonni uch marta ko'paytirish.",
    ask: '10³ nechaga teng?',
    opts: ['1000', '300', '30', '100'],
    correct: "To'g'ri. 10³ = 10 × 10 × 10 = 1000.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Степень', title: 'Куб',
    setup: 'Куб — умножение числа три раза.',
    ask: 'Чему равно 10³?',
    opts: ['1000', '300', '30', '100'],
    correct: 'Верно. 10³ = 10 × 10 × 10 = 1000.',
