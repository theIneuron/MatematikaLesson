// Dars08 · Amaliyot 01 — Kvadrat · 🟢 · Bekzod · tag: square_simple
import React, { useState, useEffect, useRef, useCallback } from 'react';

const DATA = { correct: 0, tag: 'square_simple', level: '🟢' };
const T = {
  uz: {
    eyebrow: 'Daraja', title: 'Kvadrat',
    setup: "Sonning kvadrati — uni o'ziga ko'paytirish.",
    ask: '5² nechaga teng?',
    opts: ['25', '10', '7', '32'],
    correct: "To'g'ri. 5² = 5 × 5 = 25.",
    wrongMsg: "Hali to'g'ri emas. Yana bir bor o'ylab ko'ring.",
  },
  ru: {
    eyebrow: 'Степень', title: 'Квадрат',
    setup: 'Квадрат числа — умножение его на само себя.',
    ask: 'Чему равно 5²?',
    opts: ['25', '10', '7', '32'],
    correct: 'Верно. 5² = 5 × 5 = 25.',
