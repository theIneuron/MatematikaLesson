...
const DATA = {
  ...
  given: [['40°', L('va', 'и', 'and'), '60°']],
  givenLabel: L(
    'Berilgan:',
    'Дано:',
    'Given:'),
  cards: [
    { id: 'a', label: L('uchinchisi 80°', 'третий 80°', 'the third 80°') },
    { id: 'b', label: L('eng katta tomon 80° qarshisida', 'наибольшая сторона против 80°', 'the largest side faces 80°') },
    { id: 'c', label: L('uchinchisi 100°', 'третий 100°', 'the third 100°') },
    { id: 'd', label: L('eng katta tomon 60° qarshisida', 'наибольшая сторона против 60°', 'the largest side faces 60°') },
  ],
  answerSeq: ['a', 'b'],
  fieldH: 52,
  ask: L(
