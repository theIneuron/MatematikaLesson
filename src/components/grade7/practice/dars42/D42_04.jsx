...
const DATA = {
  ...
  given: [['5', ',', '7', ',', L('orasidagi 40°', 'между ними 40°', 'included 40°')]],
  givenLabel: L(
    'Berilgan:',
    'Дано:',
    'Given:'),
  cards: [
    { id: 'a', label: L('ikki tomon va orasidagi burchak', 'две стороны и угол между ними', 'two sides and the included angle') },
    { id: 'b', label: L('uchburchaklar teng', 'треугольники равны', 'the triangles are equal') },
    { id: 'c', label: L('uch burchak', 'три угла', 'three angles') },
