// Dars04 · Amaliyot 08 — Ayniymi yoki yo'q · 🔴 · sort · tag: id_zones
// Mexanika: kit.jsx -> Zones. Raskladka: 8-o'rin.
// 2(x + 3) va 2x + 6 -> ayniy teng
// (x + 1)² va x² + 1 -> ayniy emas (o'rta had yo'qolgan)
// x + x va 2x -> ayniy teng
import React from 'react';
import { Zones, L } from '../kit.jsx';

const DATA = {
  tag: 'id_zones', level: '🔴', itemSize: 18, zoneLbl: 96,
  eyebrow: L('Ayniymi', 'Тождество ли', 'Identity or not'),
  setup: L(
    "Har juftlikni tekshirish kerak: ular hamma son uchun tengmi? Bitta mos kelmagan son yetadi -- juftlik ayniy emas.",
  ...
  zones: [
    { id: 'zy', label: L('Ayniy teng', 'Тождественно равны', 'Identical') },
    { id: 'zn', label: L('Ayniy emas', 'Не тождество', 'Not an identity') },
    { id: 'zy2', label: L('Ayniy teng (yana)', 'Тождество (ещё)', 'Identical (another)') },
  ],
  items: [
  ...
  correctText: L(
    "To'g'ri. (x + 1)² = x² + 2x + 1, ya'ni o'rta had yo'qolgan: x = 2 da 9 va 5 chiqadi. Qolgan ikki juftlik esa ayniy teng.",
  ...
  wrongs: [
    { when: (s) => s.bad.indexOf('i2') !== -1, text: L(
      "(x + 1)² da o'rta had bor: x = 2 da chap tomon 9, o'ng tomon esa 5. Bu ayniylik emas.",
    ...
    { when: (s) => s.bad.indexOf('i1') !== -1, text: L(
      "2(x + 3) = 2x + 6 -- taqsimot xossasi, ayniy teng.",
    ...
    { when: (s) => s.bad.indexOf('i3') !== -1, text: L(
      "x + x = 2x -- o'xshash hadlarni ixchamlash, ayniy teng.",
