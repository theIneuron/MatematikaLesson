...
// Bitta sonda tenglik chiqishi ayniyatni isbotlamaydi: u faqat RAD ETADI.
...
const DATA = {
  ...
  opts: [
    ...
    { label: L('Yozuvlar har doim teng', 'Записи тождественно равны', 'The records are always equal') },
    { label: L('Yozuvlar teng emas', 'Записи не равны', 'The records are unequal') },
  ],
  correct: 0,
  correctText: L(
    "To'g'ri. Bitta son mos kelishi tasodif bo'lishi mumkin. Ayniyatni isbotlash uchun xossalar bilan qayta yozish kerak.",
