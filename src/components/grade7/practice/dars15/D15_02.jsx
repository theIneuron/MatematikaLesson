...
//
// DARAJA KO'TARILDI (PODXOD_7SINF.md §13): koeffitsiyent uch xonali,
// harfli qism esa uzunroq.
//
// −125a²b³ ning koeffitsiyenti −125: minus koeffitsiyentning bir qismi.
// Xato variantlar: 125 (minusni tashlab ketgan) va 2 (ko'rsatkichni
...
const DATA = {
  ...
  expr: ['−125a²b³'], exprSize: 36,
  ask: L('Bu bir hadning koeffitsiyenti qanday?', 'Каков коэффициент этого одночлена?', 'What is the coefficient of this monomial?'),
  opts: [{ label: ['−125'] }, { label: ['125'] }, { label: ['2'] }],
  correct: 0,
  correctText: L(
    "To'g'ri. Koeffitsiyent −125: minus songa tegishli, harflarga emas.",
    'Верно. Коэффициент −125: минус относится к числу, а не к буквам.',
    'Correct. The coefficient is −125: the minus belongs to the number, not to the letters.'),
  wrongs: [
    { when: (s) => s.picked === 1, text: L(
      "Minus yo'qolib qoldi. U harfning oldida emas, SONNING oldida turibdi: koeffitsiyent −125.",
      'Минус потерялся. Он стоит не перед буквой, а перед ЧИСЛОМ: коэффициент −125.',
      'The minus got lost. It stands before the NUMBER, not the letter: the coefficient is −125.') },
