  ...
  props: {
    ...
    tasks: [
      ...
      },
      {
        ...
        solution: ['x0 = 1, y0 = −4', L("Uchi: (1; −4)", 'Вершина: (1; −4)', 'Vertex: (1; −4)')],
      },
    ],
  },
}
  ...
  props: {
    ...
    tasks: [
      ...
      },
      {
        ...
        solution: ['x0 = −4 / (−4)', 'x0 = 1', L("Simmetriya o'qi: x = 1", 'Ось симметрии: x = 1', 'Axis of symmetry: x = 1')],
      },
      {
        expr: 'y = x² + 6x + 9',
        ...
        solution: ['x0 = −6 / 2 = −3', 'y0 = 9 − 18 + 9 = 0', L("Uchi Ox da, nol bitta", 'Вершина на оси Ox, нуль один', 'The vertex is on the Ox axis, one zero')],
      },
    ],
  },
}
    ...
    tasks: [
      {
        ...
        solution: [
          L("To'g'ri juftlik: x1 va x2 uchidan bir xil masofada, ikki tarafda", 'Верная пара: x1 и x2 на одинаковом расстоянии от вершины, по обе стороны', 'Correct pair: x1 and x2 at equal distance from the vertex, on both sides'),
          L("Masalan, x = 0 va x = 4 (ikkalasi ham uchidan ikki birlik uzoqlikda)", 'Например, x = 0 и x = 4 (обе на расстоянии двух единиц от вершины)', 'For example, x = 0 and x = 4 (both two units away from the vertex)'),
          'y(0) = 3, y(4) = 3',
        ],
      },
    ],
    ...
    tasks: [
      {
        ...
        solution: ['a = 1, b = −6', 'x0 = 6 / 2 = 3', L('y = x² − 6x + 1 mos keladi', 'Подходит y = x² − 6x + 1', 'y = x² − 6x + 1 fits')],
      },
      {
        expr: 'x0 = −1',
        question: L(
        ...
        solution: ['a = 2, b = 4', 'x0 = −4 / 4 = −1', L('y = 2x² + 4x − 5 mos keladi', 'Подходит y = 2x² + 4x − 5', 'y = 2x² + 4x − 5 fits')],
      },
    ],
  },
}
