...
const CONTENT = {
  ...
  s2: {
    eyebrow: { ru: 'Сравни сам', uz: "O'zing solishtir" },
    title: { ru: 'Собери дробь и сравни сам', uz: "Kasrni yig'ib, o'zing solishtir" },
