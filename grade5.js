...
export const grade5Amaliy = [
  // — Bilim darajasi diagnostikasi (mavzu bo'yicha, soddadan murakkabga) —
  {
    slug: 'diagnostika-01-katta-sonlar',
    title: 'Diagnostika 1. Katta sonlar — bilim darajasi',
    desc: "10 topshiriq (soddadan murakkabga, oxirgisi eng qiyin). RU + UZ, vizual razryad/sinf jadvali, geymifikatsiya. Mavzu bo'yicha o'quvchining darajasini aniqlaydi.",
    Component: lazy(() => import('../components/grade5/diagnostika/Diag01_KattaSonlar.jsx')),
  },
