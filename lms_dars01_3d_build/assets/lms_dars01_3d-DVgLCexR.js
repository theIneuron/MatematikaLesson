...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ls(e,t,n){let r=new Float32Array(Yo),i=new H(0,1,0);return new Ta({name:`SphericalGaussianBlur`,defines:{n:Yo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:fs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function us(){return new Ta({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:fs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ds(){return new Ta({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fs(),fragmentShader:`
	...
	`}var ps=class extends vn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ra(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Ac(i,i.VERTEX_SHADER,y),S=Ac(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ic(i,x,`vertex`),n=Ic(i,S,`fragment`);z(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Cu=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},wu=new J(-1,1,1,-1,0,1),Tu=new class extends Qr{constructor(){super(),this.setAttribute(`position`,new Br([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new Br([0,2,0,0,2,0],2))}},Eu=class{constructor(e){this._mesh=new q(Tu,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,wu)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Du=class extends Cu{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Ta?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Sa.clone(e.uniforms),this.material=new Ta({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Eu(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Ou=class extends Cu{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},ku=class extends Cu{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Au=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new V);this._width=n.width,this._height=n.height,t=new vn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:oe}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Du(Su),this.copyPass.material.blending=0,this.timer=new po}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Ou!==void 0&&(r instanceof Ou?n=!0:r instanceof ku&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new V);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},ju=class extends Cu{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new G}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Mu={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new G(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},Nu=class e extends Cu{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new V(256,256):new V(e.x,e.y),this.clearColor=new G(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new vn(i,a,{type:oe}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new vn(i,a,{type:oe});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new vn(i,a,{type:oe});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=Mu;this.highPassUniforms=Sa.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new Ta({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new V(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new H(1,1,1),new H(1,1,1),new H(1,1,1),new H(1,1,1),new H(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=Sa.clone(Su.uniforms),this.blendMaterial=new Ta({uniforms:this.copyUniforms,vertexShader:Su.vertexShader,fragmentShader:Su.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new G,this._oldClearAlpha=1,this._basic=new K,this._fsQuad=new Eu(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new V(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new Ta({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new V(.5,.5)},direction:{value:new V(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}_getCompositeMaterial(e){return new Ta({defines:{NUM_MIPS:e},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`
				...
				}`})}};Nu.BlurDirectionX=new V(1,0),Nu.BlurDirectionY=new V(0,1);var Pu={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Fu=class extends Cu{constructor(){super(),this.isOutputPass=!0,this.uniforms=Sa.clone(Pu.uniforms),this.material=new Ea({name:Pu.name,uniforms:this.uniforms,vertexShader:Pu.vertexShader,fragmentShader:Pu.fragmentShader}),this._fsQuad=new Eu(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},W.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Iu=16669466,Lu=4884223,Ru=6018802,zu=Zt.smoothstep,Bu=Zt.lerp;function Vu(e,t={}){let{orbit:n=!1,autoRotate:r=!1,bg:i=329231,camPos:a=[0,1.2,12.5],camTarget:o=[0,.1,0],bloomStrength:s=.7}=t,c=new Xl({canvas:e,antialias:!0});c.setPixelRatio(Math.min(window.devicePixelRatio,2)),c.toneMapping=4,c.toneMappingExposure=1.1;let l=new ir;l.background=new G(i),l.fog=new rr(i,.016);let u=new io(45,1,.1,200);u.position.set(...a);let d=new ou(u,c.domElement);d.enableDamping=!0,d.enablePan=!1,d.enableZoom=n,d.enableRotate=n,d.autoRotate=r,d.autoRotateSpeed=.3,d.minDistance=6,d.maxDistance=20,d.target.set(...o);let f=new Au(c);f.addPass(new ju(l,u));let p=new Nu(new V(1,1),s,.5,.82);f.addPass(p),f.addPass(new Fu),l.add(new so(4609402,.8));let m=new oo(16773856,2.1);m.position.set(5,6,5),l.add(m);let h=new oo(5999871,1.15);h.position.set(-6,-1,-4),l.add(h);let g=new jo,_=new Oo,v=new V,y=[],b=null,x=0,S=!1;function C(){let t=e.clientWidth||640,n=e.clientHeight||400;c.setSize(t,n,!1),f.setSize(t,n),p.resolution.set(t,n),u.aspect=t/n,u.updateProjectionMatrix()}let w=new ResizeObserver(C);w.observe(e),C();function T(t){if(!b)return;let n=e.getBoundingClientRect();v.x=(t.clientX-n.left)/n.width*2-1,v.y=-((t.clientY-n.top)/n.height)*2+1,_.setFromCamera(v,u);let r=b.getTargets(),i=_.intersectObjects(r,!0)[0];if(i){let e=i.object;for(;e&&e.userData.pickId===void 0&&e.parent;)e=e.parent;b.handler(e.userData.pickId===void 0?i.object:e,i)}}e.addEventListener(`pointerdown`,T);function E(){if(S)return;let e=Math.min(g.getDelta(),.05),t=g.getElapsedTime();for(let n of y)n(e,t);d.update(),f.render(),x=requestAnimationFrame(E)}return{scene:l,camera:u,renderer:c,composer:f,controls:d,bloom:p,onFrame(e){y.push(e)},onClick(e,t){b={getTargets:e,handler:t}},start(){x||E()},dispose(){S=!0,cancelAnimationFrame(x),w.disconnect(),e.removeEventListener(`pointerdown`,T),d.dispose(),l.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose())}),f.dispose?.(),c.dispose()}}}var Hu=(e,t=.35,n=.6)=>new Da({color:e,roughness:t,metalness:n}),Uu=(e,t=1.6)=>new Da({color:e,emissive:e,emissiveIntensity:t});function Wu(e,t=1300,n=90){let r=new Float32Array(t*3);for(let e=0;e<t;e++){let t=n*(.6+Math.random()*.4),i=Math.random()*6.283,a=Math.acos(2*Math.random()-1);r[e*3]=t*Math.sin(a)*Math.cos(i),r[e*3+1]=t*Math.sin(a)*Math.sin(i),r[e*3+2]=t*Math.cos(a)}let i=new Qr;i.setAttribute(`position`,new Lr(r,3));let a=new ta(i,new Xi({color:16777215,size:.09,sizeAttenuation:!0,transparent:!0,opacity:.9}));return e.add(a),a}function Gu(e,t=120){let n=new Float32Array(t*3);for(let e=0;e<t;e++)n[e*3]=(Math.random()-.5)*16,n[e*3+1]=(Math.random()-.5)*10,n[e*3+2]=(Math.random()-.5)*8;let r=new Qr;r.setAttribute(`position`,new Lr(n,3));let i=new ta(r,new Xi({color:12374271,size:.05,sizeAttenuation:!0,transparent:!0,opacity:.35}));return e.add(i),i}function Ku(e,t=[-6.8,2.6,-15],n=1){let r=new Yn;r.add(new q(new ha(2.6,48,48),new Da({color:4156848,roughness:.85,metalness:.1,emissive:661552,emissiveIntensity:.5})));let i=new q(new ma(3.4,5.2,80),new K({color:13213802,side:2,transparent:!0,opacity:.5}));return i.rotation.x=-Math.PI/2.2,r.add(i),r.position.set(...t),r.scale.setScalar(n),r.rotation.z=.35,e.add(r),r}function qu(){let e=Hu(12899292,.35,.55),t=new Yn,n=new q(new xu(1.15,1.35,.72,4,.28),e);n.position.y=-.15,t.add(n);let r=new q(new xu(1.35,.98,.82,4,.26),e);r.position.y=.82,t.add(r);let i=new q(new xu(1.02,.62,.12,3,.14),new Da({color:1451052,roughness:.25,metalness:.4,emissive:727586,emissiveIntensity:.6}));i.position.set(0,.82,.4),t.add(i);let a=Uu(Ru,2.2),o=new q(new ha(.1,16,16),a);o.position.set(-.22,.86,.47);let s=o.clone();s.position.x=.22,t.add(o,s);let c=new q(new ga(.16,.03,10,20,Math.PI),Uu(Ru,1.6));c.position.set(0,.66,.47),c.rotation.z=Math.PI,c.visible=!1,t.add(c),t.add(new q(new da(.03,.03,.34,10),e).translateY(1.48));let l=new q(new ha(.11,14,14),Uu(Iu,2.4));return l.position.set(0,1.68,0),t.add(l),[[-.72,.1,.5],[.72,.1,-.5]].forEach(([n,r,i])=>{let a=new q(new la(.09,.34,4,8),e);a.position.set(n,r,0),a.rotation.z=i,t.add(a)}),[[-.28,-1],[.28,-1]].forEach(([n,r])=>{let i=new q(new la(.11,.22,4,8),e);i.position.set(n,r,0),t.add(i)}),t.userData={eyeMat:a,mouth:c,tip:l},t}function Ju(e,t,n=0){e.position.y=e.userData.baseY??e.position.y,e.userData.baseY=e.userData.baseY??e.position.y,e.position.y=e.userData.baseY+Math.sin(t*.8)*.18,e.rotation.y=Math.sin(t*.4)*.12,e.userData.tip.material.emissiveIntensity=2+Math.sin(t*3)*.4+n*1.5,e.userData.eyeMat.emissiveIntensity=2.2+n*.8,e.userData.mouth.visible=n>.5}function Yu(){let e=new Yn;e.add(new q(new da(.28,.28,1,24),Hu(15001839,.3,.75)));let t=new q(new da(.15,.15,.16,18),Uu(Iu,.7));t.position.y=.58,e.add(t);let n=new q(new da(.285,.285,.24,24),Hu(2106412,.6,.4));n.position.y=-.16,e.add(n);let r=new q(new da(.288,.288,.05,24),Uu(Iu,.7));return r.position.y=.14,e.add(r),e}function Xu(e=10){let t=new Yn;t.add(new q(new xu(1.5,.95,.5,4,.08),Hu(1777190,.35,.65)));let n=[];for(let r=0;r<2;r++)for(let i=0;i<5;i++){let a=r*5+i<e,o=new q(new da(.06,.06,.05,14),a?Uu(Iu,1.5):Hu(3809302,.5,.3));o.rotation.x=Math.PI/2,o.position.set(-.56+i*.28,.23-r*.46,.26),t.add(o),n.push(o)}return t.userData={leds:n},t}function Zu(e=6,t=3.4){let n=new Yn,r=new q(new xu(e,t,.3,4,.14),Hu(1316900,.5,.5));n.add(r);let i=new q(new ca(.05,t*.86,.34),Uu(2766160,.4));i.position.z=.05,n.add(i);let a=new q(new pa(e/2-.4,t-.4),new K({color:Iu,transparent:!0,opacity:.06}));a.position.set(-e/4,0,.17);let o=new q(new pa(e/2-.4,t-.4),new K({color:Lu,transparent:!0,opacity:.06}));return o.position.set(e/4,0,.17),n.add(a,o),n.userData={w:e,h:t,tensX:-e/4,onesX:e/4},n}function Qu(e,t=Math.random()*6.28){e.userData.f={seed:t,home:e.position.clone(),spin:new H((Math.random()-.5)*.25,(Math.random()-.5)*.25,(Math.random()-.5)*.25),sp:.3+Math.random()*.3}}function $u(e,t,n,r=.25){let i=e.userData.f;i&&(e.position.x=i.home.x+Math.cos(t*i.sp*.7+i.seed)*r,e.position.y=i.home.y+Math.sin(t*i.sp+i.seed)*r*1.4,e.rotation.x+=i.spin.x*n,e.rotation.y+=i.spin.y*n,e.rotation.z+=i.spin.z*n)}function ed(e,{color:t=`#ffffff`,font:n=96,weight:r=800,bg:i=null,scale:a=1,glowColor:o=null}={}){let s=document.createElement(`canvas`),c=s.getContext(`2d`),l=`${r} ${n}px Manrope, Arial, sans-serif`;if(c.font=l,s.width=Math.ceil(c.measureText(e).width)+n*.8,s.height=Math.ceil(n*1.5),c.font=l,c.textAlign=`center`,c.textBaseline=`middle`,i){c.fillStyle=i;let e=s.width-8,t=s.height-8;c.beginPath(),c.roundRect(4,4,e,t,24),c.fill()}o&&(c.shadowColor=o,c.shadowBlur=n*.5),c.fillStyle=t,c.fillText(e,s.width/2,s.height/2);let u=new ia(s);u.anisotropy=4,u.needsUpdate=!0;let d=new vi(new ii({map:u,transparent:!0,depthWrite:!1})),f=s.width/s.height;return d.scale.set(f*a,a,1),d.userData.px=s.width,d.userData.py=s.height,d}function td(e,t,n={}){let r=ed(t,n);e.material.map.dispose(),e.material.map=r.material.map,e.material.needsUpdate=!0,e.scale.copy(r.scale)}var nd=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),$=o(((e,t)=>{t.exports=nd()}))();function rd(e,t){let n=(0,_.useRef)(),r=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let i=Vu(n.current,e);return r.current=t(i)||{},i.start(),()=>i.dispose()},[]),{canvasRef:n,apiRef:r}}var id=({canvasRef:e})=>(0,$.jsx)(`canvas`,{ref:e,className:`l3-canvas`});function ad(e,t=!0){Wu(e.scene,1200),Gu(e.scene,90),t&&Ku(e.scene,[-7.6,3.2,-17],.85)}function od(e,t=[4.2,.2,.6],n=.82){let r=qu();return r.position.set(...t),r.scale.setScalar(n),r.userData.baseY=t[1],e.scene.add(r),r}function sd(e,t,n,{tx:r=-2.7,ox:i=1.6}={}){let a=new Yn;for(let e=0;e<t;e++){let t=Xu(10),n=e%2,i=Math.floor(e/2);t.position.set(r+n*1.75,1-i*1.12,(Math.random()-.5)*.3),t.userData.rot=(Math.random()-.5)*.15,t.userData.ph=Math.random()*6.28,a.add(t)}for(let e=0;e<n;e++){let t=Yu();t.scale.setScalar(.82);let n=e%3,r=Math.floor(e/3);t.position.set(i+n*.72,1.25-r*1.15,(Math.random()-.5)*.3),t.rotation.z=.25+(Math.random()-.5)*.3,t.userData.rot=(Math.random()-.5)*.2,t.userData.ph=Math.random()*6.28,a.add(t)}return e.add(a),a}function cd(e,t){e.children.forEach(e=>{e.userData.rot!==void 0&&(e.rotation.y+=e.userData.rot*.01,e.position.y+=Math.sin(t*.7+e.userData.ph)*.0016)})}function ld({sid:e,tens:t,ones:n,options:r,correct:i,explains:a,scored:o=!0,fact:s}){let c=y[e],l=kd(),u=Ad(),d=jd(c.audio.intro[l],l),[f,p]=(0,_.useState)(null),[m,h]=(0,_.useState)(!1),{canvasRef:g}=rd({camPos:[0,.8,12],camTarget:[0,.3,0]},e=>{ad(e);let r=sd(e.scene,t,n),i=od(e),a=0;return e.onFrame((e,t)=>{cd(r,t),Ju(i,t,a)}),{setCheer:e=>{a=e}}}),v=e=>{if(f!=null)return;p(e);let t=e===i;window.speechSynthesis?.cancel();let n=t?c.audio.on_correct:a?.[e]||c.audio.on_wrong,r=window.SpeechSynthesisUtterance&&new SpeechSynthesisUtterance(u(n));r&&!d.muted&&(r.lang=l===`ru`?`ru-RU`:`uz-UZ`,r.rate=.98,window.speechSynthesis.speak(r)),t&&s&&setTimeout(()=>h(!0),500)},b=f===i;return(0,$.jsx)(Ld,{eyebrow:u(c.eyebrow),title:u(c.q),nar:d,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(Pd,{opts:r.map(e=>e.label),picked:f,correct:i,onPick:v,cols:(r.length,2)}),(0,$.jsx)(Fd,{show:f!=null,ok:b,children:u(b?c.audio.on_correct:a?.[f]||c.audio.on_wrong)}),m&&s&&(0,$.jsxs)(`div`,{className:`l3-fact`,children:[(0,$.jsx)(`span`,{className:`l3-fact-badge`,children:u(s.badge)}),(0,$.jsx)(`p`,{children:u(s.text)})]})]}),children:(0,$.jsx)(id,{canvasRef:g})})}function ud(){let e=y.s0,t=kd(),n=Ad(),r=jd(e.audio.intro[t],t),[i,a]=(0,_.useState)(null),{canvasRef:o}=rd({orbit:!0,autoRotate:!0,camPos:[0,1.2,12.5]},e=>{ad(e),Ku(e.scene,[-6.8,2.6,-15],1);let t=od(e,[3.8,.3,.5],.9),n=[];for(let t=0;t<10;t++){let t=Yu();t.position.set((Math.random()-.5)*7-.6,(Math.random()-.5)*4.2,(Math.random()-.5)*3),t.rotation.set(Math.random()*3,Math.random()*3,Math.random()*3),Qu(t),e.scene.add(t),n.push(t)}return e.onFrame((e,r)=>{n.forEach(t=>$u(t,r,e,.3)),Ju(t,r,0)}),{}}),s=[e.opt0,e.opt1,e.opt2];return(0,$.jsx)(Ld,{eyebrow:n(e.topic),title:n(e.lead),sub:n(e.q),nar:r,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(Pd,{opts:s.map(n),picked:i,correct:1,onPick:o=>{if(i!=null)return;a(o),window.speechSynthesis?.cancel();let s=o===1?e.audio.on_correct:o===0?e.audio.on_wrong:e.audio.on_unknown,c=new SpeechSynthesisUtterance(n(s));c.lang=t===`ru`?`ru-RU`:`uz-UZ`,r.muted||window.speechSynthesis.speak(c)},cols:3}),(0,$.jsx)(Fd,{show:i!=null,ok:i===1,children:n(i===1?e.audio.on_correct:i===0?e.audio.on_wrong:e.audio.on_unknown)})]}),children:(0,$.jsx)(id,{canvasRef:o})})}function dd(){let e=y.s1,t=kd(),n=Ad(),r=jd(e.audio.intro,t),[i,a]=(0,_.useState)(null),{canvasRef:o}=rd({camPos:[0,.6,11],camTarget:[0,.2,0]},e=>{ad(e);let t=od(e,[4.3,.2,.4],.78),n=[],r=new Yn;e.scene.add(r);for(let e=0;e<10;e++){let e=new q(new ca(.42,.42,.42),new Da({color:15001839,roughness:.3,metalness:.6,emissive:Lu,emissiveIntensity:.15}));r.add(e),n.push(e)}let i=Xu(10);i.position.set(0,0,0),i.visible=!1,e.scene.add(i);let a=0;return e.onFrame((e,r)=>{a=(Math.sin(r*.5)+1)/2,n.forEach((t,n)=>{let r=new H(-2.2+n%5*1.1,1.1-Math.floor(n/5)*1,0),i=new H(-.56+n%5*.28,.23-Math.floor(n/5)*.46,0);t.position.lerpVectors(r,i,zu(a,.4,1)),t.scale.setScalar(1-zu(a,.5,1)*.75),t.rotation.y+=e*.5,t.visible=a<.97}),i.visible=a>.9,i.scale.setScalar(.001+zu(a,.85,1)),Ju(t,r,+(a>.9))}),{}}),s=[e.opt0,e.opt1,e.opt2],c=o=>{if(i!=null)return;a(o),window.speechSynthesis?.cancel();let s=o===0?e.audio.on_correct:e.audio.on_wrong,c=new SpeechSynthesisUtterance(n(s));c.lang=t===`ru`?`ru-RU`:`uz-UZ`,r.muted||window.speechSynthesis.speak(c)},l=[null,e.wrong_1,e.wrong_2];return(0,$.jsx)(Ld,{eyebrow:n(e.eyebrow),title:n(e.q),nar:r,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(Pd,{opts:s.map(n),picked:i,correct:0,onPick:c,cols:3}),(0,$.jsx)(Fd,{show:i!=null,ok:i===0,children:n(i===0?e.audio.on_correct:l[i])})]}),children:(0,$.jsx)(id,{canvasRef:o})})}function fd({onNext:e}){let t=y.s2,n=kd(),r=Ad(),i=jd(t.audio[n],n),[a,o]=(0,_.useState)(0),s=(0,_.useRef)(0),{canvasRef:c}=rd({camPos:[0,.6,11.5],camTarget:[0,.2,0]},e=>{ad(e);let t=od(e,[4.3,.2,.4],.75),n=Xu(0);n.position.set(0,-.2,0),e.scene.add(n);let r=n.userData.leds,i=[];for(let e=0;e<2;e++)for(let t=0;t<5;t++)i.push(new H(-.56+t*.28,.03-e*.46,.3));let a=[];for(let t=0;t<10;t++){let n=Yu();n.scale.setScalar(.62),n.position.set((Math.random()<.5?-1:1)*(2.4+Math.random()*1.2),(Math.random()-.5)*3.4,(Math.random()-.5)*1.5),n.rotation.set(Math.random()*3,0,Math.random()*3),Qu(n),n.userData.pickId=t,n.userData.done=!1,e.scene.add(n),a.push(n)}return e.onClick(()=>a.filter(e=>!e.userData.done),e=>{let t=e;if(t.userData.done)return;let n=s.current;n>=10||(t.userData.done=!0,t.userData.slot=i[n],t.userData.f=null,s.current=n+1,o(n+1))}),e.onFrame((e,n)=>{a.forEach(t=>{t.userData.done?(t.position.lerp(t.userData.slot,.15),t.rotation.x=Bu(t.rotation.x,0,.15),t.rotation.z=Bu(t.rotation.z,0,.15),t.scale.setScalar(Bu(t.scale.x,.42,.1))):$u(t,n,e,.2)}),r.forEach((e,t)=>{let r=t<s.current;e.material.emissive?.setHex?.(r?Iu:3809302),r&&(e.material.emissiveIntensity=1.4+Math.sin(n*5+t)*.3)}),Ju(t,n,+(s.current>=10))}),{}}),l=a>=10;return(0,$.jsx)(Ld,{eyebrow:r(t.eyebrow),title:r(t.lead),nar:i,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`l3-counter`,children:l?`✓ 10 / 10`:`${a} / 10`}),(0,$.jsx)(Fd,{show:l,ok:!0,children:r(t.done_text)})]}),children:(0,$.jsx)(id,{canvasRef:c})})}function pd({sid:e,target:t,withCheck:n}){let r=y[e],i=kd(),a=Ad(),o=jd(n?r.audio.intro:r.audio[i],i),[s,c]=(0,_.useState)(0),[l,u]=(0,_.useState)(0),[d,f]=(0,_.useState)(null),p=(0,_.useRef)({tens:0,ones:0}),m=(0,_.useRef)(null),h=rd({camPos:[0,.7,12],camTarget:[0,.1,0]},e=>{ad(e,!1),Ku(e.scene,[7.5,3.2,-17],.8);let t=Zu(6.4,3.2);t.position.set(0,.2,0),e.scene.add(t);let n=new Yn;n.position.set(-1.6,.4,.4),t.add(n);let i=new Yn;i.position.set(1.6,.4,.4),t.add(i);let o=ed(`0`,{font:150,color:`#ffffff`,glowColor:`#8fb4ff`,scale:1.4});o.position.set(0,3,.4),e.scene.add(o),m.current=o;let s=ed(a(r.tens_label).toUpperCase(),{font:44,color:`#ffbfa6`,scale:.42});s.position.set(-1.6,-1.35,.4),t.add(s);let c=ed(a(r.ones_label).toUpperCase(),{font:44,color:`#aecbff`,scale:.42});c.position.set(1.6,-1.35,.4),t.add(c);let l=()=>{[n,i].forEach(e=>{for(;e.children.length;)e.remove(e.children[0])});let e=p.current.tens,t=p.current.ones;for(let t=0;t<e;t++){let e=Xu(10);e.scale.setScalar(.62),e.position.set(-.5+t%2*1,.5-Math.floor(t/2)*.7,0),e.userData.pop=0,n.add(e)}for(let e=0;e<t;e++){let t=Yu();t.scale.setScalar(.5),t.position.set(-.5+e%3*.5,.6-Math.floor(e/3)*.7,0),t.userData.pop=0,i.add(t)}td(o,String(e*10+t),{font:150,color:d(),glowColor:`#8fb4ff`,scale:1.4})};p.current.rebuild=l;let u=`#ffffff`;function d(){return u}return p.current.setColor=e=>{u=e,l()},e.onFrame((e,t)=>{[n,i].forEach(t=>t.children.forEach(t=>{t.userData.pop=Math.min(1,(t.userData.pop||0)+e*4);let r=(t.parent===n?.62:.5)*zu(t.userData.pop,0,1);t.scale.setScalar(r),t.rotation.y+=e*.3}))}),p.current}),g=(e,t)=>{if(d===!0)return;let n=Math.max(0,Math.min(9,s+e)),r=Math.max(0,Math.min(9,l+t));c(n),u(r),p.current.tens=n,p.current.ones=r,p.current.rebuild?.(),d===!1&&f(null)},v=s*10+l,b=!n&&v===t;return(0,$.jsx)(Ld,{eyebrow:a(r.eyebrow),title:a(n?r.q:r.lead),nar:o,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`l3-build-ctrls`,children:[(0,$.jsxs)(`div`,{className:`l3-bctrl`,children:[(0,$.jsx)(`span`,{className:`tens`,children:a(r.src_tens)}),(0,$.jsxs)(`div`,{className:`l3-bbtns`,children:[(0,$.jsx)(`button`,{onClick:()=>g(-1,0),children:`−`}),(0,$.jsx)(`b`,{children:s}),(0,$.jsx)(`button`,{onClick:()=>g(1,0),children:`+`})]})]}),(0,$.jsxs)(`div`,{className:`l3-bctrl`,children:[(0,$.jsx)(`span`,{className:`ones`,children:a(r.src_ones)}),(0,$.jsxs)(`div`,{className:`l3-bbtns`,children:[(0,$.jsx)(`button`,{onClick:()=>g(0,-1),children:`−`}),(0,$.jsx)(`b`,{children:l}),(0,$.jsx)(`button`,{onClick:()=>g(0,1),children:`+`})]})]})]}),n?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(Id,{onClick:()=>{let e=v===t;f(e),window.speechSynthesis?.cancel();let n=new SpeechSynthesisUtterance(a(e?r.audio.on_correct:r.audio.on_wrong));n.lang=i===`ru`?`ru-RU`:`uz-UZ`,o.muted||window.speechSynthesis.speak(n),p.current.setColor?.(e?`#7CF2B0`:`#ffffff`)},disabled:d===!0,children:a(r.check_label)}),(0,$.jsx)(Fd,{show:d!=null,ok:d,children:a(d?r.audio.on_correct:r.audio.on_wrong)})]}):(0,$.jsx)(Fd,{show:b,ok:!0,children:a(r.done_text)})]}),children:(0,$.jsx)(id,{canvasRef:h.canvasRef})})}function md(){let e=y.s4,t=kd(),n=Ad(),r=jd(e.audio[t],t),[i,a]=(0,_.useState)(0),o=(0,_.useRef)({}),{canvasRef:s}=rd({camPos:[0,.7,12],camTarget:[0,.1,0]},t=>{ad(t,!1),Ku(t.scene,[7.6,3,-17],.8);let r=Zu(6.4,3.2);r.position.set(0,.2,0),t.scene.add(r);let i=new Yn;i.position.set(-1.6,.4,.4),r.add(i);let a=new Yn;a.position.set(1.6,.4,.4),r.add(a);let s=ed(n(e.tens_label).toUpperCase(),{font:44,color:`#ffbfa6`,scale:.42});s.position.set(-1.6,-1.35,.4),r.add(s);let c=ed(n(e.ones_label).toUpperCase(),{font:44,color:`#aecbff`,scale:.42});c.position.set(1.6,-1.35,.4),r.add(c);let l=ed(`34`,{font:150,color:`#ffffff`,glowColor:`#8fb4ff`,scale:1.35});return l.position.set(0,3,.4),l.visible=!1,t.scene.add(l),o.current={apply(e){if([i,a].forEach(e=>{for(;e.children.length;)e.remove(e.children[0])}),e>=1)for(let e=0;e<3;e++){let t=Xu(10);t.scale.setScalar(.6),t.position.set(0,.6-e*.7,0),i.add(t)}if(e>=2)for(let e=0;e<4;e++){let t=Yu();t.scale.setScalar(.5),t.position.set(-.5+e%2*.5,.6-Math.floor(e/2)*.7,0),a.add(t)}l.visible=e>=3}},t.onFrame(e=>{[i,a].forEach(t=>t.children.forEach(t=>{t.userData.p=Math.min(1,(t.userData.p||0)+e*4),t.scale.setScalar((t.parent===i?.6:.5)*zu(t.userData.p,0,1)),t.rotation.y+=e*.25}))}),o.current.apply(0),o.current});return n(e.tens_label),n(e.ones_label),(0,$.jsx)(Ld,{eyebrow:n(e.eyebrow),title:n(e.lead),nar:r,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`l3-anchor`,children:i>=1?(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`b`,{style:{color:`#fe5b1a`},children:`3`}),` `,n(e.tens_label),i>=2?(0,$.jsxs)($.Fragment,{children:[` · `,(0,$.jsx)(`b`,{style:{color:`#4a86ff`},children:`4`}),` `,n(e.ones_label)]}):null,i>=3?(0,$.jsxs)($.Fragment,{children:[`  →  `,(0,$.jsx)(`b`,{children:`34 = 30 + 4`})]}):null]}):(0,$.jsx)(`span`,{className:`dim`,children:`…`})}),i<3?(0,$.jsx)(Id,{onClick:()=>{let e=Math.min(3,i+1);a(e),o.current.apply(e)},children:t===`ru`?`Дальше шаг →`:`Keyingi qadam →`}):(0,$.jsx)(Fd,{show:!0,ok:!0,children:t===`ru`?`Слева десятки, справа единицы.`:`Chapda o'nliklar, o'ngda birliklar.`})]}),children:(0,$.jsx)(id,{canvasRef:s})})}function hd(){let e=y.s5,t=kd(),n=Ad(),r=jd(e.audio[t],t),[i,a]=(0,_.useState)(0),[o,s]=(0,_.useState)(null),[c,l]=(0,_.useState)(null),[u,d]=(0,_.useState)(null),f=(0,_.useRef)({}),{canvasRef:p}=rd({camPos:[0,.6,12],camTarget:[0,.2,0]},e=>{ad(e,!1),Ku(e.scene,[-7.5,3,-17],.8);let t=od(e,[4.4,.1,.3],.72),n=new Yn;e.scene.add(n);let r=new q(new ga(2.1,.16,12,40),new Da({color:2766160,roughness:.4,metalness:.6,emissive:1318970,emissiveIntensity:.5}));r.position.set(-.6,.3,0),n.add(r);let i=new q(new ua(2,40),new Da({color:1054760,roughness:.5,metalness:.5,side:2}));return i.position.set(-.6,.3,-.05),n.add(i),f.current={open:!1,setOpen(e){this.open=e},leaf:i,frame:r},e.onFrame((e,n)=>{Ju(t,n,+!!f.current.open);let a=f.current.open?-3.6:-.6;i.position.x=Bu(i.position.x,a,.08),i.material.opacity=1,r.material.emissiveIntensity=f.current.open?1.4+Math.sin(n*4)*.4:.5}),f.current}),m=i===0?{tens:`4`,ones:`5`}:{tens:`5`,ones:`4`},h=(u,p)=>{if(i>=2)return;u===`t`?s(p):l(p);let h=u===`t`?p:o,g=u===`o`?p:c;h&&g&&(h===m.tens&&g===m.ones?(d({ok:!0}),f.current.setOpen(!0),gd(n(i===0?{ru:e.audio.ru[1],uz:e.audio.uz[1]}:e.audio),t,r.muted,i===0?t===`ru`?e.audio.ru[1]:e.audio.uz[1]:t===`ru`?e.audio.ru[2]:e.audio.uz[2]),setTimeout(()=>{i===0?(a(1),s(null),l(null),d(null),f.current.setOpen(!1)):a(2)},1600)):d({ok:!1}))};return(0,$.jsx)(Ld,{eyebrow:n(e.eyebrow),title:n(e.lead),nar:r,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`l3-code`,children:[(0,$.jsxs)(`div`,{className:`l3-code-row`,children:[(0,$.jsx)(`div`,{className:`l3-slot tens ${o?`on`:``}`,onClick:()=>o&&h(`t`,null),children:o||`?`}),(0,$.jsx)(`div`,{className:`l3-slot ones ${c?`on`:``}`,onClick:()=>c&&h(`o`,null),children:c||`?`})]}),(0,$.jsxs)(`div`,{className:`l3-code-labels`,children:[(0,$.jsx)(`span`,{className:`tens`,children:n(e.tens_label)}),(0,$.jsx)(`span`,{className:`ones`,children:n(e.ones_label)})]}),(0,$.jsx)(`div`,{className:`l3-code-hint`,children:n(i===0?e.round1:e.round2)}),(0,$.jsx)(`div`,{className:`l3-digits`,children:[`4`,`5`].map(t=>(0,$.jsxs)(_.Fragment,{children:[(0,$.jsxs)(`button`,{className:`l3-digit`,onClick:()=>h(`t`,t),children:[t,` → `,n(e.tens_label)]}),(0,$.jsxs)(`button`,{className:`l3-digit ones`,onClick:()=>h(`o`,t),children:[t,` → `,n(e.ones_label)]})]},t))})]}),u&&!u.ok&&(0,$.jsxs)(Fd,{show:!0,ok:!1,children:[n(e.wrong),` `,(0,$.jsx)(`button`,{className:`l3-mini`,onClick:()=>{s(null),l(null),d(null)},children:`↺`})]}),i===2&&(0,$.jsx)(Fd,{show:!0,ok:!0,children:n(e.done_text)})]}),children:(0,$.jsx)(id,{canvasRef:p})})}function gd(e,t,n,r){if(n||!window.SpeechSynthesisUtterance)return;window.speechSynthesis.cancel();let i=new SpeechSynthesisUtterance(r);i.lang=t===`ru`?`ru-RU`:`uz-UZ`,i.rate=.98,window.speechSynthesis.speak(i)}function _d(){let e=y.s6,t=kd(),n=Ad(),r=jd(e.audio[t],t),[i,a]=(0,_.useState)(0),o=(0,_.useRef)({}),{canvasRef:s}=rd({camPos:[0,1.4,12],camTarget:[0,.4,0]},e=>{ad(e,!1);let t=-5.2,n=5.2-t,r=new q(new ca(n,.08,.08),new Da({color:10466255,emissive:820,emissiveIntensity:.4}));r.position.set(0,0,0),e.scene.add(r);let i=e=>t+e/40*n;[0,10,20,30,40].forEach(t=>{let n=new q(new ca(.06,.5,.06),new Da({color:13623551}));n.position.set(i(t),0,0),e.scene.add(n);let r=ed(String(t),{font:54,color:`#cfe0ff`,scale:.5});r.position.set(i(t),-.7,0),e.scene.add(r)});let a=new q(new ha(.28,20,20),new Da({color:Iu,emissive:Iu,emissiveIntensity:1.8}));a.position.set(i(0),.45,0),e.scene.add(a);let s=ed(`34`,{font:90,color:`#ffd9c8`,glowColor:`#fe5b1a`,scale:.8});return s.position.set(i(34),1.5,0),s.visible=!1,e.scene.add(s),o.current={px:i,marker:a,val34:s,target:0,cur:0},e.onFrame((e,t)=>{let n=o.current;n.cur=Bu(n.cur,n.target,.12),n.marker.position.x=i(n.cur);let r=n.target<=30;n.marker.position.y=.45+Math.abs(Math.sin((n.cur/n.target||0)*Math.PI))*(r?.9:.3)*(Math.abs(n.cur-n.target)>.5),n.marker.material.emissiveIntensity=1.6+Math.sin(t*5)*.4,n.val34.visible=n.target>=34&&Math.abs(n.cur-34)<.6}),o.current}),c=()=>{let e=Math.min(7,i+1);a(e),o.current.target=e<=3?e*10:30+(e-3)},l=i===0?`0`:i<=3?`${i*10}`:`${30+(i-3)}`;return(0,$.jsx)(Ld,{eyebrow:n(e.eyebrow),title:n(e.lead),nar:r,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`l3-anchor`,children:(0,$.jsxs)(`span`,{children:[i<=3?t===`ru`?`Большой прыжок (десяток)`:`Katta sakrash (o'nlik)`:t===`ru`?`Маленький шаг (единица)`:`Kichik qadam (birlik)`,`: `,(0,$.jsx)(`b`,{children:l})]})}),i<7?(0,$.jsx)(Id,{onClick:c,children:i<3?t===`ru`?`Прыжок +10 →`:`Sakrash +10 →`:t===`ru`?`Шаг +1 →`:`Qadam +1 →`}):(0,$.jsx)(Fd,{show:!0,ok:!0,children:n(e.done_text)})]}),children:(0,$.jsx)(id,{canvasRef:s})})}function vd(){let e=y.s7,t=kd(),n=Ad(),r=jd(e.audio[t],t),[i,a]=(0,_.useState)(null),{canvasRef:o}=rd({camPos:[0,.4,11],camTarget:[0,.3,0]},e=>{ad(e,!1),Ku(e.scene,[7.6,3,-18],.7);let t=od(e,[4.4,.1,.3],.7),n=new Yn;e.scene.add(n);for(let e=0;e<4;e++){let t=Xu(10);t.scale.setScalar(.5),t.position.set(-3.4,1.1-e*.62,0),n.add(t)}for(let e=0;e<5;e++){let t=Yu();t.scale.setScalar(.44),t.position.set(-1.8+e%3*.5,1-Math.floor(e/3)*.8,0),t.rotation.z=.2,n.add(t)}let r=ed(`4`,{font:150,color:`#fe5b1a`,glowColor:`#fe5b1a`,scale:1.5});r.position.set(.5,1.3,.5);let i=ed(`5`,{font:150,color:`#4a86ff`,glowColor:`#4a86ff`,scale:1.5});return i.position.set(1.7,1.3,.5),e.scene.add(r,i),e.onFrame((e,i)=>{Ju(t,i,0),n.children.forEach(t=>t.rotation.y+=e*.2),r.position.y=1.3+Math.sin(i*1.2)*.05}),{}});return(0,$.jsx)(Ld,{eyebrow:n(e.eyebrow),nar:r,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`l3-rule`,children:n(e.rule)}),(0,$.jsx)(`p`,{className:`l3-check-q`,children:n(e.check_q)}),(0,$.jsxs)(`div`,{className:`l3-check-row`,children:[(0,$.jsx)(`button`,{className:`l3-check-digit tens ${i===!0?`ok`:``}`,onClick:()=>a(!0),children:`4`}),(0,$.jsx)(`button`,{className:`l3-check-digit ones ${i===!1?`no`:``}`,onClick:()=>a(!1),children:`5`})]}),(0,$.jsx)(Fd,{show:i!=null,ok:i===!0,children:n(i?e.check_ok:e.check_no)})]}),children:(0,$.jsx)(id,{canvasRef:o})})}function yd(){let e=y.s9,t=kd(),n=Ad(),r=jd(e.audio.intro,t),[i,a]=(0,_.useState)(null),[o,s]=(0,_.useState)(0),[c,l]=(0,_.useState)(null),{canvasRef:u,apiRef:d}=rd({camPos:[0,.7,12],camTarget:[0,.2,0]},e=>{ad(e,!1),Ku(e.scene,[7.6,3.2,-18],.7);let t={};[[`tens`,-3.7,Iu],[`ones`,3.7,Lu]].forEach(([n,r,i])=>{let a=new q(new ca(2.6,.25,2),new Da({color:1317418,emissive:i,emissiveIntensity:.3}));a.position.set(r,-1.7,0),e.scene.add(a),t[n]={x:r,y:-1.3,n:0}});let n=[],r=0;[[`tens`,3],[`ones`,2]].forEach(([t,i])=>{for(let a=0;a<i;a++){let i=t===`tens`?Xu(10):Yu();i.scale.setScalar(t===`tens`?.58:.7),i.position.set((r-2)*1.5,1.2+(t===`ones`?-.2:.4),(Math.random()-.5)*.8),Qu(i),i.userData.pickId=r,i.userData.kind=t,i.userData.done=!1,i.userData.sc=i.scale.x,e.scene.add(i),n.push(i),r++}});let i=null,a={onSelect:null,onWrong:null,onPlaced:null};return e.onClick(()=>n.filter(e=>!e.userData.done),e=>{i=e,a.onSelect?.(e.userData.kind)}),a.drop=e=>{let n=i;if(!n)return;if(n.userData.kind!==e){a.onWrong?.();return}n.userData.done=!0,n.userData.f=null;let r=t[e];n.userData.target=new H(r.x-.7+r.n%3*.7,r.y+Math.floor(r.n/3)*.5,0),r.n++,i=null,a.onPlaced?.()},e.onFrame((e,t)=>{n.forEach(n=>{n.userData.done?(n.position.lerp(n.userData.target,.14),n.rotation.x=Bu(n.rotation.x,0,.1),n.scale.setScalar(n.userData.sc)):($u(n,t,e,.16),n.scale.setScalar(n.userData.sc*(n===i?1+Math.sin(t*8)*.1:1)))})}),a});(0,_.useEffect)(()=>{let e=d.current;e&&(e.onSelect=e=>{a(e),l(null)},e.onWrong=()=>l(`wrong`),e.onPlaced=()=>{a(null),s(e=>e+1)})},[]);let f=a=>{if(!i)return;let o=i===a;if(d.current?.drop(a),window.speechSynthesis?.cancel(),!o){let i=new SpeechSynthesisUtterance(n(e.audio.on_wrong));i.lang=t===`ru`?`ru-RU`:`uz-UZ`,r.muted||window.speechSynthesis.speak(i)}},p=o>=5;return(0,_.useEffect)(()=>{if(p){window.speechSynthesis?.cancel();let i=new SpeechSynthesisUtterance(n(e.audio.on_correct));i.lang=t===`ru`?`ru-RU`:`uz-UZ`,r.muted||window.speechSynthesis.speak(i)}},[p]),(0,$.jsx)(Ld,{eyebrow:n(e.eyebrow),title:n(e.q),nar:r,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`l3-bins`,children:[(0,$.jsx)(`button`,{className:`l3-bin tens ${i?`live`:``}`,onClick:()=>f(`tens`),children:n(e.hold_tens)}),(0,$.jsx)(`button`,{className:`l3-bin ones ${i?`live`:``}`,onClick:()=>f(`ones`),children:n(e.hold_ones)})]}),(0,$.jsxs)(`div`,{className:`l3-hint-note`,children:[p?`✓ `+n(e.audio.on_correct):i?t===`ru`?`Выбери отсек ↑`:`Tryumni tanlang ↑`:t===`ru`?`Нажми на груз в космосе`:`Koinotdagi yukni bosing`,` · `,o,`/`,5]}),c===`wrong`&&(0,$.jsx)(Fd,{show:!0,ok:!1,children:n(e.audio.on_wrong)})]}),children:(0,$.jsx)(id,{canvasRef:u})})}function bd(){let e=y.s12,t=kd(),n=Ad(),r=jd(e.audio[t],t),{canvasRef:i}=rd({camPos:[0,.8,12],camTarget:[0,.3,0]},e=>{ad(e);let t=sd(e.scene,6,3),n=od(e,[4.6,.2,.4],.7);return e.onFrame((e,r)=>{cd(t,r),Ju(n,r,0)}),{}});return(0,$.jsx)(Ld,{eyebrow:n(e.eyebrow),title:n(e.lead),nar:r,footer:(0,$.jsxs)(`div`,{className:`l3-manifest`,children:[(0,$.jsx)(`span`,{className:`l3-manifest-badge`,children:n(e.manifest_label)}),(0,$.jsxs)(`span`,{children:[`6 × `,(0,$.jsx)(`b`,{style:{color:`#fe5b1a`},children:t===`ru`?`кассет`:`kasseta`}),` · 3 × `,(0,$.jsx)(`b`,{style:{color:`#4a86ff`},children:t===`ru`?`батарейки`:`batareya`})]})]}),children:(0,$.jsx)(id,{canvasRef:i})})}function xd(){let e=y.s15,t=kd(),n=Ad(),r=jd(e.audio[t],t),{canvasRef:i}=rd({orbit:!0,autoRotate:!0,camPos:[0,1,13]},e=>{ad(e),Ku(e.scene,[-8,-2,-20],1.4);let t=od(e,[2.6,.2,.5],.85),n=new Yn,r=new q(new la(.6,1.8,8,16),new Da({color:14673648,roughness:.3,metalness:.6}));n.add(r);let i=new q(new fa(.6,.9,16),new Da({color:Iu,roughness:.4,metalness:.3,emissive:Iu,emissiveIntensity:.3}));i.position.y=1.75,n.add(i);let a=new q(new fa(.4,1.2,16),new K({color:16765803}));return a.position.y=-1.7,a.rotation.x=Math.PI,n.add(a),n.position.set(-3.2,-.4,0),n.rotation.z=.08,e.scene.add(n),e.onFrame((e,r)=>{Ju(t,r,1),n.position.y=-.4+Math.sin(r*1.2)*.15,a.scale.y=1+Math.sin(r*20)*.25,a.scale.x=1+Math.sin(r*25)*.15,n.rotation.z=.08+Math.sin(r*.8)*.03}),{}});return(0,$.jsx)(Ld,{eyebrow:n(e.eyebrow),title:n(e.mission_done),nar:r,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`p`,{className:`l3-cando`,children:n(e.cando)}),(0,$.jsxs)(`div`,{className:`l3-recap`,children:[(0,$.jsx)(`span`,{className:`l3-recap-badge`,children:t===`ru`?`Правило`:`Qoida`}),n(e.rule_recap)]}),(0,$.jsxs)(`div`,{className:`l3-conn`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`b`,{children:[n(e.conn_label_refs),`:`]}),` `,n(e.conn_refs)]}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`b`,{children:[n(e.conn_label_next),`:`]}),` `,n(e.conn_next)]})]}),(0,$.jsxs)(`div`,{className:`l3-roadmap`,children:[`🪐 1 / 6 — `,t===`ru`?`планета пройдена`:`sayyora o'tildi`]})]}),children:(0,$.jsx)(id,{canvasRef:i})})}var Sd=()=>(0,$.jsx)(ld,{sid:`s10`,tens:5,ones:2,options:[{label:`52`},{label:`25`},{label:`7`},{label:`502`}],correct:0,explains:[null,y.s10.wrong_1,y.s10.wrong_2,y.s10.wrong_3]}),Cd=()=>(0,$.jsx)(Ed,{}),wd=()=>(0,$.jsx)(ld,{sid:`s13`,tens:6,ones:3,options:[{label:`63`},{label:`36`},{label:`9`},{label:`60`}],correct:0,explains:[null,y.s13.wrong_1,y.s13.wrong_2,y.s13.wrong_3]}),Td=()=>(0,$.jsx)(ld,{sid:`s14`,tens:4,ones:7,options:[{label:`47`},{label:`74`},{label:`11`},{label:`407`}],correct:0,explains:[null,y.s14.wrong_1,y.s14.wrong_2,y.s14.wrong_3],fact:{badge:y.s14.fact_badge,text:y.s14.fact_text}});function Ed(){let e=y.s11,t=kd(),n=Ad(),r=jd(e.audio.intro,t),[i,a]=(0,_.useState)(null),{canvasRef:o}=rd({camPos:[0,.8,13],camTarget:[0,.2,0]},e=>{ad(e);let t=sd(e.scene,4,5,{tx:-4.4,ox:-3}),n=sd(e.scene,5,4,{tx:2.2,ox:4});return t.scale.setScalar(.62),t.position.set(-2.2,0,0),n.scale.setScalar(.62),n.position.set(.4,0,0),e.onFrame((e,r)=>{cd(t,r),cd(n,r)}),{}});return(0,$.jsx)(Ld,{eyebrow:n(e.eyebrow),title:n(e.q),nar:r,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(Pd,{opts:[n(e.opt0),n(e.opt1)],picked:i,correct:1,onPick:o=>{if(i!=null)return;a(o),window.speechSynthesis?.cancel();let s=new SpeechSynthesisUtterance(n(o===1?e.audio.on_correct:e.audio.on_wrong));s.lang=t===`ru`?`ru-RU`:`uz-UZ`,r.muted||window.speechSynthesis.speak(s)},cols:2}),(0,$.jsx)(Fd,{show:i!=null,ok:i===1,children:n(i===1?e.audio.on_correct:e.audio.on_wrong)})]}),children:(0,$.jsx)(id,{canvasRef:o})})}var Dd={s0:ud,s1:dd,s2:fd,s3:()=>(0,$.jsx)(pd,{sid:`s3`,target:24,withCheck:!1}),s4:md,s5:hd,s6:_d,s7:vd,s8:()=>(0,$.jsx)(pd,{sid:`s8`,target:45,withCheck:!0}),s9:yd,s10:Sd,s11:Cd,s12:bd,s13:wd,s14:Td,s15:xd},Od=(0,_.createContext)(`uz`),kd=()=>(0,_.useContext)(Od),Ad=()=>{let e=kd();return t=>(t&&(t[e]??t.uz??t.ru))??``};function jd(e,t,n=!0){let[r,i]=(0,_.useState)(0),[a,o]=(0,_.useState)(!1),s=(Array.isArray(e)?e:e?[e]:[]).map(e=>typeof e==`string`?e:e&&(e[t]??e.uz??e.ru)||``),c=(0,_.useRef)(null),l=(0,_.useCallback)(()=>{window.speechSynthesis?.cancel(),c.current&&clearTimeout(c.current)},[]),u=(0,_.useCallback)((e=0)=>{l();let n=window.speechSynthesis,r=e;i(r);let o=()=>{if(r>=s.length)return;i(r);let e=s[r];if(n&&!a){let i=new SpeechSynthesisUtterance(e);i.lang=t===`ru`?`ru-RU`:`uz-UZ`,i.rate=.98,i.pitch=1.05,i.onend=()=>{r++,r<s.length&&o()},i.onerror=()=>{r++,c.current=setTimeout(o,1400)},n.speak(i)}else{let t=Math.max(1600,e.length*55);r++,r<s.length&&(c.current=setTimeout(o,t))}};o()},[s,t,a,l]);return(0,_.useEffect)(()=>(n&&u(0),l),[t]),(0,_.useEffect)(()=>l,[l]),{idx:r,text:s[r]||``,muted:a,setMuted:o,play:u,stop:l,count:s.length}}function Md({children:e}){return(0,$.jsx)(`span`,{className:`l3-eyebrow`,children:e})}function Nd({nar:e}){return e.text?(0,$.jsxs)(`div`,{className:`l3-caption`,children:[(0,$.jsx)(`button`,{className:`l3-spk ${e.muted?`off`:``}`,onClick:()=>{e.setMuted(!e.muted)},title:`Ovoz`,children:e.muted?`🔇`:`🔊`}),(0,$.jsx)(`p`,{className:`l3-cap-text`,children:e.text},e.idx),(0,$.jsx)(`button`,{className:`l3-replay`,onClick:()=>e.play(0),title:`Qayta`,children:`↻`})]}):null}function Pd({opts:e,picked:t,correct:n,onPick:r,disabled:i,cols:a}){return(0,$.jsx)(`div`,{className:`l3-opts`,style:{gridTemplateColumns:`repeat(${a||e.length}, 1fr)`},children:e.map((e,a)=>{let o=`l3-opt`;return t!=null&&(a===t?o+=a===n?` ok`:` no`:a===n&&t!==n&&(o+=` reveal`)),(0,$.jsx)(`button`,{className:o,disabled:i||t!=null,onClick:()=>r(a),children:e},a)})})}function Fd({show:e,ok:t,children:n}){return e?(0,$.jsx)(`div`,{className:`l3-fb ${t?`ok`:`no`}`,children:n}):null}function Id({children:e,onClick:t,disabled:n}){return(0,$.jsx)(`button`,{className:`l3-primary`,onClick:t,disabled:n,children:e})}function Ld({eyebrow:e,title:t,sub:n,nar:r,children:i,footer:a}){return(0,$.jsxs)(`div`,{className:`l3-card`,children:[(0,$.jsxs)(`div`,{className:`l3-head`,children:[e&&(0,$.jsx)(Md,{children:e}),t&&(0,$.jsx)(`h1`,{className:`l3-title`,children:t}),n&&(0,$.jsx)(`p`,{className:`l3-sub`,children:n})]}),r&&(0,$.jsx)(Nd,{nar:r}),i,a]})}function Rd({i:e,n:t}){return(0,$.jsxs)(`div`,{className:`l3-progress`,children:[(0,$.jsx)(`div`,{className:`l3-progress-bar`,children:(0,$.jsx)(`i`,{style:{width:`${(e+1)/t*100}%`}})}),(0,$.jsxs)(`span`,{className:`l3-progress-txt`,children:[e+1,` / `,t]})]})}function zd(){let[e,t]=(0,_.useState)(`uz`),[n,r]=(0,_.useState)(0),i=b.length,a=Dd[b[n]],o=()=>r(e=>Math.min(i-1,e+1)),s=()=>r(e=>Math.max(0,e-1));return(0,$.jsx)(Od.Provider,{value:e,children:(0,$.jsxs)(`div`,{className:`l3-root`,children:[(0,$.jsxs)(`div`,{className:`l3-topbar`,children:[(0,$.jsxs)(`div`,{className:`l3-brand`,children:[`Dars01 · 3D `,(0,$.jsx)(`span`,{className:`l3-tag`,children:`prototip`})]}),(0,$.jsx)(Rd,{i:n,n:i}),(0,$.jsxs)(`div`,{className:`l3-lang`,children:[(0,$.jsx)(`button`,{className:e===`uz`?`on`:``,onClick:()=>t(`uz`),children:`UZ`}),(0,$.jsx)(`button`,{className:e===`ru`?`on`:``,onClick:()=>t(`ru`),children:`RU`})]})]}),(0,$.jsx)(`div`,{className:`l3-stage-wrap`,children:(0,$.jsx)(a,{onNext:o,onPrev:s,isFirst:n===0,isLast:n===i-1,idx:n},b[n]+e)}),(0,$.jsxs)(`div`,{className:`l3-nav`,children:[(0,$.jsx)(`button`,{className:`l3-nav-btn ghost`,onClick:s,disabled:n===0,children:`← Orqaga`}),(0,$.jsx)(`button`,{className:`l3-nav-btn`,onClick:o,disabled:n===i-1,children:n===i-1?`Tugadi`:`Davom →`})]})]})})}(0,v.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(zd,{}));