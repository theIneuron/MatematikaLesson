...
// ---------------------------------------------------------------------------
// 4. ОЦЕНКА И ЗАМОК: теория 6 класса не оценивается
// ---------------------------------------------------------------------------
if (!/navLock:\s*false/.test(src)) bad('замок перехода не выключен (navLock: false)');
...
// ---------------------------------------------------------------------------
[
  ["div_6_NN", 'lessonId остался шаблонным'],
