// build-grade3-dars14.mjs — Dars14.jsx ni Dars13.jsx dan YIG'ADI (etap 3, sborka).
...
// `src/components/grade3/Dars14.jsx` faylining O'ZI; tuzatishlar shu faylga kiritiladi.
...
//
// Ishlatish: node scripts/build-grade3-dars14.mjs [--out src/components/grade3/Dars14.jsx]
import fs from 'node:fs';
import path from 'node:path';

const SRC = path.resolve('src/components/grade3/Dars13.jsx');
const OUT = path.resolve(process.argv.includes('--out') ? process.argv[process.argv.indexOf('--out') + 1] : 'src/components/grade3/Dars14.jsx');
