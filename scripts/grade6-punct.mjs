...
//   3) ЗНАК В КОНЦЕ ШАГА. Шаг способа — указание, а не предложение: во всём
//      классе шаги идут без конечного знака. Вопрос в шаге методист снял.
...
// Шаг списка — указание, а не предложение: конечного знака у него нет.
// Решение методиста 2026-08-20 по шагу «So'rang: ... oshadimi yoki kamayadimi?».
// Многоточие оставляем: в шаге «5 : 11 = 0,4545…» это математика, а не знак.
