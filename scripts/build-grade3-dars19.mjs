// build-grade3-dars19.mjs — Dars19.jsx ni Dars17.jsx dan YIG'ADI (etap 3, sborka).
// Metodist qoidasi: «yangi mexanika YARATMA, tayyoridan foydalan» — infra donordan bayt-aniq
// ko'chadi; sahna 3-darsdan (ustaxona), konsol va jadval 16-darsdan, svyortka 14-darsdan.
// Bir martalik generator: yig'ilgandan keyin manba — `src/components/grade3/Dars19.jsx` o'zi.
//
// Ishlatish: node scripts/build-grade3-dars19.mjs [--out src/components/grade3/Dars19.jsx]
import fs from 'node:fs';
import path from 'node:path';

const SRC = path.resolve('src/components/grade3/Dars17.jsx');
const OUT = path.resolve(process.argv.includes('--out') ? process.argv[process.argv.indexOf('--out') + 1] : 'src/components/grade3/Dars19.jsx');
