...
const LESSONS = {
  ...
  dars08: { slug: 'dars08-murakkab-teskari-funksiya', no: 8, segments: 4 },
  dars09: { slug: 'dars09-arkfunksiyalar', no: 9, segments: 4 },
  dars10: { slug: 'dars10-sodda-tenglamalar', no: 10, segments: 4 },
  dars11: { slug: 'dars11-sin-x-a', no: 11, segments: 4 },
  dars07: { slug: 'dars07-funksiyalar', no: 7, segments: 4 },
  dars12: { slug: 'dars12-cos-x-a', no: 12, segments: 4 },
  dars13: { slug: 'dars13-tg-x-a', no: 13, segments: 4 },
  dars14: { slug: 'dars14-usullar', no: 14, segments: 4 },
  dars15: { slug: 'dars15-daraja', no: 15, segments: 4 },
  dars16: { slug: 'dars16-korsatkichli-funksiya', no: 16, segments: 4 },
  dars17: { slug: 'dars17-korsatkichli-tenglamalar', no: 17, segments: 4 },
  dars18: { slug: 'dars18-logarifm', no: 18, segments: 4 },
  dars19: { slug: 'dars19-logarifmik-funksiya', no: 19, segments: 4 },
  dars20: { slug: 'dars20-logarifmik-tenglamalar', no: 20, segments: 4 },
  dars21: { slug: 'dars21-irratsional-tenglamalar', no: 21, segments: 4 },
  dars22: { slug: 'dars22-ratsional-tengsizliklar', no: 22, segments: 4 },
  dars23: { slug: 'dars23-logarifmik-ifodalar', no: 23, segments: 4 },
  dars24: { slug: 'dars24-korsatkichli-logarifmik-tengsizliklar', no: 24, segments: 4 },
  dars25: { slug: 'dars25-tenglamalar-sistemasi', no: 25, segments: 4 },
  dars26: { slug: 'dars26-trigonometrik-tengsizliklar', no: 26, segments: 4 },
  dars27: { slug: 'dars27-ehtimolliklar-nazariyasi', no: 27, segments: 4 },
  dars28: { slug: 'dars28-stereometriya-aksiomalari', no: 28, segments: 4 },
  dars29: { slug: 'dars29-ayqash-togri-chiziqlar', no: 29, segments: 4 },
  dars30: { slug: 'dars30-chiziq-va-tekislik-parallelligi', no: 30, segments: 4 },
  dars31: { slug: 'dars31-tekisliklar-parallelligi', no: 31, segments: 4 },
  dars32: { slug: 'dars32-parallel-proyeksiyalash', no: 32, segments: 4 },
  dars33: { slug: 'dars33-perpendikulyar-chiziq-tekislik', no: 33, segments: 4 },
  dars36: { slug: 'dars36-ogma-va-uch-perpendikulyar', no: 36, segments: 4 },
  dars34: { slug: 'dars34-chiziq-va-tekislik-burchagi', no: 34, segments: 4 },
  dars35: { slug: 'dars35-ikki-yoqli-burchak', no: 35, segments: 4 },
  dars37: { slug: 'dars37-prizma', no: 37, segments: 4 },
  dars38: { slug: 'dars38-parallelepiped', no: 38, segments: 4 },
  dars39: { slug: 'dars39-piramida', no: 39, segments: 4 },
  dars40: { slug: 'dars40-sirt-yuzasi', no: 40, segments: 4 },
  dars41: { slug: 'dars41-muntazam-jismlar', no: 41, segments: 4 },
  dars42: { slug: 'dars42-kesimlarni-yasash', no: 42, segments: 4 },
  dars43: { slug: 'dars43-fazoda-koordinatalar', no: 43, segments: 4 },
  dars44: { slug: 'dars44-fazoda-vektorlar', no: 44, segments: 4 },
  dars45: { slug: 'dars45-vektorlar-amallar', no: 45, segments: 4 },
  dars46: { slug: 'dars46-skalyar-kopaytma', no: 46, segments: 4 },
  dars47: { slug: 'dars47-tekislik-tenglamasi', no: 47, segments: 4 },
}
if (!LESSONS[LESSON]) {
